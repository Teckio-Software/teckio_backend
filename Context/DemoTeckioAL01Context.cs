...
public partial class DemoTeckioAL01Context : DbContext
{
    public DemoTeckioAL01Context()
    {
    }

    public DemoTeckioAL01Context(DbContextOptions<DemoTeckioAL01Context> options)
        : base(options)
    {
    }
