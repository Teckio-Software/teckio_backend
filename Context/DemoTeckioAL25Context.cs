...
public partial class DemoTeckioAL25Context : DbContext
{
    public DemoTeckioAL25Context()
    {
    }

    public DemoTeckioAL25Context(DbContextOptions<DemoTeckioAL25Context> options)
        : base(options)
    {
    }
