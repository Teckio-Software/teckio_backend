...
public partial class DemoTeckioAL04Context : DbContext
{
    public DemoTeckioAL04Context()
    {
    }

    public DemoTeckioAL04Context(DbContextOptions<DemoTeckioAL04Context> options)
        : base(options)
    {
    }
