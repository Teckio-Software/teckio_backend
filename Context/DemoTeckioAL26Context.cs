...
public partial class DemoTeckioAL26Context : DbContext
{
    public DemoTeckioAL26Context()
    {
    }

    public DemoTeckioAL26Context(DbContextOptions<DemoTeckioAL26Context> options)
        : base(options)
    {
    }
