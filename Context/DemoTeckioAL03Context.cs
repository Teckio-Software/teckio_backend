...
public partial class DemoTeckioAL03Context : DbContext
{
    public DemoTeckioAL03Context()
    {
    }

    public DemoTeckioAL03Context(DbContextOptions<DemoTeckioAL03Context> options)
        : base(options)
    {
    }
