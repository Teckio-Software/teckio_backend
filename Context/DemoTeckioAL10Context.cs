...
public partial class DemoTeckioAL10Context : DbContext
{
    public DemoTeckioAL10Context()
    {
    }

    public DemoTeckioAL10Context(DbContextOptions<DemoTeckioAL10Context> options)
        : base(options)
    {
    }
