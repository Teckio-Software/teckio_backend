...
public partial class DemoTeckioAL16Context : DbContext
{
    public DemoTeckioAL16Context()
    {
    }

    public DemoTeckioAL16Context(DbContextOptions<DemoTeckioAL16Context> options)
        : base(options)
    {
    }
