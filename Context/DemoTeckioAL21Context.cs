...
public partial class DemoTeckioAL21Context : DbContext
{
    public DemoTeckioAL21Context()
    {
    }

    public DemoTeckioAL21Context(DbContextOptions<DemoTeckioAL21Context> options)
        : base(options)
    {
    }
