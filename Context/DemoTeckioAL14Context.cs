...
public partial class DemoTeckioAL14Context : DbContext
{
    public DemoTeckioAL14Context()
    {
    }

    public DemoTeckioAL14Context(DbContextOptions<DemoTeckioAL14Context> options)
        : base(options)
    {
    }
