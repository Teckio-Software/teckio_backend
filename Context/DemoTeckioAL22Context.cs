...
public partial class DemoTeckioAL22Context : DbContext
{
    public DemoTeckioAL22Context()
    {
    }

    public DemoTeckioAL22Context(DbContextOptions<DemoTeckioAL22Context> options)
        : base(options)
    {
    }
