...
public partial class DemoTeckioAL19Context : DbContext
{
    public DemoTeckioAL19Context()
    {
    }

    public DemoTeckioAL19Context(DbContextOptions<DemoTeckioAL19Context> options)
        : base(options)
    {
    }
