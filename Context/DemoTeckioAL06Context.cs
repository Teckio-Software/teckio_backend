...
public partial class DemoTeckioAL06Context : DbContext
{
    public DemoTeckioAL06Context()
    {
    }

    public DemoTeckioAL06Context(DbContextOptions<DemoTeckioAL06Context> options)
        : base(options)
    {
    }
