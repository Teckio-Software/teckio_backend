...
public partial class DemoTeckioAL07Context : DbContext
{
    public DemoTeckioAL07Context()
    {
    }

    public DemoTeckioAL07Context(DbContextOptions<DemoTeckioAL07Context> options)
        : base(options)
    {
    }
