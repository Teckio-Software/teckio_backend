...
public partial class DemoTeckioAL13Context : DbContext
{
    public DemoTeckioAL13Context()
    {
    }

    public DemoTeckioAL13Context(DbContextOptions<DemoTeckioAL13Context> options)
        : base(options)
    {
    }
