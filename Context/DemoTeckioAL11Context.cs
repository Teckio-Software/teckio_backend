...
public partial class DemoTeckioAL11Context : DbContext
{
    public DemoTeckioAL11Context()
    {
    }

    public DemoTeckioAL11Context(DbContextOptions<DemoTeckioAL11Context> options)
        : base(options)
    {
    }
