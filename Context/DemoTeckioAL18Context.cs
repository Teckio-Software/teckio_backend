...
public partial class DemoTeckioAL18Context : DbContext
{
    public DemoTeckioAL18Context()
    {
    }

    public DemoTeckioAL18Context(DbContextOptions<DemoTeckioAL18Context> options)
        : base(options)
    {
    }
