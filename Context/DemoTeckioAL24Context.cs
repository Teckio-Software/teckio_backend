...
public partial class DemoTeckioAL24Context : DbContext
{
    public DemoTeckioAL24Context()
    {
    }

    public DemoTeckioAL24Context(DbContextOptions<DemoTeckioAL24Context> options)
        : base(options)
    {
    }
