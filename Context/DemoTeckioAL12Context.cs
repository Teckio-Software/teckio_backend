...
public partial class DemoTeckioAL12Context : DbContext
{
    public DemoTeckioAL12Context()
    {
    }

    public DemoTeckioAL12Context(DbContextOptions<DemoTeckioAL12Context> options)
        : base(options)
    {
    }
