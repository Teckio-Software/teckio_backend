...
public partial class DemoTeckioAL02Context : DbContext
{
    public DemoTeckioAL02Context()
    {
    }

    public DemoTeckioAL02Context(DbContextOptions<DemoTeckioAL02Context> options)
        : base(options)
    {
    }
