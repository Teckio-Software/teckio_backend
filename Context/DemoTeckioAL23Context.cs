...
public partial class DemoTeckioAL23Context : DbContext
{
    public DemoTeckioAL23Context()
    {
    }

    public DemoTeckioAL23Context(DbContextOptions<DemoTeckioAL23Context> options)
        : base(options)
    {
    }
