...
public partial class DemoTeckioAL20Context : DbContext
{
    public DemoTeckioAL20Context()
    {
    }

    public DemoTeckioAL20Context(DbContextOptions<DemoTeckioAL20Context> options)
        : base(options)
    {
    }
