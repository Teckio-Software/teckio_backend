...
public partial class DemoTeckioAL09Context : DbContext
{
    public DemoTeckioAL09Context()
    {
    }

    public DemoTeckioAL09Context(DbContextOptions<DemoTeckioAL09Context> options)
        : base(options)
    {
    }
