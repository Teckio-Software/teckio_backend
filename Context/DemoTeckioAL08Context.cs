...
public partial class DemoTeckioAL08Context : DbContext
{
    public DemoTeckioAL08Context()
    {
    }

    public DemoTeckioAL08Context(DbContextOptions<DemoTeckioAL08Context> options)
        : base(options)
    {
    }
