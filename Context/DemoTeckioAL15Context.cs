...
public partial class DemoTeckioAL15Context : DbContext
{
    public DemoTeckioAL15Context()
    {
    }

    public DemoTeckioAL15Context(DbContextOptions<DemoTeckioAL15Context> options)
        : base(options)
    {
    }
