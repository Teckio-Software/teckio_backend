...
public partial class DemoTeckioAL17Context : DbContext
{
    public DemoTeckioAL17Context()
    {
    }

    public DemoTeckioAL17Context(DbContextOptions<DemoTeckioAL17Context> options)
        : base(options)
    {
    }
