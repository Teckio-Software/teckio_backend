...
public partial class DemoTeckioAL05Context : DbContext
{
    public DemoTeckioAL05Context()
    {
    }

    public DemoTeckioAL05Context(DbContextOptions<DemoTeckioAL05Context> options)
        : base(options)
    {
    }
