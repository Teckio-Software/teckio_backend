...
namespace ERP_TECKIO.Servicios.Facturacion
{
    ...
    {
        private readonly IGenericRepository<FacturaImpuestos, T> _repository;
        private readonly IMapper _mapper;

        public FacturaImpuestosService(
            IGenericRepository<FacturaImpuestos, T> repository,
            IMapper mapper
            )
        {
        ...
        {
            var respuesta = await _repository.Crear(_mapper.Map<FacturaImpuestos>(registro));
        ...
        public async Task<RespuestaDTO> Editar(FacturaImpuestosDTO registro)
        {
            ...
            try
            {
                ...
                var modelo = _mapper.Map<FacturaImpuestos>(objetoEncontrado);
