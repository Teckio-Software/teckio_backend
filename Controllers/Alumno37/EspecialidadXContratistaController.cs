...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa35")]
    public class EspecialIdadXContratistaAlumno37Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno37Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno37Controller(
            ILogger<EspecialIdadXContratistaAlumno37Controller> logger,
