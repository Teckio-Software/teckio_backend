...
{
    [Route("api/cliente/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno37Controller : ControllerBase
    {
        private readonly IClientesService<Alumno37Context> _Service;

        private readonly ClienteProceso<Alumno37Context> _Proceso;
        public ClienteAlumno37Controller(
            IClientesService<Alumno37Context> service
            , ClienteProceso<Alumno37Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
