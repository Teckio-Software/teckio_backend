...
{
    [Route("api/saldosbalanzacomprobacion/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa35")]
    public class SaldosBalanzaComprobacionAlumno37Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno37Context> _Service;
        private readonly ICuentaContableService<Alumno37Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno37Controller> _Logger;
        private readonly Alumno37Context _Context;
        public SaldosBalanzaComprobacionAlumno37Controller(
            ILogger<SaldosBalanzaComprobacionAlumno37Controller> logger
            , Alumno37Context context
            , ISaldosBalanzaComprobacionService<Alumno37Context> service
