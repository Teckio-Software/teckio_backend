...
{
    [Route("api/indirectosXConcepto/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoAlumno37Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno37Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno37Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno37Controller(
            IIndirectosXConceptoService<Alumno37Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno37Context> indirectosXConceptoProceso
            ) { 
