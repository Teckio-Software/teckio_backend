...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa35")]
    public class InsumoXContratistaAlumno37Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno37Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno37Controller(
            ILogger<InsumoXContratistaAlumno37Controller> logger,
