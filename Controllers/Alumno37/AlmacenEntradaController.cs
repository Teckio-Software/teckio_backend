...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno37Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno37Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno37Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno37Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno37Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno37Controller(
            ILogger<AlmacenEntradaAlumno37Controller> logger,
            Alumno37Context context
            , IAlmacenEntradaService<Alumno37Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno37Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno37Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
