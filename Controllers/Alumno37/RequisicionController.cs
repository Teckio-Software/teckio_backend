...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno37Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno37Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno37Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno37Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno37Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno37Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno37Controller(
            ILogger<RequisicionAlumno37Controller> Logger
            , Alumno37Context Context
            , IRequisicionService<Alumno37Context> RequisicionService
            , RequisicionProceso<Alumno37Context> Proceso
            , ObjetoRequisicionProceso<Alumno37Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno37Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
