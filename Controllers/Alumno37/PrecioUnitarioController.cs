...
namespace SistemaERP.API.Alumno37Controllers.Procomi
{
    [Route("api/preciounitario/37")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno37Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno37Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno37Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno37Context> _Options;
        public PrecioUnitarioAlumno37Controller(
            PrecioUnitarioProceso<Alumno37Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno37Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno37Context> options
            )
        {
        ...
        {
            using (var db = new Alumno37Context(_Options.Options))
            {
