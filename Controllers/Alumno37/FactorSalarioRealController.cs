...
namespace ERP_TECKIO.Controllers.Alumno37
{
    [Route("api/fsr/37")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno37Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno37Context> factorSalarioRealProceso)
        {
