...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno37Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno37Context> _Service;

        private readonly RequisicionProceso<Alumno37Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno37Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno37Controller(
            ILogger<InsumoXRequisicionAlumno37Controller> Logger,
            RequisicionProceso<Alumno37Context> Proceso,
            Alumno37Context Context
            , IInsumoXRequisicionService<Alumno37Context> Service)
        {
            _Logger = Logger;
