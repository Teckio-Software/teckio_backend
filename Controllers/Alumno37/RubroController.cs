...
namespace ERP_TECKIO
{
    ...
    public class RubroAlumno37Controller : ControllerBase
    {
        private readonly IRubroService<Alumno37Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno37Controller> Logger;
        ...
        public RubroAlumno37Controller(
            ILogger<RubroAlumno37Controller> logger,
            Alumno37Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno37Context> service
            )
        {
            //_Service = service;
            Logger = logger;
