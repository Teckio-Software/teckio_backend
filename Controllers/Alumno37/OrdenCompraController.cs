...
{
    [Route("api/ordencompra/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno37Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno37Context> _Service;
        private readonly OrdenCompraProceso<Alumno37Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno37Controller> _Logger;
        private readonly Alumno37Context Context;
        public OrdenCompraAlumno37Controller(
            ILogger<OrdenCompraAlumno37Controller> Logger
            , Alumno37Context Context
            , IOrdenCompraService<Alumno37Context> Service
