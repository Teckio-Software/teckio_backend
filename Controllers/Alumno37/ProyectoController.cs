...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/proyecto/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno37Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno37Context> _ProyectoProceso;
        public ProyectoAlumno37Controller(
            ProyectoProceso<Alumno37Context> proyectoProceso)
        {
