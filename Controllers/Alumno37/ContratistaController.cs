...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/37")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno37Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno37Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno37Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno37Controller(
            ILogger<ContratistaAlumno37Controller> logger,
            Alumno37Context context
            , IContratistaService<Alumno37Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
