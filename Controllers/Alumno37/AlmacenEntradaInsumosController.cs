...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno37Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno37Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno37Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno37Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno37Controller(
            ILogger<AlmacenEntradaInsumoAlumno37Controller> logger,
            Alumno37Context context
            , IInsumoXAlmacenEntradaService<Alumno37Context> AlmacenEntradaDetalle
