...
namespace ERP_TECKIO
{
    ...
    public class InsumoAlumno37Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno37Context> _InsumoProceso;
        public InsumoAlumno37Controller(
            InsumoProceso<Alumno37Context> insumoProceso)
        {
