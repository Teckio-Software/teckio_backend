...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno37Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno37Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno37Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno37Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno37Controller> Logger;
        ...
        public AlmacenSalidaAlumno37Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno37Controller> logger,
            Alumno37Context context
            , IAlmacenSalidaService<Alumno37Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno37Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno37Context> Proceso
            )
        {
