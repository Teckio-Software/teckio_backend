...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno37Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno37Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno37Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno37Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno37Controller(
            ILogger<CuentaContableAlumno37Controller> logger,
            Alumno37Context context
            , ICuentaContableService<Alumno37Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno37Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
