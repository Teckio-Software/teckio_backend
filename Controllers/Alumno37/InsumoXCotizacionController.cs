...
{
    [Route("api/insumoxcotizacion/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno37Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno37Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno37Controller> _Logger;
        private readonly CotizacionProceso<Alumno37Context> _Proceso;
        private readonly Alumno37Context Context;
        public InsumoXCotizacionAlumno37Controller(
            ILogger<InsumoXCotizacionAlumno37Controller> Logger,
            Alumno37Context Context
            , IInsumoXCotizacionService<Alumno37Context> Service
