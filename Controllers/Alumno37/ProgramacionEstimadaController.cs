...
{
    [Route("api/programacionestimada/37")]
    [ApiController]
    public class ProgramacionEstimadaAlumno37Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno37Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno37Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno37Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno37Controller(
            ProgramacionEstimadaProceso<Alumno37Context> programacionEstimadaProceso,
            IProyectoService<Alumno37Context> proyectoProceso,
            IPrecioUnitarioService<Alumno37Context> precioUnitarioService,
