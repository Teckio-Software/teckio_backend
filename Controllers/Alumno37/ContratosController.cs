...
{
    [Route("api/contratos/37")]
    [ApiController]
    public class ContratosAlumno37Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno37Context> _contratosProceso;
        public ContratosAlumno37Controller(
            ContratosProceso<Alumno37Context> contratosProceso
            )
        {
