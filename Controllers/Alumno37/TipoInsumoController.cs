...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno37Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno37Context> _TipoInsumoProceso;

        public TipoInsumoAlumno37Controller(
            TipoInsumoProceso<Alumno37Context> tipoInsumoProceso
            )
        {
