...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno37Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno37Context> _Service;
        private readonly IPolizaDetalleService<Alumno37Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno37Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno37Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno37Context> _SaldosService;
        private readonly ILogger<PolizaAlumno37Controller> _Logger;
        private readonly Alumno37Context _Context;
        public PolizaAlumno37Controller(
            ILogger<PolizaAlumno37Controller> logger
            , Alumno37Context context
            , IPolizaService<Alumno37Context> service
            , IPolizaDetalleService<Alumno37Context> detalleService
            , ITipoPolizaService<Alumno37Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno37Context> saldosService
