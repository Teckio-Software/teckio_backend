...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/generadores/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa35")]
    public class GeneradoresAlumno37Controller : ControllerBase
    {
        private readonly GeneradoresProceso<Alumno37Context> _GeneradoresProceso;
        public GeneradoresAlumno37Controller(
            GeneradoresProceso<Alumno37Context> generadoresProceso)
        {
