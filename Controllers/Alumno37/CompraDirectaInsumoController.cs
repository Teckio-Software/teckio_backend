...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno37Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno37Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno37Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno37Controller(
            ILogger<CompraDirectaInsumoAlumno37Controller> logger
            , Alumno37Context context
            , IInsumoXCompraDirectaService<Alumno37Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
