...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/37")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno37Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno37Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno37Controller(
            ILogger<ContratistaCuentaBancariaAlumno37Controller> logger,
