...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno37Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno37Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno37Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno37Context Context;
        /// <summary>
        ...
        public CompraDirectaAlumno37Controller(
            ILogger<CompraDirectaAlumno37Controller> logger,
            Alumno37Context context
            , ICompraDirectaService<Alumno37Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
