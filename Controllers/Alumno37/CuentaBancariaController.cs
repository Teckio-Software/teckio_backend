...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno37Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno37Context> _proceso;

        private readonly ICuentaBancariaService<Alumno37Context> _servicio;
        public CuentaBancariaAlumno37Controller(CuentaBancariaProceso<Alumno37Context> _proceso, ICuentaBancariaService<Alumno37Context> _servicio
           )
        {
