...
{
    [Route("api/cotizacion/37")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno37Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno37Context> _Service;
        private readonly CotizacionProceso<Alumno37Context> _Proceso;
        private readonly IOrdenCompraService<Alumno37Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno37Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno37Controller> _Logger;
        private readonly Alumno37Context Context;
        public CotizacionAlumno37Controller(

            ILogger<CotizacionAlumno37Controller> Logger
            , Alumno37Context Context
            , ICotizacionService<Alumno37Context> Service
            , IOrdenCompraService<Alumno37Context> OrdenCompraService,
              ITipoImpuestoService<Alumno37Context> TipoImpuestoService
            , CotizacionProceso<Alumno37Context> Proceso)
        {
            _Logger = Logger;
