...
namespace ERP_TECKIO.Controllers.Alumno12
{
    ...
    [Route("api/produccion/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<Alumno12Context> _proceso;

        public ProduccionController(ProduccionProceso<Alumno12Context> proceso)
        {
            _proceso = proceso;
        }
