...
{
    [Route("api/detalleordencompra/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class DetalleOrdenVentaController: ControllerBase
    {
        private readonly DetalleOrdenVentaProceso<Alumno12Context> _Proceso;

        public DetalleOrdenVentaController(DetalleOrdenVentaProceso<Alumno12Context> proceso)
        {
            _Proceso = proceso;
        }
