...
namespace ERP_TECKIO.API.Alumno012Controllers.Procomi
{
    [Route("api/estimaciones/12")]
    [ApiController]
    public class EstimacionesAlumno12Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno12Context> _estimacionesProceso;
        public EstimacionesAlumno12Controller(
