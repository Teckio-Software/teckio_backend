...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa12")]
    public class InsumoXContratistaAlumno12Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno12Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno12Controller(
            ILogger<InsumoXContratistaAlumno12Controller> logger,
