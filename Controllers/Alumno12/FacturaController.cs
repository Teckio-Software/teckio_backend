...
{
    [Route("api/factura/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaAlumno12Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno12Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno12Context> _categoriaProductoYServicioService;
        public FacturaAlumno12Controller(
            ObtenFacturaProceso<Alumno12Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno12Context> categoriaProductoYServicioService
            )
        {
