...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoAlumno12Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno12Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno12Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno12Controller(
            IIndirectosXConceptoService<Alumno12Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno12Context> indirectosXConceptoProceso
            ) { 
