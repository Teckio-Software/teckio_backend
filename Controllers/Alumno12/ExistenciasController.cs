...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno12Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno12Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno12Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno12Controller(
            ILogger<ExistenciasAlumno12Controller> Logger,
            Alumno12Context Context
            , IAlmacenExistenciaInsumoService<Alumno12Context> ExistenciaService
            , ExistenciasProceso<Alumno12Context> Proceso
            )
        {
            _Logger = Logger;
