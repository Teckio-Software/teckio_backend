...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno12Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno12Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno12Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno12Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno12Controller(
            ILogger<AlmacenEntradaInsumoAlumno12Controller> logger,
            Alumno12Context context
            , IInsumoXAlmacenEntradaService<Alumno12Context> AlmacenEntradaDetalle
