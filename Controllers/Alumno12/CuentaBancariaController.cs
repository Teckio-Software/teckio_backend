...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno12Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno12Context> _proceso;

        private readonly ICuentaBancariaService<Alumno12Context> _servicio;
        public CuentaBancariaAlumno12Controller(CuentaBancariaProceso<Alumno12Context> _proceso, ICuentaBancariaService<Alumno12Context> _servicio
           )
        {
