...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno12Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno12Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno12Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno12Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno12Controller(
            ILogger<ContratistaAlumno12Controller> logger,
            Alumno12Context context
            , IContratistaService<Alumno12Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno12Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
