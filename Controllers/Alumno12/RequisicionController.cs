...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno12Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno12Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno12Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno12Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno12Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno12Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno12Controller(
            ILogger<RequisicionAlumno12Controller> Logger
            , Alumno12Context Context
            , IRequisicionService<Alumno12Context> RequisicionService
            , RequisicionProceso<Alumno12Context> Proceso
            , ObjetoRequisicionProceso<Alumno12Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno12Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/12/970"))
            {
