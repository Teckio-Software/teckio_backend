...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno12Controller : ControllerBase
    {
        private readonly IClientesService<Alumno12Context> _Service;

        private readonly ClienteProceso<Alumno12Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno12Context> _clientesCuentasContablesProceso;
        public ClienteAlumno12Controller(
            IClientesService<Alumno12Context> service
            , ClienteProceso<Alumno12Context> proceso,
            ClienteCuentasContablesProceso<Alumno12Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
