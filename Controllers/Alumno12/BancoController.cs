...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno12Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno12Context> _bancoService;

        public BancoAlumno12Controller(IBancoService<Alumno12Context> bancoService)
        {
