...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno12Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno12Context> _Service;
        private readonly OrdenCompraProceso<Alumno12Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno12Controller> _Logger;
        private readonly Alumno12Context _Context;
        public InsumoXOrdenCompraAlumno12Controller(
            ILogger<InsumoXOrdenCompraAlumno12Controller> Logger,
            Alumno12Context Context
            , IInsumoXOrdenCompraService<Alumno12Context> Service
