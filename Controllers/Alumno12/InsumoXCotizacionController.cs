...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionAlumno12Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno12Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno12Controller> _Logger;
        private readonly CotizacionProceso<Alumno12Context> _Proceso;
        private readonly Alumno12Context Context;
        public InsumoXCotizacionAlumno12Controller(
            ILogger<InsumoXCotizacionAlumno12Controller> Logger,
            Alumno12Context Context
            , IInsumoXCotizacionService<Alumno12Context> Service
