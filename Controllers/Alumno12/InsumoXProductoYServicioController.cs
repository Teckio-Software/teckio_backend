...
namespace ERP_TECKIO.Controllers.Alumno12
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/12")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno12Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno12Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno12Context> service, InsumoXProductoYServicioProceso<Alumno12Context> process)
        {
            _service = service;
            _process = process;
        }
