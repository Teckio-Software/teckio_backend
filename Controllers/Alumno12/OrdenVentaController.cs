...
{
    [Route("api/ordenventa/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaAlumno12Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno12Context> _ordenVentaProceso;
        public OrdenVentaAlumno12Controller(
            OrdenVentaProceso<Alumno12Context> ordenVentaProceso
            ) { 
