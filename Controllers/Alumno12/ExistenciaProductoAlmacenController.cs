...
namespace ERP_TECKIO.Controllers.Alumno12
{
    ...
    [Route("api/existenciaproductoalmacen/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno12Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno12Context> proces)
        {
            _proceso = proces;
        }
