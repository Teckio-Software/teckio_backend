...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno12Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno12Context> _empleadoService;
        public EmpleadoAlumno12Controller(
            IEmpleadoService<Alumno12Context> empleadoService
            )
        {
