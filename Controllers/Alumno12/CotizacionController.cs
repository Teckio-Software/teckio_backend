...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno12Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno12Context> _Service;
        private readonly CotizacionProceso<Alumno12Context> _Proceso;
        private readonly IOrdenCompraService<Alumno12Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno12Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno12Controller> _Logger;
        private readonly Alumno12Context Context;
        public CotizacionAlumno12Controller(

            ILogger<CotizacionAlumno12Controller> Logger
            , Alumno12Context Context
            , ICotizacionService<Alumno12Context> Service
            , IOrdenCompraService<Alumno12Context> OrdenCompraService,
              ITipoImpuestoService<Alumno12Context> TipoImpuestoService
            , CotizacionProceso<Alumno12Context> Proceso)
        {
            _Logger = Logger;
