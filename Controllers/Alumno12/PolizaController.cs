...
namespace ERP_TECKIO.Controllers
{
    [Route("api/poliza/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa12")]
    public class PolizaAlumno12Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno12Context> _Service;
        private readonly IPolizaDetalleService<Alumno12Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno12Context> _TipoPolizaService;
        ...
        public PolizaAlumno12Controller(
            ...
            , IPolizaService<Alumno12Context> service
            , IPolizaDetalleService<Alumno12Context> detalleService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa12")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa12")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa12")]
