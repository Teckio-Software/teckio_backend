...
namespace ERP_TECKIO.Controllers.Alumno12
{
    [Route("api/fsr/12")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno12Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno12Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno12Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno12Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno12Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno12Context> porcentajeCesantiaEdadService
            )
        {
