...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa12")]
    public class TipoInsumoAlumno12Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno12Context> _TipoInsumoProceso;

        public TipoInsumoAlumno12Controller(
            TipoInsumoProceso<Alumno12Context> tipoInsumoProceso
            )
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoInsumo-Empresa12")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoInsumo-Empresa12")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarTipoInsumo-Empresa12")]
