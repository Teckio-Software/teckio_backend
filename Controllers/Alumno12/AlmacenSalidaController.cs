...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno12Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno12Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno12Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno12Controller> Logger;
        ...
        public AlmacenSalidaAlumno12Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno12Controller> logger,
            Alumno12Context context
            , IAlmacenSalidaService<Alumno12Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno12Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno12Context> Proceso
            )
        {
