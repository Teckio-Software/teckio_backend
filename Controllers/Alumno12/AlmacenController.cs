...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno12Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno12Context> _almacenServicio;

        public AlmacenAlumno12Controller(
            IAlmacenService<Alumno12Context> almacenServicio)
        {
