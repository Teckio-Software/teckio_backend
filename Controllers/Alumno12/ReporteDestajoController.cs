...
namespace ERP_TECKIO.API.Controllers.Alumno12
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno12Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno12Context> _proceso;
        private readonly EstimacionesProceso<Alumno12Context> _estimacionesProceso;

        public ReporteDestajoAlumno12Controller(
            ReporteDestajoProceso<Alumno12Context> proceso,
            EstimacionesProceso<Alumno12Context> estimacionesProceso
            ) { 
            _proceso = proceso;
