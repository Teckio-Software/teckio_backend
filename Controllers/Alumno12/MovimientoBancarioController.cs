...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno12Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno12Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno12Controller(
            MovimientoBancarioProceso<Alumno12Context> movimientoBancarioProceso
            )
        {
