...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno12Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno12Context> _contratosProceso;
        public ContratosAlumno12Controller(
            ContratosProceso<Alumno12Context> contratosProceso
            )
        {
