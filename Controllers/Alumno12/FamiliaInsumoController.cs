...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa12")]
    public class FamiliaInsumoAlumno12Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno12Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno12Controller(
            FamiliaInsumoProceso<Alumno12Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa12")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa12")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa12")]
