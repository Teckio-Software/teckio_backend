...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa12")]
    public class CompraDirectaInsumoAlumno12Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno12Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno12Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno12Controller(
            ILogger<CompraDirectaInsumoAlumno12Controller> logger
            , Alumno12Context context
            , IInsumoXCompraDirectaService<Alumno12Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
