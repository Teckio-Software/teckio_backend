...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa12")]
    public class EspecialIdadXContratistaAlumno12Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno12Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno12Controller(
            ILogger<EspecialIdadXContratistaAlumno12Controller> logger,
