...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno12Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno12Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno12Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno12Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno12Controller(
            ILogger<AlmacenEntradaAlumno12Controller> logger,
            Alumno12Context context
            , IAlmacenEntradaService<Alumno12Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno12Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno12Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
