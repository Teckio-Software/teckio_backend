...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno12Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno12Context> _Service;

        private readonly RequisicionProceso<Alumno12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno12Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno12Controller(
            ILogger<InsumoXRequisicionAlumno12Controller> Logger,
            RequisicionProceso<Alumno12Context> Proceso,
            Alumno12Context Context
            , IInsumoXRequisicionService<Alumno12Context> Service)
        {
            _Logger = Logger;
