...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa12")]
    public class CompraDirectaAlumno12Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno12Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno12Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno12Controller(
            ILogger<CompraDirectaAlumno12Controller> logger,
            Alumno12Context context
            , ICompraDirectaService<Alumno12Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa12")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa12")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa12")]
