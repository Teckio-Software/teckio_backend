...
namespace ERP_TECKIO.Controllers.Alumno12
{
    ...
    public class ProductoYServicioAlumno12Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno12Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno12Context> _process;

        public ProductoYServicioAlumno12Controller(IProductoYservicioService<Alumno12Context> productoYServicioService,
            ProductoYServicioProceso<Alumno12Context> process
            )
        {
