...
namespace ERP_TECKIO.Controllers.Alumno12
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno12Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno12Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno12Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno12Controller(
            IPrecioUnitarioXEmpleadoService<Alumno12Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno12Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
