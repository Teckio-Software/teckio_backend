...
{
    [Route("api/reportesdestajo/6")]
    [ApiController]
    public class ReporteDestajoAlumno06Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno06Context> _proceso;
        private readonly EstimacionesProceso<Alumno06Context> _estimacionesProceso;

        public ReporteDestajoAlumno06Controller(
            ReporteDestajoProceso<Alumno06Context> proceso,
            EstimacionesProceso<Alumno06Context> estimacionesProceso
            ) { 
            _proceso = proceso;
