...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    public class FacturaAlumno06Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno06Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno06Context> _categoriaProductoYServicioService;
        public FacturaAlumno06Controller(
            ObtenFacturaProceso<Alumno06Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno06Context> categoriaProductoYServicioService
            )
        {
