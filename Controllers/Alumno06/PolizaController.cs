...
namespace ERP_TECKIO.Controllers
{
    [Route("api/poliza/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa6")]
    public class PolizaAlumno06Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno06Context> _Service;
        private readonly IPolizaDetalleService<Alumno06Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno06Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno06Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno06Context> _SaldosService;
        private readonly ILogger<PolizaAlumno06Controller> _Logger;
        private readonly Alumno06Context _Context;
        public PolizaAlumno06Controller(
            ILogger<PolizaAlumno06Controller> logger
            , Alumno06Context context
            , IPolizaService<Alumno06Context> service
            , IPolizaDetalleService<Alumno06Context> detalleService
            , ITipoPolizaService<Alumno06Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno06Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa6")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa6")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa6")]
