...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno06Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno06Context> _Service;
        private readonly OrdenCompraProceso<Alumno06Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno06Controller> _Logger;
        private readonly Alumno06Context _Context;
        public InsumoXOrdenCompraAlumno06Controller(
            ILogger<InsumoXOrdenCompraAlumno06Controller> Logger,
            Alumno06Context Context
            , IInsumoXOrdenCompraService<Alumno06Context> Service
