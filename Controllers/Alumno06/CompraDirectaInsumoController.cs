...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa6")]
    public class CompraDirectaInsumoAlumno06Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno06Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno06Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno06Controller(
            ILogger<CompraDirectaInsumoAlumno06Controller> logger
            , Alumno06Context context
            , IInsumoXCompraDirectaService<Alumno06Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
