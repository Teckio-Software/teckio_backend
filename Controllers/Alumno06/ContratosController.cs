...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno06Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno06Context> _contratosProceso;
        public ContratosAlumno06Controller(
            ContratosProceso<Alumno06Context> contratosProceso
            )
        {
