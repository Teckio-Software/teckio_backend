...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa6")]
    public class InsumoXContratistaAlumno06Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno06Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno06Controller(
            ILogger<InsumoXContratistaAlumno06Controller> logger,
