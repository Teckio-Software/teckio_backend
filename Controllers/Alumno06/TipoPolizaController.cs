...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/tipopoliza/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa6")]
    public class TipoPolizaAlumno06Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno06Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno06Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno06Controller(
            ILogger<TipoPolizaAlumno06Controller> logger,
            Alumno06Context context
            , ITipoPolizaService<Alumno06Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa6")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa6")]
