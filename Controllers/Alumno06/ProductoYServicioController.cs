...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    public class ProductoYServicioAlumno06Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno06Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno06Context> _process;

        public ProductoYServicioAlumno06Controller(IProductoYservicioService<Alumno06Context> productoYServicioService,
            ProductoYServicioProceso<Alumno06Context> process
            )
        {
