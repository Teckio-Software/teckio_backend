...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno06Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno06Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno06Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno06Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno06Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno06Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno06Controller(
            ILogger<RequisicionAlumno06Controller> Logger
            , Alumno06Context Context
            , IRequisicionService<Alumno06Context> RequisicionService
            , RequisicionProceso<Alumno06Context> Proceso
            , ObjetoRequisicionProceso<Alumno06Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno06Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
