...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosAlumno06Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno06Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno06Context> _indirectosService;
        private readonly IndirectosProceso<Alumno06Context> _indirectosProceso;

        public IndirectosAlumno06Controller(
                        IConjuntoIndirectosService<Alumno06Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno06Context> indirectosService,
                        IndirectosProceso<Alumno06Context> indirectosProceso
            )
        {
