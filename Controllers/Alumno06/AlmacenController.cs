...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno06Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno06Context> _almacenServicio;

        public AlmacenAlumno06Controller(
            IAlmacenService<Alumno06Context> almacenServicio)
        {
