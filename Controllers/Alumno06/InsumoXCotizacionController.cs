...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionAlumno06Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno06Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno06Controller> _Logger;
        private readonly CotizacionProceso<Alumno06Context> _Proceso;
        private readonly Alumno06Context Context;
        public InsumoXCotizacionAlumno06Controller(
            ILogger<InsumoXCotizacionAlumno06Controller> Logger,
            Alumno06Context Context
            , IInsumoXCotizacionService<Alumno06Context> Service
