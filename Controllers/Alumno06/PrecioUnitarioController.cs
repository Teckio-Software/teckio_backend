...
{
    [Route("api/preciounitario/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno06Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno06Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno06Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno06Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno06Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno06Controller(
            PrecioUnitarioProceso<Alumno06Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno06Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno06Context> options,
            ExplocionInsumosProceso<Alumno06Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new Alumno06Context(_Options.Options))
            {
