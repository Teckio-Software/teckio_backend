...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/familiainsumo/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa6")]
    public class FamiliaInsumoAlumno06Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno06Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno06Controller(
            FamiliaInsumoProceso<Alumno06Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa6")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa6")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa6")]
