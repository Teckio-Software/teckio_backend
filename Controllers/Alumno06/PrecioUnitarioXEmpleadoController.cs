...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno06Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno06Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno06Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno06Controller(
            IPrecioUnitarioXEmpleadoService<Alumno06Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno06Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
