...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno06Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno06Context> service)
        {
            _service = service;
        }
