...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno06Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno06Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno06Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno06Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno06Controller(
            ILogger<AlmacenEntradaInsumoAlumno06Controller> logger,
            Alumno06Context context
            , IInsumoXAlmacenEntradaService<Alumno06Context> AlmacenEntradaDetalle
