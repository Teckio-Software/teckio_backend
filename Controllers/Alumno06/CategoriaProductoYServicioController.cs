...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno06Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno06Context> service)
        {
            _service = service;
        }
