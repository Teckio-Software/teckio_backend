...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno06Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno06Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno06Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno06Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno06Controller(
            ILogger<ExistenciasAlumno06Controller> Logger,
            Alumno06Context Context
            , IAlmacenExistenciaInsumoService<Alumno06Context> ExistenciaService
            , ExistenciasProceso<Alumno06Context> Proceso
            )
        {
            _Logger = Logger;
