...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno06Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno06Context> proces)
        {
            _proceso = proces;
        }
