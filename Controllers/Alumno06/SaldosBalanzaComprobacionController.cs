...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa6")]
    public class SaldosBalanzaComprobacionAlumno06Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno06Context> _Service;
        private readonly ICuentaContableService<Alumno06Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno06Controller> _Logger;
        private readonly Alumno06Context _Context;
        public SaldosBalanzaComprobacionAlumno06Controller(
            ILogger<SaldosBalanzaComprobacionAlumno06Controller> logger
            , Alumno06Context context
            , ISaldosBalanzaComprobacionService<Alumno06Context> service
