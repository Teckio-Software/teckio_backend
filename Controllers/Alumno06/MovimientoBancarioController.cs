...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly MovimientoBancarioProceso<Alumno06Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno06Controller(
            MovimientoBancarioProceso<Alumno06Context> movimientoBancarioProceso
            )
        {
