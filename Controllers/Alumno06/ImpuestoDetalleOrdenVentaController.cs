...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno06Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno06Context> process)
        {
            _process = process;
        }
