...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno06Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno06Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno06Context> service, InsumoXProductoYServicioProceso<Alumno06Context> process)
        {
            _service = service;
            _process = process;
        }
