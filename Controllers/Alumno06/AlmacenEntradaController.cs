...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno06Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno06Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno06Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno06Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno06Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno06Controller(
            ILogger<AlmacenEntradaAlumno06Controller> logger,
            Alumno06Context context
            , IAlmacenEntradaService<Alumno06Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno06Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno06Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
