...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa6")]
    public class EspecialIdadXContratistaAlumno06Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno06Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno06Controller(
            ILogger<EspecialIdadXContratistaAlumno06Controller> logger,
