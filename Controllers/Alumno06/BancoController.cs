...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno06Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno06Context> _bancoService;

        public BancoAlumno06Controller(IBancoService<Alumno06Context> bancoService)
        {
