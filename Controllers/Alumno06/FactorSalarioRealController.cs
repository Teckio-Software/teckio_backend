...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    public class FactorSalarioRealController : ControllerBase
    {
        ...
        private readonly IParametrosFsrService<Alumno06Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno06Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno06Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno06Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno06Context> porcentajeCesantiaEdadService
            )
        {
