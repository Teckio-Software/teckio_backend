...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno06Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno06Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno06Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno06Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno06Controller> Logger;
        ...
        public AlmacenSalidaAlumno06Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno06Controller> logger,
            Alumno06Context context
            , IAlmacenSalidaService<Alumno06Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno06Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno06Context> Proceso
            )
        {
