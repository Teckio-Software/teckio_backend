...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno06Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno06Context> _Service;
        private readonly CotizacionProceso<Alumno06Context> _Proceso;
        private readonly IOrdenCompraService<Alumno06Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno06Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno06Controller> _Logger;
        private readonly Alumno06Context Context;
        public CotizacionAlumno06Controller(

            ILogger<CotizacionAlumno06Controller> Logger
            , Alumno06Context Context
            , ICotizacionService<Alumno06Context> Service
            , IOrdenCompraService<Alumno06Context> OrdenCompraService,
              ITipoImpuestoService<Alumno06Context> TipoImpuestoService
            , CotizacionProceso<Alumno06Context> Proceso)
        {
            _Logger = Logger;
