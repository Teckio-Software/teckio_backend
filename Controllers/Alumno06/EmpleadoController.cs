...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno06Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno06Context> _empleadoService;
        public EmpleadoAlumno06Controller(
            IEmpleadoService<Alumno06Context> empleadoService
            )
        {
