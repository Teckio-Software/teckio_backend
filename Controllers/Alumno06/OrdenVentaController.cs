...
namespace ERP_TECKIO.Controllers.Alumno06
{
    ...
    public class OrdenVentaAlumno06Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno06Context> _ordenVentaProceso;
        public OrdenVentaAlumno06Controller(
            OrdenVentaProceso<Alumno06Context> ordenVentaProceso
            ) { 
