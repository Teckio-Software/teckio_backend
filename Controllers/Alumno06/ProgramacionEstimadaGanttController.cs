...
namespace SistemaERP.API.Controllers.Alumno06
{
    [Route("api/programacionestimadaGantt/6")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno06Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno06Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno06Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno06Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno06Controller(
            ProgramacionEstimadaGanttProceso<Alumno06Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno06Context> importeSemanalGanttProceso,
