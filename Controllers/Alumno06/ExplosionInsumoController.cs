...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoAlumno06Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoAlumno06Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoAlumno06Controller(
            ILogger<ExplosionInsumoAlumno06Controller> Logger,
