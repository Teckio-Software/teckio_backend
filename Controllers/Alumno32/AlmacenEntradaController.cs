...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno32Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno32Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno32Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno32Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno32Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno32Controller(
            ILogger<AlmacenEntradaAlumno32Controller> logger,
            Alumno32Context context
            , IAlmacenEntradaService<Alumno32Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno32Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno32Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
