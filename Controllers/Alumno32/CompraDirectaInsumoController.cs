...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa32")]
    public class CompraDirectaInsumoAlumno32Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno32Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno32Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno32Controller(
            ILogger<CompraDirectaInsumoAlumno32Controller> logger
            , Alumno32Context context
            , IInsumoXCompraDirectaService<Alumno32Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
