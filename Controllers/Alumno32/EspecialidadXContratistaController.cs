...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa32")]
    public class EspecialIdadXContratistaAlumno32Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno32Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno32Controller(
            ILogger<EspecialIdadXContratistaAlumno32Controller> logger,
