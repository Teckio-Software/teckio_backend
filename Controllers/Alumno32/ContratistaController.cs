...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/32")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno32Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno32Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno32Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno32Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno32Controller(
            ILogger<ContratistaAlumno32Controller> logger,
            Alumno32Context context
            , IContratistaService<Alumno32Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno32Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
