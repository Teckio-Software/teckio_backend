...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa32")]
    public class InsumoXContratistaAlumno32Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno32Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno32Controller(
            ILogger<InsumoXContratistaAlumno32Controller> logger,
