...
namespace ERP_TECKIO.Controllers.Alumno32
{
    [Route("api/factura/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaAlumno32Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno32Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno32Context> _categoriaProductoYServicioService;
        public FacturaAlumno32Controller(
            ObtenFacturaProceso<Alumno32Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno32Context> categoriaProductoYServicioService
            )
        {
