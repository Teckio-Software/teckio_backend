...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno32Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno32Context> _bancoService;

        public BancoAlumno32Controller(IBancoService<Alumno32Context> bancoService)
        {
