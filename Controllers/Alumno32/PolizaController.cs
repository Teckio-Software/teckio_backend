...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno32Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno32Context> _Service;
        private readonly IPolizaDetalleService<Alumno32Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno32Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno32Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno32Context> _SaldosService;
        private readonly ILogger<PolizaAlumno32Controller> _Logger;
        private readonly Alumno32Context _Context;
        public PolizaAlumno32Controller(
            ILogger<PolizaAlumno32Controller> logger
            , Alumno32Context context
            , IPolizaService<Alumno32Context> service
            , IPolizaDetalleService<Alumno32Context> detalleService
            , ITipoPolizaService<Alumno32Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno32Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa32")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa32")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa32")]
