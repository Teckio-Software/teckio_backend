...
{
    [Route("api/insumoxcotizacion/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno32Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno32Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno32Controller> _Logger;
        private readonly CotizacionProceso<Alumno32Context> _Proceso;
        private readonly Alumno32Context Context;
        public InsumoXCotizacionAlumno32Controller(
            ILogger<InsumoXCotizacionAlumno32Controller> Logger,
            Alumno32Context Context
            , IInsumoXCotizacionService<Alumno32Context> Service
