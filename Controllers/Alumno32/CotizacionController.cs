...
{
    [Route("api/cotizacion/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno32Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno32Context> _Service;
        private readonly CotizacionProceso<Alumno32Context> _Proceso;
        private readonly IOrdenCompraService<Alumno32Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno32Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno32Controller> _Logger;
        private readonly Alumno32Context Context;
        public CotizacionAlumno32Controller(

            ILogger<CotizacionAlumno32Controller> Logger
            , Alumno32Context Context
            , ICotizacionService<Alumno32Context> Service
            , IOrdenCompraService<Alumno32Context> OrdenCompraService,
              ITipoImpuestoService<Alumno32Context> TipoImpuestoService
            , CotizacionProceso<Alumno32Context> Proceso)
        {
            _Logger = Logger;
