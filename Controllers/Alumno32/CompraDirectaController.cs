...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa32")]
    public class CompraDirectaAlumno32Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno32Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno32Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno32Controller(
            ILogger<CompraDirectaAlumno32Controller> logger,
            Alumno32Context context
            , ICompraDirectaService<Alumno32Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa32")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa32")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa32")]
