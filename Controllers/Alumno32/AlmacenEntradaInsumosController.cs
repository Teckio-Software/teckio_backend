...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno32Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno32Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno32Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno32Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno32Controller(
            ILogger<AlmacenEntradaInsumoAlumno32Controller> logger,
            Alumno32Context context
            , IInsumoXAlmacenEntradaService<Alumno32Context> AlmacenEntradaDetalle
