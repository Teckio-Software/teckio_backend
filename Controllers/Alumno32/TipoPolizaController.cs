...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa32")]
    public class TipoPolizaAlumno32Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno32Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno32Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno32Controller(
            ILogger<TipoPolizaAlumno32Controller> logger,
            Alumno32Context context
            , ITipoPolizaService<Alumno32Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa32")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa32")]
