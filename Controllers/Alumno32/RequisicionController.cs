...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno32Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno32Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno32Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno32Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno32Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno32Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno32Controller(
            ILogger<RequisicionAlumno32Controller> Logger
            , Alumno32Context Context
            , IRequisicionService<Alumno32Context> RequisicionService
            , RequisicionProceso<Alumno32Context> Proceso
            , ObjetoRequisicionProceso<Alumno32Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno32Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/32/970"))
            {
