...
{
    [Route("api/reportesdestajo/32")]
    [ApiController]
    public class ReporteDestajoAlumno32Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno32Context> _proceso;
        private readonly EstimacionesProceso<Alumno32Context> _estimacionesProceso;

        public ReporteDestajoAlumno32Controller(
            ReporteDestajoProceso<Alumno32Context> proceso,
            EstimacionesProceso<Alumno32Context> estimacionesProceso
            ) { 
            _proceso = proceso;
