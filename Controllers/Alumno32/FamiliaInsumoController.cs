...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa32")]
    public class FamiliaInsumoAlumno32Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno32Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno32Controller(
            FamiliaInsumoProceso<Alumno32Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa32")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa32")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa32")]
