...
{
    [Route("api/insumoxordencompra/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno32Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno32Context> _Service;
        private readonly OrdenCompraProceso<Alumno32Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno32Controller> _Logger;
        private readonly Alumno32Context _Context;
        public InsumoXOrdenCompraAlumno32Controller(
            ILogger<InsumoXOrdenCompraAlumno32Controller> Logger,
            Alumno32Context Context
            , IInsumoXOrdenCompraService<Alumno32Context> Service
