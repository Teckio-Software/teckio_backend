...
{
    [Route("api/indirectosXConcepto/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoAlumno32Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno32Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno32Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno32Controller(
            IIndirectosXConceptoService<Alumno32Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno32Context> indirectosXConceptoProceso
            ) { 
