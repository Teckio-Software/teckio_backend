...
{
    [Route("api/programacionestimada/32")]
    [ApiController]
    public class ProgramacionEstimadaAlumno32Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno32Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno32Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno32Context> _PrecioUnitarioService;


        public ProgramacionEstimadaAlumno32Controller(
            ProgramacionEstimadaProceso<Alumno32Context> programacionEstimadaProceso,
            IProyectoService<Alumno32Context> proyectoProceso,
            IPrecioUnitarioService<Alumno32Context> precioUnitarioService,
