...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno32Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno32Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno32Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno32Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno32Controller> Logger;
        ...
        public AlmacenSalidaAlumno32Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno32Controller> logger,
            Alumno32Context context
            , IAlmacenSalidaService<Alumno32Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno32Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno32Context> Proceso
            )
        {
