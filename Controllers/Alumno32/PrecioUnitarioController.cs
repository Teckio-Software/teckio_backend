...
{
    [Route("api/preciounitario/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno32Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno32Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno32Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno32Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno32Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno32Controller(
            PrecioUnitarioProceso<Alumno32Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno32Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno32Context> options,
            ExplocionInsumosProceso<Alumno32Context> explocionInsumosProceso
            )
        {
