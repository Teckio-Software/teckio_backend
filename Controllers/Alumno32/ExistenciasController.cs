...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno32Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno32Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno32Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno32Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno32Controller(
            ILogger<ExistenciasAlumno32Controller> Logger,
            Alumno32Context Context
            , IAlmacenExistenciaInsumoService<Alumno32Context> ExistenciaService
            , ExistenciasProceso<Alumno32Context> Proceso
            )
        {
            _Logger = Logger;
