...
{
    [Route("api/cliente/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno32Controller : ControllerBase
    {
        private readonly IClientesService<Alumno32Context> _Service;

        private readonly ClienteProceso<Alumno32Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno32Context> _clientesCuentasContablesProceso;
        public ClienteAlumno32Controller(
            IClientesService<Alumno32Context> service
            , ClienteProceso<Alumno32Context> proceso,
            ClienteCuentasContablesProceso<Alumno32Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
