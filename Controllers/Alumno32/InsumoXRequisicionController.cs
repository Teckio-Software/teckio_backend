...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno32Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno32Context> _Service;

        private readonly RequisicionProceso<Alumno32Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno32Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno32Controller(
            ILogger<InsumoXRequisicionAlumno32Controller> Logger,
            RequisicionProceso<Alumno32Context> Proceso,
            Alumno32Context Context
            , IInsumoXRequisicionService<Alumno32Context> Service)
        {
            _Logger = Logger;
