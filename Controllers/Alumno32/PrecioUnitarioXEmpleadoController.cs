...
{
    [Route("api/precioUnitarioXEmpleado/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoAlumno32Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno32Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno32Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno32Controller(
            IPrecioUnitarioXEmpleadoService<Alumno32Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno32Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
