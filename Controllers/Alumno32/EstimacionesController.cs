...
namespace ERP_TECKIO.API.Alumno032Controllers.Procomi
{
    [Route("api/estimaciones/32")]
    [ApiController]
    public class EstimacionesAlumno32Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno32Context> _estimacionesProceso;
        public EstimacionesAlumno32Controller(
