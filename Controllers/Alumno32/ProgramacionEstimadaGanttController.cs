...
namespace SistemaERP.API.Controllers.Alumno32
{
    [Route("api/programacionestimadaGantt/32")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno32Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno32Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno32Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno32Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno32Controller(
            ProgramacionEstimadaGanttProceso<Alumno32Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno32Context> importeSemanalGanttProceso,
