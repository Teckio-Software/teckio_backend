...
{
    [Route("api/empleado/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoAlumno32Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno32Context> _empleadoService;
        public EmpleadoAlumno32Controller(
            IEmpleadoService<Alumno32Context> empleadoService
            )
        {
