...
{
    [Route("api/ordencompra/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno32Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno32Context> _Service;
        private readonly OrdenCompraProceso<Alumno32Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno32Controller> _Logger;
        private readonly Alumno32Context Context;
        private readonly PolizaProceso<Alumno32Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno32Context> _obtenFacturaProceso;

        public OrdenCompraAlumno32Controller(
            ILogger<OrdenCompraAlumno32Controller> Logger
            , Alumno32Context Context
            , IOrdenCompraService<Alumno32Context> Service
            , OrdenCompraProceso<Alumno32Context> Proceso
            , PolizaProceso<Alumno32Context> polizaProceso
            , ObtenFacturaProceso<Alumno32Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
