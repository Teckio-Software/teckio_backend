...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno32Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno32Context> _almacenServicio;

        public AlmacenAlumno32Controller(
            IAlmacenService<Alumno32Context> almacenServicio)
        {
