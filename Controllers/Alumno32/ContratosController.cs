...
{
    [Route("api/contratos/32")]
    [ApiController]
    public class ContratosAlumno32Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno32Context> _contratosProceso;
        public ContratosAlumno32Controller(
            ContratosProceso<Alumno32Context> contratosProceso
            )
        {
