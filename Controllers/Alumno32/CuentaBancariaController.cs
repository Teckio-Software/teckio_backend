...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/32")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno32Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno32Context> _proceso;

        private readonly ICuentaBancariaService<Alumno32Context> _servicio;
        public CuentaBancariaAlumno32Controller(CuentaBancariaProceso<Alumno32Context> _proceso, ICuentaBancariaService<Alumno32Context> _servicio
           )
        {
