...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/32")]
    [ApiController]
    public class MovimientoBancarioAlumno32Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno32Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno32Controller(
            MovimientoBancarioProceso<Alumno32Context> movimientoBancarioProceso
            )
        {
