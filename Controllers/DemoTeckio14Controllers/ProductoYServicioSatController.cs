...
namespace ERP_TECKIO.Controllers.DemoTeckioAL14
{
    ...
    {
        private readonly IProductoYServicioSatService<DemoTeckioAL14Context> _service;

        public ProductoYServicioSatController(IProductoYServicioSatService<DemoTeckioAL14Context> service)
        {
            _service = service;
        }
