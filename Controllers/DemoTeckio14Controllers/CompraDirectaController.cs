...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL14Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL14Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL14Controller(
            ILogger<CompraDirectaDemoTeckioAL14Controller> logger,
            DemoTeckioAL14Context context
            , ICompraDirectaService<DemoTeckioAL14Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
