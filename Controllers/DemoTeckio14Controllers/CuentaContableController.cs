...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL14Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL14Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL14Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL14Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL14Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL14Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL14Controller(
            ILogger<CuentaContableDemoTeckioAL14Controller> logger,
            DemoTeckioAL14Context context
            , ICuentaContableService<DemoTeckioAL14Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL14Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL14Context> RubroService
            , CuentaContableProceso<DemoTeckioAL14Context> proceso
            )
        {
            Logger = logger;
            Context = context;
