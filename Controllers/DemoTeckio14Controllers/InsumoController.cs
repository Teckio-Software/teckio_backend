...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL14Context> _InsumoProceso;
        public InsumoDemoTeckioAL14Controller(
            InsumoProceso<DemoTeckioAL14Context> insumoProceso)
        {
