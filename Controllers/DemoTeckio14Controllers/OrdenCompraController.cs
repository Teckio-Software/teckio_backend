...
{
    [Route("api/ordencompra/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL14Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL14Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL14Controller> _Logger;
        private readonly DemoTeckioAL14Context Context;
        private readonly PolizaProceso<DemoTeckioAL14Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL14Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL14Controller(
            ILogger<OrdenCompraDemoTeckioAL14Controller> Logger
            , DemoTeckioAL14Context Context
            , IOrdenCompraService<DemoTeckioAL14Context> Service
            , OrdenCompraProceso<DemoTeckioAL14Context> Proceso
            , PolizaProceso<DemoTeckioAL14Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL14Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
