...
{
    [Route("api/contratos/14")]
    [ApiController]
    public class ContratosDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL14Context> _contratosProceso;
        public ContratosDemoTeckioAL14Controller(
            ContratosProceso<DemoTeckioAL14Context> contratosProceso
            )
        {
