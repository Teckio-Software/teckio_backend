...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL14Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL14Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL14Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL14Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL14Controller> logger,
            DemoTeckioAL14Context context
            , IAlmacenSalidaService<DemoTeckioAL14Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL14Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL14Context> Proceso
            )
        {
