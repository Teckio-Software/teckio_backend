...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL14Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL14Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL14Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL14Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL14Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL14Controller> _Logger;
        private readonly DemoTeckioAL14Context _Context;
        private readonly PolizaProceso<DemoTeckioAL14Context> _polizaProceso;
        public PolizaDemoTeckioAL14Controller(
            ILogger<PolizaDemoTeckioAL14Controller> logger
            , DemoTeckioAL14Context context
            , IPolizaService<DemoTeckioAL14Context> service
            , IPolizaDetalleService<DemoTeckioAL14Context> detalleService
            , ITipoPolizaService<DemoTeckioAL14Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL14Context> saldosService
            , ICuentaContableService<DemoTeckioAL14Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL14Context> polizaProceso
            )
        {
