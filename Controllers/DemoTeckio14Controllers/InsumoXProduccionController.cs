...
namespace ERP_TECKIO.Controllers.DemoTeckioAL14
{
    ...
    [Route("api/insumoXproduccion/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL14Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL14Context> proces)
        {
            _proceso = proces;
        }
