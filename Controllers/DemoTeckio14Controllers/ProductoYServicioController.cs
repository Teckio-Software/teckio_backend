...
{
    [Route("api/productoyservicio/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL14Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL14Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL14Context> _process;

        public ProductoYServicioDemoTeckioAL14Controller(IProductoYservicioService<DemoTeckioAL14Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL14Context> process
            )
        {
