...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL14Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL14Controller(
            TipoInsumoProceso<DemoTeckioAL14Context> tipoInsumoProceso
            )
        {
