...
namespace ERP_TECKIO.Controllers.DemoTeckioAL14
{
    ...
    [Route("api/existenciaproductoalmacen/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL14Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL14Context> proces)
        {
            _proceso = proces;
        }
