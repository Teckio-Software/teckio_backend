...
{
    [Route("api/indirectosXConcepto/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL14Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL14Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL14Controller(
            IIndirectosXConceptoService<DemoTeckioAL14Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL14Context> indirectosXConceptoProceso
            ) { 
