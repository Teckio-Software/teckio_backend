...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL14Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL14Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL14Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL14Context> cuentaBancariaEmpresaService,
