...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL14Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL14Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL14Context> _indirectosProceso;

        public IndirectosDemoTeckioAL14Controller(
                        IConjuntoIndirectosService<DemoTeckioAL14Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL14Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL14Context> indirectosProceso
            )
        {
