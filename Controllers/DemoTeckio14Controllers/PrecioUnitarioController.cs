...
{
    [Route("api/preciounitario/14")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL14Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL14Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL14Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL14Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL14Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL14Controller(
            PrecioUnitarioProceso<DemoTeckioAL14Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL14Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL14Context> options,
            ExplocionInsumosProceso<DemoTeckioAL14Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL14Context(_Options.Options))
            {
