...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL14Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL14Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL14Controller(
            ReporteDestajoProceso<DemoTeckioAL14Context> proceso,
            EstimacionesProceso<DemoTeckioAL14Context> estimacionesProceso
            ) { 
            _proceso = proceso;
