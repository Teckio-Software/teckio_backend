...
namespace ERP_TECKIO.Controllers.DemoTeckioAL14
{
    ...
    [Route("api/categoriaProductoServicio/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CategoriaProductoYServicioController: ControllerBase
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL14Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL14Context> service)
        {
            _service = service;
        }
