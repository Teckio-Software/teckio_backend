...
{
    [Route("api/cliente/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL14Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL14Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL14Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL14Controller(
            IClientesService<DemoTeckioAL14Context> service
            , ClienteProceso<DemoTeckioAL14Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL14Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
