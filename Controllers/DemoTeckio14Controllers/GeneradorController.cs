...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL14Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL14Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL14Controller(
            GeneradoresProceso<DemoTeckioAL14Context> generadoresProceso)
        {
