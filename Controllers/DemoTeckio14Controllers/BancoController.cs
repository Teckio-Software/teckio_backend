...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL14Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL14Context> _bancoService;

        public BancoDemoTeckioAL14Controller(IBancoService<DemoTeckioAL14Context> bancoService)
        {
