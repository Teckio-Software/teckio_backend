...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL14Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL14Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL14Controller> _Logger;
        private readonly DemoTeckioAL14Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL14Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL14Controller> logger
            , DemoTeckioAL14Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL14Context> service
