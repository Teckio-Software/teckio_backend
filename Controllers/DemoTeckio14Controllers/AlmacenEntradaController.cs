...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL14Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL14Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL14Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL14Controller(
            ILogger<AlmacenEntradaDemoTeckioAL14Controller> logger,
            DemoTeckioAL14Context context
            , IAlmacenEntradaService<DemoTeckioAL14Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL14Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL14Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
