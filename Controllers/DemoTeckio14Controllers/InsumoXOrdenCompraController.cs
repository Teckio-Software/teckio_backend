...
{
    [Route("api/insumoxordencompra/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL14Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL14Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL14Controller> _Logger;
        private readonly DemoTeckioAL14Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL14Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL14Controller> Logger,
            DemoTeckioAL14Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL14Context> Service
