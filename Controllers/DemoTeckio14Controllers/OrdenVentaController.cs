...
{
    [Route("api/ordenventa/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL14Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL14Controller(
            OrdenVentaProceso<DemoTeckioAL14Context> ordenVentaProceso
            ) { 
