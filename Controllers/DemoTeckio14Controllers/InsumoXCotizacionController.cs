...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL14Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL14Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL14Context> _Proceso;
        private readonly DemoTeckioAL14Context Context;
        public InsumoXCotizacionDemoTeckioAL14Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL14Controller> Logger,
            DemoTeckioAL14Context Context
            , IInsumoXCotizacionService<DemoTeckioAL14Context> Service
