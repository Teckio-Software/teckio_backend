...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/14")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL14Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL14Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL14Controller(
            MovimientoBancarioProceso<DemoTeckioAL14Context> movimientoBancarioProceso
            )
        {
