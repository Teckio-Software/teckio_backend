...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL14Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL14Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL14Controller(
            ILogger<ExistenciasDemoTeckioAL14Controller> Logger,
            DemoTeckioAL14Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL14Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL14Context> Proceso
            )
        {
            _Logger = Logger;
