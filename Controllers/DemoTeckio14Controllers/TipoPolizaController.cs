...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL14Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL14Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL14Controller(
            ILogger<TipoPolizaDemoTeckioAL14Controller> logger,
            DemoTeckioAL14Context context
            , ITipoPolizaService<DemoTeckioAL14Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
