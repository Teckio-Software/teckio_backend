...
namespace SistemaERP.API.DemoTeckioAL14Controllers.Procomi
{
    [Route("api/preciounitariodetalle/14")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL14Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL14Controller(
