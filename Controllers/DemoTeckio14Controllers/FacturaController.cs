...
{
    [Route("api/factura/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL14Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL14Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL14Controller(
            ObtenFacturaProceso<DemoTeckioAL14Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL14Context> categoriaProductoYServicioService
            )
        {
