...
namespace SistemaERP.API.Controllers.DemoTeckioAL14
{
    [Route("api/programacionestimadaGantt/14")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL14Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL14Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL14Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL14Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL14Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL14Context> importeSemanalGanttProceso,
