...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL14Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL14Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL14Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL14Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL14Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL14Controller(
            ILogger<RequisicionDemoTeckioAL14Controller> Logger
            , DemoTeckioAL14Context Context
            , IRequisicionService<DemoTeckioAL14Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL14Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL14Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL14Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/14/1470"))
            {
