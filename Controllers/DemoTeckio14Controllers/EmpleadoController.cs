...
{
    [Route("api/empleado/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL14Context> _empleadoService;
        public EmpleadoDemoTeckioAL14Controller(
            IEmpleadoService<DemoTeckioAL14Context> empleadoService
            )
        {
