...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL14Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL14Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL14Controller(
            EspecialidadProceso<DemoTeckioAL14Context> especialidadProceso)
        {
