...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/14")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL14Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL14Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL14Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL14Controller(
            ILogger<ContratistaDemoTeckioAL14Controller> logger,
            DemoTeckioAL14Context context
            , IContratistaService<DemoTeckioAL14Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL14Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
