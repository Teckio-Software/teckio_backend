...
namespace ERP_TECKIO.Controllers.DemoTeckioAL14
{
    ...
    [Route("api/produccion/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL14Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL14Context> proceso)
        {
            _proceso = proceso;
        }
