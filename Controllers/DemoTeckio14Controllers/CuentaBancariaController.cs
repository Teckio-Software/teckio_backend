...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL14Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL14Context> _servicio;
        public CuentaBancariaDemoTeckioAL14Controller(CuentaBancariaProceso<DemoTeckioAL14Context> _proceso, ICuentaBancariaService<DemoTeckioAL14Context> _servicio
           )
        {
