...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL14Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL14Controller(
            FamiliaInsumoProceso<DemoTeckioAL14Context> familiaInsumoProceso)
        {
