...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL14Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL14Controller(
            ProyectoProceso<DemoTeckioAL14Context> proyectoProceso)
        {
