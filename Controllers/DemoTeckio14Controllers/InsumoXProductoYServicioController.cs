...
namespace ERP_TECKIO.Controllers.DemoTeckioAL14
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/14")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL14Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL14Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL14Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL14Context> process)
        {
            _service = service;
            _process = process;
        }
