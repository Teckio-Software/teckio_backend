...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL14Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL14Controller> Logger;
        ...
        public RubroDemoTeckioAL14Controller(
            ILogger<RubroDemoTeckioAL14Controller> logger,
            DemoTeckioAL14Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL14Context> service
            )
        {
            //_Service = service;
            Logger = logger;
