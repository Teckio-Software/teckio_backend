...
namespace ERP_TECKIO.Controllers.DemoTeckioAL14
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL14Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL14Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL14Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL14Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL14Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL14Context> porcentajeCesantiaEdadService
            )
        {
