...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL14Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL14Controller(
            ConceptoProceso<DemoTeckioAL14Context> conceptoProceso)
        {
