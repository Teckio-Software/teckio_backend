...
{
    [Route("api/programacionestimada/14")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL14Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL14Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL14Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL14Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL14Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL14Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL14Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL14Context> precioUnitarioService,
