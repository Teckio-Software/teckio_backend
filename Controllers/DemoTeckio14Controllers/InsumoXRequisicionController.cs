...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL14Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL14Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL14Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL14Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL14Controller> Logger,
            RequisicionProceso<DemoTeckioAL14Context> Proceso,
            DemoTeckioAL14Context Context
            , IInsumoXRequisicionService<DemoTeckioAL14Context> Service)
        {
            _Logger = Logger;
