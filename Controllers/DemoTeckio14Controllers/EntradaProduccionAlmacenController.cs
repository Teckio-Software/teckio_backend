...
{
    [Route("api/entradaproduccionalmacen/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL14Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL14Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL14Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL14Context> proceso)
        {
            _proceso = proceso;
        }
