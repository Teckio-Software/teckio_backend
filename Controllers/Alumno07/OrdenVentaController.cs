...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    public class OrdenVentaAlumno07Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno07Context> _ordenVentaProceso;
        public OrdenVentaAlumno07Controller(
            OrdenVentaProceso<Alumno07Context> ordenVentaProceso
            ) { 
