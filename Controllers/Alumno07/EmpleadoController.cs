...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno07Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno07Context> _empleadoService;
        public EmpleadoAlumno07Controller(
            IEmpleadoService<Alumno07Context> empleadoService
            )
        {
