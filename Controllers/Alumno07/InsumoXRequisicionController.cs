...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno07Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno07Context> _Service;

        private readonly RequisicionProceso<Alumno07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno07Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno07Controller(
            ILogger<InsumoXRequisicionAlumno07Controller> Logger,
            RequisicionProceso<Alumno07Context> Proceso,
            Alumno07Context Context
            , IInsumoXRequisicionService<Alumno07Context> Service)
        {
            _Logger = Logger;
