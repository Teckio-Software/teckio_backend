...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    public class FacturaAlumno07Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno07Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno07Context> _categoriaProductoYServicioService;
        public FacturaAlumno07Controller(
            ObtenFacturaProceso<Alumno07Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno07Context> categoriaProductoYServicioService
            )
        {
