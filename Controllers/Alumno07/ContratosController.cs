...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno07Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno07Context> _contratosProceso;
        public ContratosAlumno07Controller(
            ContratosProceso<Alumno07Context> contratosProceso
            )
        {
