...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno07Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno07Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno07Controller> Logger;
        /// <summary>
