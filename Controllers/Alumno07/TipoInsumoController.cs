...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa7")]
    public class TipoInsumoAlumno07Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno07Context> _TipoInsumoProceso;

        public TipoInsumoAlumno07Controller(
            TipoInsumoProceso<Alumno07Context> tipoInsumoProceso
            )
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoInsumo-Empresa7")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoInsumo-Empresa7")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarTipoInsumo-Empresa7")]
