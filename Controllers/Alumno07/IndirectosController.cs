...
{
    [Route("api/indirectos/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno07Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno07Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno07Context> _indirectosService;
        private readonly IndirectosProceso<Alumno07Context> _indirectosProceso;

        public IndirectosAlumno07Controller(
                        IConjuntoIndirectosService<Alumno07Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno07Context> indirectosService,
                        IndirectosProceso<Alumno07Context> indirectosProceso
            )
        {
