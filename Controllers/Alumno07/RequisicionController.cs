...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno07Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno07Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno07Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno07Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno07Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno07Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno07Controller(
            ILogger<RequisicionAlumno07Controller> Logger
            , Alumno07Context Context
            , IRequisicionService<Alumno07Context> RequisicionService
            , RequisicionProceso<Alumno07Context> Proceso
            , ObjetoRequisicionProceso<Alumno07Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno07Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
