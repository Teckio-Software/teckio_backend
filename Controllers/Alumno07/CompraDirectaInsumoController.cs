...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa7")]
    public class CompraDirectaInsumoAlumno07Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno07Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno07Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno07Controller(
            ILogger<CompraDirectaInsumoAlumno07Controller> logger
            , Alumno07Context context
            , IInsumoXCompraDirectaService<Alumno07Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
