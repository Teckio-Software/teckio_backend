...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno07Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno07Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno07Context> service, InsumoXProductoYServicioProceso<Alumno07Context> process)
        {
            _service = service;
            _process = process;
        }
