...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno07Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno07Context> _almacenServicio;

        public AlmacenAlumno07Controller(
            IAlmacenService<Alumno07Context> almacenServicio)
        {
