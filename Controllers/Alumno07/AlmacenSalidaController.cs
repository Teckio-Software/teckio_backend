...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno07Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno07Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno07Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno07Controller> Logger;
        ...
        public AlmacenSalidaAlumno07Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno07Controller> logger,
            Alumno07Context context
            , IAlmacenSalidaService<Alumno07Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno07Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno07Context> Proceso
            )
        {
