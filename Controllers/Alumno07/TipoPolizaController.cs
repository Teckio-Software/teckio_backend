...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/tipopoliza/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa7")]
    public class TipoPolizaAlumno07Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno07Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno07Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno07Controller(
            ILogger<TipoPolizaAlumno07Controller> logger,
            Alumno07Context context
            , ITipoPolizaService<Alumno07Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa7")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa7")]
