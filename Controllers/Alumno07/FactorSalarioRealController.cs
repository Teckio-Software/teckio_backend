...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno07Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno07Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno07Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno07Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno07Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno07Context> porcentajeCesantiaEdadService
            )
        {
