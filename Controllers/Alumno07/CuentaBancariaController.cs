...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno07Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno07Context> _proceso;

        private readonly ICuentaBancariaService<Alumno07Context> _servicio;
        public CuentaBancariaAlumno07Controller(CuentaBancariaProceso<Alumno07Context> _proceso, ICuentaBancariaService<Alumno07Context> _servicio
           )
        {
