...
{
    [Route("api/saldosbalanzacomprobacion/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa7")]
    public class SaldosBalanzaComprobacionAlumno07Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno07Context> _Service;
        private readonly ICuentaContableService<Alumno07Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno07Controller> _Logger;
        private readonly Alumno07Context _Context;
        public SaldosBalanzaComprobacionAlumno07Controller(
            ILogger<SaldosBalanzaComprobacionAlumno07Controller> logger
            , Alumno07Context context
            , ISaldosBalanzaComprobacionService<Alumno07Context> service
