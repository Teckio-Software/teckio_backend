...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno07Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno07Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno07Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno07Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno07Controller(
            ILogger<AlmacenEntradaInsumoAlumno07Controller> logger,
            Alumno07Context context
            , IInsumoXAlmacenEntradaService<Alumno07Context> AlmacenEntradaDetalle
