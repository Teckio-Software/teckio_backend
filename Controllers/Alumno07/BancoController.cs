...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno07Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno07Context> _bancoService;

        public BancoAlumno07Controller(IBancoService<Alumno07Context> bancoService)
        {
