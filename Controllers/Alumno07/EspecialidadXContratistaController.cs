...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa7")]
    public class EspecialIdadXContratistaAlumno07Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno07Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno07Controller(
            ILogger<EspecialIdadXContratistaAlumno07Controller> logger,
