...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionAlumno07Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno07Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno07Controller> _Logger;
        private readonly CotizacionProceso<Alumno07Context> _Proceso;
        private readonly Alumno07Context Context;
        public InsumoXCotizacionAlumno07Controller(
            ILogger<InsumoXCotizacionAlumno07Controller> Logger,
            Alumno07Context Context
            , IInsumoXCotizacionService<Alumno07Context> Service
