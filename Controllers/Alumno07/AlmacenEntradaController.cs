...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno07Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno07Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno07Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno07Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno07Controller(
            ILogger<AlmacenEntradaAlumno07Controller> logger,
            Alumno07Context context
            , IAlmacenEntradaService<Alumno07Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno07Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno07Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
