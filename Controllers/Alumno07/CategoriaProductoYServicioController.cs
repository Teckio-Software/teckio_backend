...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno07Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno07Context> service)
        {
            _service = service;
        }
