...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno07Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno07Context> proces)
        {
            _proceso = proces;
        }
