...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno07Controller : ControllerBase
    {
        private readonly IClientesService<Alumno07Context> _Service;

        private readonly ClienteProceso<Alumno07Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno07Context> _clientesCuentasContablesProceso;
        public ClienteAlumno07Controller(
            IClientesService<Alumno07Context> service
            , ClienteProceso<Alumno07Context> proceso,
            ClienteCuentasContablesProceso<Alumno07Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
