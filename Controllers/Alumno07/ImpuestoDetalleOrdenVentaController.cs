...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno07Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno07Context> process)
        {
            _process = process;
        }
