...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/proyecto/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa7")]
    public class ProyectoAlumno07Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno07Context> _ProyectoProceso;
        public ProyectoAlumno07Controller(
            ProyectoProceso<Alumno07Context> proyectoProceso)
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearProyecto-Empresa7")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarProyecto-Empresa7")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarProyecto-Empresa7")]
