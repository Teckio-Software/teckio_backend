...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno07Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno07Context> _Service;
        private readonly OrdenCompraProceso<Alumno07Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno07Controller> _Logger;
        private readonly Alumno07Context _Context;
        public InsumoXOrdenCompraAlumno07Controller(
            ILogger<InsumoXOrdenCompraAlumno07Controller> Logger,
            Alumno07Context Context
            , IInsumoXOrdenCompraService<Alumno07Context> Service
