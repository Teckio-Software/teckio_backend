...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/rubro/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionRubro-Empresa7")]
    public class RubroAlumno07Controller : ControllerBase
    {
        private readonly IRubroService<Alumno07Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno07Controller> Logger;
        ...
        public RubroAlumno07Controller(
            ILogger<RubroAlumno07Controller> logger,
            Alumno07Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno07Context> service
            )
        {
            //_Service = service;
            Logger = logger;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearRubro-Empresa7")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarRubro-Empresa7")]
