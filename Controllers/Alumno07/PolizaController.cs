...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaAlumno07Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno07Context> _Service;
        private readonly IPolizaDetalleService<Alumno07Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno07Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno07Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno07Context> _SaldosService;
        private readonly ILogger<PolizaAlumno07Controller> _Logger;
        private readonly Alumno07Context _Context;
        public PolizaAlumno07Controller(
            ILogger<PolizaAlumno07Controller> logger
            , Alumno07Context context
            , IPolizaService<Alumno07Context> service
            , IPolizaDetalleService<Alumno07Context> detalleService
            , ITipoPolizaService<Alumno07Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno07Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa7")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa7")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa7")]
