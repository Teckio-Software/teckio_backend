...
namespace ERP_TECKIO.Controllers.Alumno07
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno07Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno07Context> service)
        {
            _service = service;
        }
