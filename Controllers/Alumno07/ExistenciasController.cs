...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno07Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno07Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno07Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno07Controller(
            ILogger<ExistenciasAlumno07Controller> Logger,
            Alumno07Context Context
            , IAlmacenExistenciaInsumoService<Alumno07Context> ExistenciaService
            , ExistenciasProceso<Alumno07Context> Proceso
            )
        {
            _Logger = Logger;
