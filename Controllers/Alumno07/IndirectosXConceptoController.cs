...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoAlumno07Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno07Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno07Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno07Controller(
            IIndirectosXConceptoService<Alumno07Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno07Context> indirectosXConceptoProceso
            ) { 
