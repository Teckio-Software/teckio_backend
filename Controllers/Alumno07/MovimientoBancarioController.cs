...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno07Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno07Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno07Controller(
            MovimientoBancarioProceso<Alumno07Context> movimientoBancarioProceso
            )
        {
