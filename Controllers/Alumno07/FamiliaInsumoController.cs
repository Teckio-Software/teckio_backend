...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/familiainsumo/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa7")]
    public class FamiliaInsumoAlumno07Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno07Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno07Controller(
            FamiliaInsumoProceso<Alumno07Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa7")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa7")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa7")]
