...
namespace ERP_TECKIO.API.Controllers.Alumno16
{
    ...
    public class IndirectosXConceptoAlumno16Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno16Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno16Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno16Controller(
            IIndirectosXConceptoService<Alumno16Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno16Context> indirectosXConceptoProceso
            ) { 
