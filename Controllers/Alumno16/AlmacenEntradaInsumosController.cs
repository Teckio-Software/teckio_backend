...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno16Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno16Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno16Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno16Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno16Controller(
            ILogger<AlmacenEntradaInsumoAlumno16Controller> logger,
            Alumno16Context context
            , IInsumoXAlmacenEntradaService<Alumno16Context> AlmacenEntradaDetalle
