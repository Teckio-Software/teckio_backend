...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno16Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno16Context> process)
        {
            _process = process;
        }
