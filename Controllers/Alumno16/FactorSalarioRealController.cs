...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno16Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno16Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno16Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno16Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno16Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno16Context> porcentajeCesantiaEdadService
            )
        {
