...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno16Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno16Context> service)
        {
            _service = service;
        }
