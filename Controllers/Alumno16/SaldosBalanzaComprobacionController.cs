...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionAlumno16Controller : ControllerBase
    {
        ...
        private readonly ILogger<SaldosBalanzaComprobacionAlumno16Controller> _Logger;
        private readonly Alumno16Context _Context;
        public SaldosBalanzaComprobacionAlumno16Controller(
            ILogger<SaldosBalanzaComprobacionAlumno16Controller> logger
            , Alumno16Context context
            , ISaldosBalanzaComprobacionService<Alumno16Context> service
