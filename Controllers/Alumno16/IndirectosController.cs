...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosAlumno16Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno16Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno16Context> _indirectosService;
        private readonly IndirectosProceso<Alumno16Context> _indirectosProceso;

        public IndirectosAlumno16Controller(
                        IConjuntoIndirectosService<Alumno16Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno16Context> indirectosService,
                        IndirectosProceso<Alumno16Context> indirectosProceso
            )
        {
