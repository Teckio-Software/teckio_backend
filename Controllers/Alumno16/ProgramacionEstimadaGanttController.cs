...
namespace SistemaERP.API.Controllers.Alumno16
{
    [Route("api/programacionestimadaGantt/16")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno16Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno16Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno16Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno16Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno16Controller(
            ProgramacionEstimadaGanttProceso<Alumno16Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno16Context> importeSemanalGanttProceso,
