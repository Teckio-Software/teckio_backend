...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno16Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno16Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno16Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno16Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno16Controller> Logger;
        ...
        public AlmacenSalidaAlumno16Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno16Controller> logger,
            Alumno16Context context
            , IAlmacenSalidaService<Alumno16Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno16Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno16Context> Proceso
            )
        {
