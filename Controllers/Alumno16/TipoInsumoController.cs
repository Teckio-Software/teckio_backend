...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa16")]
    public class TipoInsumoAlumno16Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno16Context> _TipoInsumoProceso;

        public TipoInsumoAlumno16Controller(
            TipoInsumoProceso<Alumno16Context> tipoInsumoProceso
            )
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoInsumo-Empresa16")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoInsumo-Empresa16")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarTipoInsumo-Empresa16")]
