...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno16Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno16Context> _Service;
        private readonly OrdenCompraProceso<Alumno16Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno16Controller> _Logger;
        private readonly Alumno16Context _Context;
        public InsumoXOrdenCompraAlumno16Controller(
            ILogger<InsumoXOrdenCompraAlumno16Controller> Logger,
            Alumno16Context Context
            , IInsumoXOrdenCompraService<Alumno16Context> Service
