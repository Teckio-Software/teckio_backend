...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno16Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno16Context> _bancoService;

        public BancoAlumno16Controller(IBancoService<Alumno16Context> bancoService)
        {
