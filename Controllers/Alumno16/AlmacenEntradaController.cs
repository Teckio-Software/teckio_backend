...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno16Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno16Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno16Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno16Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno16Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno16Controller(
            ILogger<AlmacenEntradaAlumno16Controller> logger,
            Alumno16Context context
            , IAlmacenEntradaService<Alumno16Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno16Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno16Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
