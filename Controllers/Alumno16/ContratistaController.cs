...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno16Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno16Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno16Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno16Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno16Controller(
            ILogger<ContratistaAlumno16Controller> logger,
            Alumno16Context context
            , IContratistaService<Alumno16Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno16Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
