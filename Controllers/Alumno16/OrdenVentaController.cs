...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    public class OrdenVentaAlumno16Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno16Context> _ordenVentaProceso;
        public OrdenVentaAlumno16Controller(
            OrdenVentaProceso<Alumno16Context> ordenVentaProceso
            ) { 
