...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno16Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno16Context> _proceso;

        private readonly ICuentaBancariaService<Alumno16Context> _servicio;
        public CuentaBancariaAlumno16Controller(CuentaBancariaProceso<Alumno16Context> _proceso, ICuentaBancariaService<Alumno16Context> _servicio
           )
        {
