...
namespace ERP_TECKIO.API.Controllers.Alumno16
{
    ...
    [ApiController]
    public class ContratosAlumno16Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno16Context> _contratosProceso;
        public ContratosAlumno16Controller(
            ContratosProceso<Alumno16Context> contratosProceso
            )
        {
