...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    public class ProductoYServicioAlumno16Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno16Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno16Context> _process;

        public ProductoYServicioAlumno16Controller(IProductoYservicioService<Alumno16Context> productoYServicioService,
            ProductoYServicioProceso<Alumno16Context> process
            )
        {
