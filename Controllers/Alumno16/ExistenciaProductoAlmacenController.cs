...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno16Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno16Context> proces)
        {
            _proceso = proces;
        }
