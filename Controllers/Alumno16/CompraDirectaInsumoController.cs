...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa16")]
    public class CompraDirectaInsumoAlumno16Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno16Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno16Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno16Controller(
            ILogger<CompraDirectaInsumoAlumno16Controller> logger
            , Alumno16Context context
            , IInsumoXCompraDirectaService<Alumno16Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
