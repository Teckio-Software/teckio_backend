...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno16Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno16Context> _Service;

        private readonly RequisicionProceso<Alumno16Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno16Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno16Controller(
            ILogger<InsumoXRequisicionAlumno16Controller> Logger,
            RequisicionProceso<Alumno16Context> Proceso,
            Alumno16Context Context
            , IInsumoXRequisicionService<Alumno16Context> Service)
        {
            _Logger = Logger;
