...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno16Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno16Context> _Service;
        private readonly CotizacionProceso<Alumno16Context> _Proceso;
        private readonly IOrdenCompraService<Alumno16Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno16Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno16Controller> _Logger;
        private readonly Alumno16Context Context;
        public CotizacionAlumno16Controller(

            ILogger<CotizacionAlumno16Controller> Logger
            , Alumno16Context Context
            , ICotizacionService<Alumno16Context> Service
            , IOrdenCompraService<Alumno16Context> OrdenCompraService,
              ITipoImpuestoService<Alumno16Context> TipoImpuestoService
            , CotizacionProceso<Alumno16Context> Proceso)
        {
            _Logger = Logger;
