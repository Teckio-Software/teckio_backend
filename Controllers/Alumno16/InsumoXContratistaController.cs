...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa16")]
    public class InsumoXContratistaAlumno16Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno16Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno16Controller(
            ILogger<InsumoXContratistaAlumno16Controller> logger,
