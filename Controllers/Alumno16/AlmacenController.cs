...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno16Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno16Context> _almacenServicio;

        public AlmacenAlumno16Controller(
            IAlmacenService<Alumno16Context> almacenServicio)
        {
