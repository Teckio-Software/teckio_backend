...
{
    [Route("api/reportesdestajo/16")]
    [ApiController]
    public class ReporteDestajoAlumno16Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno16Context> _proceso;
        private readonly EstimacionesProceso<Alumno16Context> _estimacionesProceso;

        public ReporteDestajoAlumno16Controller(
            ReporteDestajoProceso<Alumno16Context> proceso,
            EstimacionesProceso<Alumno16Context> estimacionesProceso
            ) { 
            _proceso = proceso;
