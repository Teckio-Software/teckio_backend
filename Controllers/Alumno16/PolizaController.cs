...
namespace ERP_TECKIO
{
    [Route("api/poliza/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa16")]
    public class PolizaAlumno16Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno16Context> _Service;
        private readonly IPolizaDetalleService<Alumno16Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno16Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno16Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno16Context> _SaldosService;
        private readonly ILogger<PolizaAlumno16Controller> _Logger;
        private readonly Alumno16Context _Context;
        public PolizaAlumno16Controller(
            ILogger<PolizaAlumno16Controller> logger
            , Alumno16Context context
            , IPolizaService<Alumno16Context> service
            , IPolizaDetalleService<Alumno16Context> detalleService
            , ITipoPolizaService<Alumno16Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno16Context> saldosService
            , ICuentaContableService<Alumno16Context> cuentaContableService
            )
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa16")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa16")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa16")]
