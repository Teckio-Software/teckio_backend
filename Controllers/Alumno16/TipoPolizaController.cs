...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa16")]
    public class TipoPolizaAlumno16Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno16Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno16Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno16Controller(
            ILogger<TipoPolizaAlumno16Controller> logger,
            Alumno16Context context
            , ITipoPolizaService<Alumno16Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa16")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa16")]
