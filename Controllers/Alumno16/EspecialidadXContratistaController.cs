...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa16")]
    public class EspecialIdadXContratistaAlumno16Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno16Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno16Controller(
            ILogger<EspecialIdadXContratistaAlumno16Controller> logger,
