...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno16Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno16Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno16Context> service, InsumoXProductoYServicioProceso<Alumno16Context> process)
        {
            _service = service;
            _process = process;
        }
