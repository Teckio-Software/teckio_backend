...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno16Controller : ControllerBase
    {
        private readonly IClientesService<Alumno16Context> _Service;

        private readonly ClienteProceso<Alumno16Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno16Context> _clientesCuentasContablesProceso;
        public ClienteAlumno16Controller(
            IClientesService<Alumno16Context> service
            , ClienteProceso<Alumno16Context> proceso,
            ClienteCuentasContablesProceso<Alumno16Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
