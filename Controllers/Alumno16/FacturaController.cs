...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    public class FacturaAlumno16Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno16Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno16Context> _categoriaProductoYServicioService;
        public FacturaAlumno16Controller(
            ObtenFacturaProceso<Alumno16Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno16Context> categoriaProductoYServicioService
            )
        {
