...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno16Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno16Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno16Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno16Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno16Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno16Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno16Controller(
            ILogger<RequisicionAlumno16Controller> Logger
            , Alumno16Context Context
            , IRequisicionService<Alumno16Context> RequisicionService
            , RequisicionProceso<Alumno16Context> Proceso
            , ObjetoRequisicionProceso<Alumno16Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno16Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
