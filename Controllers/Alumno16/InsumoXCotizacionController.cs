...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno16Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno16Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno16Controller> _Logger;
        private readonly CotizacionProceso<Alumno16Context> _Proceso;
        private readonly Alumno16Context Context;
        public InsumoXCotizacionAlumno16Controller(
            ILogger<InsumoXCotizacionAlumno16Controller> Logger,
            Alumno16Context Context
            , IInsumoXCotizacionService<Alumno16Context> Service
