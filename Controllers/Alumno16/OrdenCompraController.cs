...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno16Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno16Context> _Service;
        private readonly OrdenCompraProceso<Alumno16Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno16Controller> _Logger;
        private readonly Alumno16Context Context;
        private readonly PolizaProceso<Alumno16Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno16Context> _obtenFacturaProceso;

        public OrdenCompraAlumno16Controller(
            ILogger<OrdenCompraAlumno16Controller> Logger
            , Alumno16Context Context
            , IOrdenCompraService<Alumno16Context> Service
            , OrdenCompraProceso<Alumno16Context> Proceso
            , PolizaProceso<Alumno16Context> polizaProceso
            , ObtenFacturaProceso<Alumno16Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
