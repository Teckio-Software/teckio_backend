...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno16Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno16Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno16Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno16Controller(
            IPrecioUnitarioXEmpleadoService<Alumno16Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno16Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
