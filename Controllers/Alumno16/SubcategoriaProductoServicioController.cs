...
namespace ERP_TECKIO.Controllers.Alumno16
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno16Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno16Context> service)
        {
            _service = service;
        }
