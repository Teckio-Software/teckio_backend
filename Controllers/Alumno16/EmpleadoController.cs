...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno16Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno16Context> _empleadoService;
        public EmpleadoAlumno16Controller(
            IEmpleadoService<Alumno16Context> empleadoService
            )
        {
