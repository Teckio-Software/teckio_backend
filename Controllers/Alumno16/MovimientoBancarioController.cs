...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno16Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno16Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno16Controller(
            MovimientoBancarioProceso<Alumno16Context> movimientoBancarioProceso
            )
        {
