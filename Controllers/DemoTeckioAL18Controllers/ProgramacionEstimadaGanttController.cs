...
namespace SistemaERP.API.Controllers.DemoTeckioAL18
{
    [Route("api/programacionestimadaGantt/18")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL18Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL18Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL18Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL18Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL18Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL18Context> importeSemanalGanttProceso,
