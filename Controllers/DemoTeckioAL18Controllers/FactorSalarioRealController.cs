...
namespace ERP_TECKIO.Controllers.DemoTeckioAL18
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL18Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL18Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL18Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL18Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL18Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL18Context> porcentajeCesantiaEdadService
            )
        {
