...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/18")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL18Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL18Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL18Controller(
            MovimientoBancarioProceso<DemoTeckioAL18Context> movimientoBancarioProceso
            )
        {
