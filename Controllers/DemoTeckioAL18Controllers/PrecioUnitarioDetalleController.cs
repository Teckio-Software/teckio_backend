...
namespace SistemaERP.API.DemoTeckioAL18Controllers.Procomi
{
    [Route("api/preciounitariodetalle/18")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL18Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL18Controller(
