...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/18")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL18Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL18Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL18Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL18Controller(
            ILogger<ContratistaDemoTeckioAL18Controller> logger,
            DemoTeckioAL18Context context
            , IContratistaService<DemoTeckioAL18Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL18Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
