...
namespace ERP_TECKIO.Controllers.DemoTeckioAL18
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL18Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL18Context> service)
        {
            _service = service;
        }
