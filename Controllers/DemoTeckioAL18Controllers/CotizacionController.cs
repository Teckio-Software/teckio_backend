...
{
    [Route("api/cotizacion/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL18Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL18Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL18Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL18Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL18Controller> _Logger;
        private readonly DemoTeckioAL18Context Context;
        public CotizacionDemoTeckioAL18Controller(

            ILogger<CotizacionDemoTeckioAL18Controller> Logger
            , DemoTeckioAL18Context Context
            , ICotizacionService<DemoTeckioAL18Context> Service
            , IOrdenCompraService<DemoTeckioAL18Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL18Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL18Context> Proceso)
        {
            _Logger = Logger;
