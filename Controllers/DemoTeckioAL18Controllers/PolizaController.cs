...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL18Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL18Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL18Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL18Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL18Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL18Controller> _Logger;
        private readonly DemoTeckioAL18Context _Context;
        private readonly PolizaProceso<DemoTeckioAL18Context> _polizaProceso;
        public PolizaDemoTeckioAL18Controller(
            ILogger<PolizaDemoTeckioAL18Controller> logger
            , DemoTeckioAL18Context context
            , IPolizaService<DemoTeckioAL18Context> service
            , IPolizaDetalleService<DemoTeckioAL18Context> detalleService
            , ITipoPolizaService<DemoTeckioAL18Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL18Context> saldosService
