...
{
    [Route("api/precioUnitarioXEmpleado/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL18Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL18Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL18Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL18Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL18Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
