...
{
    [Route("api/programacionestimada/18")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL18Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL18Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL18Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL18Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL18Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL18Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL18Context> precioUnitarioService,
