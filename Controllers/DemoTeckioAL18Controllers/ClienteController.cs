...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL18Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL18Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL18Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL18Controller(
            IClientesService<DemoTeckioAL18Context> service
            , ClienteProceso<DemoTeckioAL18Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL18Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
