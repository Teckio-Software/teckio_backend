...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL18Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL18Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL18Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL18Controller(
            ILogger<AlmacenEntradaDemoTeckioAL18Controller> logger,
            DemoTeckioAL18Context context
            , IAlmacenEntradaService<DemoTeckioAL18Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL18Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL18Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
