...
namespace ERP_TECKIO.Controllers.DemoTeckioAL18
{
    ...
    public class FacturaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL18Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL18Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL18Controller(
            ObtenFacturaProceso<DemoTeckioAL18Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL18Context> categoriaProductoYServicioService
            )
        {
