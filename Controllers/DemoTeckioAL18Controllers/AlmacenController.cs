...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL18Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL18Context> _almacenProceso;
        public AlmacenDemoTeckioAL18Controller(
            IAlmacenService<DemoTeckioAL18Context> almacenServicio, AlmacenProceso<DemoTeckioAL18Context> almacenProceso)
        {
