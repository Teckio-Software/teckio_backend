...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL18Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL18Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL18Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL18Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL18Controller> logger,
            DemoTeckioAL18Context context
            , IAlmacenSalidaService<DemoTeckioAL18Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL18Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL18Context> Proceso
            )
        {
