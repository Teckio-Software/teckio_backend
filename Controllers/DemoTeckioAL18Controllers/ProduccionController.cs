...
namespace ERP_TECKIO.Controllers.DemoTeckioAL18
{
    ...
    [Route("api/produccion/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL18Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL18Context> proceso)
        {
            _proceso = proceso;
        }
