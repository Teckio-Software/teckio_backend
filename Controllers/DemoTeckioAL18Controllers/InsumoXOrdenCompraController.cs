...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL18Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL18Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL18Controller> _Logger;
        private readonly DemoTeckioAL18Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL18Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL18Controller> Logger,
            DemoTeckioAL18Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL18Context> Service
