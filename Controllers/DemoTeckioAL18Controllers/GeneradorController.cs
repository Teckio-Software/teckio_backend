...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL18Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL18Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL18Controller(
            GeneradoresProceso<DemoTeckioAL18Context> generadoresProceso)
        {
