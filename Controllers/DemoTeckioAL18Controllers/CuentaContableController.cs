...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL18Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL18Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL18Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL18Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL18Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL18Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL18Controller(
            ILogger<CuentaContableDemoTeckioAL18Controller> logger,
            DemoTeckioAL18Context context
            , ICuentaContableService<DemoTeckioAL18Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL18Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL18Context> RubroService
            , CuentaContableProceso<DemoTeckioAL18Context> proceso
            )
        {
            Logger = logger;
            Context = context;
