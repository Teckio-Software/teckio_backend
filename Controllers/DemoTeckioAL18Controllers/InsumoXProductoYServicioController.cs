...
namespace ERP_TECKIO.Controllers.DemoTeckioAL18
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/18")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL18Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL18Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL18Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL18Context> process)
        {
            _service = service;
            _process = process;
        }
