...
{
    [Route("api/indirectosXConcepto/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL18Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL18Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL18Controller(
            IIndirectosXConceptoService<DemoTeckioAL18Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL18Context> indirectosXConceptoProceso
            ) { 
