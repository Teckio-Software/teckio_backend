...
{
    [Route("api/insumoxcotizacion/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL18Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL18Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL18Context> _Proceso;
        private readonly DemoTeckioAL18Context Context;
        public InsumoXCotizacionDemoTeckioAL18Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL18Controller> Logger,
            DemoTeckioAL18Context Context
            , IInsumoXCotizacionService<DemoTeckioAL18Context> Service
