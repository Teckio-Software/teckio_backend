...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL18Context> _InsumoProceso;
        public InsumoDemoTeckioAL18Controller(
            InsumoProceso<DemoTeckioAL18Context> insumoProceso)
        {
