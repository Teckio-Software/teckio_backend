...
{
    [Route("api/ordenventa/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL18Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL18Controller(
            OrdenVentaProceso<DemoTeckioAL18Context> ordenVentaProceso
            ) { 
