...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL18Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL18Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL18Controller(
            ILogger<CompraDirectaDemoTeckioAL18Controller> logger,
            DemoTeckioAL18Context context
            , ICompraDirectaService<DemoTeckioAL18Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
