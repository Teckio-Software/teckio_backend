...
{
    [Route("api/preciounitario/18")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL18Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL18Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL18Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL18Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL18Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL18Controller(
            PrecioUnitarioProceso<DemoTeckioAL18Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL18Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL18Context> options,
            ExplocionInsumosProceso<DemoTeckioAL18Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL18Context(_Options.Options))
            {
