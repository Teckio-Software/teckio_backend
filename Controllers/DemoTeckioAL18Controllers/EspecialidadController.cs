...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL18Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL18Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL18Controller(
            EspecialidadProceso<DemoTeckioAL18Context> especialidadProceso)
        {
