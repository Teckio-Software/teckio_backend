...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL18Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL18Controller> Logger;
        ...
        public RubroDemoTeckioAL18Controller(
            ILogger<RubroDemoTeckioAL18Controller> logger,
            DemoTeckioAL18Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL18Context> service
            )
        {
            //_Service = service;
            Logger = logger;
