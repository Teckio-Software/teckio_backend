...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL18Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL18Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL18Controller(
            ILogger<ExistenciasDemoTeckioAL18Controller> Logger,
            DemoTeckioAL18Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL18Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL18Context> Proceso
            )
        {
            _Logger = Logger;
