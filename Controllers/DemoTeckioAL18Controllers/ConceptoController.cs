...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL18Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL18Controller(
            ConceptoProceso<DemoTeckioAL18Context> conceptoProceso)
        {
