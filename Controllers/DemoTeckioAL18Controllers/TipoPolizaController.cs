...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL18Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL18Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL18Controller(
            ILogger<TipoPolizaDemoTeckioAL18Controller> logger,
            DemoTeckioAL18Context context
            , ITipoPolizaService<DemoTeckioAL18Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
