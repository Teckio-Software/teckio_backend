...
{
    [Route("api/productoyservicio/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL18Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL18Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL18Context> _process;

        public ProductoYServicioDemoTeckioAL18Controller(IProductoYservicioService<DemoTeckioAL18Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL18Context> process
            )
        {
