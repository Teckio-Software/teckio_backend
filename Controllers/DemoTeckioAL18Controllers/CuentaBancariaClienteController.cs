...
{
    [Route("api/cuentabancariacliente/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaClienteDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL18Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL18Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL18Controller(
            ICuentaBancariaClienteService<DemoTeckioAL18Context> cuentaBancariaClienteService,
