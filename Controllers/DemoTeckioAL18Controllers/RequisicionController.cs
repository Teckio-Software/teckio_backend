...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL18Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL18Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL18Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL18Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL18Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL18Controller(
            ILogger<RequisicionDemoTeckioAL18Controller> Logger
            , DemoTeckioAL18Context Context
            , IRequisicionService<DemoTeckioAL18Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL18Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL18Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL18Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/18/970"))
            {
