...
{
    [Route("api/empleado/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL18Context> _empleadoService;
        public EmpleadoDemoTeckioAL18Controller(
            IEmpleadoService<DemoTeckioAL18Context> empleadoService
            )
        {
