...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL18Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL18Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL18Controller> _Logger;
        private readonly DemoTeckioAL18Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL18Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL18Controller> logger
            , DemoTeckioAL18Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL18Context> service
