...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL18Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL18Controller(
            FamiliaInsumoProceso<DemoTeckioAL18Context> familiaInsumoProceso)
        {
