...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL18Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL18Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL18Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL18Controller> Logger,
            RequisicionProceso<DemoTeckioAL18Context> Proceso,
            DemoTeckioAL18Context Context
            , IInsumoXRequisicionService<DemoTeckioAL18Context> Service)
        {
            _Logger = Logger;
