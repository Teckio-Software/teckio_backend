...
{
    [Route("api/entradaproduccionalmacen/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL18Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL18Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL18Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL18Context> proceso)
        {
            _proceso = proceso;
        }
