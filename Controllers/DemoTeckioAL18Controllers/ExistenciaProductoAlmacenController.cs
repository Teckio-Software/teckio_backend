...
namespace ERP_TECKIO.Controllers.DemoTeckioAL18
{
    ...
    [Route("api/existenciaproductoalmacen/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL18Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL18Context> proces)
        {
            _proceso = proces;
        }
