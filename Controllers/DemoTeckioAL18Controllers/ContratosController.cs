...
{
    [Route("api/contratos/18")]
    [ApiController]
    public class ContratosDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL18Context> _contratosProceso;
        public ContratosDemoTeckioAL18Controller(
            ContratosProceso<DemoTeckioAL18Context> contratosProceso
            )
        {
