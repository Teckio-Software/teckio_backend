...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL18Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL18Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL18Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL18Context> _indirectosProceso;

        public IndirectosDemoTeckioAL18Controller(
                        IConjuntoIndirectosService<DemoTeckioAL18Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL18Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL18Context> indirectosProceso
            )
        {
