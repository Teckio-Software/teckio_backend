...
namespace ERP_TECKIO.Controllers.DemoTeckioAL18
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL18Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL18Context> service)
        {
            _service = service;
        }
