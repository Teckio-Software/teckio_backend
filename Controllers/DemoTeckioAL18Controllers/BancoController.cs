...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL18Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL18Context> _bancoService;

        public BancoDemoTeckioAL18Controller(IBancoService<DemoTeckioAL18Context> bancoService)
        {
