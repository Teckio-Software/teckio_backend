...
{
    [Route("api/reportesdestajo/18")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL18Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL18Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL18Controller(
            ReporteDestajoProceso<DemoTeckioAL18Context> proceso,
            EstimacionesProceso<DemoTeckioAL18Context> estimacionesProceso
            ) { 
            _proceso = proceso;
