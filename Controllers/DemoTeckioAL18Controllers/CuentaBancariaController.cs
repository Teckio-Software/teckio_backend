...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL18Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL18Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL18Context> _servicio;
        public CuentaBancariaDemoTeckioAL18Controller(CuentaBancariaProceso<DemoTeckioAL18Context> _proceso, ICuentaBancariaService<DemoTeckioAL18Context> _servicio
           )
        {
