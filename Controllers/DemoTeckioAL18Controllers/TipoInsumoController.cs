...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL18Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL18Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL18Controller(
            TipoInsumoProceso<DemoTeckioAL18Context> tipoInsumoProceso
            )
        {
