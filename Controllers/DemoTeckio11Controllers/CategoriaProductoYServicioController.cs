...
namespace ERP_TECKIO.Controllers.DemoTeckioAL11
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL11Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL11Context> service)
        {
            _service = service;
        }
