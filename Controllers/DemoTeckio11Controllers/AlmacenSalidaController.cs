...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL11Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL11Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL11Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL11Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , IAlmacenSalidaService<DemoTeckioAL11Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL11Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL11Context> Proceso
            )
        {
