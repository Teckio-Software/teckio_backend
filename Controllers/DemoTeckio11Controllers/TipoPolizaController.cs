...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL11Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL11Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL11Controller(
            ILogger<TipoPolizaDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , ITipoPolizaService<DemoTeckioAL11Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
