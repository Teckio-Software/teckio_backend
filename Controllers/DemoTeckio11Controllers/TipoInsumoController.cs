...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL11Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL11Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL11Controller(
            TipoInsumoProceso<DemoTeckioAL11Context> tipoInsumoProceso
            )
        {
