...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL11Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL11Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL11Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL11Controller> Logger,
            RequisicionProceso<DemoTeckioAL11Context> Proceso,
            DemoTeckioAL11Context Context
            , IInsumoXRequisicionService<DemoTeckioAL11Context> Service)
        {
            _Logger = Logger;
