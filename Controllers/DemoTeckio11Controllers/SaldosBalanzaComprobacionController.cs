...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL11Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL11Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL11Controller> _Logger;
        private readonly DemoTeckioAL11Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL11Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL11Controller> logger
            , DemoTeckioAL11Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL11Context> service
