...
{
    [Route("api/ordencompra/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL11Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL11Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL11Controller> _Logger;
        private readonly DemoTeckioAL11Context Context;
        private readonly PolizaProceso<DemoTeckioAL11Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL11Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL11Controller(
            ILogger<OrdenCompraDemoTeckioAL11Controller> Logger
            , DemoTeckioAL11Context Context
            , IOrdenCompraService<DemoTeckioAL11Context> Service
            , OrdenCompraProceso<DemoTeckioAL11Context> Proceso
            , PolizaProceso<DemoTeckioAL11Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL11Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
