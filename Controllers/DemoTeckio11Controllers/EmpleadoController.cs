...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL11Context> _empleadoService;
        public EmpleadoDemoTeckioAL11Controller(
            IEmpleadoService<DemoTeckioAL11Context> empleadoService
            )
        {
