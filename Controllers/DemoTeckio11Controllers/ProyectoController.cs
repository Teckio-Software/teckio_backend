...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL11Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL11Controller(
            ProyectoProceso<DemoTeckioAL11Context> proyectoProceso)
        {
