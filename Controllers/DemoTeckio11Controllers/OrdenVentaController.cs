...
{
    [Route("api/ordenventa/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL11Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL11Controller(
            OrdenVentaProceso<DemoTeckioAL11Context> ordenVentaProceso
            ) { 
