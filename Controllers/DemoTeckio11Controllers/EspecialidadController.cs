...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL11Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL11Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL11Controller(
            EspecialidadProceso<DemoTeckioAL11Context> especialidadProceso)
        {
