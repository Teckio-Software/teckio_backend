...
namespace ERP_TECKIO.Controllers.DemoTeckioAL11
{
    ...
    {
        private readonly IProductoYServicioSatService<DemoTeckioAL11Context> _service;

        public ProductoYServicioSatController(IProductoYServicioSatService<DemoTeckioAL11Context> service)
        {
            _service = service;
        }
