...
namespace SistemaERP.API.Controllers.DemoTeckioAL11
{
    [Route("api/programacionestimadaGantt/11")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL11Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL11Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL11Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL11Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL11Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL11Context> importeSemanalGanttProceso,
