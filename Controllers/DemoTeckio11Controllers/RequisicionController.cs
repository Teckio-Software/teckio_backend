...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL11Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL11Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL11Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL11Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL11Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL11Controller(
            ILogger<RequisicionDemoTeckioAL11Controller> Logger
            , DemoTeckioAL11Context Context
            , IRequisicionService<DemoTeckioAL11Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL11Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL11Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL11Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL11Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/11/1170"))
            {
