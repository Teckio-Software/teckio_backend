...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoDemoTeckioAL11Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoDemoTeckioAL11Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL11Context Context;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL11Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoDemoTeckioAL11Controller(
            ILogger<AlmacenEntradaInsumoDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , IInsumoXAlmacenEntradaService<DemoTeckioAL11Context> AlmacenEntradaDetalle
