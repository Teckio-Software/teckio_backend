...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL11Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL11Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL11Controller(
            IIndirectosXConceptoService<DemoTeckioAL11Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL11Context> indirectosXConceptoProceso
            ) { 
