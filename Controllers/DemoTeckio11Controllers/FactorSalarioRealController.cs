...
namespace ERP_TECKIO.Controllers.DemoTeckioAL11
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL11Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL11Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL11Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL11Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL11Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL11Context> porcentajeCesantiaEdadService
            )
        {
