...
namespace ERP_TECKIO.Controllers.DemoTeckioAL11
{
    ...
    [Route("api/subcategoriaProductoServicio/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL11Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL11Context> service)
        {
            _service = service;
        }
