...
namespace ERP_TECKIO.Controllers.DemoTeckioAL11
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/11")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL11Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL11Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL11Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL11Context> process)
        {
            _service = service;
            _process = process;
        }
