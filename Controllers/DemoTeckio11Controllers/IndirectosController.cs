...
{
    [Route("api/indirectos/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL11Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL11Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL11Context> _indirectosProceso;

        public IndirectosDemoTeckioAL11Controller(
                        IConjuntoIndirectosService<DemoTeckioAL11Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL11Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL11Context> indirectosProceso
            )
        {
