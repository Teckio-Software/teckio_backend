...
{
    [Route("api/cliente/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL11Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL11Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL11Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL11Controller(
            IClientesService<DemoTeckioAL11Context> service
            , ClienteProceso<DemoTeckioAL11Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL11Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
