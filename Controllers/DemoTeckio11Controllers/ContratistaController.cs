...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/11")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL11Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL11Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL11Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL11Controller(
            ILogger<ContratistaDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , IContratistaService<DemoTeckioAL11Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL11Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
