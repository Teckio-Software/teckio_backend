...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL11Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL11Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL11Controller(
            ReporteDestajoProceso<DemoTeckioAL11Context> proceso,
            EstimacionesProceso<DemoTeckioAL11Context> estimacionesProceso
            ) { 
            _proceso = proceso;
