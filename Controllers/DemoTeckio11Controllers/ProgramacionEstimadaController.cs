...
{
    [Route("api/programacionestimada/11")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL11Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL11Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL11Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL11Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL11Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL11Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL11Context> precioUnitarioService,
