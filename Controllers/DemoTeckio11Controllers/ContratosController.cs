...
{
    [Route("api/contratos/11")]
    [ApiController]
    public class ContratosDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL11Context> _contratosProceso;
        public ContratosDemoTeckioAL11Controller(
            ContratosProceso<DemoTeckioAL11Context> contratosProceso
            )
        {
