...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/11")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL11Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL11Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL11Controller(
            MovimientoBancarioProceso<DemoTeckioAL11Context> movimientoBancarioProceso
            )
        {
