...
{
    [Route("api/entradaproduccionalmacen/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL11Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL11Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL11Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL11Context> proceso)
        {
            _proceso = proceso;
        }
