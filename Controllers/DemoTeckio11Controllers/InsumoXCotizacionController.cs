...
{
    [Route("api/insumoxcotizacion/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL11Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL11Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL11Context> _Proceso;
        private readonly DemoTeckioAL11Context Context;
        public InsumoXCotizacionDemoTeckioAL11Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL11Controller> Logger,
            DemoTeckioAL11Context Context
            , IInsumoXCotizacionService<DemoTeckioAL11Context> Service
