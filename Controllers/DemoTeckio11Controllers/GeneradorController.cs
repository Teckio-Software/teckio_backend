...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL11Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL11Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL11Controller(
            GeneradoresProceso<DemoTeckioAL11Context> generadoresProceso)
        {
