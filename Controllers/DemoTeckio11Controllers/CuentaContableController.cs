...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL11Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL11Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL11Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL11Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL11Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL11Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL11Controller(
            ILogger<CuentaContableDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , ICuentaContableService<DemoTeckioAL11Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL11Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL11Context> RubroService
            , CuentaContableProceso<DemoTeckioAL11Context> proceso
            )
        {
            Logger = logger;
            Context = context;
