...
{
    [Route("api/preciounitario/11")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL11Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL11Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL11Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL11Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL11Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL11Controller(
            PrecioUnitarioProceso<DemoTeckioAL11Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL11Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL11Context> options,
            ExplocionInsumosProceso<DemoTeckioAL11Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL11Context(_Options.Options))
            {
