...
namespace ERP_TECKIO.Controllers.DemoTeckioAL11
{
    ...
    [Route("api/produccion/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL11Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL11Context> proceso)
        {
            _proceso = proceso;
        }
