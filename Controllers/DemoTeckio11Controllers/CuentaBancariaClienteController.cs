...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL11Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL11Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL11Controller(
            ICuentaBancariaClienteService<DemoTeckioAL11Context> cuentaBancariaClienteService,
