...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL11Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL11Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL11Controller(
            ILogger<ExistenciasDemoTeckioAL11Controller> Logger,
            DemoTeckioAL11Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL11Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL11Context> Proceso
            )
        {
            _Logger = Logger;
