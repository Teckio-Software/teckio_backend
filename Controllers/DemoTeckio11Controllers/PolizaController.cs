...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL11Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL11Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL11Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL11Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL11Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL11Controller> _Logger;
        private readonly DemoTeckioAL11Context _Context;
        private readonly PolizaProceso<DemoTeckioAL11Context> _polizaProceso;
        public PolizaDemoTeckioAL11Controller(
            ILogger<PolizaDemoTeckioAL11Controller> logger
            , DemoTeckioAL11Context context
            , IPolizaService<DemoTeckioAL11Context> service
            , IPolizaDetalleService<DemoTeckioAL11Context> detalleService
            , ITipoPolizaService<DemoTeckioAL11Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL11Context> saldosService
