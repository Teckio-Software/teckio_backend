...
namespace ERP_TECKIO.Controllers.DemoTeckioAL11
{
    ...
    public class FacturaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL11Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL11Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL11Controller(
            ObtenFacturaProceso<DemoTeckioAL11Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL11Context> categoriaProductoYServicioService
            )
        {
