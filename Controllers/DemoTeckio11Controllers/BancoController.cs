...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL11Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL11Context> _bancoService;

        public BancoDemoTeckioAL11Controller(IBancoService<DemoTeckioAL11Context> bancoService)
        {
