...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL11Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL11Context> _servicio;
        public CuentaBancariaDemoTeckioAL11Controller(CuentaBancariaProceso<DemoTeckioAL11Context> _proceso, ICuentaBancariaService<DemoTeckioAL11Context> _servicio
           )
        {
