...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL11Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL11Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL11Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL11Controller(
            ILogger<AlmacenEntradaDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , IAlmacenEntradaService<DemoTeckioAL11Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL11Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL11Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
