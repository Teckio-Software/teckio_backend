...
{
    [Route("api/insumoxordencompra/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL11Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL11Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL11Controller> _Logger;
        private readonly DemoTeckioAL11Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL11Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL11Controller> Logger,
            DemoTeckioAL11Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL11Context> Service
