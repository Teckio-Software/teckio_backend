...
{
    [Route("api/productoyservicio/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL11Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL11Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL11Context> _process;

        public ProductoYServicioDemoTeckioAL11Controller(IProductoYservicioService<DemoTeckioAL11Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL11Context> process
            )
        {
