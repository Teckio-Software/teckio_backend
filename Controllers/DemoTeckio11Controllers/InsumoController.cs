...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL11Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL11Context> _InsumoProceso;
        public InsumoDemoTeckioAL11Controller(
            InsumoProceso<DemoTeckioAL11Context> insumoProceso)
        {
