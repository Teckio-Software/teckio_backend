...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL11Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL11Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL11Controller(
            ILogger<CompraDirectaDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , ICompraDirectaService<DemoTeckioAL11Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
