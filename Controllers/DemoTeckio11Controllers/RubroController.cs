...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL11Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL11Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL11Controller> Logger;
        ...
        public RubroDemoTeckioAL11Controller(
            ILogger<RubroDemoTeckioAL11Controller> logger,
            DemoTeckioAL11Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL11Context> service
            )
        {
            //_Service = service;
            Logger = logger;
