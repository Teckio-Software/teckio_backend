...
{
    [Route("api/cotizacion/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL11Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL11Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL11Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL11Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL11Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL11Controller> _Logger;
        private readonly DemoTeckioAL11Context Context;
        public CotizacionDemoTeckioAL11Controller(

            ILogger<CotizacionDemoTeckioAL11Controller> Logger
            , DemoTeckioAL11Context Context
            , ICotizacionService<DemoTeckioAL11Context> Service
            , IOrdenCompraService<DemoTeckioAL11Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL11Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL11Context> Proceso)
        {
            _Logger = Logger;
