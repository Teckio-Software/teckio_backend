...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL11Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL11Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL11Controller(
            FamiliaInsumoProceso<DemoTeckioAL11Context> familiaInsumoProceso)
        {
