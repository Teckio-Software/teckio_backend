...
namespace SistemaERP.API.DemoTeckioAL11Controllers.Procomi
{
    [Route("api/preciounitariodetalle/11")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL11Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL11Controller(
