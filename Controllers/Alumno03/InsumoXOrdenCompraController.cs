...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno03Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno03Context> _Service;
        private readonly OrdenCompraProceso<Alumno03Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno03Controller> _Logger;
        private readonly Alumno03Context _Context;
        public InsumoXOrdenCompraAlumno03Controller(
            ILogger<InsumoXOrdenCompraAlumno03Controller> Logger,
            Alumno03Context Context
            , IInsumoXOrdenCompraService<Alumno03Context> Service
