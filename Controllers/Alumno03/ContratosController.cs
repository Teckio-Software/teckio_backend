...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno03Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno03Context> _contratosProceso;
        public ContratosAlumno03Controller(
            ContratosProceso<Alumno03Context> contratosProceso
            )
        {
