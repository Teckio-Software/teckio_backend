...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno03Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno03Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno03Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno03Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno03Controller(
            ILogger<AlmacenEntradaInsumoAlumno03Controller> logger,
            Alumno03Context context
            , IInsumoXAlmacenEntradaService<Alumno03Context> AlmacenEntradaDetalle
