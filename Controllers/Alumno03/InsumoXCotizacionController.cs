...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionAlumno03Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno03Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno03Controller> _Logger;
        private readonly CotizacionProceso<Alumno03Context> _Proceso;
        private readonly Alumno03Context Context;
        public InsumoXCotizacionAlumno03Controller(
            ILogger<InsumoXCotizacionAlumno03Controller> Logger,
            Alumno03Context Context
            , IInsumoXCotizacionService<Alumno03Context> Service
