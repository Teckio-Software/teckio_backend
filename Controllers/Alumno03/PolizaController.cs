...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaAlumno03Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno03Context> _Service;
        private readonly IPolizaDetalleService<Alumno03Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno03Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno03Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno03Context> _SaldosService;
        private readonly ILogger<PolizaAlumno03Controller> _Logger;
        private readonly Alumno03Context _Context;
        public PolizaAlumno03Controller(
            ILogger<PolizaAlumno03Controller> logger
            , Alumno03Context context
            , IPolizaService<Alumno03Context> service
            , IPolizaDetalleService<Alumno03Context> detalleService
            , ITipoPolizaService<Alumno03Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno03Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa3")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa3")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa3")]
