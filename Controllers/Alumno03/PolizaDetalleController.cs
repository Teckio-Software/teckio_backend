...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDetalleAlumno03Controller : ControllerBase
    {
        ...
        private readonly ILogger<PolizaDetalleAlumno03Controller> _Logger;
        private readonly Alumno03Context _Context;
        public PolizaDetalleAlumno03Controller(
            ILogger<PolizaDetalleAlumno03Controller> logger
            , Alumno03Context context
            , IPolizaDetalleService<Alumno03Context> service
