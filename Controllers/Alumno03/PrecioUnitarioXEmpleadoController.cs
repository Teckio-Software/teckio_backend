...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno03Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno03Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno03Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno03Controller(
            IPrecioUnitarioXEmpleadoService<Alumno03Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno03Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
