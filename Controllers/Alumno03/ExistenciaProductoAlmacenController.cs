...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno03Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno03Context> proces)
        {
            _proceso = proces;
        }
