...
namespace SistemaERP.API.Controllers.Alumno03
{
    [Route("api/programacionestimadaGantt/3")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno03Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno03Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno03Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno03Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno03Controller(
            ProgramacionEstimadaGanttProceso<Alumno03Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno03Context> importeSemanalGanttProceso,
