...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa3")]
    public class InsumoXContratistaAlumno03Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno03Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno03Controller(
            ILogger<InsumoXContratistaAlumno03Controller> logger,
