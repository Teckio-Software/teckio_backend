...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno03Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno03Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno03Controller> Logger;
        /// <summary>
