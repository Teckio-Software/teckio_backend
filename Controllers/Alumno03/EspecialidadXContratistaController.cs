...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa3")]
    public class EspecialIdadXContratistaAlumno03Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno03Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno03Controller(
            ILogger<EspecialIdadXContratistaAlumno03Controller> logger,
