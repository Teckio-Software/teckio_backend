...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno03Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno03Context> _almacenServicio;

        public AlmacenAlumno03Controller(
            IAlmacenService<Alumno03Context> almacenServicio)
        {
