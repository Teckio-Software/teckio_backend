...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno03Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno03Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno03Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno03Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno03Controller> Logger;
        ...
        public AlmacenSalidaAlumno03Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno03Controller> logger,
            Alumno03Context context
            , IAlmacenSalidaService<Alumno03Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno03Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno03Context> Proceso
            )
        {
