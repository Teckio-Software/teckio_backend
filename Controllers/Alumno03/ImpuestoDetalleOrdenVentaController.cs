...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno03Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno03Context> process)
        {
            _process = process;
        }
