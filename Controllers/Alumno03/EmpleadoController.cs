...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno03Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno03Context> _empleadoService;
        public EmpleadoAlumno03Controller(
            IEmpleadoService<Alumno03Context> empleadoService
            )
        {
