...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno03Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno03Context> _Service;

        private readonly RequisicionProceso<Alumno03Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno03Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno03Controller(
            ILogger<InsumoXRequisicionAlumno03Controller> Logger,
            RequisicionProceso<Alumno03Context> Proceso,
            Alumno03Context Context
            , IInsumoXRequisicionService<Alumno03Context> Service)
        {
            _Logger = Logger;
