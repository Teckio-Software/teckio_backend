...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno03Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno03Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno03Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno03Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno03Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno03Controller(
            ILogger<AlmacenEntradaAlumno03Controller> logger,
            Alumno03Context context
            , IAlmacenEntradaService<Alumno03Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno03Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno03Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
