...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno03Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno03Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno03Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno03Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno03Controller(
            ILogger<ExistenciasAlumno03Controller> Logger,
            Alumno03Context Context
            , IAlmacenExistenciaInsumoService<Alumno03Context> ExistenciaService
            , ExistenciasProceso<Alumno03Context> Proceso
            )
        {
            _Logger = Logger;
