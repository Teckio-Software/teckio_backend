...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno03Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno03Context> _proceso;

        private readonly ICuentaBancariaService<Alumno03Context> _servicio;
        public CuentaBancariaAlumno03Controller(CuentaBancariaProceso<Alumno03Context> _proceso, ICuentaBancariaService<Alumno03Context> _servicio
           )
        {
