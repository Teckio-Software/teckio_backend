...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    public class FacturaAlumno03Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno03Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno03Context> _categoriaProductoYServicioService;
        public FacturaAlumno03Controller(
            ObtenFacturaProceso<Alumno03Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno03Context> categoriaProductoYServicioService
            )
        {
