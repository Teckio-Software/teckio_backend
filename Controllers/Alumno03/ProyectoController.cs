...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/proyecto/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa3")]
    public class ProyectoAlumno03Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno03Context> _ProyectoProceso;
        public ProyectoAlumno03Controller(
            ProyectoProceso<Alumno03Context> proyectoProceso)
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearProyecto-Empresa3")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarProyecto-Empresa3")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarProyecto-Empresa3")]
