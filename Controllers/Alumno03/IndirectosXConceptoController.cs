...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoAlumno03Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno03Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno03Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno03Controller(
            IIndirectosXConceptoService<Alumno03Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno03Context> indirectosXConceptoProceso
            ) { 
