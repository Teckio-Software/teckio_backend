...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno03Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno03Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno03Context> service, InsumoXProductoYServicioProceso<Alumno03Context> process)
        {
            _service = service;
            _process = process;
        }
