...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno03Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno03Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno03Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno03Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno03Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno03Context> porcentajeCesantiaEdadService
            )
        {
