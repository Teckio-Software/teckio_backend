...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno03Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno03Context> _Service;
        private readonly CotizacionProceso<Alumno03Context> _Proceso;
        private readonly IOrdenCompraService<Alumno03Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno03Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno03Controller> _Logger;
        private readonly Alumno03Context Context;
        public CotizacionAlumno03Controller(

            ILogger<CotizacionAlumno03Controller> Logger
            , Alumno03Context Context
            , ICotizacionService<Alumno03Context> Service
            , IOrdenCompraService<Alumno03Context> OrdenCompraService,
              ITipoImpuestoService<Alumno03Context> TipoImpuestoService
            , CotizacionProceso<Alumno03Context> Proceso)
        {
            _Logger = Logger;
