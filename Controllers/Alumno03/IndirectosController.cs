...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosAlumno03Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno03Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno03Context> _indirectosService;
        private readonly IndirectosProceso<Alumno03Context> _indirectosProceso;

        public IndirectosAlumno03Controller(
                        IConjuntoIndirectosService<Alumno03Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno03Context> indirectosService,
                        IndirectosProceso<Alumno03Context> indirectosProceso
            )
        {
