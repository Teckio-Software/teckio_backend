...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa3")]
    public class CompraDirectaInsumoAlumno03Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno03Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno03Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno03Controller(
            ILogger<CompraDirectaInsumoAlumno03Controller> logger
            , Alumno03Context context
            , IInsumoXCompraDirectaService<Alumno03Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
