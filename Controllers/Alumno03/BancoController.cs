...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno03Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno03Context> _bancoService;

        public BancoAlumno03Controller(IBancoService<Alumno03Context> bancoService)
        {
