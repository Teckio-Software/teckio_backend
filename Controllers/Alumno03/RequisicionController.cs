...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno03Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno03Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno03Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno03Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno03Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno03Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno03Controller(
            ILogger<RequisicionAlumno03Controller> Logger
            , Alumno03Context Context
            , IRequisicionService<Alumno03Context> RequisicionService
            , RequisicionProceso<Alumno03Context> Proceso
            , ObjetoRequisicionProceso<Alumno03Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno03Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
