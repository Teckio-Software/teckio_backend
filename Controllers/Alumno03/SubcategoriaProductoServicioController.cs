...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno03Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno03Context> service)
        {
            _service = service;
        }
