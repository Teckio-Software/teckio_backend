...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly EntradaProduccionAlmacenProceso<Alumno03Context> _proceso;

        public EntradaProduccionAlmacenController(EntradaProduccionAlmacenProceso<Alumno03Context> proceso)
        {
            _proceso = proceso;
        }
