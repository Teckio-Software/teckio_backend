...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno03Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno03Context> service)
        {
            _service = service;
        }
