...
namespace ERP_TECKIO.Controllers.Alumno03
{
    ...
    public class ProductoYServicioAlumno03Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno03Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno03Context> _process;

        public ProductoYServicioAlumno03Controller(IProductoYservicioService<Alumno03Context> productoYServicioService,
            ProductoYServicioProceso<Alumno03Context> process
            )
        {
