...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteAlumno03Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno03Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno03Context> _proceso;

        public CuentaBancariaClienteAlumno03Controller(
            ICuentaBancariaClienteService<Alumno03Context> cuentaBancariaClienteService,
