...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno03Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno03Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno03Controller(
            MovimientoBancarioProceso<Alumno03Context> movimientoBancarioProceso
            )
        {
