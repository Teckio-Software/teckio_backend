...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    public class FacturaAlumno15Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno15Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno15Context> _categoriaProductoYServicioService;
        public FacturaAlumno15Controller(
            ObtenFacturaProceso<Alumno15Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno15Context> categoriaProductoYServicioService
            )
        {
