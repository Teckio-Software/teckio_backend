...
{
    [Route("api/reportesdestajo/15")]
    [ApiController]
    public class ReporteDestajoAlumno15Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno15Context> _proceso;
        private readonly EstimacionesProceso<Alumno15Context> _estimacionesProceso;

        public ReporteDestajoAlumno15Controller(
            ReporteDestajoProceso<Alumno15Context> proceso,
            EstimacionesProceso<Alumno15Context> estimacionesProceso
            ) { 
            _proceso = proceso;
