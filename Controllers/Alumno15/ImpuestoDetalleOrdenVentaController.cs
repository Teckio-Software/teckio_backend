...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno15Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno15Context> process)
        {
            _process = process;
        }
