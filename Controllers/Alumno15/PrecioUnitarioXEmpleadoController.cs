...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno15Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno15Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno15Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno15Controller(
            IPrecioUnitarioXEmpleadoService<Alumno15Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno15Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
