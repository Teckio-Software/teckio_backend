...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa15")]
    public class FamiliaInsumoAlumno15Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno15Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno15Controller(
            FamiliaInsumoProceso<Alumno15Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa15")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa15")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa15")]
