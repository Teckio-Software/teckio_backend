...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa15")]
    public class CompraDirectaAlumno15Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno15Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno15Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno15Controller(
            ILogger<CompraDirectaAlumno15Controller> logger,
            Alumno15Context context
            , ICompraDirectaService<Alumno15Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa15")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa15")]
