...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno15Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno15Context> _bancoService;

        public BancoAlumno15Controller(IBancoService<Alumno15Context> bancoService)
        {
