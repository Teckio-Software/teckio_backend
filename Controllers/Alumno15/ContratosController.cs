...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno15Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno15Context> _contratosProceso;
        public ContratosAlumno15Controller(
            ContratosProceso<Alumno15Context> contratosProceso
            )
        {
