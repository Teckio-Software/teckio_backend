...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno15Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno15Context> _Service;
        private readonly CotizacionProceso<Alumno15Context> _Proceso;
        private readonly IOrdenCompraService<Alumno15Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno15Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno15Controller> _Logger;
        private readonly Alumno15Context Context;
        public CotizacionAlumno15Controller(

            ILogger<CotizacionAlumno15Controller> Logger
            , Alumno15Context Context
            , ICotizacionService<Alumno15Context> Service
            , IOrdenCompraService<Alumno15Context> OrdenCompraService,
              ITipoImpuestoService<Alumno15Context> TipoImpuestoService
            , CotizacionProceso<Alumno15Context> Proceso)
        {
            _Logger = Logger;
