...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno15Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno15Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno15Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno15Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno15Controller(
            ILogger<ContratistaAlumno15Controller> logger,
            Alumno15Context context
            , IContratistaService<Alumno15Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno15Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
