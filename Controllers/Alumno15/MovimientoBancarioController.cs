...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno15Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno15Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno15Controller(
            MovimientoBancarioProceso<Alumno15Context> movimientoBancarioProceso
            )
        {
