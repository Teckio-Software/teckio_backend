...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno15Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno15Context> _almacenServicio;

        public AlmacenAlumno15Controller(
            IAlmacenService<Alumno15Context> almacenServicio)
        {
