...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno15Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno15Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno15Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno15Controller(
            ILogger<ExistenciasAlumno15Controller> Logger,
            Alumno15Context Context
            , IAlmacenExistenciaInsumoService<Alumno15Context> ExistenciaService
            , ExistenciasProceso<Alumno15Context> Proceso
            )
        {
            _Logger = Logger;
