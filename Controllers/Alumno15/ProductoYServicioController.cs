...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    public class ProductoYServicioAlumno15Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno15Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno15Context> _process;

        public ProductoYServicioAlumno15Controller(IProductoYservicioService<Alumno15Context> productoYServicioService,
            ProductoYServicioProceso<Alumno15Context> process
            )
        {
