...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno15Controller : ControllerBase
    {
        private readonly IClientesService<Alumno15Context> _Service;

        private readonly ClienteProceso<Alumno15Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno15Context> _clientesCuentasContablesProceso;
        public ClienteAlumno15Controller(
            IClientesService<Alumno15Context> service
            , ClienteProceso<Alumno15Context> proceso,
            ClienteCuentasContablesProceso<Alumno15Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
