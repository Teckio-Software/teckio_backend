...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno15Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno15Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno15Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno15Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno15Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno15Context> porcentajeCesantiaEdadService
            )
        {
