...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno15Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno15Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno15Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno15Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno15Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno15Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno15Controller(
            ILogger<RequisicionAlumno15Controller> Logger
            , Alumno15Context Context
            , IRequisicionService<Alumno15Context> RequisicionService
            , RequisicionProceso<Alumno15Context> Proceso
            , ObjetoRequisicionProceso<Alumno15Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno15Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/15/970"))
            {
