...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno15Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno15Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno15Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno15Controller> Logger;
        ...
        public AlmacenSalidaAlumno15Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno15Controller> logger,
            Alumno15Context context
            , IAlmacenSalidaService<Alumno15Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno15Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno15Context> Proceso
            )
        {
