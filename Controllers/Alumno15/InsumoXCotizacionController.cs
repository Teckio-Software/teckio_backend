...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno15Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno15Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno15Controller> _Logger;
        private readonly CotizacionProceso<Alumno15Context> _Proceso;
        private readonly Alumno15Context Context;
        public InsumoXCotizacionAlumno15Controller(
            ILogger<InsumoXCotizacionAlumno15Controller> Logger,
            Alumno15Context Context
            , IInsumoXCotizacionService<Alumno15Context> Service
