...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno15Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno15Context> service)
        {
            _service = service;
        }
