...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno15Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno15Context> _Service;

        private readonly RequisicionProceso<Alumno15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno15Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno15Controller(
            ILogger<InsumoXRequisicionAlumno15Controller> Logger,
            RequisicionProceso<Alumno15Context> Proceso,
            Alumno15Context Context
            , IInsumoXRequisicionService<Alumno15Context> Service)
        {
            _Logger = Logger;
