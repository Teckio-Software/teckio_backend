...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno15Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno15Context> _proceso;

        private readonly ICuentaBancariaService<Alumno15Context> _servicio;
        public CuentaBancariaAlumno15Controller(CuentaBancariaProceso<Alumno15Context> _proceso, ICuentaBancariaService<Alumno15Context> _servicio
           )
        {
