...
namespace SistemaERP.API.Controllers.Alumno15
{
    [Route("api/programacionestimadaGantt/15")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno15Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno15Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno15Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno15Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno15Controller(
            ProgramacionEstimadaGanttProceso<Alumno15Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno15Context> importeSemanalGanttProceso,
