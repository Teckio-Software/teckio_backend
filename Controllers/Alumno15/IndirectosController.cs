...
{
    [Route("api/indirectos/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno15Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno15Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno15Context> _indirectosService;
        private readonly IndirectosProceso<Alumno15Context> _indirectosProceso;

        public IndirectosAlumno15Controller(
                        IConjuntoIndirectosService<Alumno15Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno15Context> indirectosService,
                        IndirectosProceso<Alumno15Context> indirectosProceso
            )
        {
