...
namespace ERP_TECKIO
{
    ...
    public class CompraDirectaInsumoAlumno15Controller : ControllerBase
    {
        ...
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno15Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno15Controller(
            ILogger<CompraDirectaInsumoAlumno15Controller> logger
            , Alumno15Context context
            , IInsumoXCompraDirectaService<Alumno15Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
