...
namespace ERP_TECKIO.API.Controllers.Alumno15
{
    ...
    public class IndirectosXConceptoAlumno15Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno15Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno15Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno15Controller(
            IIndirectosXConceptoService<Alumno15Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno15Context> indirectosXConceptoProceso
            ) { 
