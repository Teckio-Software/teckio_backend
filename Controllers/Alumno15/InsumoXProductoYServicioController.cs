...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno15Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno15Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno15Context> service, InsumoXProductoYServicioProceso<Alumno15Context> process)
        {
            _service = service;
            _process = process;
        }
