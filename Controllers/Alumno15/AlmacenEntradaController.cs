...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno15Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno15Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno15Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno15Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno15Controller(
            ILogger<AlmacenEntradaAlumno15Controller> logger,
            Alumno15Context context
            , IAlmacenEntradaService<Alumno15Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno15Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno15Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
