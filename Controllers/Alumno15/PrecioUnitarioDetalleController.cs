...
namespace SistemaERP.API.Alumno15Controllers.Procomi
{
    [Route("api/preciounitariodetalle/15")]
    [ApiController]
    public class PrecioUnitarioDetalleAlumno15Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleAlumno15Controller(
