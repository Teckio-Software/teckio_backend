...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno15Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno15Context> _Service;
        private readonly IPolizaDetalleService<Alumno15Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno15Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno15Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno15Context> _SaldosService;
        private readonly ILogger<PolizaAlumno15Controller> _Logger;
        private readonly Alumno15Context _Context;
        public PolizaAlumno15Controller(
            ILogger<PolizaAlumno15Controller> logger
            , Alumno15Context context
            , IPolizaService<Alumno15Context> service
            , IPolizaDetalleService<Alumno15Context> detalleService
            , ITipoPolizaService<Alumno15Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno15Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa15")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa15")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa15")]
