...
namespace ERP_TECKIO.API.Alumno015Controllers.Procomi
{
    [Route("api/estimaciones/15")]
    [ApiController]
    public class EstimacionesAlumno15Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno15Context> _estimacionesProceso;
        public EstimacionesAlumno15Controller(
