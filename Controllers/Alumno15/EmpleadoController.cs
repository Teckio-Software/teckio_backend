...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno15Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno15Context> _empleadoService;
        public EmpleadoAlumno15Controller(
            IEmpleadoService<Alumno15Context> empleadoService
            )
        {
