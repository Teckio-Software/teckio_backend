...
namespace ERP_TECKIO.Controllers.Alumno15
{
    ...
    public class OrdenVentaAlumno15Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno15Context> _ordenVentaProceso;
        public OrdenVentaAlumno15Controller(
            OrdenVentaProceso<Alumno15Context> ordenVentaProceso
            ) { 
