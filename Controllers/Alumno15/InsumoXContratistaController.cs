...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa15")]
    public class InsumoXContratistaAlumno15Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno15Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno15Controller(
            ILogger<InsumoXContratistaAlumno15Controller> logger,
