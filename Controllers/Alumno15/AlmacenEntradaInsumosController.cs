...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno15Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno15Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno15Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno15Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno15Controller(
            ILogger<AlmacenEntradaInsumoAlumno15Controller> logger,
            Alumno15Context context
            , IInsumoXAlmacenEntradaService<Alumno15Context> AlmacenEntradaDetalle
