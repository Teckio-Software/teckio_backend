...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa15")]
    public class EspecialIdadXContratistaAlumno15Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno15Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno15Controller(
            ILogger<EspecialIdadXContratistaAlumno15Controller> logger,
