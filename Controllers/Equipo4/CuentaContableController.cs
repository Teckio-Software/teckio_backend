...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentacontable/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno42Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno42Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno42Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno42Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno42Controller(
            ILogger<CuentaContableAlumno42Controller> logger,
            Alumno42Context context
            , ICuentaContableService<Alumno42Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno42Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
