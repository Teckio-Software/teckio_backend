...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    public class RubroAlumno42Controller : ControllerBase
    {
        private readonly IRubroService<Alumno42Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno42Controller> Logger;
        ...
        public RubroAlumno42Controller(
            ILogger<RubroAlumno42Controller> logger,
            Alumno42Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno42Context> service
            )
        {
            //_Service = service;
            Logger = logger;
