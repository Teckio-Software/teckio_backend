...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    [Route("api/almacen/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno42Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno42Context> _almacenServicio;

        public AlmacenAlumno42Controller(
            IAlmacenService<Alumno42Context> almacenServicio)
        {
