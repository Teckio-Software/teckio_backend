...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/familiainsumo/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno42Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno42Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno42Controller(
            FamiliaInsumoProceso<Alumno42Context> familiaInsumoProceso)
        {
