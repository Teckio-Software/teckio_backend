...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratista/42")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno42Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno42Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno42Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno42Controller(
            ILogger<ContratistaAlumno42Controller> logger,
            Alumno42Context context
            , IContratistaService<Alumno42Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
