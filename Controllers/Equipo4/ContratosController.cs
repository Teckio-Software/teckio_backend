...
{
    [Route("api/contratos/42")]
    [ApiController]
    public class ContratosAlumno42Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno42Context> _contratosProceso;
        public ContratosAlumno42Controller(
            ContratosProceso<Alumno42Context> contratosProceso
            )
        {
