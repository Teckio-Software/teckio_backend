...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipopoliza/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno42Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno42Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno42Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno42Controller(
            ILogger<TipoPolizaAlumno42Controller> logger,
            Alumno42Context context
            , ITipoPolizaService<Alumno42Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
