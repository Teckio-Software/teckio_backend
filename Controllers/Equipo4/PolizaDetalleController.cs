...
{
    [Route("api/polizadetalle/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa35")]
    public class PolizaDetalleAlumno42Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno42Context> _Service;
        private readonly ICuentaContableService<Alumno42Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno42Controller> _Logger;
        private readonly Alumno42Context _Context;
        public PolizaDetalleAlumno42Controller(
            ILogger<PolizaDetalleAlumno42Controller> logger
            , Alumno42Context context
            , IPolizaDetalleService<Alumno42Context> service
