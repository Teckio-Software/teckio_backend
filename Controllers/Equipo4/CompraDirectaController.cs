...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirecta/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno42Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno42Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno42Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno42Context Context;
        /// <summary>
        ...
        public CompraDirectaAlumno42Controller(
            ILogger<CompraDirectaAlumno42Controller> logger,
            Alumno42Context context
            , ICompraDirectaService<Alumno42Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
