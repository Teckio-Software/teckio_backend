...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno42Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno42Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno42Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno42Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno42Controller(
            ILogger<AlmacenEntradaInsumoAlumno42Controller> logger,
            Alumno42Context context
            , IInsumoXAlmacenEntradaService<Alumno42Context> AlmacenEntradaDetalle
