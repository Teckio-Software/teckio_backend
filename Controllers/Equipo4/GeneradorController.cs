...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/generadores/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa35")]
    public class GeneradoresAlumno42Controller : ControllerBase
    {
        private readonly GeneradoresProceso<Alumno42Context> _GeneradoresProceso;
        public GeneradoresAlumno42Controller(
            GeneradoresProceso<Alumno42Context> generadoresProceso)
        {
