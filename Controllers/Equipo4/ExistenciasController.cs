...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/existencias/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno42Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno42Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno42Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno42Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno42Controller(
            ILogger<ExistenciasAlumno42Controller> Logger,
            Alumno42Context Context
            , IAlmacenExistenciaInsumoService<Alumno42Context> ExistenciaService
            , ExistenciasProceso<Alumno42Context> Proceso
            )
        {
            _Logger = Logger;
