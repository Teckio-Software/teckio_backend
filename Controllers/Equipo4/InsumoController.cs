...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    public class InsumoAlumno42Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno42Context> _InsumoProceso;
        public InsumoAlumno42Controller(
            InsumoProceso<Alumno42Context> insumoProceso)
        {
