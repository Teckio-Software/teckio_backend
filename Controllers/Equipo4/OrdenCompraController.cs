...
{
    [Route("api/ordencompra/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno42Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno42Context> _Service;
        private readonly OrdenCompraProceso<Alumno42Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno42Controller> _Logger;
        private readonly Alumno42Context Context;
        public OrdenCompraAlumno42Controller(
            ILogger<OrdenCompraAlumno42Controller> Logger
            , Alumno42Context Context
            , IOrdenCompraService<Alumno42Context> Service
