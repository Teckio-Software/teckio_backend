...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno42Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno42Context> _Service;

        private readonly RequisicionProceso<Alumno42Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno42Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno42Controller(
            ILogger<InsumoXRequisicionAlumno42Controller> Logger,
            RequisicionProceso<Alumno42Context> Proceso,
            Alumno42Context Context
            , IInsumoXRequisicionService<Alumno42Context> Service)
        {
            _Logger = Logger;
