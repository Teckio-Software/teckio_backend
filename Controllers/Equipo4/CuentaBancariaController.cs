...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno42Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno42Context> _proceso;

        private readonly ICuentaBancariaService<Alumno42Context> _servicio;
        public CuentaBancariaAlumno42Controller(CuentaBancariaProceso<Alumno42Context> _proceso, ICuentaBancariaService<Alumno42Context> _servicio
           )
        {
