...
{
    [Route("api/cotizacion/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno42Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno42Context> _Service;
        private readonly CotizacionProceso<Alumno42Context> _Proceso;
        private readonly IOrdenCompraService<Alumno42Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno42Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno42Controller> _Logger;
        private readonly Alumno42Context Context;
        public CotizacionAlumno42Controller(

            ILogger<CotizacionAlumno42Controller> Logger
            , Alumno42Context Context
            , ICotizacionService<Alumno42Context> Service
            , IOrdenCompraService<Alumno42Context> OrdenCompraService,
              ITipoImpuestoService<Alumno42Context> TipoImpuestoService
            , CotizacionProceso<Alumno42Context> Proceso)
        {
            _Logger = Logger;
