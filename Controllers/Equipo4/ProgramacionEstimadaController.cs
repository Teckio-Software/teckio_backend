...
{
    [Route("api/programacionestimada/42")]
    [ApiController]
    public class ProgramacionEstimadaAlumno42Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno42Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno42Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno42Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno42Controller(
            ProgramacionEstimadaProceso<Alumno42Context> programacionEstimadaProceso,
            IProyectoService<Alumno42Context> proyectoProceso,
            IPrecioUnitarioService<Alumno42Context> precioUnitarioService,
