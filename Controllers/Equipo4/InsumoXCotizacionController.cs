...
{
    [Route("api/insumoxcotizacion/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno42Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno42Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno42Controller> _Logger;
        private readonly CotizacionProceso<Alumno42Context> _Proceso;
        private readonly Alumno42Context Context;
        public InsumoXCotizacionAlumno42Controller(
            ILogger<InsumoXCotizacionAlumno42Controller> Logger,
            Alumno42Context Context
            , IInsumoXCotizacionService<Alumno42Context> Service
