...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/42")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno42Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno42Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno42Controller(
            ILogger<ContratistaCuentaBancariaAlumno42Controller> logger,
