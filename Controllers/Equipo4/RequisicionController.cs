...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/requisicion/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno42Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno42Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno42Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno42Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno42Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno42Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno42Controller(
            ILogger<RequisicionAlumno42Controller> Logger
            , Alumno42Context Context
            , IRequisicionService<Alumno42Context> RequisicionService
            , RequisicionProceso<Alumno42Context> Proceso
            , ObjetoRequisicionProceso<Alumno42Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno42Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
