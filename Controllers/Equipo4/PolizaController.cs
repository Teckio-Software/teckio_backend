...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    public class PolizaAlumno42Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno42Context> _Service;
        private readonly IPolizaDetalleService<Alumno42Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno42Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno42Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno42Context> _SaldosService;
        private readonly ILogger<PolizaAlumno42Controller> _Logger;
        private readonly Alumno42Context _Context;
        public PolizaAlumno42Controller(
            ILogger<PolizaAlumno42Controller> logger
            , Alumno42Context context
            , IPolizaService<Alumno42Context> service
            , IPolizaDetalleService<Alumno42Context> detalleService
            , ITipoPolizaService<Alumno42Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno42Context> saldosService
