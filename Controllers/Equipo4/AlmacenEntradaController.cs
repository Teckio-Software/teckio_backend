...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentrada/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno42Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno42Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno42Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno42Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno42Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno42Controller(
            ILogger<AlmacenEntradaAlumno42Controller> logger,
            Alumno42Context context
            , IAlmacenEntradaService<Alumno42Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno42Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno42Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
