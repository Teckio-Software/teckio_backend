...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenSalida/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno42Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno42Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno42Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno42Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno42Controller> Logger;
        ...
        public AlmacenSalidaAlumno42Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno42Controller> logger,
            Alumno42Context context
            , IAlmacenSalidaService<Alumno42Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno42Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno42Context> Proceso
            )
        {
