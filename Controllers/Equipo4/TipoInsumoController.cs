...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno42Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno42Context> _TipoInsumoProceso;

        public TipoInsumoAlumno42Controller(
            TipoInsumoProceso<Alumno42Context> tipoInsumoProceso
            )
        {
