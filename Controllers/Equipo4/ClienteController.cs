...
{
    [Route("api/cliente/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno42Controller : ControllerBase
    {
        private readonly IClientesService<Alumno42Context> _Service;

        private readonly ClienteProceso<Alumno42Context> _Proceso;
        public ClienteAlumno42Controller(
            IClientesService<Alumno42Context> service
            , ClienteProceso<Alumno42Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
