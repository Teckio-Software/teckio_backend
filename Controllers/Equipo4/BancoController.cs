...
namespace SistemaERP.API.Controllers.Alumno42
{
    ...
    public class BancoAlumno42Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno42Context> _bancoService;

        public BancoAlumno42Controller(IBancoService<Alumno42Context> bancoService)
        {
