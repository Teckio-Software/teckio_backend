...
namespace SistemaERP.API.Alumno42Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/42")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno42Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno42Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno42Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno42Controller(
            ILogger<CompraDirectaInsumoAlumno42Controller> logger
            , Alumno42Context context
            , IInsumoXCompraDirectaService<Alumno42Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
