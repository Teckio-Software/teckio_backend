...
{
    [Route("api/preciounitario/42")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno42Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno42Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno42Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno42Context> _Options;
        public PrecioUnitarioAlumno42Controller(
            PrecioUnitarioProceso<Alumno42Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno42Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno42Context> options
            )
        {
        ...
        {
            using (var db = new Alumno42Context(_Options.Options))
            {
