...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa26")]
    public class CuentaContableAlumno26Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno26Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno26Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno26Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno26Controller(
            ILogger<CuentaContableAlumno26Controller> logger,
            Alumno26Context context
            , ICuentaContableService<Alumno26Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno26Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
