...
namespace ERP_TECKIO
{
    ...
    public class OrdenCompraAlumno26Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno26Context> _Service;
        private readonly OrdenCompraProceso<Alumno26Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno26Controller> _Logger;
        private readonly Alumno26Context Context;
        public OrdenCompraAlumno26Controller(
            ILogger<OrdenCompraAlumno26Controller> Logger
            , Alumno26Context Context
            , IOrdenCompraService<Alumno26Context> Service
