...
namespace ERP_TECKIO
{
    ...
    public class RequisicionAlumno26Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno26Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno26Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno26Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno26Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno26Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno26Controller(
            ILogger<RequisicionAlumno26Controller> Logger
            , Alumno26Context Context
            , IRequisicionService<Alumno26Context> RequisicionService
            , RequisicionProceso<Alumno26Context> Proceso
            , ObjetoRequisicionProceso<Alumno26Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno26Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
