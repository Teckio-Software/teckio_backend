...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa26")]
    public class EspecialIdadXContratistaAlumno26Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno26Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno26Controller(
            ILogger<EspecialIdadXContratistaAlumno26Controller> logger,
