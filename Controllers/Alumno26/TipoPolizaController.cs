...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa26")]
    public class TipoPolizaAlumno26Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno26Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno26Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno26Controller(
            ILogger<TipoPolizaAlumno26Controller> logger,
            Alumno26Context context
            , ITipoPolizaService<Alumno26Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa26")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa26")]
