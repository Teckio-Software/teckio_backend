...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa26")]
    public class CompraDirectaInsumoAlumno26Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno26Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno26Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno26Controller(
            ILogger<CompraDirectaInsumoAlumno26Controller> logger
            , Alumno26Context context
            , IInsumoXCompraDirectaService<Alumno26Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
