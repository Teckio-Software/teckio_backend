...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno26Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno26Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno26Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno26Controller> Logger;
        ...
        public AlmacenSalidaAlumno26Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno26Controller> logger,
            Alumno26Context context
            , IAlmacenSalidaService<Alumno26Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno26Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno26Context> Proceso
            )
        {
