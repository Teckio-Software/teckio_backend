...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno26Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno26Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno26Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno26Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno26Controller(
            ProgramacionEstimadaProceso<Alumno26Context> programacionEstimadaProceso,
            IProyectoService<Alumno26Context> proyectoProceso,
            IPrecioUnitarioService<Alumno26Context> precioUnitarioService,
