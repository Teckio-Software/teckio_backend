...
namespace ERP_TECKIO.Controllers.Alumno26
{
    [Route("api/fsr/26")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno26Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno26Context> factorSalarioRealProceso)
        {
