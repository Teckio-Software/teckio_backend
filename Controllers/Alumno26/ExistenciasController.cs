...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno26Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno26Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno26Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno26Controller(
            ILogger<ExistenciasAlumno26Controller> Logger,
            Alumno26Context Context
            , IAlmacenExistenciaInsumoService<Alumno26Context> ExistenciaService
            , ExistenciasProceso<Alumno26Context> Proceso
            )
        {
            _Logger = Logger;
