...
namespace ERP_TECKIO.API.Controllers.Alumno26
{
    ...
    public class IndirectosXConceptoAlumno26Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno26Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno26Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno26Controller(
            IIndirectosXConceptoService<Alumno26Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno26Context> indirectosXConceptoProceso
            ) { 
