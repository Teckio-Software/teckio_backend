...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno26Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno26Context> _Service;
        private readonly CotizacionProceso<Alumno26Context> _Proceso;
        private readonly IOrdenCompraService<Alumno26Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno26Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno26Controller> _Logger;
        private readonly Alumno26Context Context;
        public CotizacionAlumno26Controller(

            ILogger<CotizacionAlumno26Controller> Logger
            , Alumno26Context Context
            , ICotizacionService<Alumno26Context> Service
            , IOrdenCompraService<Alumno26Context> OrdenCompraService,
              ITipoImpuestoService<Alumno26Context> TipoImpuestoService
            , CotizacionProceso<Alumno26Context> Proceso)
        {
            _Logger = Logger;
