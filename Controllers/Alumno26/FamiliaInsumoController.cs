...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa26")]
    public class FamiliaInsumoAlumno26Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno26Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno26Controller(
            FamiliaInsumoProceso<Alumno26Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa26")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa26")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa26")]
