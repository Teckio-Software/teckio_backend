...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno26Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno26Context> _Service;

        private readonly RequisicionProceso<Alumno26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno26Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno26Controller(
            ILogger<InsumoXRequisicionAlumno26Controller> Logger,
            RequisicionProceso<Alumno26Context> Proceso,
            Alumno26Context Context
            , IInsumoXRequisicionService<Alumno26Context> Service)
        {
            _Logger = Logger;
