...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa26")]
    public class InsumoXContratistaAlumno26Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno26Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno26Controller(
            ILogger<InsumoXContratistaAlumno26Controller> logger,
