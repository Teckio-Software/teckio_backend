...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa26")]
    public class SaldosBalanzaComprobacionAlumno26Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno26Context> _Service;
        private readonly ICuentaContableService<Alumno26Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno26Controller> _Logger;
        private readonly Alumno26Context _Context;
        public SaldosBalanzaComprobacionAlumno26Controller(
            ILogger<SaldosBalanzaComprobacionAlumno26Controller> logger
            , Alumno26Context context
            , ISaldosBalanzaComprobacionService<Alumno26Context> service
