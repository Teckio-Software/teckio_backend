...
namespace ERP_TECKIO
{
    ...
    public class ClienteAlumno26Controller : ControllerBase
    {
        private readonly IClientesService<Alumno26Context> _Service;

        private readonly ClienteProceso<Alumno26Context> _Proceso;
        public ClienteAlumno26Controller(
            IClientesService<Alumno26Context> service
            , ClienteProceso<Alumno26Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
