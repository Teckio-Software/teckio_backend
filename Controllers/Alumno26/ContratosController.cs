...
namespace ERP_TECKIO.API.Controllers.Alumno26
{
    ...
    [ApiController]
    public class ContratosAlumno26Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno26Context> _contratosProceso;
        public ContratosAlumno26Controller(
            ContratosProceso<Alumno26Context> contratosProceso
            )
        {
