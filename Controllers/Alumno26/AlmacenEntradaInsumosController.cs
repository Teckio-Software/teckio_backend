...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno26Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno26Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno26Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno26Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno26Controller(
            ILogger<AlmacenEntradaInsumoAlumno26Controller> logger,
            Alumno26Context context
            , IInsumoXAlmacenEntradaService<Alumno26Context> AlmacenEntradaDetalle
