...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno26Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno26Context> _proceso;

        private readonly ICuentaBancariaService<Alumno26Context> _servicio;
        public CuentaBancariaAlumno26Controller(CuentaBancariaProceso<Alumno26Context> _proceso, ICuentaBancariaService<Alumno26Context> _servicio
           )
        {
