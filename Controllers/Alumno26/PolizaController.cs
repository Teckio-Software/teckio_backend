...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno26Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno26Context> _Service;
        private readonly IPolizaDetalleService<Alumno26Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno26Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno26Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno26Context> _SaldosService;
        private readonly ILogger<PolizaAlumno26Controller> _Logger;
        private readonly Alumno26Context _Context;
        public PolizaAlumno26Controller(
            ILogger<PolizaAlumno26Controller> logger
            , Alumno26Context context
            , IPolizaService<Alumno26Context> service
            , IPolizaDetalleService<Alumno26Context> detalleService
            , ITipoPolizaService<Alumno26Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno26Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa26")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa26")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa26")]
