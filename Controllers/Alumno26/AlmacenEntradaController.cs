...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno26Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno26Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno26Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno26Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno26Controller(
            ILogger<AlmacenEntradaAlumno26Controller> logger,
            Alumno26Context context
            , IAlmacenEntradaService<Alumno26Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno26Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno26Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
