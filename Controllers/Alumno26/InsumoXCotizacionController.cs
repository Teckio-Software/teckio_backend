...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno26Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno26Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno26Controller> _Logger;
        private readonly CotizacionProceso<Alumno26Context> _Proceso;
        private readonly Alumno26Context Context;
        public InsumoXCotizacionAlumno26Controller(
            ILogger<InsumoXCotizacionAlumno26Controller> Logger,
            Alumno26Context Context
            , IInsumoXCotizacionService<Alumno26Context> Service
