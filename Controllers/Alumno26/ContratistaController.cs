...
namespace ERP_TECKIO
{
    ...
    public class ContratistaAlumno26Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno26Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno26Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno26Controller(
            ILogger<ContratistaAlumno26Controller> logger,
            Alumno26Context context
            , IContratistaService<Alumno26Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
