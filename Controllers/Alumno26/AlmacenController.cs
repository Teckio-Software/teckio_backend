...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno26Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno26Context> _almacenServicio;

        public AlmacenAlumno26Controller(
            IAlmacenService<Alumno26Context> almacenServicio)
        {
