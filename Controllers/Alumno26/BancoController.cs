...
namespace ERP_TECKIO.API.Controllers.Alumno26
{
    ...
    public class BancoAlumno26Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno26Context> _bancoService;

        public BancoAlumno26Controller(IBancoService<Alumno26Context> bancoService)
        {
