...
namespace SistemaERP.API.Alumno26Controllers.Procomi
{
    ...
    public class PrecioUnitarioAlumno26Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno26Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno26Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno26Context> _Options;
        public PrecioUnitarioAlumno26Controller(
            PrecioUnitarioProceso<Alumno26Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno26Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno26Context> options
            )
        {
        ...
        {
            using (var db = new Alumno26Context(_Options.Options))
            {
