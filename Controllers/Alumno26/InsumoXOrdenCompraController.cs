...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno26Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno26Context> _Service;
        private readonly OrdenCompraProceso<Alumno26Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno26Controller> _Logger;
        private readonly Alumno26Context _Context;
        public InsumoXOrdenCompraAlumno26Controller(
            ILogger<InsumoXOrdenCompraAlumno26Controller> Logger,
            Alumno26Context Context
            , IInsumoXOrdenCompraService<Alumno26Context> Service
            , OrdenCompraProceso<Alumno26Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
