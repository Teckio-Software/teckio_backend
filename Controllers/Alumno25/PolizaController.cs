...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno25Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno25Context> _Service;
        private readonly IPolizaDetalleService<Alumno25Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno25Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno25Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno25Context> _SaldosService;
        private readonly ILogger<PolizaAlumno25Controller> _Logger;
        private readonly Alumno25Context _Context;
        public PolizaAlumno25Controller(
            ILogger<PolizaAlumno25Controller> logger
            , Alumno25Context context
            , IPolizaService<Alumno25Context> service
            , IPolizaDetalleService<Alumno25Context> detalleService
            , ITipoPolizaService<Alumno25Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno25Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa25")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa25")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa25")]
