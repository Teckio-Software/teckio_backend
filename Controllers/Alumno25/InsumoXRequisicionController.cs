...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno25Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno25Context> _Service;

        private readonly RequisicionProceso<Alumno25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno25Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno25Controller(
            ILogger<InsumoXRequisicionAlumno25Controller> Logger,
            RequisicionProceso<Alumno25Context> Proceso,
            Alumno25Context Context
            , IInsumoXRequisicionService<Alumno25Context> Service)
        {
            _Logger = Logger;
