...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno25Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno25Context> _contratosProceso;
        public ContratosAlumno25Controller(
            ContratosProceso<Alumno25Context> contratosProceso
            )
        {
