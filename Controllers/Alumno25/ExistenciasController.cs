...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno25Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno25Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno25Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno25Controller(
            ILogger<ExistenciasAlumno25Controller> Logger,
            Alumno25Context Context
            , IAlmacenExistenciaInsumoService<Alumno25Context> ExistenciaService
            , ExistenciasProceso<Alumno25Context> Proceso
            )
        {
            _Logger = Logger;
