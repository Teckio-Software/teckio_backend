...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa25")]
    public class FamiliaInsumoAlumno25Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno25Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno25Controller(
            FamiliaInsumoProceso<Alumno25Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa25")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa25")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa25")]
