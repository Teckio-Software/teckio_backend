...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa25")]
    public class CompraDirectaInsumoAlumno25Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno25Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno25Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno25Controller(
            ILogger<CompraDirectaInsumoAlumno25Controller> logger
            , Alumno25Context context
            , IInsumoXCompraDirectaService<Alumno25Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
