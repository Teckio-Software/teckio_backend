...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno25Controller : ControllerBase
    {
        ...
        private readonly ClienteCuentasContablesProceso<Alumno25Context> _clientesCuentasContablesProceso;
        public ClienteAlumno25Controller(
            IClientesService<Alumno25Context> service
            , ClienteProceso<Alumno25Context> proceso,
            ClienteCuentasContablesProceso<Alumno25Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
