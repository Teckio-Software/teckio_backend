...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno25Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno25Context> _almacenServicio;

        public AlmacenAlumno25Controller(
            IAlmacenService<Alumno25Context> almacenServicio)
        {
