...
namespace ERP_TECKIO.Controllers.Alumno25
{
    ...
    public class FacturaAlumno25Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno25Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno25Context> _categoriaProductoYServicioService;
        public FacturaAlumno25Controller(
            ObtenFacturaProceso<Alumno25Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno25Context> categoriaProductoYServicioService
            )
        {
