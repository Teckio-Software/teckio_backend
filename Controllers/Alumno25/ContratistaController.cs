...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno25Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno25Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno25Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno25Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno25Controller(
            ILogger<ContratistaAlumno25Controller> logger,
            Alumno25Context context
            , IContratistaService<Alumno25Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno25Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
