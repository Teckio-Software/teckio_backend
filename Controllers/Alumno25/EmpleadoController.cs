...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno25Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno25Context> _empleadoService;
        public EmpleadoAlumno25Controller(
            IEmpleadoService<Alumno25Context> empleadoService
            )
        {
