...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno25Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno25Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno25Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno25Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno25Controller(
            ILogger<AlmacenEntradaAlumno25Controller> logger,
            Alumno25Context context
            , IAlmacenEntradaService<Alumno25Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno25Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno25Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
