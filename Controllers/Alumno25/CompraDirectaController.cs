...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa25")]
    public class CompraDirectaAlumno25Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno25Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno25Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno25Controller(
            ILogger<CompraDirectaAlumno25Controller> logger,
            Alumno25Context context
            , ICompraDirectaService<Alumno25Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa25")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa25")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa25")]
