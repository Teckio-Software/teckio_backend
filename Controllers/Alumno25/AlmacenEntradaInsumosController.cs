...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno25Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno25Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno25Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno25Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno25Controller(
            ILogger<AlmacenEntradaInsumoAlumno25Controller> logger,
            Alumno25Context context
            , IInsumoXAlmacenEntradaService<Alumno25Context> AlmacenEntradaDetalle
