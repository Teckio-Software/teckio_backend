...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno25Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno25Context> _Service;
        private readonly CotizacionProceso<Alumno25Context> _Proceso;
        private readonly IOrdenCompraService<Alumno25Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno25Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno25Controller> _Logger;
        private readonly Alumno25Context Context;
        public CotizacionAlumno25Controller(

            ILogger<CotizacionAlumno25Controller> Logger
            , Alumno25Context Context
            , ICotizacionService<Alumno25Context> Service
            , IOrdenCompraService<Alumno25Context> OrdenCompraService,
              ITipoImpuestoService<Alumno25Context> TipoImpuestoService
            , CotizacionProceso<Alumno25Context> Proceso)
        {
            _Logger = Logger;
