...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa25")]
    public class EspecialIdadXContratistaAlumno25Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno25Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno25Controller(
            ILogger<EspecialIdadXContratistaAlumno25Controller> logger,
