...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioAlumno25Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno25Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno25Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno25Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno25Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno25Controller(
            PrecioUnitarioProceso<Alumno25Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno25Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno25Context> options,
            ExplocionInsumosProceso<Alumno25Context> explocionInsumosProceso
            )
        {
