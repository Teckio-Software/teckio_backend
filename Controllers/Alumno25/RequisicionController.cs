...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno25Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno25Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno25Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno25Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno25Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno25Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno25Controller(
            ILogger<RequisicionAlumno25Controller> Logger
            , Alumno25Context Context
            , IRequisicionService<Alumno25Context> RequisicionService
            , RequisicionProceso<Alumno25Context> Proceso
            , ObjetoRequisicionProceso<Alumno25Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno25Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
