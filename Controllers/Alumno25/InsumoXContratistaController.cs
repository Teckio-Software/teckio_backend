...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa25")]
    public class InsumoXContratistaAlumno25Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno25Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno25Controller(
            ILogger<InsumoXContratistaAlumno25Controller> logger,
