...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno25Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno25Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno25Controller> _Logger;
        private readonly CotizacionProceso<Alumno25Context> _Proceso;
        private readonly Alumno25Context Context;
        public InsumoXCotizacionAlumno25Controller(
            ILogger<InsumoXCotizacionAlumno25Controller> Logger,
            Alumno25Context Context
            , IInsumoXCotizacionService<Alumno25Context> Service
