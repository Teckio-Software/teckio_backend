...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno25Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno25Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno25Controller(
            MovimientoBancarioProceso<Alumno25Context> movimientoBancarioProceso
            )
        {
