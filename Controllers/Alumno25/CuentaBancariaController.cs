...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno25Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno25Context> _proceso;

        private readonly ICuentaBancariaService<Alumno25Context> _servicio;
        public CuentaBancariaAlumno25Controller(CuentaBancariaProceso<Alumno25Context> _proceso, ICuentaBancariaService<Alumno25Context> _servicio
           )
        {
