...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno25Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno25Context> _Service;
        private readonly OrdenCompraProceso<Alumno25Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno25Controller> _Logger;
        private readonly Alumno25Context _Context;
        public InsumoXOrdenCompraAlumno25Controller(
            ILogger<InsumoXOrdenCompraAlumno25Controller> Logger,
            Alumno25Context Context
            , IInsumoXOrdenCompraService<Alumno25Context> Service
