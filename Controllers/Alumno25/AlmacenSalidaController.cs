...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno25Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno25Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno25Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno25Controller> Logger;
        ...
        public AlmacenSalidaAlumno25Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno25Controller> logger,
            Alumno25Context context
            , IAlmacenSalidaService<Alumno25Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno25Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno25Context> Proceso
            )
        {
