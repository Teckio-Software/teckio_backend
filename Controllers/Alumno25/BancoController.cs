...
namespace ERP_TECKIO.API.Controllers.Alumno25
{
    ...
    public class BancoAlumno25Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno25Context> _bancoService;

        public BancoAlumno25Controller(IBancoService<Alumno25Context> bancoService)
        {
