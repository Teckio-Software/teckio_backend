...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa27")]
    public class CompraDirectaInsumoAlumno27Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno27Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno27Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno27Controller(
            ILogger<CompraDirectaInsumoAlumno27Controller> logger
            , Alumno27Context context
            , IInsumoXCompraDirectaService<Alumno27Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
