...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno27Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno27Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno27Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno27Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno27Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno27Controller(
            ILogger<AlmacenEntradaAlumno27Controller> logger,
            Alumno27Context context
            , IAlmacenEntradaService<Alumno27Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno27Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno27Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
