...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno27Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno27Context> _almacenServicio;

        public AlmacenAlumno27Controller(
            IAlmacenService<Alumno27Context> almacenServicio)
        {
