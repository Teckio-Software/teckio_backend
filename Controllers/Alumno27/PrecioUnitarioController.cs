...
namespace SistemaERP.API.Alumno27Controllers.Procomi
{
    [Route("api/preciounitario/27")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno27Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno27Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno27Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno27Context> _Options;
        public PrecioUnitarioAlumno27Controller(
            PrecioUnitarioProceso<Alumno27Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno27Context> programacionEstimadaService
