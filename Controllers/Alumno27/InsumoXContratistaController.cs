...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa27")]
    public class InsumoXContratistaAlumno27Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno27Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno27Controller(
            ILogger<InsumoXContratistaAlumno27Controller> logger,
