...
{
    [Route("api/indirectos/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno27Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno27Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno27Context> _indirectosService;
        private readonly IndirectosProceso<Alumno27Context> _indirectosProceso;

        public IndirectosAlumno27Controller(
                        IConjuntoIndirectosService<Alumno27Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno27Context> indirectosService,
                        IndirectosProceso<Alumno27Context> indirectosProceso
            )
        {
