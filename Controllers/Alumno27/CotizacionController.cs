...
{
    [Route("api/cotizacion/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno27Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno27Context> _Service;
        private readonly CotizacionProceso<Alumno27Context> _Proceso;
        private readonly IOrdenCompraService<Alumno27Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno27Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno27Controller> _Logger;
        private readonly Alumno27Context Context;
        public CotizacionAlumno27Controller(

            ILogger<CotizacionAlumno27Controller> Logger
            , Alumno27Context Context
            , ICotizacionService<Alumno27Context> Service
            , IOrdenCompraService<Alumno27Context> OrdenCompraService,
              ITipoImpuestoService<Alumno27Context> TipoImpuestoService
            , CotizacionProceso<Alumno27Context> Proceso)
        {
            _Logger = Logger;
