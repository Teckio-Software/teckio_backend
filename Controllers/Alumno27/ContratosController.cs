...
{
    [Route("api/contratos/27")]
    [ApiController]
    public class ContratosAlumno27Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno27Context> _contratosProceso;
        public ContratosAlumno27Controller(
            ContratosProceso<Alumno27Context> contratosProceso
            )
        {
