...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno27Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno27Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno27Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno27Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno27Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno27Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno27Controller(
            ILogger<RequisicionAlumno27Controller> Logger
            , Alumno27Context Context
            , IRequisicionService<Alumno27Context> RequisicionService
            , RequisicionProceso<Alumno27Context> Proceso
            , ObjetoRequisicionProceso<Alumno27Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno27Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
