...
{
    [Route("api/programacionestimada/27")]
    [ApiController]
    public class ProgramacionEstimadaAlumno27Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno27Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno27Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno27Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno27Controller(
            ProgramacionEstimadaProceso<Alumno27Context> programacionEstimadaProceso,
            IProyectoService<Alumno27Context> proyectoProceso,
            IPrecioUnitarioService<Alumno27Context> precioUnitarioService,
