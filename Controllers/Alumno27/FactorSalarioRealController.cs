...
namespace ERP_TECKIO.Controllers.Alumno27
{
    [Route("api/fsr/27")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno27Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno27Context> factorSalarioRealProceso)
        {
