...
{
    [Route("api/reportesdestajo/27")]
    [ApiController]
    public class ReporteDestajoAlumno27Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno27Context> _proceso;
        private readonly EstimacionesProceso<Alumno27Context> _estimacionesProceso;

        public ReporteDestajoAlumno27Controller(
            ReporteDestajoProceso<Alumno27Context> proceso,
