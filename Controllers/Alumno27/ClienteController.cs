...
{
    [Route("api/cliente/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno27Controller : ControllerBase
    {
        private readonly IClientesService<Alumno27Context> _Service;

        private readonly ClienteProceso<Alumno27Context> _Proceso;
        public ClienteAlumno27Controller(
            IClientesService<Alumno27Context> service
            , ClienteProceso<Alumno27Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
