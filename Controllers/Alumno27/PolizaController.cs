...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno27Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno27Context> _Service;
        private readonly IPolizaDetalleService<Alumno27Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno27Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno27Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno27Context> _SaldosService;
        private readonly ILogger<PolizaAlumno27Controller> _Logger;
        private readonly Alumno27Context _Context;
        public PolizaAlumno27Controller(
            ILogger<PolizaAlumno27Controller> logger
            , Alumno27Context context
            , IPolizaService<Alumno27Context> service
            , IPolizaDetalleService<Alumno27Context> detalleService
            , ITipoPolizaService<Alumno27Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno27Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa27")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa27")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa27")]
