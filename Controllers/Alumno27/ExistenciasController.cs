...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno27Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno27Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno27Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno27Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno27Controller(
            ILogger<ExistenciasAlumno27Controller> Logger,
            Alumno27Context Context
            , IAlmacenExistenciaInsumoService<Alumno27Context> ExistenciaService
            , ExistenciasProceso<Alumno27Context> Proceso
            )
        {
            _Logger = Logger;
