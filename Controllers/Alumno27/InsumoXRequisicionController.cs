...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno27Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno27Context> _Service;

        private readonly RequisicionProceso<Alumno27Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno27Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno27Controller(
            ILogger<InsumoXRequisicionAlumno27Controller> Logger,
            RequisicionProceso<Alumno27Context> Proceso,
            Alumno27Context Context
            , IInsumoXRequisicionService<Alumno27Context> Service)
        {
            _Logger = Logger;
