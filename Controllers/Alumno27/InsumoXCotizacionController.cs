...
{
    [Route("api/insumoxcotizacion/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno27Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno27Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno27Controller> _Logger;
        private readonly CotizacionProceso<Alumno27Context> _Proceso;
        private readonly Alumno27Context Context;
        public InsumoXCotizacionAlumno27Controller(
            ILogger<InsumoXCotizacionAlumno27Controller> Logger,
            Alumno27Context Context
            , IInsumoXCotizacionService<Alumno27Context> Service
