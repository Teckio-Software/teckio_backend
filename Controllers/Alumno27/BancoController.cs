...
namespace ERP_TECKIO.API.Controllers.Alumno27
{
    ...
    public class BancoAlumno27Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno27Context> _bancoService;

        public BancoAlumno27Controller(IBancoService<Alumno27Context> bancoService)
        {
