...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa27")]
    public class CompraDirectaAlumno27Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno27Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno27Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno27Controller(
            ILogger<CompraDirectaAlumno27Controller> logger,
            Alumno27Context context
            , ICompraDirectaService<Alumno27Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa27")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa27")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa27")]
