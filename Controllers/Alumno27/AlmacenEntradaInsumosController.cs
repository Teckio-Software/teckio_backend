...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno27Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno27Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno27Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno27Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno27Controller(
            ILogger<AlmacenEntradaInsumoAlumno27Controller> logger,
            Alumno27Context context
            , IInsumoXAlmacenEntradaService<Alumno27Context> AlmacenEntradaDetalle
