...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa27")]
    public class EspecialIdadXContratistaAlumno27Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno27Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno27Controller(
            ILogger<EspecialIdadXContratistaAlumno27Controller> logger,
