...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa27")]
    public class CuentaContableAlumno27Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno27Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno27Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno27Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno27Controller(
            ILogger<CuentaContableAlumno27Controller> logger,
            Alumno27Context context
            , ICuentaContableService<Alumno27Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno27Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
