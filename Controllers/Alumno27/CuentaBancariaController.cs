...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno27Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno27Context> _proceso;

        private readonly ICuentaBancariaService<Alumno27Context> _servicio;
        public CuentaBancariaAlumno27Controller(CuentaBancariaProceso<Alumno27Context> _proceso, ICuentaBancariaService<Alumno27Context> _servicio
           )
        {
