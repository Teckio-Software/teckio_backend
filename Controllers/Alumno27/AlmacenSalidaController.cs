...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno27Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno27Context> _AlmacenSalidaServicio;
        ...
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno27Controller> Logger;
        ...
        public AlmacenSalidaAlumno27Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno27Controller> logger,
            Alumno27Context context
            , IAlmacenSalidaService<Alumno27Context> AlmacenSalidaServicio
