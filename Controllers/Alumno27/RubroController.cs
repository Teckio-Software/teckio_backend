...
namespace ERP_TECKIO
{
    ...
    [Route("api/rubro/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionRubro-Empresa27")]
    public class RubroAlumno27Controller : ControllerBase
    {
        private readonly IRubroService<Alumno27Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno27Controller> Logger;
        ...
        public RubroAlumno27Controller(
            ILogger<RubroAlumno27Controller> logger,
            Alumno27Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno27Context> service
            )
        {
            //_Service = service;
            Logger = logger;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearRubro-Empresa27")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarRubro-Empresa27")]
