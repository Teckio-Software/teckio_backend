...
{
    [Route("api/ordencompra/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno27Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno27Context> _Service;
        private readonly OrdenCompraProceso<Alumno27Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno27Controller> _Logger;
        private readonly Alumno27Context Context;
        public OrdenCompraAlumno27Controller(
            ILogger<OrdenCompraAlumno27Controller> Logger
            , Alumno27Context Context
            , IOrdenCompraService<Alumno27Context> Service
