...
{
    [Route("api/insumoxordencompra/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno27Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno27Context> _Service;
        private readonly OrdenCompraProceso<Alumno27Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno27Controller> _Logger;
        private readonly Alumno27Context _Context;
        public InsumoXOrdenCompraAlumno27Controller(
            ILogger<InsumoXOrdenCompraAlumno27Controller> Logger,
            Alumno27Context Context
            , IInsumoXOrdenCompraService<Alumno27Context> Service
            , OrdenCompraProceso<Alumno27Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
