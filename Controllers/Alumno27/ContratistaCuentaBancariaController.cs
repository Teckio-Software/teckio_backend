...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/27")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno27Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno27Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno27Controller(
            ILogger<ContratistaCuentaBancariaAlumno27Controller> logger,
