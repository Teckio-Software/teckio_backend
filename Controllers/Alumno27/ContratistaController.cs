...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/27")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno27Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno27Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno27Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno27Controller(
            ILogger<ContratistaAlumno27Controller> logger,
            Alumno27Context context
            , IContratistaService<Alumno27Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
