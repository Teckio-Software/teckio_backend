...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/27")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa27")]
    public class FamiliaInsumoAlumno27Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno27Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno27Controller(
            FamiliaInsumoProceso<Alumno27Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa27")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa27")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa27")]
