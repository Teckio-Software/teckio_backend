...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno34Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno34Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno34Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno34Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno34Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno34Controller(
            ILogger<AlmacenEntradaAlumno34Controller> logger,
            Alumno34Context context
            , IAlmacenEntradaService<Alumno34Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno34Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno34Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
