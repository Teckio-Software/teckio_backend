...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno34Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno34Context> _Service;
        private readonly IPolizaDetalleService<Alumno34Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno34Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno34Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno34Context> _SaldosService;
        private readonly ILogger<PolizaAlumno34Controller> _Logger;
        private readonly Alumno34Context _Context;
        public PolizaAlumno34Controller(
            ILogger<PolizaAlumno34Controller> logger
            , Alumno34Context context
            , IPolizaService<Alumno34Context> service
            , IPolizaDetalleService<Alumno34Context> detalleService
            , ITipoPolizaService<Alumno34Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno34Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa34")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa34")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa34")]
