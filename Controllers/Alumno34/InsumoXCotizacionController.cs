...
{
    [Route("api/insumoxcotizacion/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno34Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno34Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno34Controller> _Logger;
        private readonly CotizacionProceso<Alumno34Context> _Proceso;
        private readonly Alumno34Context Context;
        public InsumoXCotizacionAlumno34Controller(
            ILogger<InsumoXCotizacionAlumno34Controller> Logger,
            Alumno34Context Context
            , IInsumoXCotizacionService<Alumno34Context> Service
