...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa34")]
    public class EspecialIdadXContratistaAlumno34Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno34Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno34Controller(
            ILogger<EspecialIdadXContratistaAlumno34Controller> logger,
