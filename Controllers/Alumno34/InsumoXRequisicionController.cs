...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno34Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno34Context> _Service;

        private readonly RequisicionProceso<Alumno34Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno34Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno34Controller(
            ILogger<InsumoXRequisicionAlumno34Controller> Logger,
            RequisicionProceso<Alumno34Context> Proceso,
            Alumno34Context Context
            , IInsumoXRequisicionService<Alumno34Context> Service)
        {
            _Logger = Logger;
