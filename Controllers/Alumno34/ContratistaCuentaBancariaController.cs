...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/34")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno34Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno34Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno34Controller(
            ILogger<ContratistaCuentaBancariaAlumno34Controller> logger,
