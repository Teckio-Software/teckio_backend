...
{
    [Route("api/insumoxordencompra/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno34Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno34Context> _Service;
        private readonly OrdenCompraProceso<Alumno34Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno34Controller> _Logger;
        private readonly Alumno34Context _Context;
        public InsumoXOrdenCompraAlumno34Controller(
            ILogger<InsumoXOrdenCompraAlumno34Controller> Logger,
            Alumno34Context Context
            , IInsumoXOrdenCompraService<Alumno34Context> Service
            , OrdenCompraProceso<Alumno34Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
