...
{
    [Route("api/indirectosXConcepto/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoAlumno34Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno34Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno34Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno34Controller(
            IIndirectosXConceptoService<Alumno34Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno34Context> indirectosXConceptoProceso
            ) { 
