...
{
    [Route("api/cliente/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno34Controller : ControllerBase
    {
        private readonly IClientesService<Alumno34Context> _Service;

        private readonly ClienteProceso<Alumno34Context> _Proceso;
        public ClienteAlumno34Controller(
            IClientesService<Alumno34Context> service
            , ClienteProceso<Alumno34Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
