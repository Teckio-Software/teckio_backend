...
namespace ERP_TECKIO.API.Alumno034Controllers.Procomi
{
    [Route("api/estimaciones/34")]
    [ApiController]
    public class EstimacionesAlumno34Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno34Context> _estimacionesProceso;
        public EstimacionesAlumno34Controller(
