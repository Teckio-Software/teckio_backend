...
namespace SistemaERP.API.Alumno34Controllers.Procomi
{
    [Route("api/preciounitario/34")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno34Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno34Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno34Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno34Context> _Options;
        public PrecioUnitarioAlumno34Controller(
            PrecioUnitarioProceso<Alumno34Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno34Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno34Context> options
            )
        {
        ...
        {
            using (var db = new Alumno34Context(_Options.Options))
            {
