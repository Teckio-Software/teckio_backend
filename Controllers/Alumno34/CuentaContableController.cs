...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa34")]
    public class CuentaContableAlumno34Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno34Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno34Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno34Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno34Controller(
            ILogger<CuentaContableAlumno34Controller> logger,
            Alumno34Context context
            , ICuentaContableService<Alumno34Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno34Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
