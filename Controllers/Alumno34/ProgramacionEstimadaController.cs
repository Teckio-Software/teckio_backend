...
{
    [Route("api/programacionestimada/34")]
    [ApiController]
    public class ProgramacionEstimadaAlumno34Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno34Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno34Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno34Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno34Controller(
            ProgramacionEstimadaProceso<Alumno34Context> programacionEstimadaProceso,
            IProyectoService<Alumno34Context> proyectoProceso,
            IPrecioUnitarioService<Alumno34Context> precioUnitarioService,
