...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/34")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno34Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno34Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno34Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno34Controller(
            ILogger<ContratistaAlumno34Controller> logger,
            Alumno34Context context
            , IContratistaService<Alumno34Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
