...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno34Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno34Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno34Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno34Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno34Controller(
            ILogger<AlmacenEntradaInsumoAlumno34Controller> logger,
            Alumno34Context context
            , IInsumoXAlmacenEntradaService<Alumno34Context> AlmacenEntradaDetalle
