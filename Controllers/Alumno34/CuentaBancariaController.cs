...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno34Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno34Context> _proceso;

        private readonly ICuentaBancariaService<Alumno34Context> _servicio;
        public CuentaBancariaAlumno34Controller(CuentaBancariaProceso<Alumno34Context> _proceso, ICuentaBancariaService<Alumno34Context> _servicio
           )
        {
