...
{
    [Route("api/ordencompra/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno34Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno34Context> _Service;
        private readonly OrdenCompraProceso<Alumno34Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno34Controller> _Logger;
        private readonly Alumno34Context Context;
        public OrdenCompraAlumno34Controller(
            ILogger<OrdenCompraAlumno34Controller> Logger
            , Alumno34Context Context
            , IOrdenCompraService<Alumno34Context> Service
