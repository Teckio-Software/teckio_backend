...
{
    [Route("api/cuentabancariacliente/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaClienteAlumno34Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno34Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno34Context> _proceso;

        public CuentaBancariaClienteAlumno34Controller(
            ICuentaBancariaClienteService<Alumno34Context> cuentaBancariaClienteService,
