...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa34")]
    public class CompraDirectaAlumno34Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno34Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno34Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno34Controller(
            ILogger<CompraDirectaAlumno34Controller> logger,
            Alumno34Context context
            , ICompraDirectaService<Alumno34Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa34")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa34")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa34")]
