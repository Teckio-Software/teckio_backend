...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa34")]
    public class CompraDirectaInsumoAlumno34Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno34Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno34Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno34Controller(
            ILogger<CompraDirectaInsumoAlumno34Controller> logger
            , Alumno34Context context
            , IInsumoXCompraDirectaService<Alumno34Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
