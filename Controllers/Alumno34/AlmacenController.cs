...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno34Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno34Context> _almacenServicio;

        public AlmacenAlumno34Controller(
            IAlmacenService<Alumno34Context> almacenServicio)
        {
