...
{
    [Route("api/contratos/34")]
    [ApiController]
    public class ContratosAlumno34Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno34Context> _contratosProceso;
        public ContratosAlumno34Controller(
            ContratosProceso<Alumno34Context> contratosProceso
            )
        {
