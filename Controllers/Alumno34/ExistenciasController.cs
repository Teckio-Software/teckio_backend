...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno34Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno34Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno34Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno34Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno34Controller(
            ILogger<ExistenciasAlumno34Controller> Logger,
            Alumno34Context Context
            , IAlmacenExistenciaInsumoService<Alumno34Context> ExistenciaService
            , ExistenciasProceso<Alumno34Context> Proceso
            )
        {
            _Logger = Logger;
