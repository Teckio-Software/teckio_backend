...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno34Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno34Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno34Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno34Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno34Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno34Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno34Controller(
            ILogger<RequisicionAlumno34Controller> Logger
            , Alumno34Context Context
            , IRequisicionService<Alumno34Context> RequisicionService
            , RequisicionProceso<Alumno34Context> Proceso
            , ObjetoRequisicionProceso<Alumno34Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno34Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
