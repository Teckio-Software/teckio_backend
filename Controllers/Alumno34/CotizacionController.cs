...
{
    [Route("api/cotizacion/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno34Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno34Context> _Service;
        private readonly CotizacionProceso<Alumno34Context> _Proceso;
        private readonly IOrdenCompraService<Alumno34Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno34Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno34Controller> _Logger;
        private readonly Alumno34Context Context;
        public CotizacionAlumno34Controller(

            ILogger<CotizacionAlumno34Controller> Logger
            , Alumno34Context Context
            , ICotizacionService<Alumno34Context> Service
            , IOrdenCompraService<Alumno34Context> OrdenCompraService,
              ITipoImpuestoService<Alumno34Context> TipoImpuestoService
            , CotizacionProceso<Alumno34Context> Proceso)
        {
            _Logger = Logger;
