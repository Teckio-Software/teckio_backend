...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa34")]
    public class InsumoXContratistaAlumno34Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno34Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno34Controller(
            ILogger<InsumoXContratistaAlumno34Controller> logger,
