...
namespace ERP_TECKIO.Controllers.Alumno34
{
    [Route("api/fsr/34")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno34Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno34Context> factorSalarioRealProceso)
        {
