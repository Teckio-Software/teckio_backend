...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/34")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno34Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno34Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno34Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno34Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno34Controller> Logger;
        ...
        public AlmacenSalidaAlumno34Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno34Controller> logger,
            Alumno34Context context
            , IAlmacenSalidaService<Alumno34Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno34Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno34Context> Proceso
            )
        {
