...
namespace ERP_TECKIO.API.Controllers.Alumno34
{
    ...
    public class BancoAlumno34Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno34Context> _bancoService;

        public BancoAlumno34Controller(IBancoService<Alumno34Context> bancoService)
        {
