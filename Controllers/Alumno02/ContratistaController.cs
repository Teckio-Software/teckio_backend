...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno02Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno02Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno02Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno02Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno02Controller(
            ILogger<ContratistaAlumno02Controller> logger,
            Alumno02Context context
            , IContratistaService<Alumno02Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno02Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
