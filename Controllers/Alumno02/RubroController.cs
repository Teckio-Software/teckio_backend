...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroAlumno02Controller : ControllerBase
    {
        ...
        /// </summary>
        private readonly ILogger<RubroAlumno02Controller> Logger;
        ...
        public RubroAlumno02Controller(
            ILogger<RubroAlumno02Controller> logger,
            Alumno02Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno02Context> service
            )
        {
            //_Service = service;
            Logger = logger;
