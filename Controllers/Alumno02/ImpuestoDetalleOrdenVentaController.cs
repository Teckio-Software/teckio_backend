...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno02Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno02Context> process)
        {
            _process = process;
        }
