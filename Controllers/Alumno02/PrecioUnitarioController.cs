...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioAlumno02Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno02Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno02Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno02Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno02Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno02Controller(
            PrecioUnitarioProceso<Alumno02Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno02Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno02Context> options,
            ExplocionInsumosProceso<Alumno02Context> explocionInsumosProceso
            )
        {
