...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno02Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno02Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno02Controller(
            MovimientoBancarioProceso<Alumno02Context> movimientoBancarioProceso
            )
        {
