...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno02Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno02Context> _almacenServicio;

        public AlmacenAlumno02Controller(
            IAlmacenService<Alumno02Context> almacenServicio)
        {
