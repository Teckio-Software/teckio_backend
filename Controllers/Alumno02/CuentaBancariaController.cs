...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno02Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno02Context> _proceso;

        private readonly ICuentaBancariaService<Alumno02Context> _servicio;
        public CuentaBancariaAlumno02Controller(CuentaBancariaProceso<Alumno02Context> _proceso, ICuentaBancariaService<Alumno02Context> _servicio
           )
        {
