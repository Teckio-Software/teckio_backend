...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaInsumoAlumno02Controller : ControllerBase
    {
        private readonly IInsumoXAlmacenSalidaService<Alumno02Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno02Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaInsumoAlumno02Controller> Logger;
        /// <summary>
        ...
        public AlmacenSalidaInsumoAlumno02Controller(
            ILogger<AlmacenSalidaInsumoAlumno02Controller> logger,
            Alumno02Context context
            , IInsumoXAlmacenSalidaService<Alumno02Context> AlmacenSalidaDetalleServicio
