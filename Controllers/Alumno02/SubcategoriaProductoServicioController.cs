...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno02Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno02Context> service)
        {
            _service = service;
        }
