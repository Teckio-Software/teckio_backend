...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa2")]
    public class EspecialIdadXContratistaAlumno02Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno02Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno02Controller(
            ILogger<EspecialIdadXContratistaAlumno02Controller> logger,
