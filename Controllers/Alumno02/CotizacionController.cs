...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno02Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno02Context> _Service;
        private readonly CotizacionProceso<Alumno02Context> _Proceso;
        private readonly IOrdenCompraService<Alumno02Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno02Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno02Controller> _Logger;
        private readonly Alumno02Context Context;
        public CotizacionAlumno02Controller(

            ILogger<CotizacionAlumno02Controller> Logger
            , Alumno02Context Context
            , ICotizacionService<Alumno02Context> Service
            , IOrdenCompraService<Alumno02Context> OrdenCompraService,
              ITipoImpuestoService<Alumno02Context> TipoImpuestoService
            , CotizacionProceso<Alumno02Context> Proceso)
        {
            _Logger = Logger;
