...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno02Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno02Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno02Context> service, InsumoXProductoYServicioProceso<Alumno02Context> process)
        {
            _service = service;
            _process = process;
        }
