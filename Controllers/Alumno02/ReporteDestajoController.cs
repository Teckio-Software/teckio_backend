...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno02Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno02Context> _proceso;
        private readonly EstimacionesProceso<Alumno02Context> _estimacionesProceso;

        public ReporteDestajoAlumno02Controller(
            ReporteDestajoProceso<Alumno02Context> proceso,
            EstimacionesProceso<Alumno02Context> estimacionesProceso
            ) { 
            _proceso = proceso;
