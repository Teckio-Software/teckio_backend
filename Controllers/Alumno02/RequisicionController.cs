...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno02Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno02Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno02Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno02Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno02Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno02Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno02Controller(
            ILogger<RequisicionAlumno02Controller> Logger
            , Alumno02Context Context
            , IRequisicionService<Alumno02Context> RequisicionService
            , RequisicionProceso<Alumno02Context> Proceso
            , ObjetoRequisicionProceso<Alumno02Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno02Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
