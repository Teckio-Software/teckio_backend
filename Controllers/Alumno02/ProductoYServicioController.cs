...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    public class ProductoYServicioAlumno02Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno02Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno02Context> _process;

        public ProductoYServicioAlumno02Controller(IProductoYservicioService<Alumno02Context> productoYServicioService,
            ProductoYServicioProceso<Alumno02Context> process
            )
        {
