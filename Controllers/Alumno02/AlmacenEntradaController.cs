...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno02Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno02Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno02Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno02Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno02Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno02Controller(
            ILogger<AlmacenEntradaAlumno02Controller> logger,
            Alumno02Context context
            , IAlmacenEntradaService<Alumno02Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno02Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno02Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
