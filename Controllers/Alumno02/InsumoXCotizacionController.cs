...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionAlumno02Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno02Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno02Controller> _Logger;
        private readonly CotizacionProceso<Alumno02Context> _Proceso;
        private readonly Alumno02Context Context;
        public InsumoXCotizacionAlumno02Controller(
            ILogger<InsumoXCotizacionAlumno02Controller> Logger,
            Alumno02Context Context
            , IInsumoXCotizacionService<Alumno02Context> Service
