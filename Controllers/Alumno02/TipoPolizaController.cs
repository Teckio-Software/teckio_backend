...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaAlumno02Controller : ControllerBase
    {
        ...
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno02Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno02Controller(
            ILogger<TipoPolizaAlumno02Controller> logger,
            Alumno02Context context
            , ITipoPolizaService<Alumno02Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
