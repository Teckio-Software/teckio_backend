...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno02Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno02Context> _Service;

        private readonly RequisicionProceso<Alumno02Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno02Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno02Controller(
            ILogger<InsumoXRequisicionAlumno02Controller> Logger,
            RequisicionProceso<Alumno02Context> Proceso,
            Alumno02Context Context
            , IInsumoXRequisicionService<Alumno02Context> Service)
        {
            _Logger = Logger;
