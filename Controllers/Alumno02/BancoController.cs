...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno02Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno02Context> _bancoService;

        public BancoAlumno02Controller(IBancoService<Alumno02Context> bancoService)
        {
