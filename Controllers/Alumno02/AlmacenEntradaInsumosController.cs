...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno02Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno02Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno02Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno02Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno02Controller(
            ILogger<AlmacenEntradaInsumoAlumno02Controller> logger,
            Alumno02Context context
            , IInsumoXAlmacenEntradaService<Alumno02Context> AlmacenEntradaDetalle
