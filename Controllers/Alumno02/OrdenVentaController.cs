...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    public class OrdenVentaAlumno02Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno02Context> _ordenVentaProceso;
        public OrdenVentaAlumno02Controller(
            OrdenVentaProceso<Alumno02Context> ordenVentaProceso
            ) { 
