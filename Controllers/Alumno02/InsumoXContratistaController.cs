...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa2")]
    public class InsumoXContratistaAlumno02Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno02Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno02Controller(
            ILogger<InsumoXContratistaAlumno02Controller> logger,
