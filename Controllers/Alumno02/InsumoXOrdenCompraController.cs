...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno02Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno02Context> _Service;
        private readonly OrdenCompraProceso<Alumno02Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno02Controller> _Logger;
        private readonly Alumno02Context _Context;
        public InsumoXOrdenCompraAlumno02Controller(
            ILogger<InsumoXOrdenCompraAlumno02Controller> Logger,
            Alumno02Context Context
            , IInsumoXOrdenCompraService<Alumno02Context> Service
