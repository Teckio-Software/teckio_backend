...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno02Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno02Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno02Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno02Controller(
            IPrecioUnitarioXEmpleadoService<Alumno02Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno02Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
