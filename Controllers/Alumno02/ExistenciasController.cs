...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno02Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno02Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno02Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno02Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno02Controller(
            ILogger<ExistenciasAlumno02Controller> Logger,
            Alumno02Context Context
            , IAlmacenExistenciaInsumoService<Alumno02Context> ExistenciaService
            , ExistenciasProceso<Alumno02Context> Proceso
            )
        {
            _Logger = Logger;
