...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno02Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno02Context> _Service;
        private readonly OrdenCompraProceso<Alumno02Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno02Controller> _Logger;
        ...
        public OrdenCompraAlumno02Controller(
            ILogger<OrdenCompraAlumno02Controller> Logger
            , Alumno02Context Context
            , IOrdenCompraService<Alumno02Context> Service
            , OrdenCompraProceso<Alumno02Context> Proceso
