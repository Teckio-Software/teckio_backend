...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno02Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno02Context> proces)
        {
            _proceso = proces;
        }
