...
namespace ERP_TECKIO.Controllers.Alumno02
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno02Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno02Context> service)
        {
            _service = service;
        }
