...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa2")]
    public class CompraDirectaInsumoAlumno02Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno02Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno02Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno02Controller(
            ILogger<CompraDirectaInsumoAlumno02Controller> logger
            , Alumno02Context context
            , IInsumoXCompraDirectaService<Alumno02Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
