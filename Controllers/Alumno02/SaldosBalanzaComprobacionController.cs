...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionAlumno02Controller : ControllerBase
    {
        ...
        private readonly ILogger<SaldosBalanzaComprobacionAlumno02Controller> _Logger;
        private readonly Alumno02Context _Context;
        public SaldosBalanzaComprobacionAlumno02Controller(
            ILogger<SaldosBalanzaComprobacionAlumno02Controller> logger
            , Alumno02Context context
            , ISaldosBalanzaComprobacionService<Alumno02Context> service
