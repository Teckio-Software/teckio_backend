...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno02Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno02Context> _empleadoService;
        public EmpleadoAlumno02Controller(
            IEmpleadoService<Alumno02Context> empleadoService
            )
        {
