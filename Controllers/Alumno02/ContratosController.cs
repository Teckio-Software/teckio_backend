...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno02Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno02Context> _contratosProceso;
        public ContratosAlumno02Controller(
            ContratosProceso<Alumno02Context> contratosProceso
            )
        {
