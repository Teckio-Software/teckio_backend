...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa2")]
    public class TipoInsumoAlumno02Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno02Context> _TipoInsumoProceso;

        public TipoInsumoAlumno02Controller(
            TipoInsumoProceso<Alumno02Context> tipoInsumoProceso
            )
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoInsumo-Empresa2")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoInsumo-Empresa2")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarTipoInsumo-Empresa2")]
