...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaAlumno02Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno02Context> _Service;
        private readonly IPolizaDetalleService<Alumno02Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno02Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno02Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno02Context> _SaldosService;
        private readonly ILogger<PolizaAlumno02Controller> _Logger;
        private readonly Alumno02Context _Context;
        public PolizaAlumno02Controller(
            ILogger<PolizaAlumno02Controller> logger
            , Alumno02Context context
            , IPolizaService<Alumno02Context> service
            , IPolizaDetalleService<Alumno02Context> detalleService
            , ITipoPolizaService<Alumno02Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno02Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa2")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa2")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa2")]
