...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa22")]
    public class InsumoXContratistaAlumno22Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno22Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno22Controller(
            ILogger<InsumoXContratistaAlumno22Controller> logger,
