...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno22Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno22Context> _Service;
        private readonly CotizacionProceso<Alumno22Context> _Proceso;
        private readonly IOrdenCompraService<Alumno22Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno22Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno22Controller> _Logger;
        private readonly Alumno22Context Context;
        public CotizacionAlumno22Controller(

            ILogger<CotizacionAlumno22Controller> Logger
            , Alumno22Context Context
            , ICotizacionService<Alumno22Context> Service
            , IOrdenCompraService<Alumno22Context> OrdenCompraService,
              ITipoImpuestoService<Alumno22Context> TipoImpuestoService
            , CotizacionProceso<Alumno22Context> Proceso)
        {
            _Logger = Logger;
