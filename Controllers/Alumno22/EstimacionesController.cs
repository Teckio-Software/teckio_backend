...
namespace ERP_TECKIO.API.Alumno022Controllers.Procomi
{
    [Route("api/estimaciones/22")]
    [ApiController]
    public class EstimacionesAlumno22Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno22Context> _estimacionesProceso;
        public EstimacionesAlumno22Controller(
