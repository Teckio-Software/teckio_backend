...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno22Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno22Context> _empleadoService;
        public EmpleadoAlumno22Controller(
            IEmpleadoService<Alumno22Context> empleadoService
            )
        {
