...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno22Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno22Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno22Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno22Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno22Controller(
            ILogger<AlmacenEntradaInsumoAlumno22Controller> logger,
            Alumno22Context context
            , IInsumoXAlmacenEntradaService<Alumno22Context> AlmacenEntradaDetalle
