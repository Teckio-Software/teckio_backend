...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno22Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno22Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno22Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno22Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno22Controller(
            ILogger<ContratistaAlumno22Controller> logger,
            Alumno22Context context
            , IContratistaService<Alumno22Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno22Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
