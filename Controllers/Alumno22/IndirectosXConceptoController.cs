...
namespace ERP_TECKIO.API.Controllers.Alumno22
{
    ...
    public class IndirectosXConceptoAlumno22Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno22Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno22Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno22Controller(
            IIndirectosXConceptoService<Alumno22Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno22Context> indirectosXConceptoProceso
            ) { 
