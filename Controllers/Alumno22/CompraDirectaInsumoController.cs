...
namespace ERP_TECKIO
{
    ...
    public class CompraDirectaInsumoAlumno22Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno22Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno22Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno22Controller(
            ILogger<CompraDirectaInsumoAlumno22Controller> logger
            , Alumno22Context context
            , IInsumoXCompraDirectaService<Alumno22Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
