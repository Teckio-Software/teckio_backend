...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno22Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno22Context> _proceso;

        private readonly ICuentaBancariaService<Alumno22Context> _servicio;
        public CuentaBancariaAlumno22Controller(CuentaBancariaProceso<Alumno22Context> _proceso, ICuentaBancariaService<Alumno22Context> _servicio
           )
        {
