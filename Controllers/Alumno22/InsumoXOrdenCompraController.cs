...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno22Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno22Context> _Service;
        private readonly OrdenCompraProceso<Alumno22Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno22Controller> _Logger;
        private readonly Alumno22Context _Context;
        public InsumoXOrdenCompraAlumno22Controller(
            ILogger<InsumoXOrdenCompraAlumno22Controller> Logger,
            Alumno22Context Context
            , IInsumoXOrdenCompraService<Alumno22Context> Service
