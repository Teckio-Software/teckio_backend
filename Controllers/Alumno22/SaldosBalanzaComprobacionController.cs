...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa22")]
    public class SaldosBalanzaComprobacionAlumno22Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno22Context> _Service;
        private readonly ICuentaContableService<Alumno22Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno22Controller> _Logger;
        private readonly Alumno22Context _Context;
        public SaldosBalanzaComprobacionAlumno22Controller(
            ILogger<SaldosBalanzaComprobacionAlumno22Controller> logger
            , Alumno22Context context
            , ISaldosBalanzaComprobacionService<Alumno22Context> service
