...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno22Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno22Context> _Service;
        private readonly OrdenCompraProceso<Alumno22Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno22Controller> _Logger;
        private readonly Alumno22Context Context;
        private readonly PolizaProceso<Alumno22Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno22Context> _obtenFacturaProceso;

        public OrdenCompraAlumno22Controller(
            ILogger<OrdenCompraAlumno22Controller> Logger
            , Alumno22Context Context
            , IOrdenCompraService<Alumno22Context> Service
            , OrdenCompraProceso<Alumno22Context> Proceso
            , PolizaProceso<Alumno22Context> polizaProceso
            , ObtenFacturaProceso<Alumno22Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
