...
namespace ERP_TECKIO.Controllers.Alumno22
{
    [Route("api/factura/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaAlumno22Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno22Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno22Context> _categoriaProductoYServicioService;
        public FacturaAlumno22Controller(
            ObtenFacturaProceso<Alumno22Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno22Context> categoriaProductoYServicioService
            )
        {
