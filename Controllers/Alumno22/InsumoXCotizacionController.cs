...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno22Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno22Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno22Controller> _Logger;
        private readonly CotizacionProceso<Alumno22Context> _Proceso;
        private readonly Alumno22Context Context;
        public InsumoXCotizacionAlumno22Controller(
            ILogger<InsumoXCotizacionAlumno22Controller> Logger,
            Alumno22Context Context
            , IInsumoXCotizacionService<Alumno22Context> Service
