...
namespace ERP_TECKIO.API.Controllers.Alumno22
{
    ...
    public class CuentaBancariaClienteAlumno22Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno22Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno22Context> _proceso;

        public CuentaBancariaClienteAlumno22Controller(
            ICuentaBancariaClienteService<Alumno22Context> cuentaBancariaClienteService,
