...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno22Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno22Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno22Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno22Controller(
            ILogger<ExistenciasAlumno22Controller> Logger,
            Alumno22Context Context
            , IAlmacenExistenciaInsumoService<Alumno22Context> ExistenciaService
            , ExistenciasProceso<Alumno22Context> Proceso
            )
        {
            _Logger = Logger;
