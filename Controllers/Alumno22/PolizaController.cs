...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno22Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno22Context> _Service;
        private readonly IPolizaDetalleService<Alumno22Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno22Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno22Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno22Context> _SaldosService;
        private readonly ILogger<PolizaAlumno22Controller> _Logger;
        private readonly Alumno22Context _Context;
        public PolizaAlumno22Controller(
            ILogger<PolizaAlumno22Controller> logger
            , Alumno22Context context
            , IPolizaService<Alumno22Context> service
            , IPolizaDetalleService<Alumno22Context> detalleService
            , ITipoPolizaService<Alumno22Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno22Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa22")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa22")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa22")]
