...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosAlumno22Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno22Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno22Context> _indirectosService;
        private readonly IndirectosProceso<Alumno22Context> _indirectosProceso;

        public IndirectosAlumno22Controller(
                        IConjuntoIndirectosService<Alumno22Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno22Context> indirectosService,
                        IndirectosProceso<Alumno22Context> indirectosProceso
            )
        {
