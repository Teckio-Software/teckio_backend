...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno22Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno22Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno22Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno22Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno22Controller(
            ILogger<AlmacenEntradaAlumno22Controller> logger,
            Alumno22Context context
            , IAlmacenEntradaService<Alumno22Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno22Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno22Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
