...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno22Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno22Context> _almacenServicio;

        public AlmacenAlumno22Controller(
            IAlmacenService<Alumno22Context> almacenServicio)
        {
