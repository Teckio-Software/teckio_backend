...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno22Controller : ControllerBase
    {
        private readonly IClientesService<Alumno22Context> _Service;

        private readonly ClienteProceso<Alumno22Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno22Context> _clientesCuentasContablesProceso;
        public ClienteAlumno22Controller(
            IClientesService<Alumno22Context> service
            , ClienteProceso<Alumno22Context> proceso,
            ClienteCuentasContablesProceso<Alumno22Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
