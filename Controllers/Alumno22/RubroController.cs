...
namespace ERP_TECKIO
{
    ...
    [Route("api/rubro/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionRubro-Empresa22")]
    public class RubroAlumno22Controller : ControllerBase
    {
        private readonly IRubroService<Alumno22Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno22Controller> Logger;
        ...
        public RubroAlumno22Controller(
            ILogger<RubroAlumno22Controller> logger,
            Alumno22Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno22Context> service
            )
        {
            //_Service = service;
            Logger = logger;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearRubro-Empresa22")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarRubro-Empresa22")]
