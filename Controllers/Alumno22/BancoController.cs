...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno22Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno22Context> _bancoService;

        public BancoAlumno22Controller(IBancoService<Alumno22Context> bancoService)
        {
