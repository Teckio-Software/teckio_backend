...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa22")]
    public class FamiliaInsumoAlumno22Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno22Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno22Controller(
            FamiliaInsumoProceso<Alumno22Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa22")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa22")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa22")]
