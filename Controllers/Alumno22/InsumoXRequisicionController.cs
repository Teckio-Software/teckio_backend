...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno22Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno22Context> _Service;

        private readonly RequisicionProceso<Alumno22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno22Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno22Controller(
            ILogger<InsumoXRequisicionAlumno22Controller> Logger,
            RequisicionProceso<Alumno22Context> Proceso,
            Alumno22Context Context
            , IInsumoXRequisicionService<Alumno22Context> Service)
        {
            _Logger = Logger;
