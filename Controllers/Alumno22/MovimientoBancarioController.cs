...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno22Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno22Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno22Controller(
            MovimientoBancarioProceso<Alumno22Context> movimientoBancarioProceso
            )
        {
