...
namespace ERP_TECKIO
{
    ...
    public class CompraDirectaAlumno22Controller : ControllerBase
    {
        ...
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno22Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno22Controller(
            ILogger<CompraDirectaAlumno22Controller> logger,
            Alumno22Context context
            , ICompraDirectaService<Alumno22Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
