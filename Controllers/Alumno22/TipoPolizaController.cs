...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa22")]
    public class TipoPolizaAlumno22Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno22Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno22Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno22Controller(
            ILogger<TipoPolizaAlumno22Controller> logger,
            Alumno22Context context
            , ITipoPolizaService<Alumno22Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa22")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa22")]
