...
namespace ERP_TECKIO
{
    ...
    public class InsumoAlumno22Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno22Context> _InsumoProceso;
        public InsumoAlumno22Controller(
            InsumoProceso<Alumno22Context> insumoProceso)
        {
            _InsumoProceso = insumoProceso;
        }

        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearInsumo-Empresa22")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarInsumo-Empresa22")]
        ...
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarInsumo-Empresa22")]
