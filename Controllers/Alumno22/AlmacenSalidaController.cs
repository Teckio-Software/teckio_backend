...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno22Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno22Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno22Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno22Controller> Logger;
        ...
        public AlmacenSalidaAlumno22Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno22Controller> logger,
            Alumno22Context context
            , IAlmacenSalidaService<Alumno22Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno22Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno22Context> Proceso
            )
        {
