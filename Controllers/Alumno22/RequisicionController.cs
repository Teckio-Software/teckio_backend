...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno22Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno22Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno22Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno22Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno22Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno22Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno22Controller(
            ILogger<RequisicionAlumno22Controller> Logger
            , Alumno22Context Context
            , IRequisicionService<Alumno22Context> RequisicionService
            , RequisicionProceso<Alumno22Context> Proceso
            , ObjetoRequisicionProceso<Alumno22Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno22Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno22Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
