...
{
    [Route("api/precioUnitarioXEmpleado/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoAlumno22Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno22Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno22Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno22Controller(
            IPrecioUnitarioXEmpleadoService<Alumno22Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno22Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
