...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL20Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL20Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL20Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL20Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL20Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL20Controller> _Logger;
        private readonly DemoTeckioAL20Context _Context;
        private readonly PolizaProceso<DemoTeckioAL20Context> _polizaProceso;
        public PolizaDemoTeckioAL20Controller(
            ILogger<PolizaDemoTeckioAL20Controller> logger
            , DemoTeckioAL20Context context
            , IPolizaService<DemoTeckioAL20Context> service
            , IPolizaDetalleService<DemoTeckioAL20Context> detalleService
            , ITipoPolizaService<DemoTeckioAL20Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL20Context> saldosService
