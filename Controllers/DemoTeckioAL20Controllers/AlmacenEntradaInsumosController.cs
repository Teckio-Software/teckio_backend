...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoDemoTeckioAL20Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoDemoTeckioAL20Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL20Context Context;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL20Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoDemoTeckioAL20Controller(
            ILogger<AlmacenEntradaInsumoDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , IInsumoXAlmacenEntradaService<DemoTeckioAL20Context> AlmacenEntradaDetalle
