...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL20Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL20Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL20Controller(
            ILogger<TipoPolizaDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , ITipoPolizaService<DemoTeckioAL20Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
