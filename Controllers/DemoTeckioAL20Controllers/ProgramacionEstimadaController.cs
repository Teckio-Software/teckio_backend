...
{
    [Route("api/programacionestimada/20")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL20Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL20Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL20Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL20Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL20Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL20Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL20Context> precioUnitarioService,
