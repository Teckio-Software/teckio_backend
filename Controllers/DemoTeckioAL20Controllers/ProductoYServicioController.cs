...
{
    [Route("api/productoyservicio/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL20Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL20Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL20Context> _process;

        public ProductoYServicioDemoTeckioAL20Controller(IProductoYservicioService<DemoTeckioAL20Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL20Context> process
            )
        {
