...
namespace ERP_TECKIO.Controllers.DemoTeckioAL20
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/20")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL20Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL20Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL20Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL20Context> process)
        {
            _service = service;
            _process = process;
        }
