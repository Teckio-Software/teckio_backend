...
namespace ERP_TECKIO.Controllers.DemoTeckioAL20
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL20Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL20Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL20Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL20Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL20Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL20Context> porcentajeCesantiaEdadService
            )
        {
