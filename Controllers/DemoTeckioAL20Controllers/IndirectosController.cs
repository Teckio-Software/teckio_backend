...
{
    [Route("api/indirectos/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL20Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL20Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL20Context> _indirectosProceso;

        public IndirectosDemoTeckioAL20Controller(
                        IConjuntoIndirectosService<DemoTeckioAL20Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL20Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL20Context> indirectosProceso
            )
        {
