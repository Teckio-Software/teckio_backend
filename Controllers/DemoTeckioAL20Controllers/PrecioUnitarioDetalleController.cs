...
namespace SistemaERP.API.DemoTeckioAL20Controllers.Procomi
{
    [Route("api/preciounitariodetalle/20")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL20Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL20Controller(
