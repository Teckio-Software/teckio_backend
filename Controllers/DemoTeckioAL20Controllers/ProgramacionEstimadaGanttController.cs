...
namespace SistemaERP.API.Controllers.DemoTeckioAL20
{
    [Route("api/programacionestimadaGantt/20")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL20Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL20Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL20Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL20Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL20Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL20Context> importeSemanalGanttProceso,
