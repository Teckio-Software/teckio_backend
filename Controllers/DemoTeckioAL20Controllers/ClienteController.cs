...
{
    [Route("api/cliente/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL20Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL20Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL20Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL20Controller(
            IClientesService<DemoTeckioAL20Context> service
            , ClienteProceso<DemoTeckioAL20Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL20Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
