...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL20Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL20Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL20Controller(
            EspecialidadProceso<DemoTeckioAL20Context> especialidadProceso)
        {
