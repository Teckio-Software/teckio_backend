...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL20Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL20Controller(
            ProyectoProceso<DemoTeckioAL20Context> proyectoProceso)
        {
