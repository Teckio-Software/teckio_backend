...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioAL20Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL20Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL20Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL20Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL20Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL20Controller(
            PrecioUnitarioProceso<DemoTeckioAL20Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL20Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL20Context> options,
            ExplocionInsumosProceso<DemoTeckioAL20Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL20Context(_Options.Options))
            {
