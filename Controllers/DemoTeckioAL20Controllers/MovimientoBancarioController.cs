...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/20")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL20Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL20Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL20Controller(
            MovimientoBancarioProceso<DemoTeckioAL20Context> movimientoBancarioProceso
            )
        {
