...
{
    [Route("api/reportesdestajo/20")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL20Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL20Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL20Controller(
            ReporteDestajoProceso<DemoTeckioAL20Context> proceso,
            EstimacionesProceso<DemoTeckioAL20Context> estimacionesProceso
            ) { 
            _proceso = proceso;
