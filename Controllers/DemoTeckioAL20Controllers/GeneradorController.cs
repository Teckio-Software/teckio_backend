...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL20Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL20Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL20Controller(
            GeneradoresProceso<DemoTeckioAL20Context> generadoresProceso)
        {
