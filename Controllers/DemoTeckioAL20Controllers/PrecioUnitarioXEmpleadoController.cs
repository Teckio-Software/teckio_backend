...
{
    [Route("api/precioUnitarioXEmpleado/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL20Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL20Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL20Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL20Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL20Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
