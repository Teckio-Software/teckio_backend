...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoDemoTeckioAL20Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoDemoTeckioAL20Controller(
            ILogger<ExplosionInsumoDemoTeckioAL20Controller> Logger,
