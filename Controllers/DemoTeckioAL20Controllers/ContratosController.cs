...
{
    [Route("api/contratos/20")]
    [ApiController]
    public class ContratosDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL20Context> _contratosProceso;
        public ContratosDemoTeckioAL20Controller(
            ContratosProceso<DemoTeckioAL20Context> contratosProceso
            )
        {
