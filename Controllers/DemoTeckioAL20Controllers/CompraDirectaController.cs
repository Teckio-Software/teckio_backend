...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL20Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL20Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL20Controller(
            ILogger<CompraDirectaDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , ICompraDirectaService<DemoTeckioAL20Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
