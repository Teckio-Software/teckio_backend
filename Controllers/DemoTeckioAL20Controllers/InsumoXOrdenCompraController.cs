...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL20Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL20Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL20Controller> _Logger;
        private readonly DemoTeckioAL20Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL20Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL20Controller> Logger,
            DemoTeckioAL20Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL20Context> Service
