...
{
    [Route("api/cotizacion/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL20Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL20Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL20Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL20Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL20Controller> _Logger;
        private readonly DemoTeckioAL20Context Context;
        public CotizacionDemoTeckioAL20Controller(

            ILogger<CotizacionDemoTeckioAL20Controller> Logger
            , DemoTeckioAL20Context Context
            , ICotizacionService<DemoTeckioAL20Context> Service
            , IOrdenCompraService<DemoTeckioAL20Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL20Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL20Context> Proceso)
        {
            _Logger = Logger;
