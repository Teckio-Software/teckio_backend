...
{
    [Route("api/ordencompra/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL20Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL20Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL20Controller> _Logger;
        private readonly DemoTeckioAL20Context Context;
        private readonly PolizaProceso<DemoTeckioAL20Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL20Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL20Controller(
            ILogger<OrdenCompraDemoTeckioAL20Controller> Logger
            , DemoTeckioAL20Context Context
            , IOrdenCompraService<DemoTeckioAL20Context> Service
            , OrdenCompraProceso<DemoTeckioAL20Context> Proceso
            , PolizaProceso<DemoTeckioAL20Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL20Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
