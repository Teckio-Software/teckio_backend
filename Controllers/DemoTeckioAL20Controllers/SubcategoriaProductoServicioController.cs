...
namespace ERP_TECKIO.Controllers.DemoTeckioAL20
{
    ...
    [Route("api/subcategoriaProductoServicio/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL20Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL20Context> service)
        {
            _service = service;
        }
