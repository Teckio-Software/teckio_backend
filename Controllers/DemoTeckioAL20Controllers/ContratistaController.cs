...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/20")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL20Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL20Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL20Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL20Controller(
            ILogger<ContratistaDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , IContratistaService<DemoTeckioAL20Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL20Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
