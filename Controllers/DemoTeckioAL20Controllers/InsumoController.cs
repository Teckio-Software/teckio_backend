...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL20Context> _InsumoProceso;
        public InsumoDemoTeckioAL20Controller(
            InsumoProceso<DemoTeckioAL20Context> insumoProceso)
        {
