...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL20Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL20Context> _servicio;
        public CuentaBancariaDemoTeckioAL20Controller(CuentaBancariaProceso<DemoTeckioAL20Context> _proceso, ICuentaBancariaService<DemoTeckioAL20Context> _servicio
           )
        {
