...
{
    [Route("api/ordenventa/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL20Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL20Controller(
            OrdenVentaProceso<DemoTeckioAL20Context> ordenVentaProceso
            ) { 
