...
{
    [Route("api/insumoxcotizacion/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL20Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL20Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL20Context> _Proceso;
        private readonly DemoTeckioAL20Context Context;
        public InsumoXCotizacionDemoTeckioAL20Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL20Controller> Logger,
            DemoTeckioAL20Context Context
            , IInsumoXCotizacionService<DemoTeckioAL20Context> Service
