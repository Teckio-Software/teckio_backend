...
{
    [Route("api/factura/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL20Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL20Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL20Controller(
            ObtenFacturaProceso<DemoTeckioAL20Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL20Context> categoriaProductoYServicioService
            )
        {
