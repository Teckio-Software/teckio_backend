...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL20Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL20Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL20Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL20Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL20Controller(
            ILogger<AlmacenEntradaDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , IAlmacenEntradaService<DemoTeckioAL20Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL20Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL20Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
