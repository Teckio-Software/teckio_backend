...
{
    [Route("api/entradaproduccionalmacen/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL20Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL20Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL20Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL20Context> proceso)
        {
            _proceso = proceso;
        }
