...
{
    [Route("api/impuestodetalleordencompra/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ImpuestoDetalleOrdenVentaController: ControllerBase
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL20Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL20Context> process)
        {
            _process = process;
        }
