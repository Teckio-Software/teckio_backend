...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL20Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL20Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL20Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL20Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL20Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL20Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL20Controller(
            ILogger<CuentaContableDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , ICuentaContableService<DemoTeckioAL20Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL20Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL20Context> RubroService
            , CuentaContableProceso<DemoTeckioAL20Context> proceso
            )
        {
            Logger = logger;
            Context = context;
