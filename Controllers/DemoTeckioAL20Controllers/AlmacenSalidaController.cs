...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL20Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL20Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL20Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL20Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL20Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , IAlmacenSalidaService<DemoTeckioAL20Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL20Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL20Context> Proceso
            )
        {
