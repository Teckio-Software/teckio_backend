...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL20Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL20Controller> Logger;
        ...
        public RubroDemoTeckioAL20Controller(
            ILogger<RubroDemoTeckioAL20Controller> logger,
            DemoTeckioAL20Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL20Context> service
            )
        {
            //_Service = service;
            Logger = logger;
