...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL20Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL20Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL20Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL20Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL20Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL20Controller(
            ILogger<RequisicionDemoTeckioAL20Controller> Logger
            , DemoTeckioAL20Context Context
            , IRequisicionService<DemoTeckioAL20Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL20Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL20Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL20Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL20Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/20/970"))
            {
