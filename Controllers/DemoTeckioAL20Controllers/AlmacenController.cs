...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL20Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL20Context> _almacenProceso;
        public AlmacenDemoTeckioAL20Controller(
            IAlmacenService<DemoTeckioAL20Context> almacenServicio, AlmacenProceso<DemoTeckioAL20Context> almacenProceso)
        {
