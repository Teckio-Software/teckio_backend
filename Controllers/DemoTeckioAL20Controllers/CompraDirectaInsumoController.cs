...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa1")]
    public class CompraDirectaInsumoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL20Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL20Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL20Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL20Controller> logger
            , DemoTeckioAL20Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL20Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
