...
{
    [Route("api/empleado/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL20Context> _empleadoService;
        public EmpleadoDemoTeckioAL20Controller(
            IEmpleadoService<DemoTeckioAL20Context> empleadoService
            )
        {
