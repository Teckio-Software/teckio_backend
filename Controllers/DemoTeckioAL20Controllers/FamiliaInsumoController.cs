...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL20Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL20Controller(
            FamiliaInsumoProceso<DemoTeckioAL20Context> familiaInsumoProceso)
        {
