...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL20Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL20Controller(
            TipoInsumoProceso<DemoTeckioAL20Context> tipoInsumoProceso
            )
        {
