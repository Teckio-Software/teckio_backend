...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL20Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL20Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL20Controller> _Logger;
        private readonly DemoTeckioAL20Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL20Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL20Controller> logger
            , DemoTeckioAL20Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL20Context> service
