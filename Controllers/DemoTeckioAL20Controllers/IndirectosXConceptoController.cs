...
{
    [Route("api/indirectosXConcepto/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL20Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL20Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL20Controller(
            IIndirectosXConceptoService<DemoTeckioAL20Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL20Context> indirectosXConceptoProceso
            ) { 
