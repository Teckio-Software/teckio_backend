...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL20Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL20Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL20Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL20Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL20Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL20Controller> Logger,
            RequisicionProceso<DemoTeckioAL20Context> Proceso,
            DemoTeckioAL20Context Context
            , IInsumoXRequisicionService<DemoTeckioAL20Context> Service)
        {
            _Logger = Logger;
