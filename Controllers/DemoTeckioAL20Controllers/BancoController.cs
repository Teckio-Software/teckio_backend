...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL20Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL20Context> _bancoService;

        public BancoDemoTeckioAL20Controller(IBancoService<DemoTeckioAL20Context> bancoService)
        {
