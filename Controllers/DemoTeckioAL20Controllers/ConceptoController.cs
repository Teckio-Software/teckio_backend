...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL20Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL20Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL20Controller(
            ConceptoProceso<DemoTeckioAL20Context> conceptoProceso)
        {
