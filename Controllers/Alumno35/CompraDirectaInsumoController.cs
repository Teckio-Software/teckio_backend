...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/35")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno35Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno35Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno35Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno35Controller(
            ILogger<CompraDirectaInsumoAlumno35Controller> logger
            , Alumno35Context context
            , IInsumoXCompraDirectaService<Alumno35Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
