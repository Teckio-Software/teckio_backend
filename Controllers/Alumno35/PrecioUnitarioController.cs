...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioAlumno35Controller : ControllerBase
    {
        ...
        private readonly IProgramacionEstimadaService<Alumno35Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno35Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno35Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno35Controller(
            PrecioUnitarioProceso<Alumno35Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno35Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno35Context> options,
            ExplocionInsumosProceso<Alumno35Context> explocionInsumosProceso
            )
        {
