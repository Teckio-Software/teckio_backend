...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/35")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno35Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno35Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno35Controller(
            FamiliaInsumoProceso<Alumno35Context> familiaInsumoProceso)
        {
