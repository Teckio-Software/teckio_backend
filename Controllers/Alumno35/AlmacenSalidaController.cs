...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno35Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno35Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno35Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno35Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno35Controller> Logger;
        ...
        public AlmacenSalidaAlumno35Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno35Controller> logger,
            Alumno35Context context
            , IAlmacenSalidaService<Alumno35Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno35Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno35Context> Proceso
            )
        {
