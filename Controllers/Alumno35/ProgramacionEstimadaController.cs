...
{
    [Route("api/programacionestimada/1042")]
    [ApiController]
    public class ProgramacionEstimadaAlumno35Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno35Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno35Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno35Context> _PrecioUnitarioService;


        public ProgramacionEstimadaAlumno35Controller(
            ProgramacionEstimadaProceso<Alumno35Context> programacionEstimadaProceso,
            IProyectoService<Alumno35Context> proyectoProceso,
            IPrecioUnitarioService<Alumno35Context> precioUnitarioService,
