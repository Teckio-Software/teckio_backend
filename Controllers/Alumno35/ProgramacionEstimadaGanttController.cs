...
namespace SistemaERP.API.Controllers.Alumno35
{
    ...
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno35Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno35Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno35Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno35Controller(
            ProgramacionEstimadaGanttProceso<Alumno35Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno35Context> importeSemanalGanttProceso,
