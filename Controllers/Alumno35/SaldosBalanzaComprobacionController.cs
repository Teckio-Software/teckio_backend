...
{
    [Route("api/saldosbalanzacomprobacion/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa1")]
    public class SaldosBalanzaComprobacionAlumno35Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno35Context> _Service;
        private readonly ICuentaContableService<Alumno35Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno35Controller> _Logger;
        private readonly Alumno35Context _Context;
        public SaldosBalanzaComprobacionAlumno35Controller(
            ILogger<SaldosBalanzaComprobacionAlumno35Controller> logger
            , Alumno35Context context
            , ISaldosBalanzaComprobacionService<Alumno35Context> service
