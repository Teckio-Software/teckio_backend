...
{
    [Route("api/empleado/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoAlumno35Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno35Context> _empleadoService;
        public EmpleadoAlumno35Controller(
            IEmpleadoService<Alumno35Context> empleadoService
            )
        {
