...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno35Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno35Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno35Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno35Controller(
            ILogger<ExistenciasAlumno35Controller> Logger,
            Alumno35Context Context
            , IAlmacenExistenciaInsumoService<Alumno35Context> ExistenciaService
            , ExistenciasProceso<Alumno35Context> Proceso
            )
        {
            _Logger = Logger;
