...
{
    [Route("api/contratos/1042")]
    [ApiController]
    public class ContratosAlumno35Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno35Context> _contratosProceso;
        public ContratosAlumno35Controller(
            ContratosProceso<Alumno35Context> contratosProceso
            )
        {
