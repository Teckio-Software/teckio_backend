...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly GeneradoresProceso<Alumno35Context> _GeneradoresProceso;
        public GeneradoresAlumno35Controller(
            GeneradoresProceso<Alumno35Context> generadoresProceso)
        {
