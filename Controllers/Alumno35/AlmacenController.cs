...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno35Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno35Context> _almacenServicio;

        public AlmacenAlumno35Controller(
            IAlmacenService<Alumno35Context> almacenServicio)
        {
