...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/35")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno35Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno35Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno35Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno35Controller(
            ILogger<TipoPolizaAlumno35Controller> logger,
            Alumno35Context context
            , ITipoPolizaService<Alumno35Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
