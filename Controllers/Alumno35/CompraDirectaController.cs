...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/35")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno35Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno35Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno35Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno35Controller(
            ILogger<CompraDirectaAlumno35Controller> logger,
            Alumno35Context context
            , ICompraDirectaService<Alumno35Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
