...
{
    [Route("api/cotizacion/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno35Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno35Context> _Service;
        private readonly CotizacionProceso<Alumno35Context> _Proceso;
        private readonly IOrdenCompraService<Alumno35Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno35Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno35Controller> _Logger;
        private readonly Alumno35Context Context;
        public CotizacionAlumno35Controller(

            ILogger<CotizacionAlumno35Controller> Logger
            , Alumno35Context Context
            , ICotizacionService<Alumno35Context> Service
            , IOrdenCompraService<Alumno35Context> OrdenCompraService,
              ITipoImpuestoService<Alumno35Context> TipoImpuestoService
            , CotizacionProceso<Alumno35Context> Proceso)
        {
            _Logger = Logger;
