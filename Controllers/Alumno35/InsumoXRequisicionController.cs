...
namespace ERP_TECKIO
{
    ...
    {
        private readonly IInsumoXRequisicionService<Alumno35Context> _Service;

        private readonly RequisicionProceso<Alumno35Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno35Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno35Controller(
            ILogger<InsumoXRequisicionAlumno35Controller> Logger,
            RequisicionProceso<Alumno35Context> Proceso,
            Alumno35Context Context
            , IInsumoXRequisicionService<Alumno35Context> Service)
        {
            _Logger = Logger;
