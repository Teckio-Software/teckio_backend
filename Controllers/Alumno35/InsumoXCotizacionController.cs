...
{
    [Route("api/insumoxcotizacion/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno35Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno35Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno35Controller> _Logger;
        private readonly CotizacionProceso<Alumno35Context> _Proceso;
        private readonly Alumno35Context Context;
        public InsumoXCotizacionAlumno35Controller(
            ILogger<InsumoXCotizacionAlumno35Controller> Logger,
            Alumno35Context Context
            , IInsumoXCotizacionService<Alumno35Context> Service
