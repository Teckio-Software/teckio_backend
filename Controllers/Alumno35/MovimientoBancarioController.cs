...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/1042")]
    [ApiController]
    public class MovimientoBancarioAlumno35Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno35Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno35Controller(
            MovimientoBancarioProceso<Alumno35Context> movimientoBancarioProceso
            )
        {
