...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/1042")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno35Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno35Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno35Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno35Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno35Controller(
            ILogger<ContratistaAlumno35Controller> logger,
            Alumno35Context context
            , IContratistaService<Alumno35Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno35Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
