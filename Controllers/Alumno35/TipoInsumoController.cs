...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/35")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno35Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno35Context> _TipoInsumoProceso;

        public TipoInsumoAlumno35Controller(
            TipoInsumoProceso<Alumno35Context> tipoInsumoProceso
            )
        {
