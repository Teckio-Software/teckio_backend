...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly IClientesService<Alumno35Context> _Service;

        private readonly ClienteProceso<Alumno35Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno35Context> _clientesCuentasContablesProceso;
        public ClienteAlumno35Controller(
            IClientesService<Alumno35Context> service
            , ClienteProceso<Alumno35Context> proceso,
            ClienteCuentasContablesProceso<Alumno35Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
