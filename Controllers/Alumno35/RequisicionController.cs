...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/35")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno35Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno35Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno35Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno35Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno35Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno35Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno35Controller(
            ILogger<RequisicionAlumno35Controller> Logger
            , Alumno35Context Context
            , IRequisicionService<Alumno35Context> RequisicionService
            , RequisicionProceso<Alumno35Context> Proceso
            , ObjetoRequisicionProceso<Alumno35Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno35Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno35Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/35/970"))
            {
