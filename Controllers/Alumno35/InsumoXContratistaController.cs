...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/35")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa35")]
    public class InsumoXContratistaAlumno35Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno35Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno35Controller(
            ILogger<InsumoXContratistaAlumno35Controller> logger,
