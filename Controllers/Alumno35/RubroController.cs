...
namespace ERP_TECKIO
{
    ...
    public class RubroAlumno35Controller : ControllerBase
    {
        private readonly IRubroService<Alumno35Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno35Controller> Logger;
        ...
        public RubroAlumno35Controller(
            ILogger<RubroAlumno35Controller> logger,
            Alumno35Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno35Context> service
            )
        {
            //_Service = service;
            Logger = logger;
