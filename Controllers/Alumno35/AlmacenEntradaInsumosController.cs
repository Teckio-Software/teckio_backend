...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno35Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno35Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno35Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno35Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno35Controller(
            ILogger<AlmacenEntradaInsumoAlumno35Controller> logger,
            Alumno35Context context
            , IInsumoXAlmacenEntradaService<Alumno35Context> AlmacenEntradaDetalle
