...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno35Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno35Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno35Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno35Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno35Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno35Controller(
            ILogger<AlmacenEntradaAlumno35Controller> logger,
            Alumno35Context context
            , IAlmacenEntradaService<Alumno35Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno35Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno35Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
