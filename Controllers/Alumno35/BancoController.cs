...
{
    [Route("api/Banco/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class BancoAlumno35Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno35Context> _bancoService;

        public BancoAlumno35Controller(IBancoService<Alumno35Context> bancoService)
        {
