...
namespace ERP_TECKIO
{
    ...
    public class InsumoAlumno35Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno35Context> _InsumoProceso;
        public InsumoAlumno35Controller(
            InsumoProceso<Alumno35Context> insumoProceso)
        {
