...
namespace ERP_TECKIO
{
    ...
    {
        private readonly EspecialidadProceso<Alumno35Context> _EspecialidadProceso;
        public EspecialidadAlumno35Controller(
            EspecialidadProceso<Alumno35Context> especialidadProceso)
        {
