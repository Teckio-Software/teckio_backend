...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno35Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno35Context> _proceso;

        private readonly ICuentaBancariaService<Alumno35Context> _servicio;
        public CuentaBancariaAlumno35Controller(CuentaBancariaProceso<Alumno35Context> _proceso, ICuentaBancariaService<Alumno35Context> _servicio
           )
        {
