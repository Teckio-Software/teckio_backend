...
{
    [Route("api/insumoxordencompra/1042")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno35Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno35Context> _Service;
        private readonly OrdenCompraProceso<Alumno35Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno35Controller> _Logger;
        private readonly Alumno35Context _Context;
        public InsumoXOrdenCompraAlumno35Controller(
            ILogger<InsumoXOrdenCompraAlumno35Controller> Logger,
            Alumno35Context Context
            , IInsumoXOrdenCompraService<Alumno35Context> Service
