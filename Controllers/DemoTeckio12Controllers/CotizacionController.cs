...
{
    [Route("api/cotizacion/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL12Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL12Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL12Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL12Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL12Controller> _Logger;
        private readonly DemoTeckioAL12Context Context;
        public CotizacionDemoTeckioAL12Controller(

            ILogger<CotizacionDemoTeckioAL12Controller> Logger
            , DemoTeckioAL12Context Context
            , ICotizacionService<DemoTeckioAL12Context> Service
            , IOrdenCompraService<DemoTeckioAL12Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL12Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL12Context> Proceso)
        {
            _Logger = Logger;
