...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioAL12Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL12Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL12Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL12Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL12Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL12Controller(
            PrecioUnitarioProceso<DemoTeckioAL12Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL12Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL12Context> options,
            ExplocionInsumosProceso<DemoTeckioAL12Context> explocionInsumosProceso
            )
        {
