...
{
    [Route("api/reportesdestajo/12")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL12Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL12Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL12Controller(
            ReporteDestajoProceso<DemoTeckioAL12Context> proceso,
            EstimacionesProceso<DemoTeckioAL12Context> estimacionesProceso
            ) { 
            _proceso = proceso;
