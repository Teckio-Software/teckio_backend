...
{
    [Route("api/entradaproduccionalmacen/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL12Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL12Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL12Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL12Context> proceso)
        {
            _proceso = proceso;
        }
