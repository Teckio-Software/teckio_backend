...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL12Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL12Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL12Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL12Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL12Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL12Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL12Controller(
            ILogger<CuentaContableDemoTeckioAL12Controller> logger,
            DemoTeckioAL12Context context
            , ICuentaContableService<DemoTeckioAL12Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL12Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL12Context> RubroService
            , CuentaContableProceso<DemoTeckioAL12Context> proceso
            )
        {
            Logger = logger;
            Context = context;
