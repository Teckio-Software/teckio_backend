...
{
    [Route("api/ordencompra/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL12Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL12Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL12Controller> _Logger;
        private readonly DemoTeckioAL12Context Context;
        private readonly PolizaProceso<DemoTeckioAL12Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL12Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL12Controller(
            ILogger<OrdenCompraDemoTeckioAL12Controller> Logger
            , DemoTeckioAL12Context Context
            , IOrdenCompraService<DemoTeckioAL12Context> Service
            , OrdenCompraProceso<DemoTeckioAL12Context> Proceso
            , PolizaProceso<DemoTeckioAL12Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL12Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
