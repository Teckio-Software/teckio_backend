...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL12Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL12Controller> Logger;
        ...
        public RubroDemoTeckioAL12Controller(
            ILogger<RubroDemoTeckioAL12Controller> logger,
            DemoTeckioAL12Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL12Context> service
            )
        {
            //_Service = service;
            Logger = logger;
