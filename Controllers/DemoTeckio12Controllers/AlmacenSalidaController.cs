...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL12Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL12Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL12Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL12Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL12Controller> logger,
            DemoTeckioAL12Context context
            , IAlmacenSalidaService<DemoTeckioAL12Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL12Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL12Context> Proceso
            )
        {
