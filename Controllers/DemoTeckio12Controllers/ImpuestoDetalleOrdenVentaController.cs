...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL12Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL12Context> process)
        {
            _process = process;
        }
