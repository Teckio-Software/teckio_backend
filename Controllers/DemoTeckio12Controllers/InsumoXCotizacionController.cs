...
{
    [Route("api/insumoxcotizacion/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL12Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL12Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL12Context> _Proceso;
        private readonly DemoTeckioAL12Context Context;
        public InsumoXCotizacionDemoTeckioAL12Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL12Controller> Logger,
            DemoTeckioAL12Context Context
            , IInsumoXCotizacionService<DemoTeckioAL12Context> Service
