...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/12")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL12Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL12Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL12Controller(
            MovimientoBancarioProceso<DemoTeckioAL12Context> movimientoBancarioProceso
            )
        {
