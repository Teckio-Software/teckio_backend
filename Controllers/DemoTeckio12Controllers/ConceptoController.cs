...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL12Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL12Controller(
            ConceptoProceso<DemoTeckioAL12Context> conceptoProceso)
        {
