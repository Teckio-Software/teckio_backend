...
{
    [Route("api/cliente/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL12Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL12Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL12Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL12Controller(
            IClientesService<DemoTeckioAL12Context> service
            , ClienteProceso<DemoTeckioAL12Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL12Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
