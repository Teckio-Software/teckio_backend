...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL12Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL12Context> proces)
        {
            _proceso = proces;
        }
