...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL12Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL12Controller(
            TipoInsumoProceso<DemoTeckioAL12Context> tipoInsumoProceso
            )
        {
