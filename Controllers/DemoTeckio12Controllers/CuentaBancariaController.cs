...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL12Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL12Context> _servicio;
        public CuentaBancariaDemoTeckioAL12Controller(CuentaBancariaProceso<DemoTeckioAL12Context> _proceso, ICuentaBancariaService<DemoTeckioAL12Context> _servicio
           )
        {
