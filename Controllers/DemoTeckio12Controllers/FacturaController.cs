...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    public class FacturaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL12Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL12Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL12Controller(
            ObtenFacturaProceso<DemoTeckioAL12Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL12Context> categoriaProductoYServicioService
            )
        {
