...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL12Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL12Context> proces)
        {
            _proceso = proces;
        }
