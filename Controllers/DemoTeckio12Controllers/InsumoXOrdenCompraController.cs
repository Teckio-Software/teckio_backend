...
{
    [Route("api/insumoxordencompra/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL12Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL12Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL12Controller> _Logger;
        private readonly DemoTeckioAL12Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL12Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL12Controller> Logger,
            DemoTeckioAL12Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL12Context> Service
