...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL12Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL12Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL12Controller(
            EspecialidadProceso<DemoTeckioAL12Context> especialidadProceso)
        {
