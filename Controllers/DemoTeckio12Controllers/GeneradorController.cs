...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL12Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL12Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL12Controller(
            GeneradoresProceso<DemoTeckioAL12Context> generadoresProceso)
        {
