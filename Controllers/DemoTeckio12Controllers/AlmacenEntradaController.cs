...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL12Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL12Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL12Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL12Controller(
            ILogger<AlmacenEntradaDemoTeckioAL12Controller> logger,
            DemoTeckioAL12Context context
            , IAlmacenEntradaService<DemoTeckioAL12Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL12Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL12Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
