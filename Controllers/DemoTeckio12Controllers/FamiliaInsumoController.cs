...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL12Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL12Controller(
            FamiliaInsumoProceso<DemoTeckioAL12Context> familiaInsumoProceso)
        {
