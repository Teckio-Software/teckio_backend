...
{
    [Route("api/empleado/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL12Context> _empleadoService;
        public EmpleadoDemoTeckioAL12Controller(
            IEmpleadoService<DemoTeckioAL12Context> empleadoService
            )
        {
