...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/12")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL12Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL12Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL12Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL12Controller(
            ILogger<ContratistaDemoTeckioAL12Controller> logger,
            DemoTeckioAL12Context context
            , IContratistaService<DemoTeckioAL12Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL12Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
