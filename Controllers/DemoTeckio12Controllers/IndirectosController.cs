...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL12Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL12Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL12Context> _indirectosProceso;

        public IndirectosDemoTeckioAL12Controller(
                        IConjuntoIndirectosService<DemoTeckioAL12Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL12Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL12Context> indirectosProceso
            )
        {
