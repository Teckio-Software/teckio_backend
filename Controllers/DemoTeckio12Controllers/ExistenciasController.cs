...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL12Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL12Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL12Controller(
            ILogger<ExistenciasDemoTeckioAL12Controller> Logger,
            DemoTeckioAL12Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL12Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL12Context> Proceso
            )
        {
            _Logger = Logger;
