...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL12Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL12Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL12Controller(
            ILogger<TipoPolizaDemoTeckioAL12Controller> logger,
            DemoTeckioAL12Context context
            , ITipoPolizaService<DemoTeckioAL12Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
