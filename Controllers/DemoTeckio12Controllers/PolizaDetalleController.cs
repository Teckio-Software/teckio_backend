...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDetalleDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<DemoTeckioAL12Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL12Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleDemoTeckioAL12Controller> _Logger;
        private readonly DemoTeckioAL12Context _Context;
        public PolizaDetalleDemoTeckioAL12Controller(
            ILogger<PolizaDetalleDemoTeckioAL12Controller> logger
            , DemoTeckioAL12Context context
            , IPolizaDetalleService<DemoTeckioAL12Context> service
