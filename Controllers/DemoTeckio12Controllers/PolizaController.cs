...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL12Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL12Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL12Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL12Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL12Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL12Controller> _Logger;
        private readonly DemoTeckioAL12Context _Context;
        private readonly PolizaProceso<DemoTeckioAL12Context> _polizaProceso;
        public PolizaDemoTeckioAL12Controller(
            ILogger<PolizaDemoTeckioAL12Controller> logger
            , DemoTeckioAL12Context context
            , IPolizaService<DemoTeckioAL12Context> service
            , IPolizaDetalleService<DemoTeckioAL12Context> detalleService
            , ITipoPolizaService<DemoTeckioAL12Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL12Context> saldosService
