...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    [Route("api/categoriaProductoServicio/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CategoriaProductoYServicioController: ControllerBase
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL12Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL12Context> service)
        {
            _service = service;
        }
