...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL12Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL12Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL12Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL12Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL12Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL12Controller(
            ILogger<RequisicionDemoTeckioAL12Controller> Logger
            , DemoTeckioAL12Context Context
            , IRequisicionService<DemoTeckioAL12Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL12Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL12Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL12Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL12Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/12/1270"))
            {
