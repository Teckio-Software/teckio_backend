...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL12Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL12Controller(
            ProyectoProceso<DemoTeckioAL12Context> proyectoProceso)
        {
