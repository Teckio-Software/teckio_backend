...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL12Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL12Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL12Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL12Context> process)
        {
            _service = service;
            _process = process;
        }
