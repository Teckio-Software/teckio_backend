...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL12Context> _InsumoProceso;
        public InsumoDemoTeckioAL12Controller(
            InsumoProceso<DemoTeckioAL12Context> insumoProceso)
        {
