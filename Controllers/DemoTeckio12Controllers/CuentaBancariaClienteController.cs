...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL12Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL12Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL12Controller(
            ICuentaBancariaClienteService<DemoTeckioAL12Context> cuentaBancariaClienteService,
            CuentaBancariaProceso<DemoTeckioAL12Context> proceso
            )
        {
