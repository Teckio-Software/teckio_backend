...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL12Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL12Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL12Controller(
            ILogger<CompraDirectaDemoTeckioAL12Controller> logger,
            DemoTeckioAL12Context context
            , ICompraDirectaService<DemoTeckioAL12Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
