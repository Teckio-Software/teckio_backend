...
namespace SistemaERP.API.DemoTeckioAL12Controllers.Procomi
{
    [Route("api/preciounitariodetalle/12")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL12Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL12Controller(
