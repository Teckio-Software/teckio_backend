...
{
    [Route("api/indirectosXConcepto/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL12Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL12Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL12Controller(
            IIndirectosXConceptoService<DemoTeckioAL12Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL12Context> indirectosXConceptoProceso
            ) { 
