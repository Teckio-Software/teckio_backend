...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    public class OrdenVentaDemoTeckioAL12Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL12Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL12Controller(
            OrdenVentaProceso<DemoTeckioAL12Context> ordenVentaProceso
            ) { 
