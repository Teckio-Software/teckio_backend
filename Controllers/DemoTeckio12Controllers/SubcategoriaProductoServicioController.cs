...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL12Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL12Context> service)
        {
            _service = service;
        }
