...
namespace ERP_TECKIO.Controllers.DemoTeckioAL12
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL12Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL12Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL12Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL12Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL12Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL12Context> porcentajeCesantiaEdadService
            )
        {
