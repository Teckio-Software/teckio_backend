...
{
    [Route("api/contratos/12")]
    [ApiController]
    public class ContratosDemoTeckioAL12Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL12Context> _contratosProceso;
        public ContratosDemoTeckioAL12Controller(
            ContratosProceso<DemoTeckioAL12Context> contratosProceso
            )
        {
