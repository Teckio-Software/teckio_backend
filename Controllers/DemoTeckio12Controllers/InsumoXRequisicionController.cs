...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/12")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL12Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL12Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL12Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL12Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL12Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL12Controller> Logger,
            RequisicionProceso<DemoTeckioAL12Context> Proceso,
            DemoTeckioAL12Context Context
            , IInsumoXRequisicionService<DemoTeckioAL12Context> Service)
        {
            _Logger = Logger;
