...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno23Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno23Context> _Service;
        private readonly OrdenCompraProceso<Alumno23Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno23Controller> _Logger;
        private readonly Alumno23Context Context;
        private readonly PolizaProceso<Alumno23Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno23Context> _obtenFacturaProceso;

        public OrdenCompraAlumno23Controller(
            ILogger<OrdenCompraAlumno23Controller> Logger
            , Alumno23Context Context
            , IOrdenCompraService<Alumno23Context> Service
            , OrdenCompraProceso<Alumno23Context> Proceso
            , PolizaProceso<Alumno23Context> polizaProceso
            , ObtenFacturaProceso<Alumno23Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
