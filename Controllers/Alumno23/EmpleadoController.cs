...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno23Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno23Context> _empleadoService;
        public EmpleadoAlumno23Controller(
            IEmpleadoService<Alumno23Context> empleadoService
            )
        {
