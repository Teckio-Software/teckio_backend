...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno23Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno23Context> _proceso;
        private readonly EstimacionesProceso<Alumno23Context> _estimacionesProceso;

        public ReporteDestajoAlumno23Controller(
            ReporteDestajoProceso<Alumno23Context> proceso,
            EstimacionesProceso<Alumno23Context> estimacionesProceso
            ) { 
            _proceso = proceso;
