...
namespace ERP_TECKIO.API.Alumno023Controllers.Procomi
{
    [Route("api/estimaciones/23")]
    [ApiController]
    public class EstimacionesAlumno23Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno23Context> _estimacionesProceso;
        public EstimacionesAlumno23Controller(
