...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa23")]
    public class FamiliaInsumoAlumno23Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno23Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno23Controller(
            FamiliaInsumoProceso<Alumno23Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa23")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa23")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa23")]
