...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno23Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno23Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno23Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno23Controller(
            ILogger<ExistenciasAlumno23Controller> Logger,
            Alumno23Context Context
            , IAlmacenExistenciaInsumoService<Alumno23Context> ExistenciaService
            , ExistenciasProceso<Alumno23Context> Proceso
            )
        {
            _Logger = Logger;
