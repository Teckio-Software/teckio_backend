...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno23Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno23Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno23Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno23Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno23Controller(
            ProgramacionEstimadaProceso<Alumno23Context> programacionEstimadaProceso,
            IProyectoService<Alumno23Context> proyectoProceso,
            IPrecioUnitarioService<Alumno23Context> precioUnitarioService,
