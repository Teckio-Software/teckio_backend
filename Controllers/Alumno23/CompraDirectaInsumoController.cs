...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa23")]
    public class CompraDirectaInsumoAlumno23Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno23Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno23Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno23Controller(
            ILogger<CompraDirectaInsumoAlumno23Controller> logger
            , Alumno23Context context
            , IInsumoXCompraDirectaService<Alumno23Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
