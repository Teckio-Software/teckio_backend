...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno23Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno23Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno23Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno23Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno23Controller(
            ILogger<ContratistaAlumno23Controller> logger,
            Alumno23Context context
            , IContratistaService<Alumno23Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno23Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
