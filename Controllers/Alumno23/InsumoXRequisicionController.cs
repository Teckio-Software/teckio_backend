...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno23Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno23Context> _Service;

        private readonly RequisicionProceso<Alumno23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno23Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno23Controller(
            ILogger<InsumoXRequisicionAlumno23Controller> Logger,
            RequisicionProceso<Alumno23Context> Proceso,
            Alumno23Context Context
            , IInsumoXRequisicionService<Alumno23Context> Service)
        {
            _Logger = Logger;
