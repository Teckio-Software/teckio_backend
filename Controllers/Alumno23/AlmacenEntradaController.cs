...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno23Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno23Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno23Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno23Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno23Controller(
            ILogger<AlmacenEntradaAlumno23Controller> logger,
            Alumno23Context context
            , IAlmacenEntradaService<Alumno23Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno23Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno23Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
