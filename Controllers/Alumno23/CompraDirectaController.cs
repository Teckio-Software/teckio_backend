...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa23")]
    public class CompraDirectaAlumno23Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno23Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno23Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno23Controller(
            ILogger<CompraDirectaAlumno23Controller> logger,
            Alumno23Context context
            , ICompraDirectaService<Alumno23Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa23")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa23")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa23")]
