...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa23")]
    public class EspecialIdadXContratistaAlumno23Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno23Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno23Controller(
            ILogger<EspecialIdadXContratistaAlumno23Controller> logger,
