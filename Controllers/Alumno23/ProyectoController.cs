...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/proyecto/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa23")]
    public class ProyectoAlumno23Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno23Context> _ProyectoProceso;
        public ProyectoAlumno23Controller(
            ProyectoProceso<Alumno23Context> proyectoProceso)
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearProyecto-Empresa23")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarProyecto-Empresa23")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarProyecto-Empresa23")]
