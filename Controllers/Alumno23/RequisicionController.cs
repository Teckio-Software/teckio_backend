...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno23Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno23Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno23Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno23Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno23Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno23Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno23Controller(
            ILogger<RequisicionAlumno23Controller> Logger
            , Alumno23Context Context
            , IRequisicionService<Alumno23Context> RequisicionService
            , RequisicionProceso<Alumno23Context> Proceso
            , ObjetoRequisicionProceso<Alumno23Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno23Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
