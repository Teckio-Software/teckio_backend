...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno23Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno23Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno23Controller(
            MovimientoBancarioProceso<Alumno23Context> movimientoBancarioProceso
            )
        {
