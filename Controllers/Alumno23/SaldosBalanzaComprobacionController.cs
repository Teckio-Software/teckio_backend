...
{
    [Route("api/saldosbalanzacomprobacion/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa23")]
    public class SaldosBalanzaComprobacionAlumno23Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno23Context> _Service;
        private readonly ICuentaContableService<Alumno23Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno23Controller> _Logger;
        private readonly Alumno23Context _Context;
        public SaldosBalanzaComprobacionAlumno23Controller(
            ILogger<SaldosBalanzaComprobacionAlumno23Controller> logger
            , Alumno23Context context
            , ISaldosBalanzaComprobacionService<Alumno23Context> service
