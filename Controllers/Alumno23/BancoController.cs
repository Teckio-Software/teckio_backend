...
namespace ERP_TECKIO.API.Controllers.Alumno23
{
    ...
    public class BancoAlumno23Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno23Context> _bancoService;

        public BancoAlumno23Controller(IBancoService<Alumno23Context> bancoService)
        {
