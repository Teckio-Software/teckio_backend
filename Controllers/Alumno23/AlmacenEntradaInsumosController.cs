...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno23Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno23Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno23Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno23Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno23Controller(
            ILogger<AlmacenEntradaInsumoAlumno23Controller> logger,
            Alumno23Context context
            , IInsumoXAlmacenEntradaService<Alumno23Context> AlmacenEntradaDetalle
