...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno23Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno23Context> _Service;
        private readonly IPolizaDetalleService<Alumno23Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno23Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno23Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno23Context> _SaldosService;
        private readonly ILogger<PolizaAlumno23Controller> _Logger;
        private readonly Alumno23Context _Context;
        public PolizaAlumno23Controller(
            ILogger<PolizaAlumno23Controller> logger
            , Alumno23Context context
            , IPolizaService<Alumno23Context> service
            , IPolizaDetalleService<Alumno23Context> detalleService
            , ITipoPolizaService<Alumno23Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno23Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa23")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa23")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa23")]
