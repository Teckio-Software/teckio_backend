...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno23Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno23Context> _proceso;

        private readonly ICuentaBancariaService<Alumno23Context> _servicio;
        public CuentaBancariaAlumno23Controller(CuentaBancariaProceso<Alumno23Context> _proceso, ICuentaBancariaService<Alumno23Context> _servicio
           )
        {
