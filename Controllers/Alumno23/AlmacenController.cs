...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno23Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno23Context> _almacenServicio;

        public AlmacenAlumno23Controller(
            IAlmacenService<Alumno23Context> almacenServicio)
        {
