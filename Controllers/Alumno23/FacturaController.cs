...
namespace ERP_TECKIO.Controllers.Alumno23
{
    ...
    public class FacturaAlumno23Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno23Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno23Context> _categoriaProductoYServicioService;
        public FacturaAlumno23Controller(
            ObtenFacturaProceso<Alumno23Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno23Context> categoriaProductoYServicioService
            )
        {
