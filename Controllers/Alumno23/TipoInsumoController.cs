...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa23")]
    public class TipoInsumoAlumno23Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno23Context> _TipoInsumoProceso;

        public TipoInsumoAlumno23Controller(
            TipoInsumoProceso<Alumno23Context> tipoInsumoProceso
            )
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoInsumo-Empresa23")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoInsumo-Empresa23")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarTipoInsumo-Empresa23")]
