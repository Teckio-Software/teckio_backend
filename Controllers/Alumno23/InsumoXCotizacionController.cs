...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno23Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno23Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno23Controller> _Logger;
        private readonly CotizacionProceso<Alumno23Context> _Proceso;
        private readonly Alumno23Context Context;
        public InsumoXCotizacionAlumno23Controller(
            ILogger<InsumoXCotizacionAlumno23Controller> Logger,
            Alumno23Context Context
            , IInsumoXCotizacionService<Alumno23Context> Service
