...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno23Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno23Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno23Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno23Controller> Logger;
        ...
        public AlmacenSalidaAlumno23Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno23Controller> logger,
            Alumno23Context context
            , IAlmacenSalidaService<Alumno23Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno23Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno23Context> Proceso
            )
        {
