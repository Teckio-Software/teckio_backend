...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno23Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno23Context> _Service;
        private readonly OrdenCompraProceso<Alumno23Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno23Controller> _Logger;
        private readonly Alumno23Context _Context;
        public InsumoXOrdenCompraAlumno23Controller(
            ILogger<InsumoXOrdenCompraAlumno23Controller> Logger,
            Alumno23Context Context
            , IInsumoXOrdenCompraService<Alumno23Context> Service
