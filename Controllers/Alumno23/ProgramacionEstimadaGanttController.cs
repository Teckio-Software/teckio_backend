...
namespace SistemaERP.API.Controllers.Alumno23
{
    [Route("api/programacionestimadaGantt/23")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno23Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno23Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno23Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno23Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno23Controller(
            ProgramacionEstimadaGanttProceso<Alumno23Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno23Context> importeSemanalGanttProceso,
