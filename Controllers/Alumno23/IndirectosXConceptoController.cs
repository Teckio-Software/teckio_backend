...
namespace ERP_TECKIO.API.Controllers.Alumno23
{
    ...
    public class IndirectosXConceptoAlumno23Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno23Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno23Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno23Controller(
            IIndirectosXConceptoService<Alumno23Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno23Context> indirectosXConceptoProceso
            ) { 
