...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa23")]
    public class InsumoXContratistaAlumno23Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno23Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno23Controller(
            ILogger<InsumoXContratistaAlumno23Controller> logger,
