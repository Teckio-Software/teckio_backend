...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno23Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno23Context> _Service;
        private readonly CotizacionProceso<Alumno23Context> _Proceso;
        private readonly IOrdenCompraService<Alumno23Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno23Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno23Controller> _Logger;
        private readonly Alumno23Context Context;
        public CotizacionAlumno23Controller(

            ILogger<CotizacionAlumno23Controller> Logger
            , Alumno23Context Context
            , ICotizacionService<Alumno23Context> Service
            , IOrdenCompraService<Alumno23Context> OrdenCompraService,
              ITipoImpuestoService<Alumno23Context> TipoImpuestoService
            , CotizacionProceso<Alumno23Context> Proceso)
        {
            _Logger = Logger;
