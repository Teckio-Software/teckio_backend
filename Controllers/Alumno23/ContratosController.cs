...
namespace ERP_TECKIO.API.Controllers.Alumno23
{
    ...
    [ApiController]
    public class ContratosAlumno23Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno23Context> _contratosProceso;
        public ContratosAlumno23Controller(
            ContratosProceso<Alumno23Context> contratosProceso
            )
        {
