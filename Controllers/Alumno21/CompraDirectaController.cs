...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa21")]
    public class CompraDirectaAlumno21Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno21Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno21Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno21Controller(
            ILogger<CompraDirectaAlumno21Controller> logger,
            Alumno21Context context
            , ICompraDirectaService<Alumno21Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa21")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa21")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa21")]
