...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno21Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno21Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno21Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno21Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno21Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno21Controller(
            ILogger<AlmacenEntradaAlumno21Controller> logger,
            Alumno21Context context
            , IAlmacenEntradaService<Alumno21Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno21Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno21Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
