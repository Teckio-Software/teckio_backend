...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa21")]
    public class EspecialIdadXContratistaAlumno21Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno21Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno21Controller(
            ILogger<EspecialIdadXContratistaAlumno21Controller> logger,
