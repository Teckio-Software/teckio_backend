...
namespace ERP_TECKIO.Controllers.Alumno21
{
    ...
    public class FacturaAlumno21Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno21Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno21Context> _categoriaProductoYServicioService;
        public FacturaAlumno21Controller(
            ObtenFacturaProceso<Alumno21Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno21Context> categoriaProductoYServicioService
            )
        {
