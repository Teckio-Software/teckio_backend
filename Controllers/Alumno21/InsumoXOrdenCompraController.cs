...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno21Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno21Context> _Service;
        private readonly OrdenCompraProceso<Alumno21Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno21Controller> _Logger;
        private readonly Alumno21Context _Context;
        public InsumoXOrdenCompraAlumno21Controller(
            ILogger<InsumoXOrdenCompraAlumno21Controller> Logger,
            Alumno21Context Context
            , IInsumoXOrdenCompraService<Alumno21Context> Service
