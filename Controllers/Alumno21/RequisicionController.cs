...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno21Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno21Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno21Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno21Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno21Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno21Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno21Controller(
            ILogger<RequisicionAlumno21Controller> Logger
            , Alumno21Context Context
            , IRequisicionService<Alumno21Context> RequisicionService
            , RequisicionProceso<Alumno21Context> Proceso
            , ObjetoRequisicionProceso<Alumno21Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno21Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
