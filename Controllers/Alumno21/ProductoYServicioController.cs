...
namespace ERP_TECKIO.Controllers.Alumno21
{
    ...
    public class ProductoYServicioAlumno21Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno21Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno21Context> _process;

        public ProductoYServicioAlumno21Controller(IProductoYservicioService<Alumno21Context> productoYServicioService,
            ProductoYServicioProceso<Alumno21Context> process
            )
        {
