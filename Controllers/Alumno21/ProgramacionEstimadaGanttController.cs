...
namespace SistemaERP.API.Controllers.Alumno21
{
    [Route("api/programacionestimadaGantt/21")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno21Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno21Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno21Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno21Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno21Controller(
            ProgramacionEstimadaGanttProceso<Alumno21Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno21Context> importeSemanalGanttProceso,
