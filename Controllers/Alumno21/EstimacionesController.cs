...
namespace ERP_TECKIO.API.Alumno021Controllers.Procomi
{
    [Route("api/estimaciones/21")]
    [ApiController]
    public class EstimacionesAlumno21Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno21Context> _estimacionesProceso;
        public EstimacionesAlumno21Controller(
