...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno21Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno21Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno21Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno21Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno21Controller(
            ProgramacionEstimadaProceso<Alumno21Context> programacionEstimadaProceso,
            IProyectoService<Alumno21Context> proyectoProceso,
            IPrecioUnitarioService<Alumno21Context> precioUnitarioService,
