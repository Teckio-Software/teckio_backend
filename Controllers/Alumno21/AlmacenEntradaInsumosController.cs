...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno21Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno21Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno21Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno21Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno21Controller(
            ILogger<AlmacenEntradaInsumoAlumno21Controller> logger,
            Alumno21Context context
            , IInsumoXAlmacenEntradaService<Alumno21Context> AlmacenEntradaDetalle
