...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno21Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno21Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno21Controller> _Logger;
        private readonly CotizacionProceso<Alumno21Context> _Proceso;
        private readonly Alumno21Context Context;
        public InsumoXCotizacionAlumno21Controller(
            ILogger<InsumoXCotizacionAlumno21Controller> Logger,
            Alumno21Context Context
            , IInsumoXCotizacionService<Alumno21Context> Service
