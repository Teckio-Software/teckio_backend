...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno21Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno21Context> _Service;

        private readonly RequisicionProceso<Alumno21Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno21Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno21Controller(
            ILogger<InsumoXRequisicionAlumno21Controller> Logger,
            RequisicionProceso<Alumno21Context> Proceso,
            Alumno21Context Context
            , IInsumoXRequisicionService<Alumno21Context> Service)
        {
            _Logger = Logger;
