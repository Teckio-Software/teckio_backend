...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno21Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno21Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno21Controller(
            MovimientoBancarioProceso<Alumno21Context> movimientoBancarioProceso
            )
        {
