...
namespace ERP_TECKIO.Controllers.Alumno21
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno21Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno21Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno21Context> service, InsumoXProductoYServicioProceso<Alumno21Context> process)
        {
            _service = service;
            _process = process;
        }
