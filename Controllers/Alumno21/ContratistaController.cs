...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno21Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno21Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno21Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno21Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno21Controller(
            ILogger<ContratistaAlumno21Controller> logger,
            Alumno21Context context
            , IContratistaService<Alumno21Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno21Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
