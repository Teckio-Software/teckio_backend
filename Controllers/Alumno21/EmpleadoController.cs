...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno21Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno21Context> _empleadoService;
        public EmpleadoAlumno21Controller(
            IEmpleadoService<Alumno21Context> empleadoService
            )
        {
