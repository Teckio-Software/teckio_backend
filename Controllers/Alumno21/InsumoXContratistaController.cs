...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa21")]
    public class InsumoXContratistaAlumno21Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno21Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno21Controller(
            ILogger<InsumoXContratistaAlumno21Controller> logger,
