...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno21Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno21Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno21Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno21Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno21Controller> Logger;
        ...
        public AlmacenSalidaAlumno21Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno21Controller> logger,
            Alumno21Context context
            , IAlmacenSalidaService<Alumno21Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno21Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno21Context> Proceso
            )
        {
