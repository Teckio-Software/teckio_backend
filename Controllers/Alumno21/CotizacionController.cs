...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno21Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno21Context> _Service;
        private readonly CotizacionProceso<Alumno21Context> _Proceso;
        private readonly IOrdenCompraService<Alumno21Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno21Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno21Controller> _Logger;
        private readonly Alumno21Context Context;
        public CotizacionAlumno21Controller(

            ILogger<CotizacionAlumno21Controller> Logger
            , Alumno21Context Context
            , ICotizacionService<Alumno21Context> Service
            , IOrdenCompraService<Alumno21Context> OrdenCompraService,
              ITipoImpuestoService<Alumno21Context> TipoImpuestoService
            , CotizacionProceso<Alumno21Context> Proceso)
        {
            _Logger = Logger;
