...
namespace ERP_TECKIO.Controllers.Alumno21
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno21Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno21Context> process)
        {
            _process = process;
        }
