...
namespace ERP_TECKIO.Controllers.Alumno21
{
    ...
    public class FactorSalarioRealController : ControllerBase
    {
        ...
        private readonly IParametrosFsrService<Alumno21Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno21Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno21Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno21Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno21Context> porcentajeCesantiaEdadService
            )
        {
