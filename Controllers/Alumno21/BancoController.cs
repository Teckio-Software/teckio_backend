...
namespace ERP_TECKIO.API.Controllers.Alumno21
{
    ...
    public class BancoAlumno21Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno21Context> _bancoService;

        public BancoAlumno21Controller(IBancoService<Alumno21Context> bancoService)
        {
