...
namespace ERP_TECKIO.API.Controllers.Alumno21
{
    ...
    public class IndirectosAlumno21Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno21Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno21Context> _indirectosService;
        private readonly IndirectosProceso<Alumno21Context> _indirectosProceso;

        public IndirectosAlumno21Controller(
                        IConjuntoIndirectosService<Alumno21Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno21Context> indirectosService,
                        IndirectosProceso<Alumno21Context> indirectosProceso
            )
        {
