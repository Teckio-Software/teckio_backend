...
namespace ERP_TECKIO
{
    ...
    public class CompraDirectaInsumoAlumno21Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno21Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno21Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno21Controller(
            ILogger<CompraDirectaInsumoAlumno21Controller> logger
            , Alumno21Context context
            , IInsumoXCompraDirectaService<Alumno21Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
