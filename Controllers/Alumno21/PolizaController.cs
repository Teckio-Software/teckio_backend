...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno21Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno21Context> _Service;
        private readonly IPolizaDetalleService<Alumno21Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno21Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno21Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno21Context> _SaldosService;
        private readonly ILogger<PolizaAlumno21Controller> _Logger;
        private readonly Alumno21Context _Context;
        public PolizaAlumno21Controller(
            ILogger<PolizaAlumno21Controller> logger
            , Alumno21Context context
            , IPolizaService<Alumno21Context> service
            , IPolizaDetalleService<Alumno21Context> detalleService
            , ITipoPolizaService<Alumno21Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno21Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa21")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa21")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa21")]
