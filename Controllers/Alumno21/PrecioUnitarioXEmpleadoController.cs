...
namespace ERP_TECKIO.Controllers.Alumno21
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno21Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno21Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno21Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno21Controller(
            IPrecioUnitarioXEmpleadoService<Alumno21Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno21Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
