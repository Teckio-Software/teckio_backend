...
namespace ERP_TECKIO.Controllers.Alumno21
{
    ...
    public class OrdenVentaAlumno21Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno21Context> _ordenVentaProceso;
        public OrdenVentaAlumno21Controller(
            OrdenVentaProceso<Alumno21Context> ordenVentaProceso
            ) { 
