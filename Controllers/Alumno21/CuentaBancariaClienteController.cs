...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteAlumno21Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno21Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno21Context> _proceso;

        public CuentaBancariaClienteAlumno21Controller(
            ICuentaBancariaClienteService<Alumno21Context> cuentaBancariaClienteService,
