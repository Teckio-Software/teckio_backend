...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno21Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno21Context> _almacenServicio;

        public AlmacenAlumno21Controller(
            IAlmacenService<Alumno21Context> almacenServicio)
        {
