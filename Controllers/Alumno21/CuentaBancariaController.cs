...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno21Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno21Context> _proceso;

        private readonly ICuentaBancariaService<Alumno21Context> _servicio;
        public CuentaBancariaAlumno21Controller(CuentaBancariaProceso<Alumno21Context> _proceso, ICuentaBancariaService<Alumno21Context> _servicio
           )
        {
