...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno04Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno04Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno04Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno04Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno04Controller(
            ILogger<AlmacenEntradaInsumoAlumno04Controller> logger,
            Alumno04Context context
            , IInsumoXAlmacenEntradaService<Alumno04Context> AlmacenEntradaDetalle
