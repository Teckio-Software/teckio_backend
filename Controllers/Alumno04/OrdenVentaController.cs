...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    public class OrdenVentaAlumno04Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno04Context> _ordenVentaProceso;
        public OrdenVentaAlumno04Controller(
            OrdenVentaProceso<Alumno04Context> ordenVentaProceso
            ) { 
