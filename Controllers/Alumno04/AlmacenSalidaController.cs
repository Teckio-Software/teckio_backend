...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno04Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno04Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno04Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno04Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno04Controller> Logger;
        ...
        public AlmacenSalidaAlumno04Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno04Controller> logger,
            Alumno04Context context
            , IAlmacenSalidaService<Alumno04Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno04Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno04Context> Proceso
            )
        {
