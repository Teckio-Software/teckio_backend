...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno04Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno04Context> _proceso;
        private readonly EstimacionesProceso<Alumno04Context> _estimacionesProceso;

        public ReporteDestajoAlumno04Controller(
            ReporteDestajoProceso<Alumno04Context> proceso,
