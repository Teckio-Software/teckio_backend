...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/proyecto/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa4")]
    public class ProyectoAlumno04Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno04Context> _ProyectoProceso;
        public ProyectoAlumno04Controller(
            ProyectoProceso<Alumno04Context> proyectoProceso)
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearProyecto-Empresa4")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarProyecto-Empresa4")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarProyecto-Empresa4")]
