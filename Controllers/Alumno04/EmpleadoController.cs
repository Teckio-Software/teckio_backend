...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno04Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno04Context> _empleadoService;
        public EmpleadoAlumno04Controller(
            IEmpleadoService<Alumno04Context> empleadoService
            )
        {
