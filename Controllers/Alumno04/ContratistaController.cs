...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno04Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno04Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno04Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno04Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno04Controller(
            ILogger<ContratistaAlumno04Controller> logger,
            Alumno04Context context
            , IContratistaService<Alumno04Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno04Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
