...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno04Controller : ControllerBase
    {
        private readonly IClientesService<Alumno04Context> _Service;

        private readonly ClienteProceso<Alumno04Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno04Context> _clientesCuentasContablesProceso;
        public ClienteAlumno04Controller(
            IClientesService<Alumno04Context> service
            , ClienteProceso<Alumno04Context> proceso,
            ClienteCuentasContablesProceso<Alumno04Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
