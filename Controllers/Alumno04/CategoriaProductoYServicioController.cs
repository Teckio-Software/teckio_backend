...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno04Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno04Context> service)
        {
            _service = service;
        }
