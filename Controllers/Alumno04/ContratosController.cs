...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno04Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno04Context> _contratosProceso;
        public ContratosAlumno04Controller(
            ContratosProceso<Alumno04Context> contratosProceso
            )
        {
