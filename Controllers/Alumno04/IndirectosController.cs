...
{
    [Route("api/indirectos/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno04Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno04Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno04Context> _indirectosService;
        private readonly IndirectosProceso<Alumno04Context> _indirectosProceso;

        public IndirectosAlumno04Controller(
                        IConjuntoIndirectosService<Alumno04Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno04Context> indirectosService,
                        IndirectosProceso<Alumno04Context> indirectosProceso
            )
        {
