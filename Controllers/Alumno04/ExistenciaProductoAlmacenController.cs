...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno04Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno04Context> proces)
        {
            _proceso = proces;
        }
