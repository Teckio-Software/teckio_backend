...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    public class ProductoYServicioAlumno04Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno04Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno04Context> _process;

        public ProductoYServicioAlumno04Controller(IProductoYservicioService<Alumno04Context> productoYServicioService,
            ProductoYServicioProceso<Alumno04Context> process
            )
        {
