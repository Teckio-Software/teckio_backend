...
namespace ERP_TECKIO.Controllers.Alumno04
{
    [Route("api/fsr/4")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno04Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno04Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno04Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno04Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno04Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno04Context> porcentajeCesantiaEdadService
            )
        {
