...
namespace SistemaERP.API.Controllers.Alumno04
{
    [Route("api/programacionestimadaGantt/4")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno04Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno04Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno04Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno04Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno04Controller(
            ProgramacionEstimadaGanttProceso<Alumno04Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno04Context> importeSemanalGanttProceso,
