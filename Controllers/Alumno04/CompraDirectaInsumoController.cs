...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa4")]
    public class CompraDirectaInsumoAlumno04Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno04Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno04Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno04Controller(
            ILogger<CompraDirectaInsumoAlumno04Controller> logger
            , Alumno04Context context
            , IInsumoXCompraDirectaService<Alumno04Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
