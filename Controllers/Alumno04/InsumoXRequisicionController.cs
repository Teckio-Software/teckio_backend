...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno04Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno04Context> _Service;

        private readonly RequisicionProceso<Alumno04Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno04Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno04Controller(
            ILogger<InsumoXRequisicionAlumno04Controller> Logger,
            RequisicionProceso<Alumno04Context> Proceso,
            Alumno04Context Context
            , IInsumoXRequisicionService<Alumno04Context> Service)
        {
            _Logger = Logger;
