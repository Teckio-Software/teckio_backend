...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirecta/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa4")]
    public class CompraDirectaAlumno04Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno04Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno04Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno04Controller(
            ILogger<CompraDirectaAlumno04Controller> logger,
            Alumno04Context context
            , ICompraDirectaService<Alumno04Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa4")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa4")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa4")]
