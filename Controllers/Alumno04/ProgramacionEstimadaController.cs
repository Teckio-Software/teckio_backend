...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno04Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno04Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno04Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno04Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno04Controller(
            ProgramacionEstimadaProceso<Alumno04Context> programacionEstimadaProceso,
            IProyectoService<Alumno04Context> proyectoProceso,
            IPrecioUnitarioService<Alumno04Context> precioUnitarioService,
