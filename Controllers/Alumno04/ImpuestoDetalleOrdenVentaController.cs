...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno04Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno04Context> process)
        {
            _process = process;
        }
