...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno04Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno04Context> _bancoService;

        public BancoAlumno04Controller(IBancoService<Alumno04Context> bancoService)
        {
