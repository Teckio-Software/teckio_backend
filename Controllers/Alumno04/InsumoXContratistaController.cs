...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa4")]
    public class InsumoXContratistaAlumno04Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno04Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno04Controller(
            ILogger<InsumoXContratistaAlumno04Controller> logger,
