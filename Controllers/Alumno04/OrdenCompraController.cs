...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno04Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno04Context> _Service;
        private readonly OrdenCompraProceso<Alumno04Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno04Controller> _Logger;
        private readonly Alumno04Context Context;
        private readonly PolizaProceso<Alumno04Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno04Context> _obtenFacturaProceso;

        public OrdenCompraAlumno04Controller(
            ILogger<OrdenCompraAlumno04Controller> Logger
            , Alumno04Context Context
            , IOrdenCompraService<Alumno04Context> Service
            , OrdenCompraProceso<Alumno04Context> Proceso
            , PolizaProceso<Alumno04Context> polizaProceso
            , ObtenFacturaProceso<Alumno04Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
