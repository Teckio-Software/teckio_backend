...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa4")]
    public class TipoInsumoAlumno04Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno04Context> _TipoInsumoProceso;

        public TipoInsumoAlumno04Controller(
            TipoInsumoProceso<Alumno04Context> tipoInsumoProceso
            )
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoInsumo-Empresa4")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoInsumo-Empresa4")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarTipoInsumo-Empresa4")]
