...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa4")]
    public class EspecialIdadXContratistaAlumno04Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno04Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno04Controller(
            ILogger<EspecialIdadXContratistaAlumno04Controller> logger,
