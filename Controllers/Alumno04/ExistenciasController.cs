...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno04Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno04Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno04Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno04Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno04Controller(
            ILogger<ExistenciasAlumno04Controller> Logger,
            Alumno04Context Context
            , IAlmacenExistenciaInsumoService<Alumno04Context> ExistenciaService
            , ExistenciasProceso<Alumno04Context> Proceso
            )
        {
            _Logger = Logger;
