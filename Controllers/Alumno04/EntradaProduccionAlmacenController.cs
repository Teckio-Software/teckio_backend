...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EntradaProduccionAlmacenAlumno04Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<Alumno04Context> _proceso;

        public EntradaProduccionAlmacenAlumno04Controller(EntradaProduccionAlmacenProceso<Alumno04Context> proceso)
        {
            _proceso = proceso;
        }
