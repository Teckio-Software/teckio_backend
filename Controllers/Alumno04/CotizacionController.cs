...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno04Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno04Context> _Service;
        private readonly CotizacionProceso<Alumno04Context> _Proceso;
        private readonly IOrdenCompraService<Alumno04Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno04Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno04Controller> _Logger;
        private readonly Alumno04Context Context;
        public CotizacionAlumno04Controller(

            ILogger<CotizacionAlumno04Controller> Logger
            , Alumno04Context Context
            , ICotizacionService<Alumno04Context> Service
            , IOrdenCompraService<Alumno04Context> OrdenCompraService,
              ITipoImpuestoService<Alumno04Context> TipoImpuestoService
