...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    public class FacturaAlumno04Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno04Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno04Context> _categoriaProductoYServicioService;
        public FacturaAlumno04Controller(
            ObtenFacturaProceso<Alumno04Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno04Context> categoriaProductoYServicioService
            )
        {
