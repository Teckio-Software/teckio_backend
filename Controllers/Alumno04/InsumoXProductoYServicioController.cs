...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno04Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno04Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno04Context> service, InsumoXProductoYServicioProceso<Alumno04Context> process)
        {
            _service = service;
            _process = process;
        }
