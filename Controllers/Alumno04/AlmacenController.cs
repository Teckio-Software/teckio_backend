...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno04Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno04Context> _almacenServicio;

        public AlmacenAlumno04Controller(
            IAlmacenService<Alumno04Context> almacenServicio)
        {
