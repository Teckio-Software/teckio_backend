...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno04Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno04Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno04Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno04Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno04Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno04Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno04Controller(
            ILogger<RequisicionAlumno04Controller> Logger
            , Alumno04Context Context
            , IRequisicionService<Alumno04Context> RequisicionService
            , RequisicionProceso<Alumno04Context> Proceso
            , ObjetoRequisicionProceso<Alumno04Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno04Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
