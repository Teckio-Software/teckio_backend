...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/familiainsumo/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa4")]
    public class FamiliaInsumoAlumno04Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno04Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno04Controller(
            FamiliaInsumoProceso<Alumno04Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa4")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa4")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa4")]
