...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno04Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno04Context> service)
        {
            _service = service;
        }
