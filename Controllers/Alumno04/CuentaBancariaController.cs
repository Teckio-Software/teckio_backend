...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno04Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno04Context> _proceso;

        private readonly ICuentaBancariaService<Alumno04Context> _servicio;
        public CuentaBancariaAlumno04Controller(CuentaBancariaProceso<Alumno04Context> _proceso, ICuentaBancariaService<Alumno04Context> _servicio
           )
        {
