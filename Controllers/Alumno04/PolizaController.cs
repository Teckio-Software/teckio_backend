...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaAlumno04Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno04Context> _Service;
        private readonly IPolizaDetalleService<Alumno04Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno04Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno04Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno04Context> _SaldosService;
        private readonly ILogger<PolizaAlumno04Controller> _Logger;
        private readonly Alumno04Context _Context;
        public PolizaAlumno04Controller(
            ILogger<PolizaAlumno04Controller> logger
            , Alumno04Context context
            , IPolizaService<Alumno04Context> service
            , IPolizaDetalleService<Alumno04Context> detalleService
            , ITipoPolizaService<Alumno04Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno04Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa4")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa4")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa4")]
