...
namespace ERP_TECKIO.Controllers.Alumno04
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno04Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno04Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno04Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno04Controller(
            IPrecioUnitarioXEmpleadoService<Alumno04Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno04Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
