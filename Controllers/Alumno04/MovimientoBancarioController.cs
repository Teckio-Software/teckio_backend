...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno04Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno04Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno04Controller(
            MovimientoBancarioProceso<Alumno04Context> movimientoBancarioProceso
            )
        {
