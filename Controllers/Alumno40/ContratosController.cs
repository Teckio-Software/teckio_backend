...
{
    [Route("api/contratos/1040")]
    [ApiController]
    public class ContratosAlumno40Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno40Context> _contratosProceso;
        public ContratosAlumno40Controller(
            ContratosProceso<Alumno40Context> contratosProceso
            )
        {
