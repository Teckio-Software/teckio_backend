...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly IContratistaService<Alumno40Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno40Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno40Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno40Controller(
            ILogger<ContratistaAlumno40Controller> logger,
            Alumno40Context context
            , IContratistaService<Alumno40Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno40Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
