...
{
    [Route("api/factura/40")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaAlumno40Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno40Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno40Context> _categoriaProductoYServicioService;
        public FacturaAlumno40Controller(
            ObtenFacturaProceso<Alumno40Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno40Context> categoriaProductoYServicioService
            )
        {
