...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly MovimientoBancarioProceso<Alumno40Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno40Controller(
            MovimientoBancarioProceso<Alumno40Context> movimientoBancarioProceso
            )
        {
