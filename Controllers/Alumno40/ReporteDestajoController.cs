...
{
    [Route("api/reportesdestajo/1040")]
    [ApiController]
    public class ReporteDestajoAlumno40Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno40Context> _proceso;
        private readonly EstimacionesProceso<Alumno40Context> _estimacionesProceso;

        public ReporteDestajoAlumno40Controller(
            ReporteDestajoProceso<Alumno40Context> proceso,
            EstimacionesProceso<Alumno40Context> estimacionesProceso
            ) { 
            _proceso = proceso;
