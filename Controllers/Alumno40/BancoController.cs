...
{
    [Route("api/Banco/1040")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class BancoAlumno40Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno40Context> _bancoService;

        public BancoAlumno40Controller(IBancoService<Alumno40Context> bancoService)
        {
