...
{
    [Route("api/programacionestimada/1040")]
    [ApiController]
    public class ProgramacionEstimadaAlumno40Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno40Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno40Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno40Context> _PrecioUnitarioService;


        public ProgramacionEstimadaAlumno40Controller(
            ProgramacionEstimadaProceso<Alumno40Context> programacionEstimadaProceso,
            IProyectoService<Alumno40Context> proyectoProceso,
            IPrecioUnitarioService<Alumno40Context> precioUnitarioService,
