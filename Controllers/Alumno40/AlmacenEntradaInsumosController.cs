...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/1040")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno40Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno40Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno40Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno40Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno40Controller(
            ILogger<AlmacenEntradaInsumoAlumno40Controller> logger,
            Alumno40Context context
            , IInsumoXAlmacenEntradaService<Alumno40Context> AlmacenEntradaDetalle
