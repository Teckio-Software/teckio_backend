...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly IAlmacenSalidaService<Alumno40Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno40Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno40Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno40Controller> Logger;
        ...
        public AlmacenSalidaAlumno40Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno40Controller> logger,
            Alumno40Context context
            , IAlmacenSalidaService<Alumno40Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno40Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno40Context> Proceso
            )
        {
