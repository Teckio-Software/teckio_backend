...
{
    [Route("api/insumoxcotizacion/1040")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno40Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno40Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno40Controller> _Logger;
        private readonly CotizacionProceso<Alumno40Context> _Proceso;
        private readonly Alumno40Context Context;
        public InsumoXCotizacionAlumno40Controller(
            ILogger<InsumoXCotizacionAlumno40Controller> Logger,
            Alumno40Context Context
            , IInsumoXCotizacionService<Alumno40Context> Service
