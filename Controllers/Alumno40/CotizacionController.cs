...
{
    [Route("api/cotizacion/1040")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno40Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno40Context> _Service;
        private readonly CotizacionProceso<Alumno40Context> _Proceso;
        private readonly IOrdenCompraService<Alumno40Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno40Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno40Controller> _Logger;
        private readonly Alumno40Context Context;
        public CotizacionAlumno40Controller(

            ILogger<CotizacionAlumno40Controller> Logger
            , Alumno40Context Context
            , ICotizacionService<Alumno40Context> Service
            , IOrdenCompraService<Alumno40Context> OrdenCompraService,
              ITipoImpuestoService<Alumno40Context> TipoImpuestoService
            , CotizacionProceso<Alumno40Context> Proceso)
        {
            _Logger = Logger;
