...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly IAlmacenEntradaService<Alumno40Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno40Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno40Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno40Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno40Controller(
            ILogger<AlmacenEntradaAlumno40Controller> logger,
            Alumno40Context context
            , IAlmacenEntradaService<Alumno40Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno40Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno40Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
