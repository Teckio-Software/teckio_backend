...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno40Controller : ControllerBase
    {
        ...
        private readonly ICuentaBancariaService<Alumno40Context> _servicio;
        public CuentaBancariaAlumno40Controller(CuentaBancariaProceso<Alumno40Context> _proceso, ICuentaBancariaService<Alumno40Context> _servicio
           )
        {
