...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioAlumno40Controller : ControllerBase
    {
        ...
        private readonly IProgramacionEstimadaService<Alumno40Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno40Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno40Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno40Controller(
            PrecioUnitarioProceso<Alumno40Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno40Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno40Context> options,
            ExplocionInsumosProceso<Alumno40Context> explocionInsumosProceso
            )
        {
