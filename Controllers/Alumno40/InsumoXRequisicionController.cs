...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/1040")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno40Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno40Context> _Service;

        private readonly RequisicionProceso<Alumno40Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno40Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno40Controller(
            ILogger<InsumoXRequisicionAlumno40Controller> Logger,
            RequisicionProceso<Alumno40Context> Proceso,
            Alumno40Context Context
            , IInsumoXRequisicionService<Alumno40Context> Service)
        {
            _Logger = Logger;
