...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly IRequisicionService<Alumno40Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno40Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno40Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno40Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno40Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno40Controller(
            ILogger<RequisicionAlumno40Controller> Logger
            , Alumno40Context Context
            , IRequisicionService<Alumno40Context> RequisicionService
            , RequisicionProceso<Alumno40Context> Proceso
            , ObjetoRequisicionProceso<Alumno40Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno40Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
