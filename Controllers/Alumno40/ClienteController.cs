...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno40Controller : ControllerBase
    {
        ...
        private readonly ClienteCuentasContablesProceso<Alumno40Context> _clientesCuentasContablesProceso;
        public ClienteAlumno40Controller(
            IClientesService<Alumno40Context> service
            , ClienteProceso<Alumno40Context> proceso,
            ClienteCuentasContablesProceso<Alumno40Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
