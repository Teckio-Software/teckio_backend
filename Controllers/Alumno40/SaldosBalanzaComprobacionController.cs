...
{
    [Route("api/saldosbalanzacomprobacion/1040")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa1")]
    public class SaldosBalanzaComprobacionAlumno40Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno40Context> _Service;
        private readonly ICuentaContableService<Alumno40Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno40Controller> _Logger;
        private readonly Alumno40Context _Context;
        public SaldosBalanzaComprobacionAlumno40Controller(
            ILogger<SaldosBalanzaComprobacionAlumno40Controller> logger
            , Alumno40Context context
            , ISaldosBalanzaComprobacionService<Alumno40Context> service
