...
{
    [Route("api/programacionestimadaGantt/1040")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno40Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno40Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno40Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno40Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno40Controller(
            ProgramacionEstimadaGanttProceso<Alumno40Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno40Context> importeSemanalGanttProceso,
