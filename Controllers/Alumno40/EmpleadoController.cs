...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno40Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno40Context> _empleadoService;
        public EmpleadoAlumno40Controller(
            IEmpleadoService<Alumno40Context> empleadoService
            )
        {
