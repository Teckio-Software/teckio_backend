...
{
    [Route("api/reportesdestajo/4")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL04Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL04Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL04Controller(
            ReporteDestajoProceso<DemoTeckioAL04Context> proceso,
            EstimacionesProceso<DemoTeckioAL04Context> estimacionesProceso
            ) { 
            _proceso = proceso;
