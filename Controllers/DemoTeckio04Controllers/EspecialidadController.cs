...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL04Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL04Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL04Controller(
            EspecialidadProceso<DemoTeckioAL04Context> especialidadProceso)
        {
