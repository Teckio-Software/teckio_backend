...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL04Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL04Controller(
            TipoInsumoProceso<DemoTeckioAL04Context> tipoInsumoProceso
            )
        {
