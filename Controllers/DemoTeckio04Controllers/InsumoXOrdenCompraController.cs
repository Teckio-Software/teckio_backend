...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL04Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL04Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL04Controller> _Logger;
        private readonly DemoTeckioAL04Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL04Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL04Controller> Logger,
            DemoTeckioAL04Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL04Context> Service
