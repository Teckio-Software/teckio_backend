...
{
    [Route("api/cotizacion/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL04Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL04Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL04Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL04Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL04Controller> _Logger;
        private readonly DemoTeckioAL04Context Context;
        public CotizacionDemoTeckioAL04Controller(

            ILogger<CotizacionDemoTeckioAL04Controller> Logger
            , DemoTeckioAL04Context Context
            , ICotizacionService<DemoTeckioAL04Context> Service
            , IOrdenCompraService<DemoTeckioAL04Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL04Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL04Context> Proceso)
        {
            _Logger = Logger;
