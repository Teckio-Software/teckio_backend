...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL04Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL04Context> _servicio;
        public CuentaBancariaDemoTeckioAL04Controller(CuentaBancariaProceso<DemoTeckioAL04Context> _proceso, ICuentaBancariaService<DemoTeckioAL04Context> _servicio
           )
        {
