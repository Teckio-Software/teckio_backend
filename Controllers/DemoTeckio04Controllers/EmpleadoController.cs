...
{
    [Route("api/empleado/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL04Context> _empleadoService;
        public EmpleadoDemoTeckioAL04Controller(
            IEmpleadoService<DemoTeckioAL04Context> empleadoService
            )
        {
