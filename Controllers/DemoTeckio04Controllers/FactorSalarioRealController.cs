...
namespace ERP_TECKIO.Controllers.DemoTeckioAL04
{
    [Route("api/fsr/4")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL04Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL04Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL04Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL04Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL04Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL04Context> porcentajeCesantiaEdadService
            )
        {
