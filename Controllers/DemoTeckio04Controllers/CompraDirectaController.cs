...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL04Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL04Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL04Controller(
            ILogger<CompraDirectaDemoTeckioAL04Controller> logger,
            DemoTeckioAL04Context context
            , ICompraDirectaService<DemoTeckioAL04Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
