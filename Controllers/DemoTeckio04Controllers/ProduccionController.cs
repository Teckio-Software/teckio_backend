...
namespace ERP_TECKIO.Controllers.DemoTeckioAL04
{
    ...
    [Route("api/produccion/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL04Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL04Context> proceso)
        {
            _proceso = proceso;
        }
