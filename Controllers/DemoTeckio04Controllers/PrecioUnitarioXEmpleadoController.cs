...
{
    [Route("api/precioUnitarioXEmpleado/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL04Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL04Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL04Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL04Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL04Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
