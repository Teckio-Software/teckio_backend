...
{
    [Route("api/contratos/4")]
    [ApiController]
    public class ContratosDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL04Context> _contratosProceso;
        public ContratosDemoTeckioAL04Controller(
            ContratosProceso<DemoTeckioAL04Context> contratosProceso
            )
        {
