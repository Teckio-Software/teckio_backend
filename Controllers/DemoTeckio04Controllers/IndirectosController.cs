...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL04Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL04Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL04Context> _indirectosProceso;

        public IndirectosDemoTeckioAL04Controller(
                        IConjuntoIndirectosService<DemoTeckioAL04Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL04Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL04Context> indirectosProceso
            )
        {
