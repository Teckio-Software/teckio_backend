...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL04Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL04Controller(
            ConceptoProceso<DemoTeckioAL04Context> conceptoProceso)
        {
