...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL04Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL04Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL04Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL04Controller(
            IClientesService<DemoTeckioAL04Context> service
            , ClienteProceso<DemoTeckioAL04Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL04Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
