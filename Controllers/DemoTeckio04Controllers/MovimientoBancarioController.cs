...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/4")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL04Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL04Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL04Controller(
            MovimientoBancarioProceso<DemoTeckioAL04Context> movimientoBancarioProceso
            )
        {
