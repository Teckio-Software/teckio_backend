...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL04Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL04Controller> Logger;
        ...
        public RubroDemoTeckioAL04Controller(
            ILogger<RubroDemoTeckioAL04Controller> logger,
            DemoTeckioAL04Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL04Context> service
            )
        {
            //_Service = service;
            Logger = logger;
