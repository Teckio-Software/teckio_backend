...
{
    [Route("api/productoyservicio/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL04Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL04Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL04Context> _process;

        public ProductoYServicioDemoTeckioAL04Controller(IProductoYservicioService<DemoTeckioAL04Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL04Context> process
            )
        {
