...
namespace ERP_TECKIO.Controllers.DemoTeckioAL04
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/4")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL04Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL04Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL04Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL04Context> process)
        {
            _service = service;
            _process = process;
        }
