...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL04Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL04Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL04Context> _Proceso;
        private readonly DemoTeckioAL04Context Context;
        public InsumoXCotizacionDemoTeckioAL04Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL04Controller> Logger,
            DemoTeckioAL04Context Context
            , IInsumoXCotizacionService<DemoTeckioAL04Context> Service
