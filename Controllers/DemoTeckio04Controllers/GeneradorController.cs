...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL04Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL04Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL04Controller(
            GeneradoresProceso<DemoTeckioAL04Context> generadoresProceso)
        {
