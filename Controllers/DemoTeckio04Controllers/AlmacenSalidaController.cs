...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL04Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL04Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL04Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL04Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL04Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL04Controller> logger,
            DemoTeckioAL04Context context
            , IAlmacenSalidaService<DemoTeckioAL04Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL04Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL04Context> Proceso
            )
        {
