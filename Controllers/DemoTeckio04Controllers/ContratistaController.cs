...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/4")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL04Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL04Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL04Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL04Controller(
            ILogger<ContratistaDemoTeckioAL04Controller> logger,
            DemoTeckioAL04Context context
            , IContratistaService<DemoTeckioAL04Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL04Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
