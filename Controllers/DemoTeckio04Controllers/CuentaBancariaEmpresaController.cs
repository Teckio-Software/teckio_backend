...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL04Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL04Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL04Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL04Context> cuentaBancariaEmpresaService,
