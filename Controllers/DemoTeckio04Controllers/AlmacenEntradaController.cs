...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL04Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL04Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL04Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL04Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL04Controller(
            ILogger<AlmacenEntradaDemoTeckioAL04Controller> logger,
            DemoTeckioAL04Context context
            , IAlmacenEntradaService<DemoTeckioAL04Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL04Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL04Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
