...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL04Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL04Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL04Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL04Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL04Controller> Logger,
            RequisicionProceso<DemoTeckioAL04Context> Proceso,
            DemoTeckioAL04Context Context
            , IInsumoXRequisicionService<DemoTeckioAL04Context> Service)
        {
            _Logger = Logger;
