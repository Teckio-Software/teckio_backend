...
{
    [Route("api/preciounitario/4")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL04Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL04Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL04Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL04Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL04Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL04Controller(
            PrecioUnitarioProceso<DemoTeckioAL04Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL04Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL04Context> options,
            ExplocionInsumosProceso<DemoTeckioAL04Context> explocionInsumosProceso
            )
        {
