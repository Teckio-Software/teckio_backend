...
{
    [Route("api/ordenventa/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL04Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL04Controller(
            OrdenVentaProceso<DemoTeckioAL04Context> ordenVentaProceso
            ) { 
