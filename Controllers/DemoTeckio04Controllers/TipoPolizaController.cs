...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL04Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL04Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL04Controller(
            ILogger<TipoPolizaDemoTeckioAL04Controller> logger,
            DemoTeckioAL04Context context
            , ITipoPolizaService<DemoTeckioAL04Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
