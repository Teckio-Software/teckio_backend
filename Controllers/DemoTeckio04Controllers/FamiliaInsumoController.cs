...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL04Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL04Controller(
            FamiliaInsumoProceso<DemoTeckioAL04Context> familiaInsumoProceso)
        {
