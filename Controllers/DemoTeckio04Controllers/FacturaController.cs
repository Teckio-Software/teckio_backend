...
namespace ERP_TECKIO.Controllers.DemoTeckioAL04
{
    ...
    public class FacturaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL04Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL04Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL04Controller(
            ObtenFacturaProceso<DemoTeckioAL04Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL04Context> categoriaProductoYServicioService
            )
        {
