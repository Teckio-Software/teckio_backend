...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL04Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL04Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL04Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL04Controller(
            ILogger<ExistenciasDemoTeckioAL04Controller> Logger,
            DemoTeckioAL04Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL04Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL04Context> Proceso
            )
        {
            _Logger = Logger;
