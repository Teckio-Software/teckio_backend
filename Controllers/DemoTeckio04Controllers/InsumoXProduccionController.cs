...
namespace ERP_TECKIO.Controllers.DemoTeckioAL04
{
    ...
    [Route("api/insumoXproduccion/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL04Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL04Context> proces)
        {
            _proceso = proces;
        }
