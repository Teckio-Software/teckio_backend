...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL04Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL04Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL04Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL04Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL04Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL04Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL04Controller(
            ILogger<CuentaContableDemoTeckioAL04Controller> logger,
            DemoTeckioAL04Context context
            , ICuentaContableService<DemoTeckioAL04Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL04Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL04Context> RubroService
            , CuentaContableProceso<DemoTeckioAL04Context> proceso
            )
        {
            Logger = logger;
            Context = context;
