...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL04Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL04Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL04Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL04Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL04Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL04Controller> _Logger;
        private readonly DemoTeckioAL04Context _Context;
        private readonly PolizaProceso<DemoTeckioAL04Context> _polizaProceso;
        public PolizaDemoTeckioAL04Controller(
            ILogger<PolizaDemoTeckioAL04Controller> logger
            , DemoTeckioAL04Context context
            , IPolizaService<DemoTeckioAL04Context> service
            , IPolizaDetalleService<DemoTeckioAL04Context> detalleService
            , ITipoPolizaService<DemoTeckioAL04Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL04Context> saldosService
