...
namespace SistemaERP.API.Controllers.DemoTeckioAL04
{
    [Route("api/programacionestimadaGantt/4")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL04Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL04Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL04Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL04Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL04Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL04Context> importeSemanalGanttProceso,
