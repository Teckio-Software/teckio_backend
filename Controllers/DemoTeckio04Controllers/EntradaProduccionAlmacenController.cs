...
{
    [Route("api/entradaproduccionalmacen/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL04Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL04Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL04Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL04Context> proceso)
        {
            _proceso = proceso;
        }
