...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL04Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL04Controller(
            ProyectoProceso<DemoTeckioAL04Context> proyectoProceso)
        {
