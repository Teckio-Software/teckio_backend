...
{
    [Route("api/programacionestimada/4")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL04Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL04Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL04Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL04Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL04Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL04Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL04Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL04Context> precioUnitarioService,
