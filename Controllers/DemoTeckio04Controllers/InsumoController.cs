...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL04Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL04Context> _InsumoProceso;
        public InsumoDemoTeckioAL04Controller(
            InsumoProceso<DemoTeckioAL04Context> insumoProceso)
        {
