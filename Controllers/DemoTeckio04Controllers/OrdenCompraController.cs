...
{
    [Route("api/ordencompra/4")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL04Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL04Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL04Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL04Controller> _Logger;
        private readonly DemoTeckioAL04Context Context;
        private readonly PolizaProceso<DemoTeckioAL04Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL04Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL04Controller(
            ILogger<OrdenCompraDemoTeckioAL04Controller> Logger
            , DemoTeckioAL04Context Context
            , IOrdenCompraService<DemoTeckioAL04Context> Service
            , OrdenCompraProceso<DemoTeckioAL04Context> Proceso
            , PolizaProceso<DemoTeckioAL04Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL04Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
