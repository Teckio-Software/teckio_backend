...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL04Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL04Context> _bancoService;

        public BancoDemoTeckioAL04Controller(IBancoService<DemoTeckioAL04Context> bancoService)
        {
