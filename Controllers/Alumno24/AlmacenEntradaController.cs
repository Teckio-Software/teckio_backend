...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno24Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno24Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno24Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno24Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno24Controller(
            ILogger<AlmacenEntradaAlumno24Controller> logger,
            Alumno24Context context
            , IAlmacenEntradaService<Alumno24Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno24Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno24Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
