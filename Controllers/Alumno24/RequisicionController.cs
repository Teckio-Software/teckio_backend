...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno24Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno24Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno24Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno24Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno24Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno24Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno24Controller(
            ILogger<RequisicionAlumno24Controller> Logger
            , Alumno24Context Context
            , IRequisicionService<Alumno24Context> RequisicionService
            , RequisicionProceso<Alumno24Context> Proceso
            , ObjetoRequisicionProceso<Alumno24Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno24Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
