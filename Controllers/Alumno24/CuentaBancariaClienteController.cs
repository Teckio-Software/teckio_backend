...
namespace ERP_TECKIO.API.Controllers.Alumno24
{
    ...
    public class CuentaBancariaClienteAlumno24Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno24Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno24Context> _proceso;

        public CuentaBancariaClienteAlumno24Controller(
            ICuentaBancariaClienteService<Alumno24Context> cuentaBancariaClienteService,
