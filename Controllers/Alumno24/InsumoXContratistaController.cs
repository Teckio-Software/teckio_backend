...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa24")]
    public class InsumoXContratistaAlumno24Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno24Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno24Controller(
            ILogger<InsumoXContratistaAlumno24Controller> logger,
