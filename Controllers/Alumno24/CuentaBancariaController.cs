...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno24Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno24Context> _proceso;

        private readonly ICuentaBancariaService<Alumno24Context> _servicio;
        public CuentaBancariaAlumno24Controller(CuentaBancariaProceso<Alumno24Context> _proceso, ICuentaBancariaService<Alumno24Context> _servicio
           )
        {
