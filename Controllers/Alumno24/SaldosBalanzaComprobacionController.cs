...
{
    [Route("api/saldosbalanzacomprobacion/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa24")]
    public class SaldosBalanzaComprobacionAlumno24Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno24Context> _Service;
        private readonly ICuentaContableService<Alumno24Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno24Controller> _Logger;
        private readonly Alumno24Context _Context;
        public SaldosBalanzaComprobacionAlumno24Controller(
            ILogger<SaldosBalanzaComprobacionAlumno24Controller> logger
            , Alumno24Context context
            , ISaldosBalanzaComprobacionService<Alumno24Context> service
