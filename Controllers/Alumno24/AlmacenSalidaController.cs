...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno24Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno24Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno24Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno24Controller> Logger;
        ...
        public AlmacenSalidaAlumno24Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno24Controller> logger,
            Alumno24Context context
            , IAlmacenSalidaService<Alumno24Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno24Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno24Context> Proceso
            )
        {
