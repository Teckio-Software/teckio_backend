...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno24Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno24Context> _almacenServicio;

        public AlmacenAlumno24Controller(
            IAlmacenService<Alumno24Context> almacenServicio)
        {
