...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno24Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno24Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno24Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno24Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno24Controller(
            ILogger<AlmacenEntradaInsumoAlumno24Controller> logger,
            Alumno24Context context
            , IInsumoXAlmacenEntradaService<Alumno24Context> AlmacenEntradaDetalle
