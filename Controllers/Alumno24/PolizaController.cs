...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno24Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno24Context> _Service;
        private readonly IPolizaDetalleService<Alumno24Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno24Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno24Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno24Context> _SaldosService;
        private readonly ILogger<PolizaAlumno24Controller> _Logger;
        private readonly Alumno24Context _Context;
        public PolizaAlumno24Controller(
            ILogger<PolizaAlumno24Controller> logger
            , Alumno24Context context
            , IPolizaService<Alumno24Context> service
            , IPolizaDetalleService<Alumno24Context> detalleService
            , ITipoPolizaService<Alumno24Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno24Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa24")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa24")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa24")]
