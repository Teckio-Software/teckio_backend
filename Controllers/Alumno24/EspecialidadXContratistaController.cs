...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa24")]
    public class EspecialIdadXContratistaAlumno24Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno24Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno24Controller(
            ILogger<EspecialIdadXContratistaAlumno24Controller> logger,
