...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno24Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno24Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno24Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno24Controller(
            ILogger<ExistenciasAlumno24Controller> Logger,
            Alumno24Context Context
            , IAlmacenExistenciaInsumoService<Alumno24Context> ExistenciaService
            , ExistenciasProceso<Alumno24Context> Proceso
            )
        {
            _Logger = Logger;
