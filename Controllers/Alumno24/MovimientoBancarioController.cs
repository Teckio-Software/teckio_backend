...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno24Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno24Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno24Controller(
            MovimientoBancarioProceso<Alumno24Context> movimientoBancarioProceso
            )
        {
