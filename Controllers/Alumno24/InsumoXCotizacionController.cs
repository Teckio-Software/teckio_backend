...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno24Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno24Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno24Controller> _Logger;
        private readonly CotizacionProceso<Alumno24Context> _Proceso;
        private readonly Alumno24Context Context;
        public InsumoXCotizacionAlumno24Controller(
            ILogger<InsumoXCotizacionAlumno24Controller> Logger,
            Alumno24Context Context
            , IInsumoXCotizacionService<Alumno24Context> Service
