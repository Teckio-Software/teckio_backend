...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno24Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno24Context> _Service;
        private readonly OrdenCompraProceso<Alumno24Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno24Controller> _Logger;
        private readonly Alumno24Context _Context;
        public InsumoXOrdenCompraAlumno24Controller(
            ILogger<InsumoXOrdenCompraAlumno24Controller> Logger,
            Alumno24Context Context
            , IInsumoXOrdenCompraService<Alumno24Context> Service
