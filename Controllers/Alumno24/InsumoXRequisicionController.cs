...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno24Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno24Context> _Service;

        private readonly RequisicionProceso<Alumno24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno24Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno24Controller(
            ILogger<InsumoXRequisicionAlumno24Controller> Logger,
            RequisicionProceso<Alumno24Context> Proceso,
            Alumno24Context Context
            , IInsumoXRequisicionService<Alumno24Context> Service)
        {
            _Logger = Logger;
