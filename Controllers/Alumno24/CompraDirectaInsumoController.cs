...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa24")]
    public class CompraDirectaInsumoAlumno24Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno24Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno24Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno24Controller(
            ILogger<CompraDirectaInsumoAlumno24Controller> logger
            , Alumno24Context context
            , IInsumoXCompraDirectaService<Alumno24Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
