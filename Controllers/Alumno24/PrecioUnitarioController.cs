...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioAlumno24Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno24Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno24Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno24Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno24Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno24Controller(
            PrecioUnitarioProceso<Alumno24Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno24Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno24Context> options,
            ExplocionInsumosProceso<Alumno24Context> explocionInsumosProceso
            )
        {
