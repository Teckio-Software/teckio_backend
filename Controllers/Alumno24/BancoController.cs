...
namespace ERP_TECKIO.API.Controllers.Alumno24
{
    ...
    public class BancoAlumno24Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno24Context> _bancoService;

        public BancoAlumno24Controller(IBancoService<Alumno24Context> bancoService)
        {
