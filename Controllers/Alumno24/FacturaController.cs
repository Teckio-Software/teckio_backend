...
namespace ERP_TECKIO.Controllers.Alumno24
{
    ...
    public class FacturaAlumno24Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno24Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno24Context> _categoriaProductoYServicioService;
        public FacturaAlumno24Controller(
            ObtenFacturaProceso<Alumno24Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno24Context> categoriaProductoYServicioService
            )
        {
