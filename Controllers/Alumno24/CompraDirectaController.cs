...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa24")]
    public class CompraDirectaAlumno24Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno24Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno24Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno24Controller(
            ILogger<CompraDirectaAlumno24Controller> logger,
            Alumno24Context context
            , ICompraDirectaService<Alumno24Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa24")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa24")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa24")]
