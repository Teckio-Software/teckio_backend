...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno24Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno24Context> _Service;
        private readonly CotizacionProceso<Alumno24Context> _Proceso;
        private readonly IOrdenCompraService<Alumno24Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno24Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno24Controller> _Logger;
        private readonly Alumno24Context Context;
        public CotizacionAlumno24Controller(

            ILogger<CotizacionAlumno24Controller> Logger
            , Alumno24Context Context
            , ICotizacionService<Alumno24Context> Service
            , IOrdenCompraService<Alumno24Context> OrdenCompraService,
              ITipoImpuestoService<Alumno24Context> TipoImpuestoService
            , CotizacionProceso<Alumno24Context> Proceso)
        {
            _Logger = Logger;
