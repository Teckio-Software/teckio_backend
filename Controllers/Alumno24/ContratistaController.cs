...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno24Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno24Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno24Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno24Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno24Controller(
            ILogger<ContratistaAlumno24Controller> logger,
            Alumno24Context context
            , IContratistaService<Alumno24Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno24Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
