...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno24Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno24Context> _empleadoService;
        public EmpleadoAlumno24Controller(
            IEmpleadoService<Alumno24Context> empleadoService
            )
        {
