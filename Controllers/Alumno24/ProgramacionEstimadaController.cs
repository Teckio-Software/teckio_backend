...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno24Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno24Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno24Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno24Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno24Controller(
            ProgramacionEstimadaProceso<Alumno24Context> programacionEstimadaProceso,
            IProyectoService<Alumno24Context> proyectoProceso,
            IPrecioUnitarioService<Alumno24Context> precioUnitarioService,
