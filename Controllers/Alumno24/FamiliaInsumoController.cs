...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa24")]
    public class FamiliaInsumoAlumno24Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno24Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno24Controller(
            FamiliaInsumoProceso<Alumno24Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa24")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa24")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa24")]
