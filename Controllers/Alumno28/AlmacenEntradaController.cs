...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno28Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno28Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno28Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno28Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno28Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno28Controller(
            ILogger<AlmacenEntradaAlumno28Controller> logger,
            Alumno28Context context
            , IAlmacenEntradaService<Alumno28Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno28Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno28Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
