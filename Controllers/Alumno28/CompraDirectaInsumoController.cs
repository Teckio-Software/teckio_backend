...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa28")]
    public class CompraDirectaInsumoAlumno28Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno28Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno28Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno28Controller(
            ILogger<CompraDirectaInsumoAlumno28Controller> logger
            , Alumno28Context context
            , IInsumoXCompraDirectaService<Alumno28Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
