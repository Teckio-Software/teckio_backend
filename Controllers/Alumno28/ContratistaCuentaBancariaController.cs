...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/28")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno28Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno28Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno28Controller(
            ILogger<ContratistaCuentaBancariaAlumno28Controller> logger,
