...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa28")]
    public class EspecialIdadXContratistaAlumno28Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno28Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno28Controller(
            ILogger<EspecialIdadXContratistaAlumno28Controller> logger,
