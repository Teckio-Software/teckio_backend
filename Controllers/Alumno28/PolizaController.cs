...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno28Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno28Context> _Service;
        private readonly IPolizaDetalleService<Alumno28Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno28Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno28Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno28Context> _SaldosService;
        private readonly ILogger<PolizaAlumno28Controller> _Logger;
        private readonly Alumno28Context _Context;
        public PolizaAlumno28Controller(
            ILogger<PolizaAlumno28Controller> logger
            , Alumno28Context context
            , IPolizaService<Alumno28Context> service
            , IPolizaDetalleService<Alumno28Context> detalleService
            , ITipoPolizaService<Alumno28Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno28Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa28")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa28")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa28")]
