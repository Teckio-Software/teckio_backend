...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno28Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno28Context> _Service;

        private readonly RequisicionProceso<Alumno28Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno28Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno28Controller(
            ILogger<InsumoXRequisicionAlumno28Controller> Logger,
            RequisicionProceso<Alumno28Context> Proceso,
            Alumno28Context Context
            , IInsumoXRequisicionService<Alumno28Context> Service)
        {
            _Logger = Logger;
