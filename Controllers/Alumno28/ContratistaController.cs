...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/28")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno28Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno28Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno28Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno28Controller(
            ILogger<ContratistaAlumno28Controller> logger,
            Alumno28Context context
            , IContratistaService<Alumno28Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
