...
{
    [Route("api/insumoxordencompra/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno28Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno28Context> _Service;
        private readonly OrdenCompraProceso<Alumno28Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno28Controller> _Logger;
        private readonly Alumno28Context _Context;
        public InsumoXOrdenCompraAlumno28Controller(
            ILogger<InsumoXOrdenCompraAlumno28Controller> Logger,
            Alumno28Context Context
            , IInsumoXOrdenCompraService<Alumno28Context> Service
            , OrdenCompraProceso<Alumno28Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
