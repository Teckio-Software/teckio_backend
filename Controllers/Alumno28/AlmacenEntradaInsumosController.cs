...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno28Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno28Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno28Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno28Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno28Controller(
            ILogger<AlmacenEntradaInsumoAlumno28Controller> logger,
            Alumno28Context context
            , IInsumoXAlmacenEntradaService<Alumno28Context> AlmacenEntradaDetalle
