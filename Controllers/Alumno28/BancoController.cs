...
namespace ERP_TECKIO.API.Controllers.Alumno28
{
    ...
    public class BancoAlumno28Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno28Context> _bancoService;

        public BancoAlumno28Controller(IBancoService<Alumno28Context> bancoService)
        {
