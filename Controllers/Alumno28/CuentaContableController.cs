...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa28")]
    public class CuentaContableAlumno28Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno28Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno28Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno28Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno28Controller(
            ILogger<CuentaContableAlumno28Controller> logger,
            Alumno28Context context
            , ICuentaContableService<Alumno28Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno28Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
