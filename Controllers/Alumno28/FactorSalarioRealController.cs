...
namespace ERP_TECKIO.Controllers.Alumno28
{
    [Route("api/fsr/28")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno28Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno28Context> factorSalarioRealProceso)
        {
