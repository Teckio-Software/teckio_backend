...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa28")]
    public class InsumoXContratistaAlumno28Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno28Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno28Controller(
            ILogger<InsumoXContratistaAlumno28Controller> logger,
