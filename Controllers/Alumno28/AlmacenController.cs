...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno28Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno28Context> _almacenServicio;

        public AlmacenAlumno28Controller(
            IAlmacenService<Alumno28Context> almacenServicio)
        {
