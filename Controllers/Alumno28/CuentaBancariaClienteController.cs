...
{
    [Route("api/cuentabancariacliente/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaClienteAlumno28Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno28Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno28Context> _proceso;

        public CuentaBancariaClienteAlumno28Controller(
            ICuentaBancariaClienteService<Alumno28Context> cuentaBancariaClienteService,
