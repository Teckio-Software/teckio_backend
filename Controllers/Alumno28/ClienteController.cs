...
{
    [Route("api/cliente/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno28Controller : ControllerBase
    {
        private readonly IClientesService<Alumno28Context> _Service;

        private readonly ClienteProceso<Alumno28Context> _Proceso;
        public ClienteAlumno28Controller(
            IClientesService<Alumno28Context> service
            , ClienteProceso<Alumno28Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
