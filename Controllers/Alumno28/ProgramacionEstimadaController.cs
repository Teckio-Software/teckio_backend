...
{
    [Route("api/programacionestimada/28")]
    [ApiController]
    public class ProgramacionEstimadaAlumno28Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno28Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno28Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno28Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno28Controller(
            ProgramacionEstimadaProceso<Alumno28Context> programacionEstimadaProceso,
            IProyectoService<Alumno28Context> proyectoProceso,
            IPrecioUnitarioService<Alumno28Context> precioUnitarioService,
