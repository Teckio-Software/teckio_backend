...
{
    [Route("api/cotizacion/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno28Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno28Context> _Service;
        private readonly CotizacionProceso<Alumno28Context> _Proceso;
        private readonly IOrdenCompraService<Alumno28Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno28Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno28Controller> _Logger;
        private readonly Alumno28Context Context;
        public CotizacionAlumno28Controller(

            ILogger<CotizacionAlumno28Controller> Logger
            , Alumno28Context Context
            , ICotizacionService<Alumno28Context> Service
            , IOrdenCompraService<Alumno28Context> OrdenCompraService,
              ITipoImpuestoService<Alumno28Context> TipoImpuestoService
            , CotizacionProceso<Alumno28Context> Proceso)
        {
            _Logger = Logger;
