...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa28")]
    public class FamiliaInsumoAlumno28Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno28Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno28Controller(
            FamiliaInsumoProceso<Alumno28Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa28")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa28")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa28")]
