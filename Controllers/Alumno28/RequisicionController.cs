...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno28Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno28Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno28Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno28Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno28Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno28Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno28Controller(
            ILogger<RequisicionAlumno28Controller> Logger
            , Alumno28Context Context
            , IRequisicionService<Alumno28Context> RequisicionService
            , RequisicionProceso<Alumno28Context> Proceso
            , ObjetoRequisicionProceso<Alumno28Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno28Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
