...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno28Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno28Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno28Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno28Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno28Controller> Logger;
        ...
        public AlmacenSalidaAlumno28Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno28Controller> logger,
            Alumno28Context context
            , IAlmacenSalidaService<Alumno28Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno28Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno28Context> Proceso
            )
        {
