...
{
    [Route("api/ordencompra/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno28Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno28Context> _Service;
        private readonly OrdenCompraProceso<Alumno28Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno28Controller> _Logger;
        private readonly Alumno28Context Context;
        public OrdenCompraAlumno28Controller(
            ILogger<OrdenCompraAlumno28Controller> Logger
            , Alumno28Context Context
            , IOrdenCompraService<Alumno28Context> Service
