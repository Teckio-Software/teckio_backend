...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno28Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno28Context> _proceso;

        private readonly ICuentaBancariaService<Alumno28Context> _servicio;
        public CuentaBancariaAlumno28Controller(CuentaBancariaProceso<Alumno28Context> _proceso, ICuentaBancariaService<Alumno28Context> _servicio
           )
        {
