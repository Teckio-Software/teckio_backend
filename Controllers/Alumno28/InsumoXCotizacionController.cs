...
{
    [Route("api/insumoxcotizacion/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno28Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno28Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno28Controller> _Logger;
        private readonly CotizacionProceso<Alumno28Context> _Proceso;
        private readonly Alumno28Context Context;
        public InsumoXCotizacionAlumno28Controller(
            ILogger<InsumoXCotizacionAlumno28Controller> Logger,
            Alumno28Context Context
            , IInsumoXCotizacionService<Alumno28Context> Service
