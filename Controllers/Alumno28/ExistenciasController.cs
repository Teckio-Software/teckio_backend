...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/28")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno28Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno28Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno28Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno28Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno28Controller(
            ILogger<ExistenciasAlumno28Controller> Logger,
            Alumno28Context Context
            , IAlmacenExistenciaInsumoService<Alumno28Context> ExistenciaService
            , ExistenciasProceso<Alumno28Context> Proceso
            )
        {
            _Logger = Logger;
