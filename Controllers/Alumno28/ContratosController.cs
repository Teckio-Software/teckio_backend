...
{
    [Route("api/contratos/28")]
    [ApiController]
    public class ContratosAlumno28Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno28Context> _contratosProceso;
        public ContratosAlumno28Controller(
            ContratosProceso<Alumno28Context> contratosProceso
            )
        {
