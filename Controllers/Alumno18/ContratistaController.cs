...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno18Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno18Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno18Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno18Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno18Controller(
            ILogger<ContratistaAlumno18Controller> logger,
            Alumno18Context context
            , IContratistaService<Alumno18Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno18Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
