...
namespace ERP_TECKIO.Controllers.Alumno18
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno18Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno18Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno18Context> service, InsumoXProductoYServicioProceso<Alumno18Context> process)
        {
            _service = service;
            _process = process;
        }
