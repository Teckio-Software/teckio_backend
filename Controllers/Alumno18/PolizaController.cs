...
namespace ERP_TECKIO
{
    [Route("api/poliza/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa18")]
    public class PolizaAlumno18Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno18Context> _Service;
        private readonly IPolizaDetalleService<Alumno18Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno18Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno18Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno18Context> _SaldosService;
        private readonly ILogger<PolizaAlumno18Controller> _Logger;
        private readonly Alumno18Context _Context;
        public PolizaAlumno18Controller(
            ILogger<PolizaAlumno18Controller> logger
            , Alumno18Context context
            , IPolizaService<Alumno18Context> service
            , IPolizaDetalleService<Alumno18Context> detalleService
            , ITipoPolizaService<Alumno18Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno18Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa18")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa18")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa18")]
