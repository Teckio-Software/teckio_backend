...
namespace ERP_TECKIO.API.Controllers.Alumno18
{
    ...
    public class BancoAlumno18Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno18Context> _bancoService;

        public BancoAlumno18Controller(IBancoService<Alumno18Context> bancoService)
        {
