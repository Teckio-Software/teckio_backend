...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno18Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno18Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno18Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno18Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno18Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno18Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno18Controller(
            ILogger<RequisicionAlumno18Controller> Logger
            , Alumno18Context Context
            , IRequisicionService<Alumno18Context> RequisicionService
            , RequisicionProceso<Alumno18Context> Proceso
            , ObjetoRequisicionProceso<Alumno18Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno18Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
