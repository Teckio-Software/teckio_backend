...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno18Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno18Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno18Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno18Controller(
            ILogger<ExistenciasAlumno18Controller> Logger,
            Alumno18Context Context
            , IAlmacenExistenciaInsumoService<Alumno18Context> ExistenciaService
            , ExistenciasProceso<Alumno18Context> Proceso
            )
        {
            _Logger = Logger;
