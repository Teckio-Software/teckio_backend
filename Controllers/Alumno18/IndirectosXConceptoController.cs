...
namespace ERP_TECKIO.API.Controllers.Alumno18
{
    ...
    public class IndirectosXConceptoAlumno18Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno18Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno18Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno18Controller(
            IIndirectosXConceptoService<Alumno18Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno18Context> indirectosXConceptoProceso
            ) { 
