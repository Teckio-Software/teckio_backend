...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa18")]
    public class EspecialIdadXContratistaAlumno18Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno18Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno18Controller(
            ILogger<EspecialIdadXContratistaAlumno18Controller> logger,
