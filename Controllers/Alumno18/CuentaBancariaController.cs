...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno18Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno18Context> _proceso;

        private readonly ICuentaBancariaService<Alumno18Context> _servicio;
        public CuentaBancariaAlumno18Controller(CuentaBancariaProceso<Alumno18Context> _proceso, ICuentaBancariaService<Alumno18Context> _servicio
           )
        {
