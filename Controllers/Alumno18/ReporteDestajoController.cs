...
namespace ERP_TECKIO.API.Controllers.Alumno18
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno18Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno18Context> _proceso;
        private readonly EstimacionesProceso<Alumno18Context> _estimacionesProceso;

        public ReporteDestajoAlumno18Controller(
            ReporteDestajoProceso<Alumno18Context> proceso,
            EstimacionesProceso<Alumno18Context> estimacionesProceso
            ) { 
            _proceso = proceso;
