...
{
    [Route("api/insumoxordencompra/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno18Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno18Context> _Service;
        private readonly OrdenCompraProceso<Alumno18Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno18Controller> _Logger;
        private readonly Alumno18Context _Context;
        public InsumoXOrdenCompraAlumno18Controller(
            ILogger<InsumoXOrdenCompraAlumno18Controller> Logger,
            Alumno18Context Context
            , IInsumoXOrdenCompraService<Alumno18Context> Service
