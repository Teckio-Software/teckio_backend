...
namespace ERP_TECKIO.Controllers.Alumno18
{
    ...
    public class ProductoYServicioAlumno18Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno18Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno18Context> _process;

        public ProductoYServicioAlumno18Controller(IProductoYservicioService<Alumno18Context> productoYServicioService,
            ProductoYServicioProceso<Alumno18Context> process
            )
        {
