...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno18Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno18Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno18Controller(
            MovimientoBancarioProceso<Alumno18Context> movimientoBancarioProceso
            )
        {
