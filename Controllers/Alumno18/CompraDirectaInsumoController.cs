...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa18")]
    public class CompraDirectaInsumoAlumno18Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno18Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno18Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno18Controller(
            ILogger<CompraDirectaInsumoAlumno18Controller> logger
            , Alumno18Context context
            , IInsumoXCompraDirectaService<Alumno18Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
