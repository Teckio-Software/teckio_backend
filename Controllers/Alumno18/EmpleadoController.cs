...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno18Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno18Context> _empleadoService;
        public EmpleadoAlumno18Controller(
            IEmpleadoService<Alumno18Context> empleadoService
            )
        {
