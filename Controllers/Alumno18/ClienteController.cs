...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno18Controller : ControllerBase
    {
        ...
        private readonly ClienteCuentasContablesProceso<Alumno18Context> _clientesCuentasContablesProceso;
        public ClienteAlumno18Controller(
            IClientesService<Alumno18Context> service
            , ClienteProceso<Alumno18Context> proceso,
            ClienteCuentasContablesProceso<Alumno18Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
