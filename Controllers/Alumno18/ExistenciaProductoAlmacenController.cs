...
namespace ERP_TECKIO.Controllers.Alumno18
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno18Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno18Context> proces)
        {
            _proceso = proces;
        }
