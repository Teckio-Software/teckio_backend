...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa18")]
    public class InsumoXContratistaAlumno18Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno18Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno18Controller(
            ILogger<InsumoXContratistaAlumno18Controller> logger,
