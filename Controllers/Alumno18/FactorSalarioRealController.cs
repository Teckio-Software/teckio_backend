...
namespace ERP_TECKIO.Controllers.Alumno18
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno18Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno18Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno18Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno18Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno18Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno18Context> porcentajeCesantiaEdadService
            )
        {
