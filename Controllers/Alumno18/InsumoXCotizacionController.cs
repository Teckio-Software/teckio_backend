...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno18Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno18Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno18Controller> _Logger;
        private readonly CotizacionProceso<Alumno18Context> _Proceso;
        private readonly Alumno18Context Context;
        public InsumoXCotizacionAlumno18Controller(
            ILogger<InsumoXCotizacionAlumno18Controller> Logger,
            Alumno18Context Context
            , IInsumoXCotizacionService<Alumno18Context> Service
