...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno18Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno18Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno18Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno18Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno18Controller(
            ILogger<AlmacenEntradaInsumoAlumno18Controller> logger,
            Alumno18Context context
            , IInsumoXAlmacenEntradaService<Alumno18Context> AlmacenEntradaDetalle
