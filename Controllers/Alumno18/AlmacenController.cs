...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno18Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno18Context> _almacenServicio;

        public AlmacenAlumno18Controller(
            IAlmacenService<Alumno18Context> almacenServicio)
        {
