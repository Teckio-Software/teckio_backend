...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/18")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa18")]
    public class CompraDirectaAlumno18Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno18Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno18Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno18Controller(
            ILogger<CompraDirectaAlumno18Controller> logger,
            Alumno18Context context
            , ICompraDirectaService<Alumno18Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa18")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa18")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa18")]
