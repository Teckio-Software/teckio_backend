...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno18Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno18Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno18Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno18Controller> Logger;
        ...
        public AlmacenSalidaAlumno18Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno18Controller> logger,
            Alumno18Context context
            , IAlmacenSalidaService<Alumno18Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno18Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno18Context> Proceso
            )
        {
