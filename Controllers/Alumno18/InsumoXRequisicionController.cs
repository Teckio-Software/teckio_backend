...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno18Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno18Context> _Service;

        private readonly RequisicionProceso<Alumno18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno18Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno18Controller(
            ILogger<InsumoXRequisicionAlumno18Controller> Logger,
            RequisicionProceso<Alumno18Context> Proceso,
            Alumno18Context Context
            , IInsumoXRequisicionService<Alumno18Context> Service)
        {
            _Logger = Logger;
