...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno18Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno18Context> _Service;
        private readonly CotizacionProceso<Alumno18Context> _Proceso;
        private readonly IOrdenCompraService<Alumno18Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno18Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno18Controller> _Logger;
        private readonly Alumno18Context Context;
        public CotizacionAlumno18Controller(

            ILogger<CotizacionAlumno18Controller> Logger
            , Alumno18Context Context
            , ICotizacionService<Alumno18Context> Service
            , IOrdenCompraService<Alumno18Context> OrdenCompraService,
              ITipoImpuestoService<Alumno18Context> TipoImpuestoService
            , CotizacionProceso<Alumno18Context> Proceso)
        {
            _Logger = Logger;
