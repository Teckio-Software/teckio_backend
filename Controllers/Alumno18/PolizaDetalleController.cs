...
namespace ERP_TECKIO
{
    ...
    public class PolizaDetalleAlumno18Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno18Context> _Service;
        private readonly ICuentaContableService<Alumno18Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno18Controller> _Logger;
        private readonly Alumno18Context _Context;
        public PolizaDetalleAlumno18Controller(
            ILogger<PolizaDetalleAlumno18Controller> logger
            , Alumno18Context context
            , IPolizaDetalleService<Alumno18Context> service
