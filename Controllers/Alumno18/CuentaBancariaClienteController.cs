...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteAlumno18Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno18Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno18Context> _proceso;

        public CuentaBancariaClienteAlumno18Controller(
            ICuentaBancariaClienteService<Alumno18Context> cuentaBancariaClienteService,
