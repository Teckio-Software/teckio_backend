...
namespace SistemaERP.API.Controllers.Alumno18
{
    [Route("api/programacionestimadaGantt/18")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno18Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno18Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno18Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno18Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno18Controller(
            ProgramacionEstimadaGanttProceso<Alumno18Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno18Context> importeSemanalGanttProceso,
