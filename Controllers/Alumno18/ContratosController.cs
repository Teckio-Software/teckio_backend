...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno18Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno18Context> _contratosProceso;
        public ContratosAlumno18Controller(
            ContratosProceso<Alumno18Context> contratosProceso
            )
        {
