...
namespace ERP_TECKIO.Controllers.Alumno18
{
    ...
    public class OrdenVentaAlumno18Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno18Context> _ordenVentaProceso;
        public OrdenVentaAlumno18Controller(
            OrdenVentaProceso<Alumno18Context> ordenVentaProceso
            ) { 
