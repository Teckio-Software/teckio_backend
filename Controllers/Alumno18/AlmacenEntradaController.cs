...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno18Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno18Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno18Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno18Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno18Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno18Controller(
            ILogger<AlmacenEntradaAlumno18Controller> logger,
            Alumno18Context context
            , IAlmacenEntradaService<Alumno18Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno18Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno18Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
