...
namespace ERP_TECKIO.Controllers.Alumno18
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno18Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno18Context> process)
        {
            _process = process;
        }
