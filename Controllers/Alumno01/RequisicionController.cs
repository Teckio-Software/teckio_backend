...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno01Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno01Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno01Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno01Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno01Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno01Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno01Controller(
            ILogger<RequisicionAlumno01Controller> Logger
            , Alumno01Context Context
            , IRequisicionService<Alumno01Context> RequisicionService
            , RequisicionProceso<Alumno01Context> Proceso
            , ObjetoRequisicionProceso<Alumno01Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno01Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
