...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDetalleAlumno01Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno01Context> _Service;
        private readonly ICuentaContableService<Alumno01Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno01Controller> _Logger;
        private readonly Alumno01Context _Context;
        public PolizaDetalleAlumno01Controller(
            ILogger<PolizaDetalleAlumno01Controller> logger
            , Alumno01Context context
            , IPolizaDetalleService<Alumno01Context> service
