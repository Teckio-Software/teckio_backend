...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno01Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno01Context> _empleadoService;
        public EmpleadoAlumno01Controller(
            IEmpleadoService<Alumno01Context> empleadoService
            )
        {
