...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionAlumno01Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno01Context> _Service;
        private readonly ICuentaContableService<Alumno01Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno01Controller> _Logger;
        private readonly Alumno01Context _Context;
        public SaldosBalanzaComprobacionAlumno01Controller(
            ILogger<SaldosBalanzaComprobacionAlumno01Controller> logger
            , Alumno01Context context
            , ISaldosBalanzaComprobacionService<Alumno01Context> service
