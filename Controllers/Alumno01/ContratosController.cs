...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno01Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno01Context> _contratosProceso;
        public ContratosAlumno01Controller(
            ContratosProceso<Alumno01Context> contratosProceso
            )
        {
