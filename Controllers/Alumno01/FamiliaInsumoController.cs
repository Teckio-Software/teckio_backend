...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoAlumno01Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno01Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno01Controller(
            FamiliaInsumoProceso<Alumno01Context> familiaInsumoProceso)
        {
