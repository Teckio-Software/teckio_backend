...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno01Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno01Context> _Service;
        private readonly CotizacionProceso<Alumno01Context> _Proceso;
        private readonly IOrdenCompraService<Alumno01Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno01Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno01Controller> _Logger;
        private readonly Alumno01Context Context;
        public CotizacionAlumno01Controller(

            ILogger<CotizacionAlumno01Controller> Logger
            , Alumno01Context Context
            , ICotizacionService<Alumno01Context> Service
            , IOrdenCompraService<Alumno01Context> OrdenCompraService,
              ITipoImpuestoService<Alumno01Context> TipoImpuestoService
            , CotizacionProceso<Alumno01Context> Proceso)
        {
            _Logger = Logger;
        ...
        public async Task<ActionResult> Post([FromBody] CotizacionCreacionDTO creacionDTO)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno01Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
