...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno01Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno01Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno01Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno01Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno01Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno01Controller(
            ILogger<AlmacenEntradaAlumno01Controller> logger,
            Alumno01Context context
            , IAlmacenEntradaService<Alumno01Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno01Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno01Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
