...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresAlumno01Controller : ControllerBase
    {
        private readonly GeneradoresProceso<Alumno01Context> _GeneradoresProceso;
        public GeneradoresAlumno01Controller(
            GeneradoresProceso<Alumno01Context> generadoresProceso)
        {
