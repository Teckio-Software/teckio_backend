...
{
    [Route("api/insumoxcotizacion/1")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno01Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno01Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno01Controller> _Logger;
        private readonly CotizacionProceso<Alumno01Context> _Proceso;
        private readonly Alumno01Context Context;
        public InsumoXCotizacionAlumno01Controller(
            ILogger<InsumoXCotizacionAlumno01Controller> Logger,
            Alumno01Context Context
            , IInsumoXCotizacionService<Alumno01Context> Service
