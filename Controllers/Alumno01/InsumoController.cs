...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoAlumno01Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno01Context> _InsumoProceso;
        public InsumoAlumno01Controller(
            InsumoProceso<Alumno01Context> insumoProceso)
        {
