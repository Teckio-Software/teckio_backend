...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno01Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno01Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno01Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno01Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno01Controller(
            ILogger<AlmacenEntradaInsumoAlumno01Controller> logger,
            Alumno01Context context
            , IInsumoXAlmacenEntradaService<Alumno01Context> AlmacenEntradaDetalle
