...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoAlumno01Controller : ControllerBase
    {
        private readonly ConceptoProceso<Alumno01Context> _ConceptoProceso;
        public ConceptoAlumno01Controller(
            ConceptoProceso<Alumno01Context> conceptoProceso)
        {
