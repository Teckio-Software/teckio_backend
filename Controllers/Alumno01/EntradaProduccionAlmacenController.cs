...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EntradaProduccionAlmacenAlumno01Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<Alumno01Context> _proceso;

        public EntradaProduccionAlmacenAlumno01Controller(EntradaProduccionAlmacenProceso<Alumno01Context> proceso)
        {
            _proceso = proceso;
        }
