...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno01Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno01Context> _Service;

        private readonly RequisicionProceso<Alumno01Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno01Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno01Controller(
            ILogger<InsumoXRequisicionAlumno01Controller> Logger,
            RequisicionProceso<Alumno01Context> Proceso,
            Alumno01Context Context
            , IInsumoXRequisicionService<Alumno01Context> Service)
        {
            _Logger = Logger;
