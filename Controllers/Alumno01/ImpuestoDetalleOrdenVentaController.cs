...
namespace ERP_TECKIO.Controllers.Alumno01
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno01Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno01Context> process)
        {
            _process = process;
        }
