...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroAlumno01Controller : ControllerBase
    {
        private readonly IRubroService<Alumno01Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno01Controller> Logger;
        ...
        public RubroAlumno01Controller(
            ILogger<RubroAlumno01Controller> logger,
            Alumno01Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno01Context> service
            )
        {
            //_Service = service;
            Logger = logger;
