...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoAlumno01Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno01Context> _TipoInsumoProceso;

        public TipoInsumoAlumno01Controller(
            TipoInsumoProceso<Alumno01Context> tipoInsumoProceso
            )
        {
