...
{
    [Route("api/reportesdestajo/1")]
    [ApiController]
    public class ReporteDestajoAlumno01Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno01Context> _proceso;
        private readonly EstimacionesProceso<Alumno01Context> _estimacionesProceso;

        public ReporteDestajoAlumno01Controller(
            ReporteDestajoProceso<Alumno01Context> proceso,
            EstimacionesProceso<Alumno01Context> estimacionesProceso
            ) { 
            _proceso = proceso;
