...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno01Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno01Context> _Service;
        private readonly OrdenCompraProceso<Alumno01Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno01Controller> _Logger;
        private readonly Alumno01Context _Context;
        public InsumoXOrdenCompraAlumno01Controller(
            ILogger<InsumoXOrdenCompraAlumno01Controller> Logger,
            Alumno01Context Context
            , IInsumoXOrdenCompraService<Alumno01Context> Service
