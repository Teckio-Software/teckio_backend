...
{
    [Route("api/indirectos/1")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno01Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno01Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno01Context> _indirectosService;
        private readonly IndirectosProceso<Alumno01Context> _indirectosProceso;

        public IndirectosAlumno01Controller(
                        IConjuntoIndirectosService<Alumno01Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno01Context> indirectosService,
                        IndirectosProceso<Alumno01Context> indirectosProceso
            )
        {
