...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno01Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno01Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno01Controller(
            MovimientoBancarioProceso<Alumno01Context> movimientoBancarioProceso
            )
        {
