...
namespace ERP_TECKIO.Controllers.Alumno01
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno01Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno01Context> proces)
        {
            _proceso = proces;
        }
