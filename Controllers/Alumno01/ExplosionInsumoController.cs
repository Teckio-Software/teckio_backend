...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoAlumno01Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoAlumno01Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoAlumno01Controller(
            ILogger<ExplosionInsumoAlumno01Controller> Logger,
