...
namespace ERP_TECKIO.Controllers.Alumno01
{
    ...
    public class ParametrosImpresionPuController : ControllerBase
    {
        ...
        private readonly ParametrosImpresionPuProceso<Alumno01Context> _proceso;

        public ParametrosImpresionPuController(ParametrosImpresionPuProceso<Alumno01Context> proceso)
        {
            _proceso = proceso;
        }

        [HttpPost("crear")]
        public async Task<ActionResult<RespuestaDTO>> Crear(ParametrosIPuConArchivo conjunto)
        {
