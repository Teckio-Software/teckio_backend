...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaAlumno01Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno01Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno01Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno01Controller(
            ILogger<CompraDirectaAlumno01Controller> logger,
            Alumno01Context context
            , ICompraDirectaService<Alumno01Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
