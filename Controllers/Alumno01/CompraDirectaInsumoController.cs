...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoAlumno01Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno01Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno01Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno01Controller(
            ILogger<CompraDirectaInsumoAlumno01Controller> logger
            , Alumno01Context context
            , IInsumoXCompraDirectaService<Alumno01Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
