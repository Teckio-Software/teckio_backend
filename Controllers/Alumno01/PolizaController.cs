...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaAlumno01Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno01Context> _Service;
        private readonly IPolizaDetalleService<Alumno01Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno01Context> _TipoPolizaService;
        ...
        public PolizaAlumno01Controller(
            ...
            , IPolizaService<Alumno01Context> service
            , IPolizaDetalleService<Alumno01Context> detalleService
