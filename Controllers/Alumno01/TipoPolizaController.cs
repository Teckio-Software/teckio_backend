...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaAlumno01Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno01Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno01Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno01Controller(
            ILogger<TipoPolizaAlumno01Controller> logger,
            Alumno01Context context
            , ITipoPolizaService<Alumno01Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
