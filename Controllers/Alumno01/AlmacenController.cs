...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno01Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno01Context> _almacenServicio;

        public AlmacenAlumno01Controller(
            IAlmacenService<Alumno01Context> almacenServicio)
        {
