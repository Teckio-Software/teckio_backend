...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno01Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno01Context> _bancoService;

        public BancoAlumno01Controller(IBancoService<Alumno01Context> bancoService)
        {
