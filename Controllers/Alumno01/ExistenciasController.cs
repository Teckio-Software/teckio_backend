...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno01Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno01Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno01Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno01Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno01Controller(
            ILogger<ExistenciasAlumno01Controller> Logger,
            Alumno01Context Context
            , IAlmacenExistenciaInsumoService<Alumno01Context> ExistenciaService
            , ExistenciasProceso<Alumno01Context> Proceso
            )
        {
            _Logger = Logger;
