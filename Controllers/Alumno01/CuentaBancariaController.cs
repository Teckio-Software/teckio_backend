...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno01Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno01Context> _proceso;

        private readonly ICuentaBancariaService<Alumno01Context> _servicio;
        public CuentaBancariaAlumno01Controller(CuentaBancariaProceso<Alumno01Context> _proceso, ICuentaBancariaService<Alumno01Context> _servicio
           )
        {
