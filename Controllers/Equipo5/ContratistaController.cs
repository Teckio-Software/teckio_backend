...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratista/43")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno43Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno43Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno43Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno43Controller(
            ILogger<ContratistaAlumno43Controller> logger,
            Alumno43Context context
            , IContratistaService<Alumno43Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
