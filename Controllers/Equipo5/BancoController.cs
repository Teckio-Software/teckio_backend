...
namespace SistemaERP.API.Controllers.Alumno43
{
    ...
    public class BancoAlumno43Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno43Context> _bancoService;

        public BancoAlumno43Controller(IBancoService<Alumno43Context> bancoService)
        {
