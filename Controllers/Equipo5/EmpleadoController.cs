...
{
    [Route("api/empleado/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoAlumno43Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno43Context> _empleadoService;
        public EmpleadoAlumno43Controller(
            IEmpleadoService<Alumno43Context> empleadoService
            )
        {
