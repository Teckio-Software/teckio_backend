...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno43Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno43Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno43Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno43Controller(
            ILogger<CompraDirectaInsumoAlumno43Controller> logger
            , Alumno43Context context
            , IInsumoXCompraDirectaService<Alumno43Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
