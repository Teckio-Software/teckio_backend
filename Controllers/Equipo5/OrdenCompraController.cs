...
{
    [Route("api/ordencompra/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno43Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno43Context> _Service;
        private readonly OrdenCompraProceso<Alumno43Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno43Controller> _Logger;
        private readonly Alumno43Context Context;
        public OrdenCompraAlumno43Controller(
            ILogger<OrdenCompraAlumno43Controller> Logger
            , Alumno43Context Context
            , IOrdenCompraService<Alumno43Context> Service
