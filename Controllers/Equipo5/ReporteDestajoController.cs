...
{
    [Route("api/reportesdestajo/43")]
    [ApiController]
    public class ReporteDestajoAlumno43Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno43Context> _proceso;
        private readonly EstimacionesProceso<Alumno43Context> _estimacionesProceso;

        public ReporteDestajoAlumno43Controller(
            ReporteDestajoProceso<Alumno43Context> proceso,
            EstimacionesProceso<Alumno43Context> estimacionesProceso
            ) { 
            _proceso = proceso;
