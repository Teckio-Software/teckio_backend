...
{
    [Route("api/programacionestimada/43")]
    [ApiController]
    public class ProgramacionEstimadaAlumno43Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno43Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno43Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno43Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno43Controller(
            ProgramacionEstimadaProceso<Alumno43Context> programacionEstimadaProceso,
            IProyectoService<Alumno43Context> proyectoProceso,
            IPrecioUnitarioService<Alumno43Context> precioUnitarioService,
