...
{
    [Route("api/cotizacion/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno43Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno43Context> _Service;
        private readonly CotizacionProceso<Alumno43Context> _Proceso;
        private readonly IOrdenCompraService<Alumno43Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno43Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno43Controller> _Logger;
        private readonly Alumno43Context Context;
        public CotizacionAlumno43Controller(

            ILogger<CotizacionAlumno43Controller> Logger
            , Alumno43Context Context
            , ICotizacionService<Alumno43Context> Service
            , IOrdenCompraService<Alumno43Context> OrdenCompraService,
              ITipoImpuestoService<Alumno43Context> TipoImpuestoService
            , CotizacionProceso<Alumno43Context> Proceso)
        {
            _Logger = Logger;
