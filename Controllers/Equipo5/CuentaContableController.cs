...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentacontable/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno43Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno43Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno43Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno43Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno43Controller(
            ILogger<CuentaContableAlumno43Controller> logger,
            Alumno43Context context
            , ICuentaContableService<Alumno43Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno43Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
