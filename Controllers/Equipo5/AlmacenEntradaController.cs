...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentrada/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno43Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno43Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno43Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno43Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno43Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno43Controller(
            ILogger<AlmacenEntradaAlumno43Controller> logger,
            Alumno43Context context
            , IAlmacenEntradaService<Alumno43Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno43Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno43Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
