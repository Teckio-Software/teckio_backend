...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialidad/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa35")]
    public class EspecialidadAlumno43Controller : ControllerBase
    {
        private readonly EspecialidadProceso<Alumno43Context> _EspecialidadProceso;
        public EspecialidadAlumno43Controller(
            EspecialidadProceso<Alumno43Context> especialidadProceso)
        {
