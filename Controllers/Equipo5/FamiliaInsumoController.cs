...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/familiainsumo/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno43Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno43Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno43Controller(
            FamiliaInsumoProceso<Alumno43Context> familiaInsumoProceso)
        {
