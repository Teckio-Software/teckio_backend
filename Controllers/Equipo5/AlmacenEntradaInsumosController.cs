...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno43Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno43Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno43Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno43Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno43Controller(
            ILogger<AlmacenEntradaInsumoAlumno43Controller> logger,
            Alumno43Context context
            , IInsumoXAlmacenEntradaService<Alumno43Context> AlmacenEntradaDetalle
