...
{
    [Route("api/insumoxcotizacion/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno43Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno43Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno43Controller> _Logger;
        private readonly CotizacionProceso<Alumno43Context> _Proceso;
        private readonly Alumno43Context Context;
        public InsumoXCotizacionAlumno43Controller(
            ILogger<InsumoXCotizacionAlumno43Controller> Logger,
            Alumno43Context Context
            , IInsumoXCotizacionService<Alumno43Context> Service
