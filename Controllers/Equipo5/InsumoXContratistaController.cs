...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa35")]
    public class InsumoXContratistaAlumno43Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno43Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno43Controller(
            ILogger<InsumoXContratistaAlumno43Controller> logger,
