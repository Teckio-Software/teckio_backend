...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenSalida/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno43Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno43Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno43Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno43Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno43Controller> Logger;
        ...
        public AlmacenSalidaAlumno43Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno43Controller> logger,
            Alumno43Context context
            , IAlmacenSalidaService<Alumno43Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno43Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno43Context> Proceso
            )
        {
