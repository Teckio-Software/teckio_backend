...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno43Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno43Context> _proceso;

        private readonly ICuentaBancariaService<Alumno43Context> _servicio;
        public CuentaBancariaAlumno43Controller(CuentaBancariaProceso<Alumno43Context> _proceso, ICuentaBancariaService<Alumno43Context> _servicio
           )
        {
