...
{
    [Route("api/polizadetalle/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa35")]
    public class PolizaDetalleAlumno43Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno43Context> _Service;
        private readonly ICuentaContableService<Alumno43Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno43Controller> _Logger;
        private readonly Alumno43Context _Context;
        public PolizaDetalleAlumno43Controller(
            ILogger<PolizaDetalleAlumno43Controller> logger
            , Alumno43Context context
            , IPolizaDetalleService<Alumno43Context> service
