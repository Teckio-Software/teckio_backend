...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/requisicion/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno43Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno43Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno43Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno43Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno43Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno43Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno43Controller(
            ILogger<RequisicionAlumno43Controller> Logger
            , Alumno43Context Context
            , IRequisicionService<Alumno43Context> RequisicionService
            , RequisicionProceso<Alumno43Context> Proceso
            , ObjetoRequisicionProceso<Alumno43Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno43Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
