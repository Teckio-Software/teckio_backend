...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    public class InsumoAlumno43Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno43Context> _InsumoProceso;
        public InsumoAlumno43Controller(
            InsumoProceso<Alumno43Context> insumoProceso)
        {
