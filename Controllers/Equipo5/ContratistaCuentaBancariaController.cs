...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/43")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno43Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno43Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno43Controller(
            ILogger<ContratistaCuentaBancariaAlumno43Controller> logger,
