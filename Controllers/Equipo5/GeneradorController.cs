...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/generadores/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa35")]
    public class GeneradoresAlumno43Controller : ControllerBase
    {
        private readonly GeneradoresProceso<Alumno43Context> _GeneradoresProceso;
        public GeneradoresAlumno43Controller(
            GeneradoresProceso<Alumno43Context> generadoresProceso)
        {
