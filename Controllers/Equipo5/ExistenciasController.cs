...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/existencias/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno43Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno43Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno43Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno43Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno43Controller(
            ILogger<ExistenciasAlumno43Controller> Logger,
            Alumno43Context Context
            , IAlmacenExistenciaInsumoService<Alumno43Context> ExistenciaService
            , ExistenciasProceso<Alumno43Context> Proceso
            )
        {
            _Logger = Logger;
