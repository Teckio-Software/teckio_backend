...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    public class PolizaAlumno43Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno43Context> _Service;
        private readonly IPolizaDetalleService<Alumno43Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno43Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno43Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno43Context> _SaldosService;
        private readonly ILogger<PolizaAlumno43Controller> _Logger;
        private readonly Alumno43Context _Context;
        public PolizaAlumno43Controller(
            ILogger<PolizaAlumno43Controller> logger
            , Alumno43Context context
            , IPolizaService<Alumno43Context> service
            , IPolizaDetalleService<Alumno43Context> detalleService
            , ITipoPolizaService<Alumno43Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno43Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa35")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa35")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa35")]
