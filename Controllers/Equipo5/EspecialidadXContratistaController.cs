...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa35")]
    public class EspecialIdadXContratistaAlumno43Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno43Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno43Controller(
            ILogger<EspecialIdadXContratistaAlumno43Controller> logger,
