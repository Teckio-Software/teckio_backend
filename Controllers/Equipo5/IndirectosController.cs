...
{
    [Route("api/indirectos/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno43Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno43Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno43Context> _indirectosService;
        private readonly IndirectosProceso<Alumno43Context> _indirectosProceso;

        public IndirectosAlumno43Controller(
                        IConjuntoIndirectosService<Alumno43Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno43Context> indirectosService,
                        IndirectosProceso<Alumno43Context> indirectosProceso
            )
        {
