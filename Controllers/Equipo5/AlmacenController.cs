...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    [Route("api/almacen/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno43Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno43Context> _almacenServicio;

        public AlmacenAlumno43Controller(
            IAlmacenService<Alumno43Context> almacenServicio)
        {
