...
{
    [Route("api/insumoxordencompra/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno43Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno43Context> _Service;
        private readonly OrdenCompraProceso<Alumno43Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno43Controller> _Logger;
        private readonly Alumno43Context _Context;
        public InsumoXOrdenCompraAlumno43Controller(
            ILogger<InsumoXOrdenCompraAlumno43Controller> Logger,
            Alumno43Context Context
            , IInsumoXOrdenCompraService<Alumno43Context> Service
            , OrdenCompraProceso<Alumno43Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
