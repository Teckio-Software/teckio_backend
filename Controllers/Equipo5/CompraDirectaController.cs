...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirecta/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno43Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno43Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno43Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno43Context Context;
        /// <summary>
        ...
        public CompraDirectaAlumno43Controller(
            ILogger<CompraDirectaAlumno43Controller> logger,
            Alumno43Context context
            , ICompraDirectaService<Alumno43Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        public async Task<ActionResult> Post([FromBody] CompraDirectaCreacionDTO CreacionDTO)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno43Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
