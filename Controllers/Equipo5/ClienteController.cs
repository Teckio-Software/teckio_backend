...
{
    [Route("api/cliente/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno43Controller : ControllerBase
    {
        private readonly IClientesService<Alumno43Context> _Service;

        private readonly ClienteProceso<Alumno43Context> _Proceso;
        public ClienteAlumno43Controller(
            IClientesService<Alumno43Context> service
            , ClienteProceso<Alumno43Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
