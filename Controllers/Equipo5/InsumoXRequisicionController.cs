...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno43Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno43Context> _Service;

        private readonly RequisicionProceso<Alumno43Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno43Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno43Controller(
            ILogger<InsumoXRequisicionAlumno43Controller> Logger,
            RequisicionProceso<Alumno43Context> Proceso,
            Alumno43Context Context
            , IInsumoXRequisicionService<Alumno43Context> Service)
        {
            _Logger = Logger;
