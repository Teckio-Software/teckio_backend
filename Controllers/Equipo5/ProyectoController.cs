...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/proyecto/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno43Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno43Context> _ProyectoProceso;
        public ProyectoAlumno43Controller(
            ProyectoProceso<Alumno43Context> proyectoProceso)
        {
