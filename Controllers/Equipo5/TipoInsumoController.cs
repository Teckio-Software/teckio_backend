...
namespace SistemaERP.API.Alumno43Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/43")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno43Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno43Context> _TipoInsumoProceso;

        public TipoInsumoAlumno43Controller(
            TipoInsumoProceso<Alumno43Context> tipoInsumoProceso
            )
        {
