...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno17Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno17Context> _Service;
        private readonly OrdenCompraProceso<Alumno17Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno17Controller> _Logger;
        private readonly Alumno17Context _Context;
        public InsumoXOrdenCompraAlumno17Controller(
            ILogger<InsumoXOrdenCompraAlumno17Controller> Logger,
            Alumno17Context Context
            , IInsumoXOrdenCompraService<Alumno17Context> Service
