...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa17")]
    public class TipoPolizaAlumno17Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno17Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno17Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno17Controller(
            ILogger<TipoPolizaAlumno17Controller> logger,
            Alumno17Context context
            , ITipoPolizaService<Alumno17Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa17")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa17")]
