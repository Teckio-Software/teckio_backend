...
namespace ERP_TECKIO.API.Controllers.Alumno17
{
    ...
    public class IndirectosAlumno17Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno17Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno17Context> _indirectosService;
        private readonly IndirectosProceso<Alumno17Context> _indirectosProceso;

        public IndirectosAlumno17Controller(
                        IConjuntoIndirectosService<Alumno17Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno17Context> indirectosService,
                        IndirectosProceso<Alumno17Context> indirectosProceso
            )
        {
