...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ContratistaCuentaBancariaAlumno17Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno17Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno17Controller(
            ILogger<ContratistaCuentaBancariaAlumno17Controller> logger,
