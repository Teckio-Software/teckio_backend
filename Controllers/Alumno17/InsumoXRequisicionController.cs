...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno17Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno17Context> _Service;

        private readonly RequisicionProceso<Alumno17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno17Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno17Controller(
            ILogger<InsumoXRequisicionAlumno17Controller> Logger,
            RequisicionProceso<Alumno17Context> Proceso,
            Alumno17Context Context
            , IInsumoXRequisicionService<Alumno17Context> Service)
        {
            _Logger = Logger;
