...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    public class OrdenVentaAlumno17Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno17Context> _ordenVentaProceso;
        public OrdenVentaAlumno17Controller(
            OrdenVentaProceso<Alumno17Context> ordenVentaProceso
            ) { 
