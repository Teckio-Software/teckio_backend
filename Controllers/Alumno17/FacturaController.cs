...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    public class FacturaAlumno17Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno17Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno17Context> _categoriaProductoYServicioService;
        public FacturaAlumno17Controller(
            ObtenFacturaProceso<Alumno17Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno17Context> categoriaProductoYServicioService
            )
        {
