...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno17Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno17Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno17Controller> _Logger;
        private readonly CotizacionProceso<Alumno17Context> _Proceso;
        private readonly Alumno17Context Context;
        public InsumoXCotizacionAlumno17Controller(
            ILogger<InsumoXCotizacionAlumno17Controller> Logger,
            Alumno17Context Context
            , IInsumoXCotizacionService<Alumno17Context> Service
