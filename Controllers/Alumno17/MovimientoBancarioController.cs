...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno17Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno17Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno17Controller(
            MovimientoBancarioProceso<Alumno17Context> movimientoBancarioProceso
            )
        {
