...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno17Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno17Context> _empleadoService;
        public EmpleadoAlumno17Controller(
            IEmpleadoService<Alumno17Context> empleadoService
            )
        {
