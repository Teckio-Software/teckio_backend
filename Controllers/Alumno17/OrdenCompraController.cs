...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno17Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno17Context> _Service;
        private readonly OrdenCompraProceso<Alumno17Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno17Controller> _Logger;
        private readonly Alumno17Context Context;
        private readonly PolizaProceso<Alumno17Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno17Context> _obtenFacturaProceso;

        public OrdenCompraAlumno17Controller(
            ILogger<OrdenCompraAlumno17Controller> Logger
            , Alumno17Context Context
            , IOrdenCompraService<Alumno17Context> Service
            , OrdenCompraProceso<Alumno17Context> Proceso
            , PolizaProceso<Alumno17Context> polizaProceso
            , ObtenFacturaProceso<Alumno17Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
