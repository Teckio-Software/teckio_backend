...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa17")]
    public class EspecialIdadXContratistaAlumno17Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno17Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno17Controller(
            ILogger<EspecialIdadXContratistaAlumno17Controller> logger,
