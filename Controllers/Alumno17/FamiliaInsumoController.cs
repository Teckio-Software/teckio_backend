...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa17")]
    public class FamiliaInsumoAlumno17Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno17Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno17Controller(
            FamiliaInsumoProceso<Alumno17Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa17")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa17")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa17")]
