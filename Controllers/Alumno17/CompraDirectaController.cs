...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa17")]
    public class CompraDirectaAlumno17Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno17Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno17Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno17Controller(
            ILogger<CompraDirectaAlumno17Controller> logger,
            Alumno17Context context
            , ICompraDirectaService<Alumno17Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa17")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa17")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa17")]
