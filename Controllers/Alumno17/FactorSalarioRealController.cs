...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno17Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno17Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno17Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno17Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno17Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno17Context> porcentajeCesantiaEdadService
            )
        {
