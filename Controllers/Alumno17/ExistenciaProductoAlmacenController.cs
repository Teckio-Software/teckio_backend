...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno17Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno17Context> proces)
        {
            _proceso = proces;
        }
