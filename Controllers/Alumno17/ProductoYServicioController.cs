...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    public class ProductoYServicioAlumno17Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno17Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno17Context> _process;

        public ProductoYServicioAlumno17Controller(IProductoYservicioService<Alumno17Context> productoYServicioService,
            ProductoYServicioProceso<Alumno17Context> process
            )
        {
