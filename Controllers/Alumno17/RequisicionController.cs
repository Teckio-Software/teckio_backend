...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno17Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno17Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno17Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno17Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno17Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno17Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno17Controller(
            ILogger<RequisicionAlumno17Controller> Logger
            , Alumno17Context Context
            , IRequisicionService<Alumno17Context> RequisicionService
            , RequisicionProceso<Alumno17Context> Proceso
            , ObjetoRequisicionProceso<Alumno17Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno17Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
