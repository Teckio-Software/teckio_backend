...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno17Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno17Context> _almacenServicio;

        public AlmacenAlumno17Controller(
            IAlmacenService<Alumno17Context> almacenServicio)
        {
