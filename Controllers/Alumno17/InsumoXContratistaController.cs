...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa17")]
    public class InsumoXContratistaAlumno17Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno17Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno17Controller(
            ILogger<InsumoXContratistaAlumno17Controller> logger,
