...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno17Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno17Context> service)
        {
            _service = service;
        }
