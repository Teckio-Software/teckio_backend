...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno17Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno17Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno17Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno17Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno17Controller(
            ILogger<AlmacenEntradaInsumoAlumno17Controller> logger,
            Alumno17Context context
            , IInsumoXAlmacenEntradaService<Alumno17Context> AlmacenEntradaDetalle
