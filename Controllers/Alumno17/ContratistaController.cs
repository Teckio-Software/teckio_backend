...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno17Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno17Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno17Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno17Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno17Controller(
            ILogger<ContratistaAlumno17Controller> logger,
            Alumno17Context context
            , IContratistaService<Alumno17Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno17Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
