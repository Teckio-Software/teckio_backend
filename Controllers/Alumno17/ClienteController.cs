...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno17Controller : ControllerBase
    {
        private readonly IClientesService<Alumno17Context> _Service;

        private readonly ClienteProceso<Alumno17Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno17Context> _clientesCuentasContablesProceso;
        public ClienteAlumno17Controller(
            IClientesService<Alumno17Context> service
            , ClienteProceso<Alumno17Context> proceso,
            ClienteCuentasContablesProceso<Alumno17Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
