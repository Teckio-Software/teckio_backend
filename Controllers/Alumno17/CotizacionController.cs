...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno17Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno17Context> _Service;
        private readonly CotizacionProceso<Alumno17Context> _Proceso;
        private readonly IOrdenCompraService<Alumno17Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno17Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno17Controller> _Logger;
        private readonly Alumno17Context Context;
        public CotizacionAlumno17Controller(

            ILogger<CotizacionAlumno17Controller> Logger
            , Alumno17Context Context
            , ICotizacionService<Alumno17Context> Service
            , IOrdenCompraService<Alumno17Context> OrdenCompraService,
              ITipoImpuestoService<Alumno17Context> TipoImpuestoService
            , CotizacionProceso<Alumno17Context> Proceso)
        {
            _Logger = Logger;
