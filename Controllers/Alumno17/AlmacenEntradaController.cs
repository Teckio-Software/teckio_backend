...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno17Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno17Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno17Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno17Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno17Controller(
            ILogger<AlmacenEntradaAlumno17Controller> logger,
            Alumno17Context context
            , IAlmacenEntradaService<Alumno17Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno17Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno17Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
