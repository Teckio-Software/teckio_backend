...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno17Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno17Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno17Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno17Controller> Logger;
        ...
        public AlmacenSalidaAlumno17Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno17Controller> logger,
            Alumno17Context context
            , IAlmacenSalidaService<Alumno17Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno17Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno17Context> Proceso
            )
        {
