...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno17Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno17Context> _proceso;

        private readonly ICuentaBancariaService<Alumno17Context> _servicio;
        public CuentaBancariaAlumno17Controller(CuentaBancariaProceso<Alumno17Context> _proceso, ICuentaBancariaService<Alumno17Context> _servicio
           )
        {
