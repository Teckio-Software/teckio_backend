...
{
    [Route("api/saldosbalanzacomprobacion/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa17")]
    public class SaldosBalanzaComprobacionAlumno17Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno17Context> _Service;
        private readonly ICuentaContableService<Alumno17Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno17Controller> _Logger;
        private readonly Alumno17Context _Context;
        public SaldosBalanzaComprobacionAlumno17Controller(
            ILogger<SaldosBalanzaComprobacionAlumno17Controller> logger
            , Alumno17Context context
            , ISaldosBalanzaComprobacionService<Alumno17Context> service
