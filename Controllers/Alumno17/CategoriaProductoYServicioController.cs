...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno17Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno17Context> service)
        {
            _service = service;
        }
