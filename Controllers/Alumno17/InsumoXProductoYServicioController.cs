...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno17Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno17Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno17Context> service, InsumoXProductoYServicioProceso<Alumno17Context> process)
        {
            _service = service;
            _process = process;
        }
