...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno17Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno17Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno17Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno17Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno17Controller(
            ProgramacionEstimadaProceso<Alumno17Context> programacionEstimadaProceso,
            IProyectoService<Alumno17Context> proyectoProceso,
            IPrecioUnitarioService<Alumno17Context> precioUnitarioService,
