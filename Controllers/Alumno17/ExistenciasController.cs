...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno17Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno17Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno17Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno17Controller(
            ILogger<ExistenciasAlumno17Controller> Logger,
            Alumno17Context Context
            , IAlmacenExistenciaInsumoService<Alumno17Context> ExistenciaService
            , ExistenciasProceso<Alumno17Context> Proceso
            )
        {
            _Logger = Logger;
