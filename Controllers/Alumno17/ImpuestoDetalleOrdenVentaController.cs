...
namespace ERP_TECKIO.Controllers.Alumno17
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno17Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno17Context> process)
        {
            _process = process;
        }
