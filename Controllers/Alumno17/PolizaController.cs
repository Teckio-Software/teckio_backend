...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno17Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno17Context> _Service;
        private readonly IPolizaDetalleService<Alumno17Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno17Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno17Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno17Context> _SaldosService;
        private readonly ILogger<PolizaAlumno17Controller> _Logger;
        private readonly Alumno17Context _Context;
        public PolizaAlumno17Controller(
            ILogger<PolizaAlumno17Controller> logger
            , Alumno17Context context
            , IPolizaService<Alumno17Context> service
            , IPolizaDetalleService<Alumno17Context> detalleService
            , ITipoPolizaService<Alumno17Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno17Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa17")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa17")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa17")]
