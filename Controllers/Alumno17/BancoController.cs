...
namespace ERP_TECKIO.API.Controllers.Alumno17
{
    ...
    public class BancoAlumno17Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno17Context> _bancoService;

        public BancoAlumno17Controller(IBancoService<Alumno17Context> bancoService)
        {
