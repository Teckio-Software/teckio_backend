...
namespace ERP_TECKIO.API.Controllers.Alumno17
{
    ...
    [ApiController]
    public class ContratosAlumno17Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno17Context> _contratosProceso;
        public ContratosAlumno17Controller(
            ContratosProceso<Alumno17Context> contratosProceso
            )
        {
