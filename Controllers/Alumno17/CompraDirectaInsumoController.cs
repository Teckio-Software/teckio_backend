...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa17")]
    public class CompraDirectaInsumoAlumno17Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno17Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno17Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno17Controller(
            ILogger<CompraDirectaInsumoAlumno17Controller> logger
            , Alumno17Context context
            , IInsumoXCompraDirectaService<Alumno17Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
