...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoDemoTeckioController : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoDemoTeckioController> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoDemoTeckioController(
            ILogger<ExplosionInsumoDemoTeckioController> Logger,
