...
namespace ERP_TECKIO.Controllers.DemoTeckio
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/3")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioContext> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioContext> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioContext> service, InsumoXProductoYServicioProceso<DemoTeckioContext> process)
        {
            _service = service;
            _process = process;
        }
