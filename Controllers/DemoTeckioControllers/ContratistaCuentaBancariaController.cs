...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/3")]
    [ApiController]
    public class ContratistaCuentaBancariaDemoTeckioController : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaDemoTeckioController> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaDemoTeckioController(
            ILogger<ContratistaCuentaBancariaDemoTeckioController> logger,
