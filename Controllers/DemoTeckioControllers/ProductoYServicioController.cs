...
namespace ERP_TECKIO.Controllers.DemoTeckio
{
    ...
    public class ProductoYServicioDemoTeckioController : ControllerBase
    {
        ...
        private readonly IProductoYservicioService<DemoTeckioContext> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioContext> _process;

        public ProductoYServicioDemoTeckioController(IProductoYservicioService<DemoTeckioContext> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioContext> process
            )
        {
