...
{
    [Route("api/indirectosXConcepto/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioController : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioContext> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioContext> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioController(
            IIndirectosXConceptoService<DemoTeckioContext> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioContext> indirectosXConceptoProceso
            ) { 
