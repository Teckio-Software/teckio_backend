...
namespace SistemaERP.API.Controllers.DemoTeckio
{
    [Route("api/programacionestimadaGantt/3")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioController : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioContext> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioContext> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioContext> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioController(
            ProgramacionEstimadaGanttProceso<DemoTeckioContext> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioContext> importeSemanalGanttProceso,
