...
{
    [Route("api/programacionestimada/3")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioController : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioContext> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioContext> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioContext> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioController(
            ProgramacionEstimadaProceso<DemoTeckioContext> programacionEstimadaProceso,
            IProyectoService<DemoTeckioContext> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioContext> precioUnitarioService,
