...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenDemoTeckioController : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioContext> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioContext> _almacenProceso;

        public AlmacenDemoTeckioController(
            IAlmacenService<DemoTeckioContext> almacenServicio, AlmacenProceso<DemoTeckioContext> almacenProceso)
        {
