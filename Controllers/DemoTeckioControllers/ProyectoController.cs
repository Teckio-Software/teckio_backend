...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioController : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioContext> _ProyectoProceso;
        public ProyectoDemoTeckioController(
            ProyectoProceso<DemoTeckioContext> proyectoProceso)
        {
