...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioController : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioContext> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioContext> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioContext> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioContext> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioController(
            PrecioUnitarioProceso<DemoTeckioContext> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioContext> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioContext> options,
            ExplocionInsumosProceso<DemoTeckioContext> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioContext(_Options.Options))
            {
