...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioController : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioContext> _ConceptoProceso;
        public ConceptoDemoTeckioController(
            ConceptoProceso<DemoTeckioContext> conceptoProceso)
        {
