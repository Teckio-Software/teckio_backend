...
namespace ERP_TECKIO.Controllers.DemoTeckio
{
    ...
    [Route("api/categoriaProductoServicio/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CategoriaProductoYServicioController: ControllerBase
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioContext> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioContext> service)
        {
            _service = service;
        }
