...
{
    [Route("api/entradaproduccionalmacen/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioController : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioContext> _proceso;

        public EntradaProduccionAlmacenDemoTeckioController(EntradaProduccionAlmacenProceso<DemoTeckioContext> proceso)
        {
            _proceso = proceso;
        }
