...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioController : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioContext> _Service;
        private readonly IPolizaDetalleService<DemoTeckioContext> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioContext> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioContext> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioContext> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioController> _Logger;
        private readonly DemoTeckioContext _Context;
        private readonly PolizaProceso<DemoTeckioContext> _polizaProceso;
        public PolizaDemoTeckioController(
            ILogger<PolizaDemoTeckioController> logger
            , DemoTeckioContext context
            , IPolizaService<DemoTeckioContext> service
            , IPolizaDetalleService<DemoTeckioContext> detalleService
            , ITipoPolizaService<DemoTeckioContext> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioContext> saldosService
            , ICuentaContableService<DemoTeckioContext> cuentaContableService
            , PolizaProceso<DemoTeckioContext> polizaProceso
            )
        {
