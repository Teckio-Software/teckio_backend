...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioController : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioContext> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioContext> _servicio;
        public CuentaBancariaDemoTeckioController(CuentaBancariaProceso<DemoTeckioContext> _proceso, ICuentaBancariaService<DemoTeckioContext> _servicio
           )
        {
