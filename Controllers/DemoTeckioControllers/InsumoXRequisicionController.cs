...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioController : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioContext> _Service;

        private readonly RequisicionProceso<DemoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioController> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioController(
            ILogger<InsumoXRequisicionDemoTeckioController> Logger,
            RequisicionProceso<DemoTeckioContext> Proceso,
            DemoTeckioContext Context
            , IInsumoXRequisicionService<DemoTeckioContext> Service)
        {
            _Logger = Logger;
