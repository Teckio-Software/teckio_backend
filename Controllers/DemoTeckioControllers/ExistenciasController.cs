...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioController : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioContext> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioController> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioController(
            ILogger<ExistenciasDemoTeckioController> Logger,
            DemoTeckioContext Context
            , IAlmacenExistenciaInsumoService<DemoTeckioContext> ExistenciaService
            , ExistenciasProceso<DemoTeckioContext> Proceso
            )
        {
            _Logger = Logger;
