...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioController : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioContext> _InsumoProceso;
        public InsumoDemoTeckioController(
            InsumoProceso<DemoTeckioContext> insumoProceso)
        {
