...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioController : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioController> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioController(
            ILogger<CompraDirectaInsumoDemoTeckioController> logger
            , DemoTeckioContext context
            , IInsumoXCompraDirectaService<DemoTeckioContext> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
