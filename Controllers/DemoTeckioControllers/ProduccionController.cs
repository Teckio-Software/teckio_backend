...
namespace ERP_TECKIO.Controllers.DemoTeckio
{
    ...
    [Route("api/produccion/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioContext> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioContext> proceso)
        {
            _proceso = proceso;
        }
