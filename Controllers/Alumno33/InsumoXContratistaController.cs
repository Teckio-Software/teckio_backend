...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa33")]
    public class InsumoXContratistaAlumno33Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno33Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno33Controller(
            ILogger<InsumoXContratistaAlumno33Controller> logger,
