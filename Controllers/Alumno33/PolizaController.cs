...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno33Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno33Context> _Service;
        private readonly IPolizaDetalleService<Alumno33Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno33Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno33Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno33Context> _SaldosService;
        private readonly ILogger<PolizaAlumno33Controller> _Logger;
        private readonly Alumno33Context _Context;
        public PolizaAlumno33Controller(
            ILogger<PolizaAlumno33Controller> logger
            , Alumno33Context context
            , IPolizaService<Alumno33Context> service
            , IPolizaDetalleService<Alumno33Context> detalleService
            , ITipoPolizaService<Alumno33Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno33Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa33")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa33")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa33")]
