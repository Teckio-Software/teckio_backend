...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno33Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno33Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno33Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno33Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno33Controller(
            ILogger<ExistenciasAlumno33Controller> Logger,
            Alumno33Context Context
            , IAlmacenExistenciaInsumoService<Alumno33Context> ExistenciaService
            , ExistenciasProceso<Alumno33Context> Proceso
            )
        {
            _Logger = Logger;
