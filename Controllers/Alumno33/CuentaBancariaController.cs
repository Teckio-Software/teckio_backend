...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno33Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno33Context> _proceso;

        private readonly ICuentaBancariaService<Alumno33Context> _servicio;
        public CuentaBancariaAlumno33Controller(CuentaBancariaProceso<Alumno33Context> _proceso, ICuentaBancariaService<Alumno33Context> _servicio
           )
        {
