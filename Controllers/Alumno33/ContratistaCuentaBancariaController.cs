...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/33")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno33Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno33Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno33Controller(
            ILogger<ContratistaCuentaBancariaAlumno33Controller> logger,
