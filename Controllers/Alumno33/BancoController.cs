...
namespace ERP_TECKIO.API.Controllers.Alumno33
{
    ...
    public class BancoAlumno33Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno33Context> _bancoService;

        public BancoAlumno33Controller(IBancoService<Alumno33Context> bancoService)
        {
