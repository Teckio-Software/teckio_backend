...
{
    [Route("api/programacionestimada/33")]
    [ApiController]
    public class ProgramacionEstimadaAlumno33Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno33Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno33Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno33Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno33Controller(
            ProgramacionEstimadaProceso<Alumno33Context> programacionEstimadaProceso,
            IProyectoService<Alumno33Context> proyectoProceso,
            IPrecioUnitarioService<Alumno33Context> precioUnitarioService,
