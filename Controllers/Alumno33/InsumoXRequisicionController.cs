...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno33Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno33Context> _Service;

        private readonly RequisicionProceso<Alumno33Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno33Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno33Controller(
            ILogger<InsumoXRequisicionAlumno33Controller> Logger,
            RequisicionProceso<Alumno33Context> Proceso,
            Alumno33Context Context
            , IInsumoXRequisicionService<Alumno33Context> Service)
        {
            _Logger = Logger;
