...
{
    [Route("api/insumoxordencompra/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno33Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno33Context> _Service;
        private readonly OrdenCompraProceso<Alumno33Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno33Controller> _Logger;
        private readonly Alumno33Context _Context;
        public InsumoXOrdenCompraAlumno33Controller(
            ILogger<InsumoXOrdenCompraAlumno33Controller> Logger,
            Alumno33Context Context
            , IInsumoXOrdenCompraService<Alumno33Context> Service
