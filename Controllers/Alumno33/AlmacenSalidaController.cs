...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno33Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno33Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno33Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno33Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno33Controller> Logger;
        ...
        public AlmacenSalidaAlumno33Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno33Controller> logger,
            Alumno33Context context
            , IAlmacenSalidaService<Alumno33Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno33Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno33Context> Proceso
            )
        {
