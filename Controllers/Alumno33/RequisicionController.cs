...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno33Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno33Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno33Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno33Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno33Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno33Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno33Controller(
            ILogger<RequisicionAlumno33Controller> Logger
            , Alumno33Context Context
            , IRequisicionService<Alumno33Context> RequisicionService
            , RequisicionProceso<Alumno33Context> Proceso
            , ObjetoRequisicionProceso<Alumno33Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno33Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
