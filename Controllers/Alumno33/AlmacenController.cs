...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno33Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno33Context> _almacenServicio;

        public AlmacenAlumno33Controller(
            IAlmacenService<Alumno33Context> almacenServicio)
        {
