...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa33")]
    public class CompraDirectaInsumoAlumno33Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno33Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno33Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno33Controller(
            ILogger<CompraDirectaInsumoAlumno33Controller> logger
            , Alumno33Context context
            , IInsumoXCompraDirectaService<Alumno33Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
