...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno33Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno33Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno33Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno33Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno33Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno33Controller(
            ILogger<AlmacenEntradaAlumno33Controller> logger,
            Alumno33Context context
            , IAlmacenEntradaService<Alumno33Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno33Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno33Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
