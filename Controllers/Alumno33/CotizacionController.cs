...
{
    [Route("api/cotizacion/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno33Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno33Context> _Service;
        private readonly CotizacionProceso<Alumno33Context> _Proceso;
        private readonly IOrdenCompraService<Alumno33Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno33Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno33Controller> _Logger;
        private readonly Alumno33Context Context;
        public CotizacionAlumno33Controller(

            ILogger<CotizacionAlumno33Controller> Logger
            , Alumno33Context Context
            , ICotizacionService<Alumno33Context> Service
            , IOrdenCompraService<Alumno33Context> OrdenCompraService,
              ITipoImpuestoService<Alumno33Context> TipoImpuestoService
            , CotizacionProceso<Alumno33Context> Proceso)
        {
            _Logger = Logger;
