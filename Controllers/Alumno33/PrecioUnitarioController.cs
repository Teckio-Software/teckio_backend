...
namespace SistemaERP.API.Alumno33Controllers.Procomi
{
    [Route("api/preciounitario/33")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno33Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno33Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno33Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno33Context> _Options;
        public PrecioUnitarioAlumno33Controller(
            PrecioUnitarioProceso<Alumno33Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno33Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno33Context> options
            )
        {
        ...
        {
            using (var db = new Alumno33Context(_Options.Options))
            {
