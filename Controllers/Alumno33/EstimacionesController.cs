...
namespace ERP_TECKIO.API.Alumno033Controllers.Procomi
{
    [Route("api/estimaciones/33")]
    [ApiController]
    public class EstimacionesAlumno33Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno33Context> _estimacionesProceso;
        public EstimacionesAlumno33Controller(
