...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa33")]
    public class EspecialIdadXContratistaAlumno33Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno33Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno33Controller(
            ILogger<EspecialIdadXContratistaAlumno33Controller> logger,
