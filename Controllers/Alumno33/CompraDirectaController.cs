...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa33")]
    public class CompraDirectaAlumno33Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno33Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno33Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno33Controller(
            ILogger<CompraDirectaAlumno33Controller> logger,
            Alumno33Context context
            , ICompraDirectaService<Alumno33Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa33")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa33")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa33")]
