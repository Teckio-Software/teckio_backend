...
namespace ERP_TECKIO.Controllers.Alumno33
{
    [Route("api/fsr/33")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno33Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno33Context> factorSalarioRealProceso)
        {
