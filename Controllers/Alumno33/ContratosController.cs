...
{
    [Route("api/contratos/33")]
    [ApiController]
    public class ContratosAlumno33Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno33Context> _contratosProceso;
        public ContratosAlumno33Controller(
            ContratosProceso<Alumno33Context> contratosProceso
            )
        {
