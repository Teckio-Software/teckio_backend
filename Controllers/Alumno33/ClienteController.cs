...
{
    [Route("api/cliente/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno33Controller : ControllerBase
    {
        private readonly IClientesService<Alumno33Context> _Service;

        private readonly ClienteProceso<Alumno33Context> _Proceso;
        public ClienteAlumno33Controller(
            IClientesService<Alumno33Context> service
            , ClienteProceso<Alumno33Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
