...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa33")]
    public class CuentaContableAlumno33Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno33Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno33Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno33Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno33Controller(
            ILogger<CuentaContableAlumno33Controller> logger,
            Alumno33Context context
            , ICuentaContableService<Alumno33Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno33Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
