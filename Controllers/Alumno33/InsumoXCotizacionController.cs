...
{
    [Route("api/insumoxcotizacion/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno33Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno33Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno33Controller> _Logger;
        private readonly CotizacionProceso<Alumno33Context> _Proceso;
        private readonly Alumno33Context Context;
        public InsumoXCotizacionAlumno33Controller(
            ILogger<InsumoXCotizacionAlumno33Controller> Logger,
            Alumno33Context Context
            , IInsumoXCotizacionService<Alumno33Context> Service
