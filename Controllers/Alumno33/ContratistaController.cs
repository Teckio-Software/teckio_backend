...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/33")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno33Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno33Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno33Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno33Controller(
            ILogger<ContratistaAlumno33Controller> logger,
            Alumno33Context context
            , IContratistaService<Alumno33Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
