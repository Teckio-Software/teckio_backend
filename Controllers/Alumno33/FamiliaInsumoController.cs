...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa33")]
    public class FamiliaInsumoAlumno33Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno33Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno33Controller(
            FamiliaInsumoProceso<Alumno33Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa33")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa33")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa33")]
