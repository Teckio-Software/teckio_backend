...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno33Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno33Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno33Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno33Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno33Controller(
            ILogger<AlmacenEntradaInsumoAlumno33Controller> logger,
            Alumno33Context context
            , IInsumoXAlmacenEntradaService<Alumno33Context> AlmacenEntradaDetalle
