...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/33")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa33")]
    public class TipoPolizaAlumno33Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno33Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno33Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno33Controller(
            ILogger<TipoPolizaAlumno33Controller> logger,
            Alumno33Context context
            , ITipoPolizaService<Alumno33Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa33")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa33")]
