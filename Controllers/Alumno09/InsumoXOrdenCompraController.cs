...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno09Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno09Context> _Service;
        private readonly OrdenCompraProceso<Alumno09Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno09Controller> _Logger;
        private readonly Alumno09Context _Context;
        public InsumoXOrdenCompraAlumno09Controller(
            ILogger<InsumoXOrdenCompraAlumno09Controller> Logger,
            Alumno09Context Context
            , IInsumoXOrdenCompraService<Alumno09Context> Service
