...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno09Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno09Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno09Context> service, InsumoXProductoYServicioProceso<Alumno09Context> process)
        {
            _service = service;
            _process = process;
        }
