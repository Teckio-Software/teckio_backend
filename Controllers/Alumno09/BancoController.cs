...
namespace ERP_TECKIO.API.Controllers.Alumno09
{
    ...
    public class BancoAlumno09Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno09Context> _bancoService;

        public BancoAlumno09Controller(IBancoService<Alumno09Context> bancoService)
        {
