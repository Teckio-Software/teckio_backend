...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno09Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno09Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno09Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno09Controller(
            ILogger<ExistenciasAlumno09Controller> Logger,
            Alumno09Context Context
            , IAlmacenExistenciaInsumoService<Alumno09Context> ExistenciaService
            , ExistenciasProceso<Alumno09Context> Proceso
            )
        {
            _Logger = Logger;
