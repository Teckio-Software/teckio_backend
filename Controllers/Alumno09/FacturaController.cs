...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    public class FacturaAlumno09Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno09Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno09Context> _categoriaProductoYServicioService;
        public FacturaAlumno09Controller(
            ObtenFacturaProceso<Alumno09Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno09Context> categoriaProductoYServicioService
            )
        {
