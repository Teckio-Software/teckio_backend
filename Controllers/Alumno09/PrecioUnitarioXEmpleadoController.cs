...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno09Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno09Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno09Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno09Controller(
            IPrecioUnitarioXEmpleadoService<Alumno09Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno09Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
