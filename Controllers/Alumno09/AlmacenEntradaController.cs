...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno09Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno09Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno09Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno09Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno09Controller(
            ILogger<AlmacenEntradaAlumno09Controller> logger,
            Alumno09Context context
            , IAlmacenEntradaService<Alumno09Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno09Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno09Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
