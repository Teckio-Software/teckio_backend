...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno09Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno09Context> _Service;

        private readonly RequisicionProceso<Alumno09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno09Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno09Controller(
            ILogger<InsumoXRequisicionAlumno09Controller> Logger,
            RequisicionProceso<Alumno09Context> Proceso,
            Alumno09Context Context
            , IInsumoXRequisicionService<Alumno09Context> Service)
        {
            _Logger = Logger;
