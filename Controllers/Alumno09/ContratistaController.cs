...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno09Controller : ControllerBase
    {
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno09Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno09Controller(
            ...
            ContratistaCuentasContablesProceso<Alumno09Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
