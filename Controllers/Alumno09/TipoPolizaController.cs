...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa9")]
    public class TipoPolizaAlumno09Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno09Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno09Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno09Controller(
            ILogger<TipoPolizaAlumno09Controller> logger,
            Alumno09Context context
            , ITipoPolizaService<Alumno09Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa9")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa9")]
