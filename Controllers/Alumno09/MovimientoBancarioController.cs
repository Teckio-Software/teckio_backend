...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno09Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno09Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno09Controller(
            MovimientoBancarioProceso<Alumno09Context> movimientoBancarioProceso
            )
        {
