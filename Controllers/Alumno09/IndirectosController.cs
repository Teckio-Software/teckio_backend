...
{
    [Route("api/indirectos/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno09Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno09Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno09Context> _indirectosService;
        private readonly IndirectosProceso<Alumno09Context> _indirectosProceso;

        public IndirectosAlumno09Controller(
                        IConjuntoIndirectosService<Alumno09Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno09Context> indirectosService,
                        IndirectosProceso<Alumno09Context> indirectosProceso
            )
        {
