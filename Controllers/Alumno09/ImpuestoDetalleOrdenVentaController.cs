...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno09Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno09Context> process)
        {
            _process = process;
        }
