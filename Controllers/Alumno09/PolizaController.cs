...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaAlumno09Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno09Context> _Service;
        private readonly IPolizaDetalleService<Alumno09Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno09Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno09Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno09Context> _SaldosService;
        private readonly ILogger<PolizaAlumno09Controller> _Logger;
        private readonly Alumno09Context _Context;
        public PolizaAlumno09Controller(
            ILogger<PolizaAlumno09Controller> logger
            , Alumno09Context context
            , IPolizaService<Alumno09Context> service
            , IPolizaDetalleService<Alumno09Context> detalleService
            , ITipoPolizaService<Alumno09Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno09Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa9")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa9")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa9")]
