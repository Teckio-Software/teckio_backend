...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno09Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno09Context> service)
        {
            _service = service;
        }
