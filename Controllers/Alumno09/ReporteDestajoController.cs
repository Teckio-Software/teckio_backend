...
namespace ERP_TECKIO.API.Controllers.Alumno09
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno09Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno09Context> _proceso;
        private readonly EstimacionesProceso<Alumno09Context> _estimacionesProceso;

        public ReporteDestajoAlumno09Controller(
            ReporteDestajoProceso<Alumno09Context> proceso,
            EstimacionesProceso<Alumno09Context> estimacionesProceso
            ) { 
            _proceso = proceso;
