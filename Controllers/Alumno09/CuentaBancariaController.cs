...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno09Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno09Context> _proceso;

        private readonly ICuentaBancariaService<Alumno09Context> _servicio;
        public CuentaBancariaAlumno09Controller(CuentaBancariaProceso<Alumno09Context> _proceso, ICuentaBancariaService<Alumno09Context> _servicio
           )
        {
