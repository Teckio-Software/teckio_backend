...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno09Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno09Context> service)
        {
            _service = service;
        }
