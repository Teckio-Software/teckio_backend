...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno09Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno09Context> _Service;
        private readonly CotizacionProceso<Alumno09Context> _Proceso;
        private readonly IOrdenCompraService<Alumno09Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno09Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno09Controller> _Logger;
        private readonly Alumno09Context Context;
        public CotizacionAlumno09Controller(

            ILogger<CotizacionAlumno09Controller> Logger
            , Alumno09Context Context
            , ICotizacionService<Alumno09Context> Service
            , IOrdenCompraService<Alumno09Context> OrdenCompraService,
              ITipoImpuestoService<Alumno09Context> TipoImpuestoService
            , CotizacionProceso<Alumno09Context> Proceso)
        {
            _Logger = Logger;
