...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EntradaProduccionAlmacenAlumno09Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<Alumno09Context> _proceso;

        public EntradaProduccionAlmacenAlumno09Controller(EntradaProduccionAlmacenProceso<Alumno09Context> proceso)
        {
            _proceso = proceso;
        }
