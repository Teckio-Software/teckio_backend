...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa9")]
    public class CompraDirectaInsumoAlumno09Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno09Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno09Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno09Controller(
            ILogger<CompraDirectaInsumoAlumno09Controller> logger
            , Alumno09Context context
            , IInsumoXCompraDirectaService<Alumno09Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
