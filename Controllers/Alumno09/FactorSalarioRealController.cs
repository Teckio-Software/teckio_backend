...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno09Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno09Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno09Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno09Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno09Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno09Context> porcentajeCesantiaEdadService
            )
        {
