...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno09Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno09Context> proces)
        {
            _proceso = proces;
        }
