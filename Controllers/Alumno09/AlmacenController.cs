...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno09Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno09Context> _almacenServicio;

        public AlmacenAlumno09Controller(
            IAlmacenService<Alumno09Context> almacenServicio)
        {
