...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno09Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno09Context> _Service;
        private readonly OrdenCompraProceso<Alumno09Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno09Controller> _Logger;
        private readonly Alumno09Context Context;
        private readonly PolizaProceso<Alumno09Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno09Context> _obtenFacturaProceso;

        public OrdenCompraAlumno09Controller(
            ILogger<OrdenCompraAlumno09Controller> Logger
            , Alumno09Context Context
            , IOrdenCompraService<Alumno09Context> Service
            , OrdenCompraProceso<Alumno09Context> Proceso
            , PolizaProceso<Alumno09Context> polizaProceso
            , ObtenFacturaProceso<Alumno09Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
