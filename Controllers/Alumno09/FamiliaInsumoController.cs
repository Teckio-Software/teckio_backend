...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa9")]
    public class FamiliaInsumoAlumno09Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno09Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno09Controller(
            FamiliaInsumoProceso<Alumno09Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa9")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa9")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa9")]
