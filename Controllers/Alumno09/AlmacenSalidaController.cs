...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno09Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno09Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno09Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno09Controller> Logger;
        ...
        public AlmacenSalidaAlumno09Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno09Controller> logger,
            Alumno09Context context
            , IAlmacenSalidaService<Alumno09Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno09Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno09Context> Proceso
            )
        {
