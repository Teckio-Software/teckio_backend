...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno09Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno09Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno09Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno09Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno09Controller(
            ILogger<AlmacenEntradaInsumoAlumno09Controller> logger,
            Alumno09Context context
            , IInsumoXAlmacenEntradaService<Alumno09Context> AlmacenEntradaDetalle
