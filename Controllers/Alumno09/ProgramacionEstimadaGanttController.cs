...
namespace SistemaERP.API.Controllers.Alumno09
{
    [Route("api/programacionestimadaGantt/9")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno09Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno09Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno09Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno09Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno09Controller(
            ProgramacionEstimadaGanttProceso<Alumno09Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno09Context> importeSemanalGanttProceso,
