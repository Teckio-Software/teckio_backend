...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    public class ProductoYServicioAlumno09Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno09Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno09Context> _process;

        public ProductoYServicioAlumno09Controller(IProductoYservicioService<Alumno09Context> productoYServicioService,
            ProductoYServicioProceso<Alumno09Context> process
            )
        {
