...
namespace ERP_TECKIO.Controllers.Alumno09
{
    ...
    public class OrdenVentaAlumno09Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno09Context> _ordenVentaProceso;
        public OrdenVentaAlumno09Controller(
            OrdenVentaProceso<Alumno09Context> ordenVentaProceso
            ) { 
