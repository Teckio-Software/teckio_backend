...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno09Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno09Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno09Controller> _Logger;
        private readonly CotizacionProceso<Alumno09Context> _Proceso;
        private readonly Alumno09Context Context;
        public InsumoXCotizacionAlumno09Controller(
            ILogger<InsumoXCotizacionAlumno09Controller> Logger,
            Alumno09Context Context
            , IInsumoXCotizacionService<Alumno09Context> Service
