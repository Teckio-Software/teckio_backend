...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno09Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno09Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno09Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno09Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno09Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno09Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno09Controller(
            ILogger<RequisicionAlumno09Controller> Logger
            , Alumno09Context Context
            , IRequisicionService<Alumno09Context> RequisicionService
            , RequisicionProceso<Alumno09Context> Proceso
            , ObjetoRequisicionProceso<Alumno09Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno09Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
