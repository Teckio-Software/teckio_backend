...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno09Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno09Context> _empleadoService;
        public EmpleadoAlumno09Controller(
            IEmpleadoService<Alumno09Context> empleadoService
            )
        {
