...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    public class InsumoAlumno41Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno41Context> _InsumoProceso;
        public InsumoAlumno41Controller(
            InsumoProceso<Alumno41Context> insumoProceso)
        {
