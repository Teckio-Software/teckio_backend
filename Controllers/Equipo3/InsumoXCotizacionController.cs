...
{
    [Route("api/insumoxcotizacion/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno41Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno41Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno41Controller> _Logger;
        private readonly CotizacionProceso<Alumno41Context> _Proceso;
        private readonly Alumno41Context Context;
        public InsumoXCotizacionAlumno41Controller(
            ILogger<InsumoXCotizacionAlumno41Controller> Logger,
            Alumno41Context Context
            , IInsumoXCotizacionService<Alumno41Context> Service
