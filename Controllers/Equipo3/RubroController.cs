...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    public class RubroAlumno41Controller : ControllerBase
    {
        private readonly IRubroService<Alumno41Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno41Controller> Logger;
        ...
        public RubroAlumno41Controller(
            ILogger<RubroAlumno41Controller> logger,
            Alumno41Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno41Context> service
            )
        {
            //_Service = service;
            Logger = logger;
