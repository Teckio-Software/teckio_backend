...
{
    [Route("api/cliente/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno41Controller : ControllerBase
    {
        private readonly IClientesService<Alumno41Context> _Service;

        private readonly ClienteProceso<Alumno41Context> _Proceso;
        public ClienteAlumno41Controller(
            IClientesService<Alumno41Context> service
            , ClienteProceso<Alumno41Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
