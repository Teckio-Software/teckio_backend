...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/41")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno41Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno41Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno41Controller(
            ILogger<ContratistaCuentaBancariaAlumno41Controller> logger,
