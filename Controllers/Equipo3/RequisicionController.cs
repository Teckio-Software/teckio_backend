...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/requisicion/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno41Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno41Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno41Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno41Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno41Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno41Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno41Controller(
            ILogger<RequisicionAlumno41Controller> Logger
            , Alumno41Context Context
            , IRequisicionService<Alumno41Context> RequisicionService
            , RequisicionProceso<Alumno41Context> Proceso
            , ObjetoRequisicionProceso<Alumno41Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno41Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
