...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa35")]
    public class InsumoXContratistaAlumno41Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno41Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno41Controller(
            ILogger<InsumoXContratistaAlumno41Controller> logger,
