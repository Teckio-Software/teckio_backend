...
{
    [Route("api/preciounitario/41")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno41Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno41Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno41Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno41Context> _Options;
        public PrecioUnitarioAlumno41Controller(
            PrecioUnitarioProceso<Alumno41Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno41Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno41Context> options
            )
        {
        ...
        {
            using (var db = new Alumno41Context(_Options.Options))
            {
