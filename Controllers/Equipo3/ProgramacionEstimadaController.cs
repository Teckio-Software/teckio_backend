...
{
    [Route("api/programacionestimada/41")]
    [ApiController]
    public class ProgramacionEstimadaAlumno41Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno41Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno41Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno41Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno41Controller(
            ProgramacionEstimadaProceso<Alumno41Context> programacionEstimadaProceso,
            IProyectoService<Alumno41Context> proyectoProceso,
            IPrecioUnitarioService<Alumno41Context> precioUnitarioService,
