...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/proyecto/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno41Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno41Context> _ProyectoProceso;
        public ProyectoAlumno41Controller(
            ProyectoProceso<Alumno41Context> proyectoProceso)
        {
