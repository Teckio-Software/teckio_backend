...
{
    [Route("api/contratos/41")]
    [ApiController]
    public class ContratosAlumno41Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno41Context> _contratosProceso;
        public ContratosAlumno41Controller(
            ContratosProceso<Alumno41Context> contratosProceso
            )
        {
