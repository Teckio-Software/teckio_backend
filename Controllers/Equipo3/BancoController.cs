...
namespace SistemaERP.API.Controllers.Alumno41
{
    ...
    public class BancoAlumno41Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno41Context> _bancoService;

        public BancoAlumno41Controller(IBancoService<Alumno41Context> bancoService)
        {
