...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenSalida/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno41Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno41Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno41Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno41Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno41Controller> Logger;
        ...
        public AlmacenSalidaAlumno41Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno41Controller> logger,
            Alumno41Context context
            , IAlmacenSalidaService<Alumno41Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno41Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno41Context> Proceso
            )
        {
