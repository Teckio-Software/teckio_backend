...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno41Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno41Context> _proceso;

        private readonly ICuentaBancariaService<Alumno41Context> _servicio;
        public CuentaBancariaAlumno41Controller(CuentaBancariaProceso<Alumno41Context> _proceso, ICuentaBancariaService<Alumno41Context> _servicio
           )
        {
