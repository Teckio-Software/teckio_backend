...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno41Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno41Context> _Service;

        private readonly RequisicionProceso<Alumno41Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno41Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno41Controller(
            ILogger<InsumoXRequisicionAlumno41Controller> Logger,
            RequisicionProceso<Alumno41Context> Proceso,
            Alumno41Context Context
            , IInsumoXRequisicionService<Alumno41Context> Service)
        {
            _Logger = Logger;
