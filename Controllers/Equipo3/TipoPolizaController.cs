...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipopoliza/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno41Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno41Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno41Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno41Controller(
            ILogger<TipoPolizaAlumno41Controller> logger,
            Alumno41Context context
            , ITipoPolizaService<Alumno41Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
