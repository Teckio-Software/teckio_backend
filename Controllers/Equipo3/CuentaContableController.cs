...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentacontable/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno41Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno41Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno41Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno41Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno41Controller(
            ILogger<CuentaContableAlumno41Controller> logger,
            Alumno41Context context
            , ICuentaContableService<Alumno41Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno41Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
