...
{
    [Route("api/insumoxordencompra/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno41Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno41Context> _Service;
        private readonly OrdenCompraProceso<Alumno41Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno41Controller> _Logger;
        private readonly Alumno41Context _Context;
        public InsumoXOrdenCompraAlumno41Controller(
            ILogger<InsumoXOrdenCompraAlumno41Controller> Logger,
            Alumno41Context Context
            , IInsumoXOrdenCompraService<Alumno41Context> Service
            , OrdenCompraProceso<Alumno41Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
