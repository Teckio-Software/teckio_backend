...
{
    [Route("api/empleado/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoAlumno41Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno41Context> _empleadoService;
        public EmpleadoAlumno41Controller(
            IEmpleadoService<Alumno41Context> empleadoService
            )
        {
