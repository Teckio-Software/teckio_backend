...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentrada/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno41Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno41Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno41Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno41Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno41Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno41Controller(
            ILogger<AlmacenEntradaAlumno41Controller> logger,
            Alumno41Context context
            , IAlmacenEntradaService<Alumno41Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno41Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno41Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
