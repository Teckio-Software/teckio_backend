...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/generadores/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa35")]
    public class GeneradoresAlumno41Controller : ControllerBase
    {
        private readonly GeneradoresProceso<Alumno41Context> _GeneradoresProceso;
        public GeneradoresAlumno41Controller(
            GeneradoresProceso<Alumno41Context> generadoresProceso)
        {
