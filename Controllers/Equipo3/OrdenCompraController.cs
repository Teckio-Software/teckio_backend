...
{
    [Route("api/ordencompra/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno41Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno41Context> _Service;
        private readonly OrdenCompraProceso<Alumno41Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno41Controller> _Logger;
        private readonly Alumno41Context Context;
        public OrdenCompraAlumno41Controller(
            ILogger<OrdenCompraAlumno41Controller> Logger
            , Alumno41Context Context
            , IOrdenCompraService<Alumno41Context> Service
