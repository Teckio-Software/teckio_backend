...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/existencias/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno41Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno41Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno41Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno41Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno41Controller(
            ILogger<ExistenciasAlumno41Controller> Logger,
            Alumno41Context Context
            , IAlmacenExistenciaInsumoService<Alumno41Context> ExistenciaService
            , ExistenciasProceso<Alumno41Context> Proceso
            )
        {
            _Logger = Logger;
