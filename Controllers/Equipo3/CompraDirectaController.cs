...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirecta/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno41Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno41Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno41Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno41Controller(
            ILogger<CompraDirectaAlumno41Controller> logger,
            Alumno41Context context
            , ICompraDirectaService<Alumno41Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        public async Task<ActionResult> Post([FromBody] CompraDirectaCreacionDTO CreacionDTO)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno41Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
