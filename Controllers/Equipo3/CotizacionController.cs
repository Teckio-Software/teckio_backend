...
{
    [Route("api/cotizacion/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno41Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno41Context> _Service;
        private readonly CotizacionProceso<Alumno41Context> _Proceso;
        private readonly IOrdenCompraService<Alumno41Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno41Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno41Controller> _Logger;
        private readonly Alumno41Context Context;
        public CotizacionAlumno41Controller(

            ILogger<CotizacionAlumno41Controller> Logger
            , Alumno41Context Context
            , ICotizacionService<Alumno41Context> Service
            , IOrdenCompraService<Alumno41Context> OrdenCompraService,
              ITipoImpuestoService<Alumno41Context> TipoImpuestoService
            , CotizacionProceso<Alumno41Context> Proceso)
        {
            _Logger = Logger;
