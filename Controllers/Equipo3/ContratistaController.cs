...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratista/41")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno41Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno41Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno41Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno41Controller(
            ILogger<ContratistaAlumno41Controller> logger,
            Alumno41Context context
            , IContratistaService<Alumno41Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
