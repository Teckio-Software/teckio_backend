...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/familiainsumo/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno41Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno41Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno41Controller(
            FamiliaInsumoProceso<Alumno41Context> familiaInsumoProceso)
        {
