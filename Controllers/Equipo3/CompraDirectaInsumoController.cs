...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno41Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno41Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno41Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno41Controller(
            ILogger<CompraDirectaInsumoAlumno41Controller> logger
            , Alumno41Context context
            , IInsumoXCompraDirectaService<Alumno41Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
