...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/41")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno41Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno41Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno41Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno41Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno41Controller(
            ILogger<AlmacenEntradaInsumoAlumno41Controller> logger,
            Alumno41Context context
            , IInsumoXAlmacenEntradaService<Alumno41Context> AlmacenEntradaDetalle
