...
namespace SistemaERP.API.Alumno41Controllers.Procomi
{
    ...
    public class PolizaAlumno41Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno41Context> _Service;
        private readonly IPolizaDetalleService<Alumno41Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno41Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno41Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno41Context> _SaldosService;
        private readonly ILogger<PolizaAlumno41Controller> _Logger;
        private readonly Alumno41Context _Context;
        public PolizaAlumno41Controller(
            ILogger<PolizaAlumno41Controller> logger
            , Alumno41Context context
            , IPolizaService<Alumno41Context> service
            , IPolizaDetalleService<Alumno41Context> detalleService
            , ITipoPolizaService<Alumno41Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno41Context> saldosService
