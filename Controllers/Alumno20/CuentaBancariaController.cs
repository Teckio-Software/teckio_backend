...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno20Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno20Context> _proceso;

        private readonly ICuentaBancariaService<Alumno20Context> _servicio;
        public CuentaBancariaAlumno20Controller(CuentaBancariaProceso<Alumno20Context> _proceso, ICuentaBancariaService<Alumno20Context> _servicio
           )
        {
