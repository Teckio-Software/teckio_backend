...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa20")]
    public class FamiliaInsumoAlumno20Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno20Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno20Controller(
            FamiliaInsumoProceso<Alumno20Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa20")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa20")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa20")]
