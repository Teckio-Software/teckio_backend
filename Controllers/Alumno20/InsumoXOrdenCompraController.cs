...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno20Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno20Context> _Service;
        private readonly OrdenCompraProceso<Alumno20Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno20Controller> _Logger;
        private readonly Alumno20Context _Context;
        public InsumoXOrdenCompraAlumno20Controller(
            ILogger<InsumoXOrdenCompraAlumno20Controller> Logger,
            Alumno20Context Context
            , IInsumoXOrdenCompraService<Alumno20Context> Service
