...
namespace ERP_TECKIO
{
    ...
    public class CompraDirectaInsumoAlumno20Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno20Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno20Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno20Controller(
            ILogger<CompraDirectaInsumoAlumno20Controller> logger
            , Alumno20Context context
            , IInsumoXCompraDirectaService<Alumno20Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
