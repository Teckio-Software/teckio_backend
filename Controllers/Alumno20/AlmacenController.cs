...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno20Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno20Context> _almacenServicio;

        public AlmacenAlumno20Controller(
            IAlmacenService<Alumno20Context> almacenServicio)
        {
