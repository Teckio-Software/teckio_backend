...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno20Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno20Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno20Context> service, InsumoXProductoYServicioProceso<Alumno20Context> process)
        {
            _service = service;
            _process = process;
        }
