...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno20Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno20Context> _empleadoService;
        public EmpleadoAlumno20Controller(
            IEmpleadoService<Alumno20Context> empleadoService
            )
        {
