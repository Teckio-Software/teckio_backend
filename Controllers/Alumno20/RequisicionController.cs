...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno20Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno20Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno20Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno20Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno20Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno20Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno20Controller(
            ILogger<RequisicionAlumno20Controller> Logger
            , Alumno20Context Context
            , IRequisicionService<Alumno20Context> RequisicionService
            , RequisicionProceso<Alumno20Context> Proceso
            , ObjetoRequisicionProceso<Alumno20Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno20Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
