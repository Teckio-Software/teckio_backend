...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    public class OrdenVentaAlumno20Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno20Context> _ordenVentaProceso;
        public OrdenVentaAlumno20Controller(
            OrdenVentaProceso<Alumno20Context> ordenVentaProceso
            ) { 
