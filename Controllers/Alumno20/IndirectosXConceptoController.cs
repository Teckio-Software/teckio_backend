...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoAlumno20Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno20Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno20Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno20Controller(
            IIndirectosXConceptoService<Alumno20Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno20Context> indirectosXConceptoProceso
            ) { 
