...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno20Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno20Context> _Service;
        private readonly CotizacionProceso<Alumno20Context> _Proceso;
        private readonly IOrdenCompraService<Alumno20Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno20Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno20Controller> _Logger;
        private readonly Alumno20Context Context;
        public CotizacionAlumno20Controller(

            ILogger<CotizacionAlumno20Controller> Logger
            , Alumno20Context Context
            , ICotizacionService<Alumno20Context> Service
            , IOrdenCompraService<Alumno20Context> OrdenCompraService,
              ITipoImpuestoService<Alumno20Context> TipoImpuestoService
            , CotizacionProceso<Alumno20Context> Proceso)
        {
            _Logger = Logger;
