...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno20Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno20Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno20Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno20Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno20Controller(
            ILogger<ContratistaAlumno20Controller> logger,
            Alumno20Context context
            , IContratistaService<Alumno20Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno20Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
