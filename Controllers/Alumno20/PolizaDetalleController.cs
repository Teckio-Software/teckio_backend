...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa20")]
    public class PolizaDetalleAlumno20Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno20Context> _Service;
        private readonly ICuentaContableService<Alumno20Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno20Controller> _Logger;
        private readonly Alumno20Context _Context;
        public PolizaDetalleAlumno20Controller(
            ILogger<PolizaDetalleAlumno20Controller> logger
            , Alumno20Context context
            , IPolizaDetalleService<Alumno20Context> service
