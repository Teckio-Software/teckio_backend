...
{
    [Route("api/saldosbalanzacomprobacion/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa20")]
    public class SaldosBalanzaComprobacionAlumno20Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno20Context> _Service;
        private readonly ICuentaContableService<Alumno20Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno20Controller> _Logger;
        private readonly Alumno20Context _Context;
        public SaldosBalanzaComprobacionAlumno20Controller(
            ILogger<SaldosBalanzaComprobacionAlumno20Controller> logger
            , Alumno20Context context
            , ISaldosBalanzaComprobacionService<Alumno20Context> service
