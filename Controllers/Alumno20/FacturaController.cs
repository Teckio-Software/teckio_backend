...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    public class FacturaAlumno20Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno20Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno20Context> _categoriaProductoYServicioService;
        public FacturaAlumno20Controller(
            ObtenFacturaProceso<Alumno20Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno20Context> categoriaProductoYServicioService
            )
        {
