...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno20Controller : ControllerBase
    {
        private readonly IClientesService<Alumno20Context> _Service;

        private readonly ClienteProceso<Alumno20Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno20Context> _clientesCuentasContablesProceso;
        public ClienteAlumno20Controller(
            IClientesService<Alumno20Context> service
            , ClienteProceso<Alumno20Context> proceso,
            ClienteCuentasContablesProceso<Alumno20Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
