...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno20Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno20Context> process)
        {
            _process = process;
        }
