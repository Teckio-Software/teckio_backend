...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno20Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno20Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno20Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno20Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno20Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno20Controller(
            ILogger<AlmacenEntradaAlumno20Controller> logger,
            Alumno20Context context
            , IAlmacenEntradaService<Alumno20Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno20Context> AlmacenEntradaDetalleServicio
