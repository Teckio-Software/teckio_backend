...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno20Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno20Context> _Service;

        private readonly RequisicionProceso<Alumno20Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno20Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno20Controller(
            ILogger<InsumoXRequisicionAlumno20Controller> Logger,
            RequisicionProceso<Alumno20Context> Proceso,
            Alumno20Context Context
            , IInsumoXRequisicionService<Alumno20Context> Service)
        {
            _Logger = Logger;
