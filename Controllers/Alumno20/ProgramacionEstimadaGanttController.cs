...
namespace SistemaERP.API.Controllers.Alumno20
{
    [Route("api/programacionestimadaGantt/20")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno20Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno20Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno20Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno20Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno20Controller(
            ProgramacionEstimadaGanttProceso<Alumno20Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno20Context> importeSemanalGanttProceso,
            DbContextOptionsBuilder<Alumno20Context> options
            )
        {
        ...
        {
            using (var db = new Alumno20Context(_Options.Options))
            {
