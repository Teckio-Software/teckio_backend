...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa20")]
    public class TipoPolizaAlumno20Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno20Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno20Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno20Controller(
            ILogger<TipoPolizaAlumno20Controller> logger,
            Alumno20Context context
            , ITipoPolizaService<Alumno20Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa20")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa20")]
