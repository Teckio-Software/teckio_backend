...
namespace ERP_TECKIO.API.Controllers.Alumno20
{
    ...
    public class BancoAlumno20Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno20Context> _bancoService;

        public BancoAlumno20Controller(IBancoService<Alumno20Context> bancoService)
        {
