...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    public class ProductoYServicioAlumno20Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno20Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno20Context> _process;

        public ProductoYServicioAlumno20Controller(IProductoYservicioService<Alumno20Context> productoYServicioService,
            ProductoYServicioProceso<Alumno20Context> process
            )
        {
