...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno20Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno20Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno20Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno20Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno20Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno20Context> porcentajeCesantiaEdadService
            )
        {
