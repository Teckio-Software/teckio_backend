...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno20Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno20Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno20Controller(
            MovimientoBancarioProceso<Alumno20Context> movimientoBancarioProceso
            )
        {
