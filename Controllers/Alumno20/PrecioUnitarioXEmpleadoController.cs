...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno20Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno20Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno20Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno20Controller(
            IPrecioUnitarioXEmpleadoService<Alumno20Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno20Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
