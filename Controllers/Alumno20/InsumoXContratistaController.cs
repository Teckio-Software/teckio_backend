...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa20")]
    public class InsumoXContratistaAlumno20Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno20Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno20Controller(
            ILogger<InsumoXContratistaAlumno20Controller> logger,
