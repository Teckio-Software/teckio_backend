...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaInsumoAlumno20Controller : ControllerBase
    {
        private readonly IInsumoXAlmacenSalidaService<Alumno20Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno20Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaInsumoAlumno20Controller> Logger;
        /// <summary>
        ...
        public AlmacenSalidaInsumoAlumno20Controller(
            ILogger<AlmacenSalidaInsumoAlumno20Controller> logger,
            Alumno20Context context
            , IInsumoXAlmacenSalidaService<Alumno20Context> AlmacenSalidaDetalleServicio
