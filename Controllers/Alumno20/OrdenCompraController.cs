...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno20Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno20Context> _Service;
        private readonly OrdenCompraProceso<Alumno20Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno20Controller> _Logger;
        private readonly Alumno20Context Context;
        private readonly PolizaProceso<Alumno20Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno20Context> _obtenFacturaProceso;

        public OrdenCompraAlumno20Controller(
            ILogger<OrdenCompraAlumno20Controller> Logger
            , Alumno20Context Context
            , IOrdenCompraService<Alumno20Context> Service
            , OrdenCompraProceso<Alumno20Context> Proceso
            , PolizaProceso<Alumno20Context> polizaProceso
            , ObtenFacturaProceso<Alumno20Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
