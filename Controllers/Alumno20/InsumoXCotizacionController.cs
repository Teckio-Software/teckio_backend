...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno20Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno20Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno20Controller> _Logger;
        private readonly CotizacionProceso<Alumno20Context> _Proceso;
        private readonly Alumno20Context Context;
        public InsumoXCotizacionAlumno20Controller(
            ILogger<InsumoXCotizacionAlumno20Controller> Logger,
            Alumno20Context Context
            , IInsumoXCotizacionService<Alumno20Context> Service
