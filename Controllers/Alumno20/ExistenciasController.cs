...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno20Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno20Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno20Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno20Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno20Controller(
            ILogger<ExistenciasAlumno20Controller> Logger,
            Alumno20Context Context
            , IAlmacenExistenciaInsumoService<Alumno20Context> ExistenciaService
            , ExistenciasProceso<Alumno20Context> Proceso
            )
        {
            _Logger = Logger;
