...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/20")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa20")]
    public class EspecialIdadXContratistaAlumno20Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno20Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno20Controller(
            ILogger<EspecialIdadXContratistaAlumno20Controller> logger,
