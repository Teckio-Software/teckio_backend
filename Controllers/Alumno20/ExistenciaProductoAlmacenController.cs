...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno20Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno20Context> proces)
        {
            _proceso = proces;
        }
