...
namespace ERP_TECKIO.API.Controllers.Alumno20
{
    ...
    public class IndirectosAlumno20Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno20Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno20Context> _indirectosService;
        private readonly IndirectosProceso<Alumno20Context> _indirectosProceso;

        public IndirectosAlumno20Controller(
                        IConjuntoIndirectosService<Alumno20Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno20Context> indirectosService,
                        IndirectosProceso<Alumno20Context> indirectosProceso
            )
        {
