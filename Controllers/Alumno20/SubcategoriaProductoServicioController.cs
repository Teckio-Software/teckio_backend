...
namespace ERP_TECKIO.Controllers.Alumno20
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno20Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno20Context> service)
        {
            _service = service;
        }
