...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno20Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno20Context> _proceso;
        private readonly EstimacionesProceso<Alumno20Context> _estimacionesProceso;

        public ReporteDestajoAlumno20Controller(
            ReporteDestajoProceso<Alumno20Context> proceso,
            EstimacionesProceso<Alumno20Context> estimacionesProceso
            ) { 
            _proceso = proceso;
