...
namespace ERP_TECKIO.API.Controllers.Alumno20
{
    ...
    [ApiController]
    public class ContratosAlumno20Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno20Context> _contratosProceso;
        public ContratosAlumno20Controller(
            ContratosProceso<Alumno20Context> contratosProceso
            )
        {
