...
{
    [Route("api/contratos/3")]
    [ApiController]
    public class ContratosDemoTeckioController : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioContext> _contratosProceso;
        public ContratosDemoTeckioController(
            ContratosProceso<DemoTeckioContext> contratosProceso
            )
        {
