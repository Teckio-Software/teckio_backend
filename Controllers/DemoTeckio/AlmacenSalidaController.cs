...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioController : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioContext> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioContext> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioController> Logger;
        ...
        public AlmacenSalidaDemoTeckioController(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioController> logger,
            DemoTeckioContext context
            , IAlmacenSalidaService<DemoTeckioContext> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioContext> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioContext> Proceso
            )
        {
