...
{
    [Route("api/empleado/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioController : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioContext> _empleadoService;
        public EmpleadoDemoTeckioController(
            IEmpleadoService<DemoTeckioContext> empleadoService
            )
        {
