...
{
    [Route("api/precioUnitarioXEmpleado/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioController : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioContext> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioContext> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioController(
            IPrecioUnitarioXEmpleadoService<DemoTeckioContext> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioContext> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
