...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioController : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioContext> _bancoService;

        public BancoDemoTeckioController(IBancoService<DemoTeckioContext> bancoService)
        {
