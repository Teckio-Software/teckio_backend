...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioController : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioContext> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioContext> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioContext> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioContext> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioController> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioController(
            ILogger<RequisicionDemoTeckioController> Logger
            , DemoTeckioContext Context
            , IRequisicionService<DemoTeckioContext> RequisicionService
            , RequisicionProceso<DemoTeckioContext> Proceso
            , ObjetoRequisicionProceso<DemoTeckioContext> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioContext> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
