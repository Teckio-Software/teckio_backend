...
{
    [Route("api/insumoxordencompra/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioController : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioContext> _Service;
        private readonly OrdenCompraProceso<DemoTeckioContext> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioController> _Logger;
        private readonly DemoTeckioContext _Context;
        public InsumoXOrdenCompraDemoTeckioController(
            ILogger<InsumoXOrdenCompraDemoTeckioController> Logger,
            DemoTeckioContext Context
            , IInsumoXOrdenCompraService<DemoTeckioContext> Service
