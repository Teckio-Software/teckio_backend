...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioController : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioContext> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioController(
            TipoInsumoProceso<DemoTeckioContext> tipoInsumoProceso
            )
        {
