...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioController : ControllerBase
    {
        private readonly IRubroService<DemoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioController> Logger;
        ...
        public RubroDemoTeckioController(
            ILogger<RubroDemoTeckioController> logger,
            DemoTeckioContext context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioContext> service
            )
        {
            //_Service = service;
            Logger = logger;
