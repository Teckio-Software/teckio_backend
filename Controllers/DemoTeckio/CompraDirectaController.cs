...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioController : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioController> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioController(
            ILogger<CompraDirectaDemoTeckioController> logger,
            DemoTeckioContext context
            , ICompraDirectaService<DemoTeckioContext> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
