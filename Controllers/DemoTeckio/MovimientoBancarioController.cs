...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/3")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioController : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioContext> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioController(
            MovimientoBancarioProceso<DemoTeckioContext> movimientoBancarioProceso
            )
        {
