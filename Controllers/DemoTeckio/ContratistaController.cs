...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/3")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioController : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioContext> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioController> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioContext> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioController(
            ILogger<ContratistaDemoTeckioController> logger,
            DemoTeckioContext context
            , IContratistaService<DemoTeckioContext> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioContext> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
