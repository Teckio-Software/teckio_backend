...
{
    [Route("api/indirectos/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioController : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioContext> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioContext> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioContext> _indirectosProceso;

        public IndirectosDemoTeckioController(
                        IConjuntoIndirectosService<DemoTeckioContext> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioContext> indirectosService,
                        IndirectosProceso<DemoTeckioContext> indirectosProceso
            )
        {
