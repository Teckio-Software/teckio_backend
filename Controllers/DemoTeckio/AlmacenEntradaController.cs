...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioController : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioContext> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioContext> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioController> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioController(
            ILogger<AlmacenEntradaDemoTeckioController> logger,
            DemoTeckioContext context
            , IAlmacenEntradaService<DemoTeckioContext> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioContext> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioContext> Proceso
            )
        {
            Logger = logger;
            Context = context;
