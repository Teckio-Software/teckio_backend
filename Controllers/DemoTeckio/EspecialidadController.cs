...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioController : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioContext> _EspecialidadProceso;
        public EspecialidadDemoTeckioController(
            EspecialidadProceso<DemoTeckioContext> especialidadProceso)
        {
