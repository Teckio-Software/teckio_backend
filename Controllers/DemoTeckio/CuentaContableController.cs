...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioController : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioContext> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioContext> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioContext> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioController> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioContext Context;
        private readonly CuentaContableProceso<DemoTeckioContext> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioController(
            ILogger<CuentaContableDemoTeckioController> logger,
            DemoTeckioContext context
            , ICuentaContableService<DemoTeckioContext> Service
            , ICodigoAgrupadorService<DemoTeckioContext> CodigoAgrupadorService
            , IRubroService<DemoTeckioContext> RubroService
            , CuentaContableProceso<DemoTeckioContext> proceso
            )
        {
            Logger = logger;
            Context = context;
