...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraDemoTeckioController : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioContext> _Service;
        private readonly OrdenCompraProceso<DemoTeckioContext> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioController> _Logger;
        ...
        public OrdenCompraDemoTeckioController(
            ILogger<OrdenCompraDemoTeckioController> Logger
            , DemoTeckioContext Context
            , IOrdenCompraService<DemoTeckioContext> Service
            , OrdenCompraProceso<DemoTeckioContext> Proceso
