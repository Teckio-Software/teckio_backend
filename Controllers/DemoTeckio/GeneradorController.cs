...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioController : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioContext> _GeneradoresProceso;
        public GeneradoresDemoTeckioController(
            GeneradoresProceso<DemoTeckioContext> generadoresProceso)
        {
