...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioController : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioController> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioController(
            ILogger<TipoPolizaDemoTeckioController> logger,
            DemoTeckioContext context
            , ITipoPolizaService<DemoTeckioContext> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
