...
namespace SistemaERP.API.DemoTeckioControllers.Procomi
{
    [Route("api/preciounitariodetalle/3")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioController : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioController(
