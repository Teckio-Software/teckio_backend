...
{
    [Route("api/cuentabancariacliente/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaClienteDemoTeckioController : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioContext> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioContext> _proceso;

        public CuentaBancariaClienteDemoTeckioController(
            ICuentaBancariaClienteService<DemoTeckioContext> cuentaBancariaClienteService,
