...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDetalleDemoTeckioController : ControllerBase
    {
        private readonly IPolizaDetalleService<DemoTeckioContext> _Service;
        private readonly ICuentaContableService<DemoTeckioContext> _CuentaContableService;
        private readonly ILogger<PolizaDetalleDemoTeckioController> _Logger;
        private readonly DemoTeckioContext _Context;
        public PolizaDetalleDemoTeckioController(
            ILogger<PolizaDetalleDemoTeckioController> logger
            , DemoTeckioContext context
            , IPolizaDetalleService<DemoTeckioContext> service
