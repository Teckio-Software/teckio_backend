...
{
    [Route("api/insumoxcotizacion/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioController : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioContext> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioController> _Logger;
        private readonly CotizacionProceso<DemoTeckioContext> _Proceso;
        private readonly DemoTeckioContext Context;
        public InsumoXCotizacionDemoTeckioController(
            ILogger<InsumoXCotizacionDemoTeckioController> Logger,
            DemoTeckioContext Context
            , IInsumoXCotizacionService<DemoTeckioContext> Service
