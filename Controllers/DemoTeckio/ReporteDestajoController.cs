...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioController : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioContext> _proceso;
        private readonly EstimacionesProceso<DemoTeckioContext> _estimacionesProceso;

        public ReporteDestajoDemoTeckioController(
            ReporteDestajoProceso<DemoTeckioContext> proceso,
            EstimacionesProceso<DemoTeckioContext> estimacionesProceso
            ) { 
            _proceso = proceso;
