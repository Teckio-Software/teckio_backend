...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioController : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioContext> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioController(
            FamiliaInsumoProceso<DemoTeckioContext> familiaInsumoProceso)
        {
