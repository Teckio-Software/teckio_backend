...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioController : ControllerBase
    {
        private readonly IClientesService<DemoTeckioContext> _Service;

        private readonly ClienteProceso<DemoTeckioContext> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioContext> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioController(
            IClientesService<DemoTeckioContext> service
            , ClienteProceso<DemoTeckioContext> proceso,
            ClienteCuentasContablesProceso<DemoTeckioContext> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
