...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/3")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoDemoTeckioController : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoDemoTeckioController> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioContext Context;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioContext> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoDemoTeckioController(
            ILogger<AlmacenEntradaInsumoDemoTeckioController> logger,
            DemoTeckioContext context
            , IInsumoXAlmacenEntradaService<DemoTeckioContext> AlmacenEntradaDetalle
