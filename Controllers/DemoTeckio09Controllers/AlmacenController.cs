...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL09Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL09Context> _almacenProceso;

        public AlmacenDemoTeckioAL09Controller(
            IAlmacenService<DemoTeckioAL09Context> almacenServicio, AlmacenProceso<DemoTeckioAL09Context> almacenProceso)
        {
