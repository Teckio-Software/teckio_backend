...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL09Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL09Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL09Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL09Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL09Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL09Controller> _Logger;
        private readonly DemoTeckioAL09Context _Context;
        private readonly PolizaProceso<DemoTeckioAL09Context> _polizaProceso;
        public PolizaDemoTeckioAL09Controller(
            ILogger<PolizaDemoTeckioAL09Controller> logger
            , DemoTeckioAL09Context context
            , IPolizaService<DemoTeckioAL09Context> service
            , IPolizaDetalleService<DemoTeckioAL09Context> detalleService
            , ITipoPolizaService<DemoTeckioAL09Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL09Context> saldosService
