...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL09Context> _InsumoProceso;
        public InsumoDemoTeckioAL09Controller(
            InsumoProceso<DemoTeckioAL09Context> insumoProceso)
        {
