...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    [Route("api/produccion/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL09Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL09Context> proceso)
        {
            _proceso = proceso;
        }
