...
{
    [Route("api/entradaproduccionalmacen/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL09Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL09Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL09Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL09Context> proceso)
        {
            _proceso = proceso;
        }
