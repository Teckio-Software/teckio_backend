...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL09Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL09Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL09Controller(
            GeneradoresProceso<DemoTeckioAL09Context> generadoresProceso)
        {
