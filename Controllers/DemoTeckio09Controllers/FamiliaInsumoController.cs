...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL09Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL09Controller(
            FamiliaInsumoProceso<DemoTeckioAL09Context> familiaInsumoProceso)
        {
