...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL09Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL09Controller> Logger;
        ...
        public RubroDemoTeckioAL09Controller(
            ILogger<RubroDemoTeckioAL09Controller> logger,
            DemoTeckioAL09Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL09Context> service
            )
        {
            //_Service = service;
            Logger = logger;
