...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    [Route("api/subcategoriaProductoServicio/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL09Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL09Context> service)
        {
            _service = service;
        }
