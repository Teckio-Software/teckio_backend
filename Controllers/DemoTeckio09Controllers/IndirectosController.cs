...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL09Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL09Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL09Context> _indirectosProceso;

        public IndirectosDemoTeckioAL09Controller(
                        IConjuntoIndirectosService<DemoTeckioAL09Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL09Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL09Context> indirectosProceso
            )
        {
