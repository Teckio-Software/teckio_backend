...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/9")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL09Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL09Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL09Controller(
            MovimientoBancarioProceso<DemoTeckioAL09Context> movimientoBancarioProceso
            )
        {
