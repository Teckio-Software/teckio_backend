...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL09Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL09Controller(
            ConceptoProceso<DemoTeckioAL09Context> conceptoProceso)
        {
