...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    public class FacturaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL09Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL09Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL09Controller(
            ObtenFacturaProceso<DemoTeckioAL09Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL09Context> categoriaProductoYServicioService
            )
        {
