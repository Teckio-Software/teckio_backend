...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL09Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL09Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL09Controller(
            ILogger<CompraDirectaDemoTeckioAL09Controller> logger,
            DemoTeckioAL09Context context
            , ICompraDirectaService<DemoTeckioAL09Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
