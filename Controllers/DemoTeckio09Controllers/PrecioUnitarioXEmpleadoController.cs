...
{
    [Route("api/precioUnitarioXEmpleado/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL09Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL09Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL09Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL09Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL09Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
