...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL09Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL09Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL09Controller(
            IIndirectosXConceptoService<DemoTeckioAL09Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL09Context> indirectosXConceptoProceso
            ) { 
