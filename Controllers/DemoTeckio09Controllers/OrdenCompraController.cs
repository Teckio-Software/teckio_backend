...
{
    [Route("api/ordencompra/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL09Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL09Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL09Controller> _Logger;
        private readonly DemoTeckioAL09Context Context;
        private readonly PolizaProceso<DemoTeckioAL09Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL09Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL09Controller(
            ILogger<OrdenCompraDemoTeckioAL09Controller> Logger
            , DemoTeckioAL09Context Context
            , IOrdenCompraService<DemoTeckioAL09Context> Service
            , OrdenCompraProceso<DemoTeckioAL09Context> Proceso
            , PolizaProceso<DemoTeckioAL09Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL09Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
