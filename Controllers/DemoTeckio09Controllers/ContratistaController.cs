...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL09Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL09Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL09Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL09Controller(
            ILogger<ContratistaDemoTeckioAL09Controller> logger,
            DemoTeckioAL09Context context
            , IContratistaService<DemoTeckioAL09Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL09Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
