...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL09Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL09Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL09Controller(
            ILogger<ExistenciasDemoTeckioAL09Controller> Logger,
            DemoTeckioAL09Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL09Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL09Context> Proceso
            )
        {
            _Logger = Logger;
