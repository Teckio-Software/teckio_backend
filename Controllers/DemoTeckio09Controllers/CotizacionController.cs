...
{
    [Route("api/cotizacion/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL09Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL09Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL09Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL09Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL09Controller> _Logger;
        private readonly DemoTeckioAL09Context Context;
        public CotizacionDemoTeckioAL09Controller(

            ILogger<CotizacionDemoTeckioAL09Controller> Logger
            , DemoTeckioAL09Context Context
            , ICotizacionService<DemoTeckioAL09Context> Service
            , IOrdenCompraService<DemoTeckioAL09Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL09Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL09Context> Proceso)
        {
            _Logger = Logger;
