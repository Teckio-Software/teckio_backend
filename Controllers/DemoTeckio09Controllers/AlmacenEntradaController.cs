...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL09Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL09Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL09Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL09Controller(
            ILogger<AlmacenEntradaDemoTeckioAL09Controller> logger,
            DemoTeckioAL09Context context
            , IAlmacenEntradaService<DemoTeckioAL09Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL09Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL09Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
