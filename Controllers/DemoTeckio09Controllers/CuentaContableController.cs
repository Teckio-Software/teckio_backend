...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL09Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL09Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL09Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL09Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL09Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL09Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL09Controller(
            ILogger<CuentaContableDemoTeckioAL09Controller> logger,
            DemoTeckioAL09Context context
            , ICuentaContableService<DemoTeckioAL09Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL09Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL09Context> RubroService
            , CuentaContableProceso<DemoTeckioAL09Context> proceso
            )
        {
            Logger = logger;
            Context = context;
