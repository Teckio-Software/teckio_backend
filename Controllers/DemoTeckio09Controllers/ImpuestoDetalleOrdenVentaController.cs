...
{
    [Route("api/impuestodetalleordencompra/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ImpuestoDetalleOrdenVentaController: ControllerBase
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL09Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL09Context> process)
        {
            _process = process;
        }
