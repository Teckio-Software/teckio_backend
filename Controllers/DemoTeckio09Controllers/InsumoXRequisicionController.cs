...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL09Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL09Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL09Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL09Controller> Logger,
            RequisicionProceso<DemoTeckioAL09Context> Proceso,
            DemoTeckioAL09Context Context
            , IInsumoXRequisicionService<DemoTeckioAL09Context> Service)
        {
            _Logger = Logger;
