...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL09Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL09Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL09Controller(
            ILogger<TipoPolizaDemoTeckioAL09Controller> logger,
            DemoTeckioAL09Context context
            , ITipoPolizaService<DemoTeckioAL09Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
