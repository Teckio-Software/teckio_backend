...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL09Context> _contratosProceso;
        public ContratosDemoTeckioAL09Controller(
            ContratosProceso<DemoTeckioAL09Context> contratosProceso
            )
        {
