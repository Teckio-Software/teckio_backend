...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL09Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL09Controller(
            TipoInsumoProceso<DemoTeckioAL09Context> tipoInsumoProceso
            )
        {
