...
namespace SistemaERP.API.DemoTeckioAL09Controllers.Procomi
{
    [Route("api/preciounitariodetalle/9")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL09Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL09Controller(
