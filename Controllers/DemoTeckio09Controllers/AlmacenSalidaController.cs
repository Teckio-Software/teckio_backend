...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL09Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL09Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL09Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL09Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL09Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL09Controller> logger,
            DemoTeckioAL09Context context
            , IAlmacenSalidaService<DemoTeckioAL09Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL09Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL09Context> Proceso
            )
        {
