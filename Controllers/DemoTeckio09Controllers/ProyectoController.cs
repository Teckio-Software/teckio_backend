...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL09Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL09Controller(
            ProyectoProceso<DemoTeckioAL09Context> proyectoProceso)
        {
