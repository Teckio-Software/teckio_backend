...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL09Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL09Context> _servicio;
        public CuentaBancariaDemoTeckioAL09Controller(CuentaBancariaProceso<DemoTeckioAL09Context> _proceso, ICuentaBancariaService<DemoTeckioAL09Context> _servicio
           )
        {
