...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL09Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL09Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL09Controller(
            EspecialidadProceso<DemoTeckioAL09Context> especialidadProceso)
        {
