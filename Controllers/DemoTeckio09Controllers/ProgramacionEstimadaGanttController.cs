...
namespace SistemaERP.API.Controllers.DemoTeckioAL09
{
    [Route("api/programacionestimadaGantt/9")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL09Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL09Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL09Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL09Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL09Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL09Context> importeSemanalGanttProceso,
