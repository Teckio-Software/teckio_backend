...
{
    [Route("api/empleado/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL09Context> _empleadoService;
        public EmpleadoDemoTeckioAL09Controller(
            IEmpleadoService<DemoTeckioAL09Context> empleadoService
            )
        {
