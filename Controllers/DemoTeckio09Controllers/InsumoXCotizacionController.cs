...
{
    [Route("api/insumoxcotizacion/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL09Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL09Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL09Context> _Proceso;
        private readonly DemoTeckioAL09Context Context;
        public InsumoXCotizacionDemoTeckioAL09Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL09Controller> Logger,
            DemoTeckioAL09Context Context
            , IInsumoXCotizacionService<DemoTeckioAL09Context> Service
