...
{
    [Route("api/ordenventa/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL09Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL09Controller(
            OrdenVentaProceso<DemoTeckioAL09Context> ordenVentaProceso
            ) { 
