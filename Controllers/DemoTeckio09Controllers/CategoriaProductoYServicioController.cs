...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    [Route("api/categoriaProductoServicio/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CategoriaProductoYServicioController: ControllerBase
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL09Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL09Context> service)
        {
            _service = service;
        }
