...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    [Route("api/existenciaproductoalmacen/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL09Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL09Context> proces)
        {
            _proceso = proces;
        }
