...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/9")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL09Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL09Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL09Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL09Context> process)
        {
            _service = service;
            _process = process;
        }
