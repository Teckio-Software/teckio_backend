...
{
    [Route("api/preciounitario/9")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL09Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL09Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL09Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL09Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL09Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL09Controller(
            PrecioUnitarioProceso<DemoTeckioAL09Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL09Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL09Context> options,
            ExplocionInsumosProceso<DemoTeckioAL09Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL09Context(_Options.Options))
            {
