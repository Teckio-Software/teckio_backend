...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL09Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL09Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL09Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL09Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL09Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL09Controller(
            ILogger<RequisicionDemoTeckioAL09Controller> Logger
            , DemoTeckioAL09Context Context
            , IRequisicionService<DemoTeckioAL09Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL09Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL09Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL09Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL09Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/9/970"))
            {
