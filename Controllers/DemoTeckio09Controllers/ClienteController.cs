...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL09Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL09Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL09Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL09Controller(
            IClientesService<DemoTeckioAL09Context> service
            , ClienteProceso<DemoTeckioAL09Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL09Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
