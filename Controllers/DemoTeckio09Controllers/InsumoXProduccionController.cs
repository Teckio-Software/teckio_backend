...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    [Route("api/insumoXproduccion/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL09Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL09Context> proces)
        {
            _proceso = proces;
        }
