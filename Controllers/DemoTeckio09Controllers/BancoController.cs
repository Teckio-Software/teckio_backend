...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL09Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL09Context> _bancoService;

        public BancoDemoTeckioAL09Controller(IBancoService<DemoTeckioAL09Context> bancoService)
        {
