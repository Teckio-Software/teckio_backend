...
namespace ERP_TECKIO.Controllers.DemoTeckioAL09
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL09Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL09Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL09Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL09Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL09Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL09Context> porcentajeCesantiaEdadService
            )
        {
