...
{
    [Route("api/productoyservicio/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL09Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL09Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL09Context> _process;

        public ProductoYServicioDemoTeckioAL09Controller(IProductoYservicioService<DemoTeckioAL09Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL09Context> process
            )
        {
