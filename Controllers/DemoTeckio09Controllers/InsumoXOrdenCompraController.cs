...
{
    [Route("api/insumoxordencompra/9")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL09Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL09Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL09Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL09Controller> _Logger;
        private readonly DemoTeckioAL09Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL09Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL09Controller> Logger,
            DemoTeckioAL09Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL09Context> Service
