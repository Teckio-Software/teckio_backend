...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL09Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL09Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL09Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL09Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL09Context> cuentaBancariaEmpresaService,
