...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno05Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno05Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno05Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno05Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno05Controller(
            ILogger<AlmacenEntradaInsumoAlumno05Controller> logger,
            Alumno05Context context
            , IInsumoXAlmacenEntradaService<Alumno05Context> AlmacenEntradaDetalle
