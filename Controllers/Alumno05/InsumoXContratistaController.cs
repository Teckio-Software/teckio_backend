...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa5")]
    public class InsumoXContratistaAlumno05Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno05Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno05Controller(
            ILogger<InsumoXContratistaAlumno05Controller> logger,
