...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno05Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno05Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno05Controller(
            MovimientoBancarioProceso<Alumno05Context> movimientoBancarioProceso
            )
        {
