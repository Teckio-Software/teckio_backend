...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno05Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno05Context> _contratosProceso;
        public ContratosAlumno05Controller(
            ContratosProceso<Alumno05Context> contratosProceso
            )
        {
