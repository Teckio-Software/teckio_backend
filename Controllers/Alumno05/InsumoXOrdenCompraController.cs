...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno05Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno05Context> _Service;
        private readonly OrdenCompraProceso<Alumno05Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno05Controller> _Logger;
        private readonly Alumno05Context _Context;
        public InsumoXOrdenCompraAlumno05Controller(
            ILogger<InsumoXOrdenCompraAlumno05Controller> Logger,
            Alumno05Context Context
            , IInsumoXOrdenCompraService<Alumno05Context> Service
