...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno05Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno05Context> service)
        {
            _service = service;
        }
