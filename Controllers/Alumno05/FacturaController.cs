...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    public class FacturaAlumno05Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno05Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno05Context> _categoriaProductoYServicioService;
        public FacturaAlumno05Controller(
            ObtenFacturaProceso<Alumno05Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno05Context> categoriaProductoYServicioService
            )
        {
