...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno05Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno05Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno05Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno05Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno05Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno05Context> porcentajeCesantiaEdadService
            )
        {
