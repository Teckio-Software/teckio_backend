...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoAlumno05Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno05Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno05Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno05Controller(
            ILogger<CompraDirectaInsumoAlumno05Controller> logger
            , Alumno05Context context
            , IInsumoXCompraDirectaService<Alumno05Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
