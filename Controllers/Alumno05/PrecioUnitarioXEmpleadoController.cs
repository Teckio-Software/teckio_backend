...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno05Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno05Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno05Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno05Controller(
            IPrecioUnitarioXEmpleadoService<Alumno05Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno05Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
