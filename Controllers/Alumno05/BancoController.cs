...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno05Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno05Context> _bancoService;

        public BancoAlumno05Controller(IBancoService<Alumno05Context> bancoService)
        {
