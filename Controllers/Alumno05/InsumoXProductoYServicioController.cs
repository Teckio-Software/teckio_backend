...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno05Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno05Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno05Context> service, InsumoXProductoYServicioProceso<Alumno05Context> process)
        {
            _service = service;
            _process = process;
        }
