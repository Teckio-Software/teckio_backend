...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno05Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno05Context> process)
        {
            _process = process;
        }
