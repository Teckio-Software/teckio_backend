...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/tipopoliza/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa5")]
    public class TipoPolizaAlumno05Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno05Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno05Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno05Controller(
            ILogger<TipoPolizaAlumno05Controller> logger,
            Alumno05Context context
            , ITipoPolizaService<Alumno05Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa5")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa5")]
