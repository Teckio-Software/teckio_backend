...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno05Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno05Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno05Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno05Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno05Controller(
            ProgramacionEstimadaProceso<Alumno05Context> programacionEstimadaProceso,
            IProyectoService<Alumno05Context> proyectoProceso,
            IPrecioUnitarioService<Alumno05Context> precioUnitarioService,
