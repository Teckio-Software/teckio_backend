...
namespace ERP_TECKIO.Controllers
{
    [Route("api/poliza/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa5")]
    public class PolizaAlumno05Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno05Context> _Service;
        private readonly IPolizaDetalleService<Alumno05Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno05Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno05Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno05Context> _SaldosService;
        private readonly ILogger<PolizaAlumno05Controller> _Logger;
        private readonly Alumno05Context _Context;
        public PolizaAlumno05Controller(
            ILogger<PolizaAlumno05Controller> logger
            , Alumno05Context context
            , IPolizaService<Alumno05Context> service
            , IPolizaDetalleService<Alumno05Context> detalleService
            , ITipoPolizaService<Alumno05Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno05Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa5")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa5")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa5")]
