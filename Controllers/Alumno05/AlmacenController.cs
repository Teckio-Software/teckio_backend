...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno05Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno05Context> _almacenServicio;

        public AlmacenAlumno05Controller(
            IAlmacenService<Alumno05Context> almacenServicio)
        {
