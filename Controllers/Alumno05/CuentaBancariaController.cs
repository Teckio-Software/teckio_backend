...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaAlumno05Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno05Context> _proceso;

        private readonly ICuentaBancariaService<Alumno05Context> _servicio;
        public CuentaBancariaAlumno05Controller(CuentaBancariaProceso<Alumno05Context> _proceso, ICuentaBancariaService<Alumno05Context> _servicio
           )
        {
