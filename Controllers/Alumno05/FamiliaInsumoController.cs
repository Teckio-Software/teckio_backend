...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/familiainsumo/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa5")]
    public class FamiliaInsumoAlumno05Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno05Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno05Controller(
            FamiliaInsumoProceso<Alumno05Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa5")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa5")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa5")]
