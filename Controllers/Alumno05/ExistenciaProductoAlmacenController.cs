...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno05Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno05Context> proces)
        {
            _proceso = proces;
        }
