...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno05Controller : ControllerBase
    {
        ...
        private readonly ClienteCuentasContablesProceso<Alumno05Context> _clientesCuentasContablesProceso;
        public ClienteAlumno05Controller(
            IClientesService<Alumno05Context> service
            , ClienteProceso<Alumno05Context> proceso,
            ClienteCuentasContablesProceso<Alumno05Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
