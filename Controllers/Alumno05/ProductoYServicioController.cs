...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    public class ProductoYServicioAlumno05Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno05Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno05Context> _process;

        public ProductoYServicioAlumno05Controller(IProductoYservicioService<Alumno05Context> productoYServicioService,
            ProductoYServicioProceso<Alumno05Context> process
            )
        {
