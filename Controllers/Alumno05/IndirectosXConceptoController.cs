...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoAlumno05Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno05Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno05Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno05Controller(
            IIndirectosXConceptoService<Alumno05Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno05Context> indirectosXConceptoProceso
            ) { 
