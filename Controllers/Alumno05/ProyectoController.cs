...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/proyecto/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa5")]
    public class ProyectoAlumno05Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno05Context> _ProyectoProceso;
        public ProyectoAlumno05Controller(
            ProyectoProceso<Alumno05Context> proyectoProceso)
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearProyecto-Empresa5")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarProyecto-Empresa5")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarProyecto-Empresa5")]
