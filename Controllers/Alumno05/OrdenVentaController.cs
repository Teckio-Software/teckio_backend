...
namespace ERP_TECKIO.Controllers.Alumno05
{
    ...
    public class OrdenVentaAlumno05Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno05Context> _ordenVentaProceso;
        public OrdenVentaAlumno05Controller(
            OrdenVentaProceso<Alumno05Context> ordenVentaProceso
            ) { 
