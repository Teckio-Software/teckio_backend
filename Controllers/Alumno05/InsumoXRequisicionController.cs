...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno05Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno05Context> _Service;

        private readonly RequisicionProceso<Alumno05Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno05Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno05Controller(
            ILogger<InsumoXRequisicionAlumno05Controller> Logger,
            RequisicionProceso<Alumno05Context> Proceso,
            Alumno05Context Context
            , IInsumoXRequisicionService<Alumno05Context> Service)
        {
            _Logger = Logger;
