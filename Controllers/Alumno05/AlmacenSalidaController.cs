...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno05Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno05Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno05Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno05Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno05Controller> Logger;
        ...
        public AlmacenSalidaAlumno05Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno05Controller> logger,
            Alumno05Context context
            , IAlmacenSalidaService<Alumno05Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno05Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno05Context> Proceso
            )
        {
