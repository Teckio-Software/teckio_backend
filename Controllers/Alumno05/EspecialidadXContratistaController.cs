...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa5")]
    public class EspecialIdadXContratistaAlumno05Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno05Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno05Controller(
            ILogger<EspecialIdadXContratistaAlumno05Controller> logger,
