...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno05Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno05Context> _Service;
        private readonly OrdenCompraProceso<Alumno05Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno05Controller> _Logger;
        private readonly Alumno05Context Context;
        private readonly PolizaProceso<Alumno05Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno05Context> _obtenFacturaProceso;

        public OrdenCompraAlumno05Controller(
            ILogger<OrdenCompraAlumno05Controller> Logger
            , Alumno05Context Context
            , IOrdenCompraService<Alumno05Context> Service
            , OrdenCompraProceso<Alumno05Context> Proceso
            , PolizaProceso<Alumno05Context> polizaProceso
            , ObtenFacturaProceso<Alumno05Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
