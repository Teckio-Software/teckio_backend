...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno05Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno05Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno05Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno05Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno05Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno05Controller(
            ILogger<AlmacenEntradaAlumno05Controller> logger,
            Alumno05Context context
            , IAlmacenEntradaService<Alumno05Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno05Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno05Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
