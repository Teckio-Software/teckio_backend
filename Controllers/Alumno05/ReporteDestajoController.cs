...
{
    [Route("api/reportesdestajo/5")]
    [ApiController]
    public class ReporteDestajoAlumno05Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno05Context> _proceso;
        private readonly EstimacionesProceso<Alumno05Context> _estimacionesProceso;

        public ReporteDestajoAlumno05Controller(
            ReporteDestajoProceso<Alumno05Context> proceso,
            EstimacionesProceso<Alumno05Context> estimacionesProceso
            ) { 
            _proceso = proceso;
