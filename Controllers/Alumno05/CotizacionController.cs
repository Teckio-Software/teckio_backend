...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno05Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno05Context> _Service;
        private readonly CotizacionProceso<Alumno05Context> _Proceso;
        private readonly IOrdenCompraService<Alumno05Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno05Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno05Controller> _Logger;
        private readonly Alumno05Context Context;
        public CotizacionAlumno05Controller(

            ILogger<CotizacionAlumno05Controller> Logger
            , Alumno05Context Context
            , ICotizacionService<Alumno05Context> Service
            , IOrdenCompraService<Alumno05Context> OrdenCompraService,
              ITipoImpuestoService<Alumno05Context> TipoImpuestoService
            , CotizacionProceso<Alumno05Context> Proceso)
        {
            _Logger = Logger;
