...
{
    [Route("api/insumoxcotizacion/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno05Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno05Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno05Controller> _Logger;
        private readonly CotizacionProceso<Alumno05Context> _Proceso;
        private readonly Alumno05Context Context;
        public InsumoXCotizacionAlumno05Controller(
            ILogger<InsumoXCotizacionAlumno05Controller> Logger,
            Alumno05Context Context
            , IInsumoXCotizacionService<Alumno05Context> Service
