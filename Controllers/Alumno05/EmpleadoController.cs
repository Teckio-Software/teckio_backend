...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno05Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno05Context> _empleadoService;
        public EmpleadoAlumno05Controller(
            IEmpleadoService<Alumno05Context> empleadoService
            )
        {
