...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaAlumno05Controller : ControllerBase
    {
        ...
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno05Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno05Controller(
            ILogger<CompraDirectaAlumno05Controller> logger,
            Alumno05Context context
            , ICompraDirectaService<Alumno05Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
