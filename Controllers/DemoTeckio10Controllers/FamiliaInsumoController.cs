...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL10Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL10Controller(
            FamiliaInsumoProceso<DemoTeckioAL10Context> familiaInsumoProceso)
        {
