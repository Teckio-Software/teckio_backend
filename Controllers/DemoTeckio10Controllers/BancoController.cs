...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL10Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL10Context> _bancoService;

        public BancoDemoTeckioAL10Controller(IBancoService<DemoTeckioAL10Context> bancoService)
        {
