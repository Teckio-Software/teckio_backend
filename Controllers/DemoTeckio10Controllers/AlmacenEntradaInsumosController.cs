...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoDemoTeckioAL10Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoDemoTeckioAL10Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL10Context Context;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL10Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoDemoTeckioAL10Controller(
            ILogger<AlmacenEntradaInsumoDemoTeckioAL10Controller> logger,
            DemoTeckioAL10Context context
            , IInsumoXAlmacenEntradaService<DemoTeckioAL10Context> AlmacenEntradaDetalle
