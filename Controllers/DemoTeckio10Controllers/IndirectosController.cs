...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL10Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL10Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL10Context> _indirectosProceso;

        public IndirectosDemoTeckioAL10Controller(
                        IConjuntoIndirectosService<DemoTeckioAL10Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL10Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL10Context> indirectosProceso
            )
        {
