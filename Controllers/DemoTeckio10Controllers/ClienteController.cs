...
{
    [Route("api/cliente/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL10Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL10Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL10Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL10Controller(
            IClientesService<DemoTeckioAL10Context> service
            , ClienteProceso<DemoTeckioAL10Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL10Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
