...
{
    [Route("api/cotizacion/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL10Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL10Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL10Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL10Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL10Controller> _Logger;
        private readonly DemoTeckioAL10Context Context;
        public CotizacionDemoTeckioAL10Controller(

            ILogger<CotizacionDemoTeckioAL10Controller> Logger
            , DemoTeckioAL10Context Context
            , ICotizacionService<DemoTeckioAL10Context> Service
            , IOrdenCompraService<DemoTeckioAL10Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL10Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL10Context> Proceso)
        {
            _Logger = Logger;
