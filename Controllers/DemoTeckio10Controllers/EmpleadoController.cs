...
{
    [Route("api/empleado/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL10Context> _empleadoService;
        public EmpleadoDemoTeckioAL10Controller(
            IEmpleadoService<DemoTeckioAL10Context> empleadoService
            )
        {
