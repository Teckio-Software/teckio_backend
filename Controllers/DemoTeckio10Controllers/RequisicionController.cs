...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL10Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL10Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL10Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL10Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL10Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL10Controller(
            ILogger<RequisicionDemoTeckioAL10Controller> Logger
            , DemoTeckioAL10Context Context
            , IRequisicionService<DemoTeckioAL10Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL10Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL10Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL10Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL10Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/10/1070"))
            {
