...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL10Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL10Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL10Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL10Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL10Controller(
            ILogger<AlmacenEntradaDemoTeckioAL10Controller> logger,
            DemoTeckioAL10Context context
            , IAlmacenEntradaService<DemoTeckioAL10Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL10Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL10Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
