...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    [Route("api/categoriaProductoServicio/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CategoriaProductoYServicioController: ControllerBase
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL10Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL10Context> service)
        {
            _service = service;
        }
