...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL10Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL10Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL10Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL10Controller(
            ILogger<ExistenciasDemoTeckioAL10Controller> Logger,
            DemoTeckioAL10Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL10Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL10Context> Proceso
            )
        {
            _Logger = Logger;
