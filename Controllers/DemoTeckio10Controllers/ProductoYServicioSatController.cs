...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    {
        private readonly IProductoYServicioSatService<DemoTeckioAL10Context> _service;

        public ProductoYServicioSatController(IProductoYServicioSatService<DemoTeckioAL10Context> service)
        {
            _service = service;
        }
