...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL10Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL10Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL10Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL10Controller> logger
            , DemoTeckioAL10Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL10Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
