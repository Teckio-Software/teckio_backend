...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoDemoTeckioAL10Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoDemoTeckioAL10Controller(
            ILogger<ExplosionInsumoDemoTeckioAL10Controller> Logger,
