...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL10Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL10Context> _servicio;
        public CuentaBancariaDemoTeckioAL10Controller(CuentaBancariaProceso<DemoTeckioAL10Context> _proceso, ICuentaBancariaService<DemoTeckioAL10Context> _servicio
           )
        {
