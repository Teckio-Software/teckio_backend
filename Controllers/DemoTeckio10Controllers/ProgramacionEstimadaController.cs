...
{
    [Route("api/programacionestimada/10")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL10Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL10Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL10Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL10Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL10Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL10Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL10Context> precioUnitarioService,
