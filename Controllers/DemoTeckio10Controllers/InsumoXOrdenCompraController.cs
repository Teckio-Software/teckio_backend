...
{
    [Route("api/insumoxordencompra/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL10Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL10Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL10Controller> _Logger;
        private readonly DemoTeckioAL10Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL10Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL10Controller> Logger,
            DemoTeckioAL10Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL10Context> Service
