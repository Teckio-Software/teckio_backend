...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL10Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL10Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL10Controller(
            ILogger<TipoPolizaDemoTeckioAL10Controller> logger,
            DemoTeckioAL10Context context
            , ITipoPolizaService<DemoTeckioAL10Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
