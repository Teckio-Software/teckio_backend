...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL10Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL10Context> _almacenProceso;

        public AlmacenDemoTeckioAL10Controller(
            IAlmacenService<DemoTeckioAL10Context> almacenServicio, AlmacenProceso<DemoTeckioAL10Context> almacenProceso)
        {
