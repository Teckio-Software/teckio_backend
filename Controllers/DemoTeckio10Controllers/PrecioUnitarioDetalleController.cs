...
namespace SistemaERP.API.DemoTeckioAL10Controllers.Procomi
{
    [Route("api/preciounitariodetalle/10")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL10Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL10Controller(
