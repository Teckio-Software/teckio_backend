...
{
    [Route("api/ordencompra/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL10Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL10Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL10Controller> _Logger;
        ...
        public OrdenCompraDemoTeckioAL10Controller(
            ILogger<OrdenCompraDemoTeckioAL10Controller> Logger
            , DemoTeckioAL10Context Context
            , IOrdenCompraService<DemoTeckioAL10Context> Service
            , OrdenCompraProceso<DemoTeckioAL10Context> Proceso
