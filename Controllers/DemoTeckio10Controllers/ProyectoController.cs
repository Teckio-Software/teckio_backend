...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL10Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL10Controller(
            ProyectoProceso<DemoTeckioAL10Context> proyectoProceso)
        {
