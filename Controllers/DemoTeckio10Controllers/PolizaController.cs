...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL10Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL10Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL10Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL10Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL10Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL10Controller> _Logger;
        private readonly DemoTeckioAL10Context _Context;
        private readonly PolizaProceso<DemoTeckioAL10Context> _polizaProceso;
        public PolizaDemoTeckioAL10Controller(
            ILogger<PolizaDemoTeckioAL10Controller> logger
            , DemoTeckioAL10Context context
            , IPolizaService<DemoTeckioAL10Context> service
            , IPolizaDetalleService<DemoTeckioAL10Context> detalleService
            , ITipoPolizaService<DemoTeckioAL10Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL10Context> saldosService
            , ICuentaContableService<DemoTeckioAL10Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL10Context> polizaProceso
            )
        {
