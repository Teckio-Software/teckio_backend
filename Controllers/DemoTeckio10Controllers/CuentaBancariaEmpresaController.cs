...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL10Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL10Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL10Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL10Context> cuentaBancariaEmpresaService,
