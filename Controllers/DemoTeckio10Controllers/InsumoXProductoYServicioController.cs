...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/10")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL10Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL10Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL10Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL10Context> process)
        {
            _service = service;
            _process = process;
        }
