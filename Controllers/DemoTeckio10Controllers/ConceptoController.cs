...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL10Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL10Controller(
            ConceptoProceso<DemoTeckioAL10Context> conceptoProceso)
        {
