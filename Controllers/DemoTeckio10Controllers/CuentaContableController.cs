...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL10Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL10Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL10Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL10Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL10Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL10Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL10Controller(
            ILogger<CuentaContableDemoTeckioAL10Controller> logger,
            DemoTeckioAL10Context context
            , ICuentaContableService<DemoTeckioAL10Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL10Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL10Context> RubroService
            , CuentaContableProceso<DemoTeckioAL10Context> proceso
            )
        {
            Logger = logger;
            Context = context;
