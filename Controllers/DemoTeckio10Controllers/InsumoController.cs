...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL10Context> _InsumoProceso;
        public InsumoDemoTeckioAL10Controller(
            InsumoProceso<DemoTeckioAL10Context> insumoProceso)
        {
