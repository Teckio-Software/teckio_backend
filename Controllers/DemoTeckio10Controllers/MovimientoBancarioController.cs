...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/10")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL10Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL10Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL10Controller(
            MovimientoBancarioProceso<DemoTeckioAL10Context> movimientoBancarioProceso
            )
        {
