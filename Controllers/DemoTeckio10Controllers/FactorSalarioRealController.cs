...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL10Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL10Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL10Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL10Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL10Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL10Context> porcentajeCesantiaEdadService
            )
        {
