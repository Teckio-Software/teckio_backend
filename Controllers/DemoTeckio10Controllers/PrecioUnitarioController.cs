...
{
    [Route("api/preciounitario/10")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL10Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL10Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL10Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL10Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL10Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL10Controller(
            PrecioUnitarioProceso<DemoTeckioAL10Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL10Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL10Context> options,
            ExplocionInsumosProceso<DemoTeckioAL10Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL10Context(_Options.Options))
            {
