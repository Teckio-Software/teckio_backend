...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL10Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL10Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL10Controller(
            ILogger<CompraDirectaDemoTeckioAL10Controller> logger,
            DemoTeckioAL10Context context
            , ICompraDirectaService<DemoTeckioAL10Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
