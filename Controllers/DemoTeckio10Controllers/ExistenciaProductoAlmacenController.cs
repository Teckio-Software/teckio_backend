...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    [Route("api/existenciaproductoalmacen/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL10Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL10Context> proces)
        {
            _proceso = proces;
        }
