...
{
    [Route("api/insumoxcotizacion/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL10Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL10Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL10Context> _Proceso;
        private readonly DemoTeckioAL10Context Context;
        public InsumoXCotizacionDemoTeckioAL10Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL10Controller> Logger,
            DemoTeckioAL10Context Context
            , IInsumoXCotizacionService<DemoTeckioAL10Context> Service
