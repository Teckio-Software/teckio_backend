...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/10")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL10Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL10Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL10Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL10Controller(
            ILogger<ContratistaDemoTeckioAL10Controller> logger,
            DemoTeckioAL10Context context
            , IContratistaService<DemoTeckioAL10Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL10Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
