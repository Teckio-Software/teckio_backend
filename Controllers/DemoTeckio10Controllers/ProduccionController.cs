...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    [Route("api/produccion/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL10Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL10Context> proceso)
        {
            _proceso = proceso;
        }
