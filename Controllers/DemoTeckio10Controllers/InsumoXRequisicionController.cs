...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL10Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL10Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL10Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL10Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL10Controller> Logger,
            RequisicionProceso<DemoTeckioAL10Context> Proceso,
            DemoTeckioAL10Context Context
            , IInsumoXRequisicionService<DemoTeckioAL10Context> Service)
        {
            _Logger = Logger;
