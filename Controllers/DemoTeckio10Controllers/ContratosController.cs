...
{
    [Route("api/contratos/10")]
    [ApiController]
    public class ContratosDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL10Context> _contratosProceso;
        public ContratosDemoTeckioAL10Controller(
            ContratosProceso<DemoTeckioAL10Context> contratosProceso
            )
        {
