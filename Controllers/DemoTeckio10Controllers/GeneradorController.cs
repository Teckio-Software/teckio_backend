...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL10Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL10Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL10Controller(
            GeneradoresProceso<DemoTeckioAL10Context> generadoresProceso)
        {
