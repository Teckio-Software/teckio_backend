...
{
    [Route("api/indirectosXConcepto/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL10Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL10Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL10Controller(
            IIndirectosXConceptoService<DemoTeckioAL10Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL10Context> indirectosXConceptoProceso
            ) { 
