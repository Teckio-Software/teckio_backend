...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    public class ProductoYServicioDemoTeckioAL10Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL10Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL10Context> _process;

        public ProductoYServicioDemoTeckioAL10Controller(IProductoYservicioService<DemoTeckioAL10Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL10Context> process
            )
        {
