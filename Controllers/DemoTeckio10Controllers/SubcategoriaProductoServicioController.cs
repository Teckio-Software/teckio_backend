...
namespace ERP_TECKIO.Controllers.DemoTeckioAL10
{
    ...
    [Route("api/subcategoriaProductoServicio/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL10Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL10Context> service)
        {
            _service = service;
        }
