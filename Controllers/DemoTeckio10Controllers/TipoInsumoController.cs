...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL10Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL10Controller(
            TipoInsumoProceso<DemoTeckioAL10Context> tipoInsumoProceso
            )
        {
