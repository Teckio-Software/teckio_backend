...
{
    [Route("api/detalleordencompra/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class DetalleOrdenVentaController: ControllerBase
    {
        private readonly DetalleOrdenVentaProceso<DemoTeckioAL10Context> _Proceso;

        public DetalleOrdenVentaController(DetalleOrdenVentaProceso<DemoTeckioAL10Context> proceso)
        {
            _Proceso = proceso;
        }
