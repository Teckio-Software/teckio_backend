...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EntradaProduccionAlmacenDemoTeckioAL10Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL10Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL10Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL10Context> proceso)
        {
            _proceso = proceso;
        }
