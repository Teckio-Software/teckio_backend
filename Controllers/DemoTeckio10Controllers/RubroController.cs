...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL10Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL10Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL10Controller> Logger;
        ...
        public RubroDemoTeckioAL10Controller(
            ILogger<RubroDemoTeckioAL10Controller> logger,
            DemoTeckioAL10Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL10Context> service
            )
        {
            //_Service = service;
            Logger = logger;
