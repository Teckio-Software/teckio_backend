...
{
    [Route("api/reportesdestajo/10")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL10Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL10Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL10Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL10Controller(
            ReporteDestajoProceso<DemoTeckioAL10Context> proceso,
            EstimacionesProceso<DemoTeckioAL10Context> estimacionesProceso
            ) { 
            _proceso = proceso;
