...
namespace ERP_TECKIO.Controllers.Alumno29
{
    [Route("api/fsr/29")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno29Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno29Context> factorSalarioRealProceso)
        {
