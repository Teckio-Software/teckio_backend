...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa29")]
    public class InsumoXContratistaAlumno29Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno29Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno29Controller(
            ILogger<InsumoXContratistaAlumno29Controller> logger,
