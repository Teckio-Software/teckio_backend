...
{
    [Route("api/insumoxordencompra/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno29Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno29Context> _Service;
        private readonly OrdenCompraProceso<Alumno29Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno29Controller> _Logger;
        private readonly Alumno29Context _Context;
        public InsumoXOrdenCompraAlumno29Controller(
            ILogger<InsumoXOrdenCompraAlumno29Controller> Logger,
            Alumno29Context Context
            , IInsumoXOrdenCompraService<Alumno29Context> Service
            , OrdenCompraProceso<Alumno29Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
