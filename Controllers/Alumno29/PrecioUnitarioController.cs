...
namespace SistemaERP.API.Alumno29Controllers.Procomi
{
    [Route("api/preciounitario/29")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno29Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno29Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno29Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno29Context> _Options;
        public PrecioUnitarioAlumno29Controller(
            PrecioUnitarioProceso<Alumno29Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno29Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno29Context> options
            )
        {
        ...
        {
            using (var db = new Alumno29Context(_Options.Options))
            {
