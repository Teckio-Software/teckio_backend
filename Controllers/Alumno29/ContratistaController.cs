...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/29")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno29Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno29Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno29Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno29Controller(
            ILogger<ContratistaAlumno29Controller> logger,
            Alumno29Context context
            , IContratistaService<Alumno29Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
