...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno29Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno29Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno29Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno29Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno29Controller(
            ILogger<ExistenciasAlumno29Controller> Logger,
            Alumno29Context Context
            , IAlmacenExistenciaInsumoService<Alumno29Context> ExistenciaService
            , ExistenciasProceso<Alumno29Context> Proceso
            )
        {
            _Logger = Logger;
