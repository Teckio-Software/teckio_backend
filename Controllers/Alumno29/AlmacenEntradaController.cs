...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno29Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno29Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno29Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno29Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno29Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno29Controller(
            ILogger<AlmacenEntradaAlumno29Controller> logger,
            Alumno29Context context
            , IAlmacenEntradaService<Alumno29Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno29Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno29Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
