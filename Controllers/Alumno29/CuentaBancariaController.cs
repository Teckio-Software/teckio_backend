...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno29Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno29Context> _proceso;

        private readonly ICuentaBancariaService<Alumno29Context> _servicio;
        public CuentaBancariaAlumno29Controller(CuentaBancariaProceso<Alumno29Context> _proceso, ICuentaBancariaService<Alumno29Context> _servicio
           )
        {
