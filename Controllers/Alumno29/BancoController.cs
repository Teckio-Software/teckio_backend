...
namespace ERP_TECKIO.API.Controllers.Alumno29
{
    ...
    public class BancoAlumno29Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno29Context> _bancoService;

        public BancoAlumno29Controller(IBancoService<Alumno29Context> bancoService)
        {
