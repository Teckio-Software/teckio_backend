...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/29")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno29Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno29Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno29Controller(
            ILogger<ContratistaCuentaBancariaAlumno29Controller> logger,
