...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa29")]
    public class EspecialIdadXContratistaAlumno29Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno29Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno29Controller(
            ILogger<EspecialIdadXContratistaAlumno29Controller> logger,
