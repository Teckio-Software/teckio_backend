...
namespace ERP_TECKIO.API.Alumno029Controllers.Procomi
{
    [Route("api/estimaciones/29")]
    [ApiController]
    public class EstimacionesAlumno29Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno29Context> _estimacionesProceso;
        public EstimacionesAlumno29Controller(
