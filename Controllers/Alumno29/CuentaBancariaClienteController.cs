...
{
    [Route("api/cuentabancariacliente/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaClienteAlumno29Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno29Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno29Context> _proceso;

        public CuentaBancariaClienteAlumno29Controller(
            ICuentaBancariaClienteService<Alumno29Context> cuentaBancariaClienteService,
