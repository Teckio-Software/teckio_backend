...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa29")]
    public class CompraDirectaInsumoAlumno29Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno29Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno29Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno29Controller(
            ILogger<CompraDirectaInsumoAlumno29Controller> logger
            , Alumno29Context context
            , IInsumoXCompraDirectaService<Alumno29Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
