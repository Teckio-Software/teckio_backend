...
{
    [Route("api/insumoxcotizacion/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno29Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno29Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno29Controller> _Logger;
        private readonly CotizacionProceso<Alumno29Context> _Proceso;
        private readonly Alumno29Context Context;
        public InsumoXCotizacionAlumno29Controller(
            ILogger<InsumoXCotizacionAlumno29Controller> Logger,
            Alumno29Context Context
            , IInsumoXCotizacionService<Alumno29Context> Service
