...
{
    [Route("api/programacionestimada/29")]
    [ApiController]
    public class ProgramacionEstimadaAlumno29Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno29Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno29Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno29Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno29Controller(
            ProgramacionEstimadaProceso<Alumno29Context> programacionEstimadaProceso,
            IProyectoService<Alumno29Context> proyectoProceso,
            IPrecioUnitarioService<Alumno29Context> precioUnitarioService,
