...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa29")]
    public class FamiliaInsumoAlumno29Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno29Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno29Controller(
            FamiliaInsumoProceso<Alumno29Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa29")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa29")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa29")]
