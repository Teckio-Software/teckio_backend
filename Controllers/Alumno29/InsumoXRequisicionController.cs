...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno29Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno29Context> _Service;

        private readonly RequisicionProceso<Alumno29Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno29Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno29Controller(
            ILogger<InsumoXRequisicionAlumno29Controller> Logger,
            RequisicionProceso<Alumno29Context> Proceso,
            Alumno29Context Context
            , IInsumoXRequisicionService<Alumno29Context> Service)
        {
            _Logger = Logger;
