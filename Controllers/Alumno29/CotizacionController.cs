...
{
    [Route("api/cotizacion/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno29Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno29Context> _Service;
        private readonly CotizacionProceso<Alumno29Context> _Proceso;
        private readonly IOrdenCompraService<Alumno29Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno29Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno29Controller> _Logger;
        private readonly Alumno29Context Context;
        public CotizacionAlumno29Controller(

            ILogger<CotizacionAlumno29Controller> Logger
            , Alumno29Context Context
            , ICotizacionService<Alumno29Context> Service
            , IOrdenCompraService<Alumno29Context> OrdenCompraService,
              ITipoImpuestoService<Alumno29Context> TipoImpuestoService
            , CotizacionProceso<Alumno29Context> Proceso)
        {
            _Logger = Logger;
