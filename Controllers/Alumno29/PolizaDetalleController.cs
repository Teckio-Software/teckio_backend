...
{
    [Route("api/polizadetalle/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa29")]
    public class PolizaDetalleAlumno29Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno29Context> _Service;
        private readonly ICuentaContableService<Alumno29Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno29Controller> _Logger;
        private readonly Alumno29Context _Context;
        public PolizaDetalleAlumno29Controller(
            ILogger<PolizaDetalleAlumno29Controller> logger
            , Alumno29Context context
            , IPolizaDetalleService<Alumno29Context> service
