...
namespace ERP_TECKIO
{
    [Route("api/poliza/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa29")]
    public class PolizaAlumno29Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno29Context> _Service;
        private readonly IPolizaDetalleService<Alumno29Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno29Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno29Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno29Context> _SaldosService;
        private readonly ILogger<PolizaAlumno29Controller> _Logger;
        private readonly Alumno29Context _Context;
        public PolizaAlumno29Controller(
            ILogger<PolizaAlumno29Controller> logger
            , Alumno29Context context
            , IPolizaService<Alumno29Context> service
            , IPolizaDetalleService<Alumno29Context> detalleService
            , ITipoPolizaService<Alumno29Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno29Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa29")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa29")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa29")]
