...
{
    [Route("api/indirectos/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno29Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno29Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno29Context> _indirectosService;
        private readonly IndirectosProceso<Alumno29Context> _indirectosProceso;

        public IndirectosAlumno29Controller(
                        IConjuntoIndirectosService<Alumno29Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno29Context> indirectosService,
                        IndirectosProceso<Alumno29Context> indirectosProceso
            )
        {
