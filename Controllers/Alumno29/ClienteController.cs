...
{
    [Route("api/cliente/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno29Controller : ControllerBase
    {
        private readonly IClientesService<Alumno29Context> _Service;

        private readonly ClienteProceso<Alumno29Context> _Proceso;
        public ClienteAlumno29Controller(
            IClientesService<Alumno29Context> service
            , ClienteProceso<Alumno29Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
