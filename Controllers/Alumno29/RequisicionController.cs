...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno29Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno29Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno29Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno29Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno29Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno29Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno29Controller(
            ILogger<RequisicionAlumno29Controller> Logger
            , Alumno29Context Context
            , IRequisicionService<Alumno29Context> RequisicionService
            , RequisicionProceso<Alumno29Context> Proceso
            , ObjetoRequisicionProceso<Alumno29Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno29Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
