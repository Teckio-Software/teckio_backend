...
{
    [Route("api/ordencompra/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno29Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno29Context> _Service;
        private readonly OrdenCompraProceso<Alumno29Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno29Controller> _Logger;
        private readonly Alumno29Context Context;
        public OrdenCompraAlumno29Controller(
            ILogger<OrdenCompraAlumno29Controller> Logger
            , Alumno29Context Context
            , IOrdenCompraService<Alumno29Context> Service
