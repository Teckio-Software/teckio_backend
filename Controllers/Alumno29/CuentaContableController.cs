...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa29")]
    public class CuentaContableAlumno29Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno29Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno29Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno29Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno29Controller(
            ILogger<CuentaContableAlumno29Controller> logger,
            Alumno29Context context
            , ICuentaContableService<Alumno29Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno29Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
