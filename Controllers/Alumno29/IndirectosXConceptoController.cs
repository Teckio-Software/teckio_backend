...
{
    [Route("api/indirectosXConcepto/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoAlumno29Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno29Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno29Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno29Controller(
            IIndirectosXConceptoService<Alumno29Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno29Context> indirectosXConceptoProceso
            ) { 
