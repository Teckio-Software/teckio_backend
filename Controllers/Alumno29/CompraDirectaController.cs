...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa29")]
    public class CompraDirectaAlumno29Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno29Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno29Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno29Controller(
            ILogger<CompraDirectaAlumno29Controller> logger,
            Alumno29Context context
            , ICompraDirectaService<Alumno29Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa29")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa29")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa29")]
