...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno29Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno29Context> _almacenServicio;

        public AlmacenAlumno29Controller(
            IAlmacenService<Alumno29Context> almacenServicio)
        {
