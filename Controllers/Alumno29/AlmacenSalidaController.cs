...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno29Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno29Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno29Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno29Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno29Controller> Logger;
        ...
        public AlmacenSalidaAlumno29Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno29Controller> logger,
            Alumno29Context context
            , IAlmacenSalidaService<Alumno29Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno29Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno29Context> Proceso
            )
        {
