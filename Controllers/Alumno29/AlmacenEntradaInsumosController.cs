...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/29")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno29Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno29Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno29Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno29Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno29Controller(
            ILogger<AlmacenEntradaInsumoAlumno29Controller> logger,
            Alumno29Context context
            , IInsumoXAlmacenEntradaService<Alumno29Context> AlmacenEntradaDetalle
