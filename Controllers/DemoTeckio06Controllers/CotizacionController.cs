...
{
    [Route("api/cotizacion/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL06Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL06Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL06Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL06Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL06Controller> _Logger;
        private readonly DemoTeckioAL06Context Context;
        public CotizacionDemoTeckioAL06Controller(

            ILogger<CotizacionDemoTeckioAL06Controller> Logger
            , DemoTeckioAL06Context Context
            , ICotizacionService<DemoTeckioAL06Context> Service
            , IOrdenCompraService<DemoTeckioAL06Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL06Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL06Context> Proceso)
        {
            _Logger = Logger;
