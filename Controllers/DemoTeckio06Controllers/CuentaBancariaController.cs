...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL06Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL06Context> _servicio;
        public CuentaBancariaDemoTeckioAL06Controller(CuentaBancariaProceso<DemoTeckioAL06Context> _proceso, ICuentaBancariaService<DemoTeckioAL06Context> _servicio
           )
        {
