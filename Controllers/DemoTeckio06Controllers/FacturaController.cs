...
namespace ERP_TECKIO.Controllers.DemoTeckioAL06
{
    ...
    public class FacturaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL06Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL06Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL06Controller(
            ObtenFacturaProceso<DemoTeckioAL06Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL06Context> categoriaProductoYServicioService
            )
        {
