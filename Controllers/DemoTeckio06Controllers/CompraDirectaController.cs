...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL06Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL06Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL06Controller(
            ILogger<CompraDirectaDemoTeckioAL06Controller> logger,
            DemoTeckioAL06Context context
            , ICompraDirectaService<DemoTeckioAL06Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
