...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL06Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL06Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL06Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL06Controller(
            IClientesService<DemoTeckioAL06Context> service
            , ClienteProceso<DemoTeckioAL06Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL06Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
