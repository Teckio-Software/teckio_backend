...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL06Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL06Controller> Logger;
        ...
        public RubroDemoTeckioAL06Controller(
            ILogger<RubroDemoTeckioAL06Controller> logger,
            DemoTeckioAL06Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL06Context> service
            )
        {
            //_Service = service;
            Logger = logger;
