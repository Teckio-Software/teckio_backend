...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioAL06Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL06Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL06Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL06Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL06Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL06Controller(
            PrecioUnitarioProceso<DemoTeckioAL06Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL06Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL06Context> options,
            ExplocionInsumosProceso<DemoTeckioAL06Context> explocionInsumosProceso
            )
        {
