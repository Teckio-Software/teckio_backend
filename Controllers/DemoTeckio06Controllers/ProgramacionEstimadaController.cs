...
{
    [Route("api/programacionestimada/6")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL06Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL06Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL06Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL06Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL06Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL06Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL06Context> precioUnitarioService,
