...
{
    [Route("api/insumoxordencompra/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL06Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL06Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL06Controller> _Logger;
        private readonly DemoTeckioAL06Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL06Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL06Controller> Logger,
            DemoTeckioAL06Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL06Context> Service
