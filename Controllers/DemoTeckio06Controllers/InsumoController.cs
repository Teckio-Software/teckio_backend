...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL06Context> _InsumoProceso;
        public InsumoDemoTeckioAL06Controller(
            InsumoProceso<DemoTeckioAL06Context> insumoProceso)
        {
