...
{
    [Route("api/contratos/6")]
    [ApiController]
    public class ContratosDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL06Context> _contratosProceso;
        public ContratosDemoTeckioAL06Controller(
            ContratosProceso<DemoTeckioAL06Context> contratosProceso
            )
        {
