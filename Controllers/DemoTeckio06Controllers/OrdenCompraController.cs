...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL06Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL06Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL06Controller> _Logger;
        private readonly DemoTeckioAL06Context Context;
        private readonly PolizaProceso<DemoTeckioAL06Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL06Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL06Controller(
            ILogger<OrdenCompraDemoTeckioAL06Controller> Logger
            , DemoTeckioAL06Context Context
            , IOrdenCompraService<DemoTeckioAL06Context> Service
            , OrdenCompraProceso<DemoTeckioAL06Context> Proceso
            , PolizaProceso<DemoTeckioAL06Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL06Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
