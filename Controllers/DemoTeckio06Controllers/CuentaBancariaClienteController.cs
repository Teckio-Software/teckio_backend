...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL06Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL06Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL06Controller(
            ICuentaBancariaClienteService<DemoTeckioAL06Context> cuentaBancariaClienteService,
            CuentaBancariaProceso<DemoTeckioAL06Context> proceso
            )
        {
