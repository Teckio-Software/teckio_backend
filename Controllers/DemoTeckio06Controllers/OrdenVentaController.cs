...
{
    [Route("api/ordenventa/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL06Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL06Controller(
            OrdenVentaProceso<DemoTeckioAL06Context> ordenVentaProceso
            ) { 
