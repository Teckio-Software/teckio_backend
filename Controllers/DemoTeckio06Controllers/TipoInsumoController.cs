...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL06Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL06Controller(
            TipoInsumoProceso<DemoTeckioAL06Context> tipoInsumoProceso
            )
        {
