...
{
    [Route("api/estimaciones/6")]
    [ApiController]
    public class EstimacionesDemoTeckioAL06Controller : ControllerBase
    {
        private readonly EstimacionesProceso<DemoTeckioAL06Context> _estimacionesProceso;
        public EstimacionesDemoTeckioAL06Controller(
            EstimacionesProceso<DemoTeckioAL06Context> estimacionesProceso
            )
        {
