...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL06Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL06Context> _bancoService;

        public BancoDemoTeckioAL06Controller(IBancoService<DemoTeckioAL06Context> bancoService)
        {
