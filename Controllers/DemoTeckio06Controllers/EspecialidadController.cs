...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL06Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL06Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL06Controller(
            EspecialidadProceso<DemoTeckioAL06Context> especialidadProceso)
        {
