...
{
    [Route("api/insumoxcotizacion/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL06Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL06Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL06Context> _Proceso;
        private readonly DemoTeckioAL06Context Context;
        public InsumoXCotizacionDemoTeckioAL06Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL06Controller> Logger,
            DemoTeckioAL06Context Context
            , IInsumoXCotizacionService<DemoTeckioAL06Context> Service
