...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL06Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL06Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL06Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL06Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL06Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL06Controller> logger,
            DemoTeckioAL06Context context
            , IAlmacenSalidaService<DemoTeckioAL06Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL06Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL06Context> Proceso
            )
        {
