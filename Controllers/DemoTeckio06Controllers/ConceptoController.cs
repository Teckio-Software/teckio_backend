...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL06Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL06Controller(
            ConceptoProceso<DemoTeckioAL06Context> conceptoProceso)
        {
