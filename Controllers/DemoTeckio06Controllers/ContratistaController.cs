...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/6")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL06Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL06Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL06Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL06Controller(
            ILogger<ContratistaDemoTeckioAL06Controller> logger,
            DemoTeckioAL06Context context
            , IContratistaService<DemoTeckioAL06Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL06Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
