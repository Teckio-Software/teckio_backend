...
namespace ERP_TECKIO.Controllers.DemoTeckioAL06
{
    ...
    [Route("api/categoriaProductoServicio/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CategoriaProductoYServicioController: ControllerBase
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL06Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL06Context> service)
        {
            _service = service;
        }
