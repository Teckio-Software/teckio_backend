...
namespace ERP_TECKIO.Controllers.DemoTeckioAL06
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/6")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL06Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL06Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL06Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL06Context> process)
        {
            _service = service;
            _process = process;
        }
