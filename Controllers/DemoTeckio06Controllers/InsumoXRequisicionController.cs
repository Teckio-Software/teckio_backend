...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL06Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL06Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL06Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL06Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL06Controller> Logger,
            RequisicionProceso<DemoTeckioAL06Context> Proceso,
            DemoTeckioAL06Context Context
            , IInsumoXRequisicionService<DemoTeckioAL06Context> Service)
        {
            _Logger = Logger;
