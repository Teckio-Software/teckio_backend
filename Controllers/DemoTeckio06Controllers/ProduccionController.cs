...
namespace ERP_TECKIO.Controllers.DemoTeckioAL06
{
    ...
    [Route("api/produccion/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL06Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL06Context> proceso)
        {
            _proceso = proceso;
        }
