...
namespace ERP_TECKIO.Controllers.DemoTeckioAL06
{
    ...
    [Route("api/subcategoriaProductoServicio/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL06Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL06Context> service)
        {
            _service = service;
        }
