...
namespace ERP_TECKIO.Controllers.DemoTeckioAL06
{
    ...
    [Route("api/insumoXproduccion/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL06Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL06Context> proces)
        {
            _proceso = proces;
        }
