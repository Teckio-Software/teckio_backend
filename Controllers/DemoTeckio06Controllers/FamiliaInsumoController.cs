...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL06Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL06Controller(
            FamiliaInsumoProceso<DemoTeckioAL06Context> familiaInsumoProceso)
        {
