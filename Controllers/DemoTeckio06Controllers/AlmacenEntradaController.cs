...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL06Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL06Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL06Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL06Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL06Controller(
            ILogger<AlmacenEntradaDemoTeckioAL06Controller> logger,
            DemoTeckioAL06Context context
            , IAlmacenEntradaService<DemoTeckioAL06Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL06Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL06Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
