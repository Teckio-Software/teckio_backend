...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL06Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL06Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL06Controller(
            ReporteDestajoProceso<DemoTeckioAL06Context> proceso,
