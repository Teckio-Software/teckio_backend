...
{
    [Route("api/precioUnitarioXEmpleado/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL06Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL06Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL06Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL06Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL06Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
