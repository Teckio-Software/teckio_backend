...
{
    [Route("api/indirectos/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL06Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL06Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL06Context> _indirectosProceso;

        public IndirectosDemoTeckioAL06Controller(
                        IConjuntoIndirectosService<DemoTeckioAL06Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL06Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL06Context> indirectosProceso
            )
        {
