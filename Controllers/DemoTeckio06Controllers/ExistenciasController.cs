...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL06Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL06Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL06Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL06Controller(
            ILogger<ExistenciasDemoTeckioAL06Controller> Logger,
            DemoTeckioAL06Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL06Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL06Context> Proceso
            )
        {
            _Logger = Logger;
