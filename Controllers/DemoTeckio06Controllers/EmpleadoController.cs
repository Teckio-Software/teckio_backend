...
{
    [Route("api/empleado/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL06Context> _empleadoService;
        public EmpleadoDemoTeckioAL06Controller(
            IEmpleadoService<DemoTeckioAL06Context> empleadoService
            )
        {
