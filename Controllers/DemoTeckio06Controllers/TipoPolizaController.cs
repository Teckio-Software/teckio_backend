...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL06Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL06Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL06Controller(
            ILogger<TipoPolizaDemoTeckioAL06Controller> logger,
            DemoTeckioAL06Context context
            , ITipoPolizaService<DemoTeckioAL06Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
