...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL06Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL06Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL06Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL06Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL06Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL06Controller> _Logger;
        private readonly DemoTeckioAL06Context _Context;
        private readonly PolizaProceso<DemoTeckioAL06Context> _polizaProceso;
        public PolizaDemoTeckioAL06Controller(
            ILogger<PolizaDemoTeckioAL06Controller> logger
            , DemoTeckioAL06Context context
            , IPolizaService<DemoTeckioAL06Context> service
            , IPolizaDetalleService<DemoTeckioAL06Context> detalleService
            , ITipoPolizaService<DemoTeckioAL06Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL06Context> saldosService
