...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL06Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL06Controller(
            ProyectoProceso<DemoTeckioAL06Context> proyectoProceso)
        {
