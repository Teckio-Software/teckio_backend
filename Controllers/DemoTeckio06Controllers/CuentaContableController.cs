...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaContableDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL06Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL06Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL06Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL06Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL06Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL06Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL06Controller(
            ILogger<CuentaContableDemoTeckioAL06Controller> logger,
            DemoTeckioAL06Context context
            , ICuentaContableService<DemoTeckioAL06Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL06Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL06Context> RubroService
            , CuentaContableProceso<DemoTeckioAL06Context> proceso
            )
        {
            Logger = logger;
            Context = context;
