...
{
    [Route("api/indirectosXConcepto/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL06Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL06Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL06Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL06Controller(
            IIndirectosXConceptoService<DemoTeckioAL06Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL06Context> indirectosXConceptoProceso
            ) { 
