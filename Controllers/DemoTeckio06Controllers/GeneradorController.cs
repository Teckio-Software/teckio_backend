...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL06Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL06Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL06Controller(
            GeneradoresProceso<DemoTeckioAL06Context> generadoresProceso)
        {
