...
{
    [Route("api/entradaproduccionalmacen/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL06Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL06Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL06Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL06Context> proceso)
        {
            _proceso = proceso;
        }
