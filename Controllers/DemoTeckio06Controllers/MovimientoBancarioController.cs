...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/6")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL06Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL06Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL06Controller(
            MovimientoBancarioProceso<DemoTeckioAL06Context> movimientoBancarioProceso
            )
        {
