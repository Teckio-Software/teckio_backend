...
namespace SistemaERP.API.Controllers.DemoTeckioAL06
{
    [Route("api/programacionestimadaGantt/6")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL06Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL06Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL06Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL06Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL06Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL06Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL06Context> importeSemanalGanttProceso,
