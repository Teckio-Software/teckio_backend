...
{
    [Route("api/parametrosImpresionPu/6")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ParametrosImpresionPuController : ControllerBase
    {

        private readonly ParametrosImpresionPuProceso<DemoTeckioAL06Context> _proceso;

        public ParametrosImpresionPuController(ParametrosImpresionPuProceso<DemoTeckioAL06Context> proceso)
        {
            _proceso = proceso;
        }
