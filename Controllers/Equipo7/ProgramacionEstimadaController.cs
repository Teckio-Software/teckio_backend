...
{
    [Route("api/programacionestimada/45")]
    [ApiController]
    public class ProgramacionEstimadaAlumno45Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno38Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno38Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno38Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno45Controller(
            ProgramacionEstimadaProceso<Alumno38Context> programacionEstimadaProceso,
            IProyectoService<Alumno38Context> proyectoProceso,
            IPrecioUnitarioService<Alumno38Context> precioUnitarioService,
