...
{
    [Route("api/insumoxordencompra/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno45Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno38Context> _Service;
        private readonly OrdenCompraProceso<Alumno38Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno45Controller> _Logger;
        private readonly Alumno38Context _Context;
        public InsumoXOrdenCompraAlumno45Controller(
            ILogger<InsumoXOrdenCompraAlumno45Controller> Logger,
            Alumno38Context Context
            , IInsumoXOrdenCompraService<Alumno38Context> Service
            , OrdenCompraProceso<Alumno38Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
