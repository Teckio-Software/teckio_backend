...
{
    [Route("api/cliente/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno45Controller : ControllerBase
    {
        private readonly IClientesService<Alumno38Context> _Service;

        private readonly ClienteProceso<Alumno38Context> _Proceso;
        public ClienteAlumno45Controller(
            IClientesService<Alumno38Context> service
            , ClienteProceso<Alumno38Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
