...
{
    [Route("api/contratos/45")]
    [ApiController]
    public class ContratosAlumno45Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno38Context> _contratosProceso;
        public ContratosAlumno45Controller(
            ContratosProceso<Alumno38Context> contratosProceso
            )
        {
