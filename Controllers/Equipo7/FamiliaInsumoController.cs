...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/familiainsumo/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno45Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno38Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno45Controller(
            FamiliaInsumoProceso<Alumno38Context> familiaInsumoProceso)
        {
