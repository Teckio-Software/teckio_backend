...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipopoliza/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno45Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno38Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno45Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno45Controller(
            ILogger<TipoPolizaAlumno45Controller> logger,
            Alumno38Context context
            , ITipoPolizaService<Alumno38Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
