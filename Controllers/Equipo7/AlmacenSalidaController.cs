...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenSalida/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno45Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno38Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno38Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno38Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno45Controller> Logger;
        ...
        public AlmacenSalidaAlumno45Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno45Controller> logger,
            Alumno38Context context
            , IAlmacenSalidaService<Alumno38Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno38Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno38Context> Proceso
            )
        {
