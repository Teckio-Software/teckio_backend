...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    public class RubroAlumno45Controller : ControllerBase
    {
        private readonly IRubroService<Alumno38Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno45Controller> Logger;
        ...
        public RubroAlumno45Controller(
            ILogger<RubroAlumno45Controller> logger,
            Alumno38Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno38Context> service
            )
        {
            //_Service = service;
            Logger = logger;
