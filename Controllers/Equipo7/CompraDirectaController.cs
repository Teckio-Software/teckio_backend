...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirecta/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno45Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno38Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno45Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno38Context Context;
        /// <summary>
        ...
        public CompraDirectaAlumno45Controller(
            ILogger<CompraDirectaAlumno45Controller> logger,
            Alumno38Context context
            , ICompraDirectaService<Alumno38Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        public async Task<ActionResult> Post([FromBody] CompraDirectaCreacionDTO CreacionDTO)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno38Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
