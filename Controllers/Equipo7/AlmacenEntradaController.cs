...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentrada/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno45Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno38Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno38Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno38Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno45Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno45Controller(
            ILogger<AlmacenEntradaAlumno45Controller> logger,
            Alumno38Context context
            , IAlmacenEntradaService<Alumno38Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno38Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno38Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
