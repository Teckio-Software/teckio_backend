...
{
    [Route("api/preciounitario/45")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno45Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno38Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno38Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno38Context> _Options;
        public PrecioUnitarioAlumno45Controller(
            PrecioUnitarioProceso<Alumno38Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno38Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno38Context> options
            )
        {
        ...
        {
            using(var db = new Alumno38Context(_Options.Options))
