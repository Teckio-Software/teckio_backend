...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratista/45")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno45Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno38Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno45Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno45Controller(
            ILogger<ContratistaAlumno45Controller> logger,
            Alumno38Context context
            , IContratistaService<Alumno38Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
