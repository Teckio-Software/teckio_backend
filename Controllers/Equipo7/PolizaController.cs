...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    public class PolizaAlumno45Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno38Context> _Service;
        private readonly IPolizaDetalleService<Alumno38Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno38Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno38Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno38Context> _SaldosService;
        private readonly ILogger<PolizaAlumno45Controller> _Logger;
        private readonly Alumno38Context _Context;
        public PolizaAlumno45Controller(
            ILogger<PolizaAlumno45Controller> logger
            , Alumno38Context context
            , IPolizaService<Alumno38Context> service
            , IPolizaDetalleService<Alumno38Context> detalleService
            , ITipoPolizaService<Alumno38Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno38Context> saldosService
