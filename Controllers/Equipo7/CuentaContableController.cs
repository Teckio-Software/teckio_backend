...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentacontable/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno45Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno38Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno38Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno45Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno45Controller(
            ILogger<CuentaContableAlumno45Controller> logger,
            Alumno38Context context
            , ICuentaContableService<Alumno38Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno38Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
