...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/requisicion/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno45Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno38Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno38Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno38Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno38Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno45Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno45Controller(
            ILogger<RequisicionAlumno45Controller> Logger
            , Alumno38Context Context
            , IRequisicionService<Alumno38Context> RequisicionService
            , RequisicionProceso<Alumno38Context> Proceso
            , ObjetoRequisicionProceso<Alumno38Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno38Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
