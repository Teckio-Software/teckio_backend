...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/proyecto/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno45Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno38Context> _ProyectoProceso;
        public ProyectoAlumno45Controller(
            ProyectoProceso<Alumno38Context> proyectoProceso)
        {
