...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno45Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno45Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno38Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno38Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno45Controller(
            ILogger<AlmacenEntradaInsumoAlumno45Controller> logger,
            Alumno38Context context
            , IInsumoXAlmacenEntradaService<Alumno38Context> AlmacenEntradaDetalle
