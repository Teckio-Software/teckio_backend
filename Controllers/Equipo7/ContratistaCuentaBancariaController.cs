...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/45")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno45Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno45Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno45Controller(
            ILogger<ContratistaCuentaBancariaAlumno45Controller> logger,
