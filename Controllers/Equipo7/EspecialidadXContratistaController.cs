...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa35")]
    public class EspecialIdadXContratistaAlumno45Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno45Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno45Controller(
            ILogger<EspecialIdadXContratistaAlumno45Controller> logger,
