...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno45Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno38Context> _proceso;

        private readonly ICuentaBancariaService<Alumno38Context> _servicio;
        public CuentaBancariaAlumno45Controller(CuentaBancariaProceso<Alumno38Context> _proceso, ICuentaBancariaService<Alumno38Context> _servicio
           )
        {
