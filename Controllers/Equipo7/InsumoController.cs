...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    public class InsumoAlumno45Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno38Context> _InsumoProceso;
        public InsumoAlumno45Controller(
            InsumoProceso<Alumno38Context> insumoProceso)
        {
