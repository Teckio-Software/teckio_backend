...
{
    [Route("api/empleado/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoAlumno45Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno38Context> _empleadoService;
        public EmpleadoAlumno45Controller(
            IEmpleadoService<Alumno38Context> empleadoService
            )
        {
