...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno45Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno38Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno45Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno45Controller(
            ILogger<CompraDirectaInsumoAlumno45Controller> logger
            , Alumno38Context context
            , IInsumoXCompraDirectaService<Alumno38Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
