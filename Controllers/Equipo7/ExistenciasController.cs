...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/existencias/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno45Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno38Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno38Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno45Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno45Controller(
            ILogger<ExistenciasAlumno45Controller> Logger,
            Alumno38Context Context
            , IAlmacenExistenciaInsumoService<Alumno38Context> ExistenciaService
            , ExistenciasProceso<Alumno38Context> Proceso
            )
        {
            _Logger = Logger;
