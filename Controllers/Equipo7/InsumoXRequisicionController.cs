...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno45Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno38Context> _Service;

        private readonly RequisicionProceso<Alumno38Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno45Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno45Controller(
            ILogger<InsumoXRequisicionAlumno45Controller> Logger,
            RequisicionProceso<Alumno38Context> Proceso,
            Alumno38Context Context
            , IInsumoXRequisicionService<Alumno38Context> Service)
        {
            _Logger = Logger;
