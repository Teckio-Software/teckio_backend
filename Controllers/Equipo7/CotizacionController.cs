...
{
    [Route("api/cotizacion/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno45Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno38Context> _Service;
        private readonly CotizacionProceso<Alumno38Context> _Proceso;
        private readonly IOrdenCompraService<Alumno38Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno38Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno45Controller> _Logger;
        private readonly Alumno38Context Context;
        public CotizacionAlumno45Controller(

            ILogger<CotizacionAlumno45Controller> Logger
            , Alumno38Context Context
            , ICotizacionService<Alumno38Context> Service
            , IOrdenCompraService<Alumno38Context> OrdenCompraService,
              ITipoImpuestoService<Alumno38Context> TipoImpuestoService
            , CotizacionProceso<Alumno38Context> Proceso)
        {
            _Logger = Logger;
