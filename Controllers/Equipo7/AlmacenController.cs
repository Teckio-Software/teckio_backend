...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    [Route("api/almacen/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno45Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno38Context> _almacenServicio;

        public AlmacenAlumno45Controller(
            IAlmacenService<Alumno38Context> almacenServicio)
        {
