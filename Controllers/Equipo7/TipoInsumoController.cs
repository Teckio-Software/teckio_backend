...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno45Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno38Context> _TipoInsumoProceso;

        public TipoInsumoAlumno45Controller(
            TipoInsumoProceso<Alumno38Context> tipoInsumoProceso
            )
        {
