...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa35")]
    public class InsumoXContratistaAlumno45Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno45Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno45Controller(
            ILogger<InsumoXContratistaAlumno45Controller> logger,
