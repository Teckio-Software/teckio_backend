...
namespace SistemaERP.API.Controllers.Alumno44
{
    ...
    public class BancoAlumno45Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno38Context> _bancoService;

        public BancoAlumno45Controller(IBancoService<Alumno38Context> bancoService)
        {
