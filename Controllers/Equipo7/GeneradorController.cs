...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/generadores/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa35")]
    public class GeneradoresAlumno45Controller : ControllerBase
    {
        private readonly GeneradoresProceso<Alumno38Context> _GeneradoresProceso;
        public GeneradoresAlumno45Controller(
            GeneradoresProceso<Alumno38Context> generadoresProceso)
        {
