...
{
    [Route("api/insumoxcotizacion/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno45Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno38Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno45Controller> _Logger;
        private readonly CotizacionProceso<Alumno38Context> _Proceso;
        private readonly Alumno38Context Context;
        public InsumoXCotizacionAlumno45Controller(
            ILogger<InsumoXCotizacionAlumno45Controller> Logger,
            Alumno38Context Context
            , IInsumoXCotizacionService<Alumno38Context> Service
