...
namespace SistemaERP.API.Controllers.Alumno38
{
    [Route("api/indirectosXConcepto/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoAlumno38Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno38Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno38Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno38Controller(
            IIndirectosXConceptoService<Alumno38Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno38Context> indirectosXConceptoProceso
            ) { 
