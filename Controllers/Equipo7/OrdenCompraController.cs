...
{
    [Route("api/ordencompra/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno45Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno38Context> _Service;
        private readonly OrdenCompraProceso<Alumno38Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno45Controller> _Logger;
        private readonly Alumno38Context Context;
        public OrdenCompraAlumno45Controller(
            ILogger<OrdenCompraAlumno45Controller> Logger
            , Alumno38Context Context
            , IOrdenCompraService<Alumno38Context> Service
