...
namespace SistemaERP.API.Alumno45Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialidad/45")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa35")]
    public class EspecialidadAlumno45Controller : ControllerBase
    {
        private readonly EspecialidadProceso<Alumno38Context> _EspecialidadProceso;
        public EspecialidadAlumno45Controller(
            EspecialidadProceso<Alumno38Context> especialidadProceso)
        {
