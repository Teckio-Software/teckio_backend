...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/21")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL21Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL21Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL21Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL21Controller(
            ILogger<ContratistaDemoTeckioAL21Controller> logger,
            DemoTeckioAL21Context context
            , IContratistaService<DemoTeckioAL21Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL21Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
