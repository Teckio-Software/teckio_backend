...
namespace ERP_TECKIO.Controllers.DemoTeckioAL21
{
    ...
    [Route("api/insumoXproduccion/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL21Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL21Context> proces)
        {
            _proceso = proces;
        }
