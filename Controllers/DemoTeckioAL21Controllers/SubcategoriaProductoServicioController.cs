...
namespace ERP_TECKIO.Controllers.DemoTeckioAL21
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL21Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL21Context> service)
        {
            _service = service;
        }
