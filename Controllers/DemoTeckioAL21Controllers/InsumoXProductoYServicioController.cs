...
namespace ERP_TECKIO.Controllers.DemoTeckioAL21
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/21")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL21Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL21Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL21Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL21Context> process)
        {
            _service = service;
            _process = process;
        }
