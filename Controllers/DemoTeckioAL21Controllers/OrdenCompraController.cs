...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL21Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL21Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL21Controller> _Logger;
        private readonly DemoTeckioAL21Context Context;
        private readonly PolizaProceso<DemoTeckioAL21Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL21Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL21Controller(
            ILogger<OrdenCompraDemoTeckioAL21Controller> Logger
            , DemoTeckioAL21Context Context
            , IOrdenCompraService<DemoTeckioAL21Context> Service
            , OrdenCompraProceso<DemoTeckioAL21Context> Proceso
            , PolizaProceso<DemoTeckioAL21Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL21Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
