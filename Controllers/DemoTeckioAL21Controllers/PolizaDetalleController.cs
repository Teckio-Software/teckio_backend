...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDetalleDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<DemoTeckioAL21Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL21Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleDemoTeckioAL21Controller> _Logger;
        private readonly DemoTeckioAL21Context _Context;
        public PolizaDetalleDemoTeckioAL21Controller(
            ILogger<PolizaDetalleDemoTeckioAL21Controller> logger
            , DemoTeckioAL21Context context
            , IPolizaDetalleService<DemoTeckioAL21Context> service
