...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL21Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL21Controller(
            ConceptoProceso<DemoTeckioAL21Context> conceptoProceso)
        {
