...
{
    [Route("api/factura/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL21Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL21Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL21Controller(
            ObtenFacturaProceso<DemoTeckioAL21Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL21Context> categoriaProductoYServicioService
            )
        {
