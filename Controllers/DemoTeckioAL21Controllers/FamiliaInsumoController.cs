...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL21Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL21Controller(
            FamiliaInsumoProceso<DemoTeckioAL21Context> familiaInsumoProceso)
        {
