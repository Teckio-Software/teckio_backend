...
namespace SistemaERP.API.DemoTeckioAL21Controllers.Procomi
{
    [Route("api/preciounitariodetalle/21")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL21Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL21Controller(
