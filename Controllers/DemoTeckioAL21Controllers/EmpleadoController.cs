...
{
    [Route("api/empleado/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL21Context> _empleadoService;
        public EmpleadoDemoTeckioAL21Controller(
            IEmpleadoService<DemoTeckioAL21Context> empleadoService
            )
        {
