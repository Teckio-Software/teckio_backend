...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL21Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL21Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL21Controller(
            GeneradoresProceso<DemoTeckioAL21Context> generadoresProceso)
        {
