...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL21Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL21Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL21Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL21Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL21Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL21Controller> logger,
            DemoTeckioAL21Context context
            , IAlmacenSalidaService<DemoTeckioAL21Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL21Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL21Context> Proceso
            )
        {
