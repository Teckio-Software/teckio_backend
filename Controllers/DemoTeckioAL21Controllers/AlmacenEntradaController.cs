...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL21Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL21Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL21Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL21Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL21Controller(
            ILogger<AlmacenEntradaDemoTeckioAL21Controller> logger,
            DemoTeckioAL21Context context
            , IAlmacenEntradaService<DemoTeckioAL21Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL21Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL21Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
