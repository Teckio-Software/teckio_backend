...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL21Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL21Context> _almacenProceso;
        public AlmacenDemoTeckioAL21Controller(
            IAlmacenService<DemoTeckioAL21Context> almacenServicio, AlmacenProceso<DemoTeckioAL21Context> almacenProceso)
        {
