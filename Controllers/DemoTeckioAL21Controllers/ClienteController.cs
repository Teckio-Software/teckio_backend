...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL21Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL21Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL21Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL21Controller(
            IClientesService<DemoTeckioAL21Context> service
            , ClienteProceso<DemoTeckioAL21Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL21Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
