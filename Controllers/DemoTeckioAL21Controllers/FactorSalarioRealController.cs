...
namespace ERP_TECKIO.Controllers.DemoTeckioAL21
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL21Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL21Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL21Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL21Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL21Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL21Context> porcentajeCesantiaEdadService
            )
        {
