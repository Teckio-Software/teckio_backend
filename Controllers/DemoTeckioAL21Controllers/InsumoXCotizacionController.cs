...
{
    [Route("api/insumoxcotizacion/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL21Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL21Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL21Context> _Proceso;
        private readonly DemoTeckioAL21Context Context;
        public InsumoXCotizacionDemoTeckioAL21Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL21Controller> Logger,
            DemoTeckioAL21Context Context
            , IInsumoXCotizacionService<DemoTeckioAL21Context> Service
