...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL21Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL21Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL21Controller(
            ILogger<TipoPolizaDemoTeckioAL21Controller> logger,
            DemoTeckioAL21Context context
            , ITipoPolizaService<DemoTeckioAL21Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
