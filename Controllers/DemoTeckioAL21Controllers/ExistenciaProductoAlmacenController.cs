...
namespace ERP_TECKIO.Controllers.DemoTeckioAL21
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL21Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL21Context> proces)
        {
            _proceso = proces;
        }
