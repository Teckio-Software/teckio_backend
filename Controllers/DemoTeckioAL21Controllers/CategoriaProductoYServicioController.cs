...
namespace ERP_TECKIO.Controllers.DemoTeckioAL21
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL21Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL21Context> service)
        {
            _service = service;
        }
