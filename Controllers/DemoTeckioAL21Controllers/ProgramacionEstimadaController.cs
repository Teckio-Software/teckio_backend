...
{
    [Route("api/programacionestimada/21")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL21Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL21Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL21Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL21Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL21Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL21Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL21Context> precioUnitarioService,
