...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioAL21Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL21Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL21Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL21Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL21Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL21Controller(
            PrecioUnitarioProceso<DemoTeckioAL21Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL21Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL21Context> options,
            ExplocionInsumosProceso<DemoTeckioAL21Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL21Context(_Options.Options))
            {
