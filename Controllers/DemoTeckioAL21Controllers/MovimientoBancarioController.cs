...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/21")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL21Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL21Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL21Controller(
            MovimientoBancarioProceso<DemoTeckioAL21Context> movimientoBancarioProceso
            )
        {
