...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoDemoTeckioAL21Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoDemoTeckioAL21Controller(
            ILogger<ExplosionInsumoDemoTeckioAL21Controller> Logger,
