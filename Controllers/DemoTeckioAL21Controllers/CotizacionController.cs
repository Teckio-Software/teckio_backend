...
{
    [Route("api/cotizacion/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL21Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL21Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL21Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL21Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL21Controller> _Logger;
        private readonly DemoTeckioAL21Context Context;
        public CotizacionDemoTeckioAL21Controller(

            ILogger<CotizacionDemoTeckioAL21Controller> Logger
            , DemoTeckioAL21Context Context
            , ICotizacionService<DemoTeckioAL21Context> Service
            , IOrdenCompraService<DemoTeckioAL21Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL21Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL21Context> Proceso)
        {
            _Logger = Logger;
