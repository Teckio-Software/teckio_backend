...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL21Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL21Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL21Controller(
            IIndirectosXConceptoService<DemoTeckioAL21Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL21Context> indirectosXConceptoProceso
            ) { 
