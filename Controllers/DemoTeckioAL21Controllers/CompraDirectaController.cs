...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL21Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL21Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL21Controller(
            ILogger<CompraDirectaDemoTeckioAL21Controller> logger,
            DemoTeckioAL21Context context
            , ICompraDirectaService<DemoTeckioAL21Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
