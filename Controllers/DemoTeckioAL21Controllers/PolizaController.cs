...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL21Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL21Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL21Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL21Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL21Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL21Controller> _Logger;
        private readonly DemoTeckioAL21Context _Context;
        private readonly PolizaProceso<DemoTeckioAL21Context> _polizaProceso;
        public PolizaDemoTeckioAL21Controller(
            ILogger<PolizaDemoTeckioAL21Controller> logger
            , DemoTeckioAL21Context context
            , IPolizaService<DemoTeckioAL21Context> service
            , IPolizaDetalleService<DemoTeckioAL21Context> detalleService
            , ITipoPolizaService<DemoTeckioAL21Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL21Context> saldosService
            , ICuentaContableService<DemoTeckioAL21Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL21Context> polizaProceso
            )
        {
