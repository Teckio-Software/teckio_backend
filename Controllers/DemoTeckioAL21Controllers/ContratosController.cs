...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL21Context> _contratosProceso;
        public ContratosDemoTeckioAL21Controller(
            ContratosProceso<DemoTeckioAL21Context> contratosProceso
            )
        {
