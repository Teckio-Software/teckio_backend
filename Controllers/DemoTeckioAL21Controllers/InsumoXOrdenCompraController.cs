...
{
    [Route("api/insumoxordencompra/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL21Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL21Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL21Controller> _Logger;
        private readonly DemoTeckioAL21Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL21Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL21Controller> Logger,
            DemoTeckioAL21Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL21Context> Service
