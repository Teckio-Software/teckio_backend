...
namespace ERP_TECKIO.Controllers.DemoTeckioAL21
{
    ...
    [Route("api/produccion/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL21Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL21Context> proceso)
        {
            _proceso = proceso;
        }
