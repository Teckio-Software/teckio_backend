...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL21Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL21Controller(
            ProyectoProceso<DemoTeckioAL21Context> proyectoProceso)
        {
