...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL21Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL21Controller> Logger;
        ...
        public RubroDemoTeckioAL21Controller(
            ILogger<RubroDemoTeckioAL21Controller> logger,
            DemoTeckioAL21Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL21Context> service
            )
        {
            //_Service = service;
            Logger = logger;
