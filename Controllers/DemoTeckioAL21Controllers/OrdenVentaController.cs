...
{
    [Route("api/ordenventa/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL21Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL21Controller(
            OrdenVentaProceso<DemoTeckioAL21Context> ordenVentaProceso
            ) { 
