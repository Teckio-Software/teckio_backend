...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL21Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL21Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL21Controller> _Logger;
        private readonly DemoTeckioAL21Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL21Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL21Controller> logger
            , DemoTeckioAL21Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL21Context> service
