...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaContableDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL21Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL21Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL21Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL21Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL21Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL21Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL21Controller(
            ILogger<CuentaContableDemoTeckioAL21Controller> logger,
            DemoTeckioAL21Context context
            , ICuentaContableService<DemoTeckioAL21Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL21Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL21Context> RubroService
            , CuentaContableProceso<DemoTeckioAL21Context> proceso
            )
        {
            Logger = logger;
            Context = context;
