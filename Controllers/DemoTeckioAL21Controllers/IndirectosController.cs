...
{
    [Route("api/indirectos/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL21Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL21Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL21Context> _indirectosProceso;

        public IndirectosDemoTeckioAL21Controller(
                        IConjuntoIndirectosService<DemoTeckioAL21Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL21Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL21Context> indirectosProceso
            )
        {
