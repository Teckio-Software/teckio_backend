...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL21Context> _InsumoProceso;
        public InsumoDemoTeckioAL21Controller(
            InsumoProceso<DemoTeckioAL21Context> insumoProceso)
        {
