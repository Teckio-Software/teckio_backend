...
{
    [Route("api/entradaproduccionalmacen/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL21Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL21Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL21Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL21Context> proceso)
        {
            _proceso = proceso;
        }
