...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL21Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL21Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL21Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL21Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL21Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL21Controller(
            ILogger<RequisicionDemoTeckioAL21Controller> Logger
            , DemoTeckioAL21Context Context
            , IRequisicionService<DemoTeckioAL21Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL21Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL21Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL21Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/21/970"))
            {
