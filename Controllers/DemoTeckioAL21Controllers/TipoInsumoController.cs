...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL21Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL21Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL21Controller(
            TipoInsumoProceso<DemoTeckioAL21Context> tipoInsumoProceso
            )
        {
