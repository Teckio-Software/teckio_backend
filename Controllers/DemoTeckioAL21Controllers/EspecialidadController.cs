...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL21Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL21Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL21Controller(
            EspecialidadProceso<DemoTeckioAL21Context> especialidadProceso)
        {
