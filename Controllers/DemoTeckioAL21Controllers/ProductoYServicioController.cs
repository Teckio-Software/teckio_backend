...
{
    [Route("api/productoyservicio/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL21Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL21Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL21Context> _process;

        public ProductoYServicioDemoTeckioAL21Controller(IProductoYservicioService<DemoTeckioAL21Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL21Context> process
            )
        {
