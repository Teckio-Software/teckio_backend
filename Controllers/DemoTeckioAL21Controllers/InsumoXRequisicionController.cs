...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL21Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL21Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL21Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL21Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL21Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL21Controller> Logger,
            RequisicionProceso<DemoTeckioAL21Context> Proceso,
            DemoTeckioAL21Context Context
            , IInsumoXRequisicionService<DemoTeckioAL21Context> Service)
        {
            _Logger = Logger;
