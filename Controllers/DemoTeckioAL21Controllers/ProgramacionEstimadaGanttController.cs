...
namespace SistemaERP.API.Controllers.DemoTeckioAL21
{
    [Route("api/programacionestimadaGantt/21")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL21Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL21Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL21Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL21Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL21Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL21Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL21Context> importeSemanalGanttProceso,
