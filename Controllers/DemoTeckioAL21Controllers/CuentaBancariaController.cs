...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/21")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL21Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL21Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL21Context> _servicio;
        public CuentaBancariaDemoTeckioAL21Controller(CuentaBancariaProceso<DemoTeckioAL21Context> _proceso, ICuentaBancariaService<DemoTeckioAL21Context> _servicio
           )
        {
