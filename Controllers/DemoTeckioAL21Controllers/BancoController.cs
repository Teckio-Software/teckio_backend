...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL21Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL21Context> _bancoService;

        public BancoDemoTeckioAL21Controller(IBancoService<DemoTeckioAL21Context> bancoService)
        {
