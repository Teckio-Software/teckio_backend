...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL24Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL24Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL24Controller> _Logger;
        ...
        public OrdenCompraDemoTeckioAL24Controller(
            ILogger<OrdenCompraDemoTeckioAL24Controller> Logger
            , DemoTeckioAL24Context Context
            , IOrdenCompraService<DemoTeckioAL24Context> Service
