...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/24")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL24Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL24Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL24Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL24Controller(
            ILogger<ContratistaDemoTeckioAL24Controller> logger,
            DemoTeckioAL24Context context
            , IContratistaService<DemoTeckioAL24Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL24Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
