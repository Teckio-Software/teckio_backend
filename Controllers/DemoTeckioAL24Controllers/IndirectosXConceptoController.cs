...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL24Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL24Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL24Controller(
            IIndirectosXConceptoService<DemoTeckioAL24Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL24Context> indirectosXConceptoProceso
            ) { 
