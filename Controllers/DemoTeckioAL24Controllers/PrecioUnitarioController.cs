...
{
    [Route("api/preciounitario/24")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL24Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL24Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL24Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL24Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL24Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL24Controller(
            PrecioUnitarioProceso<DemoTeckioAL24Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL24Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL24Context> options,
            ExplocionInsumosProceso<DemoTeckioAL24Context> explocionInsumosProceso
            )
        {
