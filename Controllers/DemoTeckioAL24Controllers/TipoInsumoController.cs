...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL24Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL24Controller(
            TipoInsumoProceso<DemoTeckioAL24Context> tipoInsumoProceso
            )
        {
