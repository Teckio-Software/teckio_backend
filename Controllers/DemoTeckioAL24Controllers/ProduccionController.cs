...
namespace ERP_TECKIO.Controllers.DemoTeckioAL24
{
    ...
    [Route("api/produccion/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL24Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL24Context> proceso)
        {
            _proceso = proceso;
        }
