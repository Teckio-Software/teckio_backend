...
namespace ERP_TECKIO.Controllers.DemoTeckioAL24
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL24Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL24Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL24Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL24Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL24Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL24Context> porcentajeCesantiaEdadService
            )
        {
