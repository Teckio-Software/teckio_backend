...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL24Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL24Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL24Controller> _Logger;
        private readonly DemoTeckioAL24Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL24Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL24Controller> logger
            , DemoTeckioAL24Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL24Context> service
