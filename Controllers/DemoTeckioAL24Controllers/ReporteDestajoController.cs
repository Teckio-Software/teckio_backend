...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL24Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL24Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL24Controller(
            ReporteDestajoProceso<DemoTeckioAL24Context> proceso,
