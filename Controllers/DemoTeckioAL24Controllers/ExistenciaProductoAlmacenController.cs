...
namespace ERP_TECKIO.Controllers.DemoTeckioAL24
{
    ...
    [Route("api/existenciaproductoalmacen/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL24Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL24Context> proces)
        {
            _proceso = proces;
        }
