...
{
    [Route("api/ordenventa/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL24Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL24Controller(
            OrdenVentaProceso<DemoTeckioAL24Context> ordenVentaProceso
            ) { 
