...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL24Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL24Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL24Controller(
            ILogger<TipoPolizaDemoTeckioAL24Controller> logger,
            DemoTeckioAL24Context context
            , ITipoPolizaService<DemoTeckioAL24Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
