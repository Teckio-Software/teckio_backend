...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL24Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL24Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL24Controller(
            GeneradoresProceso<DemoTeckioAL24Context> generadoresProceso)
        {
