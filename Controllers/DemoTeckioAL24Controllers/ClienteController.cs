...
{
    [Route("api/cliente/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL24Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL24Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL24Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL24Controller(
            IClientesService<DemoTeckioAL24Context> service
            , ClienteProceso<DemoTeckioAL24Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL24Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
