...
{
    [Route("api/cotizacion/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL24Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL24Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL24Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL24Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL24Controller> _Logger;
        private readonly DemoTeckioAL24Context Context;
        public CotizacionDemoTeckioAL24Controller(

            ILogger<CotizacionDemoTeckioAL24Controller> Logger
            , DemoTeckioAL24Context Context
            , ICotizacionService<DemoTeckioAL24Context> Service
            , IOrdenCompraService<DemoTeckioAL24Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL24Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL24Context> Proceso)
        {
            _Logger = Logger;
