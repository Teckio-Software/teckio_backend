...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL24Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL24Context> _servicio;
        public CuentaBancariaDemoTeckioAL24Controller(CuentaBancariaProceso<DemoTeckioAL24Context> _proceso, ICuentaBancariaService<DemoTeckioAL24Context> _servicio
           )
        {
