...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoDemoTeckioAL24Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoDemoTeckioAL24Controller(
            ILogger<ExplosionInsumoDemoTeckioAL24Controller> Logger,
