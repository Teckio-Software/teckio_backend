...
{
    [Route("api/empleado/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL24Context> _empleadoService;
        public EmpleadoDemoTeckioAL24Controller(
            IEmpleadoService<DemoTeckioAL24Context> empleadoService
            )
        {
