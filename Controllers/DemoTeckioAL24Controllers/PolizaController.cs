...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL24Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL24Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL24Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL24Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL24Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL24Controller> _Logger;
        private readonly DemoTeckioAL24Context _Context;
        private readonly PolizaProceso<DemoTeckioAL24Context> _polizaProceso;
        public PolizaDemoTeckioAL24Controller(
            ILogger<PolizaDemoTeckioAL24Controller> logger
            , DemoTeckioAL24Context context
            , IPolizaService<DemoTeckioAL24Context> service
            , IPolizaDetalleService<DemoTeckioAL24Context> detalleService
            , ITipoPolizaService<DemoTeckioAL24Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL24Context> saldosService
            , ICuentaContableService<DemoTeckioAL24Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL24Context> polizaProceso
            )
        {
