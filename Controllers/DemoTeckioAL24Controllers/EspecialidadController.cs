...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL24Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL24Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL24Controller(
            EspecialidadProceso<DemoTeckioAL24Context> especialidadProceso)
        {
