...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL24Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL24Controller(
            FamiliaInsumoProceso<DemoTeckioAL24Context> familiaInsumoProceso)
        {
