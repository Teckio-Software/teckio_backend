...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL24Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL24Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL24Controller(
            ILogger<CompraDirectaDemoTeckioAL24Controller> logger,
            DemoTeckioAL24Context context
            , ICompraDirectaService<DemoTeckioAL24Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
