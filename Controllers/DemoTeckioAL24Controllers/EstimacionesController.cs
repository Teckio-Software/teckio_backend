...
{
    [Route("api/estimaciones/24")]
    [ApiController]
    public class EstimacionesDemoTeckioAL24Controller : ControllerBase
    {
        private readonly EstimacionesProceso<DemoTeckioAL24Context> _estimacionesProceso;
        public EstimacionesDemoTeckioAL24Controller(
            EstimacionesProceso<DemoTeckioAL24Context> estimacionesProceso
            )
        {
