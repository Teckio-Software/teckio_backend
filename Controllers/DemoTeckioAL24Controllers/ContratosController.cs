...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL24Context> _contratosProceso;
        public ContratosDemoTeckioAL24Controller(
            ContratosProceso<DemoTeckioAL24Context> contratosProceso
            )
        {
