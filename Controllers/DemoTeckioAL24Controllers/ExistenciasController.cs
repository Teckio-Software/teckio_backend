...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL24Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL24Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL24Controller(
            ILogger<ExistenciasDemoTeckioAL24Controller> Logger,
            DemoTeckioAL24Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL24Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL24Context> Proceso
            )
        {
            _Logger = Logger;
