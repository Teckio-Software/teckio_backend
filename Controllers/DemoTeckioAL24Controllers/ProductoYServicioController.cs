...
{
    [Route("api/productoyservicio/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL24Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL24Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL24Context> _process;

        public ProductoYServicioDemoTeckioAL24Controller(IProductoYservicioService<DemoTeckioAL24Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL24Context> process
            )
        {
