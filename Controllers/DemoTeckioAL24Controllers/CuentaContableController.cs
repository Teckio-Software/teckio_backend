...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL24Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL24Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL24Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL24Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL24Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL24Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL24Controller(
            ILogger<CuentaContableDemoTeckioAL24Controller> logger,
            DemoTeckioAL24Context context
            , ICuentaContableService<DemoTeckioAL24Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL24Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL24Context> RubroService
            , CuentaContableProceso<DemoTeckioAL24Context> proceso
            )
        {
            Logger = logger;
            Context = context;
