...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL24Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL24Context> _bancoService;

        public BancoDemoTeckioAL24Controller(IBancoService<DemoTeckioAL24Context> bancoService)
        {
