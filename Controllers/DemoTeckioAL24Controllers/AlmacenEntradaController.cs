...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL24Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL24Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL24Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL24Controller(
            ILogger<AlmacenEntradaDemoTeckioAL24Controller> logger,
            DemoTeckioAL24Context context
            , IAlmacenEntradaService<DemoTeckioAL24Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL24Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL24Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
