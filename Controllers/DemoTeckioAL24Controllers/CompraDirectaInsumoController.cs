...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL24Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL24Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL24Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL24Controller> logger
            , DemoTeckioAL24Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL24Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
