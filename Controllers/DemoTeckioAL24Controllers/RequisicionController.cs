...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL24Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL24Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL24Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL24Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL24Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL24Controller(
            ILogger<RequisicionDemoTeckioAL24Controller> Logger
            , DemoTeckioAL24Context Context
            , IRequisicionService<DemoTeckioAL24Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL24Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL24Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL24Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/24/970"))
            {
