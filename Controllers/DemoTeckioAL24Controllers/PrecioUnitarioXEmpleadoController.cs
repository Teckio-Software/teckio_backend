...
namespace ERP_TECKIO.Controllers.DemoTeckioAL24
{
    ...
    public class PrecioUnitarioXEmpleadoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL24Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL24Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL24Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL24Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL24Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
