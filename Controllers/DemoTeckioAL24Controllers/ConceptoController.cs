...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL24Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL24Controller(
            ConceptoProceso<DemoTeckioAL24Context> conceptoProceso)
        {
