...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL24Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL24Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL24Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL24Controller> Logger,
            RequisicionProceso<DemoTeckioAL24Context> Proceso,
            DemoTeckioAL24Context Context
            , IInsumoXRequisicionService<DemoTeckioAL24Context> Service)
        {
            _Logger = Logger;
