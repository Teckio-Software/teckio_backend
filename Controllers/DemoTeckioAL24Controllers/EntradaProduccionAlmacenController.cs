...
{
    [Route("api/entradaproduccionalmacen/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL24Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL24Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL24Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL24Context> proceso)
        {
            _proceso = proceso;
        }
