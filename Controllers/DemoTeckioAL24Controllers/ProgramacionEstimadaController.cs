...
{
    [Route("api/programacionestimada/24")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL24Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL24Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL24Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL24Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL24Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL24Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL24Context> precioUnitarioService,
