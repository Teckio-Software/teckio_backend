...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL24Context> _InsumoProceso;
        public InsumoDemoTeckioAL24Controller(
            InsumoProceso<DemoTeckioAL24Context> insumoProceso)
        {
