...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL24Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL24Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL24Controller(
            ProyectoProceso<DemoTeckioAL24Context> proyectoProceso)
        {
