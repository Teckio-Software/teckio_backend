...
namespace SistemaERP.API.DemoTeckioAL24Controllers.Procomi
{
    [Route("api/preciounitariodetalle/24")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL24Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL24Controller(
