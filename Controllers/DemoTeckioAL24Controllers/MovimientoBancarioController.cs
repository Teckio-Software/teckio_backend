...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/24")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL24Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL24Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL24Controller(
            MovimientoBancarioProceso<DemoTeckioAL24Context> movimientoBancarioProceso
            )
        {
