...
namespace ERP_TECKIO.Controllers.DemoTeckioAL24
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/24")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL24Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL24Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL24Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL24Context> process)
        {
            _service = service;
            _process = process;
        }
