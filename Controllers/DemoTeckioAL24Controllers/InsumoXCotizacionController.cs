...
{
    [Route("api/insumoxcotizacion/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL24Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL24Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL24Context> _Proceso;
        private readonly DemoTeckioAL24Context Context;
        public InsumoXCotizacionDemoTeckioAL24Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL24Controller> Logger,
            DemoTeckioAL24Context Context
            , IInsumoXCotizacionService<DemoTeckioAL24Context> Service
