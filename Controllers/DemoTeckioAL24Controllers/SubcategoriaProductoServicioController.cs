...
namespace ERP_TECKIO.Controllers.DemoTeckioAL24
{
    ...
    [Route("api/subcategoriaProductoServicio/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL24Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL24Context> service)
        {
            _service = service;
        }
