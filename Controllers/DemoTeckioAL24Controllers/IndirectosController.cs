...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL24Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL24Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL24Context> _indirectosProceso;

        public IndirectosDemoTeckioAL24Controller(
                        IConjuntoIndirectosService<DemoTeckioAL24Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL24Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL24Context> indirectosProceso
            )
        {
