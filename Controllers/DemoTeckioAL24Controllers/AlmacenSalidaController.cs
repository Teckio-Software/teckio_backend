...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/24")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL24Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL24Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL24Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL24Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL24Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL24Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL24Controller> logger,
            DemoTeckioAL24Context context
            , IAlmacenSalidaService<DemoTeckioAL24Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL24Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL24Context> Proceso
            )
        {
