...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/36")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno36Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno36Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno36Controller(
            ILogger<ContratistaCuentaBancariaAlumno36Controller> logger,
