...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno36Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno36Context> _Service;

        private readonly RequisicionProceso<Alumno36Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno36Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno36Controller(
            ILogger<InsumoXRequisicionAlumno36Controller> Logger,
            RequisicionProceso<Alumno36Context> Proceso,
            Alumno36Context Context
            , IInsumoXRequisicionService<Alumno36Context> Service)
        {
            _Logger = Logger;
