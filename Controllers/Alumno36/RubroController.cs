...
namespace ERP_TECKIO
{
    ...
    public class RubroAlumno36Controller : ControllerBase
    {
        private readonly IRubroService<Alumno36Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno36Controller> Logger;
        ...
        public RubroAlumno36Controller(
            ILogger<RubroAlumno36Controller> logger,
            Alumno36Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno36Context> service
            )
        {
            //_Service = service;
            Logger = logger;
