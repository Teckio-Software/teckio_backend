...
{
    [Route("api/insumoxordencompra/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno36Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno36Context> _Service;
        private readonly OrdenCompraProceso<Alumno36Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno36Controller> _Logger;
        private readonly Alumno36Context _Context;
        public InsumoXOrdenCompraAlumno36Controller(
            ILogger<InsumoXOrdenCompraAlumno36Controller> Logger,
            Alumno36Context Context
            , IInsumoXOrdenCompraService<Alumno36Context> Service
            , OrdenCompraProceso<Alumno36Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
