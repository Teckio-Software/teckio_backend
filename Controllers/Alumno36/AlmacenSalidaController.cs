...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno36Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno36Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno36Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno36Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno36Controller> Logger;
        ...
        public AlmacenSalidaAlumno36Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno36Controller> logger,
            Alumno36Context context
            , IAlmacenSalidaService<Alumno36Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno36Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno36Context> Proceso
            )
        {
