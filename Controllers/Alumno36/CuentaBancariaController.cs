...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno36Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno36Context> _proceso;

        private readonly ICuentaBancariaService<Alumno36Context> _servicio;
        public CuentaBancariaAlumno36Controller(CuentaBancariaProceso<Alumno36Context> _proceso, ICuentaBancariaService<Alumno36Context> _servicio
           )
        {
