...
namespace ERP_TECKIO
{
    ...
    public class InsumoAlumno36Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno36Context> _InsumoProceso;
        public InsumoAlumno36Controller(
            InsumoProceso<Alumno36Context> insumoProceso)
        {
            _InsumoProceso = insumoProceso;
        }

        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearInsumo-Empresa35")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarInsumo-Empresa35")]
        ...
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarInsumo-Empresa35")]
