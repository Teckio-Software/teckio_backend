...
{
    [Route("api/polizadetalle/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa35")]
    public class PolizaDetalleAlumno36Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno36Context> _Service;
        private readonly ICuentaContableService<Alumno36Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno36Controller> _Logger;
        private readonly Alumno36Context _Context;
        public PolizaDetalleAlumno36Controller(
            ILogger<PolizaDetalleAlumno36Controller> logger
            , Alumno36Context context
            , IPolizaDetalleService<Alumno36Context> service
