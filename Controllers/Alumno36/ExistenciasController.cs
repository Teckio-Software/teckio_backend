...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno36Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno36Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno36Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno36Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno36Controller(
            ILogger<ExistenciasAlumno36Controller> Logger,
            Alumno36Context Context
            , IAlmacenExistenciaInsumoService<Alumno36Context> ExistenciaService
            , ExistenciasProceso<Alumno36Context> Proceso
            )
        {
            _Logger = Logger;
