...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/36")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno36Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno36Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno36Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno36Controller(
            ILogger<ContratistaAlumno36Controller> logger,
            Alumno36Context context
            , IContratistaService<Alumno36Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
