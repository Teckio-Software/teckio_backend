...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialidad/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa35")]
    public class EspecialidadAlumno36Controller : ControllerBase
    {
        private readonly EspecialidadProceso<Alumno36Context> _EspecialidadProceso;
        public EspecialidadAlumno36Controller(
            EspecialidadProceso<Alumno36Context> especialidadProceso)
        {
