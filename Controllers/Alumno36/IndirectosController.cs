...
{
    [Route("api/indirectos/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno36Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno36Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno36Context> _indirectosService;
        private readonly IndirectosProceso<Alumno36Context> _indirectosProceso;

        public IndirectosAlumno36Controller(
                        IConjuntoIndirectosService<Alumno36Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno36Context> indirectosService,
                        IndirectosProceso<Alumno36Context> indirectosProceso
            )
        {
