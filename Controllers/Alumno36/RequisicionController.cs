...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno36Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno36Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno36Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno36Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno36Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno36Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno36Controller(
            ILogger<RequisicionAlumno36Controller> Logger
            , Alumno36Context Context
            , IRequisicionService<Alumno36Context> RequisicionService
            , RequisicionProceso<Alumno36Context> Proceso
            , ObjetoRequisicionProceso<Alumno36Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno36Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
