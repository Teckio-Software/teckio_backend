...
{
    [Route("api/cliente/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno36Controller : ControllerBase
    {
        private readonly IClientesService<Alumno36Context> _Service;

        private readonly ClienteProceso<Alumno36Context> _Proceso;
        public ClienteAlumno36Controller(
            IClientesService<Alumno36Context> service
            , ClienteProceso<Alumno36Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
