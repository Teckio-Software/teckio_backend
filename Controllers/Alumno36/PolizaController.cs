...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno36Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno36Context> _Service;
        private readonly IPolizaDetalleService<Alumno36Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno36Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno36Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno36Context> _SaldosService;
        private readonly ILogger<PolizaAlumno36Controller> _Logger;
        private readonly Alumno36Context _Context;
        public PolizaAlumno36Controller(
            ILogger<PolizaAlumno36Controller> logger
            , Alumno36Context context
            , IPolizaService<Alumno36Context> service
            , IPolizaDetalleService<Alumno36Context> detalleService
            , ITipoPolizaService<Alumno36Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno36Context> saldosService
