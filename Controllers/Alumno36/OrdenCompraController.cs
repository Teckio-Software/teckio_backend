...
{
    [Route("api/ordencompra/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno36Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno36Context> _Service;
        private readonly OrdenCompraProceso<Alumno36Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno36Controller> _Logger;
        private readonly Alumno36Context Context;
        public OrdenCompraAlumno36Controller(
            ILogger<OrdenCompraAlumno36Controller> Logger
            , Alumno36Context Context
            , IOrdenCompraService<Alumno36Context> Service
