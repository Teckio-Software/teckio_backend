...
namespace ERP_TECKIO.API.Alumno035Controllers.Procomi
{
    [Route("api/estimaciones/36")]
    [ApiController]
    public class EstimacionesAlumno36Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno36Context> _estimacionesProceso;
        public EstimacionesAlumno36Controller(
