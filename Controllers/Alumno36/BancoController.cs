...
namespace ERP_TECKIO.API.Controllers.Alumno36
{
    ...
    public class BancoAlumno36Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno36Context> _bancoService;

        public BancoAlumno36Controller(IBancoService<Alumno36Context> bancoService)
        {
