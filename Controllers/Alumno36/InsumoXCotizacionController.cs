...
{
    [Route("api/insumoxcotizacion/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno36Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno36Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno36Controller> _Logger;
        private readonly CotizacionProceso<Alumno36Context> _Proceso;
        private readonly Alumno36Context Context;
        public InsumoXCotizacionAlumno36Controller(
            ILogger<InsumoXCotizacionAlumno36Controller> Logger,
            Alumno36Context Context
            , IInsumoXCotizacionService<Alumno36Context> Service
