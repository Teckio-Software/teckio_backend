...
{
    [Route("api/contratos/36")]
    [ApiController]
    public class ContratosAlumno36Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno36Context> _contratosProceso;
        public ContratosAlumno36Controller(
            ContratosProceso<Alumno36Context> contratosProceso
            )
        {
