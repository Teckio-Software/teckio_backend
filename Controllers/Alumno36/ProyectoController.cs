...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/proyecto/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno36Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno36Context> _ProyectoProceso;
        public ProyectoAlumno36Controller(
            ProyectoProceso<Alumno36Context> proyectoProceso)
        {
