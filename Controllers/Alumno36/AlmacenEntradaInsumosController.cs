...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno36Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno36Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno36Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno36Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno36Controller(
            ILogger<AlmacenEntradaInsumoAlumno36Controller> logger,
            Alumno36Context context
            , IInsumoXAlmacenEntradaService<Alumno36Context> AlmacenEntradaDetalle
