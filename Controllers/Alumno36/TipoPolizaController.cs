...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno36Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno36Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno36Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno36Controller(
            ILogger<TipoPolizaAlumno36Controller> logger,
            Alumno36Context context
            , ITipoPolizaService<Alumno36Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
