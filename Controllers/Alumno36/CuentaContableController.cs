...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno36Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno36Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno36Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno36Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno36Controller(
            ILogger<CuentaContableAlumno36Controller> logger,
            Alumno36Context context
            , ICuentaContableService<Alumno36Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno36Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
