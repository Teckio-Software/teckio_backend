...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno36Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno36Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno36Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno36Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno36Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno36Controller(
            ILogger<AlmacenEntradaAlumno36Controller> logger,
            Alumno36Context context
            , IAlmacenEntradaService<Alumno36Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno36Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno36Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
