...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno36Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno36Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno36Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno36Controller(
            ILogger<CompraDirectaInsumoAlumno36Controller> logger
            , Alumno36Context context
            , IInsumoXCompraDirectaService<Alumno36Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
