...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno36Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno36Context> _TipoInsumoProceso;

        public TipoInsumoAlumno36Controller(
            TipoInsumoProceso<Alumno36Context> tipoInsumoProceso
            )
        {
