...
{
    [Route("api/cotizacion/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno36Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno36Context> _Service;
        private readonly CotizacionProceso<Alumno36Context> _Proceso;
        private readonly IOrdenCompraService<Alumno36Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno36Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno36Controller> _Logger;
        private readonly Alumno36Context Context;
        public CotizacionAlumno36Controller(

            ILogger<CotizacionAlumno36Controller> Logger
            , Alumno36Context Context
            , ICotizacionService<Alumno36Context> Service
            , IOrdenCompraService<Alumno36Context> OrdenCompraService,
              ITipoImpuestoService<Alumno36Context> TipoImpuestoService
            , CotizacionProceso<Alumno36Context> Proceso)
        {
            _Logger = Logger;
