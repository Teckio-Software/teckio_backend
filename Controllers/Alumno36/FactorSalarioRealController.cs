...
namespace ERP_TECKIO.Controllers.Alumno36
{
    [Route("api/fsr/36")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno36Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno36Context> factorSalarioRealProceso)
        {
