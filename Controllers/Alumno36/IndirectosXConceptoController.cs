...
{
    [Route("api/indirectosXConcepto/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoAlumno36Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno36Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno36Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno36Controller(
            IIndirectosXConceptoService<Alumno36Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno36Context> indirectosXConceptoProceso
            ) { 
