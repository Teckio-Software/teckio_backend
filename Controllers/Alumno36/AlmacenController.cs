...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno36Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno36Context> _almacenServicio;

        public AlmacenAlumno36Controller(
            IAlmacenService<Alumno36Context> almacenServicio)
        {
