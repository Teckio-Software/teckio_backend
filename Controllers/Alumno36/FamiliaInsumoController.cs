...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/36")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno36Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno36Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno36Controller(
            FamiliaInsumoProceso<Alumno36Context> familiaInsumoProceso)
        {
