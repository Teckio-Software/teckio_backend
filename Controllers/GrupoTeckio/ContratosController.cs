...
{
    [Route("api/contratos/2")]
    [ApiController]
    public class ContratosGrupoTeckioController : ControllerBase
    {
        private readonly ContratosProceso<GrupoTeckioContext> _contratosProceso;
        public ContratosGrupoTeckioController(
            ContratosProceso<GrupoTeckioContext> contratosProceso
            )
        {
