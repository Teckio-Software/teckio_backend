...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/2")]
    [ApiController]
    public class MovimientoBancarioGrupoTeckioController : ControllerBase
    {
        private readonly MovimientoBancarioProceso<GrupoTeckioContext> _movimientoBancarioProceso;
        public MovimientoBancarioGrupoTeckioController(
            MovimientoBancarioProceso<GrupoTeckioContext> movimientoBancarioProceso
            )
        {
