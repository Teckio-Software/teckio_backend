...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoGrupoTeckioController : ControllerBase
    {
        private readonly FamiliaInsumoProceso<GrupoTeckioContext> _FamiliaInsumoProceso;
        public FamiliaInsumoGrupoTeckioController(
            FamiliaInsumoProceso<GrupoTeckioContext> familiaInsumoProceso)
        {
