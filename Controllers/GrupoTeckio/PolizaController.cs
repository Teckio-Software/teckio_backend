...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaGrupoTeckioController : ControllerBase
    {
        private readonly IPolizaService<GrupoTeckioContext> _Service;
        private readonly IPolizaDetalleService<GrupoTeckioContext> _DetalleService;
        private readonly ITipoPolizaService<GrupoTeckioContext> _TipoPolizaService;
        private readonly ICuentaContableService<GrupoTeckioContext> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<GrupoTeckioContext> _SaldosService;
        private readonly ILogger<PolizaGrupoTeckioController> _Logger;
        private readonly GrupoTeckioContext _Context;
        private readonly PolizaProceso<GrupoTeckioContext> _polizaProceso;
        public PolizaGrupoTeckioController(
            ILogger<PolizaGrupoTeckioController> logger
            , GrupoTeckioContext context
            , IPolizaService<GrupoTeckioContext> service
            , IPolizaDetalleService<GrupoTeckioContext> detalleService
            , ITipoPolizaService<GrupoTeckioContext> tipoPolizaService
            , ISaldosBalanzaComprobacionService<GrupoTeckioContext> saldosService
            , ICuentaContableService<GrupoTeckioContext> cuentaContableService
            , PolizaProceso<GrupoTeckioContext> polizaProceso
            )
        {
