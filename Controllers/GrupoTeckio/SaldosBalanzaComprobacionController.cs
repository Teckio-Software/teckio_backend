...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionGrupoTeckioController : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<GrupoTeckioContext> _Service;
        private readonly ICuentaContableService<GrupoTeckioContext> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionGrupoTeckioController> _Logger;
        private readonly GrupoTeckioContext _Context;
        public SaldosBalanzaComprobacionGrupoTeckioController(
            ILogger<SaldosBalanzaComprobacionGrupoTeckioController> logger
            , GrupoTeckioContext context
            , ISaldosBalanzaComprobacionService<GrupoTeckioContext> service
