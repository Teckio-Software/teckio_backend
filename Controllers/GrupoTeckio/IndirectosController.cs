...
{
    [Route("api/indirectos/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosGrupoTeckioController : ControllerBase
    {
        private readonly IConjuntoIndirectosService<GrupoTeckioContext> _conjuntoIndirectosService;
        private readonly IIndirectosService<GrupoTeckioContext> _indirectosService;
        private readonly IndirectosProceso<GrupoTeckioContext> _indirectosProceso;

        public IndirectosGrupoTeckioController(
                        IConjuntoIndirectosService<GrupoTeckioContext> conjuntoIndirectosService,
                        IIndirectosService<GrupoTeckioContext> indirectosService,
                        IndirectosProceso<GrupoTeckioContext> indirectosProceso
            )
        {
