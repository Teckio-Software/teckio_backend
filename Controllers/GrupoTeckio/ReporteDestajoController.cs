...
{
    [Route("api/reportesdestajo/2")]
    [ApiController]
    public class ReporteDestajoGrupoTeckioController : ControllerBase
    {
        private readonly ReporteDestajoProceso<GrupoTeckioContext> _proceso;
        private readonly EstimacionesProceso<GrupoTeckioContext> _estimacionesProceso;

        public ReporteDestajoGrupoTeckioController(
            ReporteDestajoProceso<GrupoTeckioContext> proceso,
            EstimacionesProceso<GrupoTeckioContext> estimacionesProceso
            ) { 
            _proceso = proceso;
