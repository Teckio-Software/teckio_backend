...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroGrupoTeckioController : ControllerBase
    {
        private readonly IRubroService<GrupoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroGrupoTeckioController> Logger;
        ...
        public RubroGrupoTeckioController(
            ILogger<RubroGrupoTeckioController> logger,
            GrupoTeckioContext context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<GrupoTeckioContext> service
            )
        {
            //_Service = service;
            Logger = logger;
