...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoGrupoTeckioController : ControllerBase 
    {
        private readonly IBancoService<GrupoTeckioContext> _bancoService;

        public BancoGrupoTeckioController(IBancoService<GrupoTeckioContext> bancoService)
        {
