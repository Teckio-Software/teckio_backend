...
namespace SistemaERP.API.GrupoTeckioControllers.Procomi
{
    [Route("api/preciounitariodetalle/2")]
    [ApiController]
    public class PrecioUnitarioDetalleGrupoTeckioController : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleGrupoTeckioController(
