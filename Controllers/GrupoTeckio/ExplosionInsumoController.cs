...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoGrupoTeckioController : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoGrupoTeckioController> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoGrupoTeckioController(
            ILogger<ExplosionInsumoGrupoTeckioController> Logger,
