...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaGrupoTeckioController : ControllerBase
    {
        private readonly ITipoPolizaService<GrupoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaGrupoTeckioController> Logger;
        /// <summary>
        ...
        public TipoPolizaGrupoTeckioController(
            ILogger<TipoPolizaGrupoTeckioController> logger,
            GrupoTeckioContext context
            , ITipoPolizaService<GrupoTeckioContext> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
