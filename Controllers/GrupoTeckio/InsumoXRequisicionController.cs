...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionGrupoTeckioController : ControllerBase
    {
        private readonly IInsumoXRequisicionService<GrupoTeckioContext> _Service;

        private readonly RequisicionProceso<GrupoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionGrupoTeckioController> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionGrupoTeckioController(
            ILogger<InsumoXRequisicionGrupoTeckioController> Logger,
            RequisicionProceso<GrupoTeckioContext> Proceso,
            GrupoTeckioContext Context
            , IInsumoXRequisicionService<GrupoTeckioContext> Service)
        {
            _Logger = Logger;
