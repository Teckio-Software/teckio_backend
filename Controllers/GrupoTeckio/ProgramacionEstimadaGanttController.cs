...
namespace SistemaERP.API.Controllers.GrupoTeckio
{
    [Route("api/programacionestimadaGantt/2")]
    [ApiController]
    public class ProgramacionEstimadaGanttGrupoTeckioController : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<GrupoTeckioContext> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<GrupoTeckioContext> _Options;
        private readonly ImporteSemanalGanttProceso<GrupoTeckioContext> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttGrupoTeckioController(
            ProgramacionEstimadaGanttProceso<GrupoTeckioContext> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<GrupoTeckioContext> importeSemanalGanttProceso,
