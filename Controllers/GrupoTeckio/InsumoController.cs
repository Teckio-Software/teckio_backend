...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoGrupoTeckioController : ControllerBase
    {
        private readonly InsumoProceso<GrupoTeckioContext> _InsumoProceso;
        public InsumoGrupoTeckioController(
            InsumoProceso<GrupoTeckioContext> insumoProceso)
        {
