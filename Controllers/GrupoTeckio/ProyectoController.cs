...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoGrupoTeckioController : ControllerBase
    {
        private readonly ProyectoProceso<GrupoTeckioContext> _ProyectoProceso;
        public ProyectoGrupoTeckioController(
            ProyectoProceso<GrupoTeckioContext> proyectoProceso)
        {
