...
namespace ERP_TECKIO.Controllers.GrupoTeckio
{
    ...
    public class FacturaGrupoTeckioController : ControllerBase
    {
        private readonly ObtenFacturaProceso<GrupoTeckioContext> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<GrupoTeckioContext> _categoriaProductoYServicioService;
        public FacturaGrupoTeckioController(
            ObtenFacturaProceso<GrupoTeckioContext> obtenFacturaProceso,
            ICategoriaProductoYServicioService<GrupoTeckioContext> categoriaProductoYServicioService
            )
        {
