...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableGrupoTeckioController : ControllerBase
    {
        private readonly ICuentaContableService<GrupoTeckioContext> _Service;
        private readonly ICodigoAgrupadorService<GrupoTeckioContext> _CodigoAgrupadorService;
        private readonly IRubroService<GrupoTeckioContext> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableGrupoTeckioController> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly GrupoTeckioContext Context;
        private readonly CuentaContableProceso<GrupoTeckioContext> _proceso;
        /// <summary>
        ...
        public CuentaContableGrupoTeckioController(
            ILogger<CuentaContableGrupoTeckioController> logger,
            GrupoTeckioContext context
            , ICuentaContableService<GrupoTeckioContext> Service
            , ICodigoAgrupadorService<GrupoTeckioContext> CodigoAgrupadorService
            , IRubroService<GrupoTeckioContext> RubroService
            , CuentaContableProceso<GrupoTeckioContext> proceso
            )
        {
            Logger = logger;
            Context = context;
