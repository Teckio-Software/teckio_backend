...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaGrupoTeckioController : ControllerBase
    {
        private readonly CuentaBancariaProceso<GrupoTeckioContext> _proceso;

        private readonly ICuentaBancariaService<GrupoTeckioContext> _servicio;
        public CuentaBancariaGrupoTeckioController(CuentaBancariaProceso<GrupoTeckioContext> _proceso, ICuentaBancariaService<GrupoTeckioContext> _servicio
           )
        {
