...
{
    [Route("api/insumoxcotizacion/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionGrupoTeckioController : ControllerBase
    {
        private readonly IInsumoXCotizacionService<GrupoTeckioContext> _Service;
        private readonly ILogger<InsumoXCotizacionGrupoTeckioController> _Logger;
        private readonly CotizacionProceso<GrupoTeckioContext> _Proceso;
        private readonly GrupoTeckioContext Context;
        public InsumoXCotizacionGrupoTeckioController(
            ILogger<InsumoXCotizacionGrupoTeckioController> Logger,
            GrupoTeckioContext Context
            , IInsumoXCotizacionService<GrupoTeckioContext> Service
