...
{
    [Route("api/insumoxordencompra/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraGrupoTeckioController : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<GrupoTeckioContext> _Service;
        private readonly OrdenCompraProceso<GrupoTeckioContext> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraGrupoTeckioController> _Logger;
        private readonly GrupoTeckioContext _Context;
        public InsumoXOrdenCompraGrupoTeckioController(
            ILogger<InsumoXOrdenCompraGrupoTeckioController> Logger,
            GrupoTeckioContext Context
            , IInsumoXOrdenCompraService<GrupoTeckioContext> Service
