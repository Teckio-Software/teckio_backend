...
{
    [Route("api/ordencompra/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraGrupoTeckioController : ControllerBase
    {
        private readonly IOrdenCompraService<GrupoTeckioContext> _Service;
        private readonly OrdenCompraProceso<GrupoTeckioContext> _Proceso;
        private readonly ILogger<OrdenCompraGrupoTeckioController> _Logger;
        private readonly GrupoTeckioContext Context;
        private readonly PolizaProceso<GrupoTeckioContext> _polizaProceso;
        private readonly ObtenFacturaProceso<GrupoTeckioContext> _obtenFacturaProceso;

        public OrdenCompraGrupoTeckioController(
            ILogger<OrdenCompraGrupoTeckioController> Logger
            , GrupoTeckioContext Context
            , IOrdenCompraService<GrupoTeckioContext> Service
            , OrdenCompraProceso<GrupoTeckioContext> Proceso
            , PolizaProceso<GrupoTeckioContext> polizaProceso
            , ObtenFacturaProceso<GrupoTeckioContext> obtenFacturaProceso
            )
        {
            _Logger = Logger;
