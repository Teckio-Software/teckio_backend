...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/2")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaGrupoTeckioController : ControllerBase
    {
        private readonly IContratistaService<GrupoTeckioContext> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaGrupoTeckioController> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<GrupoTeckioContext> _contratistaCuentasContablesProceso;
        public ContratistaGrupoTeckioController(
            ILogger<ContratistaGrupoTeckioController> logger,
            GrupoTeckioContext context
            , IContratistaService<GrupoTeckioContext> ContratistaService,
            ContratistaCuentasContablesProceso<GrupoTeckioContext> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
