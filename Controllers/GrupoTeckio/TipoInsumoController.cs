...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoGrupoTeckioController : ControllerBase
    {
        private readonly TipoInsumoProceso<GrupoTeckioContext> _TipoInsumoProceso;

        public TipoInsumoGrupoTeckioController(
            TipoInsumoProceso<GrupoTeckioContext> tipoInsumoProceso
            )
        {
