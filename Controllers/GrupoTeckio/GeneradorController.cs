...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresGrupoTeckioController : ControllerBase
    {
        private readonly GeneradoresProceso<GrupoTeckioContext> _GeneradoresProceso;
        public GeneradoresGrupoTeckioController(
            GeneradoresProceso<GrupoTeckioContext> generadoresProceso)
        {
