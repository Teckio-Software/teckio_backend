...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteGrupoTeckioController : ControllerBase
    {
        private readonly IClientesService<GrupoTeckioContext> _Service;

        private readonly ClienteProceso<GrupoTeckioContext> _Proceso;
        private readonly ClienteCuentasContablesProceso<GrupoTeckioContext> _clientesCuentasContablesProceso;
        public ClienteGrupoTeckioController(
            IClientesService<GrupoTeckioContext> service
            , ClienteProceso<GrupoTeckioContext> proceso,
            ClienteCuentasContablesProceso<GrupoTeckioContext> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
