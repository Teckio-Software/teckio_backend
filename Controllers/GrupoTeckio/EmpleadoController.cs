...
{
    [Route("api/empleado/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoGrupoTeckioController : ControllerBase
    {
        private readonly IEmpleadoService<GrupoTeckioContext> _empleadoService;
        public EmpleadoGrupoTeckioController(
            IEmpleadoService<GrupoTeckioContext> empleadoService
            )
        {
