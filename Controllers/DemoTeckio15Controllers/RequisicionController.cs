...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL15Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL15Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL15Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL15Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL15Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL15Controller(
            ILogger<RequisicionDemoTeckioAL15Controller> Logger
            , DemoTeckioAL15Context Context
            , IRequisicionService<DemoTeckioAL15Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL15Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL15Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL15Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL15Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/15/1570"))
            {
