...
namespace ERP_TECKIO.Controllers.DemoTeckioAL15
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL15Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL15Context> service)
        {
            _service = service;
        }
