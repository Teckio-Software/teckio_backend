...
{
    [Route("api/programacionestimada/15")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL15Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL15Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL15Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL15Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL15Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL15Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL15Context> precioUnitarioService,
