...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL15Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL15Controller(
            FamiliaInsumoProceso<DemoTeckioAL15Context> familiaInsumoProceso)
        {
