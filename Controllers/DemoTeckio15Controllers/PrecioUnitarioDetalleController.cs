...
namespace SistemaERP.API.DemoTeckioAL15Controllers.Procomi
{
    [Route("api/preciounitariodetalle/15")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL15Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL15Controller(
