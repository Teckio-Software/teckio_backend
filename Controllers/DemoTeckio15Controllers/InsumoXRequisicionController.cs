...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL15Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL15Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL15Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL15Controller> Logger,
            RequisicionProceso<DemoTeckioAL15Context> Proceso,
            DemoTeckioAL15Context Context
            , IInsumoXRequisicionService<DemoTeckioAL15Context> Service)
        {
            _Logger = Logger;
