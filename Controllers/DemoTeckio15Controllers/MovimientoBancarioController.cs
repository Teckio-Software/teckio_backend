...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/15")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL15Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL15Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL15Controller(
            MovimientoBancarioProceso<DemoTeckioAL15Context> movimientoBancarioProceso
            )
        {
