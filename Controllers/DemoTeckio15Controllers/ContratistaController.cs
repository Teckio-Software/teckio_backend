...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/15")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL15Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL15Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL15Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL15Controller(
            ILogger<ContratistaDemoTeckioAL15Controller> logger,
            DemoTeckioAL15Context context
            , IContratistaService<DemoTeckioAL15Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL15Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
