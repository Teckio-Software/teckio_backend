...
{
    [Route("api/productoyservicio/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL15Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL15Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL15Context> _process;

        public ProductoYServicioDemoTeckioAL15Controller(IProductoYservicioService<DemoTeckioAL15Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL15Context> process
            )
        {
