...
{
    [Route("api/entradaproduccionalmacen/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL15Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL15Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL15Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL15Context> proceso)
        {
            _proceso = proceso;
        }
