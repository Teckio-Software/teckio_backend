...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL15Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL15Controller(
            ProyectoProceso<DemoTeckioAL15Context> proyectoProceso)
        {
