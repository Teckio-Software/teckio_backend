...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL15Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL15Context> _servicio;
        public CuentaBancariaDemoTeckioAL15Controller(CuentaBancariaProceso<DemoTeckioAL15Context> _proceso, ICuentaBancariaService<DemoTeckioAL15Context> _servicio
           )
        {
