...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL15Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL15Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL15Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL15Context> cuentaBancariaEmpresaService,
