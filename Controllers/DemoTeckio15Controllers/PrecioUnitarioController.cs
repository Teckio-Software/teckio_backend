...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioAL15Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL15Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL15Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL15Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL15Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL15Controller(
            PrecioUnitarioProceso<DemoTeckioAL15Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL15Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL15Context> options,
            ExplocionInsumosProceso<DemoTeckioAL15Context> explocionInsumosProceso
            )
        {
