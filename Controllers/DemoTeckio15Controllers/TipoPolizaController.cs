...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL15Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL15Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL15Controller(
            ILogger<TipoPolizaDemoTeckioAL15Controller> logger,
            DemoTeckioAL15Context context
            , ITipoPolizaService<DemoTeckioAL15Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
