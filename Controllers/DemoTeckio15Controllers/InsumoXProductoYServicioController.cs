...
namespace ERP_TECKIO.Controllers.DemoTeckioAL15
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/15")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL15Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL15Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL15Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL15Context> process)
        {
            _service = service;
            _process = process;
        }
