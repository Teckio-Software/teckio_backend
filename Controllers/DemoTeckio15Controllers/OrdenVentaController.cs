...
{
    [Route("api/ordenventa/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL15Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL15Controller(
            OrdenVentaProceso<DemoTeckioAL15Context> ordenVentaProceso
            ) { 
