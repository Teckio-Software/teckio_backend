...
{
    [Route("api/cliente/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL15Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL15Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL15Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL15Controller(
            IClientesService<DemoTeckioAL15Context> service
            , ClienteProceso<DemoTeckioAL15Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL15Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
