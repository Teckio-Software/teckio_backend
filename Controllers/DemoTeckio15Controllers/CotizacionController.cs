...
{
    [Route("api/cotizacion/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL15Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL15Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL15Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL15Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL15Controller> _Logger;
        private readonly DemoTeckioAL15Context Context;
        public CotizacionDemoTeckioAL15Controller(

            ILogger<CotizacionDemoTeckioAL15Controller> Logger
            , DemoTeckioAL15Context Context
            , ICotizacionService<DemoTeckioAL15Context> Service
            , IOrdenCompraService<DemoTeckioAL15Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL15Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL15Context> Proceso)
        {
            _Logger = Logger;
