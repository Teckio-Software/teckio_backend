...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL15Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL15Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL15Controller(
            ILogger<CompraDirectaDemoTeckioAL15Controller> logger,
            DemoTeckioAL15Context context
            , ICompraDirectaService<DemoTeckioAL15Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
