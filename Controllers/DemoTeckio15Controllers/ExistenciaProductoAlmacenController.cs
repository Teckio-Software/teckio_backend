...
namespace ERP_TECKIO.Controllers.DemoTeckioAL15
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL15Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL15Context> proces)
        {
            _proceso = proces;
        }
