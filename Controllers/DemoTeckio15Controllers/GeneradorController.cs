...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL15Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL15Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL15Controller(
            GeneradoresProceso<DemoTeckioAL15Context> generadoresProceso)
        {
