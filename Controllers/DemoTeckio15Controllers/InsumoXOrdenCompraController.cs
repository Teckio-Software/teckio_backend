...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL15Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL15Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL15Controller> _Logger;
        private readonly DemoTeckioAL15Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL15Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL15Controller> Logger,
            DemoTeckioAL15Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL15Context> Service
