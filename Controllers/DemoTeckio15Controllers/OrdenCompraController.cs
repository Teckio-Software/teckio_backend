...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL15Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL15Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL15Controller> _Logger;
        private readonly DemoTeckioAL15Context Context;
        private readonly PolizaProceso<DemoTeckioAL15Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL15Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL15Controller(
            ILogger<OrdenCompraDemoTeckioAL15Controller> Logger
            , DemoTeckioAL15Context Context
            , IOrdenCompraService<DemoTeckioAL15Context> Service
            , OrdenCompraProceso<DemoTeckioAL15Context> Proceso
            , PolizaProceso<DemoTeckioAL15Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL15Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
