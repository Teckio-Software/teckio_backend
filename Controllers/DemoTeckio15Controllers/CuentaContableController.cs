...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaContableDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL15Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL15Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL15Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL15Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL15Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL15Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL15Controller(
            ILogger<CuentaContableDemoTeckioAL15Controller> logger,
            DemoTeckioAL15Context context
            , ICuentaContableService<DemoTeckioAL15Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL15Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL15Context> RubroService
            , CuentaContableProceso<DemoTeckioAL15Context> proceso
            )
        {
            Logger = logger;
            Context = context;
