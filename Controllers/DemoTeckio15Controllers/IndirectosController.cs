...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL15Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL15Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL15Context> _indirectosProceso;

        public IndirectosDemoTeckioAL15Controller(
                        IConjuntoIndirectosService<DemoTeckioAL15Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL15Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL15Context> indirectosProceso
            )
        {
