...
{
    [Route("api/factura/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL15Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL15Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL15Controller(
            ObtenFacturaProceso<DemoTeckioAL15Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL15Context> categoriaProductoYServicioService
            )
        {
