...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL15Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL15Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL15Controller(
            ILogger<ExistenciasDemoTeckioAL15Controller> Logger,
            DemoTeckioAL15Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL15Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL15Context> Proceso
            )
        {
            _Logger = Logger;
