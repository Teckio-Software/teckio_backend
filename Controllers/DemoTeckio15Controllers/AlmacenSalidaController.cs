...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL15Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL15Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL15Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL15Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL15Controller> logger,
            DemoTeckioAL15Context context
            , IAlmacenSalidaService<DemoTeckioAL15Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL15Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL15Context> Proceso
            )
        {
