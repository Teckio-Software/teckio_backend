...
{
    [Route("api/impuestodetalleordencompra/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ImpuestoDetalleOrdenVentaController: ControllerBase
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL15Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<DemoTeckioAL15Context> process)
        {
            _process = process;
        }
