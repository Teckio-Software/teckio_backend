...
{
    [Route("api/indirectosXConcepto/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL15Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL15Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL15Controller(
            IIndirectosXConceptoService<DemoTeckioAL15Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL15Context> indirectosXConceptoProceso
            ) { 
