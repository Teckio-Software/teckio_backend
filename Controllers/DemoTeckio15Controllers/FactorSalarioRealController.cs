...
namespace ERP_TECKIO.Controllers.DemoTeckioAL15
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL15Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL15Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL15Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL15Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL15Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL15Context> porcentajeCesantiaEdadService
            )
        {
