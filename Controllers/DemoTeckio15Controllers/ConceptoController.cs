...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL15Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL15Controller(
            ConceptoProceso<DemoTeckioAL15Context> conceptoProceso)
        {
