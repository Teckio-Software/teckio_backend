...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL15Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL15Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL15Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL15Controller> logger
            , DemoTeckioAL15Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL15Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
