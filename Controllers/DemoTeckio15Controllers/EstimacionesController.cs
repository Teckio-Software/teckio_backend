...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class EstimacionesDemoTeckioAL15Controller : ControllerBase
    {
        private readonly EstimacionesProceso<DemoTeckioAL15Context> _estimacionesProceso;
        public EstimacionesDemoTeckioAL15Controller(
            EstimacionesProceso<DemoTeckioAL15Context> estimacionesProceso
            )
        {
