...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL15Context> _InsumoProceso;
        public InsumoDemoTeckioAL15Controller(
            InsumoProceso<DemoTeckioAL15Context> insumoProceso)
        {
