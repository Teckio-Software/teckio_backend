...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL15Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL15Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL15Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL15Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL15Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL15Controller> _Logger;
        private readonly DemoTeckioAL15Context _Context;
        private readonly PolizaProceso<DemoTeckioAL15Context> _polizaProceso;
        public PolizaDemoTeckioAL15Controller(
            ILogger<PolizaDemoTeckioAL15Controller> logger
            , DemoTeckioAL15Context context
            , IPolizaService<DemoTeckioAL15Context> service
            , IPolizaDetalleService<DemoTeckioAL15Context> detalleService
            , ITipoPolizaService<DemoTeckioAL15Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL15Context> saldosService
