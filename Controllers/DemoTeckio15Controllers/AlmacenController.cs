...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL15Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL15Context> _almacenProceso;
        public AlmacenDemoTeckioAL15Controller(
            IAlmacenService<DemoTeckioAL15Context> almacenServicio, AlmacenProceso<DemoTeckioAL15Context> almacenProceso)
        {
