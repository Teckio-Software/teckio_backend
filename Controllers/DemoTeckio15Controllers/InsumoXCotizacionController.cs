...
{
    [Route("api/insumoxcotizacion/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL15Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL15Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL15Context> _Proceso;
        private readonly DemoTeckioAL15Context Context;
        public InsumoXCotizacionDemoTeckioAL15Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL15Controller> Logger,
            DemoTeckioAL15Context Context
            , IInsumoXCotizacionService<DemoTeckioAL15Context> Service
