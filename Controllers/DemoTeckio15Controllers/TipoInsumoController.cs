...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL15Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL15Controller(
            TipoInsumoProceso<DemoTeckioAL15Context> tipoInsumoProceso
            )
        {
