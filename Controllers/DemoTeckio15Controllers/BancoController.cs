...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL15Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL15Context> _bancoService;

        public BancoDemoTeckioAL15Controller(IBancoService<DemoTeckioAL15Context> bancoService)
        {
