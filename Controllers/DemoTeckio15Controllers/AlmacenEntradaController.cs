...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL15Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL15Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL15Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL15Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL15Controller(
            ILogger<AlmacenEntradaDemoTeckioAL15Controller> logger,
            DemoTeckioAL15Context context
            , IAlmacenEntradaService<DemoTeckioAL15Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL15Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL15Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
