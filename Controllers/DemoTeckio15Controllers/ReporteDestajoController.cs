...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL15Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL15Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL15Controller(
            ReporteDestajoProceso<DemoTeckioAL15Context> proceso,
