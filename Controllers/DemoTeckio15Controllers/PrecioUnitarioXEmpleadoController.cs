...
{
    [Route("api/precioUnitarioXEmpleado/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL15Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL15Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL15Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL15Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL15Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
