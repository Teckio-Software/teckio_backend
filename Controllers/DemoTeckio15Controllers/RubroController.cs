...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL15Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL15Controller> Logger;
        ...
        public RubroDemoTeckioAL15Controller(
            ILogger<RubroDemoTeckioAL15Controller> logger,
            DemoTeckioAL15Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL15Context> service
            )
        {
            //_Service = service;
            Logger = logger;
