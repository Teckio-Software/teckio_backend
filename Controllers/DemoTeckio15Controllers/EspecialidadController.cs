...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL15Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL15Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL15Controller(
            EspecialidadProceso<DemoTeckioAL15Context> especialidadProceso)
        {
