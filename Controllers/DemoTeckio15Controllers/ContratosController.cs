...
{
    [Route("api/contratos/15")]
    [ApiController]
    public class ContratosDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL15Context> _contratosProceso;
        public ContratosDemoTeckioAL15Controller(
            ContratosProceso<DemoTeckioAL15Context> contratosProceso
            )
        {
