...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL15Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL15Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL15Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL15Controller> _Logger;
        private readonly DemoTeckioAL15Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL15Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL15Controller> logger
            , DemoTeckioAL15Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL15Context> service
