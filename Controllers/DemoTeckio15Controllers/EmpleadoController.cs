...
{
    [Route("api/empleado/15")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL15Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL15Context> _empleadoService;
        public EmpleadoDemoTeckioAL15Controller(
            IEmpleadoService<DemoTeckioAL15Context> empleadoService
            )
        {
