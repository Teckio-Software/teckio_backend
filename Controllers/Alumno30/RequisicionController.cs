...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/requisicion/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno30Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno30Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno30Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno30Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno30Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno30Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno30Controller(
            ILogger<RequisicionAlumno30Controller> Logger
            , Alumno30Context Context
            , IRequisicionService<Alumno30Context> RequisicionService
            , RequisicionProceso<Alumno30Context> Proceso
            , ObjetoRequisicionProceso<Alumno30Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno30Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
