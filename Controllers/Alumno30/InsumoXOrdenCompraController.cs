...
{
    [Route("api/insumoxordencompra/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno30Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno30Context> _Service;
        private readonly OrdenCompraProceso<Alumno30Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno30Controller> _Logger;
        private readonly Alumno30Context _Context;
        public InsumoXOrdenCompraAlumno30Controller(
            ILogger<InsumoXOrdenCompraAlumno30Controller> Logger,
            Alumno30Context Context
            , IInsumoXOrdenCompraService<Alumno30Context> Service
            , OrdenCompraProceso<Alumno30Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
