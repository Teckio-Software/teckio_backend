...
{
    [Route("api/cotizacion/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno30Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno30Context> _Service;
        private readonly CotizacionProceso<Alumno30Context> _Proceso;
        private readonly IOrdenCompraService<Alumno30Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno30Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno30Controller> _Logger;
        private readonly Alumno30Context Context;
        public CotizacionAlumno30Controller(

            ILogger<CotizacionAlumno30Controller> Logger
            , Alumno30Context Context
            , ICotizacionService<Alumno30Context> Service
            , IOrdenCompraService<Alumno30Context> OrdenCompraService,
              ITipoImpuestoService<Alumno30Context> TipoImpuestoService
            , CotizacionProceso<Alumno30Context> Proceso)
        {
            _Logger = Logger;
