...
namespace ERP_TECKIO.Controllers.Alumno30
{
    [Route("api/fsr/30")]
    [ApiController]
    public class FactorSalarioRealController : ControllerBase
    {
        private readonly FactorSalarioRealProceso<Alumno30Context> _FactorSalarioRealProceso;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno30Context> factorSalarioRealProceso)
        {
