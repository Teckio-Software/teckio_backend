...
{
    [Route("api/cliente/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno30Controller : ControllerBase
    {
        private readonly IClientesService<Alumno30Context> _Service;

        private readonly ClienteProceso<Alumno30Context> _Proceso;
        public ClienteAlumno30Controller(
            IClientesService<Alumno30Context> service
            , ClienteProceso<Alumno30Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
