...
{
    [Route("api/indirectos/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosAlumno30Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<Alumno30Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<Alumno30Context> _indirectosService;
        private readonly IndirectosProceso<Alumno30Context> _indirectosProceso;

        public IndirectosAlumno30Controller(
                        IConjuntoIndirectosService<Alumno30Context> conjuntoIndirectosService,
                        IIndirectosService<Alumno30Context> indirectosService,
                        IndirectosProceso<Alumno30Context> indirectosProceso
            )
        {
