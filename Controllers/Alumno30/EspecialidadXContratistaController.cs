...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa30")]
    public class EspecialIdadXContratistaAlumno30Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno30Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno30Controller(
            ILogger<EspecialIdadXContratistaAlumno30Controller> logger,
