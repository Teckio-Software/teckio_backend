...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/30")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno30Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno30Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno30Controller(
            ILogger<ContratistaCuentaBancariaAlumno30Controller> logger,
