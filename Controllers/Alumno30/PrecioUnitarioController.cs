...
namespace SistemaERP.API.Alumno30Controllers.Procomi
{
    [Route("api/preciounitario/30")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno30Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno30Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno30Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno30Context> _Options;
        public PrecioUnitarioAlumno30Controller(
            PrecioUnitarioProceso<Alumno30Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno30Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno30Context> options
            )
        {
        ...
        {
            using (var db = new Alumno30Context(_Options.Options))
            {
