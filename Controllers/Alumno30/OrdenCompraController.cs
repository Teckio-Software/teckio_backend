...
{
    [Route("api/ordencompra/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno30Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno30Context> _Service;
        private readonly OrdenCompraProceso<Alumno30Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno30Controller> _Logger;
        private readonly Alumno30Context Context;
        public OrdenCompraAlumno30Controller(
            ILogger<OrdenCompraAlumno30Controller> Logger
            , Alumno30Context Context
            , IOrdenCompraService<Alumno30Context> Service
