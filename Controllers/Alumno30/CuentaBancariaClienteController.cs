...
{
    [Route("api/cuentabancariacliente/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaClienteAlumno30Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<Alumno30Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<Alumno30Context> _proceso;

        public CuentaBancariaClienteAlumno30Controller(
            ICuentaBancariaClienteService<Alumno30Context> cuentaBancariaClienteService,
