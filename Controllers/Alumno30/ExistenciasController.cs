...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno30Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno30Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno30Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno30Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno30Controller(
            ILogger<ExistenciasAlumno30Controller> Logger,
            Alumno30Context Context
            , IAlmacenExistenciaInsumoService<Alumno30Context> ExistenciaService
            , ExistenciasProceso<Alumno30Context> Proceso
            )
        {
            _Logger = Logger;
