...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno30Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno30Context> _proceso;

        private readonly ICuentaBancariaService<Alumno30Context> _servicio;
        public CuentaBancariaAlumno30Controller(CuentaBancariaProceso<Alumno30Context> _proceso, ICuentaBancariaService<Alumno30Context> _servicio
           )
        {
