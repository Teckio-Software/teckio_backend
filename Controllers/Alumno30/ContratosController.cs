...
{
    [Route("api/contratos/30")]
    [ApiController]
    public class ContratosAlumno30Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno30Context> _contratosProceso;
        public ContratosAlumno30Controller(
            ContratosProceso<Alumno30Context> contratosProceso
            )
        {
