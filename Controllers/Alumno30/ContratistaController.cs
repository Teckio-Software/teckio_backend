...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/contratista/30")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno30Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno30Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno30Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno30Controller(
            ILogger<ContratistaAlumno30Controller> logger,
            Alumno30Context context
            , IContratistaService<Alumno30Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
