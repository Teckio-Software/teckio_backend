...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno30Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno30Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno30Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno30Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno30Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno30Controller(
            ILogger<AlmacenEntradaAlumno30Controller> logger,
            Alumno30Context context
            , IAlmacenEntradaService<Alumno30Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno30Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno30Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
