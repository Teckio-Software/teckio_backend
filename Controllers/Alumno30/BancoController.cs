...
namespace ERP_TECKIO.API.Controllers.Alumno30
{
    ...
    public class BancoAlumno30Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno30Context> _bancoService;

        public BancoAlumno30Controller(IBancoService<Alumno30Context> bancoService)
        {
