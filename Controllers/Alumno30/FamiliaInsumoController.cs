...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa30")]
    public class FamiliaInsumoAlumno30Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno30Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno30Controller(
            FamiliaInsumoProceso<Alumno30Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa30")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa30")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa30")]
