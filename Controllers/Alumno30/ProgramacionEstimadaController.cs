...
{
    [Route("api/programacionestimada/30")]
    [ApiController]
    public class ProgramacionEstimadaAlumno30Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno30Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno30Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno30Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno30Controller(
            ProgramacionEstimadaProceso<Alumno30Context> programacionEstimadaProceso,
            IProyectoService<Alumno30Context> proyectoProceso,
            IPrecioUnitarioService<Alumno30Context> precioUnitarioService,
