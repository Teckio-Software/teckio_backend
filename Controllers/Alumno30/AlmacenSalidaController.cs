...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno30Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno30Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno30Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno30Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno30Controller> Logger;
        ...
        public AlmacenSalidaAlumno30Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno30Controller> logger,
            Alumno30Context context
            , IAlmacenSalidaService<Alumno30Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno30Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno30Context> Proceso
            )
        {
