...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa30")]
    public class InsumoXContratistaAlumno30Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno30Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno30Controller(
            ILogger<InsumoXContratistaAlumno30Controller> logger,
