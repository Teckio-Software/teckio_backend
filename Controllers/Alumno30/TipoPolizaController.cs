...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa30")]
    public class TipoPolizaAlumno30Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno30Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno30Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno30Controller(
            ILogger<TipoPolizaAlumno30Controller> logger,
            Alumno30Context context
            , ITipoPolizaService<Alumno30Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa30")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa30")]
