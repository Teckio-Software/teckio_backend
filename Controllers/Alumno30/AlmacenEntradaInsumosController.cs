...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno30Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno30Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno30Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno30Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno30Controller(
            ILogger<AlmacenEntradaInsumoAlumno30Controller> logger,
            Alumno30Context context
            , IInsumoXAlmacenEntradaService<Alumno30Context> AlmacenEntradaDetalle
