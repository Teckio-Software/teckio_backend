...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno30Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno30Context> _Service;

        private readonly RequisicionProceso<Alumno30Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno30Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno30Controller(
            ILogger<InsumoXRequisicionAlumno30Controller> Logger,
            RequisicionProceso<Alumno30Context> Proceso,
            Alumno30Context Context
            , IInsumoXRequisicionService<Alumno30Context> Service)
        {
            _Logger = Logger;
