...
{
    [Route("api/polizadetalle/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa30")]
    public class PolizaDetalleAlumno30Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<Alumno30Context> _Service;
        private readonly ICuentaContableService<Alumno30Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleAlumno30Controller> _Logger;
        private readonly Alumno30Context _Context;
        public PolizaDetalleAlumno30Controller(
            ILogger<PolizaDetalleAlumno30Controller> logger
            , Alumno30Context context
            , IPolizaDetalleService<Alumno30Context> service
