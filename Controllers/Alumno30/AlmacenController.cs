...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno30Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno30Context> _almacenServicio;

        public AlmacenAlumno30Controller(
            IAlmacenService<Alumno30Context> almacenServicio)
        {
