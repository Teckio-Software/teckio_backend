...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentacontable/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa30")]
    public class CuentaContableAlumno30Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno30Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno30Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno30Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno30Controller(
            ILogger<CuentaContableAlumno30Controller> logger,
            Alumno30Context context
            , ICuentaContableService<Alumno30Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno30Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
