...
{
    [Route("api/reportesdestajo/30")]
    [ApiController]
    public class ReporteDestajoAlumno30Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno30Context> _proceso;
        private readonly EstimacionesProceso<Alumno30Context> _estimacionesProceso;

        public ReporteDestajoAlumno30Controller(
            ReporteDestajoProceso<Alumno30Context> proceso,
            EstimacionesProceso<Alumno30Context> estimacionesProceso
            ) { 
            _proceso = proceso;
