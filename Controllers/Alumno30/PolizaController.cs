...
namespace ERP_TECKIO
{
    [Route("api/poliza/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPoliza-Empresa30")]
    public class PolizaAlumno30Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno30Context> _Service;
        private readonly IPolizaDetalleService<Alumno30Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno30Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno30Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno30Context> _SaldosService;
        private readonly ILogger<PolizaAlumno30Controller> _Logger;
        private readonly Alumno30Context _Context;
        public PolizaAlumno30Controller(
            ILogger<PolizaAlumno30Controller> logger
            , Alumno30Context context
            , IPolizaService<Alumno30Context> service
            , IPolizaDetalleService<Alumno30Context> detalleService
            , ITipoPolizaService<Alumno30Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno30Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa30")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa30")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa30")]
