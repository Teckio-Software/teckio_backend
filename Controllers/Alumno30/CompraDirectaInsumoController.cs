...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa30")]
    public class CompraDirectaInsumoAlumno30Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno30Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno30Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno30Controller(
            ILogger<CompraDirectaInsumoAlumno30Controller> logger
            , Alumno30Context context
            , IInsumoXCompraDirectaService<Alumno30Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
