...
namespace ERP_TECKIO.API.Alumno030Controllers.Procomi
{
    [Route("api/estimaciones/30")]
    [ApiController]
    public class EstimacionesAlumno30Controller : ControllerBase
    {
        private readonly EstimacionesProceso<Alumno30Context> _estimacionesProceso;
        public EstimacionesAlumno30Controller(
