...
{
    [Route("api/insumoxcotizacion/30")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno30Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno30Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno30Controller> _Logger;
        private readonly CotizacionProceso<Alumno30Context> _Proceso;
        private readonly Alumno30Context Context;
        public InsumoXCotizacionAlumno30Controller(
            ILogger<InsumoXCotizacionAlumno30Controller> Logger,
            Alumno30Context Context
            , IInsumoXCotizacionService<Alumno30Context> Service
