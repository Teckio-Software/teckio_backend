...
namespace ERP_TECKIO.Controllers.DemoTeckioAL19
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL19Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL19Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL19Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL19Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL19Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL19Context> porcentajeCesantiaEdadService
            )
        {
