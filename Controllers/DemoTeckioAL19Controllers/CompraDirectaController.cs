...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL19Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL19Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL19Controller(
            ILogger<CompraDirectaDemoTeckioAL19Controller> logger,
            DemoTeckioAL19Context context
            , ICompraDirectaService<DemoTeckioAL19Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
