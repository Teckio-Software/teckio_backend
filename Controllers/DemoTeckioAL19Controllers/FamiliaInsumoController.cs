...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL19Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL19Controller(
            FamiliaInsumoProceso<DemoTeckioAL19Context> familiaInsumoProceso)
        {
