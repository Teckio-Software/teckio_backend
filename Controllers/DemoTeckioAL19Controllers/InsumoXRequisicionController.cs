...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL19Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL19Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL19Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL19Controller> Logger,
            RequisicionProceso<DemoTeckioAL19Context> Proceso,
            DemoTeckioAL19Context Context
            , IInsumoXRequisicionService<DemoTeckioAL19Context> Service)
        {
            _Logger = Logger;
