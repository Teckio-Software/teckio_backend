...
{
    [Route("api/reportesdestajo/19")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL19Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL19Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL19Controller(
            ReporteDestajoProceso<DemoTeckioAL19Context> proceso,
            EstimacionesProceso<DemoTeckioAL19Context> estimacionesProceso
            ) { 
            _proceso = proceso;
