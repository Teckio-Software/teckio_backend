...
namespace ERP_TECKIO.Controllers.DemoTeckioAL19
{
    ...
    [Route("api/insumoXproduccion/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL19Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL19Context> proces)
        {
            _proceso = proces;
        }
