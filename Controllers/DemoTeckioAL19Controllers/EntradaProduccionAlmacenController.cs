...
{
    [Route("api/entradaproduccionalmacen/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL19Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL19Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL19Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL19Context> proceso)
        {
            _proceso = proceso;
        }
