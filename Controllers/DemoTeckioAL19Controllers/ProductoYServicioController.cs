...
{
    [Route("api/productoyservicio/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL19Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL19Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL19Context> _process;

        public ProductoYServicioDemoTeckioAL19Controller(IProductoYservicioService<DemoTeckioAL19Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL19Context> process
            )
        {
