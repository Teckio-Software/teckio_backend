...
namespace ERP_TECKIO.Controllers.DemoTeckioAL19
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL19Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL19Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL19Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL19Context> process)
        {
            _service = service;
            _process = process;
        }
