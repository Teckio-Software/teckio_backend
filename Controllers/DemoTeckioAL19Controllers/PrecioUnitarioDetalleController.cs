...
namespace SistemaERP.API.DemoTeckioAL19Controllers.Procomi
{
    [Route("api/preciounitariodetalle/19")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL19Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL19Controller(
