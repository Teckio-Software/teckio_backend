...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL19Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL19Controller(
            TipoInsumoProceso<DemoTeckioAL19Context> tipoInsumoProceso
            )
        {
