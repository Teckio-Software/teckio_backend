...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL19Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL19Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL19Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL19Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL19Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL19Controller> _Logger;
        private readonly DemoTeckioAL19Context _Context;
        private readonly PolizaProceso<DemoTeckioAL19Context> _polizaProceso;
        public PolizaDemoTeckioAL19Controller(
            ILogger<PolizaDemoTeckioAL19Controller> logger
            , DemoTeckioAL19Context context
            , IPolizaService<DemoTeckioAL19Context> service
            , IPolizaDetalleService<DemoTeckioAL19Context> detalleService
            , ITipoPolizaService<DemoTeckioAL19Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL19Context> saldosService
