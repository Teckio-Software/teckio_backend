...
{
    [Route("api/precioUnitarioXEmpleado/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL19Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL19Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL19Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL19Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL19Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
