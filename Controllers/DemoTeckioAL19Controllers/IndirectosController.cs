...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL19Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL19Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL19Context> _indirectosProceso;

        public IndirectosDemoTeckioAL19Controller(
                        IConjuntoIndirectosService<DemoTeckioAL19Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL19Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL19Context> indirectosProceso
            )
        {
