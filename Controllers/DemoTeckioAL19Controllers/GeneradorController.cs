...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL19Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL19Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL19Controller(
            GeneradoresProceso<DemoTeckioAL19Context> generadoresProceso)
        {
