...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL19Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL19Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL19Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL19Controller> logger
            , DemoTeckioAL19Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL19Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
