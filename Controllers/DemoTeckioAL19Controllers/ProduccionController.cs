...
namespace ERP_TECKIO.Controllers.DemoTeckioAL19
{
    ...
    [Route("api/produccion/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL19Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL19Context> proceso)
        {
            _proceso = proceso;
        }
