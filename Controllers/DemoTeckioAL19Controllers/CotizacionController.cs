...
{
    [Route("api/cotizacion/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL19Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL19Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL19Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL19Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL19Controller> _Logger;
        private readonly DemoTeckioAL19Context Context;
        public CotizacionDemoTeckioAL19Controller(

            ILogger<CotizacionDemoTeckioAL19Controller> Logger
            , DemoTeckioAL19Context Context
            , ICotizacionService<DemoTeckioAL19Context> Service
            , IOrdenCompraService<DemoTeckioAL19Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL19Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL19Context> Proceso)
        {
            _Logger = Logger;
