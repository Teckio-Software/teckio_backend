...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL19Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL19Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL19Controller(
            ILogger<ExistenciasDemoTeckioAL19Controller> Logger,
            DemoTeckioAL19Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL19Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL19Context> Proceso
            )
        {
            _Logger = Logger;
