...
{
    [Route("api/preciounitario/19")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL19Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL19Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL19Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL19Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL19Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL19Controller(
            PrecioUnitarioProceso<DemoTeckioAL19Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL19Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL19Context> options,
            ExplocionInsumosProceso<DemoTeckioAL19Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL19Context(_Options.Options))
            {
