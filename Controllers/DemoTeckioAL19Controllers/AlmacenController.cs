...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly IAlmacenService<DemoTeckioAL19Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL19Context> _almacenProceso;

        public AlmacenDemoTeckioAL19Controller(
            IAlmacenService<DemoTeckioAL19Context> almacenServicio, AlmacenProceso<DemoTeckioAL19Context> almacenProceso)
        {
