...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL19Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL19Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL19Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL19Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL19Controller> logger,
            DemoTeckioAL19Context context
            , IAlmacenSalidaService<DemoTeckioAL19Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL19Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL19Context> Proceso
            )
        {
