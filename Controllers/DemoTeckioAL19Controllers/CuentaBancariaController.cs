...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL19Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL19Context> _servicio;
        public CuentaBancariaDemoTeckioAL19Controller(CuentaBancariaProceso<DemoTeckioAL19Context> _proceso, ICuentaBancariaService<DemoTeckioAL19Context> _servicio
           )
        {
