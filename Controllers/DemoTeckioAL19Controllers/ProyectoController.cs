...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL19Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL19Controller(
            ProyectoProceso<DemoTeckioAL19Context> proyectoProceso)
        {
