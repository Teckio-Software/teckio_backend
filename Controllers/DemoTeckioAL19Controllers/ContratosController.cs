...
{
    [Route("api/contratos/19")]
    [ApiController]
    public class ContratosDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL19Context> _contratosProceso;
        public ContratosDemoTeckioAL19Controller(
            ContratosProceso<DemoTeckioAL19Context> contratosProceso
            )
        {
