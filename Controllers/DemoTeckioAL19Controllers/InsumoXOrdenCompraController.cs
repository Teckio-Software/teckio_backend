...
{
    [Route("api/insumoxordencompra/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL19Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL19Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL19Controller> _Logger;
        private readonly DemoTeckioAL19Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL19Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL19Controller> Logger,
            DemoTeckioAL19Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL19Context> Service
