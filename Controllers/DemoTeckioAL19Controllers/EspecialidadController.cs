...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL19Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL19Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL19Controller(
            EspecialidadProceso<DemoTeckioAL19Context> especialidadProceso)
        {
