...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL19Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL19Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL19Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL19Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL19Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL19Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL19Controller(
            ILogger<CuentaContableDemoTeckioAL19Controller> logger,
            DemoTeckioAL19Context context
            , ICuentaContableService<DemoTeckioAL19Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL19Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL19Context> RubroService
            , CuentaContableProceso<DemoTeckioAL19Context> proceso
            )
        {
            Logger = logger;
            Context = context;
