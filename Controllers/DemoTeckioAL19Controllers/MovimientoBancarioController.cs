...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/19")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL19Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL19Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL19Controller(
            MovimientoBancarioProceso<DemoTeckioAL19Context> movimientoBancarioProceso
            )
        {
