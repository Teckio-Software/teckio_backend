...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL19Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL19Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL19Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL19Controller(
            ILogger<AlmacenEntradaDemoTeckioAL19Controller> logger,
            DemoTeckioAL19Context context
            , IAlmacenEntradaService<DemoTeckioAL19Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL19Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL19Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
