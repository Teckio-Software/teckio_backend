...
{
    [Route("api/ordencompra/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL19Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL19Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL19Controller> _Logger;
        private readonly DemoTeckioAL19Context Context;
        private readonly PolizaProceso<DemoTeckioAL19Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL19Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL19Controller(
            ILogger<OrdenCompraDemoTeckioAL19Controller> Logger
            , DemoTeckioAL19Context Context
            , IOrdenCompraService<DemoTeckioAL19Context> Service
            , OrdenCompraProceso<DemoTeckioAL19Context> Proceso
            , PolizaProceso<DemoTeckioAL19Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL19Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
