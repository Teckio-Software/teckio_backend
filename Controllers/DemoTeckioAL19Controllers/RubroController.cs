...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL19Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL19Controller> Logger;
        ...
        public RubroDemoTeckioAL19Controller(
            ILogger<RubroDemoTeckioAL19Controller> logger,
            DemoTeckioAL19Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL19Context> service
            )
        {
            //_Service = service;
            Logger = logger;
