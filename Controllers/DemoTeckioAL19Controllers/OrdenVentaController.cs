...
{
    [Route("api/ordenventa/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL19Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL19Controller(
            OrdenVentaProceso<DemoTeckioAL19Context> ordenVentaProceso
            ) { 
