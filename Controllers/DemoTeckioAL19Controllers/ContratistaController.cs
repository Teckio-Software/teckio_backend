...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/19")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL19Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL19Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL19Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL19Controller(
            ILogger<ContratistaDemoTeckioAL19Controller> logger,
            DemoTeckioAL19Context context
            , IContratistaService<DemoTeckioAL19Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL19Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
