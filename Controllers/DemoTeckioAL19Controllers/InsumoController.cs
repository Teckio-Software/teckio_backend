...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL19Context> _InsumoProceso;
        public InsumoDemoTeckioAL19Controller(
            InsumoProceso<DemoTeckioAL19Context> insumoProceso)
        {
