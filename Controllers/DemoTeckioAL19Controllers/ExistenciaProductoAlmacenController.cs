...
namespace ERP_TECKIO.Controllers.DemoTeckioAL19
{
    ...
    [Route("api/existenciaproductoalmacen/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL19Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL19Context> proces)
        {
            _proceso = proces;
        }
