...
namespace ERP_TECKIO.Controllers.DemoTeckioAL19
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL19Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL19Context> service)
        {
            _service = service;
        }
