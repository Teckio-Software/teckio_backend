...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL19Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL19Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL19Controller(
            ICuentaBancariaClienteService<DemoTeckioAL19Context> cuentaBancariaClienteService,
            CuentaBancariaProceso<DemoTeckioAL19Context> proceso
            )
        {
