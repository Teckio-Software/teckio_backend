...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL19Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL19Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL19Controller> _Logger;
        private readonly DemoTeckioAL19Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL19Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL19Controller> logger
            , DemoTeckioAL19Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL19Context> service
