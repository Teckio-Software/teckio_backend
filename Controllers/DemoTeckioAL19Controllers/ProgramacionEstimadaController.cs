...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL19Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL19Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL19Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL19Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL19Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL19Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL19Context> precioUnitarioService,
