...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL19Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL19Context> _bancoService;

        public BancoDemoTeckioAL19Controller(IBancoService<DemoTeckioAL19Context> bancoService)
        {
