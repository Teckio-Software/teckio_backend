...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL19Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL19Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL19Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL19Controller(
            IClientesService<DemoTeckioAL19Context> service
            , ClienteProceso<DemoTeckioAL19Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL19Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
