...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL19Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL19Controller(
            ConceptoProceso<DemoTeckioAL19Context> conceptoProceso)
        {
