...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL19Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL19Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL19Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL19Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL19Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL19Controller(
            ILogger<RequisicionDemoTeckioAL19Controller> Logger
            , DemoTeckioAL19Context Context
            , IRequisicionService<DemoTeckioAL19Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL19Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL19Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL19Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL19Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/19/970"))
            {
