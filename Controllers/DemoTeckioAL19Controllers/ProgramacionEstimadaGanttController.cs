...
namespace SistemaERP.API.Controllers.DemoTeckioAL19
{
    [Route("api/programacionestimadaGantt/19")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL19Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL19Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL19Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL19Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL19Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL19Context> importeSemanalGanttProceso,
