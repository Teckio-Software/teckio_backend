...
{
    [Route("api/insumoxcotizacion/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL19Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL19Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL19Context> _Proceso;
        private readonly DemoTeckioAL19Context Context;
        public InsumoXCotizacionDemoTeckioAL19Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL19Controller> Logger,
            DemoTeckioAL19Context Context
            , IInsumoXCotizacionService<DemoTeckioAL19Context> Service
