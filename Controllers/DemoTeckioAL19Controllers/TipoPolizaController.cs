...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL19Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL19Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL19Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL19Controller(
            ILogger<TipoPolizaDemoTeckioAL19Controller> logger,
            DemoTeckioAL19Context context
            , ITipoPolizaService<DemoTeckioAL19Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
