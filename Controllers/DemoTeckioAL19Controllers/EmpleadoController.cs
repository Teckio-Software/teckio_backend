...
{
    [Route("api/empleado/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL19Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL19Context> _empleadoService;
        public EmpleadoDemoTeckioAL19Controller(
            IEmpleadoService<DemoTeckioAL19Context> empleadoService
            )
        {
