...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno14Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno14Context> _contratosProceso;
        public ContratosAlumno14Controller(
            ContratosProceso<Alumno14Context> contratosProceso
            )
        {
