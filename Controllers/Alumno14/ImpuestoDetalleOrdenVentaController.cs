...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno14Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno14Context> process)
        {
            _process = process;
        }
