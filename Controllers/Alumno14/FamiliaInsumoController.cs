...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa14")]
    public class FamiliaInsumoAlumno14Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno14Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno14Controller(
            FamiliaInsumoProceso<Alumno14Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa14")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa14")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa14")]
