...
namespace ERP_TECKIO
{
    ...
    public class ExplosionInsumoAlumno14Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoAlumno14Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoAlumno14Controller(
            ILogger<ExplosionInsumoAlumno14Controller> Logger,
