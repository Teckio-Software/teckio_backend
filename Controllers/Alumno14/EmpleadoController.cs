...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno14Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno14Context> _empleadoService;
        public EmpleadoAlumno14Controller(
            IEmpleadoService<Alumno14Context> empleadoService
            )
        {
