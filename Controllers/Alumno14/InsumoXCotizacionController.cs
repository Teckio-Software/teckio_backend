...
{
    [Route("api/insumoxcotizacion/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno14Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno14Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno14Controller> _Logger;
        private readonly CotizacionProceso<Alumno14Context> _Proceso;
        private readonly Alumno14Context Context;
        public InsumoXCotizacionAlumno14Controller(
            ILogger<InsumoXCotizacionAlumno14Controller> Logger,
            Alumno14Context Context
            , IInsumoXCotizacionService<Alumno14Context> Service
