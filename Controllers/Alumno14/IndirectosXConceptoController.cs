...
namespace ERP_TECKIO.API.Controllers.Alumno14
{
    ...
    public class IndirectosXConceptoAlumno14Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno14Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno14Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno14Controller(
            IIndirectosXConceptoService<Alumno14Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno14Context> indirectosXConceptoProceso
            ) { 
