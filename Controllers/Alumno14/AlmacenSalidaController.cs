...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno14Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno14Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno14Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno14Controller> Logger;
        ...
        public AlmacenSalidaAlumno14Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno14Controller> logger,
            Alumno14Context context
            , IAlmacenSalidaService<Alumno14Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno14Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno14Context> Proceso
            )
        {
