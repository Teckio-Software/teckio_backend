...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa14")]
    public class CompraDirectaInsumoAlumno14Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno14Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno14Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno14Controller(
            ILogger<CompraDirectaInsumoAlumno14Controller> logger
            , Alumno14Context context
            , IInsumoXCompraDirectaService<Alumno14Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
