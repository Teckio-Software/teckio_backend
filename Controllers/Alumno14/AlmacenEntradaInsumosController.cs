...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno14Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno14Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno14Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno14Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno14Controller(
            ILogger<AlmacenEntradaInsumoAlumno14Controller> logger,
            Alumno14Context context
            , IInsumoXAlmacenEntradaService<Alumno14Context> AlmacenEntradaDetalle
