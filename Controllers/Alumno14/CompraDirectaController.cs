...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa14")]
    public class CompraDirectaAlumno14Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno14Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno14Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno14Controller(
            ILogger<CompraDirectaAlumno14Controller> logger,
            Alumno14Context context
            , ICompraDirectaService<Alumno14Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa14")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa14")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa14")]
