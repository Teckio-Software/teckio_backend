...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno14Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno14Context> service)
        {
            _service = service;
        }
