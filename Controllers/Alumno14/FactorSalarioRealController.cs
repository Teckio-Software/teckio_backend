...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno14Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno14Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno14Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno14Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno14Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno14Context> porcentajeCesantiaEdadService
            )
        {
