...
{
    [Route("api/saldosbalanzacomprobacion/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa14")]
    public class SaldosBalanzaComprobacionAlumno14Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno14Context> _Service;
        private readonly ICuentaContableService<Alumno14Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno14Controller> _Logger;
        private readonly Alumno14Context _Context;
        public SaldosBalanzaComprobacionAlumno14Controller(
            ILogger<SaldosBalanzaComprobacionAlumno14Controller> logger
            , Alumno14Context context
            , ISaldosBalanzaComprobacionService<Alumno14Context> service
