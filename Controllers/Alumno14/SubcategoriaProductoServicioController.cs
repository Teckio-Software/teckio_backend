...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno14Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno14Context> service)
        {
            _service = service;
        }
