...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno14Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno14Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno14Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno14Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno14Controller(
            ILogger<AlmacenEntradaAlumno14Controller> logger,
            Alumno14Context context
            , IAlmacenEntradaService<Alumno14Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno14Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno14Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
