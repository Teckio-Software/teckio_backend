...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXOrdenCompraAlumno14Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno14Context> _Service;
        private readonly OrdenCompraProceso<Alumno14Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno14Controller> _Logger;
        private readonly Alumno14Context _Context;
        public InsumoXOrdenCompraAlumno14Controller(
            ILogger<InsumoXOrdenCompraAlumno14Controller> Logger,
            Alumno14Context Context
            , IInsumoXOrdenCompraService<Alumno14Context> Service
