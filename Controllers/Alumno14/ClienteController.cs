...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno14Controller : ControllerBase
    {
        private readonly IClientesService<Alumno14Context> _Service;

        private readonly ClienteProceso<Alumno14Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno14Context> _clientesCuentasContablesProceso;
        public ClienteAlumno14Controller(
            IClientesService<Alumno14Context> service
            , ClienteProceso<Alumno14Context> proceso,
            ClienteCuentasContablesProceso<Alumno14Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
