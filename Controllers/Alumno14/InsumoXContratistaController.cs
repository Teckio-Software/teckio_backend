...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa14")]
    public class InsumoXContratistaAlumno14Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno14Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno14Controller(
            ILogger<InsumoXContratistaAlumno14Controller> logger,
