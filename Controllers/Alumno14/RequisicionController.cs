...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno14Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno14Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno14Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno14Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno14Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno14Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno14Controller(
            ILogger<RequisicionAlumno14Controller> Logger
            , Alumno14Context Context
            , IRequisicionService<Alumno14Context> RequisicionService
            , RequisicionProceso<Alumno14Context> Proceso
            , ObjetoRequisicionProceso<Alumno14Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno14Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno14Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/14/970"))
            {
