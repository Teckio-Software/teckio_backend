...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno14Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno14Context> _Service;
        private readonly IPolizaDetalleService<Alumno14Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno14Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno14Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno14Context> _SaldosService;
        private readonly ILogger<PolizaAlumno14Controller> _Logger;
        private readonly Alumno14Context _Context;
        public PolizaAlumno14Controller(
            ILogger<PolizaAlumno14Controller> logger
            , Alumno14Context context
            , IPolizaService<Alumno14Context> service
            , IPolizaDetalleService<Alumno14Context> detalleService
            , ITipoPolizaService<Alumno14Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno14Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa14")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa14")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa14")]
