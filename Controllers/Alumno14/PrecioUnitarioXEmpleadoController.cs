...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno14Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno14Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno14Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno14Controller(
            IPrecioUnitarioXEmpleadoService<Alumno14Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno14Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
