...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno14Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno14Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno14Context> service, InsumoXProductoYServicioProceso<Alumno14Context> process)
        {
            _service = service;
            _process = process;
        }
