...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno14Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno14Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno14Controller(
            MovimientoBancarioProceso<Alumno14Context> movimientoBancarioProceso
            )
        {
