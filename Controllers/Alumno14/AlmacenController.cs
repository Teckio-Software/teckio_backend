...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno14Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno14Context> _almacenServicio;

        public AlmacenAlumno14Controller(
            IAlmacenService<Alumno14Context> almacenServicio)
        {
