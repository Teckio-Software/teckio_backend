...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa14")]
    public class TipoPolizaAlumno14Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno14Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno14Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno14Controller(
            ILogger<TipoPolizaAlumno14Controller> logger,
            Alumno14Context context
            , ITipoPolizaService<Alumno14Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa14")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa14")]
