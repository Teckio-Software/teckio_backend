...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno14Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno14Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno14Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno14Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno14Controller(
            ILogger<ContratistaAlumno14Controller> logger,
            Alumno14Context context
            , IContratistaService<Alumno14Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno14Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
