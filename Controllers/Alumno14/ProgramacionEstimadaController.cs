...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno14Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno14Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno14Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno14Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno14Controller(
            ProgramacionEstimadaProceso<Alumno14Context> programacionEstimadaProceso,
            IProyectoService<Alumno14Context> proyectoProceso,
            IPrecioUnitarioService<Alumno14Context> precioUnitarioService,
