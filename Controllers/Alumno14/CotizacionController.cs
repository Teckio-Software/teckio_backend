...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno14Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno14Context> _Service;
        private readonly CotizacionProceso<Alumno14Context> _Proceso;
        private readonly IOrdenCompraService<Alumno14Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno14Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno14Controller> _Logger;
        private readonly Alumno14Context Context;
        public CotizacionAlumno14Controller(

            ILogger<CotizacionAlumno14Controller> Logger
            , Alumno14Context Context
            , ICotizacionService<Alumno14Context> Service
            , IOrdenCompraService<Alumno14Context> OrdenCompraService,
              ITipoImpuestoService<Alumno14Context> TipoImpuestoService
            , CotizacionProceso<Alumno14Context> Proceso)
        {
            _Logger = Logger;
