...
namespace ERP_TECKIO.API.Controllers.Alumno14
{
    ...
    public class BancoAlumno14Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno14Context> _bancoService;

        public BancoAlumno14Controller(IBancoService<Alumno14Context> bancoService)
        {
