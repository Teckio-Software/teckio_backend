...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno14Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno14Context> proces)
        {
            _proceso = proces;
        }
