...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno14Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno14Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno14Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno14Controller(
            ILogger<ExistenciasAlumno14Controller> Logger,
            Alumno14Context Context
            , IAlmacenExistenciaInsumoService<Alumno14Context> ExistenciaService
            , ExistenciasProceso<Alumno14Context> Proceso
            )
        {
            _Logger = Logger;
