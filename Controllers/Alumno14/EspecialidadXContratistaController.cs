...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa14")]
    public class EspecialIdadXContratistaAlumno14Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno14Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno14Controller(
            ILogger<EspecialIdadXContratistaAlumno14Controller> logger,
