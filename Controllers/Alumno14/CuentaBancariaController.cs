...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno14Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno14Context> _proceso;

        private readonly ICuentaBancariaService<Alumno14Context> _servicio;
        public CuentaBancariaAlumno14Controller(CuentaBancariaProceso<Alumno14Context> _proceso, ICuentaBancariaService<Alumno14Context> _servicio
           )
        {
