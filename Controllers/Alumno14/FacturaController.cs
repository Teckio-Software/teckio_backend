...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    public class FacturaAlumno14Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno14Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno14Context> _categoriaProductoYServicioService;
        public FacturaAlumno14Controller(
            ObtenFacturaProceso<Alumno14Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno14Context> categoriaProductoYServicioService
            )
        {
