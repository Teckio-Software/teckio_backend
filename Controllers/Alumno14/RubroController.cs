...
namespace ERP_TECKIO
{
    ...
    [Route("api/rubro/14")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionRubro-Empresa14")]
    public class RubroAlumno14Controller : ControllerBase
    {
        private readonly IRubroService<Alumno14Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno14Controller> Logger;
        ...
        public RubroAlumno14Controller(
            ILogger<RubroAlumno14Controller> logger,
            Alumno14Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno14Context> service
            )
        {
            //_Service = service;
            Logger = logger;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearRubro-Empresa14")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarRubro-Empresa14")]
