...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno14Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno14Context> _Service;

        private readonly RequisicionProceso<Alumno14Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno14Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno14Controller(
            ILogger<InsumoXRequisicionAlumno14Controller> Logger,
            RequisicionProceso<Alumno14Context> Proceso,
            Alumno14Context Context
            , IInsumoXRequisicionService<Alumno14Context> Service)
        {
            _Logger = Logger;
