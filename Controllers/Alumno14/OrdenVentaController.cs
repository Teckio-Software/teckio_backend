...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    public class OrdenVentaAlumno14Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno14Context> _ordenVentaProceso;
        public OrdenVentaAlumno14Controller(
            OrdenVentaProceso<Alumno14Context> ordenVentaProceso
            ) { 
