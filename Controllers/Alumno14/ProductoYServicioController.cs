...
namespace ERP_TECKIO.Controllers.Alumno14
{
    ...
    public class ProductoYServicioAlumno14Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno14Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno14Context> _process;

        public ProductoYServicioAlumno14Controller(IProductoYservicioService<Alumno14Context> productoYServicioService,
            ProductoYServicioProceso<Alumno14Context> process
            )
        {
