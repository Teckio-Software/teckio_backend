...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno10Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno10Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno10Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno10Controller(
            IPrecioUnitarioXEmpleadoService<Alumno10Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno10Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
