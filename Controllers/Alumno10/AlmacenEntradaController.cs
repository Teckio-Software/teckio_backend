...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno10Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno10Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno10Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno10Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno10Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno10Controller(
            ILogger<AlmacenEntradaAlumno10Controller> logger,
            Alumno10Context context
            , IAlmacenEntradaService<Alumno10Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno10Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno10Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
