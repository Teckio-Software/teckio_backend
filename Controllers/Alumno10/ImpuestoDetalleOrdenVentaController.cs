...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno10Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno10Context> process)
        {
            _process = process;
        }
