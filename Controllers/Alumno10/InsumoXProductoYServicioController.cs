...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno10Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno10Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno10Context> service, InsumoXProductoYServicioProceso<Alumno10Context> process)
        {
            _service = service;
            _process = process;
        }
