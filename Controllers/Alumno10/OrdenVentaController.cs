...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    public class OrdenVentaAlumno10Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno10Context> _ordenVentaProceso;
        public OrdenVentaAlumno10Controller(
            OrdenVentaProceso<Alumno10Context> ordenVentaProceso
            ) { 
