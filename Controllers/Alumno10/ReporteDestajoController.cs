...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno10Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno10Context> _proceso;
        private readonly EstimacionesProceso<Alumno10Context> _estimacionesProceso;

        public ReporteDestajoAlumno10Controller(
            ReporteDestajoProceso<Alumno10Context> proceso,
