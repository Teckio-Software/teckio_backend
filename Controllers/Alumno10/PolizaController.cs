...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaAlumno10Controller : ControllerBase
    {
        ...
        private readonly IPolizaDetalleService<Alumno10Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno10Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno10Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno10Context> _SaldosService;
        private readonly ILogger<PolizaAlumno10Controller> _Logger;
        private readonly Alumno10Context _Context;
        private readonly PolizaProceso<Alumno10Context> _polizaProceso;
        public PolizaAlumno10Controller(
            ILogger<PolizaAlumno10Controller> logger
            , Alumno10Context context
            , IPolizaService<Alumno10Context> service
            , IPolizaDetalleService<Alumno10Context> detalleService
            , ITipoPolizaService<Alumno10Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno10Context> saldosService
