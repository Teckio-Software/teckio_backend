...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa10")]
    public class EspecialIdadXContratistaAlumno10Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno10Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno10Controller(
            ILogger<EspecialIdadXContratistaAlumno10Controller> logger,
