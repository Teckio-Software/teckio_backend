...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno10Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno10Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno10Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno10Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno10Controller> Logger;
        ...
        public AlmacenSalidaAlumno10Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno10Controller> logger,
            Alumno10Context context
            , IAlmacenSalidaService<Alumno10Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno10Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno10Context> Proceso
            )
        {
