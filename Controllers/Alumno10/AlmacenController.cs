...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno10Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno10Context> _almacenServicio;

        public AlmacenAlumno10Controller(
            IAlmacenService<Alumno10Context> almacenServicio)
        {
