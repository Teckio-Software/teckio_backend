...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno10Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno10Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno10Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno10Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno10Controller(
            ProgramacionEstimadaProceso<Alumno10Context> programacionEstimadaProceso,
            IProyectoService<Alumno10Context> proyectoProceso,
            IPrecioUnitarioService<Alumno10Context> precioUnitarioService,
