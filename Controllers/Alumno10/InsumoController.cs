...
namespace ERP_TECKIO
{
    ...
    public class InsumoAlumno10Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno10Context> _InsumoProceso;
        public InsumoAlumno10Controller(
            InsumoProceso<Alumno10Context> insumoProceso)
        {
            _InsumoProceso = insumoProceso;
        }

        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearInsumo-Empresa10")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarInsumo-Empresa10")]
        ...
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarInsumo-Empresa10")]
