...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno10Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno10Context> _bancoService;

        public BancoAlumno10Controller(IBancoService<Alumno10Context> bancoService)
        {
