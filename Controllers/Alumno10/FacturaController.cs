...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    public class FacturaAlumno10Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno10Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno10Context> _categoriaProductoYServicioService;
        public FacturaAlumno10Controller(
            ObtenFacturaProceso<Alumno10Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno10Context> categoriaProductoYServicioService
            )
        {
