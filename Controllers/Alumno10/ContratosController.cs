...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno10Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno10Context> _contratosProceso;
        public ContratosAlumno10Controller(
            ContratosProceso<Alumno10Context> contratosProceso
            )
        {
