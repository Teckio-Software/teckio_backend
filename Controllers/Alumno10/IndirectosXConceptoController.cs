...
namespace ERP_TECKIO.API.Controllers.Alumno10
{
    ...
    public class IndirectosXConceptoAlumno10Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno10Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno10Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno10Controller(
            IIndirectosXConceptoService<Alumno10Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno10Context> indirectosXConceptoProceso
            ) { 
