...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno10Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno10Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno10Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno10Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno10Controller(
            ILogger<AlmacenEntradaInsumoAlumno10Controller> logger,
            Alumno10Context context
            , IInsumoXAlmacenEntradaService<Alumno10Context> AlmacenEntradaDetalle
