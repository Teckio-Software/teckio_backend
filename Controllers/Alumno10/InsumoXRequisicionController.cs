...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno10Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno10Context> _Service;

        private readonly RequisicionProceso<Alumno10Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno10Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno10Controller(
            ILogger<InsumoXRequisicionAlumno10Controller> Logger,
            RequisicionProceso<Alumno10Context> Proceso,
            Alumno10Context Context
            , IInsumoXRequisicionService<Alumno10Context> Service)
        {
            _Logger = Logger;
