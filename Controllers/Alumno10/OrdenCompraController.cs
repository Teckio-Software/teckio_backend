...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno10Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno10Context> _Service;
        private readonly OrdenCompraProceso<Alumno10Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno10Controller> _Logger;
        private readonly Alumno10Context Context;
        private readonly PolizaProceso<Alumno10Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno10Context> _obtenFacturaProceso;

        public OrdenCompraAlumno10Controller(
            ILogger<OrdenCompraAlumno10Controller> Logger
            , Alumno10Context Context
            , IOrdenCompraService<Alumno10Context> Service
            , OrdenCompraProceso<Alumno10Context> Proceso
            , PolizaProceso<Alumno10Context> polizaProceso
            , ObtenFacturaProceso<Alumno10Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
