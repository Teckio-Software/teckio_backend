...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno10Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno10Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno10Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno10Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno10Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno10Context> porcentajeCesantiaEdadService
            )
        {
