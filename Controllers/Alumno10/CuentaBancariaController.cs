...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno10Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno10Context> _proceso;

        private readonly ICuentaBancariaService<Alumno10Context> _servicio;
        public CuentaBancariaAlumno10Controller(CuentaBancariaProceso<Alumno10Context> _proceso, ICuentaBancariaService<Alumno10Context> _servicio
           )
        {
