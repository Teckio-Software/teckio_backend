...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno10Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno10Context> _empleadoService;
        public EmpleadoAlumno10Controller(
            IEmpleadoService<Alumno10Context> empleadoService
            )
        {
