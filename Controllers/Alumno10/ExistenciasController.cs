...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno10Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno10Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno10Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno10Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno10Controller(
            ILogger<ExistenciasAlumno10Controller> Logger,
            Alumno10Context Context
            , IAlmacenExistenciaInsumoService<Alumno10Context> ExistenciaService
            , ExistenciasProceso<Alumno10Context> Proceso
            )
        {
            _Logger = Logger;
