...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno10Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno10Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno10Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno10Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno10Controller(
            ILogger<ContratistaAlumno10Controller> logger,
            Alumno10Context context
            , IContratistaService<Alumno10Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno10Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
