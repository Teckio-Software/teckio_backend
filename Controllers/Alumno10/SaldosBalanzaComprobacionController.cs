...
{
    [Route("api/saldosbalanzacomprobacion/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa10")]
    public class SaldosBalanzaComprobacionAlumno10Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<Alumno10Context> _Service;
        private readonly ICuentaContableService<Alumno10Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionAlumno10Controller> _Logger;
        private readonly Alumno10Context _Context;
        public SaldosBalanzaComprobacionAlumno10Controller(
            ILogger<SaldosBalanzaComprobacionAlumno10Controller> logger
            , Alumno10Context context
            , ISaldosBalanzaComprobacionService<Alumno10Context> service
