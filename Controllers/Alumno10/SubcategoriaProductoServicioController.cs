...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno10Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno10Context> service)
        {
            _service = service;
        }
