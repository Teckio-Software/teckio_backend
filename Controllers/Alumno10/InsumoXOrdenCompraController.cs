...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno10Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno10Context> _Service;
        private readonly OrdenCompraProceso<Alumno10Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno10Controller> _Logger;
        private readonly Alumno10Context _Context;
        public InsumoXOrdenCompraAlumno10Controller(
            ILogger<InsumoXOrdenCompraAlumno10Controller> Logger,
            Alumno10Context Context
            , IInsumoXOrdenCompraService<Alumno10Context> Service
