...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa10")]
    public class InsumoXContratistaAlumno10Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno10Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno10Controller(
            ILogger<InsumoXContratistaAlumno10Controller> logger,
