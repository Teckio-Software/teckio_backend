...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa10")]
    public class CompraDirectaInsumoAlumno10Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno10Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno10Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno10Controller(
            ILogger<CompraDirectaInsumoAlumno10Controller> logger
            , Alumno10Context context
            , IInsumoXCompraDirectaService<Alumno10Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
