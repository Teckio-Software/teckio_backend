...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/proyecto/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa10")]
    public class ProyectoAlumno10Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno10Context> _ProyectoProceso;
        public ProyectoAlumno10Controller(
            ProyectoProceso<Alumno10Context> proyectoProceso)
        {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearProyecto-Empresa10")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarProyecto-Empresa10")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarProyecto-Empresa10")]
