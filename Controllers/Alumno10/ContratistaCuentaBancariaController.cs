...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ContratistaCuentaBancariaAlumno10Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno10Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno10Controller(
            ILogger<ContratistaCuentaBancariaAlumno10Controller> logger,
