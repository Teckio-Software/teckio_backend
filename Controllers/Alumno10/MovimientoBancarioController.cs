...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno10Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno10Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno10Controller(
            MovimientoBancarioProceso<Alumno10Context> movimientoBancarioProceso
            )
        {
