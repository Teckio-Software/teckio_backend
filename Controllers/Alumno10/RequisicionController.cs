...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno10Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno10Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno10Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno10Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno10Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno10Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno10Controller(
            ILogger<RequisicionAlumno10Controller> Logger
            , Alumno10Context Context
            , IRequisicionService<Alumno10Context> RequisicionService
            , RequisicionProceso<Alumno10Context> Proceso
            , ObjetoRequisicionProceso<Alumno10Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno10Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/10/970"))
            {
