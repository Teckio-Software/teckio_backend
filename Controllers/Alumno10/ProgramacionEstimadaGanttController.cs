...
namespace SistemaERP.API.Controllers.Alumno10
{
    [Route("api/programacionestimadaGantt/10")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno10Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno10Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno10Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno10Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno10Controller(
            ProgramacionEstimadaGanttProceso<Alumno10Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno10Context> importeSemanalGanttProceso,
