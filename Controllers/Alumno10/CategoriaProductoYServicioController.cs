...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno10Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno10Context> service)
        {
            _service = service;
        }
