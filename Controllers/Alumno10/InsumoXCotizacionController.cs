...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno10Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno10Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno10Controller> _Logger;
        private readonly CotizacionProceso<Alumno10Context> _Proceso;
        private readonly Alumno10Context Context;
        public InsumoXCotizacionAlumno10Controller(
            ILogger<InsumoXCotizacionAlumno10Controller> Logger,
            Alumno10Context Context
            , IInsumoXCotizacionService<Alumno10Context> Service
