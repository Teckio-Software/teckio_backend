...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa10")]
    public class CompraDirectaAlumno10Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno10Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno10Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno10Controller(
            ILogger<CompraDirectaAlumno10Controller> logger,
            Alumno10Context context
            , ICompraDirectaService<Alumno10Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa10")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa10")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa10")]
