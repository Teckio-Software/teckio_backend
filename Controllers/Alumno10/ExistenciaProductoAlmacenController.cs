...
namespace ERP_TECKIO.Controllers.Alumno10
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno10Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno10Context> proces)
        {
            _proceso = proces;
        }
