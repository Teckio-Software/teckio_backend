...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno10Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno10Context> _Service;
        private readonly CotizacionProceso<Alumno10Context> _Proceso;
        private readonly IOrdenCompraService<Alumno10Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno10Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno10Controller> _Logger;
        private readonly Alumno10Context Context;
        public CotizacionAlumno10Controller(

            ILogger<CotizacionAlumno10Controller> Logger
            , Alumno10Context Context
            , ICotizacionService<Alumno10Context> Service
            , IOrdenCompraService<Alumno10Context> OrdenCompraService,
              ITipoImpuestoService<Alumno10Context> TipoImpuestoService
            , CotizacionProceso<Alumno10Context> Proceso)
        {
            _Logger = Logger;
