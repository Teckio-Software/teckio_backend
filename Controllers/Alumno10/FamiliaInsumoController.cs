...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/10")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa10")]
    public class FamiliaInsumoAlumno10Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno10Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno10Controller(
            FamiliaInsumoProceso<Alumno10Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa10")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa10")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa10")]
