...
namespace ERP_TECKIO.Controllers.DemoTeckioAL26
{
    ...
    [Route("api/insumoXproduccion/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL26Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL26Context> proces)
        {
            _proceso = proces;
        }
