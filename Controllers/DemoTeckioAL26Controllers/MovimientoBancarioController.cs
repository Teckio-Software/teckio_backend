...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/26")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL26Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL26Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL26Controller(
            MovimientoBancarioProceso<DemoTeckioAL26Context> movimientoBancarioProceso
            )
        {
