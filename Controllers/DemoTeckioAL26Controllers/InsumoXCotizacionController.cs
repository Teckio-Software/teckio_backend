...
{
    [Route("api/insumoxcotizacion/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL26Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL26Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL26Context> _Proceso;
        private readonly DemoTeckioAL26Context Context;
        public InsumoXCotizacionDemoTeckioAL26Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL26Controller> Logger,
            DemoTeckioAL26Context Context
            , IInsumoXCotizacionService<DemoTeckioAL26Context> Service
