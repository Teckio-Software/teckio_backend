...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL26Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL26Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL26Context> _indirectosProceso;

        public IndirectosDemoTeckioAL26Controller(
                        IConjuntoIndirectosService<DemoTeckioAL26Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL26Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL26Context> indirectosProceso
            )
        {
