...
{
    [Route("api/parametrosImpresionPu/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ParametrosImpresionPuController : ControllerBase
    {

        private readonly ParametrosImpresionPuProceso<DemoTeckioAL26Context> _proceso;

        public ParametrosImpresionPuController(ParametrosImpresionPuProceso<DemoTeckioAL26Context> proceso)
        {
            _proceso = proceso;
        }
