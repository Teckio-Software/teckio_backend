...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL26Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL26Context> _bancoService;

        public BancoDemoTeckioAL26Controller(IBancoService<DemoTeckioAL26Context> bancoService)
        {
