...
{
    [Route("api/factura/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL26Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL26Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL26Controller(
            ObtenFacturaProceso<DemoTeckioAL26Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL26Context> categoriaProductoYServicioService
            )
        {
