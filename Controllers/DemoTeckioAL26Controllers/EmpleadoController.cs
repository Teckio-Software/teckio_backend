...
{
    [Route("api/empleado/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL26Context> _empleadoService;
        public EmpleadoDemoTeckioAL26Controller(
            IEmpleadoService<DemoTeckioAL26Context> empleadoService
            )
        {
