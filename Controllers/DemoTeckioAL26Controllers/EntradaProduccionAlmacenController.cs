...
{
    [Route("api/entradaproduccionalmacen/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL26Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL26Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL26Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL26Context> proceso)
        {
            _proceso = proceso;
        }
