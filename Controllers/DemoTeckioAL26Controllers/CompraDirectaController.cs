...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL26Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL26Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL26Controller(
            ILogger<CompraDirectaDemoTeckioAL26Controller> logger,
            DemoTeckioAL26Context context
            , ICompraDirectaService<DemoTeckioAL26Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
