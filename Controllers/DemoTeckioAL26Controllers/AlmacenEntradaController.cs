...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL26Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL26Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL26Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL26Controller(
            ILogger<AlmacenEntradaDemoTeckioAL26Controller> logger,
            DemoTeckioAL26Context context
            , IAlmacenEntradaService<DemoTeckioAL26Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL26Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL26Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
