...
namespace SistemaERP.API.DemoTeckioAL26Controllers.Procomi
{
    [Route("api/preciounitariodetalle/26")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL26Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL26Controller(
