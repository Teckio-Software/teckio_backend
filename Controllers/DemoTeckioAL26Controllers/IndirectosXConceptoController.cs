...
{
    [Route("api/indirectosXConcepto/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL26Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL26Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL26Controller(
            IIndirectosXConceptoService<DemoTeckioAL26Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL26Context> indirectosXConceptoProceso
            ) { 
