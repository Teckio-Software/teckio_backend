...
{
    [Route("api/programacionestimada/26")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL26Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL26Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL26Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL26Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL26Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL26Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL26Context> precioUnitarioService,
