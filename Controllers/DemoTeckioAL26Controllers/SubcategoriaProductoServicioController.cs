...
namespace ERP_TECKIO.Controllers.DemoTeckioAL26
{
    ...
    [Route("api/subcategoriaProductoServicio/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL26Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL26Context> service)
        {
            _service = service;
        }
