...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL26Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL26Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL26Controller(
            ILogger<TipoPolizaDemoTeckioAL26Controller> logger,
            DemoTeckioAL26Context context
            , ITipoPolizaService<DemoTeckioAL26Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
