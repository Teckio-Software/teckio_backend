...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL26Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL26Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL26Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL26Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL26Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL26Controller(
            ILogger<RequisicionDemoTeckioAL26Controller> Logger
            , DemoTeckioAL26Context Context
            , IRequisicionService<DemoTeckioAL26Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL26Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL26Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL26Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL26Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/26/970"))
            {
