...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL26Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL26Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL26Controller(
            EspecialidadProceso<DemoTeckioAL26Context> especialidadProceso)
        {
