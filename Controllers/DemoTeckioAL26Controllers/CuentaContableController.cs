...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL26Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL26Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL26Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL26Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL26Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL26Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL26Controller(
            ILogger<CuentaContableDemoTeckioAL26Controller> logger,
            DemoTeckioAL26Context context
            , ICuentaContableService<DemoTeckioAL26Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL26Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL26Context> RubroService
            , CuentaContableProceso<DemoTeckioAL26Context> proceso
            )
        {
            Logger = logger;
            Context = context;
