...
{
    [Route("api/ordenventa/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL26Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL26Controller(
            OrdenVentaProceso<DemoTeckioAL26Context> ordenVentaProceso
            ) { 
