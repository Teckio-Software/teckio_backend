...
{
    [Route("api/productoyservicio/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL26Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL26Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL26Context> _process;

        public ProductoYServicioDemoTeckioAL26Controller(IProductoYservicioService<DemoTeckioAL26Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL26Context> process
            )
        {
