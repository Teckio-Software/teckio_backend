...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL26Context> _InsumoProceso;
        public InsumoDemoTeckioAL26Controller(
            InsumoProceso<DemoTeckioAL26Context> insumoProceso)
        {
