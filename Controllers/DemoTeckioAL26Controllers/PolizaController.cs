...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL26Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL26Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL26Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL26Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL26Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL26Controller> _Logger;
        private readonly DemoTeckioAL26Context _Context;
        private readonly PolizaProceso<DemoTeckioAL26Context> _polizaProceso;
        public PolizaDemoTeckioAL26Controller(
            ILogger<PolizaDemoTeckioAL26Controller> logger
            , DemoTeckioAL26Context context
            , IPolizaService<DemoTeckioAL26Context> service
            , IPolizaDetalleService<DemoTeckioAL26Context> detalleService
            , ITipoPolizaService<DemoTeckioAL26Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL26Context> saldosService
