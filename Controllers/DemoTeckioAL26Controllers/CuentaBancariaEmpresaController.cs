...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL26Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL26Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL26Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL26Context> cuentaBancariaEmpresaService,
