...
namespace ERP_TECKIO.Controllers.DemoTeckioAL26
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL26Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL26Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL26Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL26Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL26Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL26Context> porcentajeCesantiaEdadService
            )
        {
