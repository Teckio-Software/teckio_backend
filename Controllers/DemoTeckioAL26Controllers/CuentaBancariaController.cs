...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL26Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL26Context> _servicio;
        public CuentaBancariaDemoTeckioAL26Controller(CuentaBancariaProceso<DemoTeckioAL26Context> _proceso, ICuentaBancariaService<DemoTeckioAL26Context> _servicio
           )
        {
