...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/26")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL26Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL26Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL26Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL26Controller(
            ILogger<ContratistaDemoTeckioAL26Controller> logger,
            DemoTeckioAL26Context context
            , IContratistaService<DemoTeckioAL26Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL26Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
