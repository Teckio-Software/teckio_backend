...
{
    [Route("api/contratos/26")]
    [ApiController]
    public class ContratosDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL26Context> _contratosProceso;
        public ContratosDemoTeckioAL26Controller(
            ContratosProceso<DemoTeckioAL26Context> contratosProceso
            )
        {
