...
namespace ERP_TECKIO.Controllers.DemoTeckioAL26
{
    ...
    [Route("api/produccion/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL26Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL26Context> proceso)
        {
            _proceso = proceso;
        }
