...
{
    [Route("api/cliente/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL26Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL26Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL26Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL26Controller(
            IClientesService<DemoTeckioAL26Context> service
            , ClienteProceso<DemoTeckioAL26Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL26Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
