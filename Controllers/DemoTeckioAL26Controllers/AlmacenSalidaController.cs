...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL26Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL26Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL26Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL26Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL26Controller> logger,
            DemoTeckioAL26Context context
            , IAlmacenSalidaService<DemoTeckioAL26Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL26Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL26Context> Proceso
            )
        {
