...
{
    [Route("api/cotizacion/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL26Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL26Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL26Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL26Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL26Controller> _Logger;
        private readonly DemoTeckioAL26Context Context;
        public CotizacionDemoTeckioAL26Controller(

            ILogger<CotizacionDemoTeckioAL26Controller> Logger
            , DemoTeckioAL26Context Context
            , ICotizacionService<DemoTeckioAL26Context> Service
            , IOrdenCompraService<DemoTeckioAL26Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL26Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL26Context> Proceso)
        {
            _Logger = Logger;
