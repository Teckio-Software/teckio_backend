...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL26Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL26Controller(
            ConceptoProceso<DemoTeckioAL26Context> conceptoProceso)
        {
