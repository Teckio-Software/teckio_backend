...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL26Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL26Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL26Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL26Controller> Logger,
            RequisicionProceso<DemoTeckioAL26Context> Proceso,
            DemoTeckioAL26Context Context
            , IInsumoXRequisicionService<DemoTeckioAL26Context> Service)
        {
            _Logger = Logger;
