...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL26Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL26Controller(
            FamiliaInsumoProceso<DemoTeckioAL26Context> familiaInsumoProceso)
        {
