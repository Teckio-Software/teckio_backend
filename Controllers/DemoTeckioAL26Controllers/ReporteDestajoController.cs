...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL26Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL26Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL26Controller(
            ReporteDestajoProceso<DemoTeckioAL26Context> proceso,
            EstimacionesProceso<DemoTeckioAL26Context> estimacionesProceso
            ) { 
            _proceso = proceso;
