...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL26Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL26Controller(
            ProyectoProceso<DemoTeckioAL26Context> proyectoProceso)
        {
