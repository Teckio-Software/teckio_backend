...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL26Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL26Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL26Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL26Controller(
            ILogger<ExistenciasDemoTeckioAL26Controller> Logger,
            DemoTeckioAL26Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL26Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL26Context> Proceso
            )
        {
            _Logger = Logger;
