...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL26Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL26Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL26Controller(
            TipoInsumoProceso<DemoTeckioAL26Context> tipoInsumoProceso
            )
        {
