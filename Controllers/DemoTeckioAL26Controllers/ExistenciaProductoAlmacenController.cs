...
namespace ERP_TECKIO.Controllers.DemoTeckioAL26
{
    ...
    [Route("api/existenciaproductoalmacen/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL26Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL26Context> proces)
        {
            _proceso = proces;
        }
