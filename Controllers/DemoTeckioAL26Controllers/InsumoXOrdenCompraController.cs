...
{
    [Route("api/insumoxordencompra/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL26Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL26Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL26Controller> _Logger;
        private readonly DemoTeckioAL26Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL26Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL26Controller> Logger,
            DemoTeckioAL26Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL26Context> Service
