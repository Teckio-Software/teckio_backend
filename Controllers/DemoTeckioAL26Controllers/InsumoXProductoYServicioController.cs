...
namespace ERP_TECKIO.Controllers.DemoTeckioAL26
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/26")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL26Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL26Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL26Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL26Context> process)
        {
            _service = service;
            _process = process;
        }
