...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL26Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL26Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL26Controller(
            GeneradoresProceso<DemoTeckioAL26Context> generadoresProceso)
        {
