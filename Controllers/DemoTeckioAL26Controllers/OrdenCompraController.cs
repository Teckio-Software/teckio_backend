...
{
    [Route("api/ordencompra/26")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL26Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL26Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL26Controller> _Logger;
        private readonly DemoTeckioAL26Context Context;
        private readonly PolizaProceso<DemoTeckioAL26Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL26Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL26Controller(
            ILogger<OrdenCompraDemoTeckioAL26Controller> Logger
            , DemoTeckioAL26Context Context
            , IOrdenCompraService<DemoTeckioAL26Context> Service
            , OrdenCompraProceso<DemoTeckioAL26Context> Proceso
            , PolizaProceso<DemoTeckioAL26Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL26Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
