...
namespace SistemaERP.API.Controllers.DemoTeckioAL26
{
    [Route("api/programacionestimadaGantt/26")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL26Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL26Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL26Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL26Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL26Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL26Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL26Context> importeSemanalGanttProceso,
