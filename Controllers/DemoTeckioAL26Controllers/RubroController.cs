...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL26Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL26Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL26Controller> Logger;
        ...
        public RubroDemoTeckioAL26Controller(
            ILogger<RubroDemoTeckioAL26Controller> logger,
            DemoTeckioAL26Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL26Context> service
            )
        {
            //_Service = service;
            Logger = logger;
