...
{
    [Route("api/preciounitario/26")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL26Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL26Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL26Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL26Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL26Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL26Controller(
            PrecioUnitarioProceso<DemoTeckioAL26Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL26Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL26Context> options,
            ExplocionInsumosProceso<DemoTeckioAL26Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL26Context(_Options.Options))
            {
