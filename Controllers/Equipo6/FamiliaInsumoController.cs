...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/familiainsumo/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno44Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno44Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno44Controller(
            FamiliaInsumoProceso<Alumno44Context> familiaInsumoProceso)
        {
