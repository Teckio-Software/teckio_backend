...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentacontable/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno44Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno44Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno44Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno44Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno44Controller(
            ILogger<CuentaContableAlumno44Controller> logger,
            Alumno44Context context
            , ICuentaContableService<Alumno44Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno44Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
