...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno44Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno44Context> _TipoInsumoProceso;

        public TipoInsumoAlumno44Controller(
            TipoInsumoProceso<Alumno44Context> tipoInsumoProceso
            )
        {
