...
namespace SistemaERP.API.Controllers.Alumno44
{
    ...
    public class BancoAlumno44Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno44Context> _bancoService;

        public BancoAlumno44Controller(IBancoService<Alumno44Context> bancoService)
        {
