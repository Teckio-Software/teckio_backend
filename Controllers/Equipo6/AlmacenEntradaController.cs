...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentrada/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno44Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno44Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno44Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno44Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno44Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno44Controller(
            ILogger<AlmacenEntradaAlumno44Controller> logger,
            Alumno44Context context
            , IAlmacenEntradaService<Alumno44Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno44Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno44Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
