...
{
    [Route("api/cotizacion/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno44Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno44Context> _Service;
        private readonly CotizacionProceso<Alumno44Context> _Proceso;
        private readonly IOrdenCompraService<Alumno44Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno44Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno44Controller> _Logger;
        private readonly Alumno44Context Context;
        public CotizacionAlumno44Controller(

            ILogger<CotizacionAlumno44Controller> Logger
            , Alumno44Context Context
            , ICotizacionService<Alumno44Context> Service
            , IOrdenCompraService<Alumno44Context> OrdenCompraService,
              ITipoImpuestoService<Alumno44Context> TipoImpuestoService
            , CotizacionProceso<Alumno44Context> Proceso)
        {
            _Logger = Logger;
