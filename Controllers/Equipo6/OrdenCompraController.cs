...
{
    [Route("api/ordencompra/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno44Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno44Context> _Service;
        private readonly OrdenCompraProceso<Alumno44Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno44Controller> _Logger;
        private readonly Alumno44Context Context;
        public OrdenCompraAlumno44Controller(
            ILogger<OrdenCompraAlumno44Controller> Logger
            , Alumno44Context Context
            , IOrdenCompraService<Alumno44Context> Service
