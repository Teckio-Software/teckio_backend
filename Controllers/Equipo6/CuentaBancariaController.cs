...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno44Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno44Context> _proceso;

        private readonly ICuentaBancariaService<Alumno44Context> _servicio;
        public CuentaBancariaAlumno44Controller(CuentaBancariaProceso<Alumno44Context> _proceso, ICuentaBancariaService<Alumno44Context> _servicio
           )
        {
