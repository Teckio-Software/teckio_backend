...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    public class InsumoAlumno44Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno44Context> _InsumoProceso;
        public InsumoAlumno44Controller(
            InsumoProceso<Alumno44Context> insumoProceso)
        {
