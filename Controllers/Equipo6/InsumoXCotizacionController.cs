...
{
    [Route("api/insumoxcotizacion/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno44Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno44Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno44Controller> _Logger;
        private readonly CotizacionProceso<Alumno44Context> _Proceso;
        private readonly Alumno44Context Context;
        public InsumoXCotizacionAlumno44Controller(
            ILogger<InsumoXCotizacionAlumno44Controller> Logger,
            Alumno44Context Context
            , IInsumoXCotizacionService<Alumno44Context> Service
