...
{
    [Route("api/insumoxordencompra/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno44Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno44Context> _Service;
        private readonly OrdenCompraProceso<Alumno44Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno44Controller> _Logger;
        private readonly Alumno44Context _Context;
        public InsumoXOrdenCompraAlumno44Controller(
            ILogger<InsumoXOrdenCompraAlumno44Controller> Logger,
            Alumno44Context Context
            , IInsumoXOrdenCompraService<Alumno44Context> Service
            , OrdenCompraProceso<Alumno44Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
