...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    public class RubroAlumno44Controller : ControllerBase
    {
        private readonly IRubroService<Alumno44Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno44Controller> Logger;
        ...
        public RubroAlumno44Controller(
            ILogger<RubroAlumno44Controller> logger,
            Alumno44Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno44Context> service
            )
        {
            //_Service = service;
            Logger = logger;
