...
{
    [Route("api/preciounitario/44")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno44Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno44Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno44Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno44Context> _Options;
        public PrecioUnitarioAlumno44Controller(
            PrecioUnitarioProceso<Alumno44Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno44Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno44Context> options
            )
        {
        ...
        {
            using (var db = new Alumno44Context(_Options.Options))
            {
