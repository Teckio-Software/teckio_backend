...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno44Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno44Context> _Service;

        private readonly RequisicionProceso<Alumno44Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno44Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno44Controller(
            ILogger<InsumoXRequisicionAlumno44Controller> Logger,
            RequisicionProceso<Alumno44Context> Proceso,
            Alumno44Context Context
            , IInsumoXRequisicionService<Alumno44Context> Service)
        {
            _Logger = Logger;
