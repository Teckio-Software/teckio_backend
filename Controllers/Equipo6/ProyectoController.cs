...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/proyecto/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno44Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno44Context> _ProyectoProceso;
        public ProyectoAlumno44Controller(
            ProyectoProceso<Alumno44Context> proyectoProceso)
        {
