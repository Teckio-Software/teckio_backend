...
{
    [Route("api/programacionestimada/44")]
    [ApiController]
    public class ProgramacionEstimadaAlumno44Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno44Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno44Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno44Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno44Controller(
            ProgramacionEstimadaProceso<Alumno44Context> programacionEstimadaProceso,
            IProyectoService<Alumno44Context> proyectoProceso,
            IPrecioUnitarioService<Alumno44Context> precioUnitarioService,
