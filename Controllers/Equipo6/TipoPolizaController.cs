...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipopoliza/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno44Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno44Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno44Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno44Controller(
            ILogger<TipoPolizaAlumno44Controller> logger,
            Alumno44Context context
            , ITipoPolizaService<Alumno44Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
