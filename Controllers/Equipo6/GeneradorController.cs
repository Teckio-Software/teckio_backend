...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/generadores/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa35")]
    public class GeneradoresAlumno44Controller : ControllerBase
    {
        private readonly GeneradoresProceso<Alumno44Context> _GeneradoresProceso;
        public GeneradoresAlumno44Controller(
            GeneradoresProceso<Alumno44Context> generadoresProceso)
        {
