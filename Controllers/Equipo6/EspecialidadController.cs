...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialidad/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa35")]
    public class EspecialidadAlumno44Controller : ControllerBase
    {
        private readonly EspecialidadProceso<Alumno44Context> _EspecialidadProceso;
        public EspecialidadAlumno44Controller(
            EspecialidadProceso<Alumno44Context> especialidadProceso)
        {
