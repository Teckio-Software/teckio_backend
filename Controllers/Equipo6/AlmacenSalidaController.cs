...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenSalida/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno44Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno44Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno44Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno44Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno44Controller> Logger;
        ...
        public AlmacenSalidaAlumno44Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno44Controller> logger,
            Alumno44Context context
            , IAlmacenSalidaService<Alumno44Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno44Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno44Context> Proceso
            )
        {
