...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno44Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno44Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno44Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno44Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno44Controller(
            ILogger<AlmacenEntradaInsumoAlumno44Controller> logger,
            Alumno44Context context
            , IInsumoXAlmacenEntradaService<Alumno44Context> AlmacenEntradaDetalle
