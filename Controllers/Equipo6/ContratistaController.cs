...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratista/44")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno44Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno44Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno44Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno44Controller(
            ILogger<ContratistaAlumno44Controller> logger,
            Alumno44Context context
            , IContratistaService<Alumno44Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
