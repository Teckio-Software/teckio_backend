...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/requisicion/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno44Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno44Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno44Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno44Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno44Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno44Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno44Controller(
            ILogger<RequisicionAlumno44Controller> Logger
            , Alumno44Context Context
            , IRequisicionService<Alumno44Context> RequisicionService
            , RequisicionProceso<Alumno44Context> Proceso
            , ObjetoRequisicionProceso<Alumno44Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno44Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
