...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    public class PolizaAlumno44Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno44Context> _Service;
        private readonly IPolizaDetalleService<Alumno44Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno44Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno44Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno44Context> _SaldosService;
        private readonly ILogger<PolizaAlumno44Controller> _Logger;
        private readonly Alumno44Context _Context;
        public PolizaAlumno44Controller(
            ILogger<PolizaAlumno44Controller> logger
            , Alumno44Context context
            , IPolizaService<Alumno44Context> service
            , IPolizaDetalleService<Alumno44Context> detalleService
            , ITipoPolizaService<Alumno44Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno44Context> saldosService
