...
{
    [Route("api/contratos/44")]
    [ApiController]
    public class ContratosAlumno44Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno44Context> _contratosProceso;
        public ContratosAlumno44Controller(
            ContratosProceso<Alumno44Context> contratosProceso
            )
        {
