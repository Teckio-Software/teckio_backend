...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/44")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno44Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno44Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno44Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno44Controller(
            ILogger<CompraDirectaInsumoAlumno44Controller> logger
            , Alumno44Context context
            , IInsumoXCompraDirectaService<Alumno44Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
