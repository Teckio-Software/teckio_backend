...
namespace SistemaERP.API.Alumno44Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/44")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno44Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno44Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno44Controller(
            ILogger<ContratistaCuentaBancariaAlumno44Controller> logger,
