...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL17Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL17Controller(
            ConceptoProceso<DemoTeckioAL17Context> conceptoProceso)
        {
