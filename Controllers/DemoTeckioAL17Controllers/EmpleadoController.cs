...
{
    [Route("api/empleado/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL17Context> _empleadoService;
        public EmpleadoDemoTeckioAL17Controller(
            IEmpleadoService<DemoTeckioAL17Context> empleadoService
            )
        {
