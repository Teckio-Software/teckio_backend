...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL17Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL17Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL17Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL17Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL17Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL17Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL17Controller(
            ILogger<CuentaContableDemoTeckioAL17Controller> logger,
            DemoTeckioAL17Context context
            , ICuentaContableService<DemoTeckioAL17Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL17Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL17Context> RubroService
            , CuentaContableProceso<DemoTeckioAL17Context> proceso
            )
        {
            Logger = logger;
            Context = context;
