...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL17Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL17Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL17Controller(
            EspecialidadProceso<DemoTeckioAL17Context> especialidadProceso)
        {
