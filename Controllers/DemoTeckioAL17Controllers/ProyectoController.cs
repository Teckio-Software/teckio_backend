...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL17Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL17Controller(
            ProyectoProceso<DemoTeckioAL17Context> proyectoProceso)
        {
