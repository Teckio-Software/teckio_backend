...
namespace ERP_TECKIO.Controllers.DemoTeckioAL17
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL17Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL17Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL17Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL17Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL17Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL17Context> porcentajeCesantiaEdadService
            )
        {
