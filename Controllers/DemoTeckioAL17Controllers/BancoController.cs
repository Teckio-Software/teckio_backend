...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL17Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL17Context> _bancoService;

        public BancoDemoTeckioAL17Controller(IBancoService<DemoTeckioAL17Context> bancoService)
        {
