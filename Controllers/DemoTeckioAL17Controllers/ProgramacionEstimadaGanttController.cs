...
namespace SistemaERP.API.Controllers.DemoTeckioAL17
{
    [Route("api/programacionestimadaGantt/17")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL17Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL17Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL17Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL17Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL17Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL17Context> importeSemanalGanttProceso,
