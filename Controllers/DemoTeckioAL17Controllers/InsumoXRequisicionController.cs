...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL17Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL17Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL17Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL17Controller> Logger,
            RequisicionProceso<DemoTeckioAL17Context> Proceso,
            DemoTeckioAL17Context Context
            , IInsumoXRequisicionService<DemoTeckioAL17Context> Service)
        {
            _Logger = Logger;
