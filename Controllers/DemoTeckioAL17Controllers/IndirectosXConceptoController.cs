...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL17Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL17Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL17Controller(
            IIndirectosXConceptoService<DemoTeckioAL17Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL17Context> indirectosXConceptoProceso
            ) { 
