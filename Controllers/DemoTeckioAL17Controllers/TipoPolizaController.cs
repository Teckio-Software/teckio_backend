...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL17Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL17Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL17Controller(
            ILogger<TipoPolizaDemoTeckioAL17Controller> logger,
            DemoTeckioAL17Context context
            , ITipoPolizaService<DemoTeckioAL17Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
