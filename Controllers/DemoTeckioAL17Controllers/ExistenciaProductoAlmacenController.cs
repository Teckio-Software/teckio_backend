...
namespace ERP_TECKIO.Controllers.DemoTeckioAL17
{
    ...
    [Route("api/existenciaproductoalmacen/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL17Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL17Context> proces)
        {
            _proceso = proces;
        }
