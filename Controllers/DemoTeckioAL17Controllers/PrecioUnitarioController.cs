...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioAL17Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL17Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL17Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL17Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL17Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL17Controller(
            PrecioUnitarioProceso<DemoTeckioAL17Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL17Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL17Context> options,
            ExplocionInsumosProceso<DemoTeckioAL17Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL17Context(_Options.Options))
            {
