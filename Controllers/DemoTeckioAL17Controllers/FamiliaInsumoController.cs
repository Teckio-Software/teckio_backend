...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL17Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL17Controller(
            FamiliaInsumoProceso<DemoTeckioAL17Context> familiaInsumoProceso)
        {
