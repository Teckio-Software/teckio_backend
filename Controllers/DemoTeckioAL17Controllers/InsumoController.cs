...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL17Context> _InsumoProceso;
        public InsumoDemoTeckioAL17Controller(
            InsumoProceso<DemoTeckioAL17Context> insumoProceso)
        {
