...
{
    [Route("api/programacionestimada/17")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL17Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL17Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL17Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL17Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL17Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL17Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL17Context> precioUnitarioService,
