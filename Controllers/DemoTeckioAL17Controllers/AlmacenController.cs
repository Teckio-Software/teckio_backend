...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL17Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL17Context> _almacenProceso;
        public AlmacenDemoTeckioAL17Controller(
            IAlmacenService<DemoTeckioAL17Context> almacenServicio, AlmacenProceso<DemoTeckioAL17Context> almacenProceso)
        {
