...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL17Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL17Controller(
            TipoInsumoProceso<DemoTeckioAL17Context> tipoInsumoProceso
            )
        {
