...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/17")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL17Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL17Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL17Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL17Controller(
            ILogger<ContratistaDemoTeckioAL17Controller> logger,
            DemoTeckioAL17Context context
            , IContratistaService<DemoTeckioAL17Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL17Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
