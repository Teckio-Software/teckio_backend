...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL17Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL17Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL17Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL17Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL17Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL17Controller(
            ILogger<RequisicionDemoTeckioAL17Controller> Logger
            , DemoTeckioAL17Context Context
            , IRequisicionService<DemoTeckioAL17Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL17Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL17Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL17Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL17Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/17/970"))
            {
