...
{
    [Route("api/indirectos/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL17Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL17Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL17Context> _indirectosProceso;

        public IndirectosDemoTeckioAL17Controller(
                        IConjuntoIndirectosService<DemoTeckioAL17Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL17Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL17Context> indirectosProceso
            )
        {
