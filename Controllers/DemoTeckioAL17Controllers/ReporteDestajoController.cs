...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL17Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL17Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL17Controller(
            ReporteDestajoProceso<DemoTeckioAL17Context> proceso,
            EstimacionesProceso<DemoTeckioAL17Context> estimacionesProceso
            ) { 
            _proceso = proceso;
