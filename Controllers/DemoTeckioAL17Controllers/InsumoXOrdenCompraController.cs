...
{
    [Route("api/insumoxordencompra/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL17Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL17Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL17Controller> _Logger;
        private readonly DemoTeckioAL17Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL17Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL17Controller> Logger,
            DemoTeckioAL17Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL17Context> Service
