...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL17Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL17Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL17Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL17Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL17Controller> logger,
            DemoTeckioAL17Context context
            , IAlmacenSalidaService<DemoTeckioAL17Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL17Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL17Context> Proceso
            )
        {
