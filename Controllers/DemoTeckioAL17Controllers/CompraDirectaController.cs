...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL17Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL17Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL17Controller(
            ILogger<CompraDirectaDemoTeckioAL17Controller> logger,
            DemoTeckioAL17Context context
            , ICompraDirectaService<DemoTeckioAL17Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
