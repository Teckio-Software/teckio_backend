...
namespace ERP_TECKIO.Controllers.DemoTeckioAL17
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/17")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL17Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL17Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL17Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL17Context> process)
        {
            _service = service;
            _process = process;
        }
