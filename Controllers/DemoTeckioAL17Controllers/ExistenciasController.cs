...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL17Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL17Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL17Controller(
            ILogger<ExistenciasDemoTeckioAL17Controller> Logger,
            DemoTeckioAL17Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL17Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL17Context> Proceso
            )
        {
            _Logger = Logger;
