...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL17Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL17Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL17Controller(
            ICuentaBancariaClienteService<DemoTeckioAL17Context> cuentaBancariaClienteService,
