...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL17Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL17Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL17Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL17Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL17Controller(
            ILogger<AlmacenEntradaDemoTeckioAL17Controller> logger,
            DemoTeckioAL17Context context
            , IAlmacenEntradaService<DemoTeckioAL17Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL17Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL17Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
