...
namespace ERP_TECKIO.Controllers.DemoTeckioAL17
{
    ...
    [Route("api/produccion/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL17Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL17Context> proceso)
        {
            _proceso = proceso;
        }
