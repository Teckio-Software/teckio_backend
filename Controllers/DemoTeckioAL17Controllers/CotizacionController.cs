...
{
    [Route("api/cotizacion/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL17Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL17Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL17Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL17Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL17Controller> _Logger;
        private readonly DemoTeckioAL17Context Context;
        public CotizacionDemoTeckioAL17Controller(

            ILogger<CotizacionDemoTeckioAL17Controller> Logger
            , DemoTeckioAL17Context Context
            , ICotizacionService<DemoTeckioAL17Context> Service
            , IOrdenCompraService<DemoTeckioAL17Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL17Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL17Context> Proceso)
        {
            _Logger = Logger;
