...
{
    [Route("api/ordencompra/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL17Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL17Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL17Controller> _Logger;
        ...
        public OrdenCompraDemoTeckioAL17Controller(
            ILogger<OrdenCompraDemoTeckioAL17Controller> Logger
            , DemoTeckioAL17Context Context
            , IOrdenCompraService<DemoTeckioAL17Context> Service
            , OrdenCompraProceso<DemoTeckioAL17Context> Proceso
