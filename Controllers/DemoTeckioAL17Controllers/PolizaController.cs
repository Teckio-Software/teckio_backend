...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL17Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL17Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL17Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL17Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL17Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL17Controller> _Logger;
        private readonly DemoTeckioAL17Context _Context;
        private readonly PolizaProceso<DemoTeckioAL17Context> _polizaProceso;
        public PolizaDemoTeckioAL17Controller(
            ILogger<PolizaDemoTeckioAL17Controller> logger
            , DemoTeckioAL17Context context
            , IPolizaService<DemoTeckioAL17Context> service
            , IPolizaDetalleService<DemoTeckioAL17Context> detalleService
            , ITipoPolizaService<DemoTeckioAL17Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL17Context> saldosService
            , ICuentaContableService<DemoTeckioAL17Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL17Context> polizaProceso
            )
        {
