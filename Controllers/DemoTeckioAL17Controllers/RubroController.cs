...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL17Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL17Controller> Logger;
        ...
        public RubroDemoTeckioAL17Controller(
            ILogger<RubroDemoTeckioAL17Controller> logger,
            DemoTeckioAL17Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL17Context> service
            )
        {
            //_Service = service;
            Logger = logger;
