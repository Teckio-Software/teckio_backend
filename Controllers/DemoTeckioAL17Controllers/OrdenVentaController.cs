...
{
    [Route("api/ordenventa/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL17Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL17Controller(
            OrdenVentaProceso<DemoTeckioAL17Context> ordenVentaProceso
            ) { 
