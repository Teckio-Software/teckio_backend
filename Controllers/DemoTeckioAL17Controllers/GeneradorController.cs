...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL17Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL17Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL17Controller(
            GeneradoresProceso<DemoTeckioAL17Context> generadoresProceso)
        {
