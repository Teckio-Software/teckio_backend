...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL17Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL17Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL17Context> _servicio;
        public CuentaBancariaDemoTeckioAL17Controller(CuentaBancariaProceso<DemoTeckioAL17Context> _proceso, ICuentaBancariaService<DemoTeckioAL17Context> _servicio
           )
        {
