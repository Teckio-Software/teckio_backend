...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL17Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL17Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL17Controller> _Logger;
        private readonly DemoTeckioAL17Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL17Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL17Controller> logger
            , DemoTeckioAL17Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL17Context> service
