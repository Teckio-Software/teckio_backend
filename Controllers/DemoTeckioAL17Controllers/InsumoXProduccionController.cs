...
namespace ERP_TECKIO.Controllers.DemoTeckioAL17
{
    ...
    [Route("api/insumoXproduccion/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL17Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL17Context> proces)
        {
            _proceso = proces;
        }
