...
{
    [Route("api/insumoxcotizacion/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL17Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL17Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL17Context> _Proceso;
        private readonly DemoTeckioAL17Context Context;
        public InsumoXCotizacionDemoTeckioAL17Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL17Controller> Logger,
            DemoTeckioAL17Context Context
            , IInsumoXCotizacionService<DemoTeckioAL17Context> Service
