...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioAL17Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL17Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL17Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL17Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL17Controller> logger
            , DemoTeckioAL17Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL17Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
