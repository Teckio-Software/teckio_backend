...
namespace SistemaERP.API.DemoTeckioAL17Controllers.Procomi
{
    [Route("api/preciounitariodetalle/17")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL17Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL17Controller(
