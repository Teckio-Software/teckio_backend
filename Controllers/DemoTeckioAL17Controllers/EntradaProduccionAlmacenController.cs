...
{
    [Route("api/entradaproduccionalmacen/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL17Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL17Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL17Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL17Context> proceso)
        {
            _proceso = proceso;
        }
