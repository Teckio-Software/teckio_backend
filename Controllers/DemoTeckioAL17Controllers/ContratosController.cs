...
{
    [Route("api/contratos/17")]
    [ApiController]
    public class ContratosDemoTeckioAL17Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL17Context> _contratosProceso;
        public ContratosDemoTeckioAL17Controller(
            ContratosProceso<DemoTeckioAL17Context> contratosProceso
            )
        {
