...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/17")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL17Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL17Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL17Controller(
            MovimientoBancarioProceso<DemoTeckioAL17Context> movimientoBancarioProceso
            )
        {
