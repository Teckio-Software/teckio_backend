...
namespace ERP_TECKIO.Controllers.DemoTeckioAL17
{
    ...
    [Route("api/categoriaProductoServicio/17")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CategoriaProductoYServicioController: ControllerBase
    {
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL17Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<DemoTeckioAL17Context> service)
        {
            _service = service;
        }
