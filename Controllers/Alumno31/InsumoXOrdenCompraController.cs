...
{
    [Route("api/insumoxordencompra/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno31Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno31Context> _Service;
        private readonly OrdenCompraProceso<Alumno31Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno31Controller> _Logger;
        private readonly Alumno31Context _Context;
        public InsumoXOrdenCompraAlumno31Controller(
            ILogger<InsumoXOrdenCompraAlumno31Controller> Logger,
            Alumno31Context Context
            , IInsumoXOrdenCompraService<Alumno31Context> Service
