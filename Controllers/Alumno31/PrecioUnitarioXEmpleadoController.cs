...
{
    [Route("api/precioUnitarioXEmpleado/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoAlumno31Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno31Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno31Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno31Controller(
            IPrecioUnitarioXEmpleadoService<Alumno31Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno31Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
