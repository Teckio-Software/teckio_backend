...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/almacenSalida/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno31Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno31Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno31Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno31Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno31Controller> Logger;
        ...
        public AlmacenSalidaAlumno31Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno31Controller> logger,
            Alumno31Context context
            , IAlmacenSalidaService<Alumno31Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno31Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno31Context> Proceso
            )
        {
