...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa31")]
    public class InsumoXContratistaAlumno31Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno31Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno31Controller(
            ILogger<InsumoXContratistaAlumno31Controller> logger,
