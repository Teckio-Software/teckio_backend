...
{
    [Route("api/programacionestimada/31")]
    [ApiController]
    public class ProgramacionEstimadaAlumno31Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno31Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno31Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno31Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno31Controller(
            ProgramacionEstimadaProceso<Alumno31Context> programacionEstimadaProceso,
            IProyectoService<Alumno31Context> proyectoProceso,
            IPrecioUnitarioService<Alumno31Context> precioUnitarioService,
