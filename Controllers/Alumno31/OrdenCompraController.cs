...
{
    [Route("api/ordencompra/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno31Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno31Context> _Service;
        private readonly OrdenCompraProceso<Alumno31Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno31Controller> _Logger;
        private readonly Alumno31Context Context;
        private readonly PolizaProceso<Alumno31Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno31Context> _obtenFacturaProceso;

        public OrdenCompraAlumno31Controller(
            ILogger<OrdenCompraAlumno31Controller> Logger
            , Alumno31Context Context
            , IOrdenCompraService<Alumno31Context> Service
            , OrdenCompraProceso<Alumno31Context> Proceso
            , PolizaProceso<Alumno31Context> polizaProceso
            , ObtenFacturaProceso<Alumno31Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
