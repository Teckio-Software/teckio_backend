...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/31")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno31Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno31Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno31Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno31Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno31Controller(
            ILogger<ContratistaAlumno31Controller> logger,
            Alumno31Context context
            , IContratistaService<Alumno31Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno31Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
