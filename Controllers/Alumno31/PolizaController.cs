...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno31Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno31Context> _Service;
        private readonly IPolizaDetalleService<Alumno31Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno31Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno31Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno31Context> _SaldosService;
        private readonly ILogger<PolizaAlumno31Controller> _Logger;
        private readonly Alumno31Context _Context;
        public PolizaAlumno31Controller(
            ILogger<PolizaAlumno31Controller> logger
            , Alumno31Context context
            , IPolizaService<Alumno31Context> service
            , IPolizaDetalleService<Alumno31Context> detalleService
            , ITipoPolizaService<Alumno31Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno31Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa31")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa31")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa31")]
