...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa31")]
    public class EspecialIdadXContratistaAlumno31Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno31Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno31Controller(
            ILogger<EspecialIdadXContratistaAlumno31Controller> logger,
