...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa31")]
    public class CompraDirectaInsumoAlumno31Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno31Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno31Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno31Controller(
            ILogger<CompraDirectaInsumoAlumno31Controller> logger
            , Alumno31Context context
            , IInsumoXCompraDirectaService<Alumno31Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
