...
namespace ERP_TECKIO
{
    ...
    [Route("api/rubro/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionRubro-Empresa31")]
    public class RubroAlumno31Controller : ControllerBase
    {
        private readonly IRubroService<Alumno31Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno31Controller> Logger;
        ...
        public RubroAlumno31Controller(
            ILogger<RubroAlumno31Controller> logger,
            Alumno31Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno31Context> service
            )
        {
            //_Service = service;
            Logger = logger;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearRubro-Empresa31")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarRubro-Empresa31")]
