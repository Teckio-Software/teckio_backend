...
namespace ERP_TECKIO.API.Controllers.Alumno31
{
    ...
    public class BancoAlumno31Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno31Context> _bancoService;

        public BancoAlumno31Controller(IBancoService<Alumno31Context> bancoService)
        {
