...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno31Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno31Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno31Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno31Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno31Controller(
            ILogger<AlmacenEntradaInsumoAlumno31Controller> logger,
            Alumno31Context context
            , IInsumoXAlmacenEntradaService<Alumno31Context> AlmacenEntradaDetalle
