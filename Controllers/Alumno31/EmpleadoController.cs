...
{
    [Route("api/empleado/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoAlumno31Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno31Context> _empleadoService;
        public EmpleadoAlumno31Controller(
            IEmpleadoService<Alumno31Context> empleadoService
            )
        {
