...
{
    [Route("api/insumoxcotizacion/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno31Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno31Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno31Controller> _Logger;
        private readonly CotizacionProceso<Alumno31Context> _Proceso;
        private readonly Alumno31Context Context;
        public InsumoXCotizacionAlumno31Controller(
            ILogger<InsumoXCotizacionAlumno31Controller> Logger,
            Alumno31Context Context
            , IInsumoXCotizacionService<Alumno31Context> Service
