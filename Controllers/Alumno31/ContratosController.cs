...
{
    [Route("api/contratos/31")]
    [ApiController]
    public class ContratosAlumno31Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno31Context> _contratosProceso;
        public ContratosAlumno31Controller(
            ContratosProceso<Alumno31Context> contratosProceso
            )
        {
