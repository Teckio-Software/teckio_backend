...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno31Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno31Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno31Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno31Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno31Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno31Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno31Controller(
            ILogger<RequisicionAlumno31Controller> Logger
            , Alumno31Context Context
            , IRequisicionService<Alumno31Context> RequisicionService
            , RequisicionProceso<Alumno31Context> Proceso
            , ObjetoRequisicionProceso<Alumno31Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno31Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/31/970"))
            {
