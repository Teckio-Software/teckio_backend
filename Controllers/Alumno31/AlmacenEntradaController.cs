...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno31Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno31Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno31Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno31Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno31Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno31Controller(
            ILogger<AlmacenEntradaAlumno31Controller> logger,
            Alumno31Context context
            , IAlmacenEntradaService<Alumno31Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno31Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno31Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
