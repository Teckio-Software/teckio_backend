...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioAlumno31Controller : ControllerBase
    {
        ...
        private readonly IProgramacionEstimadaService<Alumno31Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno31Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno31Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno31Controller(
            PrecioUnitarioProceso<Alumno31Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno31Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno31Context> options,
            ExplocionInsumosProceso<Alumno31Context> explocionInsumosProceso
            )
        {
