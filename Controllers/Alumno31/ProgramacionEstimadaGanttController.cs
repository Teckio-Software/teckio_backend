...
namespace SistemaERP.API.Controllers.Alumno31
{
    [Route("api/programacionestimadaGantt/31")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno31Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno31Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno31Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno31Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno31Controller(
            ProgramacionEstimadaGanttProceso<Alumno31Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno31Context> importeSemanalGanttProceso,
            DbContextOptionsBuilder<Alumno31Context> options
            )
        {
        ...
        {
            using (var db = new Alumno31Context(_Options.Options))
            {
