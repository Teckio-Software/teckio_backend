...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa31")]
    public class FamiliaInsumoAlumno31Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno31Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno31Controller(
            FamiliaInsumoProceso<Alumno31Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa31")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa31")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa31")]
