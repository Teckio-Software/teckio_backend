...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno31Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno31Context> _proceso;

        private readonly ICuentaBancariaService<Alumno31Context> _servicio;
        public CuentaBancariaAlumno31Controller(CuentaBancariaProceso<Alumno31Context> _proceso, ICuentaBancariaService<Alumno31Context> _servicio
           )
        {
