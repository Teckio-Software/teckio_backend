...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa31")]
    public class CompraDirectaAlumno31Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno31Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno31Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno31Controller(
            ILogger<CompraDirectaAlumno31Controller> logger,
            Alumno31Context context
            , ICompraDirectaService<Alumno31Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa31")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa31")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa31")]
