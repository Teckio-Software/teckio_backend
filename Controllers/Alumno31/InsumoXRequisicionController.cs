...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno31Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno31Context> _Service;

        private readonly RequisicionProceso<Alumno31Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno31Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno31Controller(
            ILogger<InsumoXRequisicionAlumno31Controller> Logger,
            RequisicionProceso<Alumno31Context> Proceso,
            Alumno31Context Context
            , IInsumoXRequisicionService<Alumno31Context> Service)
        {
            _Logger = Logger;
