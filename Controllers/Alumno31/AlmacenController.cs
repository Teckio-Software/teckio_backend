...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno31Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno31Context> _almacenServicio;

        public AlmacenAlumno31Controller(
            IAlmacenService<Alumno31Context> almacenServicio)
        {
