...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/31")]
    [ApiController]
    public class MovimientoBancarioAlumno31Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno31Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno31Controller(
            MovimientoBancarioProceso<Alumno31Context> movimientoBancarioProceso
            )
        {
