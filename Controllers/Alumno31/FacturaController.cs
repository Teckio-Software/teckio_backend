...
namespace ERP_TECKIO.Controllers.Alumno31
{
    [Route("api/factura/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaAlumno31Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno31Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno31Context> _categoriaProductoYServicioService;
        public FacturaAlumno31Controller(
            ObtenFacturaProceso<Alumno31Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno31Context> categoriaProductoYServicioService
            )
        {
