...
{
    [Route("api/cliente/31")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno31Controller : ControllerBase
    {
        private readonly IClientesService<Alumno31Context> _Service;

        private readonly ClienteProceso<Alumno31Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno31Context> _clientesCuentasContablesProceso;
        public ClienteAlumno31Controller(
            IClientesService<Alumno31Context> service
            , ClienteProceso<Alumno31Context> proceso,
            ClienteCuentasContablesProceso<Alumno31Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
