...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL13Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL13Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL13Controller(
            IIndirectosXConceptoService<DemoTeckioAL13Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL13Context> indirectosXConceptoProceso
            ) { 
