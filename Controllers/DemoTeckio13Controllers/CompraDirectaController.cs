...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL13Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL13Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL13Controller(
            ILogger<CompraDirectaDemoTeckioAL13Controller> logger,
            DemoTeckioAL13Context context
            , ICompraDirectaService<DemoTeckioAL13Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
