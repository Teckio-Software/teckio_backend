...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL13Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL13Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL13Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL13Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL13Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL13Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL13Context> precioUnitarioService,
