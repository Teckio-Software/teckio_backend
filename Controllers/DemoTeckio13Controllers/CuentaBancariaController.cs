...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL13Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL13Context> _servicio;
        public CuentaBancariaDemoTeckioAL13Controller(CuentaBancariaProceso<DemoTeckioAL13Context> _proceso, ICuentaBancariaService<DemoTeckioAL13Context> _servicio
           )
        {
