...
{
    [Route("api/precioUnitarioXEmpleado/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL13Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL13Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL13Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL13Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL13Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
