...
namespace SistemaERP.API.DemoTeckioAL13Controllers.Procomi
{
    [Route("api/preciounitariodetalle/13")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL13Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL13Controller(
