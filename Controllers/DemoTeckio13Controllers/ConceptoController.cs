...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL13Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL13Controller(
            ConceptoProceso<DemoTeckioAL13Context> conceptoProceso)
        {
