...
{
    [Route("api/empleado/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL13Context> _empleadoService;
        public EmpleadoDemoTeckioAL13Controller(
            IEmpleadoService<DemoTeckioAL13Context> empleadoService
            )
        {
