...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL13Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL13Controller(
            FamiliaInsumoProceso<DemoTeckioAL13Context> familiaInsumoProceso)
        {
