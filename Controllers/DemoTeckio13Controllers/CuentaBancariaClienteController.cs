...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL13Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL13Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL13Controller(
            ICuentaBancariaClienteService<DemoTeckioAL13Context> cuentaBancariaClienteService,
