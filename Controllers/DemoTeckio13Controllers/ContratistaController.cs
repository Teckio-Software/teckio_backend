...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/13")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL13Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL13Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL13Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL13Controller(
            ILogger<ContratistaDemoTeckioAL13Controller> logger,
            DemoTeckioAL13Context context
            , IContratistaService<DemoTeckioAL13Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL13Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
