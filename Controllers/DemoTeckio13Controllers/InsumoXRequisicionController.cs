...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL13Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL13Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL13Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL13Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL13Controller> Logger,
            RequisicionProceso<DemoTeckioAL13Context> Proceso,
            DemoTeckioAL13Context Context
            , IInsumoXRequisicionService<DemoTeckioAL13Context> Service)
        {
            _Logger = Logger;
