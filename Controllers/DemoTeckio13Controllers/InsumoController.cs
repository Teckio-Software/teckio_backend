...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL13Context> _InsumoProceso;
        public InsumoDemoTeckioAL13Controller(
            InsumoProceso<DemoTeckioAL13Context> insumoProceso)
        {
