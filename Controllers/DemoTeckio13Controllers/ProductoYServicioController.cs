...
namespace ERP_TECKIO.Controllers.DemoTeckioAL13
{
    ...
    public class ProductoYServicioDemoTeckioAL13Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL13Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL13Context> _process;

        public ProductoYServicioDemoTeckioAL13Controller(IProductoYservicioService<DemoTeckioAL13Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL13Context> process
            )
        {
