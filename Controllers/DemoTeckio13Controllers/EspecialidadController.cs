...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL13Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL13Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL13Controller(
            EspecialidadProceso<DemoTeckioAL13Context> especialidadProceso)
        {
