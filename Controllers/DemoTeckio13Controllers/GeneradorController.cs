...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL13Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL13Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL13Controller(
            GeneradoresProceso<DemoTeckioAL13Context> generadoresProceso)
        {
