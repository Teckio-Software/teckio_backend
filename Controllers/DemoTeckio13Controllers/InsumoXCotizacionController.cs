...
{
    [Route("api/insumoxcotizacion/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL13Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL13Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL13Context> _Proceso;
        private readonly DemoTeckioAL13Context Context;
        public InsumoXCotizacionDemoTeckioAL13Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL13Controller> Logger,
            DemoTeckioAL13Context Context
            , IInsumoXCotizacionService<DemoTeckioAL13Context> Service
