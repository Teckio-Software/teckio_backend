...
namespace ERP_TECKIO.Controllers.DemoTeckioAL13
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL13Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL13Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL13Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL13Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL13Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL13Context> porcentajeCesantiaEdadService
            )
        {
