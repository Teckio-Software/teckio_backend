...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL13Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL13Context> _bancoService;

        public BancoDemoTeckioAL13Controller(IBancoService<DemoTeckioAL13Context> bancoService)
        {
