...
{
    [Route("api/entradaproduccionalmacen/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL13Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL13Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL13Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL13Context> proceso)
        {
            _proceso = proceso;
        }
