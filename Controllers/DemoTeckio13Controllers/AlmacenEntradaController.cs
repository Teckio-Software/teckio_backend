...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL13Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL13Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL13Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL13Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL13Controller(
            ILogger<AlmacenEntradaDemoTeckioAL13Controller> logger,
            DemoTeckioAL13Context context
            , IAlmacenEntradaService<DemoTeckioAL13Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL13Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL13Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
