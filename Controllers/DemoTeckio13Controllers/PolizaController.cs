...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL13Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL13Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL13Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL13Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL13Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL13Controller> _Logger;
        private readonly DemoTeckioAL13Context _Context;
        private readonly PolizaProceso<DemoTeckioAL13Context> _polizaProceso;
        public PolizaDemoTeckioAL13Controller(
            ILogger<PolizaDemoTeckioAL13Controller> logger
            , DemoTeckioAL13Context context
            , IPolizaService<DemoTeckioAL13Context> service
            , IPolizaDetalleService<DemoTeckioAL13Context> detalleService
            , ITipoPolizaService<DemoTeckioAL13Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL13Context> saldosService
            , ICuentaContableService<DemoTeckioAL13Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL13Context> polizaProceso
            )
        {
