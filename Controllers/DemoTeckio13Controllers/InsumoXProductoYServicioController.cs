...
namespace ERP_TECKIO.Controllers.DemoTeckioAL13
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/13")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL13Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL13Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL13Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL13Context> process)
        {
            _service = service;
            _process = process;
        }
