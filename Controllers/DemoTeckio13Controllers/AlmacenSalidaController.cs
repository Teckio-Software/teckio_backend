...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL13Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL13Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL13Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL13Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL13Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL13Controller> logger,
            DemoTeckioAL13Context context
            , IAlmacenSalidaService<DemoTeckioAL13Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL13Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL13Context> Proceso
            )
        {
