...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL13Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL13Controller> Logger;
        ...
        public RubroDemoTeckioAL13Controller(
            ILogger<RubroDemoTeckioAL13Controller> logger,
            DemoTeckioAL13Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL13Context> service
            )
        {
            //_Service = service;
            Logger = logger;
