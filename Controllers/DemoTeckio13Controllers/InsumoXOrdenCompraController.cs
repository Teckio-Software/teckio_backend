...
{
    [Route("api/insumoxordencompra/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL13Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL13Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL13Controller> _Logger;
        private readonly DemoTeckioAL13Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL13Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL13Controller> Logger,
            DemoTeckioAL13Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL13Context> Service
