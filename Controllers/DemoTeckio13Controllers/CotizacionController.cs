...
{
    [Route("api/cotizacion/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL13Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL13Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL13Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL13Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL13Controller> _Logger;
        private readonly DemoTeckioAL13Context Context;
        public CotizacionDemoTeckioAL13Controller(

            ILogger<CotizacionDemoTeckioAL13Controller> Logger
            , DemoTeckioAL13Context Context
            , ICotizacionService<DemoTeckioAL13Context> Service
            , IOrdenCompraService<DemoTeckioAL13Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL13Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL13Context> Proceso)
        {
            _Logger = Logger;
