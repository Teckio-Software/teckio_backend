...
namespace ERP_TECKIO.Controllers.DemoTeckioAL13
{
    ...
    [Route("api/produccion/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL13Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL13Context> proceso)
        {
            _proceso = proceso;
        }
