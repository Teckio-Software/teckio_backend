...
{
    [Route("api/reportesdestajo/13")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL13Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL13Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL13Controller(
            ReporteDestajoProceso<DemoTeckioAL13Context> proceso,
            EstimacionesProceso<DemoTeckioAL13Context> estimacionesProceso
            ) { 
            _proceso = proceso;
