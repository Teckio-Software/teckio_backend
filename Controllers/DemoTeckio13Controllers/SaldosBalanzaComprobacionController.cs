...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL13Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL13Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL13Controller> _Logger;
        private readonly DemoTeckioAL13Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL13Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL13Controller> logger
            , DemoTeckioAL13Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL13Context> service
