...
{
    [Route("api/ordenventa/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL13Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL13Controller(
            OrdenVentaProceso<DemoTeckioAL13Context> ordenVentaProceso
            ) { 
