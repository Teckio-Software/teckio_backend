...
{
    [Route("api/ordencompra/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL13Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL13Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL13Controller> _Logger;
        ...
        public OrdenCompraDemoTeckioAL13Controller(
            ILogger<OrdenCompraDemoTeckioAL13Controller> Logger
            , DemoTeckioAL13Context Context
            , IOrdenCompraService<DemoTeckioAL13Context> Service
            , OrdenCompraProceso<DemoTeckioAL13Context> Proceso
