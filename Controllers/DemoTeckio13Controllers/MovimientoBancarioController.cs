...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/13")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL13Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL13Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL13Controller(
            MovimientoBancarioProceso<DemoTeckioAL13Context> movimientoBancarioProceso
            )
        {
