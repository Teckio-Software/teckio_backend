...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL13Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL13Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL13Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL13Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL13Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL13Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL13Controller(
            ILogger<CuentaContableDemoTeckioAL13Controller> logger,
            DemoTeckioAL13Context context
            , ICuentaContableService<DemoTeckioAL13Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL13Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL13Context> RubroService
            , CuentaContableProceso<DemoTeckioAL13Context> proceso
            )
        {
            Logger = logger;
            Context = context;
