...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL13Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL13Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL13Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL13Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL13Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL13Controller(
            ILogger<RequisicionDemoTeckioAL13Controller> Logger
            , DemoTeckioAL13Context Context
            , IRequisicionService<DemoTeckioAL13Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL13Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL13Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL13Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL13Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/13/1370"))
            {
