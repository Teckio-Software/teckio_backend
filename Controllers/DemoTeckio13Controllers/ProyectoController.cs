...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL13Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL13Controller(
            ProyectoProceso<DemoTeckioAL13Context> proyectoProceso)
        {
