...
{
    [Route("api/preciounitario/13")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL13Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL13Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL13Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL13Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL13Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL13Controller(
            PrecioUnitarioProceso<DemoTeckioAL13Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL13Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL13Context> options,
            ExplocionInsumosProceso<DemoTeckioAL13Context> explocionInsumosProceso
            )
        {
