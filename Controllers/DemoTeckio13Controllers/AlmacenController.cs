...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL13Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL13Context> _almacenProceso;

        public AlmacenDemoTeckioAL13Controller(
            IAlmacenService<DemoTeckioAL13Context> almacenServicio, AlmacenProceso<DemoTeckioAL13Context> almacenProceso)
        {
