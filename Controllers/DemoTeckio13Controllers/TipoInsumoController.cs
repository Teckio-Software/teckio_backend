...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL13Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL13Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL13Controller(
            TipoInsumoProceso<DemoTeckioAL13Context> tipoInsumoProceso
            )
        {
