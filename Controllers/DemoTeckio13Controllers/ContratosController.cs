...
{
    [Route("api/contratos/13")]
    [ApiController]
    public class ContratosDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL13Context> _contratosProceso;
        public ContratosDemoTeckioAL13Controller(
            ContratosProceso<DemoTeckioAL13Context> contratosProceso
            )
        {
