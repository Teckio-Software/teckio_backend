...
namespace ERP_TECKIO.Controllers.DemoTeckioAL13
{
    ...
    [Route("api/existenciaproductoalmacen/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL13Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL13Context> proces)
        {
            _proceso = proces;
        }
