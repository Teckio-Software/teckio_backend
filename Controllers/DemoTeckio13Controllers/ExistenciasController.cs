...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasDemoTeckioAL13Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL13Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL13Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL13Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL13Controller(
            ILogger<ExistenciasDemoTeckioAL13Controller> Logger,
            DemoTeckioAL13Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL13Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL13Context> Proceso
            )
        {
            _Logger = Logger;
