...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL13Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL13Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL13Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL13Controller(
            ILogger<TipoPolizaDemoTeckioAL13Controller> logger,
            DemoTeckioAL13Context context
            , ITipoPolizaService<DemoTeckioAL13Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
