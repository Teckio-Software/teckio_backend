...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno08Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno08Context> _empleadoService;
        public EmpleadoAlumno08Controller(
            IEmpleadoService<Alumno08Context> empleadoService
            )
        {
