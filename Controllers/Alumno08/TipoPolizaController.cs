...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa8")]
    public class TipoPolizaAlumno08Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno08Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno08Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno08Controller(
            ILogger<TipoPolizaAlumno08Controller> logger,
            Alumno08Context context
            , ITipoPolizaService<Alumno08Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa8")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa8")]
