...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno08Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno08Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno08Controller> Logger;
        /// <summary>
