...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa8")]
    public class InsumoXContratistaAlumno08Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno08Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno08Controller(
            ILogger<InsumoXContratistaAlumno08Controller> logger,
