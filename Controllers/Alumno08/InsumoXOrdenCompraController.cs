...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno08Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno08Context> _Service;
        private readonly OrdenCompraProceso<Alumno08Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno08Controller> _Logger;
        private readonly Alumno08Context _Context;
        public InsumoXOrdenCompraAlumno08Controller(
            ILogger<InsumoXOrdenCompraAlumno08Controller> Logger,
            Alumno08Context Context
            , IInsumoXOrdenCompraService<Alumno08Context> Service
