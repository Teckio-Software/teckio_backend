...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno08Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno08Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno08Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno08Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno08Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno08Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno08Controller(
            ILogger<RequisicionAlumno08Controller> Logger
            , Alumno08Context Context
            , IRequisicionService<Alumno08Context> RequisicionService
            , RequisicionProceso<Alumno08Context> Proceso
            , ObjetoRequisicionProceso<Alumno08Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno08Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/8/970"))
            {
