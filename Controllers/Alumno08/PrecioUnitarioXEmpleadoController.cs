...
namespace ERP_TECKIO.Controllers.Alumno08
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno08Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno08Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno08Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno08Controller(
            IPrecioUnitarioXEmpleadoService<Alumno08Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno08Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
