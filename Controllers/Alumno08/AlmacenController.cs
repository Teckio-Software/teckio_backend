...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno08Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno08Context> _almacenServicio;

        public AlmacenAlumno08Controller(
            IAlmacenService<Alumno08Context> almacenServicio)
        {
