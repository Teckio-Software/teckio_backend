...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno08Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno08Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno08Controller> _Logger;
        private readonly CotizacionProceso<Alumno08Context> _Proceso;
        private readonly Alumno08Context Context;
        public InsumoXCotizacionAlumno08Controller(
            ILogger<InsumoXCotizacionAlumno08Controller> Logger,
            Alumno08Context Context
            , IInsumoXCotizacionService<Alumno08Context> Service
