...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno08Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno08Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno08Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno08Controller> Logger;
        ...
        public AlmacenSalidaAlumno08Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno08Controller> logger,
            Alumno08Context context
            , IAlmacenSalidaService<Alumno08Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno08Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno08Context> Proceso
            )
        {
