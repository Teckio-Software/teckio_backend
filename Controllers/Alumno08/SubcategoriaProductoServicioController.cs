...
namespace ERP_TECKIO.Controllers.Alumno08
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno08Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno08Context> service)
        {
            _service = service;
        }
