...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoAlumno08Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<Alumno08Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<Alumno08Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoAlumno08Controller(
            IIndirectosXConceptoService<Alumno08Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<Alumno08Context> indirectosXConceptoProceso
            ) { 
