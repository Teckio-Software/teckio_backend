...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa8")]
    public class EspecialIdadXContratistaAlumno08Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno08Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno08Controller(
            ILogger<EspecialIdadXContratistaAlumno08Controller> logger,
