...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno08Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno08Context> _Service;
        private readonly IPolizaDetalleService<Alumno08Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno08Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno08Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno08Context> _SaldosService;
        private readonly ILogger<PolizaAlumno08Controller> _Logger;
        private readonly Alumno08Context _Context;
        public PolizaAlumno08Controller(
            ILogger<PolizaAlumno08Controller> logger
            , Alumno08Context context
            , IPolizaService<Alumno08Context> service
            , IPolizaDetalleService<Alumno08Context> detalleService
            , ITipoPolizaService<Alumno08Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno08Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa8")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa8")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa8")]
