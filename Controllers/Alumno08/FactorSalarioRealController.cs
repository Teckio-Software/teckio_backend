...
namespace ERP_TECKIO.Controllers.Alumno08
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno08Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno08Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno08Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno08Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno08Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno08Context> porcentajeCesantiaEdadService
            )
        {
