...
namespace ERP_TECKIO.Controllers.Alumno08
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno08Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno08Context> process)
        {
            _process = process;
        }
