...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno08Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno08Context> _proceso;

        private readonly ICuentaBancariaService<Alumno08Context> _servicio;
        public CuentaBancariaAlumno08Controller(CuentaBancariaProceso<Alumno08Context> _proceso, ICuentaBancariaService<Alumno08Context> _servicio
           )
        {
