...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoAlumno08Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno08Context> _bancoService;

        public BancoAlumno08Controller(IBancoService<Alumno08Context> bancoService)
        {
