...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa8")]
    public class FamiliaInsumoAlumno08Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno08Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno08Controller(
            FamiliaInsumoProceso<Alumno08Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa8")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa8")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa8")]
