...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa8")]
    public class CompraDirectaAlumno08Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno08Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno08Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno08Controller(
            ILogger<CompraDirectaAlumno08Controller> logger,
            Alumno08Context context
            , ICompraDirectaService<Alumno08Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa8")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa8")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa8")]
