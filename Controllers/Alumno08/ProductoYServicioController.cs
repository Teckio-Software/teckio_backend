...
namespace ERP_TECKIO.Controllers.Alumno08
{
    ...
    public class ProductoYServicioAlumno08Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno08Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno08Context> _process;

        public ProductoYServicioAlumno08Controller(IProductoYservicioService<Alumno08Context> productoYServicioService,
            ProductoYServicioProceso<Alumno08Context> process
            )
        {
