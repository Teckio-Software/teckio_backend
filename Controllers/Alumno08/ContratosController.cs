...
namespace ERP_TECKIO.API.Controllers.Alumno08
{
    ...
    [ApiController]
    public class ContratosAlumno08Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno08Context> _contratosProceso;
        public ContratosAlumno08Controller(
            ContratosProceso<Alumno08Context> contratosProceso
            )
        {
