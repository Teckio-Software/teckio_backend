...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno08Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno08Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno08Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno08Controller(
            ILogger<ExistenciasAlumno08Controller> Logger,
            Alumno08Context Context
            , IAlmacenExistenciaInsumoService<Alumno08Context> ExistenciaService
            , ExistenciasProceso<Alumno08Context> Proceso
            )
        {
            _Logger = Logger;
