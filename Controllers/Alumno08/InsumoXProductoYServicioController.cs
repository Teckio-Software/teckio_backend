...
namespace ERP_TECKIO.Controllers.Alumno08
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno08Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno08Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno08Context> service, InsumoXProductoYServicioProceso<Alumno08Context> process)
        {
            _service = service;
            _process = process;
        }
