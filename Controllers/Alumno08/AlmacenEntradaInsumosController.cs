...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno08Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno08Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno08Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno08Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno08Controller(
            ILogger<AlmacenEntradaInsumoAlumno08Controller> logger,
            Alumno08Context context
            , IInsumoXAlmacenEntradaService<Alumno08Context> AlmacenEntradaDetalle
