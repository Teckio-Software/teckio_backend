...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno08Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno08Context> _Service;

        private readonly RequisicionProceso<Alumno08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno08Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno08Controller(
            ILogger<InsumoXRequisicionAlumno08Controller> Logger,
            RequisicionProceso<Alumno08Context> Proceso,
            Alumno08Context Context
            , IInsumoXRequisicionService<Alumno08Context> Service)
        {
            _Logger = Logger;
