...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno08Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno08Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno08Controller(
            MovimientoBancarioProceso<Alumno08Context> movimientoBancarioProceso
            )
        {
