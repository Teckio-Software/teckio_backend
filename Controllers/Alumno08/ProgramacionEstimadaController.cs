...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno08Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno08Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno08Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno08Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno08Controller(
            ProgramacionEstimadaProceso<Alumno08Context> programacionEstimadaProceso,
            IProyectoService<Alumno08Context> proyectoProceso,
            IPrecioUnitarioService<Alumno08Context> precioUnitarioService,
