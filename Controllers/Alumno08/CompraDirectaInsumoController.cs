...
namespace ERP_TECKIO
{
    ...
    public class CompraDirectaInsumoAlumno08Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno08Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno08Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno08Controller(
            ILogger<CompraDirectaInsumoAlumno08Controller> logger
            , Alumno08Context context
            , IInsumoXCompraDirectaService<Alumno08Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
