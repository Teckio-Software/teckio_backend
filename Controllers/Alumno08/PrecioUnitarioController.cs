...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioAlumno08Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno08Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno08Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno08Context> _Options;
        private readonly ExplocionInsumosProceso<Alumno08Context> _explocionInsumosProceso;
        public PrecioUnitarioAlumno08Controller(
            PrecioUnitarioProceso<Alumno08Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno08Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno08Context> options,
            ExplocionInsumosProceso<Alumno08Context> explocionInsumosProceso
            )
        {
