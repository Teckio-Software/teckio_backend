...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno08Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno08Context> _Service;
        private readonly OrdenCompraProceso<Alumno08Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno08Controller> _Logger;
        private readonly Alumno08Context Context;
        private readonly PolizaProceso<Alumno08Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno08Context> _obtenFacturaProceso;

        public OrdenCompraAlumno08Controller(
            ILogger<OrdenCompraAlumno08Controller> Logger
            , Alumno08Context Context
            , IOrdenCompraService<Alumno08Context> Service
            , OrdenCompraProceso<Alumno08Context> Proceso
            , PolizaProceso<Alumno08Context> polizaProceso
            , ObtenFacturaProceso<Alumno08Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
