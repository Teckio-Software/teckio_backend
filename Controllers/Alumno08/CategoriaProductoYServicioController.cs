...
namespace ERP_TECKIO.Controllers.Alumno08
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno08Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno08Context> service)
        {
            _service = service;
        }
