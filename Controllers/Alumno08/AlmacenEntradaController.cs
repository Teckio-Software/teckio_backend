...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno08Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno08Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno08Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno08Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno08Controller(
            ILogger<AlmacenEntradaAlumno08Controller> logger,
            Alumno08Context context
            , IAlmacenEntradaService<Alumno08Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno08Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno08Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
