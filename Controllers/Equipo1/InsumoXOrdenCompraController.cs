...
{
    [Route("api/insumoxordencompra/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraAlumno39Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno39Context> _Service;
        private readonly OrdenCompraProceso<Alumno39Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno39Controller> _Logger;
        private readonly Alumno39Context _Context;
        public InsumoXOrdenCompraAlumno39Controller(
            ILogger<InsumoXOrdenCompraAlumno39Controller> Logger,
            Alumno39Context Context
            , IInsumoXOrdenCompraService<Alumno39Context> Service
            , OrdenCompraProceso<Alumno39Context> Proceso)
        {
            _Logger = Logger;
            _Context = Context;
            _Service = Service;
