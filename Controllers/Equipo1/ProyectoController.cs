...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/proyecto/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno39Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno39Context> _ProyectoProceso;
        public ProyectoAlumno39Controller(
            ProyectoProceso<Alumno39Context> proyectoProceso)
        {
