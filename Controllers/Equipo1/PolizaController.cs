...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    public class PolizaAlumno39Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno39Context> _Service;
        private readonly IPolizaDetalleService<Alumno39Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno39Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno39Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno39Context> _SaldosService;
        private readonly ILogger<PolizaAlumno39Controller> _Logger;
        private readonly Alumno39Context _Context;
        public PolizaAlumno39Controller(
            ILogger<PolizaAlumno39Controller> logger
            , Alumno39Context context
            , IPolizaService<Alumno39Context> service
            , IPolizaDetalleService<Alumno39Context> detalleService
            , ITipoPolizaService<Alumno39Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno39Context> saldosService
