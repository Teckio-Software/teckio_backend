...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    [Route("api/almacen/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenAlumno39Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno39Context> _almacenServicio;

        public AlmacenAlumno39Controller(
            IAlmacenService<Alumno39Context> almacenServicio)
        {
