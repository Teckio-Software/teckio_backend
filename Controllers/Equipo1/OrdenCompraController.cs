...
{
    [Route("api/ordencompra/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraAlumno39Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno39Context> _Service;
        private readonly OrdenCompraProceso<Alumno39Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno39Controller> _Logger;
        private readonly Alumno39Context Context;
        public OrdenCompraAlumno39Controller(
            ILogger<OrdenCompraAlumno39Controller> Logger
            , Alumno39Context Context
            , IOrdenCompraService<Alumno39Context> Service
