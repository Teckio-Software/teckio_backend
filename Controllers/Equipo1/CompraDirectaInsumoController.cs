...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaInsumoAlumno39Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno39Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno39Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno39Controller(
            ILogger<CompraDirectaInsumoAlumno39Controller> logger
            , Alumno39Context context
            , IInsumoXCompraDirectaService<Alumno39Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
