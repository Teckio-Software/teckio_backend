...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    public class RubroAlumno39Controller : ControllerBase
    {
        private readonly IRubroService<Alumno39Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno39Controller> Logger;
        ...
        public RubroAlumno39Controller(
            ILogger<RubroAlumno39Controller> logger,
            Alumno39Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno39Context> service
            )
        {
            //_Service = service;
            Logger = logger;
