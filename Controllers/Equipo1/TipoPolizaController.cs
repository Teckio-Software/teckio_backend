...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipopoliza/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno39Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno39Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno39Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno39Controller(
            ILogger<TipoPolizaAlumno39Controller> logger,
            Alumno39Context context
            , ITipoPolizaService<Alumno39Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
