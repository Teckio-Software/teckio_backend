...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/requisicion/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionAlumno39Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno39Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno39Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno39Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno39Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno39Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno39Controller(
            ILogger<RequisicionAlumno39Controller> Logger
            , Alumno39Context Context
            , IRequisicionService<Alumno39Context> RequisicionService
            , RequisicionProceso<Alumno39Context> Proceso
            , ObjetoRequisicionProceso<Alumno39Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno39Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
