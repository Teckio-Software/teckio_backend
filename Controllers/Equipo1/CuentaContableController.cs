...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentacontable/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa35")]
    public class CuentaContableAlumno39Controller : ControllerBase
    {
        private readonly ICuentaContableService<Alumno39Context> _Service;
        private readonly ICodigoAgrupadorService _CodigoAgrupadorService;
        private readonly IRubroService<Alumno39Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableAlumno39Controller> Logger;
        /// <summary>
        ...
        public CuentaContableAlumno39Controller(
            ILogger<CuentaContableAlumno39Controller> logger,
            Alumno39Context context
            , ICuentaContableService<Alumno39Context> Service
            , ICodigoAgrupadorService CodigoAgrupadorService
            , IRubroService<Alumno39Context> RubroService
            )
        {
            Logger = logger;
            Context = context;
