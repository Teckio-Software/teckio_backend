...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/39")]
    [ApiController]
    public class ContratistaCuentaBancariaAlumno39Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaAlumno39Controller> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaAlumno39Controller(
            ILogger<ContratistaCuentaBancariaAlumno39Controller> logger,
