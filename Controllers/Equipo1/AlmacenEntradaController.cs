...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentrada/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaAlumno39Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno39Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno39Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno39Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno39Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno39Controller(
            ILogger<AlmacenEntradaAlumno39Controller> logger,
            Alumno39Context context
            , IAlmacenEntradaService<Alumno39Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno39Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno39Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
