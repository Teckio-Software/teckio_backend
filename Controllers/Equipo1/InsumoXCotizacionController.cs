...
{
    [Route("api/insumoxcotizacion/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionAlumno39Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno39Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno39Controller> _Logger;
        private readonly CotizacionProceso<Alumno39Context> _Proceso;
        private readonly Alumno39Context Context;
        public InsumoXCotizacionAlumno39Controller(
            ILogger<InsumoXCotizacionAlumno39Controller> Logger,
            Alumno39Context Context
            , IInsumoXCotizacionService<Alumno39Context> Service
