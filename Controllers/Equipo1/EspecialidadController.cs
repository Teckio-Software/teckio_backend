...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialidad/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa35")]
    public class EspecialidadAlumno39Controller : ControllerBase
    {
        private readonly EspecialidadProceso<Alumno39Context> _EspecialidadProceso;
        public EspecialidadAlumno39Controller(
            EspecialidadProceso<Alumno39Context> especialidadProceso)
        {
