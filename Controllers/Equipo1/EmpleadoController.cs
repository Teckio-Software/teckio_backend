...
{
    [Route("api/empleado/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoAlumno39Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno39Context> _empleadoService;
        public EmpleadoAlumno39Controller(
            IEmpleadoService<Alumno39Context> empleadoService
            )
        {
