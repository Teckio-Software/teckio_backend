...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaAlumno39Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno39Context> _proceso;

        private readonly ICuentaBancariaService<Alumno39Context> _servicio;
        public CuentaBancariaAlumno39Controller(CuentaBancariaProceso<Alumno39Context> _proceso, ICuentaBancariaService<Alumno39Context> _servicio
           )
        {
