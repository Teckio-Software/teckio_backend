...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/existencias/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasAlumno39Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno39Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno39Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno39Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno39Controller(
            ILogger<ExistenciasAlumno39Controller> Logger,
            Alumno39Context Context
            , IAlmacenExistenciaInsumoService<Alumno39Context> ExistenciaService
            , ExistenciasProceso<Alumno39Context> Proceso
            )
        {
            _Logger = Logger;
