...
namespace SistemaERP.API.Controllers.Alumno39
{
    ...
    public class BancoAlumno39Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno39Context> _bancoService;

        public BancoAlumno39Controller(IBancoService<Alumno39Context> bancoService)
        {
