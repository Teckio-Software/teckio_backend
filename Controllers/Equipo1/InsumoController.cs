...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    public class InsumoAlumno39Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno39Context> _InsumoProceso;
        public InsumoAlumno39Controller(
            InsumoProceso<Alumno39Context> insumoProceso)
        {
