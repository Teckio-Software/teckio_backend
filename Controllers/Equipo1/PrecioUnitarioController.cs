...
{
    [Route("api/preciounitario/39")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioAlumno39Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<Alumno39Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<Alumno39Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<Alumno39Context> _Options;
        public PrecioUnitarioAlumno39Controller(
            PrecioUnitarioProceso<Alumno39Context> precioUnitarioProceso
            , IProgramacionEstimadaService<Alumno39Context> programacionEstimadaService
            , DbContextOptionsBuilder<Alumno39Context> options
            )
        {
        ...
        {
            using (var db = new Alumno39Context(_Options.Options))
            {
