...
{
    [Route("api/contratos/39")]
    [ApiController]
    public class ContratosAlumno39Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno39Context> _contratosProceso;
        public ContratosAlumno39Controller(
            ContratosProceso<Alumno39Context> contratosProceso
            )
        {
