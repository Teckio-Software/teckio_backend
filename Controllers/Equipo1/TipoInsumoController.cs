...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno39Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno39Context> _TipoInsumoProceso;

        public TipoInsumoAlumno39Controller(
            TipoInsumoProceso<Alumno39Context> tipoInsumoProceso
            )
        {
