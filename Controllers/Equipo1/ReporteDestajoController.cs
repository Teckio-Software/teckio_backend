...
{
    [Route("api/reportesdestajo/39")]
    [ApiController]
    public class ReporteDestajoAlumno39Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno39Context> _proceso;
        private readonly EstimacionesProceso<Alumno39Context> _estimacionesProceso;

        public ReporteDestajoAlumno39Controller(
            ReporteDestajoProceso<Alumno39Context> proceso,
