...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionAlumno39Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno39Context> _Service;

        private readonly RequisicionProceso<Alumno39Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno39Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno39Controller(
            ILogger<InsumoXRequisicionAlumno39Controller> Logger,
            RequisicionProceso<Alumno39Context> Proceso,
            Alumno39Context Context
            , IInsumoXRequisicionService<Alumno39Context> Service)
        {
            _Logger = Logger;
