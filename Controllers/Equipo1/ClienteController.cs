...
{
    [Route("api/cliente/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteAlumno39Controller : ControllerBase
    {
        private readonly IClientesService<Alumno39Context> _Service;

        private readonly ClienteProceso<Alumno39Context> _Proceso;
        public ClienteAlumno39Controller(
            IClientesService<Alumno39Context> service
            , ClienteProceso<Alumno39Context> proceso)
        {
            _Service = service;
            _Proceso = proceso;
        }
