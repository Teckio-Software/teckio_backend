...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/contratista/39")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaAlumno39Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno39Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno39Controller> Logger;
        /// <summary>
        ...
        public ContratistaAlumno39Controller(
            ILogger<ContratistaAlumno39Controller> logger,
            Alumno39Context context
            , IContratistaService<Alumno39Context> ContratistaService
            )
        {
            Logger = logger;
            Context = context;
