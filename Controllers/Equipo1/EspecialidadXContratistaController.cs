...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa35")]
    public class EspecialIdadXContratistaAlumno39Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno39Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno39Controller(
            ILogger<EspecialIdadXContratistaAlumno39Controller> logger,
