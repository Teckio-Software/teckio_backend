...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenSalida/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaAlumno39Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno39Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno39Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno39Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno39Controller> Logger;
        ...
        public AlmacenSalidaAlumno39Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno39Controller> logger,
            Alumno39Context context
            , IAlmacenSalidaService<Alumno39Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno39Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno39Context> Proceso
            )
        {
