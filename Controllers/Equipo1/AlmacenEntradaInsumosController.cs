...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoAlumno39Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno39Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno39Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno39Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno39Controller(
            ILogger<AlmacenEntradaInsumoAlumno39Controller> logger,
            Alumno39Context context
            , IInsumoXAlmacenEntradaService<Alumno39Context> AlmacenEntradaDetalle
