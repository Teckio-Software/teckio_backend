...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirecta/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno39Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno39Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno39Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno39Context Context;
        /// <summary>
        ...
        public CompraDirectaAlumno39Controller(
            ILogger<CompraDirectaAlumno39Controller> logger,
            Alumno39Context context
            , ICompraDirectaService<Alumno39Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        public async Task<ActionResult> Post([FromBody] CompraDirectaCreacionDTO CreacionDTO)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<Alumno39Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
