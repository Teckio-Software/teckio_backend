...
{
    [Route("api/programacionestimada/39")]
    [ApiController]
    public class ProgramacionEstimadaAlumno39Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno39Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno39Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno39Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno39Controller(
            ProgramacionEstimadaProceso<Alumno39Context> programacionEstimadaProceso,
            IProyectoService<Alumno39Context> proyectoProceso,
            IPrecioUnitarioService<Alumno39Context> precioUnitarioService,
