...
{
    [Route("api/cotizacion/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionAlumno39Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno39Context> _Service;
        private readonly CotizacionProceso<Alumno39Context> _Proceso;
        private readonly IOrdenCompraService<Alumno39Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno39Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno39Controller> _Logger;
        private readonly Alumno39Context Context;
        public CotizacionAlumno39Controller(

            ILogger<CotizacionAlumno39Controller> Logger
            , Alumno39Context Context
            , ICotizacionService<Alumno39Context> Service
            , IOrdenCompraService<Alumno39Context> OrdenCompraService,
              ITipoImpuestoService<Alumno39Context> TipoImpuestoService
            , CotizacionProceso<Alumno39Context> Proceso)
        {
            _Logger = Logger;
