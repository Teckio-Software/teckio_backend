...
namespace SistemaERP.API.Alumno39Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/familiainsumo/39")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa35")]
    public class FamiliaInsumoAlumno39Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno39Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno39Controller(
            FamiliaInsumoProceso<Alumno39Context> familiaInsumoProceso)
        {
