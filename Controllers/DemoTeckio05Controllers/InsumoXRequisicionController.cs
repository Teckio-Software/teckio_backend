...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL05Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL05Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL05Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL05Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL05Controller> Logger,
            RequisicionProceso<DemoTeckioAL05Context> Proceso,
            DemoTeckioAL05Context Context
            , IInsumoXRequisicionService<DemoTeckioAL05Context> Service)
        {
            _Logger = Logger;
