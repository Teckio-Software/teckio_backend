...
{
    [Route("api/precioUnitarioXEmpleado/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL05Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL05Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL05Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL05Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL05Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
