...
{
    [Route("api/insumoxordencompra/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL05Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL05Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL05Controller> _Logger;
        private readonly DemoTeckioAL05Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL05Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL05Controller> Logger,
            DemoTeckioAL05Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL05Context> Service
