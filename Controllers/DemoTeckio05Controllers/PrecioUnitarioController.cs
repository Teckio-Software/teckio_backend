...
{
    [Route("api/preciounitario/5")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL05Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL05Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL05Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL05Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL05Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL05Controller(
            PrecioUnitarioProceso<DemoTeckioAL05Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL05Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL05Context> options,
            ExplocionInsumosProceso<DemoTeckioAL05Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL05Context(_Options.Options))
            {
