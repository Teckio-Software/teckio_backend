...
namespace SistemaERP.API.DemoTeckioAL05Controllers.Procomi
{
    [Route("api/preciounitariodetalle/5")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL05Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL05Controller(
