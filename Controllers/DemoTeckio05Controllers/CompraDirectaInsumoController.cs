...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa1")]
    public class CompraDirectaInsumoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL05Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL05Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL05Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL05Controller> logger
            , DemoTeckioAL05Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL05Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
