...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    [Route("api/existenciaproductoalmacen/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL05Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL05Context> proces)
        {
            _proceso = proces;
        }
