...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    {
        private readonly IProductoYServicioSatService<DemoTeckioAL05Context> _service;

        public ProductoYServicioSatController(IProductoYServicioSatService<DemoTeckioAL05Context> service)
        {
            _service = service;
        }
