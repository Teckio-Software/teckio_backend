...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL05Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL05Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL05Controller(
            ILogger<CompraDirectaDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , ICompraDirectaService<DemoTeckioAL05Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
