...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL05Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL05Controller> Logger;
        ...
        public RubroDemoTeckioAL05Controller(
            ILogger<RubroDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL05Context> service
            )
        {
            //_Service = service;
            Logger = logger;
