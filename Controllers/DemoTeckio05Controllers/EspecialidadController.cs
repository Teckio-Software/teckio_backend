...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL05Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL05Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL05Controller(
            EspecialidadProceso<DemoTeckioAL05Context> especialidadProceso)
        {
