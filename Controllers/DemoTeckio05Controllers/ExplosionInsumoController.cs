...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoDemoTeckioAL05Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoDemoTeckioAL05Controller(
            ILogger<ExplosionInsumoDemoTeckioAL05Controller> Logger,
