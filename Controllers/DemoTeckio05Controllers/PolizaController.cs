...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL05Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL05Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL05Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL05Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL05Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL05Controller> _Logger;
        private readonly DemoTeckioAL05Context _Context;
        private readonly PolizaProceso<DemoTeckioAL05Context> _polizaProceso;
        public PolizaDemoTeckioAL05Controller(
            ILogger<PolizaDemoTeckioAL05Controller> logger
            , DemoTeckioAL05Context context
            , IPolizaService<DemoTeckioAL05Context> service
            , IPolizaDetalleService<DemoTeckioAL05Context> detalleService
            , ITipoPolizaService<DemoTeckioAL05Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL05Context> saldosService
            , ICuentaContableService<DemoTeckioAL05Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL05Context> polizaProceso
            )
        {
