...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    [Route("api/produccion/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL05Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL05Context> proceso)
        {
            _proceso = proceso;
        }
