...
{
    [Route("api/ordenventa/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL05Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL05Controller(
            OrdenVentaProceso<DemoTeckioAL05Context> ordenVentaProceso
            ) { 
