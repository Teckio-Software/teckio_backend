...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL05Context> _InsumoProceso;
        public InsumoDemoTeckioAL05Controller(
            InsumoProceso<DemoTeckioAL05Context> insumoProceso)
        {
