...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL05Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL05Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL05Controller(
            ILogger<TipoPolizaDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , ITipoPolizaService<DemoTeckioAL05Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
