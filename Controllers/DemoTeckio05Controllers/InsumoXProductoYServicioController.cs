...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/5")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL05Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL05Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL05Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL05Context> process)
        {
            _service = service;
            _process = process;
        }
