...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL05Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL05Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL05Controller(
            ReporteDestajoProceso<DemoTeckioAL05Context> proceso,
