...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL05Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL05Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL05Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL05Controller(
            IClientesService<DemoTeckioAL05Context> service
            , ClienteProceso<DemoTeckioAL05Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL05Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
