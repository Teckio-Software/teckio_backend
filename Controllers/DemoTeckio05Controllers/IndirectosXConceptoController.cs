...
{
    [Route("api/indirectosXConcepto/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL05Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL05Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL05Controller(
            IIndirectosXConceptoService<DemoTeckioAL05Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL05Context> indirectosXConceptoProceso
            ) { 
