...
{
    [Route("api/empleado/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL05Context> _empleadoService;
        public EmpleadoDemoTeckioAL05Controller(
            IEmpleadoService<DemoTeckioAL05Context> empleadoService
            )
        {
