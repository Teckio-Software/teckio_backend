...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL05Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL05Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL05Controller> _Logger;
        private readonly DemoTeckioAL05Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL05Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL05Controller> logger
            , DemoTeckioAL05Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL05Context> service
