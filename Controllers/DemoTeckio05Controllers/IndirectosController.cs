...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL05Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL05Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL05Context> _indirectosProceso;

        public IndirectosDemoTeckioAL05Controller(
                        IConjuntoIndirectosService<DemoTeckioAL05Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL05Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL05Context> indirectosProceso
            )
        {
