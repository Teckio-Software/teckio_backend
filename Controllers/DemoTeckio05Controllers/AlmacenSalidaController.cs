...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL05Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL05Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL05Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL05Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL05Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , IAlmacenSalidaService<DemoTeckioAL05Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL05Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL05Context> Proceso
            )
        {
