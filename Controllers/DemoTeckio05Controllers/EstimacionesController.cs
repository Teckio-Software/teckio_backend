...
{
    [Route("api/estimaciones/5")]
    [ApiController]
    public class EstimacionesDemoTeckioAL05Controller : ControllerBase
    {
        private readonly EstimacionesProceso<DemoTeckioAL05Context> _estimacionesProceso;
        public EstimacionesDemoTeckioAL05Controller(
            EstimacionesProceso<DemoTeckioAL05Context> estimacionesProceso
            )
        {
