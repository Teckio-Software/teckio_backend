...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL05Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL05Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL05Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL05Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL05Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL05Controller(
            ILogger<RequisicionDemoTeckioAL05Controller> Logger
            , DemoTeckioAL05Context Context
            , IRequisicionService<DemoTeckioAL05Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL05Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL05Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL05Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/5/970"))
            {
