...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoDemoTeckioAL05Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoDemoTeckioAL05Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL05Context Context;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL05Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoDemoTeckioAL05Controller(
            ILogger<AlmacenEntradaInsumoDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , IInsumoXAlmacenEntradaService<DemoTeckioAL05Context> AlmacenEntradaDetalle
