...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL05Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL05Controller(
            FamiliaInsumoProceso<DemoTeckioAL05Context> familiaInsumoProceso)
        {
