...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL05Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL05Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL05Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL05Controller(
            ILogger<ExistenciasDemoTeckioAL05Controller> Logger,
            DemoTeckioAL05Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL05Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL05Context> Proceso
            )
        {
            _Logger = Logger;
