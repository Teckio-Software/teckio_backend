...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/5")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL05Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL05Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL05Controller(
            MovimientoBancarioProceso<DemoTeckioAL05Context> movimientoBancarioProceso
            )
        {
