...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL05Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL05Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL05Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL05Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL05Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL05Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL05Controller(
            ILogger<CuentaContableDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , ICuentaContableService<DemoTeckioAL05Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL05Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL05Context> RubroService
            , CuentaContableProceso<DemoTeckioAL05Context> proceso
            )
        {
            Logger = logger;
            Context = context;
