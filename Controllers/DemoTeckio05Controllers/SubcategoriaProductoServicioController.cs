...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    [Route("api/subcategoriaProductoServicio/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL05Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL05Context> service)
        {
            _service = service;
        }
