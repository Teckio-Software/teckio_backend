...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL05Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL05Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL05Controller(
            GeneradoresProceso<DemoTeckioAL05Context> generadoresProceso)
        {
