...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL05Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL05Controller(
            ProyectoProceso<DemoTeckioAL05Context> proyectoProceso)
        {
