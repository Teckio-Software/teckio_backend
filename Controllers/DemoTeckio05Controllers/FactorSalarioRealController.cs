...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL05Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL05Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL05Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL05Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL05Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL05Context> porcentajeCesantiaEdadService
            )
        {
