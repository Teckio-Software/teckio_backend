...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL05Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL05Context> _bancoService;

        public BancoDemoTeckioAL05Controller(IBancoService<DemoTeckioAL05Context> bancoService)
        {
