...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    [Route("api/insumoXproduccion/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL05Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL05Context> proces)
        {
            _proceso = proces;
        }
