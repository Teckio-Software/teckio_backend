...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/5")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL05Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL05Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL05Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL05Controller(
            ILogger<ContratistaDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , IContratistaService<DemoTeckioAL05Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL05Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
