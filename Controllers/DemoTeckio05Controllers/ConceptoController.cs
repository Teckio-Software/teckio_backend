...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL05Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL05Controller(
            ConceptoProceso<DemoTeckioAL05Context> conceptoProceso)
        {
