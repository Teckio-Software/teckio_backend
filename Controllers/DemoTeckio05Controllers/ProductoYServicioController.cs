...
{
    [Route("api/productoyservicio/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL05Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL05Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL05Context> _process;

        public ProductoYServicioDemoTeckioAL05Controller(IProductoYservicioService<DemoTeckioAL05Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL05Context> process
            )
        {
