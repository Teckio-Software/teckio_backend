...
{
    [Route("api/entradaproduccionalmacen/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL05Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL05Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL05Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL05Context> proceso)
        {
            _proceso = proceso;
        }
