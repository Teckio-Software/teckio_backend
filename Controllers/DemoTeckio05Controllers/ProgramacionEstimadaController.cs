...
{
    [Route("api/programacionestimada/5")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL05Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL05Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL05Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL05Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL05Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL05Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL05Context> precioUnitarioService,
