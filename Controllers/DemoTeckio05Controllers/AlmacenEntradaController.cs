...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL05Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL05Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL05Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL05Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL05Controller(
            ILogger<AlmacenEntradaDemoTeckioAL05Controller> logger,
            DemoTeckioAL05Context context
            , IAlmacenEntradaService<DemoTeckioAL05Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL05Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL05Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
