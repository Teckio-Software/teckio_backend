...
namespace ERP_TECKIO.Controllers.DemoTeckioAL05
{
    ...
    public class FacturaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL05Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL05Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL05Controller(
            ObtenFacturaProceso<DemoTeckioAL05Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL05Context> categoriaProductoYServicioService
            )
        {
