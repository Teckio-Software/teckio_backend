...
namespace SistemaERP.API.Controllers.DemoTeckioAL05
{
    [Route("api/programacionestimadaGantt/5")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL05Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL05Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL05Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL05Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL05Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL05Context> importeSemanalGanttProceso,
