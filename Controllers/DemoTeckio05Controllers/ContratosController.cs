...
{
    [Route("api/contratos/5")]
    [ApiController]
    public class ContratosDemoTeckioAL05Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL05Context> _contratosProceso;
        public ContratosDemoTeckioAL05Controller(
            ContratosProceso<DemoTeckioAL05Context> contratosProceso
            )
        {
