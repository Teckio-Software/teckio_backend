...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL05Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL05Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL05Controller(
            TipoInsumoProceso<DemoTeckioAL05Context> tipoInsumoProceso
            )
        {
