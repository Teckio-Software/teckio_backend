...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL05Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL05Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL05Context> _servicio;
        public CuentaBancariaDemoTeckioAL05Controller(CuentaBancariaProceso<DemoTeckioAL05Context> _proceso, ICuentaBancariaService<DemoTeckioAL05Context> _servicio
           )
        {
