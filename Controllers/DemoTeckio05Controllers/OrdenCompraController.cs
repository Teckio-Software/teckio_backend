...
{
    [Route("api/ordencompra/5")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL05Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL05Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL05Controller> _Logger;
        private readonly DemoTeckioAL05Context Context;
        private readonly PolizaProceso<DemoTeckioAL05Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL05Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL05Controller(
            ILogger<OrdenCompraDemoTeckioAL05Controller> Logger
            , DemoTeckioAL05Context Context
            , IOrdenCompraService<DemoTeckioAL05Context> Service
            , OrdenCompraProceso<DemoTeckioAL05Context> Proceso
            , PolizaProceso<DemoTeckioAL05Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL05Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
