...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionDemoTeckioAL05Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL05Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL05Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL05Context> _Proceso;
        private readonly DemoTeckioAL05Context Context;
        public InsumoXCotizacionDemoTeckioAL05Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL05Controller> Logger,
            DemoTeckioAL05Context Context
            , IInsumoXCotizacionService<DemoTeckioAL05Context> Service
