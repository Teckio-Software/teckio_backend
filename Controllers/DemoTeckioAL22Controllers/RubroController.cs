...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL22Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL22Controller> Logger;
        ...
        public RubroDemoTeckioAL22Controller(
            ILogger<RubroDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL22Context> service
            )
        {
            //_Service = service;
            Logger = logger;
