...
{
    [Route("api/programacionestimada/22")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL22Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL22Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL22Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL22Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL22Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL22Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL22Context> precioUnitarioService,
