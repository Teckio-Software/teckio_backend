...
namespace ERP_TECKIO.Controllers.DemoTeckioAL22
{
    ...
    [Route("api/existenciaproductoalmacen/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL22Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL22Context> proces)
        {
            _proceso = proces;
        }
