...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoDemoTeckioAL22Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoDemoTeckioAL22Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL22Context Context;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL22Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoDemoTeckioAL22Controller(
            ILogger<AlmacenEntradaInsumoDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , IInsumoXAlmacenEntradaService<DemoTeckioAL22Context> AlmacenEntradaDetalle
