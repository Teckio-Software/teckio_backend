...
{
    [Route("api/insumoxcotizacion/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL22Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL22Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL22Context> _Proceso;
        private readonly DemoTeckioAL22Context Context;
        public InsumoXCotizacionDemoTeckioAL22Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL22Controller> Logger,
            DemoTeckioAL22Context Context
            , IInsumoXCotizacionService<DemoTeckioAL22Context> Service
