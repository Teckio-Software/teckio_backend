...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL22Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL22Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL22Controller(
            ILogger<ExistenciasDemoTeckioAL22Controller> Logger,
            DemoTeckioAL22Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL22Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL22Context> Proceso
            )
        {
            _Logger = Logger;
