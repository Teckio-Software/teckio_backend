...
{
    [Route("api/cliente/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL22Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL22Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL22Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL22Controller(
            IClientesService<DemoTeckioAL22Context> service
            , ClienteProceso<DemoTeckioAL22Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL22Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
