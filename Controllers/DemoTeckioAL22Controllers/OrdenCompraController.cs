...
{
    [Route("api/ordencompra/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL22Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL22Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL22Controller> _Logger;
        private readonly DemoTeckioAL22Context Context;
        private readonly PolizaProceso<DemoTeckioAL22Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL22Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL22Controller(
            ILogger<OrdenCompraDemoTeckioAL22Controller> Logger
            , DemoTeckioAL22Context Context
            , IOrdenCompraService<DemoTeckioAL22Context> Service
            , OrdenCompraProceso<DemoTeckioAL22Context> Proceso
            , PolizaProceso<DemoTeckioAL22Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL22Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
