...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL22Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL22Controller(
            FamiliaInsumoProceso<DemoTeckioAL22Context> familiaInsumoProceso)
        {
