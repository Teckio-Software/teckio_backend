...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/22")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL22Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL22Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL22Controller(
            MovimientoBancarioProceso<DemoTeckioAL22Context> movimientoBancarioProceso
            )
        {
