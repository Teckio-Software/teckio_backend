...
{
    [Route("api/cotizacion/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL22Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL22Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL22Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL22Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL22Controller> _Logger;
        private readonly DemoTeckioAL22Context Context;
        public CotizacionDemoTeckioAL22Controller(

            ILogger<CotizacionDemoTeckioAL22Controller> Logger
            , DemoTeckioAL22Context Context
            , ICotizacionService<DemoTeckioAL22Context> Service
            , IOrdenCompraService<DemoTeckioAL22Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL22Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL22Context> Proceso)
        {
            _Logger = Logger;
