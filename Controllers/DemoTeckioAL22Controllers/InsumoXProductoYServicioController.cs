...
namespace ERP_TECKIO.Controllers.DemoTeckioAL22
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/22")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL22Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL22Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL22Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL22Context> process)
        {
            _service = service;
            _process = process;
        }
