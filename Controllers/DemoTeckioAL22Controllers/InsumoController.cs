...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL22Context> _InsumoProceso;
        public InsumoDemoTeckioAL22Controller(
            InsumoProceso<DemoTeckioAL22Context> insumoProceso)
        {
