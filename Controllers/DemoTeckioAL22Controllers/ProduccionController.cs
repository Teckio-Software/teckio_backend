...
namespace ERP_TECKIO.Controllers.DemoTeckioAL22
{
    ...
    [Route("api/produccion/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL22Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL22Context> proceso)
        {
            _proceso = proceso;
        }
