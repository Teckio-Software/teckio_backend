...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL22Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL22Controller(
            ConceptoProceso<DemoTeckioAL22Context> conceptoProceso)
        {
