...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL22Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL22Controller(
            TipoInsumoProceso<DemoTeckioAL22Context> tipoInsumoProceso
            )
        {
