...
namespace SistemaERP.API.DemoTeckioAL22Controllers.Procomi
{
    [Route("api/preciounitariodetalle/22")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL22Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL22Controller(
