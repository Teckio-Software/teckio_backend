...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL22Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL22Context> _servicio;
        public CuentaBancariaDemoTeckioAL22Controller(CuentaBancariaProceso<DemoTeckioAL22Context> _proceso, ICuentaBancariaService<DemoTeckioAL22Context> _servicio
           )
        {
