...
{
    [Route("api/empleado/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL22Context> _empleadoService;
        public EmpleadoDemoTeckioAL22Controller(
            IEmpleadoService<DemoTeckioAL22Context> empleadoService
            )
        {
