...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL22Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL22Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL22Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL22Context> cuentaBancariaEmpresaService,
