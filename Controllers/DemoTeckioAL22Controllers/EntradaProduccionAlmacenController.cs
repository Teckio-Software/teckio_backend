...
{
    [Route("api/entradaproduccionalmacen/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL22Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL22Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL22Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL22Context> proceso)
        {
            _proceso = proceso;
        }
