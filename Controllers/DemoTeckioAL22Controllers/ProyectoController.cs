...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL22Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL22Controller(
            ProyectoProceso<DemoTeckioAL22Context> proyectoProceso)
        {
