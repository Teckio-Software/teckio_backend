...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/22")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL22Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL22Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL22Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL22Controller(
            ILogger<ContratistaDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , IContratistaService<DemoTeckioAL22Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL22Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
