...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL22Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL22Context> _bancoService;

        public BancoDemoTeckioAL22Controller(IBancoService<DemoTeckioAL22Context> bancoService)
        {
