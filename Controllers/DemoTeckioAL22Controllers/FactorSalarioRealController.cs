...
namespace ERP_TECKIO.Controllers.DemoTeckioAL22
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL22Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL22Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL22Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL22Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL22Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL22Context> porcentajeCesantiaEdadService
            )
        {
