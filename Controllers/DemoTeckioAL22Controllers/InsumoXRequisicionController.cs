...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL22Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL22Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL22Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL22Controller> Logger,
            RequisicionProceso<DemoTeckioAL22Context> Proceso,
            DemoTeckioAL22Context Context
            , IInsumoXRequisicionService<DemoTeckioAL22Context> Service)
        {
            _Logger = Logger;
