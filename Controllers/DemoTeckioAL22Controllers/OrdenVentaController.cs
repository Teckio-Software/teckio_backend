...
{
    [Route("api/ordenventa/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL22Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL22Controller(
            OrdenVentaProceso<DemoTeckioAL22Context> ordenVentaProceso
            ) { 
