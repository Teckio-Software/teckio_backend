...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL22Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL22Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL22Controller(
            ILogger<CompraDirectaDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , ICompraDirectaService<DemoTeckioAL22Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
