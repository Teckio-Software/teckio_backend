...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa1")]
    public class CompraDirectaInsumoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL22Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL22Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL22Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL22Controller> logger
            , DemoTeckioAL22Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL22Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
