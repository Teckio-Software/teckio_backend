...
{
    [Route("api/indirectos/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL22Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL22Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL22Context> _indirectosProceso;

        public IndirectosDemoTeckioAL22Controller(
                        IConjuntoIndirectosService<DemoTeckioAL22Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL22Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL22Context> indirectosProceso
            )
        {
