...
namespace ERP_TECKIO.Controllers.DemoTeckioAL22
{
    ...
    public class FacturaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL22Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL22Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL22Controller(
            ObtenFacturaProceso<DemoTeckioAL22Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL22Context> categoriaProductoYServicioService
            )
        {
