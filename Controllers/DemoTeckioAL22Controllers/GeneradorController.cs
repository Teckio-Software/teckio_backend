...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL22Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL22Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL22Controller(
            GeneradoresProceso<DemoTeckioAL22Context> generadoresProceso)
        {
