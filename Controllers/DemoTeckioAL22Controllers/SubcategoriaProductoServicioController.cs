...
namespace ERP_TECKIO.Controllers.DemoTeckioAL22
{
    ...
    [Route("api/subcategoriaProductoServicio/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL22Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL22Context> service)
        {
            _service = service;
        }
