...
{
    [Route("api/insumoxordencompra/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL22Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL22Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL22Controller> _Logger;
        private readonly DemoTeckioAL22Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL22Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL22Controller> Logger,
            DemoTeckioAL22Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL22Context> Service
