...
namespace ERP_TECKIO.Controllers.DemoTeckioAL22
{
    ...
    public class PrecioUnitarioXEmpleadoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL22Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL22Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL22Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL22Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL22Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
