...
{
    [Route("api/indirectosXConcepto/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL22Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL22Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL22Controller(
            IIndirectosXConceptoService<DemoTeckioAL22Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL22Context> indirectosXConceptoProceso
            ) { 
