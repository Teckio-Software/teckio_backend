...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL22Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL22Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL22Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL22Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL22Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL22Controller> _Logger;
        private readonly DemoTeckioAL22Context _Context;
        private readonly PolizaProceso<DemoTeckioAL22Context> _polizaProceso;
        public PolizaDemoTeckioAL22Controller(
            ILogger<PolizaDemoTeckioAL22Controller> logger
            , DemoTeckioAL22Context context
            , IPolizaService<DemoTeckioAL22Context> service
            , IPolizaDetalleService<DemoTeckioAL22Context> detalleService
            , ITipoPolizaService<DemoTeckioAL22Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL22Context> saldosService
