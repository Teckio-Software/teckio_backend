...
{
    [Route("api/preciounitario/22")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL22Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL22Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL22Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL22Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL22Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL22Controller(
            PrecioUnitarioProceso<DemoTeckioAL22Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL22Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL22Context> options,
            ExplocionInsumosProceso<DemoTeckioAL22Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL22Context(_Options.Options))
            {
