...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL22Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL22Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL22Controller(
            EspecialidadProceso<DemoTeckioAL22Context> especialidadProceso)
        {
