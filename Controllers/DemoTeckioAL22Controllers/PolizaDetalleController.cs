...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDetalleDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IPolizaDetalleService<DemoTeckioAL22Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL22Context> _CuentaContableService;
        private readonly ILogger<PolizaDetalleDemoTeckioAL22Controller> _Logger;
        private readonly DemoTeckioAL22Context _Context;
        public PolizaDetalleDemoTeckioAL22Controller(
            ILogger<PolizaDetalleDemoTeckioAL22Controller> logger
            , DemoTeckioAL22Context context
            , IPolizaDetalleService<DemoTeckioAL22Context> service
