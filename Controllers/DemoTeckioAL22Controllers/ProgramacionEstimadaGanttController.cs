...
namespace SistemaERP.API.Controllers.DemoTeckioAL22
{
    [Route("api/programacionestimadaGantt/22")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL22Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL22Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL22Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL22Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL22Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL22Context> importeSemanalGanttProceso,
