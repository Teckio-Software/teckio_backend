...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL22Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL22Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL22Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL22Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL22Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL22Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL22Controller(
            ILogger<CuentaContableDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , ICuentaContableService<DemoTeckioAL22Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL22Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL22Context> RubroService
            , CuentaContableProceso<DemoTeckioAL22Context> proceso
            )
        {
            Logger = logger;
            Context = context;
