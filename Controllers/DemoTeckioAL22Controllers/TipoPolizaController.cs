...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL22Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL22Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL22Controller(
            ILogger<TipoPolizaDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , ITipoPolizaService<DemoTeckioAL22Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
