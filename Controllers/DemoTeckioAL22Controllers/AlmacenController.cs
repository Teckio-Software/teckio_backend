...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL22Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL22Context> _almacenProceso;
        public AlmacenDemoTeckioAL22Controller(
            IAlmacenService<DemoTeckioAL22Context> almacenServicio, AlmacenProceso<DemoTeckioAL22Context> almacenProceso)
        {
