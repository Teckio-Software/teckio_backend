...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL22Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL22Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL22Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL22Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , IAlmacenSalidaService<DemoTeckioAL22Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL22Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL22Context> Proceso
            )
        {
