...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosDemoTeckioAL22Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL22Context> _contratosProceso;
        public ContratosDemoTeckioAL22Controller(
            ContratosProceso<DemoTeckioAL22Context> contratosProceso
            )
        {
