...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL22Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL22Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL22Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL22Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL22Controller(
            ILogger<AlmacenEntradaDemoTeckioAL22Controller> logger,
            DemoTeckioAL22Context context
            , IAlmacenEntradaService<DemoTeckioAL22Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL22Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL22Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
