...
{
    [Route("api/productoyservicio/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL22Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL22Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL22Context> _process;

        public ProductoYServicioDemoTeckioAL22Controller(IProductoYservicioService<DemoTeckioAL22Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL22Context> process
            )
        {
