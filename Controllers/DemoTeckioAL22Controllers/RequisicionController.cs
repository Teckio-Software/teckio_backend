...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/22")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL22Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL22Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL22Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL22Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL22Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL22Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL22Controller(
            ILogger<RequisicionDemoTeckioAL22Controller> Logger
            , DemoTeckioAL22Context Context
            , IRequisicionService<DemoTeckioAL22Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL22Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL22Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL22Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL22Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/22/970"))
            {
