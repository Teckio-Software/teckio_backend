...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL16Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL16Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL16Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL16Controller> logger
            , DemoTeckioAL16Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL16Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
