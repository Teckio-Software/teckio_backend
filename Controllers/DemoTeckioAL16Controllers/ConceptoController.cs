...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL16Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL16Controller(
            ConceptoProceso<DemoTeckioAL16Context> conceptoProceso)
        {
