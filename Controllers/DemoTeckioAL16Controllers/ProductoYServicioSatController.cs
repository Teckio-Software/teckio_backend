...
namespace ERP_TECKIO.Controllers.DemoTeckioAL16
{
    ...
    {
        private readonly IProductoYServicioSatService<DemoTeckioAL16Context> _service;

        public ProductoYServicioSatController(IProductoYServicioSatService<DemoTeckioAL16Context> service)
        {
            _service = service;
        }
