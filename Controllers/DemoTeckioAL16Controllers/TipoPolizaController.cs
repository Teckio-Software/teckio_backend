...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL16Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL16Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL16Controller(
            ILogger<TipoPolizaDemoTeckioAL16Controller> logger,
            DemoTeckioAL16Context context
            , ITipoPolizaService<DemoTeckioAL16Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
