...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL16Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL16Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL16Controller(
            GeneradoresProceso<DemoTeckioAL16Context> generadoresProceso)
        {
