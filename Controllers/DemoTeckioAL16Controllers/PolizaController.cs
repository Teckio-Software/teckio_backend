...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL16Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL16Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL16Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL16Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL16Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL16Controller> _Logger;
        private readonly DemoTeckioAL16Context _Context;
        private readonly PolizaProceso<DemoTeckioAL16Context> _polizaProceso;
        public PolizaDemoTeckioAL16Controller(
            ILogger<PolizaDemoTeckioAL16Controller> logger
            , DemoTeckioAL16Context context
            , IPolizaService<DemoTeckioAL16Context> service
            , IPolizaDetalleService<DemoTeckioAL16Context> detalleService
            , ITipoPolizaService<DemoTeckioAL16Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL16Context> saldosService
