...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL16Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL16Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL16Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL16Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL16Controller> Logger,
            RequisicionProceso<DemoTeckioAL16Context> Proceso,
            DemoTeckioAL16Context Context
            , IInsumoXRequisicionService<DemoTeckioAL16Context> Service)
        {
            _Logger = Logger;
