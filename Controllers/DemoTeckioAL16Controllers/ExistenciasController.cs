...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL16Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL16Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL16Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL16Controller(
            ILogger<ExistenciasDemoTeckioAL16Controller> Logger,
            DemoTeckioAL16Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL16Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL16Context> Proceso
            )
        {
            _Logger = Logger;
