...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL16Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL16Controller(
            ProyectoProceso<DemoTeckioAL16Context> proyectoProceso)
        {
