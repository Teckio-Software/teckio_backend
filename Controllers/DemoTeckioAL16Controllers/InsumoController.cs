...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL16Context> _InsumoProceso;
        public InsumoDemoTeckioAL16Controller(
            InsumoProceso<DemoTeckioAL16Context> insumoProceso)
        {
