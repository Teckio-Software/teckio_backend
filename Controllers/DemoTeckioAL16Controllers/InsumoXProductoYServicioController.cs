...
namespace ERP_TECKIO.Controllers.DemoTeckioAL16
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/16")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL16Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL16Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL16Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL16Context> process)
        {
            _service = service;
            _process = process;
        }
