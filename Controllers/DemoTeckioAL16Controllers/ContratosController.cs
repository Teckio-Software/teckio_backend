...
{
    [Route("api/contratos/16")]
    [ApiController]
    public class ContratosDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL16Context> _contratosProceso;
        public ContratosDemoTeckioAL16Controller(
            ContratosProceso<DemoTeckioAL16Context> contratosProceso
            )
        {
