...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EntradaProduccionAlmacenDemoTeckioAL16Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL16Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL16Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL16Context> proceso)
        {
            _proceso = proceso;
        }
