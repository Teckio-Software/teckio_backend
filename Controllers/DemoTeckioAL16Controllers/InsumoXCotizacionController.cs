...
{
    [Route("api/insumoxcotizacion/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL16Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL16Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL16Context> _Proceso;
        private readonly DemoTeckioAL16Context Context;
        public InsumoXCotizacionDemoTeckioAL16Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL16Controller> Logger,
            DemoTeckioAL16Context Context
            , IInsumoXCotizacionService<DemoTeckioAL16Context> Service
