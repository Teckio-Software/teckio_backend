...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL16Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL16Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL16Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL16Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL16Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL16Controller> logger,
            DemoTeckioAL16Context context
            , IAlmacenSalidaService<DemoTeckioAL16Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL16Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL16Context> Proceso
            )
        {
