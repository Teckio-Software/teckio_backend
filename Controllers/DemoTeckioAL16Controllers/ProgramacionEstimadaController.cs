...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL16Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL16Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL16Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL16Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL16Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL16Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL16Context> precioUnitarioService,
