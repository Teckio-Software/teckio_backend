...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL16Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL16Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL16Controller(
            EspecialidadProceso<DemoTeckioAL16Context> especialidadProceso)
        {
