...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL16Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL16Controller(
            TipoInsumoProceso<DemoTeckioAL16Context> tipoInsumoProceso
            )
        {
