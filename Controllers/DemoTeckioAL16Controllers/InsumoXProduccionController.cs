...
namespace ERP_TECKIO.Controllers.DemoTeckioAL16
{
    ...
    [Route("api/insumoXproduccion/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL16Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL16Context> proces)
        {
            _proceso = proces;
        }
