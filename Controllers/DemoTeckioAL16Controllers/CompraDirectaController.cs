...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL16Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL16Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL16Controller(
            ILogger<CompraDirectaDemoTeckioAL16Controller> logger,
            DemoTeckioAL16Context context
            , ICompraDirectaService<DemoTeckioAL16Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
