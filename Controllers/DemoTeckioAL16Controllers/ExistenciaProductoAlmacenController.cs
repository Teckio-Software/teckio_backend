...
namespace ERP_TECKIO.Controllers.DemoTeckioAL16
{
    ...
    [Route("api/existenciaproductoalmacen/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL16Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL16Context> proces)
        {
            _proceso = proces;
        }
