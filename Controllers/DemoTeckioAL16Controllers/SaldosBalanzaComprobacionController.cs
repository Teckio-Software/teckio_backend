...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL16Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL16Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL16Controller> _Logger;
        private readonly DemoTeckioAL16Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL16Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL16Controller> logger
            , DemoTeckioAL16Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL16Context> service
