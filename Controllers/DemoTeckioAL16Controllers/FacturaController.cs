...
{
    [Route("api/factura/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL16Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL16Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL16Controller(
            ObtenFacturaProceso<DemoTeckioAL16Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL16Context> categoriaProductoYServicioService
            )
        {
