...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL16Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL16Controller> Logger;
        ...
        public RubroDemoTeckioAL16Controller(
            ILogger<RubroDemoTeckioAL16Controller> logger,
            DemoTeckioAL16Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL16Context> service
            )
        {
            //_Service = service;
            Logger = logger;
