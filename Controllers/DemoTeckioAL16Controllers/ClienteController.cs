...
{
    [Route("api/cliente/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL16Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL16Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL16Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL16Controller(
            IClientesService<DemoTeckioAL16Context> service
            , ClienteProceso<DemoTeckioAL16Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL16Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
