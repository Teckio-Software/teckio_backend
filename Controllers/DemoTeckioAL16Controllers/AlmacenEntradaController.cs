...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL16Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL16Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL16Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL16Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL16Controller(
            ILogger<AlmacenEntradaDemoTeckioAL16Controller> logger,
            DemoTeckioAL16Context context
            , IAlmacenEntradaService<DemoTeckioAL16Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL16Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL16Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
