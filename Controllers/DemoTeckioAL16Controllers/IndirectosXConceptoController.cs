...
{
    [Route("api/indirectosXConcepto/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL16Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL16Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL16Controller(
            IIndirectosXConceptoService<DemoTeckioAL16Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL16Context> indirectosXConceptoProceso
            ) { 
