...
namespace ERP_TECKIO.Controllers.DemoTeckioAL16
{
    ...
    [Route("api/subcategoriaProductoServicio/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SubcategoriaProductoServicioController: ControllerBase
    {
        private readonly ISubcategoriaProdutoYServicio<DemoTeckioAL16Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<DemoTeckioAL16Context> service)
        {
            _service = service;
        }
