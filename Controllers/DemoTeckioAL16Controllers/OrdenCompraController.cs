...
{
    [Route("api/ordencompra/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL16Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL16Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL16Controller> _Logger;
        private readonly DemoTeckioAL16Context Context;
        private readonly PolizaProceso<DemoTeckioAL16Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL16Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL16Controller(
            ILogger<OrdenCompraDemoTeckioAL16Controller> Logger
            , DemoTeckioAL16Context Context
            , IOrdenCompraService<DemoTeckioAL16Context> Service
            , OrdenCompraProceso<DemoTeckioAL16Context> Proceso
            , PolizaProceso<DemoTeckioAL16Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL16Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
