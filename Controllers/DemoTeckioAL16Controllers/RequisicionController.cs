...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL16Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL16Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL16Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL16Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL16Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL16Controller(
            ILogger<RequisicionDemoTeckioAL16Controller> Logger
            , DemoTeckioAL16Context Context
            , IRequisicionService<DemoTeckioAL16Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL16Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL16Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL16Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL16Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/16/970"))
            {
