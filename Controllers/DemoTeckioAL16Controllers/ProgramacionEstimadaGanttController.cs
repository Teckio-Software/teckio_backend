...
namespace SistemaERP.API.Controllers.DemoTeckioAL16
{
    [Route("api/programacionestimadaGantt/16")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL16Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL16Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL16Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL16Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL16Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL16Context> importeSemanalGanttProceso,
