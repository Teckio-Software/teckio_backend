...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/16")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL16Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL16Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL16Controller(
            MovimientoBancarioProceso<DemoTeckioAL16Context> movimientoBancarioProceso
            )
        {
