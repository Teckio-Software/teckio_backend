...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL16Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL16Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL16Controller(
            ICuentaBancariaClienteService<DemoTeckioAL16Context> cuentaBancariaClienteService,
