...
namespace SistemaERP.API.DemoTeckioAL16Controllers.Procomi
{
    [Route("api/preciounitariodetalle/16")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL16Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL16Controller(
