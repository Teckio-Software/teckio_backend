...
namespace ERP_TECKIO
{
    ...
    public class PrecioUnitarioDemoTeckioAL16Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL16Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL16Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL16Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL16Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL16Controller(
            PrecioUnitarioProceso<DemoTeckioAL16Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL16Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL16Context> options,
            ExplocionInsumosProceso<DemoTeckioAL16Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL16Context(_Options.Options))
            {
