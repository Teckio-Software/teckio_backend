...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL16Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL16Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL16Controller(
            ReporteDestajoProceso<DemoTeckioAL16Context> proceso,
