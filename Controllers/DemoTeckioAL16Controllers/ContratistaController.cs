...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/16")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL16Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL16Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL16Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL16Controller(
            ILogger<ContratistaDemoTeckioAL16Controller> logger,
            DemoTeckioAL16Context context
            , IContratistaService<DemoTeckioAL16Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL16Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
