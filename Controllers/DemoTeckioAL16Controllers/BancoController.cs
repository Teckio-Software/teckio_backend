...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL16Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL16Context> _bancoService;

        public BancoDemoTeckioAL16Controller(IBancoService<DemoTeckioAL16Context> bancoService)
        {
