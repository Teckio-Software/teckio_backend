...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL16Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL16Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL16Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL16Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL16Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL16Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL16Controller(
            ILogger<CuentaContableDemoTeckioAL16Controller> logger,
            DemoTeckioAL16Context context
            , ICuentaContableService<DemoTeckioAL16Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL16Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL16Context> RubroService
            , CuentaContableProceso<DemoTeckioAL16Context> proceso
            )
        {
            Logger = logger;
            Context = context;
