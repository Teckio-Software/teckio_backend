...
{
    [Route("api/cotizacion/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL16Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL16Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL16Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL16Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL16Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL16Controller> _Logger;
        private readonly DemoTeckioAL16Context Context;
        public CotizacionDemoTeckioAL16Controller(

            ILogger<CotizacionDemoTeckioAL16Controller> Logger
            , DemoTeckioAL16Context Context
            , ICotizacionService<DemoTeckioAL16Context> Service
            , IOrdenCompraService<DemoTeckioAL16Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL16Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL16Context> Proceso)
        {
            _Logger = Logger;
