...
{
    [Route("api/insumoxordencompra/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL16Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL16Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL16Controller> _Logger;
        private readonly DemoTeckioAL16Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL16Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL16Controller> Logger,
            DemoTeckioAL16Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL16Context> Service
