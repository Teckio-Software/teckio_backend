...
namespace ERP_TECKIO.Controllers.DemoTeckioAL16
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL16Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL16Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL16Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL16Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL16Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL16Context> porcentajeCesantiaEdadService
            )
        {
