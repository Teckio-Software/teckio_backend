...
{
    [Route("api/empleado/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL16Context> _empleadoService;
        public EmpleadoDemoTeckioAL16Controller(
            IEmpleadoService<DemoTeckioAL16Context> empleadoService
            )
        {
