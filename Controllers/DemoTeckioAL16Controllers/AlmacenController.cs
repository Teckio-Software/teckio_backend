...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL16Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL16Context> _almacenProceso;

        public AlmacenDemoTeckioAL16Controller(
            IAlmacenService<DemoTeckioAL16Context> almacenServicio, AlmacenProceso<DemoTeckioAL16Context> almacenProceso)
        {
