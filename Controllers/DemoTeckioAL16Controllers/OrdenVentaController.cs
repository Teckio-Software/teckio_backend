...
{
    [Route("api/ordenventa/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL16Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL16Controller(
            OrdenVentaProceso<DemoTeckioAL16Context> ordenVentaProceso
            ) { 
