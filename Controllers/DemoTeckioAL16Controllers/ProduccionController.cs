...
namespace ERP_TECKIO.Controllers.DemoTeckioAL16
{
    ...
    [Route("api/produccion/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL16Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL16Context> proceso)
        {
            _proceso = proceso;
        }
