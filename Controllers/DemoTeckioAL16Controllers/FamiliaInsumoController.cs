...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL16Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL16Controller(
            FamiliaInsumoProceso<DemoTeckioAL16Context> familiaInsumoProceso)
        {
