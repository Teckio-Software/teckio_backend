...
{
    [Route("api/parametrosImpresionPu/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ParametrosImpresionPuController : ControllerBase
    {

        private readonly ParametrosImpresionPuProceso<DemoTeckioAL16Context> _proceso;

        public ParametrosImpresionPuController(ParametrosImpresionPuProceso<DemoTeckioAL16Context> proceso)
        {
            _proceso = proceso;
        }
