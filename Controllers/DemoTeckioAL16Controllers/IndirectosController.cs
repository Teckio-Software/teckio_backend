...
{
    [Route("api/indirectos/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL16Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL16Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL16Context> _indirectosProceso;

        public IndirectosDemoTeckioAL16Controller(
                        IConjuntoIndirectosService<DemoTeckioAL16Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL16Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL16Context> indirectosProceso
            )
        {
