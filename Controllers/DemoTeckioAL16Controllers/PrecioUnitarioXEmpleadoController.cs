...
{
    [Route("api/precioUnitarioXEmpleado/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL16Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL16Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL16Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL16Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL16Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL16Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
