...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/16")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL16Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL16Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL16Context> _servicio;
        public CuentaBancariaDemoTeckioAL16Controller(CuentaBancariaProceso<DemoTeckioAL16Context> _proceso, ICuentaBancariaService<DemoTeckioAL16Context> _servicio
           )
        {
