...
namespace ERP_TECKIO.Controllers.GrupoTeckio
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/2")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<GrupoTeckioContext> _service;
        private readonly InsumoXProductoYServicioProceso<GrupoTeckioContext> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<GrupoTeckioContext> service, InsumoXProductoYServicioProceso<GrupoTeckioContext> process)
        {
            _service = service;
            _process = process;
        }
