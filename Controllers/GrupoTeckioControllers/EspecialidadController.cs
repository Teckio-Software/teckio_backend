...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadGrupoTeckioController : ControllerBase
    {
        private readonly EspecialidadProceso<GrupoTeckioContext> _EspecialidadProceso;
        public EspecialidadGrupoTeckioController(
            EspecialidadProceso<GrupoTeckioContext> especialidadProceso)
        {
