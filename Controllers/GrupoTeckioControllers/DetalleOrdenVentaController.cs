...
{
    [Route("api/detalleordencompra/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class DetalleOrdenVentaController: ControllerBase
    {
        private readonly DetalleOrdenVentaProceso<GrupoTeckioContext> _Proceso;

        public DetalleOrdenVentaController(DetalleOrdenVentaProceso<GrupoTeckioContext> proceso)
        {
            _Proceso = proceso;
        }
