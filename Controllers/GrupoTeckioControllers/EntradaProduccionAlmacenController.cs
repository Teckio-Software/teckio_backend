...
{
    [Route("api/entradaproduccionalmacen/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenGrupoTeckioController : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<GrupoTeckioContext> _proceso;

        public EntradaProduccionAlmacenGrupoTeckioController(EntradaProduccionAlmacenProceso<GrupoTeckioContext> proceso)
        {
            _proceso = proceso;
        }
