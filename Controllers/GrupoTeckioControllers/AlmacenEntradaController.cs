...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaGrupoTeckioController : ControllerBase
    {
        private readonly IAlmacenEntradaService<GrupoTeckioContext> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<GrupoTeckioContext> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<GrupoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaGrupoTeckioController> Logger;
        /// <summary>
        ...
        public AlmacenEntradaGrupoTeckioController(
            ILogger<AlmacenEntradaGrupoTeckioController> logger,
            GrupoTeckioContext context
            , IAlmacenEntradaService<GrupoTeckioContext> almacenServicio
            , IInsumoXAlmacenEntradaService<GrupoTeckioContext> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<GrupoTeckioContext> Proceso
            )
        {
            Logger = logger;
            Context = context;
