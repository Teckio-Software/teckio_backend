...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaGrupoTeckioController : ControllerBase
    {
        private readonly IAlmacenSalidaService<GrupoTeckioContext> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<GrupoTeckioContext> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<GrupoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaGrupoTeckioController> Logger;
        ...
        public AlmacenSalidaGrupoTeckioController(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaGrupoTeckioController> logger,
            GrupoTeckioContext context
            , IAlmacenSalidaService<GrupoTeckioContext> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<GrupoTeckioContext> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<GrupoTeckioContext> Proceso
            )
        {
