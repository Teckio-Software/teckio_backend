...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenGrupoTeckioController : ControllerBase
    {
        private readonly IAlmacenService<GrupoTeckioContext> _almacenServicio;
        private readonly AlmacenProceso<GrupoTeckioContext> _almacenProceso;

        public AlmacenGrupoTeckioController(
            IAlmacenService<GrupoTeckioContext> almacenServicio, AlmacenProceso<GrupoTeckioContext> almacenProceso)
        {
