...
namespace ERP_TECKIO.Controllers.GrupoTeckio
{
    ...
    public class ProductoYServicioGrupoTeckioController : ControllerBase
    {
        ...
        private readonly IProductoYservicioService<GrupoTeckioContext> _productoYServicioService;

        private readonly ProductoYServicioProceso<GrupoTeckioContext> _process;

        public ProductoYServicioGrupoTeckioController(IProductoYservicioService<GrupoTeckioContext> productoYServicioService,
            ProductoYServicioProceso<GrupoTeckioContext> process
            )
        {
