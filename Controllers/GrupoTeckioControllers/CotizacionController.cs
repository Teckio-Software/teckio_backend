...
{
    [Route("api/cotizacion/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionGrupoTeckioController : ControllerBase
    {
        private readonly ICotizacionService<GrupoTeckioContext> _Service;
        private readonly CotizacionProceso<GrupoTeckioContext> _Proceso;
        private readonly IOrdenCompraService<GrupoTeckioContext> _OrdenCompraService;
        private readonly ITipoImpuestoService<GrupoTeckioContext> _TipoImpuestoService;
        private readonly ILogger<CotizacionGrupoTeckioController> _Logger;
        private readonly GrupoTeckioContext Context;
        public CotizacionGrupoTeckioController(

            ILogger<CotizacionGrupoTeckioController> Logger
            , GrupoTeckioContext Context
            , ICotizacionService<GrupoTeckioContext> Service
            , IOrdenCompraService<GrupoTeckioContext> OrdenCompraService,
              ITipoImpuestoService<GrupoTeckioContext> TipoImpuestoService
            , CotizacionProceso<GrupoTeckioContext> Proceso)
        {
            _Logger = Logger;
