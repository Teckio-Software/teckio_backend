...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoGrupoTeckioController : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<GrupoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoGrupoTeckioController> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoGrupoTeckioController(
            ILogger<CompraDirectaInsumoGrupoTeckioController> logger
            , GrupoTeckioContext context
            , IInsumoXCompraDirectaService<GrupoTeckioContext> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
