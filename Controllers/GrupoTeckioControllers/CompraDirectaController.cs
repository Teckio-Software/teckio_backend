...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaGrupoTeckioController : ControllerBase
    {
        private readonly ICompraDirectaService<GrupoTeckioContext> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaGrupoTeckioController> Logger;
        /// <summary>
        ...
        public CompraDirectaGrupoTeckioController(
            ILogger<CompraDirectaGrupoTeckioController> logger,
            GrupoTeckioContext context
            , ICompraDirectaService<GrupoTeckioContext> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
