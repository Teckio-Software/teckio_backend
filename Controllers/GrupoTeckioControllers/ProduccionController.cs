...
namespace ERP_TECKIO.Controllers.GrupoTeckio
{
    ...
    [Route("api/produccion/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<GrupoTeckioContext> _proceso;

        public ProduccionController(ProduccionProceso<GrupoTeckioContext> proceso)
        {
            _proceso = proceso;
        }
