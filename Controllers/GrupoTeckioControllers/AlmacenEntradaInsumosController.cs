...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentradainsumo/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEntradaAlmacen-Empresa1")]
    public class AlmacenEntradaInsumoGrupoTeckioController : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoGrupoTeckioController> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly GrupoTeckioContext Context;
        private readonly IInsumoXAlmacenEntradaService<GrupoTeckioContext> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoGrupoTeckioController(
            ILogger<AlmacenEntradaInsumoGrupoTeckioController> logger,
            GrupoTeckioContext context
            , IInsumoXAlmacenEntradaService<GrupoTeckioContext> AlmacenEntradaDetalle
