...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoGrupoTeckioController : ControllerBase
    {
        private readonly IIndirectosXConceptoService<GrupoTeckioContext> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<GrupoTeckioContext> _indirectosXConceptoProceso;
        public IndirectosXConceptoGrupoTeckioController(
            IIndirectosXConceptoService<GrupoTeckioContext> indirectosXConceptoService,
            IndirectosXConceptoProceso<GrupoTeckioContext> indirectosXConceptoProceso
            ) { 
