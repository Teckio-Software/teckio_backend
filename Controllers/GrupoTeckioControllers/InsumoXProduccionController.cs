...
namespace ERP_TECKIO.Controllers.GrupoTeckio
{
    ...
    [Route("api/insumoXproduccion/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<GrupoTeckioContext> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<GrupoTeckioContext> proces)
        {
            _proceso = proces;
        }
