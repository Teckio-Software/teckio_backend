...
namespace ERP_TECKIO.Controllers.GrupoTeckio
{
    ...
    {
        private readonly FactorSalarioRealProceso<GrupoTeckioContext> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<GrupoTeckioContext> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<GrupoTeckioContext> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<GrupoTeckioContext> factorSalarioRealProceso,
            IParametrosFsrService<GrupoTeckioContext> parametrosFsrService,
            IPorcentajeCesantiaEdadService<GrupoTeckioContext> porcentajeCesantiaEdadService
            )
        {
