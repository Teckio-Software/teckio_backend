...
{
    [Route("api/programacionestimada/2")]
    [ApiController]
    public class ProgramacionEstimadaGrupoTeckioController : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<GrupoTeckioContext> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<GrupoTeckioContext> _ProyectoService;
        private readonly IPrecioUnitarioService<GrupoTeckioContext> _PrecioUnitarioService;


        public ProgramacionEstimadaGrupoTeckioController(
            ProgramacionEstimadaProceso<GrupoTeckioContext> programacionEstimadaProceso,
            IProyectoService<GrupoTeckioContext> proyectoProceso,
            IPrecioUnitarioService<GrupoTeckioContext> precioUnitarioService,
