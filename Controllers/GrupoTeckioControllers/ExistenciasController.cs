...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasGrupoTeckioController : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<GrupoTeckioContext> _ExistenciaService;
        private readonly ExistenciasProceso<GrupoTeckioContext> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasGrupoTeckioController> _Logger;
        /// <summary>
        ...
        public ExistenciasGrupoTeckioController(
            ILogger<ExistenciasGrupoTeckioController> Logger,
            GrupoTeckioContext Context
            , IAlmacenExistenciaInsumoService<GrupoTeckioContext> ExistenciaService
            , ExistenciasProceso<GrupoTeckioContext> Proceso
            )
        {
            _Logger = Logger;
