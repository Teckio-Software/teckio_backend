...
{
    [Route("api/parametrosImpresionPu/2")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ParametrosImpresionPuController : ControllerBase
    {

        private readonly ParametrosImpresionPuProceso<GrupoTeckioContext> _proceso;

        public ParametrosImpresionPuController(ParametrosImpresionPuProceso<GrupoTeckioContext> proceso)
        {
            _proceso = proceso;
        }
