...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratistacuentabancaria/2")]
    [ApiController]
    public class ContratistaCuentaBancariaGrupoTeckioController : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ContratistaCuentaBancariaGrupoTeckioController> Logger;
        /// <summary>
        ...
        public ContratistaCuentaBancariaGrupoTeckioController(
            ILogger<ContratistaCuentaBancariaGrupoTeckioController> logger,
