...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa13")]
    public class InsumoXContratistaAlumno13Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno13Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno13Controller(
            ILogger<InsumoXContratistaAlumno13Controller> logger,
