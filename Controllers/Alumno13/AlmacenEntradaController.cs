...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno13Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno13Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno13Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno13Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno13Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno13Controller(
            ILogger<AlmacenEntradaAlumno13Controller> logger,
            Alumno13Context context
            , IAlmacenEntradaService<Alumno13Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno13Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno13Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
