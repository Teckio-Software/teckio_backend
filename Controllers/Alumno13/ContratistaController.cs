...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno13Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno13Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno13Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno13Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno13Controller(
            ILogger<ContratistaAlumno13Controller> logger,
            Alumno13Context context
            , IContratistaService<Alumno13Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno13Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
