...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno13Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno13Context> service)
        {
            _service = service;
        }
