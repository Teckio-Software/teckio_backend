...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno13Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno13Context> process)
        {
            _process = process;
        }
