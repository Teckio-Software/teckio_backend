...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno13Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno13Context> _empleadoService;
        public EmpleadoAlumno13Controller(
            IEmpleadoService<Alumno13Context> empleadoService
            )
        {
