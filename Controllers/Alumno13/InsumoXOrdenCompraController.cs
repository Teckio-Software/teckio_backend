...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno13Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno13Context> _Service;
        private readonly OrdenCompraProceso<Alumno13Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno13Controller> _Logger;
        private readonly Alumno13Context _Context;
        public InsumoXOrdenCompraAlumno13Controller(
            ILogger<InsumoXOrdenCompraAlumno13Controller> Logger,
            Alumno13Context Context
            , IInsumoXOrdenCompraService<Alumno13Context> Service
