...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno13Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno13Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno13Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno13Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno13Controller> Logger;
        ...
        public AlmacenSalidaAlumno13Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno13Controller> logger,
            Alumno13Context context
            , IAlmacenSalidaService<Alumno13Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno13Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno13Context> Proceso
            )
        {
