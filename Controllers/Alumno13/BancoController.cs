...
namespace ERP_TECKIO.API.Controllers.Alumno13
{
    ...
    public class BancoAlumno13Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno13Context> _bancoService;

        public BancoAlumno13Controller(IBancoService<Alumno13Context> bancoService)
        {
