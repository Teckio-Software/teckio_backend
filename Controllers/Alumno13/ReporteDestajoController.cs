...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno13Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno13Context> _proceso;
        private readonly EstimacionesProceso<Alumno13Context> _estimacionesProceso;

        public ReporteDestajoAlumno13Controller(
            ReporteDestajoProceso<Alumno13Context> proceso,
