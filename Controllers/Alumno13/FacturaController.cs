...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    public class FacturaAlumno13Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno13Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno13Context> _categoriaProductoYServicioService;
        public FacturaAlumno13Controller(
            ObtenFacturaProceso<Alumno13Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno13Context> categoriaProductoYServicioService
            )
        {
