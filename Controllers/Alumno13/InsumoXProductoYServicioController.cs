...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno13Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno13Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno13Context> service, InsumoXProductoYServicioProceso<Alumno13Context> process)
        {
            _service = service;
            _process = process;
        }
