...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno13Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno13Context> _proceso;

        private readonly ICuentaBancariaService<Alumno13Context> _servicio;
        public CuentaBancariaAlumno13Controller(CuentaBancariaProceso<Alumno13Context> _proceso, ICuentaBancariaService<Alumno13Context> _servicio
           )
        {
