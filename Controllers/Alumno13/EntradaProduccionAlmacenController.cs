...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EntradaProduccionAlmacenAlumno13Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<Alumno13Context> _proceso;

        public EntradaProduccionAlmacenAlumno13Controller(EntradaProduccionAlmacenProceso<Alumno13Context> proceso)
        {
            _proceso = proceso;
        }
