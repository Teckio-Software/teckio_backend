...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno13Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno13Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno13Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno13Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno13Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno13Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno13Controller(
            ILogger<RequisicionAlumno13Controller> Logger
            , Alumno13Context Context
            , IRequisicionService<Alumno13Context> RequisicionService
            , RequisicionProceso<Alumno13Context> Proceso
            , ObjetoRequisicionProceso<Alumno13Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno13Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/13/970"))
            {
