...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa13")]
    public class CompraDirectaInsumoAlumno13Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno13Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno13Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno13Controller(
            ILogger<CompraDirectaInsumoAlumno13Controller> logger
            , Alumno13Context context
            , IInsumoXCompraDirectaService<Alumno13Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
