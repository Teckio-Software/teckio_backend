...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno13Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno13Context> proces)
        {
            _proceso = proces;
        }
