...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno13Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno13Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno13Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno13Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno13Controller(
            ILogger<AlmacenEntradaInsumoAlumno13Controller> logger,
            Alumno13Context context
            , IInsumoXAlmacenEntradaService<Alumno13Context> AlmacenEntradaDetalle
