...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno13Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno13Context> _Service;
        private readonly IPolizaDetalleService<Alumno13Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno13Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno13Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno13Context> _SaldosService;
        private readonly ILogger<PolizaAlumno13Controller> _Logger;
        private readonly Alumno13Context _Context;
        public PolizaAlumno13Controller(
            ILogger<PolizaAlumno13Controller> logger
            , Alumno13Context context
            , IPolizaService<Alumno13Context> service
            , IPolizaDetalleService<Alumno13Context> detalleService
            , ITipoPolizaService<Alumno13Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno13Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa13")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa13")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa13")]
