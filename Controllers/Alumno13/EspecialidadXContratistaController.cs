...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa13")]
    public class EspecialIdadXContratistaAlumno13Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno13Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno13Controller(
            ILogger<EspecialIdadXContratistaAlumno13Controller> logger,
