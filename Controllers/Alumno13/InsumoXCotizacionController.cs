...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno13Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno13Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno13Controller> _Logger;
        private readonly CotizacionProceso<Alumno13Context> _Proceso;
        private readonly Alumno13Context Context;
        public InsumoXCotizacionAlumno13Controller(
            ILogger<InsumoXCotizacionAlumno13Controller> Logger,
            Alumno13Context Context
            , IInsumoXCotizacionService<Alumno13Context> Service
