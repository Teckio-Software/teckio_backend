...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa13")]
    public class FamiliaInsumoAlumno13Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno13Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno13Controller(
            FamiliaInsumoProceso<Alumno13Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa13")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa13")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa13")]
