...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno13Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno13Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno13Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno13Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno13Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno13Context> porcentajeCesantiaEdadService
            )
        {
