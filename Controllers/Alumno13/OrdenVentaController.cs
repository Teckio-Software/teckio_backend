...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    public class OrdenVentaAlumno13Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno13Context> _ordenVentaProceso;
        public OrdenVentaAlumno13Controller(
            OrdenVentaProceso<Alumno13Context> ordenVentaProceso
            ) { 
