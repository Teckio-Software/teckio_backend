...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno13Controller : ControllerBase
    {
        private readonly IClientesService<Alumno13Context> _Service;

        private readonly ClienteProceso<Alumno13Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno13Context> _clientesCuentasContablesProceso;
        public ClienteAlumno13Controller(
            IClientesService<Alumno13Context> service
            , ClienteProceso<Alumno13Context> proceso,
            ClienteCuentasContablesProceso<Alumno13Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
