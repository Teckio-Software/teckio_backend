...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno13Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno13Context> _Service;
        private readonly CotizacionProceso<Alumno13Context> _Proceso;
        private readonly IOrdenCompraService<Alumno13Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno13Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno13Controller> _Logger;
        private readonly Alumno13Context Context;
        public CotizacionAlumno13Controller(

            ILogger<CotizacionAlumno13Controller> Logger
            , Alumno13Context Context
            , ICotizacionService<Alumno13Context> Service
            , IOrdenCompraService<Alumno13Context> OrdenCompraService,
              ITipoImpuestoService<Alumno13Context> TipoImpuestoService
            , CotizacionProceso<Alumno13Context> Proceso)
        {
            _Logger = Logger;
