...
namespace ERP_TECKIO.Controllers.Alumno13
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno13Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno13Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno13Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno13Controller(
            IPrecioUnitarioXEmpleadoService<Alumno13Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno13Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
