...
namespace ERP_TECKIO.API.Controllers.Alumno13
{
    ...
    [ApiController]
    public class ContratosAlumno13Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno13Context> _contratosProceso;
        public ContratosAlumno13Controller(
            ContratosProceso<Alumno13Context> contratosProceso
            )
        {
