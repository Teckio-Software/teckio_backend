...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno13Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno13Context> _almacenServicio;

        public AlmacenAlumno13Controller(
            IAlmacenService<Alumno13Context> almacenServicio)
        {
