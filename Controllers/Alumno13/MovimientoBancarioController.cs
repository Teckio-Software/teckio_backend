...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno13Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno13Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno13Controller(
            MovimientoBancarioProceso<Alumno13Context> movimientoBancarioProceso
            )
        {
