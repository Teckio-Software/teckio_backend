...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/13")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa13")]
    public class CompraDirectaAlumno13Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno13Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno13Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno13Controller(
            ILogger<CompraDirectaAlumno13Controller> logger,
            Alumno13Context context
            , ICompraDirectaService<Alumno13Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa13")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa13")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa13")]
