...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXRequisicionAlumno13Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno13Context> _Service;

        private readonly RequisicionProceso<Alumno13Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno13Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno13Controller(
            ILogger<InsumoXRequisicionAlumno13Controller> Logger,
            RequisicionProceso<Alumno13Context> Proceso,
            Alumno13Context Context
            , IInsumoXRequisicionService<Alumno13Context> Service)
        {
            _Logger = Logger;
