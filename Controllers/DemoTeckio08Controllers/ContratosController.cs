...
{
    [Route("api/contratos/8")]
    [ApiController]
    public class ContratosDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL08Context> _contratosProceso;
        public ContratosDemoTeckioAL08Controller(
            ContratosProceso<DemoTeckioAL08Context> contratosProceso
            )
        {
