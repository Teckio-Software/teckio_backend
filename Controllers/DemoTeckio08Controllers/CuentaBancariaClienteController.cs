...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL08Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL08Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL08Controller(
            ICuentaBancariaClienteService<DemoTeckioAL08Context> cuentaBancariaClienteService,
            CuentaBancariaProceso<DemoTeckioAL08Context> proceso
            )
        {
