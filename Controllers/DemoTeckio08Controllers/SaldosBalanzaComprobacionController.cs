...
{
    [Route("api/saldosbalanzacomprobacion/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSaldosBalanza-Empresa1")]
    public class SaldosBalanzaComprobacionDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL08Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL08Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL08Controller> _Logger;
        private readonly DemoTeckioAL08Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL08Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL08Controller> logger
            , DemoTeckioAL08Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL08Context> service
