...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL08Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL08Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL08Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL08Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL08Controller> logger,
            DemoTeckioAL08Context context
            , IAlmacenSalidaService<DemoTeckioAL08Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL08Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL08Context> Proceso
            )
        {
