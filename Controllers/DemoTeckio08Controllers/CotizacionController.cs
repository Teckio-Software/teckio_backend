...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL08Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL08Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL08Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL08Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL08Controller> _Logger;
        private readonly DemoTeckioAL08Context Context;
        public CotizacionDemoTeckioAL08Controller(

            ILogger<CotizacionDemoTeckioAL08Controller> Logger
            , DemoTeckioAL08Context Context
            , ICotizacionService<DemoTeckioAL08Context> Service
            , IOrdenCompraService<DemoTeckioAL08Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL08Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL08Context> Proceso)
        {
            _Logger = Logger;
