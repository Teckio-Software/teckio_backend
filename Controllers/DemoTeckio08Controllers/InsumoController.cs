...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL08Context> _InsumoProceso;
        public InsumoDemoTeckioAL08Controller(
            InsumoProceso<DemoTeckioAL08Context> insumoProceso)
        {
