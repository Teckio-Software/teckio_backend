...
{
    [Route("api/insumoxcotizacion/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL08Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL08Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL08Context> _Proceso;
        private readonly DemoTeckioAL08Context Context;
        public InsumoXCotizacionDemoTeckioAL08Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL08Controller> Logger,
            DemoTeckioAL08Context Context
            , IInsumoXCotizacionService<DemoTeckioAL08Context> Service
