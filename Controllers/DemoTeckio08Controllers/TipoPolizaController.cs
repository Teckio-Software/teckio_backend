...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL08Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL08Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL08Controller(
            ILogger<TipoPolizaDemoTeckioAL08Controller> logger,
            DemoTeckioAL08Context context
            , ITipoPolizaService<DemoTeckioAL08Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
