...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL08Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL08Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL08Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL08Controller> Logger,
            RequisicionProceso<DemoTeckioAL08Context> Proceso,
            DemoTeckioAL08Context Context
            , IInsumoXRequisicionService<DemoTeckioAL08Context> Service)
        {
            _Logger = Logger;
