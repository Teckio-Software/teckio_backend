...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL08Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL08Context> _bancoService;

        public BancoDemoTeckioAL08Controller(IBancoService<DemoTeckioAL08Context> bancoService)
        {
