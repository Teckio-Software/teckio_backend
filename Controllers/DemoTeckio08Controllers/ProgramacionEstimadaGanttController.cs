...
namespace SistemaERP.API.Controllers.DemoTeckioAL08
{
    [Route("api/programacionestimadaGantt/8")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL08Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL08Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL08Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL08Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL08Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL08Context> importeSemanalGanttProceso,
