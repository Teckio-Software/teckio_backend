...
{
    [Route("api/programacionestimada/8")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL08Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL08Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL08Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL08Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL08Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL08Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL08Context> precioUnitarioService,
