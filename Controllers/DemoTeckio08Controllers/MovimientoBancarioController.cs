...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/8")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL08Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL08Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL08Controller(
            MovimientoBancarioProceso<DemoTeckioAL08Context> movimientoBancarioProceso
            )
        {
