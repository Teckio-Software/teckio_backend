...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL08Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL08Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL08Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL08Controller(
            IClientesService<DemoTeckioAL08Context> service
            , ClienteProceso<DemoTeckioAL08Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL08Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
