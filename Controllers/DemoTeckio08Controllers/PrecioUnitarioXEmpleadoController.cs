...
{
    [Route("api/precioUnitarioXEmpleado/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class PrecioUnitarioXEmpleadoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL08Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL08Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL08Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL08Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL08Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
