...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa1")]
    public class CompraDirectaInsumoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL08Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL08Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL08Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL08Controller> logger
            , DemoTeckioAL08Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL08Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
