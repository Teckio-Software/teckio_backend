...
{
    [Route("api/reportesdestajo/8")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL08Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL08Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL08Controller(
            ReporteDestajoProceso<DemoTeckioAL08Context> proceso,
            EstimacionesProceso<DemoTeckioAL08Context> estimacionesProceso
            ) { 
            _proceso = proceso;
