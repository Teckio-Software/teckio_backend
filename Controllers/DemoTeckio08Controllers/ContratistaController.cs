...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/8")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL08Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL08Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL08Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL08Controller(
            ILogger<ContratistaDemoTeckioAL08Controller> logger,
            DemoTeckioAL08Context context
            , IContratistaService<DemoTeckioAL08Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL08Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
