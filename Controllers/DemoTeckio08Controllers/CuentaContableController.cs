...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL08Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL08Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL08Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL08Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL08Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL08Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL08Controller(
            ILogger<CuentaContableDemoTeckioAL08Controller> logger,
            DemoTeckioAL08Context context
            , ICuentaContableService<DemoTeckioAL08Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL08Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL08Context> RubroService
            , CuentaContableProceso<DemoTeckioAL08Context> proceso
            )
        {
            Logger = logger;
            Context = context;
