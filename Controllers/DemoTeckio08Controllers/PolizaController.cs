...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL08Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL08Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL08Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL08Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL08Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL08Controller> _Logger;
        private readonly DemoTeckioAL08Context _Context;
        private readonly PolizaProceso<DemoTeckioAL08Context> _polizaProceso;
        public PolizaDemoTeckioAL08Controller(
            ILogger<PolizaDemoTeckioAL08Controller> logger
            , DemoTeckioAL08Context context
            , IPolizaService<DemoTeckioAL08Context> service
            , IPolizaDetalleService<DemoTeckioAL08Context> detalleService
            , ITipoPolizaService<DemoTeckioAL08Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL08Context> saldosService
            , ICuentaContableService<DemoTeckioAL08Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL08Context> polizaProceso
            )
        {
