...
{
    [Route("api/indirectosXConcepto/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL08Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL08Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL08Controller(
            IIndirectosXConceptoService<DemoTeckioAL08Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL08Context> indirectosXConceptoProceso
            ) { 
