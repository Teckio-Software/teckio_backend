...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EntradaProduccionAlmacenDemoTeckioAL08Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL08Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL08Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL08Context> proceso)
        {
            _proceso = proceso;
        }
