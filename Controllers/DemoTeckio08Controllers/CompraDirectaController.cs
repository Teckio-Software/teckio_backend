...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL08Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL08Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL08Controller(
            ILogger<CompraDirectaDemoTeckioAL08Controller> logger,
            DemoTeckioAL08Context context
            , ICompraDirectaService<DemoTeckioAL08Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
