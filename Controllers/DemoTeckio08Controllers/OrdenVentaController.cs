...
namespace ERP_TECKIO.Controllers.DemoTeckioAL08
{
    ...
    public class OrdenVentaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL08Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL08Controller(
            OrdenVentaProceso<DemoTeckioAL08Context> ordenVentaProceso
            ) { 
