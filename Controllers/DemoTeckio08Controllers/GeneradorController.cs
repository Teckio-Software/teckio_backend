...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL08Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL08Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL08Controller(
            GeneradoresProceso<DemoTeckioAL08Context> generadoresProceso)
        {
