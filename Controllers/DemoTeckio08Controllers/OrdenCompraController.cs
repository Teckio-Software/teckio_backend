...
{
    [Route("api/ordencompra/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL08Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL08Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL08Controller> _Logger;
        ...
        public OrdenCompraDemoTeckioAL08Controller(
            ILogger<OrdenCompraDemoTeckioAL08Controller> Logger
            , DemoTeckioAL08Context Context
            , IOrdenCompraService<DemoTeckioAL08Context> Service
            , OrdenCompraProceso<DemoTeckioAL08Context> Proceso
