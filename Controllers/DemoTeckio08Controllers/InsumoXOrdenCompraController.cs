...
{
    [Route("api/insumoxordencompra/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL08Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL08Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL08Controller> _Logger;
        private readonly DemoTeckioAL08Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL08Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL08Controller> Logger,
            DemoTeckioAL08Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL08Context> Service
