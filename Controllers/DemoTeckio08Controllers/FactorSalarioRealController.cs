...
namespace ERP_TECKIO.Controllers.DemoTeckioAL08
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL08Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL08Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL08Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL08Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL08Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL08Context> porcentajeCesantiaEdadService
            )
        {
