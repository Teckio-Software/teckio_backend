...
namespace SistemaERP.API.DemoTeckioAL08Controllers.Procomi
{
    [Route("api/preciounitariodetalle/8")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL08Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL08Controller(
