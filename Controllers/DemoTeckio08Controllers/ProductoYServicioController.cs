...
{
    [Route("api/productoyservicio/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL08Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL08Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL08Context> _process;

        public ProductoYServicioDemoTeckioAL08Controller(IProductoYservicioService<DemoTeckioAL08Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL08Context> process
            )
        {
