...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL08Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL08Controller(
            ConceptoProceso<DemoTeckioAL08Context> conceptoProceso)
        {
