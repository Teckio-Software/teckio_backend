...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL08Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL08Controller> Logger;
        ...
        public RubroDemoTeckioAL08Controller(
            ILogger<RubroDemoTeckioAL08Controller> logger,
            DemoTeckioAL08Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL08Context> service
            )
        {
            //_Service = service;
            Logger = logger;
