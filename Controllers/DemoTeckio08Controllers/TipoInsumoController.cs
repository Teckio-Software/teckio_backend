...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL08Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL08Controller(
            TipoInsumoProceso<DemoTeckioAL08Context> tipoInsumoProceso
            )
        {
