...
namespace ERP_TECKIO.Controllers.DemoTeckioAL08
{
    ...
    [Route("api/produccion/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL08Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL08Context> proceso)
        {
            _proceso = proceso;
        }
