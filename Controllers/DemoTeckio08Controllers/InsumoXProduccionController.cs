...
namespace ERP_TECKIO.Controllers.DemoTeckioAL08
{
    ...
    [Route("api/insumoXproduccion/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL08Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL08Context> proces)
        {
            _proceso = proces;
        }
