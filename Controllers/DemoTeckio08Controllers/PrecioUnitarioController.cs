...
{
    [Route("api/preciounitario/8")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL08Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL08Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL08Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL08Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL08Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL08Controller(
            PrecioUnitarioProceso<DemoTeckioAL08Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL08Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL08Context> options,
            ExplocionInsumosProceso<DemoTeckioAL08Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL08Context(_Options.Options))
            {
