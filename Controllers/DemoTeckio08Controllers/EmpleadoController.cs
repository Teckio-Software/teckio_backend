...
{
    [Route("api/empleado/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL08Context> _empleadoService;
        public EmpleadoDemoTeckioAL08Controller(
            IEmpleadoService<DemoTeckioAL08Context> empleadoService
            )
        {
