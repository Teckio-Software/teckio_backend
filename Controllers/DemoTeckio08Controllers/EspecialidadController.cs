...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL08Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL08Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL08Controller(
            EspecialidadProceso<DemoTeckioAL08Context> especialidadProceso)
        {
