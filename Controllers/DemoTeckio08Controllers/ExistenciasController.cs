...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL08Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL08Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL08Controller(
            ILogger<ExistenciasDemoTeckioAL08Controller> Logger,
            DemoTeckioAL08Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL08Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL08Context> Proceso
            )
        {
            _Logger = Logger;
