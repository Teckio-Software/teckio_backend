...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL08Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL08Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL08Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL08Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL08Controller(
            ILogger<AlmacenEntradaDemoTeckioAL08Controller> logger,
            DemoTeckioAL08Context context
            , IAlmacenEntradaService<DemoTeckioAL08Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL08Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL08Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
