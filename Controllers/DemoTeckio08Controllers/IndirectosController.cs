...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL08Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL08Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL08Context> _indirectosProceso;

        public IndirectosDemoTeckioAL08Controller(
                        IConjuntoIndirectosService<DemoTeckioAL08Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL08Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL08Context> indirectosProceso
            )
        {
