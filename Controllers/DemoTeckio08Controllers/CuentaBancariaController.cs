...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/8")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL08Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL08Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL08Context> _servicio;
        public CuentaBancariaDemoTeckioAL08Controller(CuentaBancariaProceso<DemoTeckioAL08Context> _proceso, ICuentaBancariaService<DemoTeckioAL08Context> _servicio
           )
        {
