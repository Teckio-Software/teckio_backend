...
namespace ERP_TECKIO.Controllers.DemoTeckioAL08
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/8")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL08Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL08Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL08Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL08Context> process)
        {
            _service = service;
            _process = process;
        }
