...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL08Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL08Controller(
            FamiliaInsumoProceso<DemoTeckioAL08Context> familiaInsumoProceso)
        {
