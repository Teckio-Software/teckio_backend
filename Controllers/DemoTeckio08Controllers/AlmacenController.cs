...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenDemoTeckioAL08Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL08Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL08Context> _almacenProceso;

        public AlmacenDemoTeckioAL08Controller(
            IAlmacenService<DemoTeckioAL08Context> almacenServicio, AlmacenProceso<DemoTeckioAL08Context> almacenProceso)
        {
