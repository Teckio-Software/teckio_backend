...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL08Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL08Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL08Controller(
            ProyectoProceso<DemoTeckioAL08Context> proyectoProceso)
        {
