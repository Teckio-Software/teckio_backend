...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL25Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL25Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL25Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL25Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL25Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL25Controller> _Logger;
        private readonly DemoTeckioAL25Context _Context;
        private readonly PolizaProceso<DemoTeckioAL25Context> _polizaProceso;
        public PolizaDemoTeckioAL25Controller(
            ILogger<PolizaDemoTeckioAL25Controller> logger
            , DemoTeckioAL25Context context
            , IPolizaService<DemoTeckioAL25Context> service
            , IPolizaDetalleService<DemoTeckioAL25Context> detalleService
            , ITipoPolizaService<DemoTeckioAL25Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL25Context> saldosService
            , ICuentaContableService<DemoTeckioAL25Context> cuentaContableService
            , PolizaProceso<DemoTeckioAL25Context> polizaProceso
            )
        {
