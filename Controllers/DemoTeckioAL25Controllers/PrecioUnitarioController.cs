...
{
    [Route("api/preciounitario/25")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL25Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL25Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL25Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL25Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL25Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL25Controller(
            PrecioUnitarioProceso<DemoTeckioAL25Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL25Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL25Context> options,
            ExplocionInsumosProceso<DemoTeckioAL25Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL25Context(_Options.Options))
            {
