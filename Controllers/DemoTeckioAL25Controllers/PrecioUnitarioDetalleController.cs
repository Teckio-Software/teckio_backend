...
namespace SistemaERP.API.DemoTeckioAL25Controllers.Procomi
{
    [Route("api/preciounitariodetalle/25")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL25Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL25Controller(
