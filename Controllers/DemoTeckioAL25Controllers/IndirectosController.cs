...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL25Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL25Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL25Context> _indirectosProceso;

        public IndirectosDemoTeckioAL25Controller(
                        IConjuntoIndirectosService<DemoTeckioAL25Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL25Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL25Context> indirectosProceso
            )
        {
