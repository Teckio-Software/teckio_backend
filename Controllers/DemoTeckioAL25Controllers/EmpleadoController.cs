...
{
    [Route("api/empleado/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL25Context> _empleadoService;
        public EmpleadoDemoTeckioAL25Controller(
            IEmpleadoService<DemoTeckioAL25Context> empleadoService
            )
        {
