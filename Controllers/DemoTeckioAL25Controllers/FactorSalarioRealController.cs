...
namespace ERP_TECKIO.Controllers.DemoTeckioAL25
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL25Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL25Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL25Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL25Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL25Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL25Context> porcentajeCesantiaEdadService
            )
        {
