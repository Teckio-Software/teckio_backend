...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL25Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL25Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL25Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL25Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL25Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL25Controller(
            ILogger<RequisicionDemoTeckioAL25Controller> Logger
            , DemoTeckioAL25Context Context
            , IRequisicionService<DemoTeckioAL25Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL25Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL25Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL25Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/25/970"))
            {
