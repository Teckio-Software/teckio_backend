...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL25Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL25Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL25Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL25Controller(
            ILogger<AlmacenEntradaDemoTeckioAL25Controller> logger,
            DemoTeckioAL25Context context
            , IAlmacenEntradaService<DemoTeckioAL25Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL25Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL25Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
