...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ReporteDestajoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL25Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL25Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL25Controller(
            ReporteDestajoProceso<DemoTeckioAL25Context> proceso,
