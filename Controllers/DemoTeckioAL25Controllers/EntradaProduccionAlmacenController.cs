...
{
    [Route("api/entradaproduccionalmacen/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL25Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL25Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL25Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL25Context> proceso)
        {
            _proceso = proceso;
        }
