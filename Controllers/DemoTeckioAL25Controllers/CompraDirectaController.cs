...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL25Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL25Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL25Controller(
            ILogger<CompraDirectaDemoTeckioAL25Controller> logger,
            DemoTeckioAL25Context context
            , ICompraDirectaService<DemoTeckioAL25Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
