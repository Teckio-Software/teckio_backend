...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL25Context> _InsumoProceso;
        public InsumoDemoTeckioAL25Controller(
            InsumoProceso<DemoTeckioAL25Context> insumoProceso)
        {
