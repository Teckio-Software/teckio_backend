...
namespace ERP_TECKIO.Controllers.DemoTeckioAL25
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/25")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL25Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL25Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL25Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL25Context> process)
        {
            _service = service;
            _process = process;
        }
