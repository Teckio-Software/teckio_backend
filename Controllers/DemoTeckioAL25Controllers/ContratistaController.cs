...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/25")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL25Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL25Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL25Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL25Controller(
            ILogger<ContratistaDemoTeckioAL25Controller> logger,
            DemoTeckioAL25Context context
            , IContratistaService<DemoTeckioAL25Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL25Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
