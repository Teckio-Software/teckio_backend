...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/25")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL25Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL25Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL25Controller(
            MovimientoBancarioProceso<DemoTeckioAL25Context> movimientoBancarioProceso
            )
        {
