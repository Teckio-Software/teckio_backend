...
{
    [Route("api/factura/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL25Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL25Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL25Controller(
            ObtenFacturaProceso<DemoTeckioAL25Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL25Context> categoriaProductoYServicioService
            )
        {
