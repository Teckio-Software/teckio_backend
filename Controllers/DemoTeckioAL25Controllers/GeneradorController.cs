...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL25Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL25Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL25Controller(
            GeneradoresProceso<DemoTeckioAL25Context> generadoresProceso)
        {
