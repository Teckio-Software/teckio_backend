...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL25Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL25Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL25Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL25Controller(
            IClientesService<DemoTeckioAL25Context> service
            , ClienteProceso<DemoTeckioAL25Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL25Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
