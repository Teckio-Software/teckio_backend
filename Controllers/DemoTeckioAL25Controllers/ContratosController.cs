...
{
    [Route("api/contratos/25")]
    [ApiController]
    public class ContratosDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL25Context> _contratosProceso;
        public ContratosDemoTeckioAL25Controller(
            ContratosProceso<DemoTeckioAL25Context> contratosProceso
            )
        {
