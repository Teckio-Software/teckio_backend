...
{
    [Route("api/insumoxordencompra/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL25Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL25Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL25Controller> _Logger;
        private readonly DemoTeckioAL25Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL25Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL25Controller> Logger,
            DemoTeckioAL25Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL25Context> Service
