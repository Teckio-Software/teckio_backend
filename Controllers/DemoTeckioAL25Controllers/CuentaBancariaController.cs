...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL25Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL25Context> _servicio;
        public CuentaBancariaDemoTeckioAL25Controller(CuentaBancariaProceso<DemoTeckioAL25Context> _proceso, ICuentaBancariaService<DemoTeckioAL25Context> _servicio
           )
        {
