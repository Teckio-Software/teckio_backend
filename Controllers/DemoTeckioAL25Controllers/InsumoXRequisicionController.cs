...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL25Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL25Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL25Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL25Controller> Logger,
            RequisicionProceso<DemoTeckioAL25Context> Proceso,
            DemoTeckioAL25Context Context
            , IInsumoXRequisicionService<DemoTeckioAL25Context> Service)
        {
            _Logger = Logger;
