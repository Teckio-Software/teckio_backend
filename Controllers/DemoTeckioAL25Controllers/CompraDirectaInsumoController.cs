...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaInsumoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<DemoTeckioAL25Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoDemoTeckioAL25Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoDemoTeckioAL25Controller(
            ILogger<CompraDirectaInsumoDemoTeckioAL25Controller> logger
            , DemoTeckioAL25Context context
            , IInsumoXCompraDirectaService<DemoTeckioAL25Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
