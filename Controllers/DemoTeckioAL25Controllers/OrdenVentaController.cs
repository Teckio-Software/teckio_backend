...
{
    [Route("api/ordenventa/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL25Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL25Controller(
            OrdenVentaProceso<DemoTeckioAL25Context> ordenVentaProceso
            ) { 
