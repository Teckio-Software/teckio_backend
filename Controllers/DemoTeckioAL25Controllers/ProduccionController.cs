...
namespace ERP_TECKIO.Controllers.DemoTeckioAL25
{
    ...
    [Route("api/produccion/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL25Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL25Context> proceso)
        {
            _proceso = proceso;
        }
