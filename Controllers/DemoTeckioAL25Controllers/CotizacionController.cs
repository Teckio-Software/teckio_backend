...
{
    [Route("api/cotizacion/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CotizacionDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL25Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL25Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL25Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL25Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL25Controller> _Logger;
        private readonly DemoTeckioAL25Context Context;
        public CotizacionDemoTeckioAL25Controller(

            ILogger<CotizacionDemoTeckioAL25Controller> Logger
            , DemoTeckioAL25Context Context
            , ICotizacionService<DemoTeckioAL25Context> Service
            , IOrdenCompraService<DemoTeckioAL25Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL25Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL25Context> Proceso)
        {
            _Logger = Logger;
