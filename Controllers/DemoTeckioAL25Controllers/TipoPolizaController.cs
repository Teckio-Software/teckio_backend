...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL25Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL25Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL25Controller(
            ILogger<TipoPolizaDemoTeckioAL25Controller> logger,
            DemoTeckioAL25Context context
            , ITipoPolizaService<DemoTeckioAL25Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
