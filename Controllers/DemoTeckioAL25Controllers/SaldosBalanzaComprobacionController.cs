...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL25Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL25Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL25Controller> _Logger;
        private readonly DemoTeckioAL25Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL25Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL25Controller> logger
            , DemoTeckioAL25Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL25Context> service
