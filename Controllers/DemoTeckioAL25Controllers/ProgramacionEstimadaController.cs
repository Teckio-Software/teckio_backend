...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL25Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL25Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL25Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL25Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL25Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL25Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL25Context> precioUnitarioService,
