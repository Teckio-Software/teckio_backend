...
namespace ERP_TECKIO.Controllers.DemoTeckioAL25
{
    ...
    [Route("api/existenciaproductoalmacen/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL25Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL25Context> proces)
        {
            _proceso = proces;
        }
