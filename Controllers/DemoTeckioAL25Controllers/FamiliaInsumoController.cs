...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL25Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL25Controller(
            FamiliaInsumoProceso<DemoTeckioAL25Context> familiaInsumoProceso)
        {
