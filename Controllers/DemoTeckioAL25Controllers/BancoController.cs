...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL25Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL25Context> _bancoService;

        public BancoDemoTeckioAL25Controller(IBancoService<DemoTeckioAL25Context> bancoService)
        {
