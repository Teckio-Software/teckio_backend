...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaEmpresaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ICuentaBancariaEmpresaService<DemoTeckioAL25Context> _cuentaBancariaEmpresaService;
        private readonly CuentaBancariaProceso<DemoTeckioAL25Context> _proceso;

        public CuentaBancariaEmpresaDemoTeckioAL25Controller(
            ICuentaBancariaEmpresaService<DemoTeckioAL25Context> cuentaBancariaEmpresaService,
