...
namespace SistemaERP.API.Controllers.DemoTeckioAL25
{
    [Route("api/programacionestimadaGantt/25")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL25Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL25Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL25Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL25Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL25Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL25Context> importeSemanalGanttProceso,
