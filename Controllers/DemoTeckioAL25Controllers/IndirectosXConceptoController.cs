...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosXConceptoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL25Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL25Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL25Controller(
            IIndirectosXConceptoService<DemoTeckioAL25Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL25Context> indirectosXConceptoProceso
            ) { 
