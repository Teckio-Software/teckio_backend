...
{
    [Route("api/ordencompra/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL25Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL25Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL25Controller> _Logger;
        private readonly DemoTeckioAL25Context Context;
        private readonly PolizaProceso<DemoTeckioAL25Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL25Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL25Controller(
            ILogger<OrdenCompraDemoTeckioAL25Controller> Logger
            , DemoTeckioAL25Context Context
            , IOrdenCompraService<DemoTeckioAL25Context> Service
            , OrdenCompraProceso<DemoTeckioAL25Context> Proceso
            , PolizaProceso<DemoTeckioAL25Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL25Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
