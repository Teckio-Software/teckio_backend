...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL25Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL25Controller(
            ConceptoProceso<DemoTeckioAL25Context> conceptoProceso)
        {
