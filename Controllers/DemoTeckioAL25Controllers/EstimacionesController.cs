...
{
    [Route("api/estimaciones/25")]
    [ApiController]
    public class EstimacionesDemoTeckioAL25Controller : ControllerBase
    {
        private readonly EstimacionesProceso<DemoTeckioAL25Context> _estimacionesProceso;
        public EstimacionesDemoTeckioAL25Controller(
            EstimacionesProceso<DemoTeckioAL25Context> estimacionesProceso
            )
        {
