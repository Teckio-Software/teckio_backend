...
{
    [Route("api/productoyservicio/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL25Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL25Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL25Context> _process;

        public ProductoYServicioDemoTeckioAL25Controller(IProductoYservicioService<DemoTeckioAL25Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL25Context> process
            )
        {
