...
{
    [Route("api/insumoxcotizacion/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL25Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL25Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL25Context> _Proceso;
        private readonly DemoTeckioAL25Context Context;
        public InsumoXCotizacionDemoTeckioAL25Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL25Controller> Logger,
            DemoTeckioAL25Context Context
            , IInsumoXCotizacionService<DemoTeckioAL25Context> Service
