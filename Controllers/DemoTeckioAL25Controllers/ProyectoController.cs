...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL25Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL25Controller(
            ProyectoProceso<DemoTeckioAL25Context> proyectoProceso)
        {
