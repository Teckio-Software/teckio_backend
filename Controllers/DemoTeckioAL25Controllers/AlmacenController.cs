...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL25Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL25Context> _almacenProceso;

        public AlmacenDemoTeckioAL25Controller(
            IAlmacenService<DemoTeckioAL25Context> almacenServicio, AlmacenProceso<DemoTeckioAL25Context> almacenProceso)
        {
