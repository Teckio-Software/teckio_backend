...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL25Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL25Controller(
            TipoInsumoProceso<DemoTeckioAL25Context> tipoInsumoProceso
            )
        {
