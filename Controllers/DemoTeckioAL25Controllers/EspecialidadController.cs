...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL25Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL25Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL25Controller(
            EspecialidadProceso<DemoTeckioAL25Context> especialidadProceso)
        {
