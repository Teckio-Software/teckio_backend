...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExplosionInsumoDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IExplosionInsumoService _ExplosionInsumoService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<ExplosionInsumoDemoTeckioAL25Controller> _Logger;
        /// <summary>
        ...
        public ExplosionInsumoDemoTeckioAL25Controller(
            ILogger<ExplosionInsumoDemoTeckioAL25Controller> Logger,
