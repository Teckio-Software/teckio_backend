...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL25Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL25Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL25Controller(
            ILogger<ExistenciasDemoTeckioAL25Controller> Logger,
            DemoTeckioAL25Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL25Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL25Context> Proceso
            )
        {
            _Logger = Logger;
