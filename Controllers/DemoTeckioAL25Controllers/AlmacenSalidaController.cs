...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/25")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL25Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL25Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL25Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL25Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL25Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL25Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL25Controller> logger,
            DemoTeckioAL25Context context
            , IAlmacenSalidaService<DemoTeckioAL25Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL25Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL25Context> Proceso
            )
        {
