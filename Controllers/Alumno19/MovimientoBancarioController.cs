...
namespace ERP_TECKIO.Controllers
{
    ...
    {
        private readonly MovimientoBancarioProceso<Alumno19Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno19Controller(
            MovimientoBancarioProceso<Alumno19Context> movimientoBancarioProceso
            )
        {
