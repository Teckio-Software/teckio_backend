...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno19Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno19Context> _proceso;

        private readonly ICuentaBancariaService<Alumno19Context> _servicio;
        public CuentaBancariaAlumno19Controller(CuentaBancariaProceso<Alumno19Context> _proceso, ICuentaBancariaService<Alumno19Context> _servicio
           )
        {
