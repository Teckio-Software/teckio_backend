...
{
    [Route("api/factura/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaAlumno19Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno19Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno19Context> _categoriaProductoYServicioService;
        public FacturaAlumno19Controller(
            ObtenFacturaProceso<Alumno19Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno19Context> categoriaProductoYServicioService
            )
        {
