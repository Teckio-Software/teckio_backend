...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno19Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno19Context> _almacenServicio;

        public AlmacenAlumno19Controller(
            IAlmacenService<Alumno19Context> almacenServicio)
        {
