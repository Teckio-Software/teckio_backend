...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno19Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno19Context> _Service;
        private readonly OrdenCompraProceso<Alumno19Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno19Controller> _Logger;
        private readonly Alumno19Context Context;
        private readonly PolizaProceso<Alumno19Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno19Context> _obtenFacturaProceso;

        public OrdenCompraAlumno19Controller(
            ILogger<OrdenCompraAlumno19Controller> Logger
            , Alumno19Context Context
            , IOrdenCompraService<Alumno19Context> Service
            , OrdenCompraProceso<Alumno19Context> Proceso
            , PolizaProceso<Alumno19Context> polizaProceso
            , ObtenFacturaProceso<Alumno19Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
