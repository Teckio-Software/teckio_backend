...
namespace ERP_TECKIO.API.Controllers.Alumno19
{
    ...
    [ApiController]
    public class ReporteDestajoAlumno19Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<Alumno19Context> _proceso;
        private readonly EstimacionesProceso<Alumno19Context> _estimacionesProceso;

        public ReporteDestajoAlumno19Controller(
            ReporteDestajoProceso<Alumno19Context> proceso,
            EstimacionesProceso<Alumno19Context> estimacionesProceso
            ) { 
            _proceso = proceso;
