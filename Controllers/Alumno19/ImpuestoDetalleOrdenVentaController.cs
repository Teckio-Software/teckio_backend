...
namespace ERP_TECKIO.Controllers.Alumno19
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno19Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno19Context> process)
        {
            _process = process;
        }
