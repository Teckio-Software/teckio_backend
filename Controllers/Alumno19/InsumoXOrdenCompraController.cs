...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno19Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno19Context> _Service;
        private readonly OrdenCompraProceso<Alumno19Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno19Controller> _Logger;
        private readonly Alumno19Context _Context;
        public InsumoXOrdenCompraAlumno19Controller(
            ILogger<InsumoXOrdenCompraAlumno19Controller> Logger,
            Alumno19Context Context
            , IInsumoXOrdenCompraService<Alumno19Context> Service
