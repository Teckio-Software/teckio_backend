...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa19")]
    public class EspecialIdadXContratistaAlumno19Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno19Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno19Controller(
            ILogger<EspecialIdadXContratistaAlumno19Controller> logger,
