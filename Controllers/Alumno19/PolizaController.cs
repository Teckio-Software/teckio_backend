...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno19Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno19Context> _Service;
        private readonly IPolizaDetalleService<Alumno19Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno19Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno19Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno19Context> _SaldosService;
        private readonly ILogger<PolizaAlumno19Controller> _Logger;
        private readonly Alumno19Context _Context;
        public PolizaAlumno19Controller(
            ILogger<PolizaAlumno19Controller> logger
            , Alumno19Context context
            , IPolizaService<Alumno19Context> service
            , IPolizaDetalleService<Alumno19Context> detalleService
            , ITipoPolizaService<Alumno19Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno19Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa19")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa19")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa19")]
