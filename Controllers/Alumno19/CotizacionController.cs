...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionAlumno19Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno19Context> _Service;
        private readonly CotizacionProceso<Alumno19Context> _Proceso;
        private readonly IOrdenCompraService<Alumno19Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno19Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno19Controller> _Logger;
        private readonly Alumno19Context Context;
        public CotizacionAlumno19Controller(

            ILogger<CotizacionAlumno19Controller> Logger
            , Alumno19Context Context
            , ICotizacionService<Alumno19Context> Service
            , IOrdenCompraService<Alumno19Context> OrdenCompraService,
              ITipoImpuestoService<Alumno19Context> TipoImpuestoService
            , CotizacionProceso<Alumno19Context> Proceso)
        {
            _Logger = Logger;
