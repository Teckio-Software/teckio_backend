...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/familiainsumo/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionFamiliaInsumo-Empresa19")]
    public class FamiliaInsumoAlumno19Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<Alumno19Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno19Controller(
            FamiliaInsumoProceso<Alumno19Context> familiaInsumoProceso)
        {
            _FamiliaInsumoProceso = familiaInsumoProceso;
        }
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearFamiliaInsumo-Empresa19")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarFamiliaInsumo-Empresa19")]
        ...
        /// <returns>NoContent</returns>
        [HttpDelete("{Id:int}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarFamiliaInsumo-Empresa19")]
