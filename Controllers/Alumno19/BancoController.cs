...
namespace ERP_TECKIO.API.Controllers.Alumno19
{
    ...
    public class BancoAlumno19Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno19Context> _bancoService;

        public BancoAlumno19Controller(IBancoService<Alumno19Context> bancoService)
        {
