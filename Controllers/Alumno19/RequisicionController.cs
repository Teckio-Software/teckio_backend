...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno19Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno19Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno19Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno19Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno19Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno19Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno19Controller(
            ILogger<RequisicionAlumno19Controller> Logger
            , Alumno19Context Context
            , IRequisicionService<Alumno19Context> RequisicionService
            , RequisicionProceso<Alumno19Context> Proceso
            , ObjetoRequisicionProceso<Alumno19Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno19Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
