...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno19Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno19Context> _Service;

        private readonly RequisicionProceso<Alumno19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno19Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno19Controller(
            ILogger<InsumoXRequisicionAlumno19Controller> Logger,
            RequisicionProceso<Alumno19Context> Proceso,
            Alumno19Context Context
            , IInsumoXRequisicionService<Alumno19Context> Service)
        {
            _Logger = Logger;
