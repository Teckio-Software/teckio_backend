...
namespace ERP_TECKIO.Controllers.Alumno19
{
    ...
    public class OrdenVentaAlumno19Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno19Context> _ordenVentaProceso;
        public OrdenVentaAlumno19Controller(
            OrdenVentaProceso<Alumno19Context> ordenVentaProceso
            ) { 
