...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno19Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno19Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno19Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno19Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno19Controller(
            ILogger<ContratistaAlumno19Controller> logger,
            Alumno19Context context
            , IContratistaService<Alumno19Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno19Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
