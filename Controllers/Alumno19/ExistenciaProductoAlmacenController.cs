...
namespace ERP_TECKIO.Controllers.Alumno19
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno19Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno19Context> proces)
        {
            _proceso = proces;
        }
