...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno19Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno19Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno19Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno19Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno19Controller(
            ILogger<AlmacenEntradaInsumoAlumno19Controller> logger,
            Alumno19Context context
            , IInsumoXAlmacenEntradaService<Alumno19Context> AlmacenEntradaDetalle
