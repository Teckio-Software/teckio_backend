...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa19")]
    public class InsumoXContratistaAlumno19Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno19Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno19Controller(
            ILogger<InsumoXContratistaAlumno19Controller> logger,
