...
namespace ERP_TECKIO
{
    ...
    public class InsumoXCotizacionAlumno19Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno19Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno19Controller> _Logger;
        private readonly CotizacionProceso<Alumno19Context> _Proceso;
        private readonly Alumno19Context Context;
        public InsumoXCotizacionAlumno19Controller(
            ILogger<InsumoXCotizacionAlumno19Controller> Logger,
            Alumno19Context Context
            , IInsumoXCotizacionService<Alumno19Context> Service
