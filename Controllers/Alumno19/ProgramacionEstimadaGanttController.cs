...
namespace SistemaERP.API.Controllers.Alumno19
{
    [Route("api/programacionestimadaGantt/19")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno19Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno19Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno19Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno19Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno19Controller(
            ProgramacionEstimadaGanttProceso<Alumno19Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno19Context> importeSemanalGanttProceso,
