...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa19")]
    public class CompraDirectaInsumoAlumno19Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno19Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno19Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno19Controller(
            ILogger<CompraDirectaInsumoAlumno19Controller> logger
            , Alumno19Context context
            , IInsumoXCompraDirectaService<Alumno19Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
