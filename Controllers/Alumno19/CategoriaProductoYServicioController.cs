...
namespace ERP_TECKIO.Controllers.Alumno19
{
    ...
    {
        private readonly ICategoriaProductoYServicioService<Alumno19Context> _service;

        public CategoriaProductoYServicioController(ICategoriaProductoYServicioService<Alumno19Context> service)
        {
            _service = service;
        }
