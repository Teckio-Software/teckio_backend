...
namespace ERP_TECKIO.Controllers.Alumno19
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno19Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno19Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno19Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno19Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno19Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno19Context> porcentajeCesantiaEdadService
            )
        {
