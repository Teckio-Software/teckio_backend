...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno19Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno19Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno19Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno19Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno19Controller(
            ILogger<AlmacenEntradaAlumno19Controller> logger,
            Alumno19Context context
            , IAlmacenEntradaService<Alumno19Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno19Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno19Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
