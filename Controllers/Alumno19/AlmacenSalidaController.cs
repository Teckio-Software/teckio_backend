...
namespace ERP_TECKIO
{
    ...
    public class AlmacenSalidaAlumno19Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno19Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno19Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno19Controller> Logger;
        ...
        public AlmacenSalidaAlumno19Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno19Controller> logger,
            Alumno19Context context
            , IAlmacenSalidaService<Alumno19Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno19Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno19Context> Proceso
            )
        {
