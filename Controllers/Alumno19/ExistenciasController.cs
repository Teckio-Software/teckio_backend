...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno19Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno19Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno19Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno19Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno19Controller(
            ILogger<ExistenciasAlumno19Controller> Logger,
            Alumno19Context Context
            , IAlmacenExistenciaInsumoService<Alumno19Context> ExistenciaService
            , ExistenciasProceso<Alumno19Context> Proceso
            )
        {
            _Logger = Logger;
