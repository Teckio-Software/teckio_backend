...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno19Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno19Context> _contratosProceso;
        public ContratosAlumno19Controller(
            ContratosProceso<Alumno19Context> contratosProceso
            )
        {
