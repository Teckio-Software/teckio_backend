...
namespace ERP_TECKIO.Controllers.Alumno19
{
    ...
    public class ProductoYServicioAlumno19Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno19Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno19Context> _process;

        public ProductoYServicioAlumno19Controller(IProductoYservicioService<Alumno19Context> productoYServicioService,
            ProductoYServicioProceso<Alumno19Context> process
            )
        {
