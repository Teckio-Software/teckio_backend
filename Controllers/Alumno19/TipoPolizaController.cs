...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/tipopoliza/19")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa19")]
    public class TipoPolizaAlumno19Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno19Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno19Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno19Controller(
            ILogger<TipoPolizaAlumno19Controller> logger,
            Alumno19Context context
            , ITipoPolizaService<Alumno19Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearTipoPoliza-Empresa19")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarTipoPoliza-Empresa19")]
