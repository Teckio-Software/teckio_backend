...
namespace ERP_TECKIO.Controllers.Alumno19
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno19Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno19Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno19Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno19Controller(
            IPrecioUnitarioXEmpleadoService<Alumno19Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno19Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
