...
namespace ERP_TECKIO
{
    ...
    public class EmpleadoAlumno19Controller : ControllerBase
    {
        private readonly IEmpleadoService<Alumno19Context> _empleadoService;
        public EmpleadoAlumno19Controller(
            IEmpleadoService<Alumno19Context> empleadoService
            )
        {
