...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    public class PrecioUnitarioXEmpleadoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<DemoTeckioAL07Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<DemoTeckioAL07Context> _proceso;
        public PrecioUnitarioXEmpleadoDemoTeckioAL07Controller(
            IPrecioUnitarioXEmpleadoService<DemoTeckioAL07Context> service,
            PrecioUnitarioXEmpleadoProceso<DemoTeckioAL07Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
