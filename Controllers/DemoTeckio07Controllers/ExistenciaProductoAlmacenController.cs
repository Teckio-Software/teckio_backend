...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    [Route("api/existenciaproductoalmacen/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL07Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL07Context> proces)
        {
            _proceso = proces;
        }
