...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL07Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL07Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL07Controller(
            ILogger<CompraDirectaDemoTeckioAL07Controller> logger,
            DemoTeckioAL07Context context
            , ICompraDirectaService<DemoTeckioAL07Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
