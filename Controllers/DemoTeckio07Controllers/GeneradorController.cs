...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL07Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL07Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL07Controller(
            GeneradoresProceso<DemoTeckioAL07Context> generadoresProceso)
        {
