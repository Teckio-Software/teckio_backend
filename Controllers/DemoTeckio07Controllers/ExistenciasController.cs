...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL07Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL07Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL07Controller(
            ILogger<ExistenciasDemoTeckioAL07Controller> Logger,
            DemoTeckioAL07Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL07Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL07Context> Proceso
            )
        {
            _Logger = Logger;
