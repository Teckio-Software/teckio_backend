...
namespace SistemaERP.API.Controllers.DemoTeckioAL07
{
    [Route("api/programacionestimadaGantt/7")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL07Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL07Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL07Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL07Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL07Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL07Context> importeSemanalGanttProceso,
