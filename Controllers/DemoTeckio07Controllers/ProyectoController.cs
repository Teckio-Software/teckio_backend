...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL07Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL07Controller(
            ProyectoProceso<DemoTeckioAL07Context> proyectoProceso)
        {
