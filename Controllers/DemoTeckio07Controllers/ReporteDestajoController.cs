...
{
    [Route("api/reportesdestajo/7")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL07Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL07Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL07Controller(
            ReporteDestajoProceso<DemoTeckioAL07Context> proceso,
            EstimacionesProceso<DemoTeckioAL07Context> estimacionesProceso
            ) { 
            _proceso = proceso;
