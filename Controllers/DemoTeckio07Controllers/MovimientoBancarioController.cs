...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/7")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL07Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL07Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL07Controller(
            MovimientoBancarioProceso<DemoTeckioAL07Context> movimientoBancarioProceso
            )
        {
