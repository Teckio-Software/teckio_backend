...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL07Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL07Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL07Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL07Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL07Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL07Controller> _Logger;
        private readonly DemoTeckioAL07Context _Context;
        private readonly PolizaProceso<DemoTeckioAL07Context> _polizaProceso;
        public PolizaDemoTeckioAL07Controller(
            ILogger<PolizaDemoTeckioAL07Controller> logger
            , DemoTeckioAL07Context context
            , IPolizaService<DemoTeckioAL07Context> service
            , IPolizaDetalleService<DemoTeckioAL07Context> detalleService
            , ITipoPolizaService<DemoTeckioAL07Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL07Context> saldosService
