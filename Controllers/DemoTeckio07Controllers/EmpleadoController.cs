...
{
    [Route("api/empleado/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class EmpleadoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IEmpleadoService<DemoTeckioAL07Context> _empleadoService;
        public EmpleadoDemoTeckioAL07Controller(
            IEmpleadoService<DemoTeckioAL07Context> empleadoService
            )
        {
