...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL07Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL07Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL07Controller(
            EspecialidadProceso<DemoTeckioAL07Context> especialidadProceso)
        {
