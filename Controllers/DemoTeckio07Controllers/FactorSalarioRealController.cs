...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL07Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL07Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL07Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL07Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL07Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL07Context> porcentajeCesantiaEdadService
            )
        {
