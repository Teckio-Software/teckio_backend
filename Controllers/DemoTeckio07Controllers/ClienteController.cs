...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL07Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL07Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL07Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL07Controller(
            IClientesService<DemoTeckioAL07Context> service
            , ClienteProceso<DemoTeckioAL07Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL07Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
