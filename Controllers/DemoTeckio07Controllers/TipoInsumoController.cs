...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL07Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL07Controller(
            TipoInsumoProceso<DemoTeckioAL07Context> tipoInsumoProceso
            )
        {
