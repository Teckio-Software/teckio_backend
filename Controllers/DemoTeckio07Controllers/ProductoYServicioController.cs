...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    public class ProductoYServicioDemoTeckioAL07Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL07Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL07Context> _process;

        public ProductoYServicioDemoTeckioAL07Controller(IProductoYservicioService<DemoTeckioAL07Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL07Context> process
            )
        {
