...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL07Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL07Context> _bancoService;

        public BancoDemoTeckioAL07Controller(IBancoService<DemoTeckioAL07Context> bancoService)
        {
