...
{
    [Route("api/indirectosXConcepto/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL07Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL07Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL07Controller(
            IIndirectosXConceptoService<DemoTeckioAL07Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL07Context> indirectosXConceptoProceso
            ) { 
