...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL07Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL07Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL07Context> _indirectosProceso;

        public IndirectosDemoTeckioAL07Controller(
                        IConjuntoIndirectosService<DemoTeckioAL07Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL07Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL07Context> indirectosProceso
            )
        {
