...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL07Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL07Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL07Controller> _Logger;
        private readonly DemoTeckioAL07Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL07Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL07Controller> logger
            , DemoTeckioAL07Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL07Context> service
