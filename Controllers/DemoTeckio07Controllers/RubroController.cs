...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL07Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL07Controller> Logger;
        ...
        public RubroDemoTeckioAL07Controller(
            ILogger<RubroDemoTeckioAL07Controller> logger,
            DemoTeckioAL07Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL07Context> service
            )
        {
            //_Service = service;
            Logger = logger;
