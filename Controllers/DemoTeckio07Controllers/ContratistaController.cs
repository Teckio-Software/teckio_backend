...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/7")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL07Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL07Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL07Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL07Controller(
            ILogger<ContratistaDemoTeckioAL07Controller> logger,
            DemoTeckioAL07Context context
            , IContratistaService<DemoTeckioAL07Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL07Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
