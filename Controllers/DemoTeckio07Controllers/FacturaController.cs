...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    public class FacturaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL07Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL07Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL07Controller(
            ObtenFacturaProceso<DemoTeckioAL07Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL07Context> categoriaProductoYServicioService
            )
        {
