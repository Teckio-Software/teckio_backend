...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL07Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL07Context> _servicio;
        public CuentaBancariaDemoTeckioAL07Controller(CuentaBancariaProceso<DemoTeckioAL07Context> _proceso, ICuentaBancariaService<DemoTeckioAL07Context> _servicio
           )
        {
