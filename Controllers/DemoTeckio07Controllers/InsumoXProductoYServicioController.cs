...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/7")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL07Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL07Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL07Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL07Context> process)
        {
            _service = service;
            _process = process;
        }
