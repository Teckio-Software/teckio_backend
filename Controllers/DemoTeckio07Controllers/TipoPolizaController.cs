...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL07Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL07Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL07Controller(
            ILogger<TipoPolizaDemoTeckioAL07Controller> logger,
            DemoTeckioAL07Context context
            , ITipoPolizaService<DemoTeckioAL07Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
