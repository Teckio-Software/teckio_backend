...
{
    [Route("api/insumoxordencompra/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL07Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL07Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL07Controller> _Logger;
        private readonly DemoTeckioAL07Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL07Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL07Controller> Logger,
            DemoTeckioAL07Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL07Context> Service
