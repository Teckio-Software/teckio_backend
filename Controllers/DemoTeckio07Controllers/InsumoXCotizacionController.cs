...
{
    [Route("api/insumoxcotizacion/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL07Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL07Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL07Context> _Proceso;
        private readonly DemoTeckioAL07Context Context;
        public InsumoXCotizacionDemoTeckioAL07Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL07Controller> Logger,
            DemoTeckioAL07Context Context
            , IInsumoXCotizacionService<DemoTeckioAL07Context> Service
