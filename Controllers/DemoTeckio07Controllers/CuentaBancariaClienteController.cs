...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CuentaBancariaClienteDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ICuentaBancariaClienteService<DemoTeckioAL07Context> _cuentaBancariaClienteService;
        private readonly CuentaBancariaProceso<DemoTeckioAL07Context> _proceso;

        public CuentaBancariaClienteDemoTeckioAL07Controller(
            ICuentaBancariaClienteService<DemoTeckioAL07Context> cuentaBancariaClienteService,
            CuentaBancariaProceso<DemoTeckioAL07Context> proceso
            )
        {
