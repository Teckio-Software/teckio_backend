...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL07Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL07Context> _almacenProceso;

        public AlmacenDemoTeckioAL07Controller(
            IAlmacenService<DemoTeckioAL07Context> almacenServicio, AlmacenProceso<DemoTeckioAL07Context> almacenProceso)
        {
