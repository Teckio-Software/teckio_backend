...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL07Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL07Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL07Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL07Controller> Logger,
            RequisicionProceso<DemoTeckioAL07Context> Proceso,
            DemoTeckioAL07Context Context
            , IInsumoXRequisicionService<DemoTeckioAL07Context> Service)
        {
            _Logger = Logger;
