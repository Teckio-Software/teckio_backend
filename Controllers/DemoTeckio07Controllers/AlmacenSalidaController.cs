...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL07Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL07Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL07Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL07Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL07Controller> logger,
            DemoTeckioAL07Context context
            , IAlmacenSalidaService<DemoTeckioAL07Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL07Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL07Context> Proceso
            )
        {
