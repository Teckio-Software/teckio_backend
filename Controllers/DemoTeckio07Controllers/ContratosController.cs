...
{
    [Route("api/contratos/7")]
    [ApiController]
    public class ContratosDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL07Context> _contratosProceso;
        public ContratosDemoTeckioAL07Controller(
            ContratosProceso<DemoTeckioAL07Context> contratosProceso
            )
        {
