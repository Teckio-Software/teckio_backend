...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL07Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL07Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL07Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL07Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL07Controller> _Logger;
        private readonly DemoTeckioAL07Context Context;
        public CotizacionDemoTeckioAL07Controller(

            ILogger<CotizacionDemoTeckioAL07Controller> Logger
            , DemoTeckioAL07Context Context
            , ICotizacionService<DemoTeckioAL07Context> Service
            , IOrdenCompraService<DemoTeckioAL07Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL07Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL07Context> Proceso)
        {
            _Logger = Logger;
