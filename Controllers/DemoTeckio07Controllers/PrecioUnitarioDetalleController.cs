...
namespace SistemaERP.API.DemoTeckioAL07Controllers.Procomi
{
    [Route("api/preciounitariodetalle/7")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL07Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL07Controller(
