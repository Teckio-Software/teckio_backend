...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL07Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL07Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL07Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL07Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL07Controller(
            ILogger<AlmacenEntradaDemoTeckioAL07Controller> logger,
            DemoTeckioAL07Context context
            , IAlmacenEntradaService<DemoTeckioAL07Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL07Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL07Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
