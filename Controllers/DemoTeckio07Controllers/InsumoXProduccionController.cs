...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL07Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL07Context> proces)
        {
            _proceso = proces;
        }
