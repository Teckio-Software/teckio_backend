...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL07Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL07Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL07Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL07Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL07Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL07Controller(
            ILogger<RequisicionDemoTeckioAL07Controller> Logger
            , DemoTeckioAL07Context Context
            , IRequisicionService<DemoTeckioAL07Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL07Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL07Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL07Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL07Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/7/970"))
            {
