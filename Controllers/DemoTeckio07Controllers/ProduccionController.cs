...
namespace ERP_TECKIO.Controllers.DemoTeckioAL07
{
    ...
    [Route("api/produccion/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL07Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL07Context> proceso)
        {
            _proceso = proceso;
        }
