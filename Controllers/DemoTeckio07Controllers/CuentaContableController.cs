...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL07Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL07Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL07Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL07Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL07Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL07Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL07Controller(
            ILogger<CuentaContableDemoTeckioAL07Controller> logger,
            DemoTeckioAL07Context context
            , ICuentaContableService<DemoTeckioAL07Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL07Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL07Context> RubroService
            , CuentaContableProceso<DemoTeckioAL07Context> proceso
            )
        {
            Logger = logger;
            Context = context;
