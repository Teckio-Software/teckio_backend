...
{
    [Route("api/ordencompra/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL07Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL07Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL07Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL07Controller> _Logger;
        private readonly DemoTeckioAL07Context Context;
        private readonly PolizaProceso<DemoTeckioAL07Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL07Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL07Controller(
            ILogger<OrdenCompraDemoTeckioAL07Controller> Logger
            , DemoTeckioAL07Context Context
            , IOrdenCompraService<DemoTeckioAL07Context> Service
            , OrdenCompraProceso<DemoTeckioAL07Context> Proceso
            , PolizaProceso<DemoTeckioAL07Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL07Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
