...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL07Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL07Controller(
            ConceptoProceso<DemoTeckioAL07Context> conceptoProceso)
        {
