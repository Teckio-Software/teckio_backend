...
{
    [Route("api/ordenventa/7")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL07Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL07Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL07Controller(
            OrdenVentaProceso<DemoTeckioAL07Context> ordenVentaProceso
            ) { 
