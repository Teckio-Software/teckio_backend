...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL07Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL07Controller(
            FamiliaInsumoProceso<DemoTeckioAL07Context> familiaInsumoProceso)
        {
