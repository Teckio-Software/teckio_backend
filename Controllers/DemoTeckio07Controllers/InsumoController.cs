...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL07Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL07Context> _InsumoProceso;
        public InsumoDemoTeckioAL07Controller(
            InsumoProceso<DemoTeckioAL07Context> insumoProceso)
        {
