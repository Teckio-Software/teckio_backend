...
{
    [Route("api/contratos/23")]
    [ApiController]
    public class ContratosDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ContratosProceso<DemoTeckioAL23Context> _contratosProceso;
        public ContratosDemoTeckioAL23Controller(
            ContratosProceso<DemoTeckioAL23Context> contratosProceso
            )
        {
