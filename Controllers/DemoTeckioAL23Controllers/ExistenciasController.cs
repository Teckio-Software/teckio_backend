...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/existencias/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidad-Empresa1")]
    public class ExistenciasDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<DemoTeckioAL23Context> _ExistenciaService;
        private readonly ExistenciasProceso<DemoTeckioAL23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasDemoTeckioAL23Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasDemoTeckioAL23Controller(
            ILogger<ExistenciasDemoTeckioAL23Controller> Logger,
            DemoTeckioAL23Context Context
            , IAlmacenExistenciaInsumoService<DemoTeckioAL23Context> ExistenciaService
            , ExistenciasProceso<DemoTeckioAL23Context> Proceso
            )
        {
            _Logger = Logger;
