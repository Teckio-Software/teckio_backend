...
namespace ERP_TECKIO.Controllers.DemoTeckioAL23
{
    ...
    [Route("api/insumoXproduccion/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXProduccionController: ControllerBase
    {
        private readonly InsumoXProduccionProceso<DemoTeckioAL23Context> _proceso;

        public InsumoXProduccionController(InsumoXProduccionProceso<DemoTeckioAL23Context> proces)
        {
            _proceso = proces;
        }
