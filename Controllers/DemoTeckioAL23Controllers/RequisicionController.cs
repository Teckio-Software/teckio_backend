...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/requisicion/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class RequisicionDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IRequisicionService<DemoTeckioAL23Context> _RequisicionService;
        private readonly RequisicionProceso<DemoTeckioAL23Context> _Proceso;
        private readonly ObjetoRequisicionProceso<DemoTeckioAL23Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<DemoTeckioAL23Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionDemoTeckioAL23Controller> _Logger;
        /// <summary>
        ...
        public RequisicionDemoTeckioAL23Controller(
            ILogger<RequisicionDemoTeckioAL23Controller> Logger
            , DemoTeckioAL23Context Context
            , IRequisicionService<DemoTeckioAL23Context> RequisicionService
            , RequisicionProceso<DemoTeckioAL23Context> Proceso
            , ObjetoRequisicionProceso<DemoTeckioAL23Context> ObjetoRequisicionProceso
            , IProyectoService<DemoTeckioAL23Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult> Put([FromBody] RequisicionDTO parametros)
        {
            try
            {
                ...
                await HttpContext.InsertarParametrosCreacionEdicionEnCabecera<DemoTeckioAL23Context>(resultado.Estatus, resultado.Descripcion);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/23/970"))
            {
