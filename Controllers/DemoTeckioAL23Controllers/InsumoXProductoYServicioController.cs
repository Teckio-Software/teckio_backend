...
namespace ERP_TECKIO.Controllers.DemoTeckioAL23
{
    ...
    /// </summary>
    [Route("api/insumoxproductoyservicio/23")]
    [ApiController]
    ...
    {
        private readonly IInsumoXProductoYServicioService<DemoTeckioAL23Context> _service;
        private readonly InsumoXProductoYServicioProceso<DemoTeckioAL23Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<DemoTeckioAL23Context> service, InsumoXProductoYServicioProceso<DemoTeckioAL23Context> process)
        {
            _service = service;
            _process = process;
        }
