...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/insumoxrequisicion/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXRequisicionDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<DemoTeckioAL23Context> _Service;

        private readonly RequisicionProceso<DemoTeckioAL23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionDemoTeckioAL23Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionDemoTeckioAL23Controller(
            ILogger<InsumoXRequisicionDemoTeckioAL23Controller> Logger,
            RequisicionProceso<DemoTeckioAL23Context> Proceso,
            DemoTeckioAL23Context Context
            , IInsumoXRequisicionService<DemoTeckioAL23Context> Service)
        {
            _Logger = Logger;
