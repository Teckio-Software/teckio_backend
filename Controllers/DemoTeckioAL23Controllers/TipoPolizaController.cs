...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoPolizaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ITipoPolizaService<DemoTeckioAL23Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaDemoTeckioAL23Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaDemoTeckioAL23Controller(
            ILogger<TipoPolizaDemoTeckioAL23Controller> logger,
            DemoTeckioAL23Context context
            , ITipoPolizaService<DemoTeckioAL23Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
