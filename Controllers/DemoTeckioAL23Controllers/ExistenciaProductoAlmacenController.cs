...
namespace ERP_TECKIO.Controllers.DemoTeckioAL23
{
    ...
    [Route("api/existenciaproductoalmacen/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ExistenciaProductoAlmacenController: ControllerBase
    {
        private readonly ExistenciaProductoAlmacenProceso<DemoTeckioAL23Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<DemoTeckioAL23Context> proces)
        {
            _proceso = proces;
        }
