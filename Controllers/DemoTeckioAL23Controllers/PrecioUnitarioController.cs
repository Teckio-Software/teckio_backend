...
{
    [Route("api/preciounitario/23")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionPrecioUnitario-Empresa2")]
    public class PrecioUnitarioDemoTeckioAL23Controller : ControllerBase
    {
        private readonly PrecioUnitarioProceso<DemoTeckioAL23Context> _precioUnitarioProceso;
        private readonly IProgramacionEstimadaService<DemoTeckioAL23Context> _programacionestimadaService;
        private readonly DbContextOptionsBuilder<DemoTeckioAL23Context> _Options;
        private readonly ExplocionInsumosProceso<DemoTeckioAL23Context> _explocionInsumosProceso;
        public PrecioUnitarioDemoTeckioAL23Controller(
            PrecioUnitarioProceso<DemoTeckioAL23Context> precioUnitarioProceso
            , IProgramacionEstimadaService<DemoTeckioAL23Context> programacionEstimadaService
            , DbContextOptionsBuilder<DemoTeckioAL23Context> options,
            ExplocionInsumosProceso<DemoTeckioAL23Context> explocionInsumosProceso
            )
        {
        ...
        {
            using (var db = new DemoTeckioAL23Context(_Options.Options))
            {
