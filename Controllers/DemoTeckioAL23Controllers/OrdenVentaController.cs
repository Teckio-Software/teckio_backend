...
{
    [Route("api/ordenventa/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenVentaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<DemoTeckioAL23Context> _ordenVentaProceso;
        public OrdenVentaDemoTeckioAL23Controller(
            OrdenVentaProceso<DemoTeckioAL23Context> ordenVentaProceso
            ) { 
