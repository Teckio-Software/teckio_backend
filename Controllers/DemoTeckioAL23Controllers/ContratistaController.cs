...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/contratista/23")]
    [ApiController]
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionContratista-Empresa1")]
    public class ContratistaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IContratistaService<DemoTeckioAL23Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaDemoTeckioAL23Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<DemoTeckioAL23Context> _contratistaCuentasContablesProceso;
        public ContratistaDemoTeckioAL23Controller(
            ILogger<ContratistaDemoTeckioAL23Controller> logger,
            DemoTeckioAL23Context context
            , IContratistaService<DemoTeckioAL23Context> ContratistaService,
            ContratistaCuentasContablesProceso<DemoTeckioAL23Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
