...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentacontable/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionCuentaContable-Empresa1")]
    public class CuentaContableDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ICuentaContableService<DemoTeckioAL23Context> _Service;
        private readonly ICodigoAgrupadorService<DemoTeckioAL23Context> _CodigoAgrupadorService;
        private readonly IRubroService<DemoTeckioAL23Context> _RubroService;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CuentaContableDemoTeckioAL23Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly DemoTeckioAL23Context Context;
        private readonly CuentaContableProceso<DemoTeckioAL23Context> _proceso;
        /// <summary>
        ...
        public CuentaContableDemoTeckioAL23Controller(
            ILogger<CuentaContableDemoTeckioAL23Controller> logger,
            DemoTeckioAL23Context context
            , ICuentaContableService<DemoTeckioAL23Context> Service
            , ICodigoAgrupadorService<DemoTeckioAL23Context> CodigoAgrupadorService
            , IRubroService<DemoTeckioAL23Context> RubroService
            , CuentaContableProceso<DemoTeckioAL23Context> proceso
            )
        {
            Logger = logger;
            Context = context;
