...
namespace ERP_TECKIO.Controllers
{
    ...
    public class GeneradoresDemoTeckioAL23Controller : ControllerBase
    {
        private readonly GeneradoresProceso<DemoTeckioAL23Context> _GeneradoresProceso;
        public GeneradoresDemoTeckioAL23Controller(
            GeneradoresProceso<DemoTeckioAL23Context> generadoresProceso)
        {
