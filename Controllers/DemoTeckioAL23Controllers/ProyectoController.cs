...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ProyectoDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ProyectoProceso<DemoTeckioAL23Context> _ProyectoProceso;
        public ProyectoDemoTeckioAL23Controller(
            ProyectoProceso<DemoTeckioAL23Context> proyectoProceso)
        {
