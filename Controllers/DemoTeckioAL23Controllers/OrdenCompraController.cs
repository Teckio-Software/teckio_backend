...
{
    [Route("api/ordencompra/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class OrdenCompraDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IOrdenCompraService<DemoTeckioAL23Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL23Context> _Proceso;
        private readonly ILogger<OrdenCompraDemoTeckioAL23Controller> _Logger;
        private readonly DemoTeckioAL23Context Context;
        private readonly PolizaProceso<DemoTeckioAL23Context> _polizaProceso;
        private readonly ObtenFacturaProceso<DemoTeckioAL23Context> _obtenFacturaProceso;

        public OrdenCompraDemoTeckioAL23Controller(
            ILogger<OrdenCompraDemoTeckioAL23Controller> Logger
            , DemoTeckioAL23Context Context
            , IOrdenCompraService<DemoTeckioAL23Context> Service
            , OrdenCompraProceso<DemoTeckioAL23Context> Proceso
            , PolizaProceso<DemoTeckioAL23Context> polizaProceso
            , ObtenFacturaProceso<DemoTeckioAL23Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
