...
{
    [Route("api/factura/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<DemoTeckioAL23Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<DemoTeckioAL23Context> _categoriaProductoYServicioService;
        public FacturaDemoTeckioAL23Controller(
            ObtenFacturaProceso<DemoTeckioAL23Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<DemoTeckioAL23Context> categoriaProductoYServicioService
            )
        {
