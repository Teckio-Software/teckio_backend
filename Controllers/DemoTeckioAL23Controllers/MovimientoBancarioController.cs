...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/movimientobancario/23")]
    [ApiController]
    public class MovimientoBancarioDemoTeckioAL23Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<DemoTeckioAL23Context> _movimientoBancarioProceso;
        public MovimientoBancarioDemoTeckioAL23Controller(
            MovimientoBancarioProceso<DemoTeckioAL23Context> movimientoBancarioProceso
            )
        {
