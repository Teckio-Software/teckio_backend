...
{
    [Route("api/insumoxordencompra/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXOrdenCompraDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<DemoTeckioAL23Context> _Service;
        private readonly OrdenCompraProceso<DemoTeckioAL23Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraDemoTeckioAL23Controller> _Logger;
        private readonly DemoTeckioAL23Context _Context;
        public InsumoXOrdenCompraDemoTeckioAL23Controller(
            ILogger<InsumoXOrdenCompraDemoTeckioAL23Controller> Logger,
            DemoTeckioAL23Context Context
            , IInsumoXOrdenCompraService<DemoTeckioAL23Context> Service
