...
namespace ERP_TECKIO.Controllers
{
    ...
    public class FamiliaInsumoDemoTeckioAL23Controller : ControllerBase
    {
        private readonly FamiliaInsumoProceso<DemoTeckioAL23Context> _FamiliaInsumoProceso;
        public FamiliaInsumoDemoTeckioAL23Controller(
            FamiliaInsumoProceso<DemoTeckioAL23Context> familiaInsumoProceso)
        {
