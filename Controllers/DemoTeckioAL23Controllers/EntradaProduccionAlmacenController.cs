...
{
    [Route("api/entradaproduccionalmacen/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class EntradaProduccionAlmacenDemoTeckioAL23Controller : ControllerBase
    {
        private readonly EntradaProduccionAlmacenProceso<DemoTeckioAL23Context> _proceso;

        public EntradaProduccionAlmacenDemoTeckioAL23Controller(EntradaProduccionAlmacenProceso<DemoTeckioAL23Context> proceso)
        {
            _proceso = proceso;
        }
