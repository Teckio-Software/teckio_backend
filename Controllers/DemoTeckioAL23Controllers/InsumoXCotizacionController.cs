...
{
    [Route("api/insumoxcotizacion/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class InsumoXCotizacionDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<DemoTeckioAL23Context> _Service;
        private readonly ILogger<InsumoXCotizacionDemoTeckioAL23Controller> _Logger;
        private readonly CotizacionProceso<DemoTeckioAL23Context> _Proceso;
        private readonly DemoTeckioAL23Context Context;
        public InsumoXCotizacionDemoTeckioAL23Controller(
            ILogger<InsumoXCotizacionDemoTeckioAL23Controller> Logger,
            DemoTeckioAL23Context Context
            , IInsumoXCotizacionService<DemoTeckioAL23Context> Service
