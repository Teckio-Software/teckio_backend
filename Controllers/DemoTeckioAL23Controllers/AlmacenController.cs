...
namespace ERP_TECKIO.Controllers
{
    ...
    [Route("api/almacen/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IAlmacenService<DemoTeckioAL23Context> _almacenServicio;
        private readonly AlmacenProceso<DemoTeckioAL23Context> _almacenProceso;

        public AlmacenDemoTeckioAL23Controller(
            IAlmacenService<DemoTeckioAL23Context> almacenServicio, AlmacenProceso<DemoTeckioAL23Context> almacenProceso)
        {
