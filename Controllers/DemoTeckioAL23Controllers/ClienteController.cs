...
{
    [Route("api/cliente/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ClienteDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IClientesService<DemoTeckioAL23Context> _Service;

        private readonly ClienteProceso<DemoTeckioAL23Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<DemoTeckioAL23Context> _clientesCuentasContablesProceso;
        public ClienteDemoTeckioAL23Controller(
            IClientesService<DemoTeckioAL23Context> service
            , ClienteProceso<DemoTeckioAL23Context> proceso,
            ClienteCuentasContablesProceso<DemoTeckioAL23Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
