...
namespace ERP_TECKIO.Controllers
{
    ...
    public class IndirectosDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IConjuntoIndirectosService<DemoTeckioAL23Context> _conjuntoIndirectosService;
        private readonly IIndirectosService<DemoTeckioAL23Context> _indirectosService;
        private readonly IndirectosProceso<DemoTeckioAL23Context> _indirectosProceso;

        public IndirectosDemoTeckioAL23Controller(
                        IConjuntoIndirectosService<DemoTeckioAL23Context> conjuntoIndirectosService,
                        IIndirectosService<DemoTeckioAL23Context> indirectosService,
                        IndirectosProceso<DemoTeckioAL23Context> indirectosProceso
            )
        {
