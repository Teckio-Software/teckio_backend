...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CompraDirectaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ICompraDirectaService<DemoTeckioAL23Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaDemoTeckioAL23Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaDemoTeckioAL23Controller(
            ILogger<CompraDirectaDemoTeckioAL23Controller> logger,
            DemoTeckioAL23Context context
            , ICompraDirectaService<DemoTeckioAL23Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
