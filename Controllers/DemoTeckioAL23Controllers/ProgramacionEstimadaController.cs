...
{
    [Route("api/programacionestimada/23")]
    [ApiController]
    public class ProgramacionEstimadaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<DemoTeckioAL23Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<DemoTeckioAL23Context> _ProyectoService;
        private readonly IPrecioUnitarioService<DemoTeckioAL23Context> _PrecioUnitarioService;


        public ProgramacionEstimadaDemoTeckioAL23Controller(
            ProgramacionEstimadaProceso<DemoTeckioAL23Context> programacionEstimadaProceso,
            IProyectoService<DemoTeckioAL23Context> proyectoProceso,
            IPrecioUnitarioService<DemoTeckioAL23Context> precioUnitarioService,
