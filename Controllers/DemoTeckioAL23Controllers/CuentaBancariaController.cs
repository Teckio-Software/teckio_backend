...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/cuentabancaria/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class CuentaBancariaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<DemoTeckioAL23Context> _proceso;

        private readonly ICuentaBancariaService<DemoTeckioAL23Context> _servicio;
        public CuentaBancariaDemoTeckioAL23Controller(CuentaBancariaProceso<DemoTeckioAL23Context> _proceso, ICuentaBancariaService<DemoTeckioAL23Context> _servicio
           )
        {
