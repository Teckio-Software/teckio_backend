...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ConceptoDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ConceptoProceso<DemoTeckioAL23Context> _ConceptoProceso;
        public ConceptoDemoTeckioAL23Controller(
            ConceptoProceso<DemoTeckioAL23Context> conceptoProceso)
        {
