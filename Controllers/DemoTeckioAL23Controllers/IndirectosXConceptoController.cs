...
{
    [Route("api/indirectosXConcepto/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class IndirectosXConceptoDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IIndirectosXConceptoService<DemoTeckioAL23Context> _indirectosXConceptoService;
        private readonly IndirectosXConceptoProceso<DemoTeckioAL23Context> _indirectosXConceptoProceso;
        public IndirectosXConceptoDemoTeckioAL23Controller(
            IIndirectosXConceptoService<DemoTeckioAL23Context> indirectosXConceptoService,
            IndirectosXConceptoProceso<DemoTeckioAL23Context> indirectosXConceptoProceso
            ) { 
