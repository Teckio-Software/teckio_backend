...
namespace ERP_TECKIO.Controllers
{
    ...
    public class EspecialidadDemoTeckioAL23Controller : ControllerBase
    {
        private readonly EspecialidadProceso<DemoTeckioAL23Context> _EspecialidadProceso;
        public EspecialidadDemoTeckioAL23Controller(
            EspecialidadProceso<DemoTeckioAL23Context> especialidadProceso)
        {
