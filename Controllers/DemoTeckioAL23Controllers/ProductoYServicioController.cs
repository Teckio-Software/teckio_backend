...
{
    [Route("api/productoyservicio/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProductoYServicioDemoTeckioAL23Controller : ControllerBase
    {

        private readonly IProductoYservicioService<DemoTeckioAL23Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<DemoTeckioAL23Context> _process;

        public ProductoYServicioDemoTeckioAL23Controller(IProductoYservicioService<DemoTeckioAL23Context> productoYServicioService,
            ProductoYServicioProceso<DemoTeckioAL23Context> process
            )
        {
