...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoDemoTeckioAL23Controller : ControllerBase
    {
        private readonly InsumoProceso<DemoTeckioAL23Context> _InsumoProceso;
        public InsumoDemoTeckioAL23Controller(
            InsumoProceso<DemoTeckioAL23Context> insumoProceso)
        {
