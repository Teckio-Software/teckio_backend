...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenSalida/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionSalidaAlmacen-Empresa1")]
    public class AlmacenSalidaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<DemoTeckioAL23Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<DemoTeckioAL23Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<DemoTeckioAL23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaDemoTeckioAL23Controller> Logger;
        ...
        public AlmacenSalidaDemoTeckioAL23Controller(
            //UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaDemoTeckioAL23Controller> logger,
            DemoTeckioAL23Context context
            , IAlmacenSalidaService<DemoTeckioAL23Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<DemoTeckioAL23Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<DemoTeckioAL23Context> Proceso
            )
        {
