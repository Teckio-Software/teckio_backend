...
namespace ERP_TECKIO.Controllers
{
    ...
    /// </summary>
    [Route("api/almacenentrada/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AlmacenEntradaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<DemoTeckioAL23Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<DemoTeckioAL23Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<DemoTeckioAL23Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaDemoTeckioAL23Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaDemoTeckioAL23Controller(
            ILogger<AlmacenEntradaDemoTeckioAL23Controller> logger,
            DemoTeckioAL23Context context
            , IAlmacenEntradaService<DemoTeckioAL23Context> almacenServicio
            , IInsumoXAlmacenEntradaService<DemoTeckioAL23Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<DemoTeckioAL23Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
