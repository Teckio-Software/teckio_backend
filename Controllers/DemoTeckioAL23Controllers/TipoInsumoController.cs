...
namespace ERP_TECKIO.Controllers
{
    ...
    public class TipoInsumoDemoTeckioAL23Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<DemoTeckioAL23Context> _TipoInsumoProceso;

        public TipoInsumoDemoTeckioAL23Controller(
            TipoInsumoProceso<DemoTeckioAL23Context> tipoInsumoProceso
            )
        {
