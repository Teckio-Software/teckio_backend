...
namespace ERP_TECKIO.Controllers
{
    ...
    public class CotizacionDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ICotizacionService<DemoTeckioAL23Context> _Service;
        private readonly CotizacionProceso<DemoTeckioAL23Context> _Proceso;
        private readonly IOrdenCompraService<DemoTeckioAL23Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<DemoTeckioAL23Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionDemoTeckioAL23Controller> _Logger;
        private readonly DemoTeckioAL23Context Context;
        public CotizacionDemoTeckioAL23Controller(

            ILogger<CotizacionDemoTeckioAL23Controller> Logger
            , DemoTeckioAL23Context Context
            , ICotizacionService<DemoTeckioAL23Context> Service
            , IOrdenCompraService<DemoTeckioAL23Context> OrdenCompraService,
              ITipoImpuestoService<DemoTeckioAL23Context> TipoImpuestoService
            , CotizacionProceso<DemoTeckioAL23Context> Proceso)
        {
            _Logger = Logger;
