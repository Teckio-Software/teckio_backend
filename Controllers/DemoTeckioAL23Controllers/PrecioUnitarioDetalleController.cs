...
namespace SistemaERP.API.DemoTeckioAL23Controllers.Procomi
{
    [Route("api/preciounitariodetalle/23")]
    [ApiController]
    public class PrecioUnitarioDetalleDemoTeckioAL23Controller : ControllerBase
    {
        ...
        public PrecioUnitarioDetalleDemoTeckioAL23Controller(
