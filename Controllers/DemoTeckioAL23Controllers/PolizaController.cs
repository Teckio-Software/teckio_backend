...
namespace ERP_TECKIO.Controllers
{
    ...
    public class PolizaDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IPolizaService<DemoTeckioAL23Context> _Service;
        private readonly IPolizaDetalleService<DemoTeckioAL23Context> _DetalleService;
        private readonly ITipoPolizaService<DemoTeckioAL23Context> _TipoPolizaService;
        private readonly ICuentaContableService<DemoTeckioAL23Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL23Context> _SaldosService;
        private readonly ILogger<PolizaDemoTeckioAL23Controller> _Logger;
        private readonly DemoTeckioAL23Context _Context;
        private readonly PolizaProceso<DemoTeckioAL23Context> _polizaProceso;
        public PolizaDemoTeckioAL23Controller(
            ILogger<PolizaDemoTeckioAL23Controller> logger
            , DemoTeckioAL23Context context
            , IPolizaService<DemoTeckioAL23Context> service
            , IPolizaDetalleService<DemoTeckioAL23Context> detalleService
            , ITipoPolizaService<DemoTeckioAL23Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<DemoTeckioAL23Context> saldosService
