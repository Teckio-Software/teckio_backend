...
{
    [Route("api/reportesdestajo/23")]
    [ApiController]
    public class ReporteDestajoDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ReporteDestajoProceso<DemoTeckioAL23Context> _proceso;
        private readonly EstimacionesProceso<DemoTeckioAL23Context> _estimacionesProceso;

        public ReporteDestajoDemoTeckioAL23Controller(
            ReporteDestajoProceso<DemoTeckioAL23Context> proceso,
            EstimacionesProceso<DemoTeckioAL23Context> estimacionesProceso
            ) { 
            _proceso = proceso;
