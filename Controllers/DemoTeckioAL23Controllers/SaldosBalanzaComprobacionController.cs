...
namespace ERP_TECKIO.Controllers
{
    ...
    public class SaldosBalanzaComprobacionDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ISaldosBalanzaComprobacionService<DemoTeckioAL23Context> _Service;
        private readonly ICuentaContableService<DemoTeckioAL23Context> _CuentaContableService;
        private readonly ILogger<SaldosBalanzaComprobacionDemoTeckioAL23Controller> _Logger;
        private readonly DemoTeckioAL23Context _Context;
        public SaldosBalanzaComprobacionDemoTeckioAL23Controller(
            ILogger<SaldosBalanzaComprobacionDemoTeckioAL23Controller> logger
            , DemoTeckioAL23Context context
            , ISaldosBalanzaComprobacionService<DemoTeckioAL23Context> service
