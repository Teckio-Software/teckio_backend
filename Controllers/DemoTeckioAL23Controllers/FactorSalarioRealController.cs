...
namespace ERP_TECKIO.Controllers.DemoTeckioAL23
{
    ...
    {
        private readonly FactorSalarioRealProceso<DemoTeckioAL23Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<DemoTeckioAL23Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<DemoTeckioAL23Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<DemoTeckioAL23Context> factorSalarioRealProceso,
            IParametrosFsrService<DemoTeckioAL23Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<DemoTeckioAL23Context> porcentajeCesantiaEdadService
            )
        {
