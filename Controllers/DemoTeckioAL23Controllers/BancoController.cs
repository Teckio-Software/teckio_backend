...
namespace ERP_TECKIO.Controllers
{
    ...
    public class BancoDemoTeckioAL23Controller : ControllerBase 
    {
        private readonly IBancoService<DemoTeckioAL23Context> _bancoService;

        public BancoDemoTeckioAL23Controller(IBancoService<DemoTeckioAL23Context> bancoService)
        {
