...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RubroDemoTeckioAL23Controller : ControllerBase
    {
        private readonly IRubroService<DemoTeckioAL23Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroDemoTeckioAL23Controller> Logger;
        ...
        public RubroDemoTeckioAL23Controller(
            ILogger<RubroDemoTeckioAL23Controller> logger,
            DemoTeckioAL23Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<DemoTeckioAL23Context> service
            )
        {
            //_Service = service;
            Logger = logger;
