...
namespace ERP_TECKIO.Controllers.DemoTeckioAL23
{
    ...
    [Route("api/produccion/23")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class ProduccionController: ControllerBase
    {
        private readonly ProduccionProceso<DemoTeckioAL23Context> _proceso;

        public ProduccionController(ProduccionProceso<DemoTeckioAL23Context> proceso)
        {
            _proceso = proceso;
        }
