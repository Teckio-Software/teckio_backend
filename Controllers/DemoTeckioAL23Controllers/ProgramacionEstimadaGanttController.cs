...
namespace SistemaERP.API.Controllers.DemoTeckioAL23
{
    [Route("api/programacionestimadaGantt/23")]
    [ApiController]
    public class ProgramacionEstimadaGanttDemoTeckioAL23Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<DemoTeckioAL23Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<DemoTeckioAL23Context> _Options;
        private readonly ImporteSemanalGanttProceso<DemoTeckioAL23Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttDemoTeckioAL23Controller(
            ProgramacionEstimadaGanttProceso<DemoTeckioAL23Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<DemoTeckioAL23Context> importeSemanalGanttProceso,
