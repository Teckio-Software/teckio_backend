...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa11")]
    public class EspecialIdadXContratistaAlumno11Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno11Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno11Controller(
            ILogger<EspecialIdadXContratistaAlumno11Controller> logger,
