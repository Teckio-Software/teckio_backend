...
namespace ERP_TECKIO.Controllers
{
    ...
    public class InsumoXCotizacionAlumno11Controller : ControllerBase
    {
        private readonly IInsumoXCotizacionService<Alumno11Context> _Service;
        private readonly ILogger<InsumoXCotizacionAlumno11Controller> _Logger;
        private readonly CotizacionProceso<Alumno11Context> _Proceso;
        private readonly Alumno11Context Context;
        public InsumoXCotizacionAlumno11Controller(
            ILogger<InsumoXCotizacionAlumno11Controller> Logger,
            Alumno11Context Context
            , IInsumoXCotizacionService<Alumno11Context> Service
