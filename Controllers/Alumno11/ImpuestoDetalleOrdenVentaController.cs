...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    {
        private readonly ImpuestoDetalleOrdenVentaProceso<Alumno11Context> _process;

        public ImpuestoDetalleOrdenVentaController(ImpuestoDetalleOrdenVentaProceso<Alumno11Context> process)
        {
            _process = process;
        }
