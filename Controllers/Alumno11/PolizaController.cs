...
namespace ERP_TECKIO
{
    ...
    public class PolizaAlumno11Controller : ControllerBase
    {
        private readonly IPolizaService<Alumno11Context> _Service;
        private readonly IPolizaDetalleService<Alumno11Context> _DetalleService;
        private readonly ITipoPolizaService<Alumno11Context> _TipoPolizaService;
        private readonly ICuentaContableService<Alumno11Context> _CuentaContableService;
        private readonly ISaldosBalanzaComprobacionService<Alumno11Context> _SaldosService;
        private readonly ILogger<PolizaAlumno11Controller> _Logger;
        private readonly Alumno11Context _Context;
        public PolizaAlumno11Controller(
            ILogger<PolizaAlumno11Controller> logger
            , Alumno11Context context
            , IPolizaService<Alumno11Context> service
            , IPolizaDetalleService<Alumno11Context> detalleService
            , ITipoPolizaService<Alumno11Context> tipoPolizaService
            , ISaldosBalanzaComprobacionService<Alumno11Context> saldosService
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearPoliza-Empresa11")]
        ...
        [HttpPut("editar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarPoliza-Empresa11")]
        ...
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarPoliza-Empresa11")]
