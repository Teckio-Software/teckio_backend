...
namespace SistemaERP.API.Controllers.Alumno11
{
    [Route("api/programacionestimadaGantt/11")]
    [ApiController]
    public class ProgramacionEstimadaGanttAlumno11Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaGanttProceso<Alumno11Context> _ProgramacionEstimadaGanttProceso;
        private readonly DbContextOptionsBuilder<Alumno11Context> _Options;
        private readonly ImporteSemanalGanttProceso<Alumno11Context> _importeSemanalGanttProceso;

        public ProgramacionEstimadaGanttAlumno11Controller(
            ProgramacionEstimadaGanttProceso<Alumno11Context> programacionEstimadaGanttProceso,
            ImporteSemanalGanttProceso<Alumno11Context> importeSemanalGanttProceso,
