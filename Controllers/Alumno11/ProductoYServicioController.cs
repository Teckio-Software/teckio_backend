...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    public class ProductoYServicioAlumno11Controller : ControllerBase
    {

        private readonly IProductoYservicioService<Alumno11Context> _productoYServicioService;

        private readonly ProductoYServicioProceso<Alumno11Context> _process;

        public ProductoYServicioAlumno11Controller(IProductoYservicioService<Alumno11Context> productoYServicioService,
            ProductoYServicioProceso<Alumno11Context> process
            )
        {
