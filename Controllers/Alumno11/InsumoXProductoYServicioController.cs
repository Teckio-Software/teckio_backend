...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    {
        private readonly IInsumoXProductoYServicioService<Alumno11Context> _service;
        private readonly InsumoXProductoYServicioProceso<Alumno11Context> _process;

        public InsumoXProductoYServicioController(IInsumoXProductoYServicioService<Alumno11Context> service, InsumoXProductoYServicioProceso<Alumno11Context> process)
        {
            _service = service;
            _process = process;
        }
