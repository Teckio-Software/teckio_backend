...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirectainsumos/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa11")]
    public class CompraDirectaInsumoAlumno11Controller : ControllerBase
    {
        private readonly IInsumoXCompraDirectaService<Alumno11Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno11Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno11Controller(
            ILogger<CompraDirectaInsumoAlumno11Controller> logger
            , Alumno11Context context
            , IInsumoXCompraDirectaService<Alumno11Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
