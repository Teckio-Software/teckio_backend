...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaInsumoAlumno11Controller : ControllerBase
    {
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaInsumoAlumno11Controller> Logger;
        /// <summary>
        /// Se usa para mandar en "headers" los registros totales de los registros
        /// </summary>
        private readonly Alumno11Context Context;
        private readonly IInsumoXAlmacenEntradaService<Alumno11Context> _AlmacenEntradaDetalle;
        ...
        public AlmacenEntradaInsumoAlumno11Controller(
            ILogger<AlmacenEntradaInsumoAlumno11Controller> logger,
            Alumno11Context context
            , IInsumoXAlmacenEntradaService<Alumno11Context> AlmacenEntradaDetalle
