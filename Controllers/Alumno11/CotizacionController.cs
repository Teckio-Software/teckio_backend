...
namespace ERP_TECKIO
{
    ...
    public class CotizacionAlumno11Controller : ControllerBase
    {
        private readonly ICotizacionService<Alumno11Context> _Service;
        private readonly CotizacionProceso<Alumno11Context> _Proceso;
        private readonly IOrdenCompraService<Alumno11Context> _OrdenCompraService;
        private readonly ITipoImpuestoService<Alumno11Context> _TipoImpuestoService;
        private readonly ILogger<CotizacionAlumno11Controller> _Logger;
        private readonly Alumno11Context Context;
        public CotizacionAlumno11Controller(

            ILogger<CotizacionAlumno11Controller> Logger
            , Alumno11Context Context
            , ICotizacionService<Alumno11Context> Service
            , IOrdenCompraService<Alumno11Context> OrdenCompraService,
              ITipoImpuestoService<Alumno11Context> TipoImpuestoService
            , CotizacionProceso<Alumno11Context> Proceso)
        {
            _Logger = Logger;
