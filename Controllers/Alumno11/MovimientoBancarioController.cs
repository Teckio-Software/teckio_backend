...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class MovimientoBancarioAlumno11Controller : ControllerBase
    {
        private readonly MovimientoBancarioProceso<Alumno11Context> _movimientoBancarioProceso;
        public MovimientoBancarioAlumno11Controller(
            MovimientoBancarioProceso<Alumno11Context> movimientoBancarioProceso
            )
        {
