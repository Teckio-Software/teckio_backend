...
namespace ERP_TECKIO
{
    ...
    public class InsumoXOrdenCompraAlumno11Controller : ControllerBase
    {
        private readonly IInsumoXOrdenCompraService<Alumno11Context> _Service;
        private readonly OrdenCompraProceso<Alumno11Context> _Proceso;
        private readonly ILogger<InsumoXOrdenCompraAlumno11Controller> _Logger;
        private readonly Alumno11Context _Context;
        public InsumoXOrdenCompraAlumno11Controller(
            ILogger<InsumoXOrdenCompraAlumno11Controller> Logger,
            Alumno11Context Context
            , IInsumoXOrdenCompraService<Alumno11Context> Service
