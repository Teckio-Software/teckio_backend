...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    public class OrdenVentaAlumno11Controller : ControllerBase
    {
        private readonly OrdenVentaProceso<Alumno11Context> _ordenVentaProceso;
        public OrdenVentaAlumno11Controller(
            OrdenVentaProceso<Alumno11Context> ordenVentaProceso
            ) { 
