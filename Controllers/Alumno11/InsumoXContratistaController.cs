...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/insumoxcontratista/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionInsumoXContratista-Empresa11")]
    public class InsumoXContratistaAlumno11Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<InsumoXContratistaAlumno11Controller> Logger;
        /// <summary>
        ...
        public InsumoXContratistaAlumno11Controller(
            ILogger<InsumoXContratistaAlumno11Controller> logger,
