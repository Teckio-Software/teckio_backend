...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ContratistaAlumno11Controller : ControllerBase
    {
        private readonly IContratistaService<Alumno11Context> _ContratistaService;
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<ContratistaAlumno11Controller> Logger;
        /// <summary>
        ...
        /// 
        private readonly ContratistaCuentasContablesProceso<Alumno11Context> _contratistaCuentasContablesProceso;
        public ContratistaAlumno11Controller(
            ILogger<ContratistaAlumno11Controller> logger,
            Alumno11Context context
            , IContratistaService<Alumno11Context> ContratistaService,
            ContratistaCuentasContablesProceso<Alumno11Context> contratistaCuentasContablesProceso
            )
        {
            Logger = logger;
            Context = context;
