...
namespace ERP_TECKIO.API.Controllers.Alumno11
{
    ...
    public class BancoAlumno11Controller : ControllerBase 
    {
        private readonly IBancoService<Alumno11Context> _bancoService;

        public BancoAlumno11Controller(IBancoService<Alumno11Context> bancoService)
        {
