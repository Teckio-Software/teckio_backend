...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    {
        private readonly FactorSalarioRealProceso<Alumno11Context> _FactorSalarioRealProceso;
        private readonly IParametrosFsrService<Alumno11Context> _parametrosFsrService;
        private readonly IPorcentajeCesantiaEdadService<Alumno11Context> _porcentajeCesantiaEdadService;
        
        public FactorSalarioRealController(
            FactorSalarioRealProceso<Alumno11Context> factorSalarioRealProceso,
            IParametrosFsrService<Alumno11Context> parametrosFsrService,
            IPorcentajeCesantiaEdadService<Alumno11Context> porcentajeCesantiaEdadService
            )
        {
