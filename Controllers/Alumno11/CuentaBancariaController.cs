...
namespace ERP_TECKIO
{
    ...
    public class CuentaBancariaAlumno11Controller : ControllerBase
    {
        private readonly CuentaBancariaProceso<Alumno11Context> _proceso;

        private readonly ICuentaBancariaService<Alumno11Context> _servicio;
        public CuentaBancariaAlumno11Controller(CuentaBancariaProceso<Alumno11Context> _proceso, ICuentaBancariaService<Alumno11Context> _servicio
           )
        {
