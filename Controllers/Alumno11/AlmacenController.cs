...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenAlumno11Controller : ControllerBase
    {
        private readonly IAlmacenService<Alumno11Context> _almacenServicio;

        public AlmacenAlumno11Controller(
            IAlmacenService<Alumno11Context> almacenServicio)
        {
