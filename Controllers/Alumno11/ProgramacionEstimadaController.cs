...
namespace ERP_TECKIO
{
    ...
    [ApiController]
    public class ProgramacionEstimadaAlumno11Controller : ControllerBase
    {
        private readonly ProgramacionEstimadaProceso<Alumno11Context> _ProgramacionEstimadaProceso;
        private readonly IProyectoService<Alumno11Context> _ProyectoService;
        private readonly IPrecioUnitarioService<Alumno11Context> _PrecioUnitarioService;

        public ProgramacionEstimadaAlumno11Controller(
            ProgramacionEstimadaProceso<Alumno11Context> programacionEstimadaProceso,
            IProyectoService<Alumno11Context> proyectoProceso,
            IPrecioUnitarioService<Alumno11Context> precioUnitarioService,
