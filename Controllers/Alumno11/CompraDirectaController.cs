...
namespace ERP_TECKIO
{
    ...
    /// </summary>
    [Route("api/compradirecta/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa11")]
    public class CompraDirectaAlumno11Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno11Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno11Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno11Controller(
            ILogger<CompraDirectaAlumno11Controller> logger,
            Alumno11Context context
            , ICompraDirectaService<Alumno11Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "CrearOrdenCompra-Empresa11")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EditarOrdenCompra-Empresa11")]
        ...
        /// <returns>NoContent</returns>
        [HttpPut("cancelar")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "EliminarOrdenCompra-Empresa11")]
