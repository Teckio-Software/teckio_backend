...
namespace ERP_TECKIO
{
    ...
    public class InsumoXRequisicionAlumno11Controller : ControllerBase
    {
        private readonly IInsumoXRequisicionService<Alumno11Context> _Service;

        private readonly RequisicionProceso<Alumno11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<InsumoXRequisicionAlumno11Controller> _Logger;
        /// <summary>
        ...
        public InsumoXRequisicionAlumno11Controller(
            ILogger<InsumoXRequisicionAlumno11Controller> Logger,
            RequisicionProceso<Alumno11Context> Proceso,
            Alumno11Context Context
            , IInsumoXRequisicionService<Alumno11Context> Service)
        {
            _Logger = Logger;
