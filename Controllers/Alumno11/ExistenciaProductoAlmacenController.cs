...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    {
        private readonly ExistenciaProductoAlmacenProceso<Alumno11Context> _proceso;

        public ExistenciaProductoAlmacenController(ExistenciaProductoAlmacenProceso<Alumno11Context> proces)
        {
            _proceso = proces;
        }
