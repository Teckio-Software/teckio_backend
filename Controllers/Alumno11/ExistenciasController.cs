...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ExistenciasAlumno11Controller : ControllerBase
    {
        private readonly IAlmacenExistenciaInsumoService<Alumno11Context> _ExistenciaService;
        private readonly ExistenciasProceso<Alumno11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<ExistenciasAlumno11Controller> _Logger;
        /// <summary>
        ...
        public ExistenciasAlumno11Controller(
            ILogger<ExistenciasAlumno11Controller> Logger,
            Alumno11Context Context
            , IAlmacenExistenciaInsumoService<Alumno11Context> ExistenciaService
            , ExistenciasProceso<Alumno11Context> Proceso
            )
        {
            _Logger = Logger;
