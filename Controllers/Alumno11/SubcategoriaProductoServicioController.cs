...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    {
        private readonly ISubcategoriaProdutoYServicio<Alumno11Context> _service;

        public SubcategoriaProductoServicioController(ISubcategoriaProdutoYServicio<Alumno11Context> service)
        {
            _service = service;
        }
