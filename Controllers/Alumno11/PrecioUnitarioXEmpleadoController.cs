...
namespace ERP_TECKIO.Controllers.Alumno11
{
    ...
    public class PrecioUnitarioXEmpleadoAlumno11Controller : ControllerBase
    {
        private readonly IPrecioUnitarioXEmpleadoService<Alumno11Context> _service;
        private readonly PrecioUnitarioXEmpleadoProceso<Alumno11Context> _proceso;
        public PrecioUnitarioXEmpleadoAlumno11Controller(
            IPrecioUnitarioXEmpleadoService<Alumno11Context> service,
            PrecioUnitarioXEmpleadoProceso<Alumno11Context> proceso
            ) { 
            _service = service;
            _proceso = proceso;
        }
