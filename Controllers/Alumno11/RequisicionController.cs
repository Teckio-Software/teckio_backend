...
namespace ERP_TECKIO.Controllers
{
    ...
    public class RequisicionAlumno11Controller : ControllerBase
    {
        private readonly IRequisicionService<Alumno11Context> _RequisicionService;
        private readonly RequisicionProceso<Alumno11Context> _Proceso;
        private readonly ObjetoRequisicionProceso<Alumno11Context> _ObjetoRequisicionProceso;
        private readonly IProyectoService<Alumno11Context> _ProyectoService;
        //private readonly IMapper _mapper;
        /// <summary>
        /// Se usa para mostrar errores en la consola
        /// </summary>
        private readonly ILogger<RequisicionAlumno11Controller> _Logger;
        /// <summary>
        ...
        public RequisicionAlumno11Controller(
            ILogger<RequisicionAlumno11Controller> Logger
            , Alumno11Context Context
            , IRequisicionService<Alumno11Context> RequisicionService
            , RequisicionProceso<Alumno11Context> Proceso
            , ObjetoRequisicionProceso<Alumno11Context> ObjetoRequisicionProceso
            , IProyectoService<Alumno11Context> ProyectoService
            )
        {
            _Logger = Logger;
            _Context = Context;
        ...
        public async Task<ActionResult<List<RequisicionDTO>>> filtrar([FromBody] RequisicionBusquedaExtensaDTO FiltrarDTO)
        {
            ...
            if (Convert.ToDateTime(FiltrarDTO.FechaFinal) != Convert.ToDateTime(null)
                ...
                && Convert.ToDateTime(FiltrarDTO.FechaFinal) > Convert.ToDateTime("01/01/11/970"))
            {
