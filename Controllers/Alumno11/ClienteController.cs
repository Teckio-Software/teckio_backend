...
namespace ERP_TECKIO.Controllers
{
    ...
    public class ClienteAlumno11Controller : ControllerBase
    {
        private readonly IClientesService<Alumno11Context> _Service;

        private readonly ClienteProceso<Alumno11Context> _Proceso;
        private readonly ClienteCuentasContablesProceso<Alumno11Context> _clientesCuentasContablesProceso;
        public ClienteAlumno11Controller(
            IClientesService<Alumno11Context> service
            , ClienteProceso<Alumno11Context> proceso,
            ClienteCuentasContablesProceso<Alumno11Context> clientesCuentasContablesProceso)
        {
            _Service = service;
            _Proceso = proceso;
