...
namespace ERP_TECKIO.Controllers
{
    ...
    public class OrdenCompraAlumno11Controller : ControllerBase
    {
        private readonly IOrdenCompraService<Alumno11Context> _Service;
        private readonly OrdenCompraProceso<Alumno11Context> _Proceso;
        private readonly ILogger<OrdenCompraAlumno11Controller> _Logger;
        private readonly Alumno11Context Context;
        private readonly PolizaProceso<Alumno11Context> _polizaProceso;
        private readonly ObtenFacturaProceso<Alumno11Context> _obtenFacturaProceso;

        public OrdenCompraAlumno11Controller(
            ILogger<OrdenCompraAlumno11Controller> Logger
            , Alumno11Context Context
            , IOrdenCompraService<Alumno11Context> Service
            , OrdenCompraProceso<Alumno11Context> Proceso
            , PolizaProceso<Alumno11Context> polizaProceso
            , ObtenFacturaProceso<Alumno11Context> obtenFacturaProceso
            )
        {
            _Logger = Logger;
