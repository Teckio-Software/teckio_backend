...
namespace ERP_TECKIO.Controllers
{
    ...
    [ApiController]
    public class ContratosAlumno11Controller : ControllerBase
    {
        private readonly ContratosProceso<Alumno11Context> _contratosProceso;
        public ContratosAlumno11Controller(
            ContratosProceso<Alumno11Context> contratosProceso
            )
        {
