...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenSalidaAlumno11Controller : ControllerBase
    {
        private readonly IAlmacenSalidaService<Alumno11Context> _AlmacenSalidaServicio;
        private readonly IInsumoXAlmacenSalidaService<Alumno11Context> _AlmacenSalidaDetalleServicio;
        private readonly AlmacenSalidaProceso<Alumno11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenSalidaAlumno11Controller> Logger;
        ...
        public AlmacenSalidaAlumno11Controller(
            UserManager<IdentityUser> zUserManager,
            ILogger<AlmacenSalidaAlumno11Controller> logger,
            Alumno11Context context
            , IAlmacenSalidaService<Alumno11Context> AlmacenSalidaServicio
            , IInsumoXAlmacenSalidaService<Alumno11Context> AlmacenSalidaDetalleServicio
            , AlmacenSalidaProceso<Alumno11Context> Proceso
            )
        {
