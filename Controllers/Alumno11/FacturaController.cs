...
{
    [Route("api/factura/11")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]

    public class FacturaAlumno11Controller : ControllerBase
    {
        private readonly ObtenFacturaProceso<Alumno11Context> _obtenFacturaProceso;
        private readonly ICategoriaProductoYServicioService<Alumno11Context> _categoriaProductoYServicioService;
        public FacturaAlumno11Controller(
            ObtenFacturaProceso<Alumno11Context> obtenFacturaProceso,
            ICategoriaProductoYServicioService<Alumno11Context> categoriaProductoYServicioService
            )
        {
