...
namespace ERP_TECKIO.Controllers
{
    ...
    public class AlmacenEntradaAlumno11Controller : ControllerBase
    {
        private readonly IAlmacenEntradaService<Alumno11Context> _AlmacenEntradaServicio;
        private readonly IInsumoXAlmacenEntradaService<Alumno11Context> _AlmacenEntradaDetalleServicio;
        private readonly AlmacenEntradaProceso<Alumno11Context> _Proceso;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<AlmacenEntradaAlumno11Controller> Logger;
        /// <summary>
        ...
        public AlmacenEntradaAlumno11Controller(
            ILogger<AlmacenEntradaAlumno11Controller> logger,
            Alumno11Context context
            , IAlmacenEntradaService<Alumno11Context> almacenServicio
            , IInsumoXAlmacenEntradaService<Alumno11Context> AlmacenEntradaDetalleServicio
            , AlmacenEntradaProceso<Alumno11Context> Proceso
            )
        {
            Logger = logger;
            Context = context;
