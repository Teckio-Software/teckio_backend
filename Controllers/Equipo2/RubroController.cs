...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    {
        private readonly IRubroService<Alumno40Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<RubroAlumno40Controller> Logger;
        ...
        public RubroAlumno40Controller(
            ILogger<RubroAlumno40Controller> logger,
            Alumno40Context context
            , IMapper mapper
            //, IGenericRepository2<Rubro, ErpContextTeckio> genericRepository2
            , IRubroService<Alumno40Context> service
            )
        {
            //_Service = service;
            Logger = logger;
