...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/proyecto/40")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionProyecto-Empresa35")]
    public class ProyectoAlumno40Controller : ControllerBase
    {
        private readonly ProyectoProceso<Alumno40Context> _ProyectoProceso;
        public ProyectoAlumno40Controller(
            ProyectoProceso<Alumno40Context> proyectoProceso)
        {
