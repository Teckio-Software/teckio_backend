...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/especialIdadxcontratista/40")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionEspecialidadContratista-Empresa35")]
    public class EspecialIdadXContratistaAlumno40Controller : ControllerBase
    {
        /// <summary>
        /// Para mostrar los errores en consola
        /// </summary>
        private readonly ILogger<EspecialIdadXContratistaAlumno40Controller> Logger;
        /// <summary>
        ...
        public EspecialIdadXContratistaAlumno40Controller(
            ILogger<EspecialIdadXContratistaAlumno40Controller> logger,
