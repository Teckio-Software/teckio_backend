...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipoinsumo/40")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoInsumo-Empresa35")]
    public class TipoInsumoAlumno40Controller : ControllerBase
    {
        private readonly TipoInsumoProceso<Alumno40Context> _TipoInsumoProceso;

        public TipoInsumoAlumno40Controller(
            TipoInsumoProceso<Alumno40Context> tipoInsumoProceso
            )
        {
