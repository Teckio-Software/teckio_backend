...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    {
        private readonly FamiliaInsumoProceso<Alumno40Context> _FamiliaInsumoProceso;
        public FamiliaInsumoAlumno40Controller(
            FamiliaInsumoProceso<Alumno40Context> familiaInsumoProceso)
        {
