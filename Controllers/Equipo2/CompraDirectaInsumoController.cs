...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    {
        private readonly IInsumoXCompraDirectaService<Alumno40Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaInsumoAlumno40Controller> _Logger;
        /// <summary>
        ...
        public CompraDirectaInsumoAlumno40Controller(
            ILogger<CompraDirectaInsumoAlumno40Controller> logger
            , Alumno40Context context
            , IInsumoXCompraDirectaService<Alumno40Context> Service)
        {
            _Logger = logger;
            _Context = context;
            _Service = Service;
