...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/tipopoliza/40")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionTipoPoliza-Empresa35")]
    public class TipoPolizaAlumno40Controller : ControllerBase
    {
        private readonly ITipoPolizaService<Alumno40Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<TipoPolizaAlumno40Controller> Logger;
        /// <summary>
        ...
        public TipoPolizaAlumno40Controller(
            ILogger<TipoPolizaAlumno40Controller> logger,
            Alumno40Context context
            , ITipoPolizaService<Alumno40Context> service)
        {
            _Service = service;
            Logger = logger;
            Context = context;
