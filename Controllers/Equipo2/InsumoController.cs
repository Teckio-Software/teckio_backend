...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    public class InsumoAlumno40Controller : ControllerBase
    {
        private readonly InsumoProceso<Alumno40Context> _InsumoProceso;
        public InsumoAlumno40Controller(
            InsumoProceso<Alumno40Context> insumoProceso)
        {
