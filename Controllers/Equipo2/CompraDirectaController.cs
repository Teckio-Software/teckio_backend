...
namespace SistemaERP.API.Alumno40Controllers.Procomi
{
    ...
    /// </summary>
    [Route("api/compradirecta/40")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]//, Policy = "SeccionOrdenCompra-Empresa35")]
    public class CompraDirectaAlumno40Controller : ControllerBase
    {
        private readonly ICompraDirectaService<Alumno40Context> _Service;
        /// <summary>
        /// Se usa para mostrar errores en consola
        /// </summary>
        private readonly ILogger<CompraDirectaAlumno40Controller> Logger;
        /// <summary>
        ...
        public CompraDirectaAlumno40Controller(
            ILogger<CompraDirectaAlumno40Controller> logger,
            Alumno40Context context
            , ICompraDirectaService<Alumno40Context> Service)
        {
            Logger = logger;
            Context = context;
            _Service = Service;
